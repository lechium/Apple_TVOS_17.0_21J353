...
+ (Class)layoutAttributesClass;	// IMP=0x00400000000315e0
- (void).cxx_destruct;	// IMP=0x0020000000031cc0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0010000000031a80
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0010000000031770
- (void)prepareLayout;	// IMP=0x0010000000031610
