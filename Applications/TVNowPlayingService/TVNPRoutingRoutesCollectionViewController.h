...
- (void).cxx_destruct;	// IMP=0x0020000000038560
...
- (void)_pickRoute:(id)arg1;	// IMP=0x0010000000037e50
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000037da0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000037c30
- (void)_calculateVisibleVolumeCells;	// IMP=0x00100000000376e0
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x0010000000037590
- (id)_gradientMask;	// IMP=0x0010000000036f30
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0010000000036e20
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0010000000036530
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00100000000364c0
- (void)shareAudioSelected;	// IMP=0x0010000000036420
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0010000000036110
- (void)longPressSelect:(id)arg1;	// IMP=0x0010000000036010
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0010000000035eb0
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035ce0
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035b10
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0010000000035a70
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00100000000356e0
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x00100000000354a0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000035370
- (void)handleVolumeDown;	// IMP=0x0010000000034d40
- (void)handleVolumeUp;	// IMP=0x00100000000346b0
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x0010000000033410
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000033080
- (void)viewDidLoad;	// IMP=0x0010000000032150
- (void)dealloc;	// IMP=0x0010000000032100
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x0010000000031fb0
