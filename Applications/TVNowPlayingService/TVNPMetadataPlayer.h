...
- (void).cxx_destruct;	// IMP=0x002000000001c750
...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x001000000001bb00
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x001000000001baa0
- (void)_updateElapsedTimeTimer;	// IMP=0x001000000001b9a0
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x001000000001b2e0
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x001000000001af50
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x001000000001af00
- (void)updateSubtitleOptions;	// IMP=0x001000000001aef0
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001aeb0
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001ae40
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001add0
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001ad40
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x001000000001ac30
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x001000000001aba0
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x001000000001ab60
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x001000000001ab20
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x001000000001aae0
- (void)setElapsedTime:(double)arg1;	// IMP=0x001000000001a9d0
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x001000000001a9a0
- (void)stop;	// IMP=0x001000000001a900
- (void)scanWithRate:(double)arg1;	// IMP=0x001000000001a720
- (void)togglePlayPause;	// IMP=0x001000000001a6c0
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x001000000001a690
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x001000000001a660
- (void)pause;	// IMP=0x001000000001a600
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x001000000001a5d0
- (void)play;	// IMP=0x001000000001a4c0
- (void)continueLoadingCurrentItem;	// IMP=0x001000000001a4b0
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x001000000001a3e0
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x001000000001a3a0
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x001000000001a2a0
- (void)invalidate;	// IMP=0x001000000001a260
- (id)initWithName:(id)arg1;	// IMP=0x001000000001a100
- (id)init;	// IMP=0x001000000001a0a0
