...
- (void).cxx_destruct;	// IMP=0x002000000000baf0
...
- (id)_indexPathForCurrentDestination;	// IMP=0x001000000000b620
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x001000000000b480
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x001000000000b310
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x001000000000b2a0
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x001000000000aa40
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x001000000000a3b0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000009c70
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x00100000000099f0
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0010000000009740
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x0010000000009010
- (void)viewDidLayoutSubviews;	// IMP=0x00100000000088d0
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000008820
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000000086f0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000008040
- (void)viewDidLoad;	// IMP=0x0010000000007ab0
- (void)dealloc;	// IMP=0x00100000000079f0
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x0010000000007770
