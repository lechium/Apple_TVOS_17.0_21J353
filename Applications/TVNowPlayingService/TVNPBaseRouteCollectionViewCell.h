...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0020000000023cc0
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0010000000021820
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x001000000001d7b0
+ (_Bool)allowsSelection;	// IMP=0x001000000001d790
- (void).cxx_destruct;	// IMP=0x00200000000241a0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x0010000000023ab0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000022c10
- (unsigned long long)_controlStateForCell;	// IMP=0x0010000000022b40
- (void)_addInitialConstraints;	// IMP=0x00100000000219d0
- (void)accessoryViewSelected;	// IMP=0x0010000000021810
- (void)routeViewSelected;	// IMP=0x0010000000021800
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x00100000000217c0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0010000000020da0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x0010000000020c70
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000020b60
- (void)updateConstraints;	// IMP=0x001000000001ed20
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000001ebf0
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000001ebd0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001ea90
- (void)prepareForReuse;	// IMP=0x001000000001e9f0
- (id)preferredFocusEnvironments;	// IMP=0x001000000001e870
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001d7d0
