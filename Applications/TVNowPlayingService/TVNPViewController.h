...
+ (id)_remoteViewControllerInterface;	// IMP=0x00200000000416d0
+ (id)_exportedInterface;	// IMP=0x0010000000041590
- (void).cxx_destruct;	// IMP=0x0020000000041900
...
- (void)_menuPressed:(id)arg1;	// IMP=0x0010000000041740
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000410b0
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x00100000000406b0
- (void)viewDidLoad;	// IMP=0x00100000000405e0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000404d0
