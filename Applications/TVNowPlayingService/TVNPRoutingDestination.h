...
- (void).cxx_destruct;	// IMP=0x0020000000019fd0
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000019ad0
- (void)connectAndPair;	// IMP=0x0010000000019ac0
- (void)togglePlayPause;	// IMP=0x0010000000019ab0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000019a10
- (id)init;	// IMP=0x00100000000199e0
