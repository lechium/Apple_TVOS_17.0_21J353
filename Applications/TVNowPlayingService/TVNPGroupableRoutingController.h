...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000dc50
- (void).cxx_destruct;	// IMP=0x00200000000188a0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000018220
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017e00
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016850
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00100000000127d0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000012350
- (void)_updateAvailableRoutes;	// IMP=0x0010000000011800
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0010000000011640
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x00100000000115c0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000011570
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000011370
- (MISSING_TYPE *)presentEARCUpsell;	// IMP=0x0010000000010f10
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0010000000010950
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0010000000010480
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000ef70
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000ee90
- (void)dealloc;	// IMP=0x001000000000e910
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000de00
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000dd60
- (id)init;	// IMP=0x001000000000dd00
