...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0020000000042fd0
- (void).cxx_destruct;	// IMP=0x0020000000047590
...
- (id)_preloadArtwork;	// IMP=0x00100000000470d0
- (id)_placeholderArtwork;	// IMP=0x0010000000046fd0
- (void)_updateState;	// IMP=0x0010000000046d70
- (void)_updateAutomaticResponseLoading;	// IMP=0x0010000000046c80
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000046630
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000046470
- (void)_updateMetadata;	// IMP=0x00100000000442f0
- (void)_createRequestController;	// IMP=0x0010000000043c60
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0010000000043990
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0010000000043740
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000043250
- (void)playPause;	// IMP=0x0010000000043220
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000043190
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000430b0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000042f30
- (id)playerPath;	// IMP=0x0010000000042e40
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0010000000042c50
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00100000000428b0
