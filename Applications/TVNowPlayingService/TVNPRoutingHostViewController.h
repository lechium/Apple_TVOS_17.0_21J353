...
+ (id)_remoteViewControllerInterface;	// IMP=0x0020000000006f70
+ (id)_exportedInterface;	// IMP=0x0010000000006e30
- (void).cxx_destruct;	// IMP=0x0020000000007140
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0010000000006fe0
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000006c20
- (void)viewServiceHandleMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000006bb0
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x00100000000067a0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000063c0
