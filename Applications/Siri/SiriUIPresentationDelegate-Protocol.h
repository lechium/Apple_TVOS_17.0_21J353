...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 requestsAttendingStateWithCompletion:(void (^)(_Bool))arg2;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 viewDidAppearWithAceObject:(AceObject *)arg2;
- (void)userTouchedSnippet;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 reduceOrbOpacity:(_Bool)arg2;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 requestsTouchPassThroughEnabled:(_Bool)arg2;
- (void)siriPresentationCancelHIDEventDefferal:(id <SiriUIPresentation>)arg1;
- (void)siriPresentationRequestsHIDEventDefferal:(id <SiriUIPresentation>)arg1;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 willBeginEditingOfType:(long long)arg2;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 requestsKeyboardWithCompletion:(void (^)(_Bool))arg2;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 openURL:(NSURL *)arg2 conversationId:(id)arg3 completion:(void (^)(_Bool))arg4;
- (NSBundle *)effectiveCoreLocationBundleForSiriPresentation:(id <SiriUIPresentation>)arg1;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 performAceCommand:(AceObject<SAAceCommand> *)arg2 conversationItemIdentifier:(NSUUID *)arg3 turnIdentifier:(NSUUID *)arg4 completion:(void (^)(_Bool))arg5;
...
- (void)endSiriSessionForSiriPresentation:(id <SiriUIPresentation>)arg1 withDismissalReason:(long long)arg2;
- (void)siriWillStopAttending:(id <SiriUIPresentation>)arg1;
- (void)dismissSiriPresentation:(id <SiriUIPresentation>)arg1 withReason:(long long)arg2;
...
- (void)siriPresentationKeyboardViewDidAppear:(id <SiriUIPresentation>)arg1;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 startRequestForText:(NSString *)arg2;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 startRequestWithOptions:(SASRequestOptions *)arg2;
- (SASRequestOptions *)activeRequestOptionsForSiriPresentation:(id <SiriUIPresentation>)arg1;
...
@optional
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 didChangeVisualState:(unsigned long long)arg2;
- (void)tapToEditPresented:(id <SiriUIPresentation>)arg1;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 handleStartLocalRequest:(SAStartLocalRequest *)arg2 turnIdentifier:(NSUUID *)arg3;
