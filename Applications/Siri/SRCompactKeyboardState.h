...
- (void).cxx_destruct;	// IMP=0x002000000002c76c
@property(readonly, copy, nonatomic) SRCompactKeyboardAnimation *animation; // @synthesize animation=_animation;
@property(readonly, nonatomic) struct CGRect frame; // @synthesize frame=_frame;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002c73f
@property(readonly, nonatomic) struct CGRect frameForAnimation;
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x001000000002c364
- (id)initWithFrame:(struct CGRect)arg1 animation:(id)arg2;	// IMP=0x001000000002c2e4
