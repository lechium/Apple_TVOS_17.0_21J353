...
@class NSString, NSUUID, SRUIFPreferences;
...
- (void).cxx_destruct;	// IMP=0x0020000000067237
...
- (void)preferences:(id)arg1 didChangeValueForKey:(id)arg2;	// IMP=0x0010000000066eda
- (id)init;	// IMP=0x0010000000066e51
