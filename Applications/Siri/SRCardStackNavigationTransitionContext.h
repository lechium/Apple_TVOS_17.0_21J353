...
@interface SRCardStackNavigationTransitionContext : NSObject
{
    ...
    UIView<SiriSharedUIDarkening> *_backgroundPlatteredCardView;	// 24 = 0x18
    UIView<SiriSharedUIDarkening> *_fromPlatteredCardView;	// 32 = 0x20
    UIView<SiriSharedUIDarkening> *_toPlatteredCardView;	// 40 = 0x28
...
- (void).cxx_destruct;	// IMP=0x0020000000057f07
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0010000000057cba
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x0010000000057c1f
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000057bac
