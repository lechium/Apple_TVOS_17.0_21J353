...
- (void).cxx_destruct;	// IMP=0x002000000000553e
...
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x001000000000533c
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x0010000000005281
