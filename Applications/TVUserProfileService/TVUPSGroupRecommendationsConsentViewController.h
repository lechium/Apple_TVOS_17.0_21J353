...
- (void).cxx_destruct;	// IMP=0x0020000000003a90
...
- (void)groupRecommendationsConsentViewControllerDidCancel:(id)arg1;	// IMP=0x0010000000003870
- (void)groupRecommendationsConsentViewController:(id)arg1 didUpdateConsentWithAuthorized:(_Bool)arg2;	// IMP=0x0010000000003020
- (void)_dimissWithConsentGiven:(_Bool)arg1;	// IMP=0x0010000000002e40
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000002d00
- (void)viewDidLoad;	// IMP=0x0010000000002c10
- (id)initWithUserProfileIdentifier:(id)arg1;	// IMP=0x0010000000002890
