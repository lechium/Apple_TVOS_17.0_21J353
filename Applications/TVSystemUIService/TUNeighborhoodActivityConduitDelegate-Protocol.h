...
@class NSUUID, TUContinuitySessionInfo, TUConversation, TUNearbyDeviceHandle, TUNearbySuggestionAdvertisement, TUNeighborhoodActivityConduit, TUNeighborhoodHandoffContext;
