...
@class MISSING_TYPE, NSArray, NSIndexPath, NSString, UIContextMenuConfiguration, UIFocusAnimationCoordinator, UISwipeActionsConfiguration, UITableView, UITableViewCell, UITableViewFocusUpdateContext, UITargetedPreview, UIView;
...
- (MISSING_TYPE *)tableView:didEndDisplayingFooterView:forSection: /* Error: Ran out of types for this method. */;
