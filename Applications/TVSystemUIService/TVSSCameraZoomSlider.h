...
- (void).cxx_destruct;	// IMP=0x00200000000a1c20
...
- (id)_unfocusedProgressColor;	// IMP=0x00100000000a1940
- (id)_focusedProgressColor;	// IMP=0x00100000000a1860
- (void)_panUpdated:(id)arg1;	// IMP=0x00100000000a12c0
- (void)_menuPressed;	// IMP=0x00100000000a12b0
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000000a1240
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000000a11d0
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000000a1160
- (_Bool)shouldTrack;	// IMP=0x00100000000a1140
@property(nonatomic) double maxBarWidth;
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x00100000000a0d60
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00100000000a0c80
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000000a0c40
- (void)layoutSubviews;	// IMP=0x00100000000a0470
- (_Bool)canBecomeFocused;	// IMP=0x00100000000a0450
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000009fb60
