...
- (void).cxx_destruct;	// IMP=0x0020000000014ce0
...
- (void)_updateEffect;	// IMP=0x00100000000144b0
- (void)_updateCameraViewConstraints;	// IMP=0x0010000000013bc0
- (void)_updateAudioStream:(_Bool)arg1;	// IMP=0x00100000000138c0
- (_Bool)_shouldDisplayErrorContent;	// IMP=0x0010000000013750
- (_Bool)_shouldDisplayAccessModeErrorContent;	// IMP=0x00100000000135d0
- (void)_updateContentViews;	// IMP=0x0010000000013130
- (void)_updateCameraNameLabels;	// IMP=0x0010000000012ba0
- (void)cameraUserSettingsDidUpdate:(id)arg1;	// IMP=0x0010000000012b50
- (void)cameraStreamControl:(id)arg1 didStopStreamWithError:(id)arg2;	// IMP=0x00100000000127b0
- (void)cameraStreamControlDidStartStream:(id)arg1;	// IMP=0x0010000000012140
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000012060
- (void)stopStream;	// IMP=0x0010000000012010
- (void)startStreamIfNecessary;	// IMP=0x0010000000011ef0
- (void)setLiveBadgeViewHidden:(_Bool)arg1;	// IMP=0x0000000000011ea0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000000e890
