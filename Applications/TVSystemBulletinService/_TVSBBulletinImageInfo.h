...
+ (id)infoWithSymbolName:(id)arg1 configuration:(id)arg2;	// IMP=0x0040000000019da0
+ (id)infoWithImageName:(id)arg1 configuration:(id)arg2;	// IMP=0x0010000000019ca0
+ (id)infoWithImageName:(id)arg1;	// IMP=0x0010000000019bf0
- (void).cxx_destruct;	// IMP=0x0020000000019f00
