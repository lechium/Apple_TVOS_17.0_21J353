...
- (void).cxx_destruct;	// IMP=0x0020000000004810
...
- (id)preferredFocusEnvironments;	// IMP=0x00100000000045a0
- (void)viewDidLoad;	// IMP=0x0010000000003360
- (id)initWithMap:(id)arg1 allProfiles:(id)arg2 allUsers:(id)arg3 appName:(id)arg4;	// IMP=0x0010000000002f00
