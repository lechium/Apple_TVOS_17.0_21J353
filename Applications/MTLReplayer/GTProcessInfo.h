...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001e356
- (void).cxx_destruct;	// IMP=0x002000000001e770
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001e624
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001e498
- (id)init;	// IMP=0x001000000001e35e
