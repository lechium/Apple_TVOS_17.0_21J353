...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000006714
...
- (id)description;	// IMP=0x001000000000685e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000067c7
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000671c
