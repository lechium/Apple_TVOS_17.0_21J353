...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001dfa4
+ (id)protocolMethods:(id)arg1;	// IMP=0x001000000001decb
- (void).cxx_destruct;	// IMP=0x002000000001e323
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001e1f8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001e0a1
- (id)initWithProtocol:(id)arg1;	// IMP=0x001000000001dfac
