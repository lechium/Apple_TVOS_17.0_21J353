...
+ (id)steamDataFromData:(id)arg1;	// IMP=0x002000000004a325
+ (id)dataFromArchivedDataURL:(id)arg1;	// IMP=0x001000000004a25e
+ (id)streamDataClasses;	// IMP=0x001000000004a133
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004a12b
- (void).cxx_destruct;	// IMP=0x002000000004a00c
...
- (const CDStruct_71113f05 *)encoderInfoFromFunctionIndex:(unsigned int)arg1;	// IMP=0x0010000000049e9d
- (const CDStruct_0b014dd4 *)GPUCommandInfoFromFunctionIndex:(unsigned int)arg1 subCommandIndex:(int)arg2;	// IMP=0x0010000000049e19
- (void)patchObjectIds:(id)arg1;	// IMP=0x001000000004986b
- (void)debugDump:(id)arg1;	// IMP=0x0010000000049747
...
- (void)enumerateUnarchivedBatchIdFilteredCounterData:(CDUnknownBlockType)arg1;	// IMP=0x001000000004933d
...
- (void)enumerateUnarchivedGPUTimelineData:(CDUnknownBlockType)arg1;	// IMP=0x0010000000048876
...
- (void)enumerateUnarchivedShaderProfilerData:(CDUnknownBlockType)arg1;	// IMP=0x00100000000484e7
- (void)unloadAPSData:(_Bool)arg1;	// IMP=0x00100000000483d5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000047e88
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000047a5e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004749c
- (id)init;	// IMP=0x0010000000047460
