...
@class CKShareMetadata, INIntent, MISSING_TYPE, NSArray, NSCoder, NSData, NSDictionary, NSError, NSSet, NSString, NSURL, NSUserActivity, UIApplication, UIApplicationShortcutItem, UILocalNotification, UISceneConfiguration, UISceneConnectionOptions, UISceneSession, UIUserNotificationSettings, UIViewController, UIWindow;
...
- (MISSING_TYPE *)application:didFailToRegisterForRemoteNotificationsWithError: /* Error: Ran out of types for this method. */;
