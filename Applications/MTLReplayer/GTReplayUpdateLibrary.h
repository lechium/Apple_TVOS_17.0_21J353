...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000003f0d
- (void).cxx_destruct;	// IMP=0x002000000000422f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000004089
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000003f15
