...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000002562
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000002725
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000025c7
- (id)init;	// IMP=0x001000000000256a
