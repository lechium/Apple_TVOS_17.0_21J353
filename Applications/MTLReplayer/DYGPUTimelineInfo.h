...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002c8fe
- (void).cxx_destruct;	// IMP=0x002000000002c894
...
- (void)enumerateActiveShadersForSampleAtIndex:(unsigned int)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000002c655
- (void)enumerateActiveShadersForAllSamples:(CDUnknownBlockType)arg1;	// IMP=0x001000000002c4e4
- (id)init;	// IMP=0x001000000002c496
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002c37c
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002be28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002bb5d
