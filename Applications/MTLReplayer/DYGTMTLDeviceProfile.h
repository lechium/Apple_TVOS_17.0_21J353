...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001b490
- (void).cxx_destruct;	// IMP=0x002000000001b7b4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001b67b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001b498
