...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001850
- (void).cxx_destruct;	// IMP=0x0020000000001ac8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000018f1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000001858
