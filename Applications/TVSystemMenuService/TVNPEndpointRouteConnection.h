...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0020000000003630
- (void).cxx_destruct;	// IMP=0x0020000000007df0
...
- (id)_preloadArtwork;	// IMP=0x0010000000007930
- (id)_placeholderArtwork;	// IMP=0x0010000000007830
- (void)_updateState;	// IMP=0x00100000000075d0
- (void)_updateAutomaticResponseLoading;	// IMP=0x00100000000074e0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000006da0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000006be0
- (void)_updateMetadata;	// IMP=0x00100000000049f0
- (void)_createRequestController;	// IMP=0x0010000000004360
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0010000000004090
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003da0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00100000000038b0
- (void)playPause;	// IMP=0x0010000000003880
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00100000000037f0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003710
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000003590
- (id)playerPath;	// IMP=0x00100000000034a0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x00100000000032b0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000002ea0
