...
- (void).cxx_destruct;	// IMP=0x0020000000002dd0
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x00100000000028d0
- (void)connectAndPair;	// IMP=0x00100000000028c0
- (void)togglePlayPause;	// IMP=0x00100000000028b0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000002810
