...
+ (id)_remoteString;	// IMP=0x0040000000027740
+ (id)_teachableMomentAssetURL;	// IMP=0x0010000000027650
+ (id)_userInteractionAssetURL;	// IMP=0x0010000000027560
+ (double)_assetHeight;	// IMP=0x00100000000274a0
- (void).cxx_destruct;	// IMP=0x0020000000027a50
