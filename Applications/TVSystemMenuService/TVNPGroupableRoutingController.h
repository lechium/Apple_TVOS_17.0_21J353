...
@interface TVNPGroupableRoutingController : NSObject
{
    ...
    MISSING_TYPE *_allEndpoints;	// 232 = 0xe8
...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000d410
- (void).cxx_destruct;	// IMP=0x00200000000180f0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000017a30
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017610
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016060
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000011fe0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000011b60
- (void)_updateAvailableRoutes;	// IMP=0x0010000000011010
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0010000000010e50
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0010000000010dd0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000010d80
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000010b80
- (void)presentEARCUpsell;	// IMP=0x0010000000010720
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0010000000010100
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000fc30
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000e760
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000e680
- (void)dealloc;	// IMP=0x001000000000e0d0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000d5c0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000d520
- (id)init;	// IMP=0x001000000000d4c0
