...
- (void).cxx_destruct;	// IMP=0x0020000000023bf0
...
- (struct CGRect)untransformedPlatterFrameInCoordinateSpace:(id)arg1;	// IMP=0x0010000000023900
@property(readonly, nonatomic) struct CGRect selectedCellFrame;
- (id)preferredFocusEnvironments;	// IMP=0x0010000000023810
- (_Bool)definesPresentationContext;	// IMP=0x00100000000237f0
- (void)viewDidLoad;	// IMP=0x0010000000022cc0
- (void)initialAnimationDidFinish;	// IMP=0x0010000000022c80
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000022b50
