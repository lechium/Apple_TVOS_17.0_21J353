...
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x0010000000056d37
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0010000000056b20
- (void)viewDidLoad;	// IMP=0x0010000000056a24
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000569d5
