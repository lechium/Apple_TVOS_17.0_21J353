...
- (void).cxx_destruct;	// IMP=0x00200000000d0016
...
- (unsigned long long)hash;	// IMP=0x00100000000cff8e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cfe88
- (id)initWithLocaleIdentifier:(id)arg1 displayName:(id)arg2 shortDisplayName:(id)arg3 isSelected:(_Bool)arg4;	// IMP=0x00100000000cfd97
