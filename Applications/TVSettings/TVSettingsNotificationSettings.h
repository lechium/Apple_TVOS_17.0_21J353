...
@interface TVSettingsNotificationSettings : NSObject
{
    ...
    NSArray *_sectionInfos;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x0020000000005678
...
- (unsigned long long)hash;	// IMP=0x0010000000005339
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005289
