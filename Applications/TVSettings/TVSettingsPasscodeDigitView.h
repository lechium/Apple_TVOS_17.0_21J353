...
- (void).cxx_destruct;	// IMP=0x00200000000d1766
...
- (id)hiddenDigitImage;	// IMP=0x00100000000d130c
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00100000000d10d1
- (void)downGesture:(id)arg1;	// IMP=0x00100000000d0fca
- (void)upGesture:(id)arg1;	// IMP=0x00100000000d0ed5
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000000d0c3b
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000000d0b32
- (_Bool)canBecomeFocused;	// IMP=0x00100000000d0b2a
- (void)layoutSubviews;	// IMP=0x00100000000d0739
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000d0049
