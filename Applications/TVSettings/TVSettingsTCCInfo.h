...
+ (_Bool)automaticallyNotifiesObserversOfAllowAccess;	// IMP=0x00400000000a3b1e
+ (id)infoWithFacade:(id)arg1 identifier:(id)arg2 allowed:(_Bool)arg3;	// IMP=0x00100000000a3968
- (void).cxx_destruct;	// IMP=0x00200000000a3b59
