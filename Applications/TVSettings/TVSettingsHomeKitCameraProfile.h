...
- (void).cxx_destruct;	// IMP=0x0020000000081f93
...
- (id)_conditionForTriggerTime:(long long)arg1;	// IMP=0x0010000000081edc
- (id)_legacyMotionBulletinNotification;	// IMP=0x0010000000081e31
- (id)_smartDetectionBulletinNotification;	// IMP=0x0010000000081db7
- (id)_doorbellBulletinNotification;	// IMP=0x0010000000081d0c
- (void)toggledSignificantEventType:(unsigned long long)arg1;	// IMP=0x0010000000080fca
@property(readonly, copy, nonatomic) NSString *profileIdentifier;
@property(readonly, nonatomic) NSString *name;
- (id)cameraProfile;	// IMP=0x0010000000080656
- (id)initWithCameraItem:(id)arg1 controlCenterAndSiriEnabled:(_Bool)arg2;	// IMP=0x00100000000801d2
