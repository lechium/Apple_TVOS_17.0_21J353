...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000009b0f1
+ (id)sharedInstance;	// IMP=0x0010000000097f0f
- (void).cxx_destruct;	// IMP=0x002000000009b502
...
- (void)displayState:(id)arg1 didChangeWithConnection:(long long)arg2;	// IMP=0x001000000009aee0
- (void)_reloadDataFromCache;	// IMP=0x001000000009acee
- (id)_sortedDisplayModesForUserPresentation:(id)arg1;	// IMP=0x001000000009a098
- (void)presentCableCheckDisplayAssistant;	// IMP=0x001000000009a014
- (void)presentUpgradeAttemptDisplayAssistant;	// IMP=0x0010000000099f7e
- (void)resetVideoSettingsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000099e64
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000099e2e
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 requestConfiguration:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000099c51
- (void)_enumerateValidColorModesFromSortedModes:(id)arg1 existingFiltering:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000000996b2
@property(readonly, nonatomic) TVSettingsDisplayAssistantActionInfo *displayAssistantActionInfo;
- (_Bool)shouldShowDisplayAssistant;	// IMP=0x00100000000994b7
...
- (id)_recalculatedUnverifiedModes;	// IMP=0x0010000000098beb
- (id)_recalculatedUserVisibleHDRChromaModes;	// IMP=0x0010000000098904
- (id)_recalculatedUserVisibleSDRChromaModes;	// IMP=0x0010000000098601
- (id)_recalculatedUserVisibleSDRColorMappingModes;	// IMP=0x0010000000098175
- (void)dealloc;	// IMP=0x00100000000980e4
- (id)init;	// IMP=0x0010000000097f94
