...
- (void).cxx_destruct;	// IMP=0x00200000000604b6
...
- (unsigned long long)hash;	// IMP=0x001000000006032d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000060138
...
- (id)description;	// IMP=0x001000000005fc58
