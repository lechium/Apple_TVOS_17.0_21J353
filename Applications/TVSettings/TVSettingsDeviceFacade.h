...
+ (_Bool)automaticallyNotifiesObserversOfCurrentLocale;	// IMP=0x004000000003116e
+ (id)sharedInstance;	// IMP=0x0010000000030c84
- (void).cxx_destruct;	// IMP=0x00200000000321fa
...
- (void)_updateSleepTimeoutValue;	// IMP=0x0010000000031e5b
- (void)_updateLocaleForces24HourTime;	// IMP=0x0010000000031d89
@property(nonatomic) _Bool use24HourTime;
- (id)cityNameForCityID:(id)arg1;	// IMP=0x0010000000031c2e
@property(copy, nonatomic) NSString *timeZoneCityID;
- (void)_updateAutomaticTimeZoneEnabled:(_Bool)arg1;	// IMP=0x001000000003190e
@property(nonatomic) long long preferredKeyboardType;
@property(readonly, copy, nonatomic) NSArray *availableLocales;
- (void)_updateCurrentLocale;	// IMP=0x00100000000316fd
...
- (id)internetConfigurationSummary;	// IMP=0x0010000000031462
...
- (id)init;	// IMP=0x0010000000030e2f
