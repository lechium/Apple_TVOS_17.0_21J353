...
- (void).cxx_destruct;	// IMP=0x00200000000122d2
...
- (void)_menuButtonAction;	// IMP=0x0010000000012112
- (void)_playStereoVideo;	// IMP=0x001000000001204e
- (void)_playSpatialVideo;	// IMP=0x0010000000011f8a
- (void)_toggleMode:(id)arg1;	// IMP=0x0010000000011e3b
- (void)_setupAVPlayerForVideoNamed:(id)arg1 playerView:(id)arg2;	// IMP=0x0010000000011b42
- (void)willEnterForeground;	// IMP=0x0010000000011b20
- (void)didEnterBackground;	// IMP=0x0010000000011b01
- (void)viewDidLoad;	// IMP=0x00100000000106c9
- (void)dealloc;	// IMP=0x00100000000105fd
- (id)initWithBluetoothDevice:(id)arg1;	// IMP=0x00100000000104b8
