...
- (void).cxx_destruct;	// IMP=0x00200000000922fe
...
- (void)pairWithPasscode:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000009220d
- (void)unpairWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000092192
- (unsigned long long)hash;	// IMP=0x001000000009213a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000091f14
- (id)initWithEndpoint:(id)arg1;	// IMP=0x0010000000091e69
- (id)initWithDeviceRef:(void *)arg1;	// IMP=0x0010000000091dde
