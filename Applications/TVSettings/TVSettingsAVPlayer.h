...
+ (Class)layerClass;	// IMP=0x00400000000d82e4
- (void).cxx_destruct;	// IMP=0x00200000000d8fe1
...
- (void)_removeBoundaryTimeObservers;	// IMP=0x00100000000d8ed9
- (void)_addBoundaryTimeObservers;	// IMP=0x00100000000d877a
- (void)playInLoopWithRate:(float)arg1 crossfadeDuration:(double)arg2;	// IMP=0x00100000000d85bb
- (void)dealloc;	// IMP=0x00100000000d82f5
