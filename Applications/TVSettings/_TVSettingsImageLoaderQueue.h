...
- (void).cxx_destruct;	// IMP=0x002000000000c509
...
- (void)_checkForPreloadCompletion;	// IMP=0x001000000000c3e0
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x001000000000c2f3
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x001000000000c253
- (void)_loadPendingImages;	// IMP=0x001000000000be8b
- (id)_imageProxyToLoadNext;	// IMP=0x001000000000bddc
- (void)_fillQueue;	// IMP=0x001000000000bcf0
- (unsigned long long)_currentQueueSize;	// IMP=0x001000000000bc98
- (id)popNextImage;	// IMP=0x001000000000bbff
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000bbaf
- (void)dealloc;	// IMP=0x001000000000bac7
- (id)init;	// IMP=0x001000000000b9ea
