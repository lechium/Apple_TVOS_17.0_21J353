...
- (void).cxx_destruct;	// IMP=0x00200000000ad8a5
...
- (id)valueForPreferenceKey:(id)arg1;	// IMP=0x00100000000ad770
- (id)initWithDomain:(id)arg1 containerPath:(id)arg2;	// IMP=0x00100000000ad652
