...
+ (id)allowedSystemServices;	// IMP=0x00400000000845cb
- (void).cxx_destruct;	// IMP=0x0020000000084f7a
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x00100000000846a6
- (id)init;	// IMP=0x0010000000084690
