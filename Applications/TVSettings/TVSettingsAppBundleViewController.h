...
- (void).cxx_destruct;	// IMP=0x002000000001ba9f
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000001b985
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x001000000001b897
- (id)loadSettingGroups;	// IMP=0x0010000000019bdb
- (void)dealloc;	// IMP=0x0010000000019b4b
