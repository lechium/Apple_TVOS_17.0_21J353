...
+ (id)sharedInstance;	// IMP=0x00200000000681a9
- (void).cxx_destruct;	// IMP=0x0020000000068939
...
- (void)_clearLastKnownDeviceSyncState;	// IMP=0x00100000000688ad
- (void)iCloudAccountManager:(id)arg1 didModifyActiveAccount:(id)arg2;	// IMP=0x001000000006876b
- (void)clearAccountPrefsForAutoAppDownloads;	// IMP=0x001000000006874c
- (_Bool)isAutoAppDownloadsEnabledForAccountIdentifier:(id)arg1;	// IMP=0x0010000000068655
- (void)setAutoAppDownloadsEnabled:(_Bool)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000068513
- (id)init;	// IMP=0x00100000000681fe
