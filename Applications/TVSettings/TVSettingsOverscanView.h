...
- (void).cxx_destruct;	// IMP=0x00200000000a3058
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000000a2c42
- (void)layoutSubviews;	// IMP=0x00100000000a27f5
- (id)instructionText;	// IMP=0x00100000000a26a6
- (void)setInstructionText:(id)arg1;	// IMP=0x00100000000a266d
@property(copy, nonatomic) NSString *titleText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000a2270
