...
- (void).cxx_destruct;	// IMP=0x0020000000013692
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x00100000000133bb
- (void)_loadNextImage:(id)arg1;	// IMP=0x001000000001331d
- (void)_startTimer;	// IMP=0x0010000000013274
- (struct CGSize)_maximumImageSize;	// IMP=0x0010000000013215
- (void)layoutSubviews;	// IMP=0x0010000000012902
- (void)didMoveToSuperview;	// IMP=0x001000000001289f
- (void)dealloc;	// IMP=0x0010000000012856
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001276d
