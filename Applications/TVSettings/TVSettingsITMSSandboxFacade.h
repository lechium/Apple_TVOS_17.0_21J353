...
- (void).cxx_destruct;	// IMP=0x00200000000ff499
...
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x00100000000ff31c
- (void)signOut;	// IMP=0x00100000000ff0f1
- (void)signInSandboxAccountWithPresentingViewController:(id)arg1;	// IMP=0x00100000000fee88
- (void)updateSandboxAccountState;	// IMP=0x00100000000fede0
- (id)_getSandboxAccount;	// IMP=0x00100000000fed7f
- (void)dealloc;	// IMP=0x00100000000fed0a
- (id)init;	// IMP=0x00100000000fec69
