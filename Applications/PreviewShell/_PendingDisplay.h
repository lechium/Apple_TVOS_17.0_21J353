...
- (void).cxx_destruct;	// IMP=0x0020000000004dd1
...
- (_Bool)matches:(id)arg1;	// IMP=0x0010000000004cfb
- (void)cancelTimeoutTimer;	// IMP=0x0010000000004cc9
- (void)startTimeoutTimerWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004b99
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000004a1d
