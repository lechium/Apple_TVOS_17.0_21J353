...
- (void).cxx_destruct;	// IMP=0x002000000020b74a
...
- (void)_updateIconImage;	// IMP=0x001000000020b57a
- (void)_updateDisplayName;	// IMP=0x001000000020b4a1
- (void)_updateForProgressChange;	// IMP=0x001000000020b48e
- (id)description;	// IMP=0x001000000020b454
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x001000000020b1c3
