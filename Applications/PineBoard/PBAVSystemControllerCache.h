...
+ (id)sharedInstance;	// IMP=0x0040000000172378
- (void).cxx_destruct;	// IMP=0x0020000000173220
...
- (void)_callUpdateHandlerForNotificationName:(id)arg1 notification:(id)arg2;	// IMP=0x00100000001730fc
- (void)_updateAirplayDisplayActiveFromNotification:(id)arg1;	// IMP=0x0010000000172e65
- (void)_rebuildCache;	// IMP=0x0010000000172c6e
- (void)_initializeCache;	// IMP=0x0010000000172958
- (void)_handleSystemControllerMetadataDidChangeNotification:(id)arg1;	// IMP=0x00100000001726ab
- (void)_handleSystemControllerServerConnectionDied:(id)arg1;	// IMP=0x00100000001724ef
...
- (void)dealloc;	// IMP=0x0010000000172303
- (id)initWithDataProviderInitializer:(CDUnknownBlockType)arg1;	// IMP=0x0010000000172184
