...
- (void).cxx_destruct;	// IMP=0x002000000006f341
...
- (unsigned long long)hash;	// IMP=0x001000000006f1f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006eef3
- (id)description;	// IMP=0x001000000006edfe
- (id)initWithBluetoothDevice:(id)arg1;	// IMP=0x001000000006ece8
- (id)initWithPeripheral:(id)arg1;	// IMP=0x001000000006ebdc
