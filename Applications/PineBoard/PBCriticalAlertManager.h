...
+ (id)sharedInstance;	// IMP=0x002000000017674e
+ (id)dependencyDescription;	// IMP=0x0010000000176627
- (void).cxx_destruct;	// IMP=0x0020000000176c96
@property(readonly, nonatomic) PBSystemOverlayController *overlayController; // @synthesize overlayController=_overlayController;
- (void)dismissAlertWithContext:(id)arg1;	// IMP=0x0010000000176baf
- (void)presentAlertWithContext:(id)arg1;	// IMP=0x0010000000176970
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (id)init;	// IMP=0x00100000001767d5
