...
- (void).cxx_destruct;	// IMP=0x00200000001eb5ad
...
- (void)applicationSceneView:(id)arg1 didUpdateReadiness:(_Bool)arg2;	// IMP=0x00100000001eb4ea
- (void)applicationSceneViewDidUpdatePresentationMode:(id)arg1;	// IMP=0x00100000001eb4d7
- (void)applicationSceneView:(id)arg1 willLoadSnapshotWithRequest:(id)arg2;	// IMP=0x00100000001eb4b6
...
- (void)_updateDeferralTargetAssertionIfNeeded;	// IMP=0x00100000001eb1b5
- (id);	// IMP=0x00100000001eb129
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000001eb0e8
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long effectivePresentationMode;
@property(nonatomic) unsigned long long presentationMode;
- (void)setPresentationMode:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001eaee3
@property(readonly, nonatomic) PBApplicationSceneView *sceneView;
- (void)loadView;	// IMP=0x00100000001eadc0
- (void)dealloc;	// IMP=0x00100000001ead77
- (id)initWithSceneHandle:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x00100000001eacc6
