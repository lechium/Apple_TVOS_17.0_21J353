...
- (void).cxx_destruct;	// IMP=0x0020000000177789
...
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x0010000000176fa9
- (void)invalidate;	// IMP=0x0010000000176f27
- (void)activate;	// IMP=0x0010000000176dc8
- (void)dealloc;	// IMP=0x0010000000176d17
- (id)init;	// IMP=0x0010000000176cba
