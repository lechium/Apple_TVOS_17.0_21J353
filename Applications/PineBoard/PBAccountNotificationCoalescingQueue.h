...
- (void).cxx_destruct;	// IMP=0x0020000000072c8b
...
- (void)_keepNotification:(id)arg1 forAccountIdentifier:(id)arg2 removingNotification:(id)arg3;	// IMP=0x0010000000072bd6
- (id)coalescedNotifications;	// IMP=0x0010000000072773
- (void)addNotification:(id)arg1;	// IMP=0x00100000000723f7
- (id)init;	// IMP=0x001000000007236b
