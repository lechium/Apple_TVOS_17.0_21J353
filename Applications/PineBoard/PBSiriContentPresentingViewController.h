...
- (void).cxx_destruct;	// IMP=0x0020000000071cb5
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000071a12
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000071715
...
- (id)initWithSiriViewController:(id)arg1;	// IMP=0x0010000000071697
