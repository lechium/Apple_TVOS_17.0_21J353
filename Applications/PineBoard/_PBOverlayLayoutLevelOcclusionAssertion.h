...
- (void).cxx_destruct;	// IMP=0x00200000000c3368
...
- (id)stateDumpBuilder;	// IMP=0x00100000000c32be
@property(readonly, copy) NSString *description;
- (void)invalidateWithTransitionContext:(id)arg1;	// IMP=0x00100000000c317b
- (void)invalidate;	// IMP=0x00100000000c3166
- (void)dealloc;	// IMP=0x00100000000c3082
- (id)initWithController:(id)arg1 layoutLevel:(long long)arg2 reason:(id)arg3;	// IMP=0x00100000000c2fc7
