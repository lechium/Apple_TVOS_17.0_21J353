...
- (void).cxx_destruct;	// IMP=0x0020000000186422
...
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001863d7
- (void)_begin;	// IMP=0x001000000018615c
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000018606d
