...
- (void).cxx_destruct;	// IMP=0x00200000000cb419
...
- (void)cancel;	// IMP=0x00100000000cb2ed
- (void)main;	// IMP=0x00100000000cab7d
- (id)initWithSnapshot:(id)arg1 dataProvider:(id)arg2 manifest:(id)arg3;	// IMP=0x00100000000caa6d
