...
- (void).cxx_destruct;	// IMP=0x00200000000aa886
...
- (void)_postLargeGameInstalledBulletinWithAppInfo:(id)arg1;	// IMP=0x00100000000aa1ce
- (double)_largeGameInstallTimeThreshold;	// IMP=0x00100000000aa15f
- (void)_handleGameAppInfoControllerUpdate:(id)arg1;	// IMP=0x00100000000a978c
@property(readonly, nonatomic) PBBulletinService *bulletinService; // @synthesize bulletinService=_bulletinService;
- (void)_activate;	// IMP=0x00100000000a95d6
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x00100000000a93e7
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x00100000000a9311
- (void)activate;	// IMP=0x00100000000a9289
- (id)init;	// IMP=0x00100000000a9212
