...
- (void).cxx_destruct;	// IMP=0x0020000000024bcf
...
- (id)nextObject;	// IMP=0x0010000000024b0a
- (id)initWithRecipeProvider:(CDUnknownBlockType)arg1 typeEnumerator:(id)arg2;	// IMP=0x0010000000024a5c
