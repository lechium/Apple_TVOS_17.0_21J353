...
+ (id)insertUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x0040000000055556
+ (id)deleteUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x00100000000554df
- (void).cxx_destruct;	// IMP=0x00200000000555f2
...
- (id)initWithType:(long long)arg1 item:(id)arg2 fromIndexPath:(id)arg3 toIndexPath:(id)arg4;	// IMP=0x00100000000553f7
