...
- (void).cxx_destruct;	// IMP=0x0020000000134768
...
- (void)invalidateImage;	// IMP=0x00100000001346fe
- (id)fetchImage;	// IMP=0x001000000013432a
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x00100000001341ad
- (id)init;	// IMP=0x001000000013419f
