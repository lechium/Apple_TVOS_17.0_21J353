...
- (void).cxx_destruct;	// IMP=0x002000000021ce4a
...
- (void)_didComplete;	// IMP=0x001000000021cbba
- (void)_begin;	// IMP=0x001000000021c9a8
- (_Bool)_canBeInterrupted;	// IMP=0x001000000021c9a0
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x001000000021c998
- (_Bool)_animateDestinationViewInFront;	// IMP=0x001000000021c8e8
- (id)initWithRequest:(id)arg1 transitionType:(long long)arg2;	// IMP=0x001000000021c240
