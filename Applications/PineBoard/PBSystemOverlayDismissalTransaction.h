...
- (void).cxx_destruct;	// IMP=0x00200000002272f3
...
- (void)_begin;	// IMP=0x0010000000227012
- (_Bool)_canBeInterrupted;	// IMP=0x001000000022700a
- (id)initWithPresentationDelegate:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x0010000000226f91
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x0010000000226ea3
- (id)init;	// IMP=0x0010000000226e95
