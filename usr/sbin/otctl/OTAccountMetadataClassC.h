...
+ (Class)tlkSharesForVouchedIdentityType;	// IMP=0x0020000000012445
- (void).cxx_destruct;	// IMP=0x00200000000123bf
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000011f42
- (unsigned long long)hash;	// IMP=0x0010000000011d2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000119e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000115bf
- (void)copyTo:(id)arg1;	// IMP=0x0010000000011328
- (void)writeTo:(id)arg1;	// IMP=0x0010000000010ffc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000010882
- (id)dictionaryRepresentation;	// IMP=0x00100000000103a4
- (id)description;	// IMP=0x00100000000102f5
...
- (id)tlkSharesForVouchedIdentityAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000101de
- (unsigned long long)tlkSharesForVouchedIdentitysCount;	// IMP=0x00100000000101c1
- (void)addTlkSharesForVouchedIdentity:(id)arg1;	// IMP=0x0010000000010157
- (void)clearTlkSharesForVouchedIdentitys;	// IMP=0x001000000001013a
...
- (int)StringAsCdpState:(id)arg1;	// IMP=0x0010000000010064
- (id)cdpStateAsString:(int)arg1;	// IMP=0x001000000001001c
@property(nonatomic) _Bool hasCdpState;
@property(nonatomic) int cdpState; // @synthesize cdpState=_cdpState;
- (int)StringAsAttemptedJoin:(id)arg1;	// IMP=0x001000000000ff1c
- (id)attemptedJoinAsString:(int)arg1;	// IMP=0x001000000000fed4
...
- (int)StringAsTrustState:(id)arg1;	// IMP=0x001000000000fd8a
- (id)trustStateAsString:(int)arg1;	// IMP=0x001000000000fd42
...
- (int)StringAsIcloudAccountState:(id)arg1;	// IMP=0x001000000000fbc7
- (id)icloudAccountStateAsString:(int)arg1;	// IMP=0x001000000000fb7f
