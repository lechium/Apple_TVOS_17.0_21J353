...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000029ce9
- (void).cxx_destruct;	// IMP=0x0020000000029f19
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000029dc8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000029cf1
- (id)proto;	// IMP=0x0010000000029c5d
- (id)initWithProto:(id)arg1;	// IMP=0x0010000000029ae8
- (id)initWithEventData:(id)arg1 dataVersion:(unsigned int)arg2 dataTimestamp:(double)arg3;	// IMP=0x0010000000029a61
