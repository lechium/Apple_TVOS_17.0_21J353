...
- (void).cxx_destruct;	// IMP=0x0020000000046ac5
...
- (id)description;	// IMP=0x00100000000469dc
- (void)reset;	// IMP=0x00100000000469ba
- (void)close;	// IMP=0x0010000000046990
- (void)dealloc;	// IMP=0x0010000000046952
