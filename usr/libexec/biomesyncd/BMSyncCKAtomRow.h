...
- (void).cxx_destruct;	// IMP=0x001000000001f903
...
- (id)description;	// IMP=0x001000000001f77f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001f774
- (unsigned long long)hash;	// IMP=0x001000000001f735
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001f6a0
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 valueVersion:(long long)arg6 valueData:(id)arg7;	// IMP=0x001000000001f498
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 segmentName:(id)arg6 segmentOffset:(unsigned long long)arg7;	// IMP=0x001000000001f290
- (id)initWithFMResultSet:(id)arg1;	// IMP=0x001000000001f957
