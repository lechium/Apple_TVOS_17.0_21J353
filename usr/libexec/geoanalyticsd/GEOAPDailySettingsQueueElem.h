...
- (void).cxx_destruct;	// IMP=0x0020000000014ef5
@property(readonly, nonatomic) GEOLogMsgEventPeriodicSettingsSummary *settings; // @synthesize settings=_settings;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000014da4
- (unsigned long long)hash;	// IMP=0x0010000000014d18
- (id)copy;	// IMP=0x0010000000014cde
- (id)initWithSettings:(id)arg1 createTime:(id)arg2;	// IMP=0x0010000000014c42
