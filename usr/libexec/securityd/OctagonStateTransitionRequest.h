...
- (void).cxx_destruct;	// IMP=0x00200000001a7249
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000001a70ef
- (id)_onqueueStart;	// IMP=0x00100000001a706a
- (id)description;	// IMP=0x00100000001a6fa0
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x00100000001a6e9d
