...
- (void).cxx_destruct;	// IMP=0x00200000001c4bad
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c4ad0
- (unsigned long long)hash;	// IMP=0x00100000001c4a59
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c4967
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c48a9
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c4826
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c47a2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c4795
- (id)dictionaryRepresentation;	// IMP=0x00100000001c46ac
- (id)description;	// IMP=0x00100000001c45fd
