...
+ (id)trust;	// IMP=0x004000000020f0fc
- (void).cxx_destruct;	// IMP=0x002000000020f0c9
...
- (void)dealloc;	// IMP=0x001000000020eea2
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x001000000020edc3
- (id)init;	// IMP=0x001000000020ecd8
