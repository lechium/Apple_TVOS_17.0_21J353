...
- (void).cxx_destruct;	// IMP=0x002000000012eb38
...
- (void)setContainer:(id)arg1;	// IMP=0x001000000012e9da
- (id)container;	// IMP=0x001000000012e9d0
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x001000000012dcb9
- (void)fetchRampRecordWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000012da02
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x001000000012d821
