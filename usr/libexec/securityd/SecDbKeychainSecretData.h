...
- (void).cxx_destruct;	// IMP=0x00200000001088e4
...
- (id)initWithData:(id)arg1;	// IMP=0x00100000001085f8
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x0010000000108409
