...
- (void).cxx_destruct;	// IMP=0x002000000016f2c0
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x001000000016e13e
- (void)groupStart;	// IMP=0x001000000016df93
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000016dec9
