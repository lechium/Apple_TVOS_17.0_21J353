...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000c331c
- (void).cxx_destruct;	// IMP=0x00200000000c32f4
...
- (id)asPathStep;	// IMP=0x00100000000c31bb
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000c3122
