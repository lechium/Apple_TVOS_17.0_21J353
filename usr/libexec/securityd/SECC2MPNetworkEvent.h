...
- (void).cxx_destruct;	// IMP=0x00200000001ae79c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001adeef
- (unsigned long long)hash;	// IMP=0x00100000001ad8c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001ad08b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001acabc
- (void)copyTo:(id)arg1;	// IMP=0x00100000001ac5ae
- (void)writeTo:(id)arg1;	// IMP=0x00100000001ac065
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001ac058
- (id)dictionaryRepresentation;	// IMP=0x00100000001ab3e1
- (id)description;	// IMP=0x00100000001ab332
