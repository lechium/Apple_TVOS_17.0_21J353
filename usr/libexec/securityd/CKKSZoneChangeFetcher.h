...
- (void).cxx_destruct;	// IMP=0x00200000001c6c9f
...
- (void)halt;	// IMP=0x00100000001c6896
- (void)cancel;	// IMP=0x00100000001c6859
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001c6847
- (id)createSuccesfulFetchDependency;	// IMP=0x00100000001c67dc
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001c604a
- (void)maybeCreateNewFetch;	// IMP=0x00100000001c5fd9
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001c5de2
- (id)inflightFetch;	// IMP=0x00100000001c5ce7
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001c5ba8
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001c57ff
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001c5724
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001c56be
- (id)strongClientMap;	// IMP=0x00100000001c5439
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001c536d
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x00100000001c4ee5
