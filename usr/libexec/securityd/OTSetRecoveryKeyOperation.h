...
- (void).cxx_destruct;	// IMP=0x00200000000aaeaa
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000aac12
- (void)groupStart;	// IMP=0x00100000000aa843
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000aa7a1
