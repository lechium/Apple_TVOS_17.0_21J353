...
- (void).cxx_destruct;	// IMP=0x0020000000081ce7
...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2 version:(id)arg3;	// IMP=0x00100000000819af
- (void)groupStart;	// IMP=0x00100000000814df
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 authenticationErrorState:(id)arg4 errorState:(id)arg5 retryFlag:(id)arg6;	// IMP=0x0010000000081397
