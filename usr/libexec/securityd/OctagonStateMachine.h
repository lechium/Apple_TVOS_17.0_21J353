...
- (void).cxx_destruct;	// IMP=0x0020000000116647
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 transitionOp:(id)arg4 reply:(CDUnknownBlockType)arg5;	// IMP=0x0010000000115ee4
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000115d95
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x0010000000115d83
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00100000001159de
- (void)_onqueueRegisterMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00100000001158ad
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00100000001157f4
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x001000000011573b
- (void)handleExternalRequest:(id)arg1;	// IMP=0x0010000000115682
- (void)haltOperation;	// IMP=0x00100000001155d6
- (void)startOperation;	// IMP=0x0010000000115565
- (_Bool)isPaused;	// IMP=0x001000000011549a
- (void)testReleaseStateMachinePause:(id)arg1;	// IMP=0x00100000001153e1
- (void)testPauseStateMachineAfterEntering:(id)arg1;	// IMP=0x0010000000115328
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x0010000000114a0f
- (void)_onqueueRecheckConditions;	// IMP=0x00100000001140e1
- (id)possiblePendingFlags;	// IMP=0x0010000000114091
- (id)dumpPendingFlags;	// IMP=0x0010000000113f66
- (void)disablePendingFlags;	// IMP=0x0010000000113ef5
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x0010000000113cc3
- (void)_onqueueHandlePendingFlagLater:(id)arg1;	// IMP=0x0010000000113be2
- (void)handlePendingFlag:(id)arg1;	// IMP=0x0010000000113b29
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x0010000000113a84
- (void)handleFlag:(id)arg1;	// IMP=0x00100000001139cb
- (void)_onqueuePokeStateMachine;	// IMP=0x0010000000113976
- (void)pokeStateMachine;	// IMP=0x0010000000113905
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x001000000011379c
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x00100000001132a5
- (id)_onqueueNextStateMachineTransition;	// IMP=0x0010000000112e43
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x0010000000112d87
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x0010000000112a4c
- (id)pendingFlagsString;	// IMP=0x00100000001129cb
@property(readonly) NSDictionary *stateConditions;
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8;	// IMP=0x001000000011234e
