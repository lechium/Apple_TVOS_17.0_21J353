...
- (void).cxx_destruct;	// IMP=0x00200000001083f9
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000010804a
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x0010000000107e47
