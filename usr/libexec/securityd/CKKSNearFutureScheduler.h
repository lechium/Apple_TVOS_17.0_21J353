...
- (void).cxx_destruct;	// IMP=0x00200000000a8070
...
- (void)cancel;	// IMP=0x00100000000a7e36
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000a7881
- (void)trigger;	// IMP=0x00100000000a77bc
- (void)_onqueueTimerTick;	// IMP=0x00100000000a7475
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000a73a5
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000a7329
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000a7158
- (id)makeOperationDependency;	// IMP=0x00100000000a7089
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000a7002
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 qosClass:(unsigned int)arg7 block:(CDUnknownBlockType)arg8;	// IMP=0x00100000000a6e18
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000a6df5
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000a6d9a
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000a6d76
