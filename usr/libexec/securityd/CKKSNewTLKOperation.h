...
- (void).cxx_destruct;	// IMP=0x002000000016af88
...
- (void)cancel;	// IMP=0x001000000016ae96
- (void)groupStart;	// IMP=0x001000000016a8e3
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x001000000016a5b1
- (id)init;	// IMP=0x001000000016a5a3
