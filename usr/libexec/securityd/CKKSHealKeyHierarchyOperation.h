...
- (void).cxx_destruct;	// IMP=0x002000000008dfd2
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x001000000008d9a1
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x001000000008d83b
- (void)groupStart;	// IMP=0x001000000008d35e
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x001000000008d245
- (id)init;	// IMP=0x001000000008d237
