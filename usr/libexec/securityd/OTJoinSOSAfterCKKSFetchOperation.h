...
- (void).cxx_destruct;	// IMP=0x002000000007b97d
...
- (void)proceedAfterFetch;	// IMP=0x001000000007b423
- (void)groupStart;	// IMP=0x001000000007b128
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000007b05e
