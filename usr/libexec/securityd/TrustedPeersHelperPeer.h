...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001be025
- (void).cxx_destruct;	// IMP=0x00200000001bdfdc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bdde1
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bdbda
- (id)description;	// IMP=0x00100000001bda71
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x00100000001bd96a
