...
- (void).cxx_destruct;	// IMP=0x0020000000196ccd
...
- (void)setStorage:(id)arg1;	// IMP=0x0010000000196b39
- (id)storage;	// IMP=0x0010000000196ad6
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x0010000000196952
