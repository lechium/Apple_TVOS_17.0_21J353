...
- (void).cxx_destruct;	// IMP=0x00200000000ede9a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000edc97
- (void)dealloc;	// IMP=0x00100000000edba1
- (void)setCallback:(CDUnknownBlockType)arg1;	// IMP=0x00100000000edaf5
- (void)callCallback:(_Bool)arg1;	// IMP=0x00100000000edaab
- (id)initWithEngine:(struct __OpaqueSOSEngine *)arg1 peer:(struct __OpaqueSOSPeer *)arg2 localManifest:(struct __OpaqueSOSManifest *)arg3 proposedManifest:(struct __OpaqueSOSManifest *)arg4 confirmedManifest:(struct __OpaqueSOSManifest *)arg5 andMessage:(struct __OpaqueSOSMessage *)arg6;	// IMP=0x00100000000ed980
