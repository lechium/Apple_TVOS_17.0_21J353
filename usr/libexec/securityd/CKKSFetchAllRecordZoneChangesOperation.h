...
- (void).cxx_destruct;	// IMP=0x00200000000c0b6c
...
- (void)cancel;	// IMP=0x00100000000c0832
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c0419
- (void)performFetch;	// IMP=0x00100000000bf70b
- (void)groupStart;	// IMP=0x00100000000bf501
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000bef8d
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000bed32
- (id)init;	// IMP=0x00100000000bed24
