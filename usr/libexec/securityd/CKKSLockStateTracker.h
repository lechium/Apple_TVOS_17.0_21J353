...
+ (id)globalTracker;	// IMP=0x0040000000171188
- (void).cxx_destruct;	// IMP=0x0020000000170e29
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x0010000000170c79
- (_Bool)isLockedError:(id)arg1;	// IMP=0x0010000000170bec
- (_Bool)checkErrorChainForLockState:(id)arg1;	// IMP=0x0010000000170b16
- (_Bool)lockedError:(id)arg1;	// IMP=0x0010000000170a47
- (void)recheck;	// IMP=0x00100000001709d6
- (void)_onqueueRecheck;	// IMP=0x001000000017069c
- (void)resetUnlockDependency;	// IMP=0x00100000001705af
- (id)description;	// IMP=0x001000000017050a
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x0010000000170343
- (id)initWithProvider:(id)arg1;	// IMP=0x0010000000170132
