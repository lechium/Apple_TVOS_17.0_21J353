...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x004000000010c0e6
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x001000000010bfb3
- (void).cxx_destruct;	// IMP=0x002000000010bbbe
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x001000000010bae2
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x001000000010ba68
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x001000000010b9ae
- (void)_onQueueResetReachabilityDependency;	// IMP=0x001000000010b684
- (void)_onQueueRunReachabilityDependency;	// IMP=0x001000000010b546
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x001000000010b42b
- (id)init;	// IMP=0x001000000010b202
