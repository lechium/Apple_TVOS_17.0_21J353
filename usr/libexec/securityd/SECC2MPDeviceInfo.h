...
+ (Class)internalTestConfigType;	// IMP=0x00200000001c41e4
- (void).cxx_destruct;	// IMP=0x00200000001c3d8b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c39b8
- (unsigned long long)hash;	// IMP=0x00100000001c3885
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c3659
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c332f
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c314b
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c2f07
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c2efa
- (id)dictionaryRepresentation;	// IMP=0x00100000001c2b3a
- (id)description;	// IMP=0x00100000001c2a8b
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001c2a6e
- (unsigned long long)internalTestConfigsCount;	// IMP=0x00100000001c2a51
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x00100000001c29e7
- (void)clearInternalTestConfigs;	// IMP=0x00100000001c29ca
