...
@class NSData, NSOperation, NSString, OTDeviceInformation, OTInheritanceKey, OTOperationDependencies, TPPolicyVersion, TrustedPeersHelperCustodianRecoveryKey;
...
@interface OTPrepareAndRecoverTLKSharesForInheritancePeerOperation
{
    ...
    OTInheritanceKey *_ik;	// 104 = 0x68
    NSString *_salt;	// 112 = 0x70
    NSOperation *_finishOp;	// 120 = 0x78
    TrustedPeersHelperCustodianRecoveryKey *_tphcrk;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x00200000000eca5d
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000ec677
- (void)groupStart;	// IMP=0x00100000000ebea5
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 ik:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6 isInheritedAccount:(_Bool)arg7 epoch:(unsigned long long)arg8;	// IMP=0x00100000000ebd20
