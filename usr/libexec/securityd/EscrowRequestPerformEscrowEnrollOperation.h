...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00200000000b54a3
- (void).cxx_destruct;	// IMP=0x00200000000b4f4f
...
- (void)groupStart;	// IMP=0x00100000000b4601
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00100000000b446e
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00100000000b4393
