...
- (void).cxx_destruct;	// IMP=0x00200000000b4241
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b410f
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x00100000000b402f
- (void)setFromCKRecord:(id)arg1;	// IMP=0x00100000000b3f4f
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000000b3e62
- (id)CKRecordName;	// IMP=0x00100000000b3d91
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x00100000000b3c09
...
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 contextID:(id)arg3 zoneID:(id)arg4;	// IMP=0x00100000000b361f
- (id)initWithCKRecord:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000b351e
