...
- (void).cxx_destruct;	// IMP=0x00200000001cbeb2
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x00100000001cbde6
- (void)fulfill;	// IMP=0x00100000001cbd63
- (id)initToChain:(id)arg1;	// IMP=0x00100000001cbce3
- (id)init;	// IMP=0x00100000001cbccf
