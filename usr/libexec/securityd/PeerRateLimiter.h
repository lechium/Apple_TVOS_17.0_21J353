...
- (void).cxx_destruct;	// IMP=0x0020000000229d13
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x0010000000229b73
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x0010000000229a72
- (id)setUpConfigForPeer;	// IMP=0x00100000002299f7
