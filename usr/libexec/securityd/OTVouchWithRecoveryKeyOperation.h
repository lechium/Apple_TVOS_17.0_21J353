...
- (void).cxx_destruct;	// IMP=0x00200000000c9c05
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000c98f4
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000c9787
- (void)groupStart;	// IMP=0x00100000000c936f
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000c925f
