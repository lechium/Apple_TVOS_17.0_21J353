...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x00200000001d4794
- (void).cxx_destruct;	// IMP=0x00200000001d4752
...
- (void)main;	// IMP=0x00100000001d3e14
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x00100000001d3d4a
