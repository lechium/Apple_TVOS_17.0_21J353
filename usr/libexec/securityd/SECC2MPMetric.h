...
- (void).cxx_destruct;	// IMP=0x00200000000a47f4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000a4559
- (unsigned long long)hash;	// IMP=0x00100000000a4416
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a4225
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a4084
- (void);	// IMP=0x00100000000a3f43
- (void)writeTo:(id)arg1;	// IMP=0x00100000000a3e00
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000a3871
- (id)dictionaryRepresentation;	// IMP=0x00100000000a3516
- (id)description;	// IMP=0x00100000000a3467
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000a3284
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000a3218
