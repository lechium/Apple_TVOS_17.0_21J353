...
- (void).cxx_destruct;	// IMP=0x002000000003b994
...
- (id)peerID;	// IMP=0x001000000003b93a
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x001000000003b897
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x001000000003b633
