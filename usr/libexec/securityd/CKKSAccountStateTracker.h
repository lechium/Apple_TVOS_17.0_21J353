...
@interface CKKSAccountStateTracker : NSObject
{
    ...
    MISSING_TYPE *_accountCirclePeerID;	// 96 = 0x60
...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x0020000000038dfd
+ (id)getCircleStatus;	// IMP=0x0010000000038cdb
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038c3c
- (void).cxx_destruct;	// IMP=0x00200000000369b3
...
- (void)setCDPCapableiCloudAccountStatus:(long long)arg1;	// IMP=0x001000000003663a
- (void)triggerOctagonStatusFetch;	// IMP=0x001000000003643e
- (id)checkForAllDeliveries;	// IMP=0x001000000003631c
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x00100000000362de
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x00100000000362c5
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x0010000000036276
- (void)recheckCKAccountStatus;	// IMP=0x00100000000361ca
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0010000000036082
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0010000000035ed2
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0010000000035aa9
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x001000000003591d
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0010000000035733
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0010000000035638
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x00100000000354b3
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x00100000000351fd
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0010000000035114
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x0010000000034f78
- (void)dealloc;	// IMP=0x0010000000034efd
- (void)performInitialDispatches;	// IMP=0x0010000000034e73
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x00100000000349d0
