...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000a28c1
- (void).cxx_destruct;	// IMP=0x00200000000a2841
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000a24a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a21b6
- (id)description;	// IMP=0x00100000000a1f2d
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000a1e94
