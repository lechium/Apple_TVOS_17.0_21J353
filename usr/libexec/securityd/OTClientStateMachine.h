...
- (void).cxx_destruct;	// IMP=0x00200000001c05c9
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x00100000001c00fb
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001bfdfe
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x00100000001bf91a
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x00100000001bf880
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x00100000001bf7a1
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x00100000001bf58a
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x00100000001bf4ec
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x00100000001bf369
- (void)startOctagonStateMachine;	// IMP=0x00100000001bf2f8
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x00100000001bf18f
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x00100000001bee77
