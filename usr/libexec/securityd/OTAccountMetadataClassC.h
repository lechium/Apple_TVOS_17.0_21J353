...
+ (Class)tlkSharesForVouchedIdentityType;	// IMP=0x002000000002a629
+ (id)loadFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x001000000009ef6c
+ (_Bool)deleteFromKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x001000000009ed11
- (void).cxx_destruct;	// IMP=0x002000000002a5a3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000002a126
- (unsigned long long)hash;	// IMP=0x0010000000029f10
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029bca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000297a3
- (void)copyTo:(id)arg1;	// IMP=0x001000000002950c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000291e0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000028a67
- (id)dictionaryRepresentation;	// IMP=0x0010000000028589
- (id)description;	// IMP=0x00100000000284da
...
- (id)tlkSharesForVouchedIdentityAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000283c3
- (unsigned long long)tlkSharesForVouchedIdentitysCount;	// IMP=0x00100000000283a6
- (void)addTlkSharesForVouchedIdentity:(id)arg1;	// IMP=0x001000000002833c
- (void)clearTlkSharesForVouchedIdentitys;	// IMP=0x001000000002831f
...
- (int)StringAsCdpState:(id)arg1;	// IMP=0x0010000000028249
- (id)cdpStateAsString:(int)arg1;	// IMP=0x0010000000028201
@property(nonatomic) _Bool hasCdpState;
@property(nonatomic) int cdpState; // @synthesize cdpState=_cdpState;
- (int)StringAsAttemptedJoin:(id)arg1;	// IMP=0x0010000000028101
- (id)attemptedJoinAsString:(int)arg1;	// IMP=0x00100000000280b9
...
- (int)StringAsTrustState:(id)arg1;	// IMP=0x0010000000027f6f
- (id)trustStateAsString:(int)arg1;	// IMP=0x0010000000027f27
...
- (int)StringAsIcloudAccountState:(id)arg1;	// IMP=0x0010000000027dac
- (id)icloudAccountStateAsString:(int)arg1;	// IMP=0x0010000000027d64
...
- (id)parsedSecureElementIdentity;	// IMP=0x001000000009e5cf
- (void)setOctagonSecureElementIdentity:(id)arg1;	// IMP=0x001000000009e4ee
- (id)getTLKSharesPairedWithVoucher;	// IMP=0x001000000009e2d5
- (void)setTLKSharesPairedWithVoucher:(id)arg1;	// IMP=0x001000000009e09a
- (id)getTPSyncingPolicy;	// IMP=0x001000000009dffa
- (void)setTPSyncingPolicy:(id)arg1;	// IMP=0x001000000009df3a
- (_Bool)saveToKeychainForContainer:(id)arg1 contextID:(id)arg2 personaAdapter:(id)arg3 personaUniqueString:(id)arg4 error:(id *)arg5;	// IMP=0x001000000009dd9e
