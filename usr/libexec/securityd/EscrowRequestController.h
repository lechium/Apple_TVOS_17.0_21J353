...
- (void).cxx_destruct;	// IMP=0x0020000000034067
...
- (void)storePrerecordsInEscrowRPC:(CDUnknownBlockType)arg1;	// IMP=0x0010000000033e3f
- (void)triggerEscrowUpdateRPC:(id)arg1 options:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x001000000003341c
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x00100000000329bb
- (id)initWithLockStateTracker:(id)arg1;	// IMP=0x00100000000327a0
