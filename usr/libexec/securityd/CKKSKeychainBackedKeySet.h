...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bca23
- (void).cxx_destruct;	// IMP=0x00200000001bc9f0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bc84b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bc743
- (id)description;	// IMP=0x00100000001bc66b
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x00100000001bc5a6
