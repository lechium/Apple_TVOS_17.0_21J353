...
- (_Bool)_shouldSendSampleEventWithTimestamp:(double)arg1 samplingInterval:(double)arg2;	// IMP=0x001000000004b64a
- (_Bool)_passesThresholdForX:(float)arg1 y:(float)arg2 z:(float)arg3;	// IMP=0x001000000004b5c9
- (void)_queue_invalidate;	// IMP=0x001000000004b59a
- (void)handleOrientationEvent:(long long)arg1 orientationLocked:(_Bool)arg2;	// IMP=0x001000000004b594
- (void)handleAccelerometerEventWithTimestamp:(double)arg1 x:(float)arg2 y:(float)arg3 z:(float)arg4 samplingInterval:(double)arg5;	// IMP=0x001000000004b58e
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000004b4a4
