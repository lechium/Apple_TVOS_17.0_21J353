...
+ (id)sharedInstance;	// IMP=0x00400000000426e6
- (void).cxx_destruct;	// IMP=0x002000000004202d
@property(getter=isSecureModeEnabled) _Bool secureModeEnabled; // @synthesize secureModeEnabled=_secureModeEnabled;
- (void)reportAndKillInsecureProcesses;	// IMP=0x0010000000041b63
- (void)startMonitoringSecureDrawing;	// IMP=0x0010000000041b10
- (id)init;	// IMP=0x0010000000041a5b
