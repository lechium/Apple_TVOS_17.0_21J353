...
- (void).cxx_destruct;	// IMP=0x00200000000769d2
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x0010000000076784
- (void)activate;	// IMP=0x001000000007676e
- (id)initWithSentinel:(id)arg1;	// IMP=0x001000000007660d
