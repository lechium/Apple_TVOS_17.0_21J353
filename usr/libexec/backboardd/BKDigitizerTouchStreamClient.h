...
- (void).cxx_destruct;	// IMP=0x002000000006aa32
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000006a9d9
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x001000000006a831
- (id)init;	// IMP=0x001000000006a7e1
