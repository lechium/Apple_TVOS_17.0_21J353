...
+ (id)statisticWithLabel:(id)arg1;	// IMP=0x002000000004bd53
- (void).cxx_destruct;	// IMP=0x002000000004bcfa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004bc5a
- (void)reset;	// IMP=0x001000000004bb25
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000004ba1d
