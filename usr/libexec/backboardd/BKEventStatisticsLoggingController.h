...
+ (id)workQueue;	// IMP=0x002000000004d856
- (void).cxx_destruct;	// IMP=0x002000000004d193
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x001000000004d12f
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x001000000004d0a2
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x001000000004d08c
- (void)dealloc;	// IMP=0x001000000004cf03
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x001000000004cd3d
