...
@interface BKDirectTouchPerDisplayInfo : NSObject
{
    ...
    NSMutableDictionary *_cachedServiceProperties;	// 40 = 0x28
    NSMutableDictionary *_serviceToDigitizer;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x0020000000001dc0
@property(retain, nonatomic) NSMutableDictionary *serviceToDigitizer; // @synthesize serviceToDigitizer=_serviceToDigitizer;
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000001cda
- (void)dealloc;	// IMP=0x0010000000001ca0
