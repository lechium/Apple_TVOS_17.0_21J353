...
- (void).cxx_destruct;	// IMP=0x00200000000232a4
...
- (_Bool)isAlive;	// IMP=0x0010000000023258
- (void)registerClientsForMonitoring;	// IMP=0x0010000000023242
- (id)init;	// IMP=0x00100000000231a5
