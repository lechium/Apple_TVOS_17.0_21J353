...
+ (id)sharedInstance;	// IMP=0x002000000002a080
- (void).cxx_destruct;	// IMP=0x0020000000029f70
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x0010000000029c97
- (void)systemShellWillBootstrap;	// IMP=0x0010000000029c0c
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x0010000000029bc1
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000029b34
- (void)addObserver:(id)arg1;	// IMP=0x0010000000029aa7
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
@property(readonly, copy) NSString *description;
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x0010000000029821
