...
- (void).cxx_destruct;	// IMP=0x00200000000689d8
- (void)serviceDidDisappear:(id)arg1;	// IMP=0x0010000000068968
- (void)matcher:(id)arg1 servicesDidMatch:(id)arg2;	// IMP=0x00100000000688d0
- (void)dealloc;	// IMP=0x001000000006883d
- (id)_initWithDeviceOrientationManager:(id)arg1;	// IMP=0x001000000006855d
- (id)init;	// IMP=0x001000000006851d
