...
- (void).cxx_destruct;	// IMP=0x0020000000019e54
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0010000000019c75
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0010000000019bc5
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0010000000019b46
