...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x002000000006fbe9
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x001000000006fb4f
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x001000000006faba
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x001000000006fa32
+ (id)controlledBySupernode;	// IMP=0x001000000006fa02
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000006f882
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006f844
