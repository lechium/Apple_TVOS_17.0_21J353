...
+ (_Bool)isSmartCoverSupported;	// IMP=0x0020000000055679
- (void).cxx_destruct;	// IMP=0x0020000000055416
...
- (void)setDisengagedSensors:(unsigned long long)arg1;	// IMP=0x00100000000553ac
- (unsigned long long)disengagedSensors;	// IMP=0x00100000000553a2
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000005519c
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x00100000000550dc
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000054979
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x00100000000548ef
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x00100000000548ba
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000054670
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x001000000005453d
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x001000000005421b
