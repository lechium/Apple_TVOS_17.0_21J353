...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000023a92
+ (id)classesRequiredToDecode;	// IMP=0x0010000000023a0c
- (void).cxx_destruct;	// IMP=0x00200000000239e4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000023842
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000236da
- (void)dealloc;	// IMP=0x0010000000023650
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x001000000002355d
