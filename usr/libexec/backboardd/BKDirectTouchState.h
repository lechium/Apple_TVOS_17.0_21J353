...
@interface BKDirectTouchState : NSObject
{
    ...
    float _maxForce;	// 192 = 0xc0
    _Bool _determinedMaxForce;	// 196 = 0xc4
    _Bool _supportsPreciseLocations;	// 197 = 0xc5
    _Bool _displayIntegrated;	// 198 = 0xc6
    _Bool _builtIn;	// 199 = 0xc7
    _Bool _waitingForAllTouchesUp;	// 200 = 0xc8
}

- (void).cxx_destruct;	// IMP=0x0020000000055a34
- (void)invalidate;	// IMP=0x0010000000055925
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x00100000000558c4
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00100000000556bc
