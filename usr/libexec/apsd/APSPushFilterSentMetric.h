...
- (void).cxx_destruct;	// IMP=0x00200000000218d2
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 reason:(unsigned int)arg4;	// IMP=0x0010000000021661
