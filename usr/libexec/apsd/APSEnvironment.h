...
+ (void)_saveCachedProperties;	// IMP=0x0020000000076b72
+ (void)_loadCachedProperties;	// IMP=0x001000000007664b
+ (id)environmentForName:(id)arg1;	// IMP=0x0010000000076632
+ (void)initialize;	// IMP=0x001000000007607e
- (void).cxx_destruct;	// IMP=0x0020000000077038
...
- (id)description;	// IMP=0x0010000000076f19
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x0010000000076ec3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000076eb8
