...
- (id)description;	// IMP=0x0010000000043e4d
- (_Bool)isUnset;	// IMP=0x0010000000043e30
- (void)clear;	// IMP=0x0010000000043e14
- (_Bool)isUnderLimit;	// IMP=0x0010000000043dea
- (void)note;	// IMP=0x0010000000043d9b
- (_Bool)_checkIsExpired;	// IMP=0x0010000000043d2d
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x0010000000043ce1
