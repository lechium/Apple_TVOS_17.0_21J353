...
@interface APSPushConnectionDisconnectedMetric : NSObject
{
    ...
    MISSING_TYPE *_sslError;	// 36 = 0x24
    NSNumber *_genericError;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x0020000000021c5f
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 error:(unsigned int)arg4 sslError:(unsigned int)arg5 genericError:(id)arg6;	// IMP=0x00100000000218fa
