...
- (void).cxx_destruct;	// IMP=0x0020000000081634
...
- (unsigned long long)sumOfBucketType:(unsigned char)arg1;	// IMP=0x00100000000815bd
- (void)countTopic:(id)arg1 now:(double)arg2;	// IMP=0x0010000000081557
- (void)shiftBucketsBasedOnNow:(double)arg1;	// IMP=0x0010000000081475
- (void)dealloc;	// IMP=0x0010000000081436
- (id)init;	// IMP=0x00100000000813ad
