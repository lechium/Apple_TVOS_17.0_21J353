...
+ (id)sharedInstance;	// IMP=0x00400000000bc39e
- (void).cxx_destruct;	// IMP=0x00200000000bcc6c
...
- (void)removeListener:(id)arg1;	// IMP=0x00100000000bcb94
- (void)addListener:(id)arg1;	// IMP=0x00100000000bcb00
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x00100000000bc9ba
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00100000000bc874
- (void)_systemWillSleep;	// IMP=0x00100000000bc7d7
- (void)_systemDidWake;	// IMP=0x00100000000bc7ba
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x00100000000bc709
- (void)dealloc;	// IMP=0x00100000000bc45d
- (id)init;	// IMP=0x00100000000bc3f3
