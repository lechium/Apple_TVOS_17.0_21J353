...
- (void).cxx_destruct;	// IMP=0x00200000000192b3
...
- (id)initWithGuid:(id)arg1 topic:(id)arg2 changedReason:(long long)arg3 didCauseFilterChange:(_Bool)arg4;	// IMP=0x0010000000019045
