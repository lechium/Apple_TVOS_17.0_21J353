...
@interface APSPushProxyManagerSendMetric : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00200000000c0594
...
- (id)initWithGuid:(id)arg1 messageCommand:(long long)arg2 topic:(id)arg3 isNearby:(_Bool)arg4;	// IMP=0x00100000000c0326
