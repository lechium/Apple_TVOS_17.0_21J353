...
- (void).cxx_destruct;	// IMP=0x00200000000445db
...
- (void)_clearState;	// IMP=0x0010000000044493
- (void)_fireMetricIfNeeded;	// IMP=0x0010000000044369
- (void)_timerFired:(id)arg1;	// IMP=0x0010000000044338
- (void)noteReceivedLiveMessage;	// IMP=0x0010000000044326
- (void)noteSystemWillSleep;	// IMP=0x0010000000044314
- (void)noteReceivedStoredMessage;	// IMP=0x00100000000442c4
- (void)noteDidConnect;	// IMP=0x0010000000044254
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x00100000000441a5
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000004409d
- (id)init;	// IMP=0x0010000000043f31
