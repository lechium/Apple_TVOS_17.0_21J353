...
- (void).cxx_destruct;	// IMP=0x002000000007b9c1
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000007b4f9
- (void)_cleanupConnection:(id)arg1;	// IMP=0x001000000007b35a
- (void)dealloc;	// IMP=0x001000000007b2c8
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000007b11e
