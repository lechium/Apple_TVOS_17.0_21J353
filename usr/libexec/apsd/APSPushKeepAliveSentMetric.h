...
@interface APSPushKeepAliveSentMetric : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0020000000073bf9
...
// Error: Property attributes should begin with the type ('T') attribute, property name: guid
