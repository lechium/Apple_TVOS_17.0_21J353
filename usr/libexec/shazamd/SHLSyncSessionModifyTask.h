...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000495ba
- (void).cxx_destruct;	// IMP=0x0020000000049785
...
- (void)updateProgress;	// IMP=0x00100000000495c2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000494e8
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000492f9
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x00100000000488b8
- (id)_init;	// IMP=0x0010000000048792
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x0010000000048614
