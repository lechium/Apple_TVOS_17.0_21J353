...
- (void).cxx_destruct;	// IMP=0x002000000004276e
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x001000000004237a
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x001000000004214e
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x0010000000040fc5
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000003ff61
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000003fe8d
