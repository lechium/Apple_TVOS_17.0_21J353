...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002453a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000244b5
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000243ce
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x00100000000242eb
