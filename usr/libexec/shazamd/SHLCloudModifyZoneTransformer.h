...
- (void).cxx_destruct;	// IMP=0x002000000004697f
...
- (id)recordZonesFromCloudBackedZones:(id)arg1;	// IMP=0x0010000000046770
- (id)cloudBackedOperationForZonesToSave:(id)arg1 container:(id)arg2;	// IMP=0x001000000004615e
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000460d9
