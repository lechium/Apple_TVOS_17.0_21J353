...
+ (void)powerlogCallingProcessBundleID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;	// IMP=0x004000000002a6b4
- (void).cxx_destruct;	// IMP=0x002000000002a6ec
...
- (void)detachedTapForClient:(long long)arg1;	// IMP=0x001000000002a597
- (void)attachedTapForClient:(long long)arg1;	// IMP=0x001000000002a50d
- (id)initWithBundleID:(id)arg1;	// IMP=0x001000000002a4a2
