...
- (void).cxx_destruct;	// IMP=0x002000000000b2bc
...
- (void)matcher:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x001000000000b1ea
- (void)_stop;	// IMP=0x001000000000b13b
- (void)stopRecognitionForRequestID:(id)arg1;	// IMP=0x001000000000afce
- (void)stopRecognition;	// IMP=0x001000000000af60
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x001000000000aeae
- (id)initWithRunnerMatcher:(id)arg1;	// IMP=0x001000000000ae43
