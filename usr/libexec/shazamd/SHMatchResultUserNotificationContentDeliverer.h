...
- (void).cxx_destruct;	// IMP=0x002000000000db29
...
- (void)deliverContentForMatchedMediaItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000d83e
- (void)deliverContentForNoMatchWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000d658
- (id)initWithContentProvider:(id)arg1;	// IMP=0x001000000000d5ed
