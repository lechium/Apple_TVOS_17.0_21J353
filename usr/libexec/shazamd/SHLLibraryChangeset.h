...
- (void).cxx_destruct;	// IMP=0x0020000000015457
...
- (id)description;	// IMP=0x00100000000152c8
- (void)mergeChangeset:(id)arg1;	// IMP=0x00100000000151c2
- (void)deleteGroups:(id)arg1;	// IMP=0x001000000001507b
- (void)addGroups:(id)arg1;	// IMP=0x0010000000014d4d
- (void)deleteTracks:(id)arg1;	// IMP=0x0010000000014c06
- (void)addTracks:(id)arg1;	// IMP=0x0010000000014abf
...
- (id)init;	// IMP=0x00100000000146e6
