...
- (void).cxx_destruct;	// IMP=0x002000000000ca97
...
- (id)sessionConfiguration;	// IMP=0x001000000000c7d1
- (void)performRequest:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000c454
- (_Bool)isTokenFailureError:(id)arg1;	// IMP=0x001000000000c3c5
- (void)handleResult:(id)arg1 callback:(CDUnknownBlockType)arg2 error:(id)arg3;	// IMP=0x001000000000c143
- (void)invalidate;	// IMP=0x001000000000c106
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2;	// IMP=0x001000000000c036
