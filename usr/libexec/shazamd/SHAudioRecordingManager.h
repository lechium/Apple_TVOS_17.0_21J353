...
- (void).cxx_destruct;	// IMP=0x0020000000039288
...
- (void)recorder:(id)arg1 producedAudioBuffer:(id)arg2 atTime:(id)arg3;	// IMP=0x0010000000038d51
- (id)recorderForSource:(long long)arg1;	// IMP=0x0010000000038bf1
- (_Bool)isAudioSourceSupported:(long long)arg1;	// IMP=0x0010000000038bbe
@property(readonly, nonatomic) long long suggestedAudioRecordingSource;
- (_Bool)hasActiveTapsForRecordingSource:(long long)arg1;	// IMP=0x0010000000038639
@property(readonly, nonatomic) _Bool hasActiveTaps;
- (void)detachTap:(id)arg1;	// IMP=0x00100000000383a3
- (void)attachTap:(id)arg1;	// IMP=0x00100000000381d3
- (void)stopRecordingForReason:(long long)arg1;	// IMP=0x0010000000037b6d
- (void)startRecording;	// IMP=0x00100000000375b8
- (_Bool)shouldStartRecorder:(id)arg1;	// IMP=0x0010000000037548
- (id)initWithRecorders:(id)arg1;	// IMP=0x001000000003743e
- (void)dealloc;	// IMP=0x001000000003739f
