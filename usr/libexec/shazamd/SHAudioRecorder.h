...
+ (_Bool)hasAudioQueueFailedWithStatus:(int)arg1 annotateError:(id *)arg2;	// IMP=0x0020000000026f34
+ (_Bool)isAudioQueueRunning:(struct OpaqueAudioQueue *)arg1;	// IMP=0x0010000000026caa
- (void).cxx_destruct;	// IMP=0x0020000000027280
...
- (void)startAudioQueueAfterRetrySecondsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000026f8a
- (_Bool)stopAudioQueueAndClearBuffersWithError:(id *)arg1;	// IMP=0x0010000000026d0e
- (_Bool)stopRecordingWithError:(id *)arg1;	// IMP=0x0010000000026c98
- (void)startRecordingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000265a5
@property(readonly, nonatomic) _Bool isRunning;
- (id)initWithRecordingSource:(long long)arg1;	// IMP=0x001000000002651a
- (void)dealloc;	// IMP=0x001000000002647e
