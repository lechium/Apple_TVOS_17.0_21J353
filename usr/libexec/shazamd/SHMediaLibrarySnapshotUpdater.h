...
- (void).cxx_destruct;	// IMP=0x00200000000346c4
...
- (void)updateChanges:(id)arg1 condition:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000338fe
- (void)updateSnapshot:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000333fc
- (id)initWithMediaItemFetcher:(id)arg1 remoteConfiguration:(id)arg2;	// IMP=0x0010000000033363
- (id)init;	// IMP=0x00100000000332d5
