...
- (void).cxx_destruct;	// IMP=0x0020000000006c31
...
- (void)sh_setCampaignTokenForClientIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000006a4e
- (void)sh_setDefaultValuesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000068d6
