...
- (void).cxx_destruct;	// IMP=0x002000000000d5c5
...
- (id)initWithRecordingSource:(long long)arg1 client:(long long)arg2 bundleIdentifier:(id)arg3 canEnableSpectralOutput:(_Bool)arg4;	// IMP=0x001000000000d4fa
- (id)initWithRecordingSource:(long long)arg1 client:(long long)arg2 bundleIdentifier:(id)arg3;	// IMP=0x001000000000d4e5
