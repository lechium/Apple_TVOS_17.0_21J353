...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000013340
- (void).cxx_destruct;	// IMP=0x0020000000013dfa
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000133ee
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000013348
