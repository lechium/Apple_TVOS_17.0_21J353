...
- (void).cxx_destruct;	// IMP=0x0010000000010171
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000fda2
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000fbbc
- (id)init;	// IMP=0x001000000000fafb
- (void)_loadEnterpriseData;	// IMP=0x00100000000101a4
