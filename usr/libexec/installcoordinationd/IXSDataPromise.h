...
@class IXDataPromiseSeed, MISSING_TYPE, NSError, NSSet, NSString, NSUUID;
...
@interface IXSDataPromise : NSObject
{
    ...
    MISSING_TYPE *_lastSavedPercentComplete;	// 72 = 0x48
}

+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008032a
- (void).cxx_destruct;	// IMP=0x001000000008241d
...
- (id)description;	// IMP=0x0010000000082262
- (void)supersede;	// IMP=0x00100000000821a6
- (void)decommission;	// IMP=0x0010000000082070
...
- (void)_setPercentComplete:(double)arg1 saveStateIfNeeded:(_Bool)arg2;	// IMP=0x0010000000081832
...
- (void)_removeSavedState;	// IMP=0x0010000000081008
- (void)saveState;	// IMP=0x0010000000080cc0
- (_Bool)awakeFromSerializationWithLookupBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;	// IMP=0x0010000000080c53
- (_Bool)cancelForReason:(id)arg1 client:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000806e2
- (void)reset;	// IMP=0x0010000000080435
- (unsigned long long)hash;	// IMP=0x00100000000803f1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000080332
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000080183
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000007ff3c
@property(readonly, copy, nonatomic) IXDataPromiseSeed *clientSeed; // @dynamic clientSeed;
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x001000000007fd42
- (void)_internalInitWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000007fbfd
- (oneway void)_remote_preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000083172
- (oneway void)_remote_getErrorInfo:(CDUnknownBlockType)arg1;	// IMP=0x0010000000082f83
- (oneway void)_remote_resetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000082c13
- (oneway void)_remote_cancelForReason:(id)arg1 client:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000082a0e
- (oneway void)_remote_setIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x00100000000827d4
- (oneway void)_remote_getIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000082686
- (oneway void)_remote_setPercentComplete:(double)arg1;	// IMP=0x00100000000825b2
- (oneway void)_remote_getPercentComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000082464
