...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006134d
- (void).cxx_destruct;	// IMP=0x0020000000061a27
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006187b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006169c
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000061355
