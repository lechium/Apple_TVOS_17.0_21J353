...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x004000000003cd92
- (void).cxx_destruct;	// IMP=0x002000000003ce28
...
- (void)dealloc;	// IMP=0x001000000003cd4b
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x001000000003cbda
- (id)localizedStringForKey:(id)arg1 withFormatHint:(id)arg2;	// IMP=0x001000000003caf6
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003cae4
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003c4d4
- (void)_configureOptionalButtonForConfiguration:(id)arg1;	// IMP=0x001000000003c199
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x001000000003bc47
- (void)_processUserNotification:(struct __CFUserNotification *)arg1 withConfiguration:(id)arg2 response:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000003b477
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x001000000003b302
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x001000000003b0c1
