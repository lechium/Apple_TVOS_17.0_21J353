...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d77d
- (void).cxx_destruct;	// IMP=0x002000000003d89f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003d785
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003d697
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003d5af
