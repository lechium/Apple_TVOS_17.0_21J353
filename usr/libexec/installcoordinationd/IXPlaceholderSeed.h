...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000035e81
- (void).cxx_destruct;	// IMP=0x0020000000036016
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000035e89
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000035d0b
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000035b43
