...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003068f
@property(readonly, copy, nonatomic) NSDictionary *dictionary;
- (id)initWithSeed:(id)arg1 dictionary:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000030697
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003060a
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000305db
