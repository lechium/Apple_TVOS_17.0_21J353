...
- (unsigned long long)totalBytesForProgress;	// IMP=0x0010000000002c44
- (void)reset;	// IMP=0x0010000000002ba9
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002b7a
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x0010000000002cbd
