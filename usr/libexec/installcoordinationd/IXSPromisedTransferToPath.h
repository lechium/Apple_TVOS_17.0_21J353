...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x0010000000032409
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x00100000000322f4
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x00100000000321b0
