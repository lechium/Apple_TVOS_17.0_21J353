...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001288f
- (void).cxx_destruct;	// IMP=0x0020000000014701
...
- (id)description;	// IMP=0x00100000000144f2
- (id)infoPlistContent;	// IMP=0x001000000001415b
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0010000000013f1e
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0010000000013733
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x001000000001369a
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000135e6
- (id)_plistKeys;	// IMP=0x0010000000013523
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001326d
- (unsigned long long)hash;	// IMP=0x0010000000012f6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000012897
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000012555
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000012187
- (id)init;	// IMP=0x0010000000012158
