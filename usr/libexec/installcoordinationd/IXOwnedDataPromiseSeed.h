...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000347af
- (void).cxx_destruct;	// IMP=0x00200000000348af
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000347b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000346db
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000345ec
