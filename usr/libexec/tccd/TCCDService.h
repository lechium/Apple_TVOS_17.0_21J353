...
+ (id)defaultLocalizedResourcesBundlePath;	// IMP=0x00400000000361ef
+ (id)requestDenyNotificationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034cc5
+ (id)requestDenyNotificationTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034ca9
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c8d
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c71
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c55
+ (id)reminderRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c39
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c1d
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034c01
+ (id)reminderRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034be5
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034bc9
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034bad
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b91
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b75
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b59
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b3d
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b21
+ (id)reminderTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000034b05
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x0010000000034add
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x0010000000034a65
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x00100000000349a7
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x0010000000034659
+ (id)serviceAll;	// IMP=0x00100000000345d7
+ (id)allServices;	// IMP=0x00100000000300bd
- (void).cxx_destruct;	// IMP=0x00200000000370e8
...
- (id)populateRecordMetricWithFields:(id)arg1;	// IMP=0x0010000000036673
- (void)_makeAnalyticsPopulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000036661
- (unsigned long long)translateAuth:(unsigned long long)arg1 versionUpgrade:(_Bool)arg2;	// IMP=0x001000000003664a
- (void)_makeAuthTranslationBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000036638
- (void)_makePromptButtonLocalizationKeyBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000036626
- (id)localizationKeyForButtonAuth:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2;	// IMP=0x001000000003660e
- (void)_makePromptAuthorizationChoiceBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000365fc
- (int)authorizationChoicesForCurrentAuth:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2 aButtonAuth:(unsigned long long *)arg3 bButtonAuth:(unsigned long long *)arg4 cButtonAuth:(unsigned long long *)arg5;	// IMP=0x00100000000365d6
- (id)usageDescriptionKeyForAuthorization:(unsigned long long)arg1;	// IMP=0x0010000000036595
- (id)buttonTitleLocalizationKeyForAuthorization:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2;	// IMP=0x001000000003652e
- (id)requestTitleTextLocalizationKeyForAuthorization:(unsigned long long)arg1;	// IMP=0x00100000000364f3
- (id)localizedTextWithKey:(id)arg1;	// IMP=0x00100000000363c0
- (long long)developmentAuthorizationValue;	// IMP=0x0010000000035ea4
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0010000000035ddb
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0010000000035d6c
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x0010000000035d40
- (long long)compare:(id)arg1;	// IMP=0x0010000000035caf
- (id)descriptionDictionary;	// IMP=0x001000000003530e
- (id)description;	// IMP=0x00100000000352fc
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x0010000000034ce1
