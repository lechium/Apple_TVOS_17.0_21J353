...
@interface TCCDRequestContext : NSObject
{
    ...
    unsigned long long _promptingPolicy;	// 96 = 0x60
    unsigned long long _usageStringPolicy;	// 104 = 0x68
    unsigned long long _recordUpgradePolicy;	// 112 = 0x70
    unsigned long long _promptRightsMask;	// 120 = 0x78
    NSObject<OS_dispatch_semaphore> *_promptingSemaphore;	// 128 = 0x80
    unsigned long long _queryCount;	// 136 = 0x88
}

- (void).cxx_destruct;	// IMP=0x001000000003e952
...
- (id)initForSyncRequestForSubjectBundleIdentifier:(id)arg1 service:(id)arg2;	// IMP=0x001000000003e3b4
- (id)init;	// IMP=0x001000000003e39b
- (void)dealloc;	// IMP=0x001000000003e2cc
- (id)initWithRequestMessage:(id)arg1 forServer:(id)arg2 error:(id *)arg3;	// IMP=0x001000000003dd1b
- (void)presentAsynchronousDenialNotificationForService:(id)arg1;	// IMP=0x001000000002ad0c
- (void)presentAsynchronousDenialNotificationWithMessage:(id)arg1 buttonTitle:(id)arg2;	// IMP=0x001000000002a5bd
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 currentAuth:(unsigned long long)arg7 updatingResult:(id)arg8;	// IMP=0x001000000002c489
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 cButtonTitle:(id)arg7 cButtonAuth:(unsigned long long)arg8 currentAuth:(unsigned long long)arg9 updatingResult:(id)arg10;	// IMP=0x001000000002c443
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 cButtonTitle:(id)arg7 cButtonAuth:(unsigned long long)arg8 currentAuth:(unsigned long long)arg9 withTimeoutInSeconds:(unsigned int)arg10 updatingResult:(id)arg11;	// IMP=0x001000000002aecb
