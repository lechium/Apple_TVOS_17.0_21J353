...
- (void).cxx_destruct;	// IMP=0x0020000000047f45
...
- (void)display;	// IMP=0x0010000000047b53
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x0010000000047a5e
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x0010000000047951
