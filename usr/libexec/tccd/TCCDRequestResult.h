...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x0040000000040fc3
- (void).cxx_destruct;	// IMP=0x0020000000041ac3
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x001000000004159f
- (id)description;	// IMP=0x001000000004158b
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x00100000000412c4
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x0010000000041105
- (id)init;	// IMP=0x00100000000410b4
