...
- (void).cxx_destruct;	// IMP=0x002000000001128e
...
- (id)cancelInvitation;	// IMP=0x001000000001103e
- (id)initWithNetworkService:(id)arg1 email:(id)arg2 familyID:(id)arg3;	// IMP=0x0010000000010f96
