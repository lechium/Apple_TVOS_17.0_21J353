...
@class ACAccount, FAScreentimeSettingsObjectCache, MISSING_TYPE, NSData, NSDictionary, NSNumber, NSString, NSURL;
...
- (void)updateFamilyInviteStatusWith:(long long)arg1 inviteCode:(NSString *)arg2 requestUrl:(NSURL *)arg3 options:(NSDictionary *)arg4 additionalRequestParameters:(NSDictionary *)arg5 replyBlock:(void (^)(_Bool, NSError *))arg6;
...
- (MISSING_TYPE *)fetchSettingsPresetsForMemberWithAltDSID:fromCache:options:replyBlock: /* Error: Ran out of types for this method. */;
...
- (void)updateFamilyMemberFlagWithDSID:(NSNumber *)arg1 ephemeralAuthResults:(NSDictionary *)arg2 flag:(NSString *)arg3 enabled:(_Bool)arg4 replyBlock:(void (^)(NSError *))arg5;
