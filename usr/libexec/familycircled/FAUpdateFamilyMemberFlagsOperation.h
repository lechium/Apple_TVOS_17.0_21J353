...
- (void).cxx_destruct;	// IMP=0x0020000000010f43
...
- (void)_addBodyToRequest:(id)arg1;	// IMP=0x0010000000010c9e
- (void)_addHeadersToRequest:(id)arg1;	// IMP=0x0010000000010a75
- (id)updateMemberFlags;	// IMP=0x00100000000105bd
- (id)initWithNetworkService:(id)arg1 grandSlamSigner:(id)arg2 familyGrandSlamSigner:(id)arg3 memberDSID:(id)arg4 flags:(id)arg5;	// IMP=0x00100000000104c1
