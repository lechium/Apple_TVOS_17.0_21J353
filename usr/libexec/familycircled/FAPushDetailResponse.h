...
- (void).cxx_destruct;	// IMP=0x002000000001b75b
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001b6cb
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x001000000001b659
- (id)description;	// IMP=0x001000000001b5c4
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001b1a6
