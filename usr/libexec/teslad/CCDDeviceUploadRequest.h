...
- (void).cxx_destruct;	// IMP=0x00200000000032c9
...
- (id)requestWithError:(id *)arg1;	// IMP=0x0010000000002f58
- (id)_requestBodyData;	// IMP=0x0010000000002e26
- (id)_endpointURL;	// IMP=0x0010000000002d5d
- (id)_requestHeader;	// IMP=0x0010000000002bef
- (id)_contentType;	// IMP=0x0010000000002be2
