...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000015004
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000014ffc
- (void).cxx_destruct;	// IMP=0x0020000000014f4c
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000014ca7
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000014c32
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000014bbd
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000014bb7
- (void)cancel;	// IMP=0x0010000000014bb1
- (void)performConversion;	// IMP=0x0010000000014b33
- (void)didEnqueue;	// IMP=0x0010000000014ad1
- (_Bool)wantsResultAsData;	// IMP=0x0010000000014a5c
- (void)updateResultTracker;	// IMP=0x0010000000014908
- (void)callCompletionHandler;	// IMP=0x0010000000014603
- (void)loadAsset;	// IMP=0x0010000000014476
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x001000000001417d
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x001000000001402d
