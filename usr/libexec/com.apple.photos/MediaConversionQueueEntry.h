...
- (void).cxx_destruct;	// IMP=0x002000000000ad69
...
- (_Bool)allRequestsAreBackground;	// IMP=0x001000000000ab8a
- (_Bool)allRequestsAreOptional;	// IMP=0x001000000000aaeb
- (_Bool)allRequestsHaveRequestPriority:(long long)arg1;	// IMP=0x001000000000aa45
- (long long)compareProcessingOrderToEntry:(id)arg1;	// IMP=0x001000000000a842
@property(readonly) NSArray *clientRequestsSnapshot;
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x001000000000a699
- (id)requestIdentifiersForConnectionIdentifier:(id)arg1;	// IMP=0x001000000000a5bb
- (id)anyDestinationURLCollection;	// IMP=0x001000000000a4e8
- (id)clientRequestForIdentifier:(id)arg1;	// IMP=0x001000000000a3d5
- (id)removeAndReturnClientRequestWithIdentifier:(id)arg1 remainingRequestCount:(long long *)arg2;	// IMP=0x001000000000a19a
- (_Bool)clientRequestIsDuplicate:(id)arg1 identicalDestination:(_Bool *)arg2;	// IMP=0x001000000000a0ac
- (void)didDequeueAndStartProcessingQueueEntry;	// IMP=0x001000000000a093
- (void)withLockEnumerateClientRequests:(CDUnknownBlockType)arg1;	// IMP=0x0010000000009fe1
- (void)addClientRequest:(id)arg1;	// IMP=0x0010000000009f00
- (id)description;	// IMP=0x0010000000009e2f
- (void)dealloc;	// IMP=0x0010000000009d02
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x0010000000009bcd
