...
- (void).cxx_destruct;	// IMP=0x00200000000107e3
...
- (void)dealloc;	// IMP=0x001000000001041a
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f777
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f610
- (_Bool)_validateOrientation;	// IMP=0x001000000000f4e7
- (_Bool)_validateMetadata;	// IMP=0x001000000000f363
- (_Bool)_validateSource;	// IMP=0x001000000000f134
- (void)_validate;	// IMP=0x001000000000efcc
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000ef93
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000ee3c
