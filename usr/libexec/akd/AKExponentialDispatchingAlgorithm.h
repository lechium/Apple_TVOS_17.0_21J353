...
- (void)_decrementQueueSize;	// IMP=0x001000000001a89d
- (_Bool)_incrementQueueSize;	// IMP=0x001000000001a87c
- (void)_incrementCounter;	// IMP=0x001000000001a865
@property(readonly, copy) NSString *debugDescription;
- (id)nextCalculation;	// IMP=0x001000000001a641
- (id)initWithBase:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000001a5f5
