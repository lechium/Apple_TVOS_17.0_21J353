...
+ (id)decodedConfigurationInfo:(id)arg1;	// IMP=0x004000000000b4ed
- (void).cxx_destruct;	// IMP=0x002000000000f99e
...
- (id)_numberFormatter;	// IMP=0x001000000000f507
- (id)_decodeBase64String:(id)arg1;	// IMP=0x001000000000f47e
- (void)_updateDSIDWithRawValue:(id)arg1;	// IMP=0x001000000000f37d
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1 shouldUpdateDSID:(_Bool)arg2;	// IMP=0x001000000000e509
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1;	// IMP=0x001000000000e4f5
- (void)_updateAccountInformationWithResultsDictionary:(id)arg1;	// IMP=0x001000000000de25
- (void)updateWithSecondaryAuthenticationBody:(id)arg1;	// IMP=0x001000000000dd72
@property(readonly, nonatomic) _Bool isUpdateable;
- (void)_setIdmsDataToken:(id)arg1;	// IMP=0x001000000000dd47
@property(readonly, nonatomic) AKToken *idmsDataToken;
- (void)_setPasswordlessToken:(id)arg1;	// IMP=0x001000000000dd0d
@property(readonly, nonatomic) AKToken *passwordlessToken;
- (void)_setHeartbeatToken:(id)arg1;	// IMP=0x001000000000dcd3
@property(readonly, nonatomic) AKToken *inheritanceBeneficiarySetupToken;
@property(readonly, nonatomic) AKToken *heartbeatToken;
- (void)_setPasswordEquivalentToken:(id)arg1;	// IMP=0x001000000000dc7c
@property(readonly, nonatomic) AKToken *passwordEquivalentToken;
- (void)_harvestManagedAppleIDInfoFromDictionary:(id)arg1;	// IMP=0x001000000000d92f
- (void)_harvestCommonFieldsFromBody:(id)arg1;	// IMP=0x001000000000d28e
- (void)_harvestCommonFieldsFromResponse:(id)arg1;	// IMP=0x001000000000cfd4
- (id)initWithServerResponse:(id)arg1 responseBody:(id)arg2;	// IMP=0x001000000000cf1c
- (id)initWithServerResponse:(id)arg1 forAppleID:(id)arg2;	// IMP=0x001000000000ce67
- (id)_federatedPayloadFromInfo:(id)arg1;	// IMP=0x001000000000cd5b
- (id)initWithSRPContext:(id)arg1;	// IMP=0x001000000000b6b5
