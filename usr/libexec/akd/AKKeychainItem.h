...
- (void).cxx_destruct;	// IMP=0x002000000001b056
...
- (id)itemAttributes;	// IMP=0x001000000001af6c
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000001aeb0
- (id)initWithDescriptor:(id)arg1 value:(id)arg2;	// IMP=0x001000000001ae17
