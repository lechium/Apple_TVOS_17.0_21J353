...
- (void).cxx_destruct;	// IMP=0x002000000005f640
...
- (id)value;	// IMP=0x001000000005f479
- (void)setValue:(id)arg1;	// IMP=0x001000000005f3f5
- (id)initWithMaxWait:(double)arg1 description:(id)arg2;	// IMP=0x001000000005f306
- (id)init;	// IMP=0x001000000005f2ef
