...
+ (id)queryWithString:(id)arg1;	// IMP=0x00400000000a51b0
...
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x00100000000a5667
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000a53ec
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000a51fd
