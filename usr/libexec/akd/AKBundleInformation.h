...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000067b4b
- (void).cxx_destruct;	// IMP=0x0020000000067b85
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000067aa8
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000678d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000677f9
- (id)initWithBundleIdentifier:(id)arg1 bundleName:(id)arg2 bundleDescription:(id)arg3 bundleType:(unsigned long long)arg4 otherInfo:(id)arg5;	// IMP=0x0010000000067710
