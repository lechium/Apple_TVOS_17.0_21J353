...
- (void).cxx_destruct;	// IMP=0x002000000005793b
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x0010000000057793
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x0010000000057781
- (void)deactivate;	// IMP=0x00100000000576f3
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x001000000005767b
- (id)initWithClient:(id)arg1;	// IMP=0x0010000000057610
