...
- (void).cxx_destruct;	// IMP=0x0020000000022a31
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0010000000022733
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00100000000224f9
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000021f89
- (long long)versionFromTask:(id)arg1;	// IMP=0x0010000000021f2d
- (void)updateDb:(long long)arg1;	// IMP=0x0010000000021cdc
- (void)reschedule;	// IMP=0x0010000000021bde
