...
- (void).cxx_destruct;	// IMP=0x004000000004ba82
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x001000000004ba1f
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000004b9f4
- (id)initToMemory;	// IMP=0x001000000004b9c9
- (void)close;	// IMP=0x001000000004b982
- (void)open;	// IMP=0x001000000004b671
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000004b51a
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x001000000004b0a7
- (id)init;	// IMP=0x001000000004ae2e
