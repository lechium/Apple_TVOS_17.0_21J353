...
- (id)createEndpoint;	// IMP=0x00200000000018c3
- (id)allClients;	// IMP=0x0010000000001885
- (void)start;	// IMP=0x00100000000016a0
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000001628
- (void)invalidate;	// IMP=0x00100000000014d7
- (id)__invalidate;	// IMP=0x0010000000001494
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x0010000000001488
- (id)dispatchQueue;	// IMP=0x001000000000147e
...
- (void)dealloc;	// IMP=0x0010000000001297
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x00100000000011e8
