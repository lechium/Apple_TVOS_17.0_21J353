...
+ (id)createUniqueIDFromRequestID:(id)arg1 andCreatedDate:(id)arg2;	// IMP=0x002000000002487e
- (void).cxx_destruct;	// IMP=0x00200000000252d3
...
- (id)compile;	// IMP=0x0010000000024a10
- (void)updateStatus:(long long)arg1 withApproverDSID:(id)arg2;	// IMP=0x00100000000249fb
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x0010000000022c8a
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000022c09
- (id)initWithRequestStorageItem:(id)arg1;	// IMP=0x00100000000228ad
- (id)initWithApproverStorageItem:(id)arg1;	// IMP=0x001000000002259d
- (id)initWithApproverDSID:(id)arg1 createdDate:(id)arg2 modifiedDate:(id)arg3 requestIdentifier:(id)arg4 uniqueIdentifier:(id)arg5 canSendViaMessages:(_Bool)arg6 itemBundleID:(id)arg7 itemDescription:(id)arg8 itemIdentifier:(id)arg9 itemTitle:(id)arg10 localizations:(id)arg11 offerName:(id)arg12 mocked:(_Bool)arg13 previewURL:(id)arg14 productType:(id)arg15 productTypeName:(id)arg16 productURL:(id)arg17 requesterName:(id)arg18 requesterDSID:(id)arg19 requestInfo:(id)arg20 requestString:(id)arg21 requestSummary:(id)arg22 priceSummary:(id)arg23 status:(long long)arg24;	// IMP=0x00100000000221ef
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000020db5
