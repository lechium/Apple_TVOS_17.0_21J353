...
- (void).cxx_destruct;	// IMP=0x002000000000c402
...
- (void)trigger;	// IMP=0x001000000000c1b2
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x001000000000c12a
- (void)run;	// IMP=0x001000000000c118
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000000c0e6
- (id)initWithLabel:(id)arg1 delay:(unsigned long long)arg2 operationQueue:(id)arg3;	// IMP=0x001000000000bcd6
