...
@interface PCSDevice : NSObject
{
    ...
    MISSING_TYPE *_isConnected;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x0020000000003b36
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000398c
- (unsigned long long)hash;	// IMP=0x0010000000003948
@property(readonly) NSString *model;
@property(readonly) _Bool isReachable;
- (_Bool)_onQueue_isReachable;	// IMP=0x00100000000037c0
@property(readonly) _Bool supportsNewProtocol;
@property(readonly) _Bool supportsPCSKeySync;
@property(readonly) NSUUID *pairingID;
- (void)removeObserver:(id)arg1;	// IMP=0x001000000000369e
- (void)addObserver:(id)arg1;	// IMP=0x0010000000003594
- (id)init;	// IMP=0x001000000000350d
