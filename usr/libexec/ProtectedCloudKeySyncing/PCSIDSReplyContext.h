...
- (void).cxx_destruct;	// IMP=0x00200000000019e7
...
- (void)runReplyHandlerWithMessage:(id)arg1 error:(id)arg2;	// IMP=0x001000000000184b
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 logDescription:(id)arg3 sentID:(id)arg4 replyHandler:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00100000000014ac
