...
@class CNChangeHistoryClearRequest, CNChangeHistoryFetchRequest, CNContact, CNContactFetchRequest, CNContainer, CNExtensionCommand, CNSaveRequest, NSArray, NSData, NSDictionary, NSPredicate, NSString;
...
- (void)encodedContactsAndCursorForFetchRequest:(CNContactFetchRequest *)arg1 withReply:(void (^)(NSData *, NSDictionary *, id <CNEncodedFetchCursor>, _Bool, NSError *))arg2;
