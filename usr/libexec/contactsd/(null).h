...
+ (id)os_log;	// IMP=0x0020000000009fa2
- (void).cxx_destruct;	// IMP=0x002000000000a789
...
- (_Bool)isClientAuthorizedAccessForConnection:(id)arg1;	// IMP=0x001000000000a434
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000a1f9
- (id)initWithServiceProvider:(CDUnknownBlockType)arg1 schedulerProvider:(id)arg2 tccServices:(id)arg3;	// IMP=0x001000000000a0fe
- (id)init;	// IMP=0x0010000000009ffe
