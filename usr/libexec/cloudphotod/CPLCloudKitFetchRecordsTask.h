...
- (void).cxx_destruct;	// IMP=0x0020000000127774
...
- (void)runOperations;	// IMP=0x00100000001276ee
- (id)initWithController:(id)arg1 scopedIdentifiers:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000001275e6
