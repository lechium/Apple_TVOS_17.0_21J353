...
- (void).cxx_destruct;	// IMP=0x002000000014b023
- (_Bool)_checkResource:(id)arg1 record:(id)arg2 error:(id *)arg3;	// IMP=0x001000000014acb4
- (void)runOperations;	// IMP=0x001000000014a250
- (id)initWithController:(id)arg1 resources:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000014a123
