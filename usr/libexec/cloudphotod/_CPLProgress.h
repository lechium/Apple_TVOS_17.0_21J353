...
- (void).cxx_destruct;	// IMP=0x0020000000037f9d
...
- (void)unpublish;	// IMP=0x0010000000037f21
- (void)publish;	// IMP=0x0010000000037efa
- (void)_publishRealProgressIfNecessary;	// IMP=0x0010000000037dd5
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000037d44
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x0010000000037b83
