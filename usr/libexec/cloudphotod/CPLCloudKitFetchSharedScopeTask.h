...
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001022e7
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x0010000000101839
- (void)runOperations;	// IMP=0x00100000001017b8
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001016ff
