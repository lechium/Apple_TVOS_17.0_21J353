...
- (void).cxx_destruct;	// IMP=0x002000000003837e
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000381ed
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x00100000000380ad
