...
- (void).cxx_destruct;	// IMP=0x0020000000004cbf
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000467e
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003f10
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003e97
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x0010000000003d5f
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000037f2
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x001000000000370a
- (void)unregisterFromPushNotifications;	// IMP=0x0010000000003673
- (void)stopWaitingForPushNotifications;	// IMP=0x001000000000358d
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002ee8
- (id)init;	// IMP=0x0010000000002c8b
