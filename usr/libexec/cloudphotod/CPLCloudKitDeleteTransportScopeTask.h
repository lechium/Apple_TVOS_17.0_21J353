...
- (void).cxx_destruct;	// IMP=0x00200000000ccbc6
...
- (void)runOperations;	// IMP=0x00100000000cbffe
- (void)_didFinishDeleteWithError:(id)arg1;	// IMP=0x00100000000cbce2
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x00100000000cbb84
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000cba9c
