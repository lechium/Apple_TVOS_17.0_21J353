...
- (void).cxx_destruct;	// IMP=0x00200000000ba4a7
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *messages; // @synthesize messages=_messages;
- (void)runOperations;	// IMP=0x00100000000ba061
- (id)initWithController:(id)arg1 messages:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b9f85
