...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x0040000000114e85
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x0010000000114e30
- (void).cxx_destruct;	// IMP=0x0020000000115339
...
- (id)redactedDescription;	// IMP=0x0010000000115191
- (id)description;	// IMP=0x0010000000115114
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x0010000000114f19
