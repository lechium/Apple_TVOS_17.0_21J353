...
- (void).cxx_destruct;	// IMP=0x0020000000139b24
- (void)queryUserDetailsWithCurrentUserID:(id)arg1;	// IMP=0x0010000000139202
- (void)runOperations;	// IMP=0x0010000000139181
- (id)initWithController:(id)arg1 participants:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001390c8
