...
+ (id)cloudKitScopeListSyncAnchorWithScopeListSyncAnchor:(id)arg1;	// IMP=0x0020000000148919
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000148911
- (void).cxx_destruct;	// IMP=0x0020000000148cb7
...
- (id)description;	// IMP=0x0010000000148ba2
@property(readonly, nonatomic) NSData *scopeListSyncAnchor;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000148b19
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000148a3f
- (id)initWithPrivateChangeToken:(id)arg1 sharedChangeToken:(id)arg2;	// IMP=0x00100000001489a6
