...
- (void).cxx_destruct;	// IMP=0x00200000000f7d5e
...
- (void)runOperations;	// IMP=0x00100000000f7a74
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 scopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000f7967
