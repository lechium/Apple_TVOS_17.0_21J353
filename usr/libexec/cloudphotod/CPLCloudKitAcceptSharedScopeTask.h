...
- (void).cxx_destruct;	// IMP=0x00200000000d53c3
- (void)_acceptShareWithMetadata:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d4aad
- (void)_fetchMetadataForShareURL:(id)arg1 currentUserID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d38da
- (void)_acceptShareWithURL:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d3795
- (void)_updateScopeParticipantsWithCKShare:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000d367b
- (void)_updateScopeAndFlagsWithCKRecord:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000d3565
- (void)runOperations;	// IMP=0x00100000000d2d91
- (id)initWithController:(id)arg1 scope:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d2cd8
