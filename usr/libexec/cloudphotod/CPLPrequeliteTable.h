...
+ (id)tableWithName:(id)arg1;	// IMP=0x0020000000050be5
- (void).cxx_destruct;	// IMP=0x0020000000050de4
@property(readonly, nonatomic) NSString *tableName; // @synthesize tableName=_tableName;
- (id)redactedDescription;	// IMP=0x0010000000050db1
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000050d72
@property(readonly, nonatomic) NSString *injectedTableName;
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1;	// IMP=0x0010000000050c2e
