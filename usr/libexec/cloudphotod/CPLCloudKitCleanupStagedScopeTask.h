...
- (void).cxx_destruct;	// IMP=0x002000000013bd4c
...
- (void)auxiliaryOperationDidFinishWithError:(id)arg1;	// IMP=0x001000000013bc22
- (void)launchAuxiliaryOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3;	// IMP=0x001000000013bab9
- (void)operationDidFinishWithError:(id)arg1;	// IMP=0x001000000013ba51
- (void)updateProgress:(double)arg1;	// IMP=0x001000000013ba1c
- (void)updateContextWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000013b9b4
- (void)updateOneBatch;	// IMP=0x001000000013b97f
- (void)operationDidFinish:(id)arg1 error:(id)arg2;	// IMP=0x001000000013b90a
- (void)launchOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3 sourceBundleIdentifiers:(id)arg4;	// IMP=0x001000000013b821
- (void)dispatchAsync:(CDUnknownBlockType)arg1;	// IMP=0x001000000013b696
- (void)runOperations;	// IMP=0x001000000013b309
- (void)runAuxiliaryOperation;	// IMP=0x001000000013ae71
- (void)_fetchAndMoveNextBatchWithUserRecordID:(id)arg1;	// IMP=0x001000000013a889
- (void)_moveBatchRecordWithNames:(id)arg1 userRecordID:(id)arg2 operationID:(id)arg3 moveBatchID:(id)arg4 hasMore:(_Bool)arg5;	// IMP=0x001000000013a204
- (void)_sendExitFeedbackWithSourceRecordIDs:(id)arg1 destinationRecordIDs:(id)arg2 moveError:(id)arg3 operationID:(id)arg4 moveBatchID:(id)arg5;	// IMP=0x0010000000139dc5
- (id)initWithController:(id)arg1 stagedScope:(id)arg2 stagingScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000139b82

// Remaining properties
// Error: Property attributes should begin with the type ('T') attribute, property name: allowsFetchCache
