...
- (void).cxx_destruct;	// IMP=0x0020000000146306
...
- (void)_determineScopeTypeAndFetchLibraryInfoWithCurrentUserID:(id)arg1;	// IMP=0x0010000000145c7d
- (void)getScopeInfoWithCurrentUserID:(id)arg1;	// IMP=0x00100000001455db
- (void)runOperations;	// IMP=0x0010000000145546
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000145419
