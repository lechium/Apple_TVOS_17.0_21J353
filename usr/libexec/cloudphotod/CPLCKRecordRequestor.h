...
- (void).cxx_destruct;	// IMP=0x002000000012432b
...
- (_Bool)processedFetchedRequestedRecordsWithError:(id *)arg1;	// IMP=0x0010000000123e80
@property(readonly, nonatomic) NSArray *requestedRecordIDs;
- (void)fetchRequestedRecordsForTransportTask:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000123cad
- (void)_fetchRecordsForNextOperationTypeInEnumerator:(id)arg1 task:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001239ef
@property(readonly, nonatomic) _Bool needsRequestedRecords;
- (void)requestRecordWithRecordID:(id)arg1 operationType:(long long)arg2 forRecordWithRecordID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000123725
- (id)initWithFetchCache:(id)arg1 scopeProvider:(id)arg2;	// IMP=0x0010000000123673
