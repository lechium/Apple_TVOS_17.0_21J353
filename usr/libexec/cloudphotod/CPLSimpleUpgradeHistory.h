...
- (void).cxx_destruct;	// IMP=0x0020000000076592
...
- (void)resetVersionHasChanged;	// IMP=0x00100000000761e1
...
- (void)noteDatabaseWasUpgradedToVersion:(long long)arg1 fromVersion:(long long)arg2;	// IMP=0x0010000000075e90
- (id)_valueForKey:(id)arg1 class:(Class)arg2;	// IMP=0x0010000000075e35
- (id)initWithLibraryIdentifier:(id)arg1;	// IMP=0x00100000000754cb
- (void)_save;	// IMP=0x001000000007537b
- (id)_defaultsKey;	// IMP=0x001000000007535e
