...
- (void).cxx_destruct;	// IMP=0x00200000000aecc2
...
- (void)runOperations;	// IMP=0x00100000000ad23d
- (void)createRecordZoneWithID:(id)arg1;	// IMP=0x00100000000acc02
- (void)_callCompletionWithZone:(id)arg1;	// IMP=0x00100000000aca57
- (void)_updateCloudKitScopeWithZone:(id)arg1;	// IMP=0x00100000000ac938
- (id)initWithController:(id)arg1 scope:(id)arg2 cloudKitScope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ac82a
