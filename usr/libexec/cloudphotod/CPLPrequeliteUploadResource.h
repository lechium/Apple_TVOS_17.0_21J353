...
- (void).cxx_destruct;	// IMP=0x0020000000060ec7
...
- (id)resource;	// IMP=0x0010000000060cf0
- (id)initWithResource:(id)arg1;	// IMP=0x0010000000060b09
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006098b
