...
- (void).cxx_destruct;	// IMP=0x00200000000c6b49
...
- (id)cursor;	// IMP=0x00100000000c6b16
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000c51ae
- (void)runOperations;	// IMP=0x00100000000c512c
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x00100000000c50b1
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 scope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000c4f04
