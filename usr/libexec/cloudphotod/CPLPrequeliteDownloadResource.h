...
- (void).cxx_destruct;	// IMP=0x002000000005676f
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x001000000005659b
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000563a4
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005621c
