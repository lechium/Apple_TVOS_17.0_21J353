...
+ (id)descriptionForScopeListSyncAnchor:(id)arg1;	// IMP=0x0020000000147a75
- (void).cxx_destruct;	// IMP=0x00200000001488cf
- (void)_launchOperationForSharedDatabase:(_Bool)arg1;	// IMP=0x0010000000147bd8
- (void)runOperations;	// IMP=0x0010000000147bc4
- (id)initWithController:(id)arg1 scopeListSyncAnchor:(id)arg2 progressHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000147acc
