...
- (void).cxx_destruct;	// IMP=0x00200000000efa14
- (void)runOperations;	// IMP=0x00100000000ef2a6
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x00100000000ef22a
- (double)timeoutIntervalForRequest;	// IMP=0x00100000000ef21c
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ef161
