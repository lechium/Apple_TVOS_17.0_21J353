...
- (void).cxx_destruct;	// IMP=0x0020000000136012
...
- (void)_startDownload;	// IMP=0x00100000001356b3
- (void)_fetchPlaceholderRecordAndStartDownload;	// IMP=0x001000000013549a
- (void)runOperations;	// IMP=0x0010000000135340
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 record:(id)arg3 keys:(id)arg4 operationType:(long long)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000134a7f
- (id)initWithController:(id)arg1 resource:(id)arg2 record:(id)arg3 target:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000001348d7
