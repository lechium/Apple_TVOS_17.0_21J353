...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x00100000000463dc
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x00100000000462d1
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x0010000000045fef
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000045e9a
