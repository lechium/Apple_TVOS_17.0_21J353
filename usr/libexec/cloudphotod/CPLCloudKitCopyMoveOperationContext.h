...
- (void).cxx_destruct;	// IMP=0x00200000000c2181
...
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000c1eb6
- (id)operationDescription;	// IMP=0x00100000000c1e08
- (void)addCopyMoveFromRecordID:(id)arg1 toRecordID:(id)arg2;	// IMP=0x00100000000c1d38
- (id)initFromZoneID:(id)arg1 toZoneID:(id)arg2;	// IMP=0x00100000000c1c96
