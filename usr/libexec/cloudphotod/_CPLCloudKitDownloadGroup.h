...
- (void).cxx_destruct;	// IMP=0x0020000000114db7
...
- (id)description;	// IMP=0x0010000000114c86
@property(readonly, nonatomic) NSString *resourceTypeDescription;
- (id)propertyKeys;	// IMP=0x0010000000114c46
- (id)cloudResourceForRecordWithScopedIdentifier:(id)arg1;	// IMP=0x0010000000114bc8
- (void)enumerateRecordScopedIdentifiersAndTasksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000114ace
...
- (_Bool)cancelDownloadTask:(id)arg1;	// IMP=0x0010000000114777
- (void)allDownloadsDidFailWithError:(id)arg1;	// IMP=0x0010000000114568
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didFailToDownloadWithError:(id)arg2;	// IMP=0x0010000000114357
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didDownloadCKAsset:(id)arg2 withOperationType:(long long)arg3 transcoderVersion:(long long)arg4 withFingerPrint:(id)arg5 andFileUTI:(id)arg6;	// IMP=0x00100000001134cb
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didProgress:(double)arg2;	// IMP=0x001000000011325c
- (void)resourceWithRecordScopedIdentifierDidStart:(id)arg1 operationID:(id)arg2;	// IMP=0x00100000001130a6
- (void)allDownloadsDidStartWithOperationID:(id)arg1;	// IMP=0x0010000000112f4c
- (_Bool)addDownloadTask:(id)arg1;	// IMP=0x0010000000112cc0
- (id)initWithResourceType:(unsigned long long)arg1;	// IMP=0x0010000000112bf3
