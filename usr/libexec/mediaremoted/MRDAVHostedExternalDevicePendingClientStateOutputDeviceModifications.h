...
- (void).cxx_destruct;	// IMP=0x002000000002c5ca
...
- (void)removeOutputDevice:(id)arg1;	// IMP=0x001000000002c4c8
- (void)changeOutputDevice:(id)arg1;	// IMP=0x001000000002c432
- (void)addOutputDevice:(id)arg1;	// IMP=0x001000000002c3ab
- (id)description;	// IMP=0x001000000002c27e
