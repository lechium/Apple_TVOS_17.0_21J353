...
- (void).cxx_destruct;	// IMP=0x0020000000141e95
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x0010000000141de6
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000141db3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000141d87
