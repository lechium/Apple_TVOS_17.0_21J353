...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000001382c1
- (void).cxx_destruct;	// IMP=0x0020000000138483
...
- (unsigned long long)sampleRate;	// IMP=0x0010000000138411
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x00100000001383a3
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000138311
