...
- (void).cxx_destruct;	// IMP=0x00200000000f0e97
...
- (id)_notifyDelegateWithConnection:(id)arg1;	// IMP=0x00000000000f0bc2
- (void)stop;	// IMP=0x00100000000f0b5c
- (void)start;	// IMP=0x00100000000f0af5
- (void)groupSessionRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0ad7
- (id)idsRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0ac2
- (id)idsCompanionRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0aad
- (void)rapportRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0a8f
- (void)airPlayRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0a71
- (void)bonjourRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000f0a53
@property(readonly, copy) NSString *debugDescription;
- (void)_initializeIDSRemoteControlServiceWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000f0428
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000f0110
