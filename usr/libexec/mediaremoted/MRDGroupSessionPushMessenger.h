...
- (void).cxx_destruct;	// IMP=0x002000000011f81d
...
- (void)_updateAllowedDestinations:(id)arg1;	// IMP=0x001000000011f4dd
- (void)updateAllowedDestinations:(id)arg1;	// IMP=0x001000000011f408
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5 context:(id)arg6;	// IMP=0x001000000011f2c4
- (void)service:(id)arg1 account:(id)arg2 incomingMessage:(id)arg3 fromID:(id)arg4 context:(id)arg5;	// IMP=0x001000000011f198
- (void)sendMessage:(id)arg1 toDestinations:(id)arg2;	// IMP=0x001000000011ef4e
- (id)initWithService:(id)arg1 handle:(id)arg2 queue:(id)arg3 messageHandler:(CDUnknownBlockType)arg4 errorHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000011ec7e
