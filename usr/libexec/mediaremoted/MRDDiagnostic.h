...
@class MRApplicationActivity, MRDCommandClientRestriction, MRDMediaRemoteClient, MRDRemoteControlService, MRDVolumeController, MROrigin, MRPlayerPath, NSArray, NSDate, NSDictionary, NSString, _MRAVAirPlaySecuritySettingsProtobuf;
...
- (void).cxx_destruct;	// IMP=0x00200000000ef821
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x00100000000eef35
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x00100000000eef13
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000eeeee
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x00100000000eee2d
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000eee18
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x00100000000eedf4
- (id)createDiagnosticInfo;	// IMP=0x00100000000edacf
- (id)init;	// IMP=0x00100000000eda79
