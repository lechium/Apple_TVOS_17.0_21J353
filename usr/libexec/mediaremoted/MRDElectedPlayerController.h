...
- (void).cxx_destruct;	// IMP=0x00200000000ecb69
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x00100000000ec76d
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00100000000ec431
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x00100000000ec08d
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x00100000000ebba3
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x00100000000eb581
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00100000000eb42f
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00100000000eb315
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x00100000000eb198
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x00100000000eb08e
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x00100000000eaff4
...
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x00100000000eae51
- (id)initWithOriginClient:(id)arg1;	// IMP=0x00100000000eaa5c
