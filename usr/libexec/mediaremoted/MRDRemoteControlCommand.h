...
- (void).cxx_destruct;	// IMP=0x0020000000137d3e
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x0010000000137c36
- (id)_optionsDictionary;	// IMP=0x0010000000137bac
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000137b7f
- (CDUnknownBlockType)_completionHandler;	// IMP=0x0010000000137b69
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x0010000000137b0a
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013750c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001374e0
- (id)debugDescription;	// IMP=0x0010000000137394
- (id)description;	// IMP=0x0010000000137281
- (MISSING_TYPE *)initWithCommandType:playerPath:unresolvedPlayerPath:senderAppDisplayID:optionsData: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000137103
