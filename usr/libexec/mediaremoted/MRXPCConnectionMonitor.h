...
- (void).cxx_destruct;	// IMP=0x002000000010974f
...
- (id);	// IMP=0x0010000000109678
@property(retain, nonatomic) NSXPCConnection *connection; // @synthesize connection=_connection;
@property(nonatomic) __weak id <MRXPCConnectionMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x0010000000109205
- (void)_checkConnectionStatus;	// IMP=0x0010000000108d39
- (_Bool)_canSendMessage;	// IMP=0x0010000000108c53
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x0010000000108b96
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000001088c5
- (id)description;	// IMP=0x001000000010883a
- (id)_initWithLabel:(id)arg1;	// IMP=0x0010000000108789
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000001086ce
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x0010000000108602
