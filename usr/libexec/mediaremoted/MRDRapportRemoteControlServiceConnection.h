...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003696f
- (void).cxx_destruct;	// IMP=0x0020000000036d33
...
- (void)dealloc;	// IMP=0x0010000000036bc0
- (id)description;	// IMP=0x0010000000036b78
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000036a0c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000036977
