...
- (void).cxx_destruct;	// IMP=0x0020000000095931
...
- (id)_coealesceItems:(id)arg1;	// IMP=0x001000000009554d
@property(readonly, nonatomic) MRNowPlayingState *state;
- (id)description;	// IMP=0x0010000000093cc0
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000093c55
