...
- (void).cxx_destruct;	// IMP=0x002000000005baec
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005b34f
- (id)description;	// IMP=0x001000000005b23a
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x001000000005b04d
