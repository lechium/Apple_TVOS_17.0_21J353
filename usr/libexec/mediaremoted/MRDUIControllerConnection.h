...
+ (id)serviceInterface;	// IMP=0x00200000000661d8
- (void).cxx_destruct;	// IMP=0x0020000000066318
...
- (void)dealloc;	// IMP=0x0010000000065984
- (id)initWithClientObject:(id)arg1 invalidationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000065857
