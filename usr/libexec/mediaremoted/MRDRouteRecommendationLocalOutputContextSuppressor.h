...
- (void).cxx_destruct;	// IMP=0x0020000000099b89
...
- (_Bool)shouldSuppressRecommendations;	// IMP=0x0010000000099b3b
- (id)initWithOutputContextLogic:(id)arg1;	// IMP=0x0010000000099ad0
