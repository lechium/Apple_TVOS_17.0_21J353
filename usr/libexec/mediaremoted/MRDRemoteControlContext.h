...
- (void).cxx_destruct;	// IMP=0x00200000000199ad
...
- (void)clearRoutedCommands;	// IMP=0x0010000000019934
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000019740
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x001000000001951a
