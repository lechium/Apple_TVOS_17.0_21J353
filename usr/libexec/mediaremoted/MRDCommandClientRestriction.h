...
+ (id)restrictedTo:(id)arg1 by:(id)arg2;	// IMP=0x00200000000e5bea
- (void).cxx_destruct;	// IMP=0x00200000000e6047
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e5ee1
- (id)description;	// IMP=0x00100000000e5caa
