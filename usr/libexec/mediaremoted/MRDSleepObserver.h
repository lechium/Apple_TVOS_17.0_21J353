...
- (void).cxx_destruct;	// IMP=0x002000000011ea95
...
- (void)notifyDelegateOfWake;	// IMP=0x001000000011e9ce
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000011e933
- (id)init;	// IMP=0x001000000011e66e
