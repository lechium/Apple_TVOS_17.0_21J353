...
- (void).cxx_destruct;	// IMP=0x0020000000026750
@property(readonly, nonatomic) NSDate *date; // @synthesize date=_date;
@property(readonly, nonatomic) unsigned int playbackState; // @synthesize playbackState=_playbackState;
- (id)description;	// IMP=0x00100000000266d8
- (id)initWithPlaybackState:(unsigned int)arg1 date:(id)arg2;	// IMP=0x001000000002663e
