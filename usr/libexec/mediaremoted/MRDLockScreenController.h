...
- (void).cxx_destruct;	// IMP=0x00200000000991dc
...
- (_Bool)_onQueue_calculateShouldShowLockScreenForReason:(id *)arg1;	// IMP=0x0010000000098f57
- (void)_onQueue_reevaluateShouldShowLockScreenForReason:(id)arg1;	// IMP=0x0010000000098c96
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x0010000000098b20
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x0010000000098955
- (void)_handleElectedPlayerDidChangeNotification:(id)arg1;	// IMP=0x0010000000098767
- (void)_handleLayoutDidChangeNotification:(id)arg1;	// IMP=0x00100000000986b1
- (void)routeRecommendationDismissed;	// IMP=0x0010000000098635
- (void)lockScreenContentControllerStateDidChange:(id)arg1;	// IMP=0x00100000000985cd
- (void)personalDeviceControllerStateDidChange:(id)arg1;	// IMP=0x00100000000984de
- (void)_onSerialQueue_restoreElectedPlayer;	// IMP=0x00100000000983f0
- (void)setLockScreenRecommendationActive:(_Bool)arg1;	// IMP=0x0010000000097daa
...
- (_Bool)_onQueue_isLockScreenWidgetVisible;	// IMP=0x0010000000097b70
@property(readonly, nonatomic, getter=isLockScreenWidgetActive) _Bool lockScreenWidgetActive;
- (id)init;	// IMP=0x00100000000977c4
