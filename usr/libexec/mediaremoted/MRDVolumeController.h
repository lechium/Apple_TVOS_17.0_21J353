...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000000190bc
- (void).cxx_destruct;	// IMP=0x00200000000191b6
...
- (void)setIsMuted:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0010000000019189
- (void)adjustVolume:(long long)arg1 error:(id *)arg2;	// IMP=0x0010000000019183
- (void)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x001000000001917d
- (void)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x0010000000019177
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x001000000001910c
