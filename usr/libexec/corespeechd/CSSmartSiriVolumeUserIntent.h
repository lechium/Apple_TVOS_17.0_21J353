...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x001000000010c540
- (void)storeASVStateInformation;	// IMP=0x001000000010c4ed
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x001000000010c4cc
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x001000000010c4ab
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x001000000010c368
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x001000000010c260
