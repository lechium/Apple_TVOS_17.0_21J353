...
- (void).cxx_destruct;	// IMP=0x002000000008b4dd
...
- (void)removeReceiver:(id)arg1;	// IMP=0x001000000008b443
- (void)addReceiver:(id)arg1;	// IMP=0x001000000008b43d
- (void)stop;	// IMP=0x001000000008b437
- (void)pause;	// IMP=0x001000000008b431
- (void)start;	// IMP=0x001000000008b42b
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x001000000008b41d
