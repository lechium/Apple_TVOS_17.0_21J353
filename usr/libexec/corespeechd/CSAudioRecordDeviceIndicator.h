...
- (void).cxx_destruct;	// IMP=0x002000000013f714
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x001000000013f6dc
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x001000000013f53c
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x001000000013f478
