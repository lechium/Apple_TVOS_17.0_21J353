...
+ (id)initialResultCandidateFeatures;	// IMP=0x004000000000c404
+ (id)initialServerEndpointFeatures;	// IMP=0x001000000000c3b0
- (void).cxx_destruct;	// IMP=0x002000000000c388
...
- (id)dictionary;	// IMP=0x001000000000c10e
- (id)description;	// IMP=0x001000000000c05d
- (id)initWithWordCount:(long long)arg1 trailingSilenceFrames:(long long)arg2 endOfSilenceLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6;	// IMP=0x001000000000c03a
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x001000000000bf66
