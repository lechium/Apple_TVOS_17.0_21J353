...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000b2eb4
- (void).cxx_destruct;	// IMP=0x00200000000b274c
...
- (id)description;	// IMP=0x00100000000b26a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000b25be
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000b22ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b2237
- (id)initWithCSRTModelRequestOptions:(id)arg1 builder:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b216e
- (id)initWithMutableBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b1fd2
