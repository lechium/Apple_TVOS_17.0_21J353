...
- (void).cxx_destruct;	// IMP=0x00200000000dfdd9
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000dfd5a
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000dfd54
- (void)stop;	// IMP=0x00100000000dfd4e
- (void)pause;	// IMP=0x00100000000dfd48
- (void)start;	// IMP=0x00100000000dfd42
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000dfd34
