...
@interface CSIntuitiveConvRequestHandler : NSObject
{
    ...
    NSString *_dismissedRequestId;	// 280 = 0x118
    NSString *_currentRequestId;	// 288 = 0x120
    NSString *_recordingEventUUIDToIgnore;	// 296 = 0x128
    CSAttSiriMagusSupportedPolicy *_magusSupportedPolicy;	// 304 = 0x130
    CSAudioSessionInfoProvider *_audioSessionInfoProvider;	// 312 = 0x138
}
...
- (id)fetchRecordingEventUUIDToIgnore;	// IMP=0x001000000002db7a
- (void)emitRequestLinkEventForMHUUID:(id)arg1 withRequestId:(id)arg2;	// IMP=0x001000000002db74
- (id)_startStreamOptionWithMachAbsTime:(unsigned long long)arg1;	// IMP=0x001000000002daef
- (id)_startStreamOption;	// IMP=0x001000000002dac8
- (void)attSiriAudioSrcNodeDidStopUnexpectedly:(id)arg1;	// IMP=0x001000000002da57
- (void)_handleStopProcessing;	// IMP=0x001000000002d97c
- (void)_handleStartProcessingWithRecordContext:(id)arg1 withAudioStartStreamOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000002d2ff
- (void)_setupAudioSrcNodeWithSiriClientStream:(id)arg1;	// IMP=0x001000000002d238
- (void)_fetchRequiredAssets;	// IMP=0x001000000002d20a
- (void)_fetchVoiceTriggerAssets;	// IMP=0x001000000002d183
- (void)_fetchMitigationAssets;	// IMP=0x001000000002d0fc
- (void)mxSessionMonitorSomeClientWentActive:(id)arg1;	// IMP=0x001000000002d0f6
- (void)_stopMonitoringAudioSession;	// IMP=0x001000000002d0f0
- (void)_startMonitoringAudioSession;	// IMP=0x001000000002d0ea
- (void)audioSessionInfoProvider:(id)arg1 didReceiveAudioSessionRouteChangeNotificationWithUserInfo:(id)arg2;	// IMP=0x001000000002d092
- (void)didSiriUIDismiss;	// IMP=0x001000000002cf59
- (void)attSiriNode:(id)arg1 didDetectStartpointAtTime:(double)arg2;	// IMP=0x001000000002cf53
- (void)attSiriNode:(id)arg1 didDetectHardEndpointAtTime:(double)arg2 withMetrics:(id)arg3 usesAutomaticEndPointing:(_Bool)arg4;	// IMP=0x001000000002cf08
- (void)CSSiriEnabledMonitor:(id)arg1 didReceiveEnabled:(_Bool)arg2;	// IMP=0x001000000002ce2e
- (void)_handleClientPreparedAudioStream:(id)arg1 successfully:(_Bool)arg2;	// IMP=0x001000000002cd0d
- (id)_recordContextForContinuousConversation;	// IMP=0x001000000002cc53
- (void)_handleClientDidStopWithOption:(id)arg1;	// IMP=0x001000000002c9e6
- (void)_handleClientWillStopStreamWithReason:(unsigned long long)arg1 stopStreamOption:(id)arg2;	// IMP=0x001000000002c9d0
- (void)_handleClientDidStartStreamWithOption:(id)arg1 successfully:(_Bool)arg2;	// IMP=0x001000000002c7b8
- (void)_handleClientWillStartStreamWithContext:(id)arg1 option:(id)arg2;	// IMP=0x001000000002c603
- (void)siriClientBehaviorMonitor:(id)arg1 preparedSiriClientAudioStream:(id)arg2 successfully:(_Bool)arg3;	// IMP=0x001000000002c563
- (void)siriClientBehaviorMonitor:(id)arg1 fetchedSiriClientAudioStream:(id)arg2 successfully:(_Bool)arg3;	// IMP=0x001000000002c4c3
- (void)siriClientBehaviorMonitor:(id)arg1 didStopStream:(id)arg2 withEventUUID:(id)arg3;	// IMP=0x001000000002c404
- (void)siriClientBehaviorMonitor:(id)arg1 willStopStream:(id)arg2 reason:(unsigned long long)arg3 withEventUUID:(id)arg4;	// IMP=0x001000000002c339
- (void)siriClientBehaviorMonitor:(id)arg1 willStopStream:(id)arg2 reason:(unsigned long long)arg3;	// IMP=0x001000000002c333
- (void)siriClientBehaviorMonitor:(id)arg1 didStartStreamWithContext:(id)arg2 successfully:(_Bool)arg3 option:(id)arg4 withEventUUID:(id)arg5;	// IMP=0x001000000002c269
- (void)siriClientBehaviorMonitor:(id)arg1 willStartStreamWithContext:(id)arg2 option:(id)arg3 withEventUUID:(id)arg4;	// IMP=0x001000000002c17a
- (void)siriClientBehaviorMonitor:(id)arg1 willStartStreamWithContext:(id)arg2 option:(id)arg3;	// IMP=0x001000000002c174
- (void)intuitiveConvAudioCaptureMonitor:(id)arg1 fetchedAudioStream:(id)arg2 successfully:(_Bool)arg3;	// IMP=0x001000000002c0d4
- (void)intuitiveConvAudioCaptureMonitorDidStopAudioCapture:(id)arg1 stopStreamOption:(id)arg2 eventUUID:(id)arg3;	// IMP=0x001000000002c047
- (void)intuitiveConvAudioCaptureMonitor:(id)arg1 willStopAudioCaptureReason:(unsigned long long)arg2;	// IMP=0x001000000002bff8
- (void)intuitiveConvAudioCaptureMonitor:(id)arg1 didStartAudioCaptureSuccessfully:(_Bool)arg2 option:(id)arg3 eventUUID:(id)arg4;	// IMP=0x001000000002bf59
- (void)intuitiveConvAudioCaptureMonitor:(id)arg1 willStartAudioCaptureWithContext:(id)arg2 option:(id)arg3;	// IMP=0x001000000002bea2
- (void)_configureAllNodes;	// IMP=0x001000000002b983
- (void)start;	// IMP=0x001000000002b8c3
- (void)setup;	// IMP=0x001000000002b7db
