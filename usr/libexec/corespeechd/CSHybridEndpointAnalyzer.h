...
- (void).cxx_destruct;	// IMP=0x0020000000094315
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x0010000000093d2d
- (_Bool)_shouldProvideTwoShotFeedbackWithRecordContext;	// IMP=0x0010000000093ccc
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00100000000939f6
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x0010000000093981
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x00100000000938f1
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x001000000009385b
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x001000000009379e
...
- (void)getFirstAudioSampleSensorHostTimeWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000009377a
- (void)reset;	// IMP=0x0010000000093774
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000936e4
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00100000000932ce
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x00100000000932c6
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x00100000000932c0
- (void)stopEndpointer;	// IMP=0x001000000009322a
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x0010000000093182
- (void)terminateProcessing;	// IMP=0x0010000000093130
- (void)preheat;	// IMP=0x001000000009312a
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x0010000000093099
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x0010000000092fdf
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x0010000000092fce
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x0010000000092a68
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000929c8
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x0010000000092802
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x0010000000092759
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x00100000000926ac
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x00100000000924a3
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x001000000009215e
- (id)_getSerialQueueWithName:(id)arg1 targetQueue:(id)arg2;	// IMP=0x00100000000920d5
- (id)init;	// IMP=0x0010000000091a57
