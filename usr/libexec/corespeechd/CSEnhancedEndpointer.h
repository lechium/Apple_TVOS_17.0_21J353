...
@interface CSEnhancedEndpointer : NSObject
{
    ...
    float _relaxedThresholdPartial;	// 20 = 0x14
...
- (void).cxx_destruct;	// IMP=0x002000000013019d
...
- (void)updateDefaultThresholdPartial:(float)arg1 defaultThresholdRC:(float)arg2 relaxedThresholdPartial:(float)arg3 relaxedThresholdRC:(float)arg4;	// IMP=0x00100000001300e9
- (void)updateDelayedTriggerSwitch:(_Bool)arg1;	// IMP=0x00100000001300e3
- (void)didEndpointWithFeatures:(id)arg1 audioTimestampMs:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001300cd
- (id)initWithModelFile:(id)arg1 defaultThresholdPartial:(float)arg2 defaultThresholdRC:(float)arg3 relaxedThresholdPartial:(float)arg4 relaxedThresholdRC:(float)arg5 extraDelayMs:(int)arg6;	// IMP=0x00100000001300bf
