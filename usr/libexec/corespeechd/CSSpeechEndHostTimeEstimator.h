...
- (unsigned long long)estimatedSpeechEndHostTimeWithLastAudioChunkHostTime:(unsigned long long)arg1;	// IMP=0x0010000000006025
- (unsigned long long)estimatedSpeechEndHostTime;	// IMP=0x001000000000600f
- (void)notifyTrailingSilenceDurationAtEndpoint:(double)arg1;	// IMP=0x0010000000005ee6
- (void)addNumSamples:(unsigned long long)arg1 hostTime:(unsigned long long)arg2;	// IMP=0x0010000000005ed8
- (void)reset;	// IMP=0x0010000000005ebf
- (id)init;	// IMP=0x0010000000005e73
