...
- (void).cxx_destruct;	// IMP=0x00200000001357e9
...
- (id)_rtModelFromAsset:(id)arg1 requestOptions:(id)arg2 forSiriLanguage:(id)arg3 withPhraseCount:(unsigned long long)arg4;	// IMP=0x001000000013560e
- (void)keywordAnalyzerNDEAPI:(id)arg1 hasResultAvailable:(id)arg2 forChannel:(unsigned long long)arg3;	// IMP=0x001000000013543a
- (double)currentShadowMicScore;	// IMP=0x0010000000135407
- (void)processAudioChunk:(id)arg1 activeChannel:(unsigned long long)arg2;	// IMP=0x00100000001351d6
- (void)reset;	// IMP=0x00100000001351bc
- (id)initWithAsset:(id)arg1 assetConfig:(id)arg2 firstPassSource:(unsigned long long)arg3 activeChannel:(unsigned long long)arg4 siriLanguage:(id)arg5 shouldEnableShadowMicScore:(_Bool)arg6 rtmodelRequestOptions:(id)arg7;	// IMP=0x0010000000134f46
