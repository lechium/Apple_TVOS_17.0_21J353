...
- (void).cxx_destruct;	// IMP=0x00200000000fef37
...
- (id)metrics;	// IMP=0x00100000000feea1
- (void)flush;	// IMP=0x00100000000fee18
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000feb25
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000fe876
- (id)init;	// IMP=0x00100000000fe847
