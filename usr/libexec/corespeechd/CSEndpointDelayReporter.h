...
- (void).cxx_destruct;	// IMP=0x002000000004528b
...
- (void)_reportUEIUserSpeakingContext;	// IMP=0x001000000004517e
- (void)instrumentEndpointSignpostsForServerEndpointWithEndTime:(double)arg1 leadingSilence:(double)arg2 trailingSilence:(double)arg3 stopRecordingMachContinuousTime:(unsigned long long)arg4 skippedSamplesTimeInSec:(double)arg5 firstAudioSampleSensorHostTime:(unsigned long long)arg6;	// IMP=0x0010000000044fc2
- (void)reportEndpointDelayIfNeed;	// IMP=0x0010000000044fbc
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x0010000000044d1c
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2 withTrpId:(id)arg3;	// IMP=0x0010000000044c95
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x0010000000044b75
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x0010000000044a55
- (void)reset;	// IMP=0x00100000000449a8
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2 withMedocEnabled:(_Bool)arg3;	// IMP=0x001000000004482b
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x0010000000044816
