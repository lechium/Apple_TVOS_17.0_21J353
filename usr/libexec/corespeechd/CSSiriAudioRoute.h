...
- (void).cxx_destruct;	// IMP=0x002000000003b722
// Error: Property attributes should begin with the type ('T') attribute, property name: destination
...
- (id)initWithAudioDeviceID:(unsigned int)arg1;	// IMP=0x001000000003b1f6
