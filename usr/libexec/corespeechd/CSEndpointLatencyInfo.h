...
- (void).cxx_destruct;	// IMP=0x0020000000127401
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x0010000000127358
- (void)report;	// IMP=0x00100000001270c0
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x0010000000126e12
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x0010000000126d26
