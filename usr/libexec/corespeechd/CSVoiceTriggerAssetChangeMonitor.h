...
+ (id)sharedMonitor;	// IMP=0x004000000002ae70
- (void).cxx_destruct;	// IMP=0x002000000002add0
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x001000000002ad98
- (void)startMonitoring;	// IMP=0x001000000002ace6
- (id)init;	// IMP=0x001000000002ac87
