...
- (void).cxx_destruct;	// IMP=0x00200000000645e1
...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000006445a
- (void)stopEndpointer;	// IMP=0x00100000000643db
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000006435c
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x00100000000642dd
- (void)getFirstAudioSampleSensorHostTimeWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000006423b
- (void)reset;	// IMP=0x00100000000641bc
- (void)preheat;	// IMP=0x001000000006413d
- (id)init;	// IMP=0x0010000000064086
