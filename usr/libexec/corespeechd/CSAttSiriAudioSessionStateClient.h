...
- (void).cxx_destruct;	// IMP=0x0020000000112772
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00100000001122e0
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x0010000000112200
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x00100000001120fe
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000111f8a
