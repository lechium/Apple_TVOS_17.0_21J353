...
- (void).cxx_destruct;	// IMP=0x002000000010214a
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x0010000000101e3a
- (void)_calculateSpeechVoicingLevel;	// IMP=0x0010000000101ba0
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x0010000000101b5b
- (void)calculateShadowMicScore;	// IMP=0x001000000010173c
- (void)addDataToBuffer:(id)arg1;	// IMP=0x0010000000101726
- (id)init;	// IMP=0x001000000010169f
