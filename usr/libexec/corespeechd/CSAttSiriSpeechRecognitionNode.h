...
@interface CSAttSiriSpeechRecognitionNode : NSObject
{
    ...
    MISSING_TYPE *_recordingStartTime;	// 288 = 0x120
...
+ (long long)endpointModeFromEndpointMetrics:(id)arg1;	// IMP=0x0020000000085964
- (void).cxx_destruct;	// IMP=0x002000000008215d
...
- (void)_markTimeToFirstWordMetric;	// IMP=0x0010000000081a2e
- (id)_fetchRecognizerLanguageWithSiriLanguage:(id)arg1 UILanguage:(id)arg2 taskString:(id)arg3;	// IMP=0x00100000000818f2
- (double)_getFirstTokenSilenceStartTimeFromSpeechPackage:(id)arg1;	// IMP=0x00100000000817de
- (double)_getUserSpeakingEndedTimeFromSpeechPackage:(id)arg1;	// IMP=0x00100000000816bc
- (id)_sourceStringFromPreheatSource:(unsigned long long)arg1;	// IMP=0x0010000000081686
- (id)_stateToString:(unsigned long long)arg1;	// IMP=0x0010000000081667
- (void)_setLocalSpeechRecognizerState:(unsigned long long)arg1;	// IMP=0x0010000000081543
- (void)_clearAudioProcessWaitingBufferIfNeeded;	// IMP=0x00100000000814fe
- (id)_getAsrInputoriginFromContext:(id)arg1;	// IMP=0x001000000008144b
- (id)_fetchInputOriginWithRecordContext:(id)arg1;	// IMP=0x00100000000812f8
- (unsigned long long)fetchCurrentState;	// IMP=0x0010000000081148
- (void)localSpeechRecognizer:(id)arg1 didSelectRecognitionModelWithModelProperties:(id)arg2;	// IMP=0x0010000000080ec8
- (void)localSpeechRecognizer:(id)arg1 didProduceEndpointFeaturesWithWordCount:(long long)arg2 trailingSilenceDuration:(long long)arg3 eosLikelihood:(double)arg4 pauseCounts:(id)arg5 silencePosterior:(double)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x0010000000080dfb
- (void)localSpeechRecognizer:(id)arg1 didCompletionRecognitionWithStatistics:(id)arg2 error:(id)arg3;	// IMP=0x0010000000080d0e
- (void)_handleDidRecognizedSpeechPackageForEagerRecognitionCandidate:(id)arg1 multiUserSpeechPackage:(id)arg2 requestId:(id)arg3 rcId:(unsigned long long)arg4 metadata:(id)arg5;	// IMP=0x0010000000080563
- (void)_handleDidRecognizedFinalSpeechPackage:(id)arg1 multiUserSpeechPackage:(id)arg2 requestId:(id)arg3 metadata:(id)arg4;	// IMP=0x001000000008010f
- (void)localSpeechRecognizer:(id)arg1 didRecognizeMultiUserSpeechPackage:(id)arg2;	// IMP=0x0010000000080058
- (void)localSpeechRecognizer:(id)arg1 didRecognizePackage:(id)arg2 withMetadata:(id)arg3;	// IMP=0x001000000007ff73
- (void)localSpeechRecognizer:(id)arg1 didRecognizePackage:(id)arg2;	// IMP=0x001000000007febc
- (void)localSpeechRecognizer:(id)arg1 didRecognizeFinalResultCandidatePackage:(id)arg2;	// IMP=0x001000000007fe05
- (void)localSpeechRecognizer:(id)arg1 didRecognizeVoiceCommandCandidatePackage:(id)arg2 withMetadata:(id)arg3;	// IMP=0x001000000007fd20
- (void)localSpeechRecognizer:(id)arg1 didRecognizeRawEagerRecognitionCandidate:(id)arg2;	// IMP=0x001000000007fd1a
- (void)localSpeechRecognizer:(id)arg1 didProcessAudioDuration:(double)arg2;	// IMP=0x001000000007fc7d
- (MISSING_TYPE *)localSpeechRecognizer:didRecognizePartialPackage:withMetadata: /* Error: Ran out of types for this method. */;	// IMP=0x001000000007fb98
- (void)localSpeechRecognizer:(id)arg1 didRecognizeTokens:(id)arg2 withMetadata:(id)arg3;	// IMP=0x001000000007fab3
- (void)localSpeechRecognizer:(id)arg1 didRecognizeTokens:(id)arg2;	// IMP=0x001000000007f9fc
- (void)_resetLocalSpeechRecognizerParameters;	// IMP=0x001000000007f9e1
- (void)_invalidateLocalSpeechRecognizer;	// IMP=0x001000000007f916
- (id)_interactiveLocalSpeechRecognizer;	// IMP=0x001000000007f73b
- (void)_releaseRecordingTransactionIfNeededWithToken:(id)arg1;	// IMP=0x001000000007f5d5
- (void)_scheduleRecordingTransactionReleaseTimer;	// IMP=0x001000000007f464
- (void)_handleStopSpeechRecognitionTaskIfNeeded:(_Bool)arg1;	// IMP=0x001000000007f1eb
- (void)_processAudioChunk:(id)arg1 withReadyTimestamp:(id)arg2;	// IMP=0x001000000007eec3
- (_Bool)_shouldTriggerEagerResultForInterval:(double)arg1;	// IMP=0x001000000007ed69
- (void)_startLocalSpeechRecognizerIfNeeded;	// IMP=0x001000000007d6ff
- (_Bool)_shouldDisableLocalSpeechRecognizerWithOption:(id)arg1 audioRecordContext:(id)arg2;	// IMP=0x001000000007d566
- (void)_stopPreviousRecognitionTaskIfNeededWithNewRequestId:(id)arg1;	// IMP=0x001000000007d46b
- (void)prepareToStartSpeechRequestWithStartStreamOption:(id)arg1 audioRecordContext:(id)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x001000000007d386
- (void)_preheatWithLanguage:(id)arg1 preheatSource:(unsigned long long)arg2;	// IMP=0x001000000007d1f5
- (void)_preheatWithLanguage:(id)arg1 preheatSource:(unsigned long long)arg2 shouldDownloadMissingAsset:(_Bool)arg3;	// IMP=0x001000000007d16b
- (void)preheatWithLanguage:(id)arg1 source:(unsigned long long)arg2 shouldDownloadMissingAsset:(_Bool)arg3;	// IMP=0x001000000007d0c9
- (void)start;	// IMP=0x001000000007d009
- (void)attSiriNode:(id)arg1 didDetectEndpointEventAtTime:(double)arg2 eventType:(long long)arg3 withMetrics:(id)arg4;	// IMP=0x001000000007cec0
- (void)attSiriNode:(id)arg1 didDetectStartpointAtTime:(double)arg2;	// IMP=0x001000000007ceba
- (void)attSiriNode:(id)arg1 didDetectHardEndpointAtTime:(double)arg2 withMetrics:(id)arg3 usesAutomaticEndPointing:(_Bool)arg4;	// IMP=0x001000000007ce1a
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x001000000007cdcf
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000007cd42
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000007ccf4
- (void)sendSpeechCorrectionInfo:(id)arg1 interactionIdentifier:(id)arg2;	// IMP=0x001000000007cc3d
- (void)resetCacheAndCompileAllAssets;	// IMP=0x001000000007cc28
- (void)resumeLocalRecognitionWithRequestId:(id)arg1 prefixText:(id)arg2 postfixText:(id)arg3 selectedText:(id)arg4;	// IMP=0x001000000007ca97
- (void)pauseLocalSpeechRecognitionForRequestId:(id)arg1;	// IMP=0x001000000007c9b3
- (void)_disableLocalSpeechRecognitionForRequestId:(id)arg1 force:(_Bool)arg2;	// IMP=0x001000000007c849
- (void)disableLocalSpeechRecognitionForRequestId:(id)arg1;	// IMP=0x001000000007c7bc
- (void)_stopSpeechRecognitionWithReason:(unsigned long long)arg1 requestId:(id)arg2;	// IMP=0x001000000007c5ab
- (void)stopSpeechRecognitionWithReason:(unsigned long long)arg1 requestId:(id)arg2;	// IMP=0x001000000007c488
- (void)_startDeliverLocalSpeechRecognitionResultsWithRequestId:(id)arg1;	// IMP=0x001000000007c1a7
- (void)startSpeechRecognitionResultsWithSettings:(id)arg1;	// IMP=0x001000000007c0e8
- (void)_handleStopDeliverLocalSpeechRecognitionWithRequestId:(id)arg1;	// IMP=0x001000000007bf1e
- (void)_setRecordingStartTimeWithStartStreamOption:(id)arg1 audioRecordContext:(id)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x001000000007bdbe
- (void)_adjustEndpointStartTimeWithVoiceTriggerEvent:(id)arg1;	// IMP=0x001000000007b972
- (void)addRecognitionTaskCompletionReceiver:(id)arg1;	// IMP=0x001000000007b7a0
- (void)addSpeechRecognitionReceiver:(id)arg1;	// IMP=0x001000000007b6e8
- (void)addEndpointFeatureReceiver:(id)arg1;	// IMP=0x001000000007b630
- (void)addResultCandidateReceiver:(id)arg1;	// IMP=0x001000000007b578
- (void)removeReceiver:(id)arg1;	// IMP=0x001000000007b572
- (void)addReceiver:(id)arg1;	// IMP=0x001000000007b56c
- (void)stopWithReason:(unsigned long long)arg1 stopStreamOption:(id)arg2;	// IMP=0x001000000007b403
- (void)stop;	// IMP=0x001000000007b3ed
- (void)pause;	// IMP=0x001000000007b3e7
- (id)initWithLocalSpeechRecognizer:(id)arg1 isFileLoggingEnabled:(_Bool)arg2;	// IMP=0x001000000007b1f6
- (id)init;	// IMP=0x001000000007b18d
