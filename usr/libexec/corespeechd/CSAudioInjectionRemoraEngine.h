...
- (void).cxx_destruct;	// IMP=0x002000000012e157
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000012dff3
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x001000000012df3b
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x001000000012df35
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x001000000012df2f
- (void)stopAudioStream;	// IMP=0x001000000012dedd
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x001000000012de8b
- (_Bool)isRecording;	// IMP=0x001000000012ddf6
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000012ddc7
- (_Bool)injectAudio:(id)arg1;	// IMP=0x001000000012dd98
- (void)stop;	// IMP=0x001000000012dd46
- (void)start;	// IMP=0x001000000012dcf4
- (void)dealloc;	// IMP=0x001000000012dc3a
- (void)attachDevice:(id)arg1;	// IMP=0x001000000012db48
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x001000000012dab3
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x001000000012da5e
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x001000000012da56
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x001000000012d8ee
