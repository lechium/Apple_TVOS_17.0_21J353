...
+ (id)localDeviceProtocolInfo;	// IMP=0x004000000008b24c
+ (id)defaultProtocolInfo;	// IMP=0x001000000008b201
- (void).cxx_destruct;	// IMP=0x002000000008b1ce
...
- (id)description;	// IMP=0x001000000008b15a
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000008ae81
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x001000000008adb5
