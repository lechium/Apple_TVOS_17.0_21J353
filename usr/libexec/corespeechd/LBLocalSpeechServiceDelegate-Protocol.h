...
@class AFMultiUserSpeechPackage, AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, MISSING_TYPE, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTTRPCandidate, SMTTRPDetected;
...
- (MISSING_TYPE *)localSpeechServiceDidReceivedFinalResultWithRequestId:speechPackage: /* Error: Ran out of types for this method. */;
