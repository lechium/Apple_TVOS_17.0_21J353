...
+ (id)sharedDaemon;	// IMP=0x0040000000126cc5
- (void).cxx_destruct;	// IMP=0x0020000000126a26
...
- (void)_daemonWillShutdown;	// IMP=0x00100000001267fa
- (void)_setupDistnoteHandlers;	// IMP=0x00100000001267f4
- (void)_setupNotifyHandlers;	// IMP=0x00100000001267d8
- (void)_daemonDidLaunch;	// IMP=0x0010000000126570
- (void)shutdown;	// IMP=0x0010000000126558
- (void)didLaunch;	// IMP=0x0010000000126546
- (id)init;	// IMP=0x00100000001262a2
