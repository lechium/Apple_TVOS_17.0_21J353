...
+ (_Bool)isVoiceTriggerInfoAvailableLocally:(id)arg1;	// IMP=0x00400000000bae1c
+ (id)sharedInstance;	// IMP=0x00100000000badec
- (void).cxx_destruct;	// IMP=0x00200000000bab56
...
- (_Bool)_isBuiltInDeviceFromDeviceId:(id)arg1;	// IMP=0x00100000000bab01
- (void)fetchVoiceTriggerInfoWithAudioContext:(id)arg1 resultVoiceTriggerInfo:(id *)arg2 resultRTSTriggerInfo:(id *)arg3;	// IMP=0x00100000000ba86e
- (void)setVoiceTriggerInfo:(id)arg1 deviceId:(id)arg2;	// IMP=0x00100000000ba7b7
- (id)init;	// IMP=0x00100000000ba730
