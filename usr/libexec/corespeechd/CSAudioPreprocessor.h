...
- (void).cxx_destruct;	// IMP=0x00200000000ccb33
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x00100000000cc9f4
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x00100000000cc916
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x00100000000cc8e2
- (id)_fetchCurrentMetrics;	// IMP=0x00100000000cc726
- (void)_reportMetrics;	// IMP=0x00100000000cc6ab
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x00100000000cc6a5
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x00100000000cc645
- (void)flush;	// IMP=0x00100000000cc50d
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x00000000000cc2ca
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000cc095
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x00100000000cbf5f
