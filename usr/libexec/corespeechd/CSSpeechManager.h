...
+ (id)sharedManagerForCoreSpeechDaemon;	// IMP=0x002000000012167c
+ (id)sharedManager;	// IMP=0x0010000000121674
- (void).cxx_destruct;	// IMP=0x00200000001206f9
...
- (void)opportuneSpeakEventMonitor:(id)arg1 didStreamStateChanged:(_Bool)arg2;	// IMP=0x00100000001205b4
- (void)CSAudioServerCrashMonitorDidReceiveServerRestart:(id)arg1;	// IMP=0x001000000012059b
- (void)_startClearLoggingFilesTimer;	// IMP=0x00100000001204a5
- (void)_createClearLoggingFileTimer;	// IMP=0x001000000012039a
- (void)_handleClearLoggingFileTimer;	// IMP=0x0010000000120293
- (void)_reinitializeSmartSiriVolumeWithAsset:(id)arg1;	// IMP=0x0010000000120276
- (void)voiceTriggerAssetHandler:(id)arg1 endpointId:(id)arg2 didChangeCachedAsset:(id)arg3;	// IMP=0x00100000001201f7
- (void)audioRecorderWillBeDestroyed:(id)arg1;	// IMP=0x00100000001201ac
- (void)audioRecorderBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3;	// IMP=0x00100000001201a6
- (void)audioRecorderBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 arrivalTimestampToAudioRecorder:(unsigned long long)arg6 numberOfChannels:(int)arg7;	// IMP=0x00100000001201a0
- (void)audioProviderInvalidated:(id)arg1 streamHandleId:(unsigned long long)arg2;	// IMP=0x0010000000120100
- (id)_getAudioRecorderWithError:(id *)arg1;	// IMP=0x001000000011fd64
- (id)fetchFallbackAudioSessionReleaseProvider;	// IMP=0x001000000011fcab
- (id)audioProviderWithStreamID:(unsigned long long)arg1;	// IMP=0x001000000011fbee
- (id)audioProviderWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x001000000011fa0d
- (id)audioProviderWithUUID:(id)arg1;	// IMP=0x001000000011f90f
- (void)registerSiriClientProxy:(id)arg1;	// IMP=0x001000000011f86c
- (void)registerSpeechController:(id)arg1;	// IMP=0x001000000011f7b3
- (void)_getVoiceTriggerAssetIfNeeded:(CDUnknownBlockType)arg1;	// IMP=0x001000000011f70b
- (id)audioFingerprintProvider;	// IMP=0x001000000011f6f5
- (void)startManager;	// IMP=0x001000000011f468
- (void)dealloc;	// IMP=0x001000000011f3f3
- (id)init;	// IMP=0x001000000011f257
