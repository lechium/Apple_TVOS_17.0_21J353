...
- (void).cxx_destruct;	// IMP=0x002000000001d3e8
...
- (id)description;	// IMP=0x001000000001d34b
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x001000000001d2aa
