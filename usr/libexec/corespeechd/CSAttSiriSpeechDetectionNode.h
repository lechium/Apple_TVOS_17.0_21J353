...
- (void).cxx_destruct;	// IMP=0x0020000000027fca
...
- (void)_startActivation;	// IMP=0x0010000000027c37
- (void)attSiriNode:(id)arg1 didUpdateOSDFeatures:(id)arg2 withFrameDurationMs:(double)arg3;	// IMP=0x0010000000027baa
- (void)stop;	// IMP=0x0010000000027b5f
- (void)pause;	// IMP=0x0010000000027b59
- (void)start;	// IMP=0x0010000000027b0e
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000027a6b
- (void)addReceiver:(id)arg1;	// IMP=0x0010000000027974
- (id)init;	// IMP=0x00100000000278cf
