...
- (void).cxx_destruct;	// IMP=0x0020000000106e1a
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x0010000000106cb6
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x0010000000106bfe
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x0010000000106bf8
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x0010000000106bf2
- (void)stopAudioStream;	// IMP=0x0010000000106ba0
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x0010000000106b4e
- (_Bool)isRecording;	// IMP=0x0010000000106ab9
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000106a8a
- (_Bool)injectAudio:(id)arg1;	// IMP=0x0010000000106a5b
- (void)stop;	// IMP=0x0010000000106a09
- (void)start;	// IMP=0x00100000001069b7
- (void)dealloc;	// IMP=0x00100000001068fd
- (void)attachDevice:(id)arg1;	// IMP=0x001000000010680b
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x0010000000106776
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x0010000000106721
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x0010000000106719
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000001065af
