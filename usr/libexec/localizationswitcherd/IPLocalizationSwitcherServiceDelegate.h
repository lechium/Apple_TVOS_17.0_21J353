...
- (void)preferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x0010000000001e7e
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001e07
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001d90
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001c3f
