...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001bb48
- (void).cxx_destruct;	// IMP=0x002000000001c9f6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001c310
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001c018
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001c00d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001be45
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001bb50
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001b9da
