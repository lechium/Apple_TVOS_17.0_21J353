...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000006dae
- (void).cxx_destruct;	// IMP=0x0020000000007d17
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000075c7
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000072a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000729a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000070c2
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000006db6
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000006c16
