...
- (void).cxx_destruct;	// IMP=0x002000000000bbdb
@property(retain) ACAccount *activeiTunesAccount; // @synthesize activeiTunesAccount=_activeiTunesAccount;
@property(readonly, nonatomic) ACAccountStore *accountStore; // @synthesize accountStore=_accountStore;
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x001000000000bb34
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x001000000000bb2c
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x001000000000ba9a
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x001000000000ba92
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x001000000000ba70
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x001000000000b817
- (void)dealloc;	// IMP=0x001000000000b7a2
- (id)initWithAccountStore:(id)arg1;	// IMP=0x001000000000b6b7
