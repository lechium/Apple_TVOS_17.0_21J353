...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000d7d2
- (void).cxx_destruct;	// IMP=0x002000000000e305
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000dcf8
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000db76
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000d9e5
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000d7da
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x001000000000d67f
