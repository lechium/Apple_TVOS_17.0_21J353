...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000be58
- (void).cxx_destruct;	// IMP=0x001000000000d5c5
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x001000000000d3a8
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x001000000000d0f2
- (id)featureWithClass:(Class)arg1;	// IMP=0x001000000000cfa8
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000c5c5
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000c38d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000c13d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000be60
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x001000000000be17
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x001000000000bc14
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x001000000000d645
...
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x001000000000fd80
