...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000002278
- (void).cxx_destruct;	// IMP=0x00200000000034fb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000002ba5
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000027f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000027e5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000025a5
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000002280
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0010000000002090
