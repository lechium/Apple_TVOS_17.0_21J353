...
@class ASCJSClientObject, MISSING_TYPE, NSDictionary, _TtC19appstorecomponentsd12JSUserObject, _TtC19appstorecomponentsd14JSArcadeObject, _TtC19appstorecomponentsd20JSAppleSiliconObject, _TtC19appstorecomponentsd20JSFeatureFlagsObject, _TtC19appstorecomponentsd20JSStoreMetricsObject, _TtC19appstorecomponentsd22JSClientOrderingObject, _TtC19appstorecomponentsd28JSPersonalizationStoreObject;
@protocol JSExport;
...
- (void).cxx_destruct;	// IMP=0x0040000000089050
- (id)init;	// IMP=0x0010000000088ff0
@property(nonatomic, readonly) _TtC19appstorecomponentsd20JSFeatureFlagsObject *featureFlags; // @synthesize featureFlags;
...
@property(nonatomic, readonly) id <JSExport> loc; // @synthesize loc;
