...
- (void).cxx_destruct;	// IMP=0x002000000000ccc8
...
- (void)userAccountRegistry:(id)arg1 willPerformMigrationIfRequiredWithBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ca79
- (id)_securityTaskForCurrentConnection;	// IMP=0x000000000000ca60
- (id)init;	// IMP=0x001000000000c89f
