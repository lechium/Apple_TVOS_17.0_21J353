...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x0040000000097555
- (void).cxx_destruct;	// IMP=0x0020000000097d16
...
- (id)description;	// IMP=0x00100000000974d3
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00100000000971f7
