...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x0040000000096ee2
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x0010000000096e5e
+ (void)removeAllTaskInfo;	// IMP=0x0010000000096e23
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x0010000000096cb5
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x0010000000096ca3
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x0010000000096ba4
- (void).cxx_destruct;	// IMP=0x0020000000097155
...
- (id)initWithTask:(id)arg1;	// IMP=0x0010000000096c0f
