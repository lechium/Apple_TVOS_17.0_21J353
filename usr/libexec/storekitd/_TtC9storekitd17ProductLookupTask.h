...
- (void).cxx_destruct;	// IMP=0x00400000000e5a20
- (id)initWithoutKeepAlive;	// IMP=0x00100000000e59c0
- (id)init;	// IMP=0x00100000000e5990
- (void)main;	// IMP=0x00100000000e5860
- (id)initWithClient:(id)arg1 productID:(id)arg2 keyProfile:(id)arg3 logKey:(id)arg4 parameters:(id)arg5;	// IMP=0x00100000000e37b0
