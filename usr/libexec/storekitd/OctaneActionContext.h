...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x004000000006c6f8
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x001000000006c694
- (void).cxx_destruct;	// IMP=0x002000000006c748
...
- (id)init;	// IMP=0x001000000006c5f2
