...
@class MISSING_TYPE, NSArray, NSNumber, NSString, NSUUID;
...
@interface AssetRequestProperties : NSObject
{
    ...
    MISSING_TYPE *_taskPriority;	// 160 = 0xa0
}

- (void).cxx_destruct;	// IMP=0x0020000000079938
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007943e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007942c
- (id)init;	// IMP=0x00100000000793b9
