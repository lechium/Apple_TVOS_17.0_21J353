...
+ (id)inMemoryDatabaseSharedCacheFlag;	// IMP=0x0020000000079268
+ (id)inMemoryDatabaseFlag;	// IMP=0x001000000007925b
- (void).cxx_destruct;	// IMP=0x0020000000079386
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000079275
- (_Bool)isInMemoryDatabase;	// IMP=0x0010000000079202
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x00100000000791ed
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x00100000000791db
- (id)initInMemoryDatabaseWithName:(id)arg1;	// IMP=0x00100000000790fd
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x0010000000079070
