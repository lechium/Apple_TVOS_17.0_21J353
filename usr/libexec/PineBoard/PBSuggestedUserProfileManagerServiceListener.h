...
- (void).cxx_destruct;	// IMP=0x00200000001c312c
@property(retain, nonatomic) BSServiceConnectionListener *listener; // @synthesize listener=_listener;
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000001c2e7b
- (void)invalidate;	// IMP=0x00100000001c2df9
- (void)activate;	// IMP=0x00100000001c2c9a
