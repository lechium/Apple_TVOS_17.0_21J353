...
+ (double)_transitionDuration;	// IMP=0x002000000002958c
- (void).cxx_destruct;	// IMP=0x00200000000296f5
...
- (void)_transitionWithAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000295ab
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000292f8
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000028faf
...
- (id)initWithChildViewController:(id)arg1;	// IMP=0x0010000000028f2d
