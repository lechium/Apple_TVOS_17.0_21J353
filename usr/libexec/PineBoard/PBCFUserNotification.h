...
+ (id)_localizedDefaultButtonTitle;	// IMP=0x00200000001a5c74
+ (id)_defaultLocalizationBundle;	// IMP=0x00100000001a5b79
- (void).cxx_destruct;	// IMP=0x00200000001a723c
...
- (long long);	// IMP=0x00100000001a6fab
- (id)description;	// IMP=0x00100000001a6e6e
- (void)cancel;	// IMP=0x00100000001a6e54
- (void)_sendResponse:(unsigned long long)arg1 customButtonResponse:(long long)arg2;	// IMP=0x00100000001a6a35
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x00100000001a6851
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x00100000001a67fc
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x00100000001a6722
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x00100000001a6711
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x00100000001a5d6d
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00100000001a5cd1
