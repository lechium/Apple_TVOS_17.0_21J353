...
- (void).cxx_destruct;	// IMP=0x0020000000009bd3
...
- (id)_createAnimationTransaction;	// IMP=0x0010000000009b14
- (void)animateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000985f
- (id)initWithContainingView:(id)arg1 goingFullScreenLayout:(id)arg2 goingToPIPLayout:(id)arg3 quadrant:(long long)arg4 currentPIPInsets:(struct UIEdgeInsets)arg5;	// IMP=0x0010000000009785
