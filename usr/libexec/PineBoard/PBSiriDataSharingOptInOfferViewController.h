...
- (void).cxx_destruct;	// IMP=0x002000000006accd
@property(nonatomic) __weak id <PBSiriDataSharingOptInOfferViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_didNotCompleteOptIn;	// IMP=0x001000000006ac51
- (void)_optOut;	// IMP=0x001000000006ac02
- (void)_optIn;	// IMP=0x001000000006abb0
- (void)_handleHomeButton:(id)arg1;	// IMP=0x001000000006ab5d
- (void)_handleMenuButton:(id)arg1;	// IMP=0x001000000006ab0a
- (void)viewDidLoad;	// IMP=0x001000000006a333
