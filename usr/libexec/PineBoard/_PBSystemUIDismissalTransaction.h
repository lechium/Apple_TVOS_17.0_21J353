...
- (void).cxx_destruct;	// IMP=0x0020000000071654
...
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000071609
- (void)_begin;	// IMP=0x001000000007143c
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000007134d
