...
+ (id)_connectedDevicesFromDevices:(id)arg1;	// IMP=0x002000000006fd3a
+ (id)sharedInstance;	// IMP=0x001000000006f73f
- (void).cxx_destruct;	// IMP=0x00200000000708b5
...
- (void)_signalReloadDevicesSource;	// IMP=0x0010000000070800
- (void)_workQueue_reloadDevices;	// IMP=0x001000000007013f
- (void)_workQueue_activate;	// IMP=0x001000000006fd7d
- (void)_handleBluetoothManagerNotificationHandler:(id)arg1;	// IMP=0x001000000006fd27
- (void)centralManager:(id)arg1 didDisconnectPeripheral:(id)arg2 error:(id)arg3;	// IMP=0x001000000006fd14
- (void)centralManager:(id)arg1 didConnectPeripheral:(id)arg2;	// IMP=0x001000000006fd01
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x001000000006fcfb
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x001000000006fce8
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x001000000006fcd5
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x001000000006fcc2
@property(readonly, nonatomic) NSArray *connectedDevices;
@property(readonly, nonatomic) NSArray *pairedDevices;
- (void)activate;	// IMP=0x001000000006f933
- (void)dealloc;	// IMP=0x001000000006f867
- (id)_init;	// IMP=0x001000000006f7dc
- (id)init;	// IMP=0x001000000006f7d6
