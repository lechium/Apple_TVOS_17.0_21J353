...
- (void).cxx_destruct;	// IMP=0x0020000000129b02
...
- (void)invalidate;	// IMP=0x0010000000129a2f
- (void)dealloc;	// IMP=0x00100000001299f1
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000129976
