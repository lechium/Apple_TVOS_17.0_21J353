...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0020000000168600
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001685fa
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001685e7
