...
- (void).cxx_destruct;	// IMP=0x00200000001c579f
...
- (void)invalidateImage;	// IMP=0x00100000001c5717
- (id)fetchImage;	// IMP=0x00100000001c50a8
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x00100000001c4f5d
- (id)init;	// IMP=0x00100000001c4f4f
