...
- (void).cxx_destruct;	// IMP=0x002000000001f091
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x001000000001eb54
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x001000000001e943
- (void)queue_processUpdates:(id)arg1;	// IMP=0x001000000001cfe3
- (void)languageDidChange;	// IMP=0x001000000001cd4f
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x001000000001c9f7
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x001000000001c8ee
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x001000000001c7e5
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x001000000001c791
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x001000000001c73d
- (id)appInfoControllerWithEnabledApps;	// IMP=0x001000000001c6ca
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x001000000001c657
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x001000000001c5e4
- (id)appInfoControllerWithEverything;	// IMP=0x001000000001c5a8
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x001000000001c449
- (void)removeObserver:(id)arg1;	// IMP=0x001000000001c39d
- (id)addObserver:(id)arg1;	// IMP=0x001000000001c1d0
- (id)configuration;	// IMP=0x001000000001c0f4
- (id)appInfos;	// IMP=0x001000000001bfd9
- (void)dealloc;	// IMP=0x001000000001be23
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x001000000001b090
