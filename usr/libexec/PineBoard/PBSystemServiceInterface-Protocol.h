...
@class INDateComponentsRange, MISSING_TYPE, NSArray, NSDictionary, NSNumber, NSString, NSXPCListenerEndpoint, PBSAudioUpsellConfiguration;

@protocol PBSystemServiceInterface <NSObject>
@property(readonly, nonatomic) _Bool hiliteModeActive;
- (void)listen;
- (void)getHeadphoneBannerServiceProxyWithReply:(void (^)(id <PBSHeadphoneBannerServiceInterface>))arg1;
- (void)getScheduledSleepServiceProxyWithReply:(void (^)(id <PBSScheduledSleepServiceInterface>))arg1;
- (void)getEARCConfiguratorServiceProxyWithReply:(void (^)(id <PBSEARCConfiguratorServiceInterface>))arg1;
...
- (void)getRestrictionServiceProxyWithReply:(void (^)(id <PBSRestrictionServiceInterface_Internal>))arg1;
...
- (void)presentControlCenterRoutePickerWithCompletion:(void (^)(_Bool))arg1;
...
- (void)presentAudioUpsellWithConfiguration:(PBSAudioUpsellConfiguration *)arg1 completion:(void (^)(_Bool))arg2;
...
- (MISSING_TYPE *)registerNowPlayingDelegate: /* Error: Ran out of types for this method. */;
@end
