...
- (void).cxx_destruct;	// IMP=0x002000000006bcc5
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000006b59d
- (void)setServiceDelegate:(id)arg1;	// IMP=0x001000000006b544
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x001000000006b051
- (void)invalidate;	// IMP=0x001000000006b04b
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x001000000006aced
- (id)init;	// IMP=0x001000000006acdf
