...
+ (id)requestWithBundleIdentifier:(id)arg1;	// IMP=0x0020000000054887
- (void).cxx_destruct;	// IMP=0x0020000000054cd5
...
- (unsigned long long)hash;	// IMP=0x0010000000054bab
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000054997
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000548fe
