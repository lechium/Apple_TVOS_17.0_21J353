...
- (void).cxx_destruct;	// IMP=0x00200000001720ff
...
- (void)_didSelectButton:(id)arg1;	// IMP=0x0010000000171f89
@property(copy, nonatomic) NSString *descriptionText;
@property(copy, nonatomic) NSString *title;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000171654
- (id)preferredFocusEnvironments;	// IMP=0x0010000000171503
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000017036c
