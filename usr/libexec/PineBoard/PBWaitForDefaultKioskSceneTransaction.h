...
- (void).cxx_destruct;	// IMP=0x0020000000072328
...
- (void)_stopObserving;	// IMP=0x0010000000072276
- (void)sceneManager:(id)arg1 willDestroyScene:(id)arg2;	// IMP=0x0010000000072204
- (void)sceneManager:(id)arg1 didCreateScene:(id)arg2;	// IMP=0x001000000007217d
- (void)sceneContentStateDidChange:(id)arg1;	// IMP=0x0010000000072140
- (void)_didComplete;	// IMP=0x00100000000720e2
- (void)_begin;	// IMP=0x0010000000071f2d
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000071f25
@property(readonly, nonatomic) FBScene *readyDefaultKioskScene;
- (void)dealloc;	// IMP=0x0010000000071e1f
- (id)init;	// IMP=0x0010000000071ce5
