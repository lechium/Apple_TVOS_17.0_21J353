...
- (id)description;	// IMP=0x00100000000f21d1
- (unsigned long long)hash;	// IMP=0x00100000000f1e41
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f1ab0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f18be
