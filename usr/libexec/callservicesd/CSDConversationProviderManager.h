...
+ (id)errorForDisabledPseudonyms;	// IMP=0x002000000019cf73
+ (id)errorForUnregisteredProviderIdentifier:(id)arg1;	// IMP=0x001000000019ce86
+ (id)sharedInstance;	// IMP=0x001000000019b3c6
- (void).cxx_destruct;	// IMP=0x002000000019d3bb
...
- (void)createProcessMonitorIfNecessary:(id)arg1 forClient:(id)arg2;	// IMP=0x001000000019d031
- (id)serviceForProvider:(id)arg1;	// IMP=0x001000000019cbb7
- (void)doesHandle:(id)arg1 correspondToConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000019c9cc
- (void)revokePseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000019c849
- (void)renewPseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 expirationDate:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000019c68a
- (void)generatePseudonymHandleForConversationProvider:(id)arg1 expiryDuration:(double)arg2 URI:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000019c433
- (id)tuConversationProviderForIdentifier:(id)arg1;	// IMP=0x001000000019c397
- (id)conversationProviderForIdentifier:(id)arg1;	// IMP=0x001000000019c2f1
- (void)registerConversationProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000019bae4
- (id)providerIdentifiersForClient:(id)arg1;	// IMP=0x001000000019b9b6
- (void)stopTrackingClient:(id)arg1;	// IMP=0x001000000019b875
- (void)startTrackingClient:(id)arg1 forProviderIdentifier:(id)arg2;	// IMP=0x001000000019b527
- (id)init;	// IMP=0x001000000019b44b
