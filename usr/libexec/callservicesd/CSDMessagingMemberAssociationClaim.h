...
- (void).cxx_destruct;	// IMP=0x00100000000d4458
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d4265
- (unsigned long long)hash;	// IMP=0x00100000000d4160
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d3fbf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d3e6b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d3d69
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d3c65
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d3c58
- (id)dictionaryRepresentation;	// IMP=0x00100000000d3659
- (id)description;	// IMP=0x00100000000d35aa
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x00100000001b1d4a
