...
+ (id)dataForProviders:(id)arg1;	// IMP=0x002000000018687a
- (void).cxx_destruct;	// IMP=0x0020000000187bb2
...
- (void)didChangeRelayCallingAvailability;	// IMP=0x0010000000187aba
- (void)callsChangedForCallCenterObserver:(id)arg1;	// IMP=0x00100000001877a3
- (void)handleApplicationUnregisteredNotification:(id)arg1;	// IMP=0x00100000001876e1
- (id)_providersForPreferenceKey:(id)arg1;	// IMP=0x0010000000187296
- (id)_providersForKeychainItem:(id)arg1;	// IMP=0x0010000000186d8d
- (void)_saveProviders:(id)arg1 forKeychainItem:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000186b41
- (void)moveExistingPreferencesToKeychain;	// IMP=0x0010000000186511
- (_Bool)isProviderInstalled:(id)arg1;	// IMP=0x0010000000186427
- (void)removeLinksForFilenamesNotInArray:(id)arg1;	// IMP=0x0010000000186331
- (id)createLinkIfNecessaryWithFilename:(id)arg1 toURL:(id)arg2;	// IMP=0x00100000001861a0
- (_Bool)isSymbolicLinkAtURL:(id)arg1;	// IMP=0x0010000000186022
- (void)openUserActivity:(id)arg1 usingApplicationWithBundleIdentifier:(id)arg2 frontBoardOptions:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000185e42
@property(readonly, nonatomic, getter=isDevicePasscodeLocked) _Bool devicePasscodeLocked;
- (id)dialAssistedDialRequestForDialRequest:(id)arg1;	// IMP=0x0010000000185dbd
...
- (void)dealloc;	// IMP=0x0010000000185130
- (id)initWithSerialQueue:(id)arg1 localKeychainItem:(id)arg2 pairedHostKeychainItem:(id)arg3;	// IMP=0x0010000000184de5
- (id)initWithSerialQueue:(id)arg1;	// IMP=0x0010000000184c8f
