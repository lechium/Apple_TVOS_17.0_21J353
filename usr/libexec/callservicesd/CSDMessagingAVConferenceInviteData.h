...
- (void).cxx_destruct;	// IMP=0x001000000009844d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009835b
- (unsigned long long)hash;	// IMP=0x00100000000982ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009820e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009814a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000980c7
- (void)writeTo:(id)arg1;	// IMP=0x001000000009804d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000098040
- (id)dictionaryRepresentation;	// IMP=0x0010000000097e0a
- (id)description;	// IMP=0x0010000000097d5b
...
- (id)initWithFaceTimeInviteDictionary:(id)arg1;	// IMP=0x0010000000091d54
- (id)initWithRelayInviteDictionary:(id)arg1;	// IMP=0x0010000000091c7f
