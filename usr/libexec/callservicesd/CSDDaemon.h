...
- (void).cxx_destruct;	// IMP=0x0020000000093dcc
...
- (void)propertiesDidChangeForConfiguration:(id)arg1;	// IMP=0x0010000000093b4f
- (void)_setUpSandbox;	// IMP=0x0010000000093b34
- (id)_setUpTemporaryDirectory;	// IMP=0x00100000000939c8
- (void)_setUpLanguageChangeListener;	// IMP=0x001000000009390e
@property(readonly, copy) NSString *debugDescription;
- (void)_observeSignal:(int)arg1 usingHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000009364b
- (void)dealloc;	// IMP=0x00100000000934c9
- (id)init;	// IMP=0x0010000000092025
