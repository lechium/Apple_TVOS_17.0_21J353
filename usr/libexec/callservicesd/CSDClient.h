...
- (void).cxx_destruct;	// IMP=0x0010000000163234
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x001000000016318b
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x0010000000163183
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x0010000000163077
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x0010000000162dd0
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000162d6d
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000162c0c
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000162b1d
