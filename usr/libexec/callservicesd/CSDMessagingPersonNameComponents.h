...
- (void).cxx_destruct;	// IMP=0x00100000000c7a9c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000c7880
- (unsigned long long)hash;	// IMP=0x00100000000c77a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c7619
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c74ae
- (void)copyTo:(id)arg1;	// IMP=0x00100000000c73ab
- (void)writeTo:(id)arg1;	// IMP=0x00100000000c72bd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000c72b0
- (id)dictionaryRepresentation;	// IMP=0x00100000000c6ece
- (id)description;	// IMP=0x00100000000c6e1f
...
- (id)initWithPersonNameComponents:(id)arg1;	// IMP=0x00100000000b3c6d
