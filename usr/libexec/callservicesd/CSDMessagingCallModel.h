...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000466ec
- (unsigned long long)hash;	// IMP=0x001000000004660d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004643c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000046334
- (void)copyTo:(id)arg1;	// IMP=0x001000000004624f
- (void)writeTo:(id)arg1;	// IMP=0x0010000000046135
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000046128
- (id)dictionaryRepresentation;	// IMP=0x0010000000045968
- (id)description;	// IMP=0x00100000000458b9
