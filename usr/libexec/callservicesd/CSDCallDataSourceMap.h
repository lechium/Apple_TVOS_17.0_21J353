...
- (void).cxx_destruct;	// IMP=0x0020000000162048
...
- (id)callsForDataSource:(id)arg1 identifier:(id)arg2;	// IMP=0x0010000000161f43
- (void)addCalls:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000161c16
@property(readonly, copy, nonatomic) NSArray *dataSources;
- (id)init;	// IMP=0x0010000000161b69
