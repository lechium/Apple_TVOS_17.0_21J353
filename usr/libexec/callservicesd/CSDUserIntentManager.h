...
- (void).cxx_destruct;	// IMP=0x00400000001f080a
- (id)init;	// IMP=0x00100000001f07d5
- (_Bool)validateUserIntentForCallSource:(id)arg1;	// IMP=0x00100000001f0758
- (void)donateUserIntentForCallProviderIdentifier:(id)arg1;	// IMP=0x00100000001f0189
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000001f00b5
