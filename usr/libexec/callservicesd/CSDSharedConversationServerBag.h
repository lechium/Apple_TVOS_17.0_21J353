...
- (void).cxx_destruct;	// IMP=0x004000000022820a
- (id)init;	// IMP=0x00100000002281c9
...
- (_Bool)gftaasPseudonymsEnabled:(id)arg1;	// IMP=0x0010000000227fbc
- (_Bool)isGuestModeSupported;	// IMP=0x0010000000227f20
- (_Bool)isUPlusNDowngradeAvailable;	// IMP=0x0010000000227ed4
@property(nonatomic, readonly) unsigned long long maxRemoteSpatialPersonaParticipants;
- (_Bool)isGFTDowngradeToOneToOneAvailable;	// IMP=0x0010000000227e40
...
- (id)stableBundleIdentifierForLocalBundleIdentifier:(id)arg1;	// IMP=0x0010000000227d2d
@property(nonatomic, readonly) unsigned long long handoffAudioDeviceTimeout;
- (id)localBundleIDForActivityIdentifier:(id)arg1;	// IMP=0x0010000000227b4a
...
- (_Bool)isSharePlayVersionCheckEnabled;	// IMP=0x00100000002274d0
- (_Bool)isModernGFTEnabled;	// IMP=0x0010000000227484
- (_Bool)isAutomaticUpgradingEnabled;	// IMP=0x0010000000227438
