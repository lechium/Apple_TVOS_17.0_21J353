...
- (void).cxx_destruct;	// IMP=0x002000000005e90f
...
- (id)groupUUID;	// IMP=0x001000000005e360
- (id)UUID;	// IMP=0x001000000005e34e
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x001000000005e0df
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x001000000005dfab
