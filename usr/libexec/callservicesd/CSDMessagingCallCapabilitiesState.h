...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000131fb3
- (unsigned long long)hash;	// IMP=0x0010000000131f6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000131e9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000131e1e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000131dc0
- (void)writeTo:(id)arg1;	// IMP=0x0010000000131d4b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000131d3e
- (id)dictionaryRepresentation;	// IMP=0x00100000001319f4
- (id)description;	// IMP=0x0010000000131945
- (_Bool);	// IMP=0x0010000000131931
...
- (id)initWithCallCapabilitiesState:(id)arg1;	// IMP=0x001000000012e5d7
