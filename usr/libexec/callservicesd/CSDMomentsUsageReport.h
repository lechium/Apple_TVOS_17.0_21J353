...
- (id)init;	// IMP=0x004000000024356e
@property(nonatomic, readonly) NSString *description;
- (id)initWithAvailability:(int)arg1 photoRequestSuccessCount:(long long)arg2 photoRequestFailureCount:(long long)arg3 medianRequestDuration:(double)arg4 meanRequestDuration:(double)arg5;	// IMP=0x00100000002432f4
