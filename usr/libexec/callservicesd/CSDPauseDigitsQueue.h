...
- (void).cxx_destruct;	// IMP=0x00200000000afaf2
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000af6e1
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000af5e3
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000af536
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000af245
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000af1ae
- (id)init;	// IMP=0x00100000000af124
