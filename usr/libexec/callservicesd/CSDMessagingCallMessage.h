...
- (void).cxx_destruct;	// IMP=0x001000000012e5a6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000012e3b6
- (unsigned long long)hash;	// IMP=0x001000000012e27f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012e066
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000012def7
- (void)copyTo:(id)arg1;	// IMP=0x001000000012ddc7
- (void)writeTo:(id)arg1;	// IMP=0x001000000012dc75
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000012dc68
- (id)dictionaryRepresentation;	// IMP=0x001000000012d351
- (id)description;	// IMP=0x001000000012d2a2
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000012d025
- (id)typeAsString:(int)arg1;	// IMP=0x001000000012cfdc
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x00100000000141d2
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x0010000000014094
- (_Bool)wantsVideo;	// IMP=0x0010000000014082
