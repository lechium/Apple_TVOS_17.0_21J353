...
- (void).cxx_destruct;	// IMP=0x0040000000269753
- (id)init;	// IMP=0x001000000026971d
- (id)initWithStreamToken:(unsigned long long)arg1 requesterID:(id)arg2;	// IMP=0x00100000002696d6
