...
@class IDSAccount, IDSDevice, IDSGroupSessionParticipantUpdate, IDSMessageContext, IDSProtobuf, IDSService, IDSSession, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSSet, NSString, NSURL;
...
- (MISSING_TYPE *)service:account:identifier:sentBytes:totalBytes: /* Error: Ran out of types for this method. */;
