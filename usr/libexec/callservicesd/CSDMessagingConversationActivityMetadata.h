...
- (void).cxx_destruct;	// IMP=0x002000000016438e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000016416e
- (unsigned long long)hash;	// IMP=0x0010000000164042
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000163e5e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000163ced
- (void)copyTo:(id)arg1;	// IMP=0x0010000000163bcc
- (void)writeTo:(id)arg1;	// IMP=0x0010000000163aa9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000163a9c
- (id)dictionaryRepresentation;	// IMP=0x0010000000163471
- (id)description;	// IMP=0x00100000001633c2
