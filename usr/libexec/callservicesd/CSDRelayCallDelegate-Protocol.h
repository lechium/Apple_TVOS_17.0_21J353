...
@class CSDRelayCall, MISSING_TYPE, NSError, NSString, TUAnswerRequest, TUCall, TUCallProvider;

@protocol CSDRelayCallDelegate <NSObject>
- (void)relayCallDidPerformUplinkMuted:(CSDRelayCall *)arg1 uplinkMuted:(_Bool)arg2;
- (void)relayCallConferenceDidStop:(CSDRelayCall *)arg1 cleanly:(_Bool)arg2 error:(NSError *)arg3;
- (MISSING_TYPE *)relayCallConferenceFailedToStart: /* Error: Ran out of types for this method. */;
...
- (void)relayCallDidJoin:(CSDRelayCall *)arg1;
