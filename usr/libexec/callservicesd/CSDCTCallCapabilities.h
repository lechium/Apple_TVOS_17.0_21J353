...
+ (id)callCapabilitiesForCallManagementStateInfo:(id)arg1;	// IMP=0x00400000000751c4
+ (id)callCapabilitiesForCTCallCapabilities:(id)arg1;	// IMP=0x00100000000750e6
...
- (id)debugDescription;	// IMP=0x0010000000075433
- (id)description;	// IMP=0x0010000000075421
