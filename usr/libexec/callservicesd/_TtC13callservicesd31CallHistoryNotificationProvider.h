...
@interface _TtC13callservicesd31CallHistoryNotificationProvider : NSObject
{
    ...
    MISSING_TYPE *supportsDisplayingFaceTimeAudioCalls;	// 5 = 0x5
    MISSING_TYPE *openURL;	// 27 = 0x1b
    MISSING_TYPE *dialRecentCall;	// 1702125407 = 0x65745f5f
    ...
    MISSING_TYPE *add;	// 12776 = 0x31e8
    MISSING_TYPE *replace;	// 2965375 = 0x2d3f7f
    MISSING_TYPE *removeNotification;	// 12776 = 0x31e8
    MISSING_TYPE *updateBadgeValue;	// 0 = 0x0
}

- (void).cxx_destruct;	// IMP=0x0040000000271b55
- (id)init;	// IMP=0x001000000026d3b1
