...
- (void).cxx_destruct;	// IMP=0x002000000013645a
...
- (id)description;	// IMP=0x0010000000135d2c
- (void)updateWithProminenceRelayMessage:(id)arg1;	// IMP=0x001000000013596f
- (void)updateWithRelayMessage:(id)arg1;	// IMP=0x001000000013578a
- (id)initWithRelayMessage:(id)arg1 queue:(id)arg2;	// IMP=0x00100000001354e2
