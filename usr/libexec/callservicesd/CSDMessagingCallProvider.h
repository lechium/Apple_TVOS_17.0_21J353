...
+ (Class)emergencyHandlesType;	// IMP=0x00200000000823bb
+ (Class)prioritizedSenderIdentitiesType;	// IMP=0x00100000000822e9
+ (Class)emergencyLabeledHandlesType;	// IMP=0x00100000000821cc
+ (Class)handoffIdentifierType;	// IMP=0x0010000000081fcc
- (void).cxx_destruct;	// IMP=0x0010000000085491
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000084ced
- (unsigned long long)hash;	// IMP=0x0010000000084abd
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008473c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000084015
- (void)copyTo:(id)arg1;	// IMP=0x0010000000083bdb
- (void)writeTo:(id)arg1;	// IMP=0x001000000008365d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000083650
- (id)dictionaryRepresentation;	// IMP=0x001000000008247b
- (id)description;	// IMP=0x00100000000823cc
- (id)emergencyHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000008239e
- (unsigned long long)emergencyHandlesCount;	// IMP=0x0010000000082381
- (void)addEmergencyHandles:(id)arg1;	// IMP=0x0010000000082317
- (void)clearEmergencyHandles;	// IMP=0x00100000000822fa
- (id)prioritizedSenderIdentitiesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000822cc
- (unsigned long long)prioritizedSenderIdentitiesCount;	// IMP=0x00100000000822af
- (void)addPrioritizedSenderIdentities:(id)arg1;	// IMP=0x0010000000082245
- (void)clearPrioritizedSenderIdentities;	// IMP=0x0010000000082228
@property(nonatomic) _Bool hasSupportsRecents;
- (id)emergencyLabeledHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000821af
- (unsigned long long)emergencyLabeledHandlesCount;	// IMP=0x0010000000082192
- (void)addEmergencyLabeledHandles:(id)arg1;	// IMP=0x0010000000082128
- (void)clearEmergencyLabeledHandles;	// IMP=0x001000000008210b
- (void)setProtoSupportedHandleTypes:(unsigned int *)arg1 count:(unsigned long long)arg2;	// IMP=0x00100000000820f4
- (unsigned int)protoSupportedHandleTypeAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000082024
- (void)addProtoSupportedHandleType:(unsigned int)arg1;	// IMP=0x0010000000082011
- (void)clearProtoSupportedHandleTypes;	// IMP=0x0010000000082000
...
- (id)handoffIdentifierAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000081faf
- (unsigned long long)handoffIdentifiersCount;	// IMP=0x0010000000081f92
- (void)addHandoffIdentifier:(id)arg1;	// IMP=0x0010000000081f28
- (void)clearHandoffIdentifiers;	// IMP=0x0010000000081f0b
@property(readonly, nonatomic) _Bool hasOriginalRingtoneSoundURLString;
// Error: Property attributes should begin with the type ('T') attribute, property name: hasRingtoneSoundURLString
...
- (void)dealloc;	// IMP=0x0010000000081ca8
...
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000000b046d
