...
+ (id)greenTeaLeaveContext;	// IMP=0x00400000000b034b
@property(nonatomic) unsigned long long leaveReason; // @synthesize leaveReason=_leaveReason;
- (id)description;	// IMP=0x00100000000b0379
- (id)initWithLeaveReason:(unsigned long long)arg1;	// IMP=0x00100000000b030e
