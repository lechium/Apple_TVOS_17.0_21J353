...
- (void).cxx_destruct;	// IMP=0x0020000000161b07
...
- (unsigned long long)hash;	// IMP=0x0010000000161625
- (_Bool)isEqualToParticipant:(id)arg1;	// IMP=0x0010000000161156
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001610f9
- (_Bool)pseudonym;	// IMP=0x001000000016108b
...
- (id)description;	// IMP=0x0010000000160791
- (id)initWithIDSDictionaryRepresentation:(id)arg1;	// IMP=0x00100000001605b8
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3;	// IMP=0x00100000001605a3
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3 senderCorrelationIdentifier:(id)arg4;	// IMP=0x0010000000160418
