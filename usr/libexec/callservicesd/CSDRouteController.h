...
+ (id)makePairedHostDeviceRouteController;	// IMP=0x00200000002853df
+ (id)makeLocalRouteController;	// IMP=0x00100000002851eb
- (void).cxx_destruct;	// IMP=0x0040000000286ef0
- (id)init;	// IMP=0x0010000000286eba
- (void)didUpdateRouteRecommendations;	// IMP=0x0010000000286e92
- (void)handleUpdatedPairedHostDeviceRoutes:(id)arg1;	// IMP=0x0010000000286ad0
- (void)clearState;	// IMP=0x001000000028684d
- (void)pickRouteWithUniqueIdentifier:(id)arg1 shouldWaitUntilAvailable:(_Bool)arg2;	// IMP=0x0010000000286516
