...
- (void).cxx_destruct;	// IMP=0x0020000000013588
...
- (id)reportedActivityType;	// IMP=0x00100000000134db
- (id)eventPayload;	// IMP=0x00100000000133df
- (id)eventName;	// IMP=0x00100000000133d2
