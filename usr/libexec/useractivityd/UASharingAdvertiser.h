...
- (void).cxx_destruct;	// IMP=0x002000000008e483
...
- (id)statusString;	// IMP=0x001000000008cf6f
- (_Bool)pasteboardBitValue;	// IMP=0x001000000008cd94
- (_Bool)pasteboardAvailible;	// IMP=0x001000000008cbab
- (void)removeIOPowerManagerUserIdleNotifications;	// IMP=0x001000000008cb58
- (void)scheduleIOPowerManagerUserIdleNotifications;	// IMP=0x001000000008cb02
@property _Bool userIsCurrent; // @synthesize userIsCurrent=_userIsCurrent;
- (_Bool)resume;	// IMP=0x001000000008c8a0
- (_Bool)suspend;	// IMP=0x001000000008c7c7
- (_Bool)active;	// IMP=0x001000000008c736
- (_Bool)okToSuspendAdvertising;	// IMP=0x001000000008c662
- (_Bool)scheduleAdvertisementUpdate;	// IMP=0x001000000008c64d
- (_Bool)scheduleAdvertisementUpdate:(double)arg1;	// IMP=0x001000000008c5e3
- (void)activityAdvertiser:(id)arg1 pairedDevicesChangedNotification:(id)arg2;	// IMP=0x001000000008c216
- (void)activityAdvertiser:(id)arg1 didSendPayloadForActivityIdentifier:(id)arg2 toDevice:(id)arg3 error:(id)arg4;	// IMP=0x001000000008beb6
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 handoffCommand:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000088cf7
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000087df6
- (id)dataForMoreAppSuggestions;	// IMP=0x0010000000087385
- (void)setShouldAdvertiseAutoPullActivityList:(_Bool)arg1;	// IMP=0x00100000000872b2
@property(copy) NSSet *pairedDevices; // @synthesize pairedDevices=_pairedDevices;
- (void)_updatePairedDeviceCapabilities;	// IMP=0x0010000000086615
- (void)_refreshPairedSFPeerDevices;	// IMP=0x001000000008624c
...
- (id)sfActivityAdvertiser;	// IMP=0x0010000000085f0c
- (_Bool)removeSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000085e48
- (_Bool)addSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000085d77
@property(readonly, copy) NSSet *sfActivityAdvertisers;
- (_Bool)peerDeviceCanAcceptNewerPayload:(id)arg1;	// IMP=0x0010000000085836
- (void)_periodicIdleUpdate;	// IMP=0x0010000000085353
- (void)removeAdvertisement;	// IMP=0x0010000000084e51
- (void)moveAdvertisementToNonActive;	// IMP=0x0010000000084d92
- (_Bool)_updateAdvertisement;	// IMP=0x0010000000083e5f
- (_Bool)advertiseItem:(id)arg1 force:(_Bool)arg2;	// IMP=0x00100000000818c0
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 name:(id)arg3;	// IMP=0x0010000000080edb
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 name:(id)arg3 sfAdvertiser:(id)arg4;	// IMP=0x0010000000080c0d
- (_Bool)_advertisePayload:(id)arg1;	// IMP=0x0010000000080bf6
- (void)advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000080b07
- (void)updateAdvertisingPowerAssertion:(double)arg1;	// IMP=0x001000000008087a
- (id)mostRecentAdvertisedBytesTime;	// IMP=0x0010000000080868
- (id)currentAdvertisedBytes;	// IMP=0x0010000000080761
- (void)setAdvertisableItems:(id)arg1;	// IMP=0x00100000000800fc
- (id)advertisingItems;	// IMP=0x0010000000080049
- (_Bool)advertising;	// IMP=0x0010000000080016
- (id)advertisableItems;	// IMP=0x001000000007ffaa
- (id)initWithManager:(id)arg1 advertiser:(id)arg2;	// IMP=0x001000000007fa15
