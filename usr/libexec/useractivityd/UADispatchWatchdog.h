...
- (void).cxx_destruct;	// IMP=0x002000000001ac62
...
- (void)_triggerWatchdog;	// IMP=0x001000000001aa2a
- (void)cancel;	// IMP=0x001000000001a936
- (void)poke;	// IMP=0x001000000001a8a9
- (void)start;	// IMP=0x001000000001a693
- (void)dealloc;	// IMP=0x001000000001a630
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001a56c
