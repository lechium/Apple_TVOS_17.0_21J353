...
- (void).cxx_destruct;	// IMP=0x00200000000044d2
@property(copy) CDUnknownBlockType wasContinuedBlock; // @synthesize wasContinuedBlock=_wasContinuedBlock;
- (id)statusString;	// IMP=0x00100000000043da
- (id)initFromPing:(id)arg1;	// IMP=0x0010000000004347
- (id)initWithPayloadSize:(unsigned long long)arg1;	// IMP=0x0010000000004236
