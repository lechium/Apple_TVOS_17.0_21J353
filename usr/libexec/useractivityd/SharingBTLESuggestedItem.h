...
+ (id)statusString;	// IMP=0x0040000000066013
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x00100000000606d1
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x00100000000605a4
- (void).cxx_destruct;	// IMP=0x0020000000066209
...
- (id)description;	// IMP=0x0010000000065ed1
- (void)setWhen:(id)arg1;	// IMP=0x0010000000065dcb
- (id)when;	// IMP=0x0010000000065cf4
- (id)statusString;	// IMP=0x0010000000065758
- (void)clearPayload;	// IMP=0x0010000000065534
- (void)resignCurrent;	// IMP=0x00100000000654c4
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000006329a
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000062d34
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x00100000000620fd
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x0010000000062059
