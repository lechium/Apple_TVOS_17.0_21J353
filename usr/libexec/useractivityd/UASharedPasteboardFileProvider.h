...
- (void).cxx_destruct;	// IMP=0x00200000000034ba
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000336f
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000031ca
- (void)unlockWithError:(id)arg1;	// IMP=0x0010000000002f52
- (id)initWithURL:(id)arg1;	// IMP=0x0010000000002e83
