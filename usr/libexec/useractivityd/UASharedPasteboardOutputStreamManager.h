...
- (void).cxx_destruct;	// IMP=0x0020000000067444
...
- (void)shutdownStream;	// IMP=0x0010000000067186
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x00100000000670c2
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000006691d
- (id)headerForData:(id)arg1;	// IMP=0x0010000000066855
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000664a7
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x001000000006630d
