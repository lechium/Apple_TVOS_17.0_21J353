...
- (void).cxx_destruct;	// IMP=0x002000000005509e
...
- (id)description;	// IMP=0x0010000000054bf4
- (id)encodeAsData;	// IMP=0x0010000000054355
- (id)initWithData:(id)arg1;	// IMP=0x001000000005395f
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000053854
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x00100000000537ce
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x00100000000535f7
