...
- (void).cxx_destruct;	// IMP=0x002000000002d4ab
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002cf8e
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002c0c0
- (void)dealloc;	// IMP=0x001000000002bf7b
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002be0a
- (id)stateAsString;	// IMP=0x001000000002bdd8
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002bc1e
