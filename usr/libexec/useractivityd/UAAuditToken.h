...
- (id)debugDescription;	// IMP=0x001000000007f947
- (id)description;	// IMP=0x001000000007f85b
- (const char *)objCType;	// IMP=0x001000000007f84e
- (void)getValue:(void *)arg1;	// IMP=0x001000000007f831
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x001000000007f52a
