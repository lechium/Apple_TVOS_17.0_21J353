...
+ (_Bool)createConnection:(id)arg1 host:(id)arg2 port:(long long)arg3;	// IMP=0x00200000000781f4
- (void).cxx_destruct;	// IMP=0x0020000000078433
...
- (_Bool)terminate;	// IMP=0x0010000000077ff3
- (id)statusString;	// IMP=0x0010000000077ea0
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000077bb9
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000076f8b
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000075c79
- (id)initWithManager:(id)arg1 service:(id)arg2;	// IMP=0x00100000000759f2
- (id)initWithManager:(id)arg1 inputStream:(id)arg2 outputStream:(id)arg3 name:(id)arg4;	// IMP=0x001000000007578c
