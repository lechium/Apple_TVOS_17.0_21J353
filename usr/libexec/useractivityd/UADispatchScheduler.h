...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x000000000002abe5
- (void).cxx_destruct;	// IMP=0x002000000002bb8e
...
- (id)nextRunTimeString;	// IMP=0x001000000002bad7
- (void)waitUntilComplete;	// IMP=0x001000000002ba53
- (void)suspend;	// IMP=0x001000000002b9dd
- (void)resume;	// IMP=0x001000000002b9a8
- (void)reset;	// IMP=0x001000000002b7e4
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002b608
- (void)_doIt;	// IMP=0x001000000002b342
- (void)doIt;	// IMP=0x001000000002b2bb
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002b253
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002aca0
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002a8e3
