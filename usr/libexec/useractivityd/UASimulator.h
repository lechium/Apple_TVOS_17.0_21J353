...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x002000000008ed03
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x001000000008ecfb
- (void).cxx_destruct;	// IMP=0x00200000000904fd
...
- (id);	// IMP=0x001000000009041f
@property(readonly, retain) UASimulatorController *controller; // @synthesize controller=_controller;
- (id)statusString;	// IMP=0x0010000000090357
- (_Bool)terminate;	// IMP=0x0010000000090078
- (_Bool)suspend;	// IMP=0x001000000008ff8b
- (_Bool)resume;	// IMP=0x001000000008fe9e
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x001000000008fd0f
- (_Bool)active;	// IMP=0x001000000008fcdc
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x001000000008f09b
- (void)dealloc;	// IMP=0x001000000008efda
- (id)initWithController:(id)arg1;	// IMP=0x001000000008e5d0
