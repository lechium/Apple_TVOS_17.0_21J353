...
- (void).cxx_destruct;	// IMP=0x002000000003bf0d
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003bbff
- (long long)tryWriteMessage;	// IMP=0x001000000003b568
- (long long)tryWriteRawData;	// IMP=0x001000000003b259
- (long long)handleSpaceAvailable;	// IMP=0x001000000003b200
- (void)handleMessageRead;	// IMP=0x001000000003b0c5
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003b052
- (void)processHeader;	// IMP=0x001000000003af42
- (void)handleBytesAvailable;	// IMP=0x001000000003ab49
- (void)handleOpenCompleted;	// IMP=0x001000000003aa4c
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003a801
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003a4e3
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003a2e2
- (void)_stop;	// IMP=0x001000000003a0b2
- (void)tryStop;	// IMP=0x0010000000039f5f
- (void)stop;	// IMP=0x0000000000039e47
- (void)start;	// IMP=0x0010000000039a23
- (long long)queueCount;	// IMP=0x00100000000399a1
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x00100000000397bc
