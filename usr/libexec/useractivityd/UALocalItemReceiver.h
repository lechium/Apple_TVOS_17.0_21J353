...
- (void).cxx_destruct;	// IMP=0x0020000000049684
@property(readonly, retain) UAUserActivityClientProcessesController *controller; // @synthesize controller=_controller;
- (id)statusString;	// IMP=0x001000000004958f
- (id)receivedItems;	// IMP=0x0010000000049294
- (_Bool)receiving;	// IMP=0x001000000004924c
- (id)initWithManager:(id)arg1 controller:(id)arg2;	// IMP=0x00100000000491cd
