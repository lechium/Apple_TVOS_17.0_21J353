...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000698bb
- (void).cxx_destruct;	// IMP=0x0020000000069cc3
...
- (id)description;	// IMP=0x0010000000069af4
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000699ca
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000698c3
- (id)init;	// IMP=0x001000000006988c
