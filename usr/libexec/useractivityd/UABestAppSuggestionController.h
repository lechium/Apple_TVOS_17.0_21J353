...
- (void).cxx_destruct;	// IMP=0x0020000000002e70
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000029fb
- (_Bool)terminate;	// IMP=0x0010000000002910
- (_Bool)resume;	// IMP=0x0010000000002837
- (_Bool)suspend;	// IMP=0x001000000000275e
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000000264f
