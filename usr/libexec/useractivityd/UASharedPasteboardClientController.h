...
@class NSArray, NSBundle, NSDate, NSMutableSet, NSObject, NSProgress, NSString, NSTimer, NSXPCConnection, NSXPCListener, SFCompanionAdvertiser, UARemotePasteboardDidSendLocalEvent, UARemotePasteboardWasRequestedEvent, UASharedPasteboardInfo, UASharedPasteboardInfoWrapper, UASharedPasteboardInputStreamManager, UASharedPasteboardOutputStreamManager, UCRemotePasteboardGeneration;
...
- (void).cxx_destruct;	// IMP=0x0020000000039601
...
- (id)localPBStatus;	// IMP=0x0010000000038ba0
- (id);	// IMP=0x0010000000038b93
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x00100000000386ff
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000037b8c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000036ece
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x00100000000362d7
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000034506
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x00100000000343af
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x001000000003439d
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000031991
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000002f878
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000002f576
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x001000000002f482
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x001000000002f210
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000002f14a
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002ea9b
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e9c9
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e963
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e84e
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002e4b9
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002e1a3
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002e063
- (id)items;	// IMP=0x001000000002e051
- (void)startConnection:(int)arg1;	// IMP=0x001000000002dfbc
...
- (id)uuid;	// IMP=0x001000000002dd43
- (void)dealloc;	// IMP=0x001000000002dc7b
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002d5d1
