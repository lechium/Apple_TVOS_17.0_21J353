...
- (void).cxx_destruct;	// IMP=0x002000000003e301
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003e28d
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x001000000003e15c
