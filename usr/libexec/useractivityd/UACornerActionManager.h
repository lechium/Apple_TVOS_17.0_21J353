...
+ (id)sharedActivityManagerServer;	// IMP=0x002000000001c578
+ (id)cornerActionManager;	// IMP=0x001000000001c55f
- (void).cxx_destruct;	// IMP=0x0020000000029524
...
- (void)removeHandler:(id)arg1;	// IMP=0x0010000000028fe0
- (void)addHandler:(id)arg1;	// IMP=0x0010000000028f2f
@property(readonly, copy) NSSet *handlers;
- (void)removeActivityNotifier:(id)arg1;	// IMP=0x0010000000028e2b
- (void)addActivityNotifier:(id)arg1;	// IMP=0x0010000000028d6a
@property(readonly, copy) NSSet *notifiers;
- (void)removeClient:(id)arg1;	// IMP=0x0010000000028c4a
- (void)addClient:(id)arg1;	// IMP=0x0010000000028b71
@property(readonly, copy) NSSet *clients;
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000028a7d
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000289ab
@property(readonly, copy) NSSet *receivers;
- (void)removeAdvertiser:(id)arg1;	// IMP=0x00100000000287fb
- (void)addAdvertiser:(id)arg1;	// IMP=0x001000000002867e
@property(readonly, copy) NSSet *advertisers;
- (id)statusString;	// IMP=0x0010000000025e0a
- (id)shortStatusString;	// IMP=0x0010000000025455
- (id)dynamicUserActivitiesString;	// IMP=0x0010000000025382
- (id)debuggingInfo;	// IMP=0x00100000000251c8
- (id)dictionaryForCornerActionItem:(id)arg1;	// IMP=0x00100000000251c0
- (id)dictionaryForAdvertisableItem:(id)arg1;	// IMP=0x00100000000251b8
- (void)updateUIDeviceLockedState:(_Bool)arg1;	// IMP=0x0010000000024c59
- (void)updateScreenDimStateState:(_Bool)arg1;	// IMP=0x00100000000246e7
- (void)updateUserActiveState:(_Bool)arg1;	// IMP=0x0010000000023c43
@property _Bool userActive; // @synthesize userActive=_userActive;
- (void)terminate;	// IMP=0x0010000000023bd0
- (void)resume;	// IMP=0x0010000000022c9d
- (void)suspend;	// IMP=0x001000000002252e
@property _Bool suspended;
- (void)resumeListeningForBluetooth;	// IMP=0x001000000002226d
- (void)suspendListeningForBluetooth;	// IMP=0x0010000000022198
- (void)triggerAll;	// IMP=0x0010000000022145
- (void)processWasRemoved;	// IMP=0x0010000000021ff7
- (_Bool)fetchMoreAppSuggestions;	// IMP=0x0010000000021e3c
- (_Bool)haveBestAppChangeNotificationClients;	// IMP=0x0010000000021dd0
- (void)_checkIfBestApplicationChangedThread;	// IMP=0x0010000000021a88
- (_Bool)scheduleBestAppDetermination:(double)arg1;	// IMP=0x0010000000021a1e
- (_Bool)scheduleBestAppDetermination;	// IMP=0x0010000000021a09
- (void)checkIfBestCornerItemChanged:(double)arg1;	// IMP=0x001000000002197a
@property(retain, nonatomic) UAUserActivityInfo *debugCornerItem;
- (id)bestCornerItem:(id)arg1;	// IMP=0x00100000000218ff
- (id)bestCornerItem;	// IMP=0x001000000002189b
- (id)cornerActionItemForUUID:(id)arg1;	// IMP=0x0010000000021673
- (id)cornerActionItems;	// IMP=0x0010000000021262
...
- (void)_determineWhenSystemGoesIdleThread;	// IMP=0x001000000001fe5d
@property _Bool advertisingSuspended;
- (void)triggerUserIdleDetermination:(double)arg1;	// IMP=0x001000000001fbe4
- (void)triggerUserIdleDetermination;	// IMP=0x001000000001fbcf
- (_Bool)isBluetoothEnabled;	// IMP=0x001000000001fbc7
@property(readonly) _Bool activityReceivingAllowed;
@property(readonly) _Bool activityAdvertisingAllowed;
- (void)updateScreenSaverActive:(_Bool)arg1;	// IMP=0x001000000001fb03
- (void)_determineItemToAdvertiseForHandoffThread;	// IMP=0x001000000001e0ef
@property(readonly, copy) NSArray *itemsBeingAdvertised; // @synthesize itemsBeingAdvertised=_itemsBeingAdvertised;
- (_Bool)weAreAdvertisingAtLeastOneItem;	// IMP=0x001000000001de98
- (void)userActivityItemsChanged;	// IMP=0x001000000001ddad
- (id)uaAdvertisableItemsInOrder:(_Bool)arg1;	// IMP=0x001000000001d7a0
- (id)uaAdvertisableItemsInOrder;	// IMP=0x001000000001d78c
- (id)activeAdvertiseableItemsUUIDs;	// IMP=0x001000000001d556
- (void)scheduleUpdatingAdvertisableItems:(double)arg1;	// IMP=0x001000000001d4f3
- (void)scheduleUpdatingAdvertisableItems;	// IMP=0x001000000001d4d9
- (_Bool)shouldItemBeAdvertised:(id)arg1;	// IMP=0x001000000001d0e0
- (id)advertiseableItems;	// IMP=0x001000000001ce85
- (_Bool)weAreAdvertisingAnItem;	// IMP=0x001000000001ccfb
- (void)dealloc;	// IMP=0x001000000001cccc
- (id)init;	// IMP=0x001000000001c5cd
