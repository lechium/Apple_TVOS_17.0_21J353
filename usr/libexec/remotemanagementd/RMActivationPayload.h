...
- (id)reportDetails;	// IMP=0x001000000000a5b2
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000b58f
- (_Bool)_updatePropertiesForActivation:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000aef4
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000ad56
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000ab86
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000a887
