...
+ (id)sharedQueryQueue;	// IMP=0x0040000000067263
- (void).cxx_destruct;	// IMP=0x0020000000068c05
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000067ae9
- (void)_delayedQuery;	// IMP=0x00100000000677ae
- (void)_scheduleQueryForTransactions;	// IMP=0x0010000000067689
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x00100000000675a5
- (void)start;	// IMP=0x001000000006730a
- (void)dealloc;	// IMP=0x00100000000671bb
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000067119
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x0010000000067076
