...
- (id)reportDetails;	// IMP=0x001000000000bccb
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000c3ca
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000c22c
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000c07e
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000bda4
