...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000023453
- (id)reportDetails;	// IMP=0x0020000000023caa
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000002372f
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x00100000000234c3
