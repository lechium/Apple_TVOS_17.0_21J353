...
- (void)markPending;	// IMP=0x00200000000244f5
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x00100000000241ac
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000023e3e
- (void)markQueued;	// IMP=0x0010000000023ddb
