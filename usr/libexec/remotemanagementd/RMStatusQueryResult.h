...
- (void).cxx_destruct;	// IMP=0x001000000007b42f
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007a73d
- (id)init;	// IMP=0x001000000007a6d9
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x001000000007b807
