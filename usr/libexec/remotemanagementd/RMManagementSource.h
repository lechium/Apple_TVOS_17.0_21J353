...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x0020000000057b5f
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x0010000000057ab8
+ (id)fetchRequestWithEnrollmentType:(long long)arg1;	// IMP=0x0010000000057a35
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x00100000000579b2
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(long long)arg2;	// IMP=0x00100000000578fd
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x0010000000057856
- (id)reportDetails;	// IMP=0x0020000000057c06
- (void)awakeFromInsert;	// IMP=0x00100000000577c3
