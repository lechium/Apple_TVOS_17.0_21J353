...
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x00100000000563e2
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000056244
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x0010000000056096
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000055dbc
