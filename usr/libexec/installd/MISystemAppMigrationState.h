...
+ (id)defaultManager;	// IMP=0x00400000000457ac
- (void).cxx_destruct;	// IMP=0x0020000000045db5
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000045b68
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x001000000004566e
