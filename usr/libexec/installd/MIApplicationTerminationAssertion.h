...
- (void).cxx_destruct;	// IMP=0x00200000000463a7
...
- (void)assertionTargetProcessDidExit:(id)arg1;	// IMP=0x001000000004633c
- (void)dealloc;	// IMP=0x00100000000462ea
- (void)invalidate;	// IMP=0x0010000000046290
- (id)initWithBundleIdentifier:(id)arg1;	// IMP=0x001000000004601b
