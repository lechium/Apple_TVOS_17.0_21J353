...
- (void).cxx_destruct;	// IMP=0x002000000002d866
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x001000000002d58a
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x001000000002cf94
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x001000000002ce4d
