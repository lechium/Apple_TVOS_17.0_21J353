...
+ (id)installerForURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x0040000000021050
- (void).cxx_destruct;	// IMP=0x00200000000273d3
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0010000000026674
- (_Bool)_installInstallable:(id)arg1 containingSymlink:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0010000000025459
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0010000000024f50
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0010000000024b28
- (id)_discoverInstallableWithError:(id *)arg1;	// IMP=0x0010000000023a4b
- (_Bool)_writeLockBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000023959
- (id)_identifiersToLockForBundle:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000236d4
- (id)_bundleInDirectory:(id)arg1 withBundleID:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000022ebf
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x00100000000229d9
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x00100000000221bc
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x001000000002144a
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x00100000000211ec
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x0010000000021183
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x001000000002110e
- (void)dealloc;	// IMP=0x0010000000020f6f
- (id)initWithURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x0010000000020e79
- (id)init;	// IMP=0x0010000000020e70
