...
- (void).cxx_destruct;	// IMP=0x0020000000011050
...
// Error: Property attributes should begin with the type ('T') attribute, property name: downloadToken
...
- (void)assetDownloadSession:(id)arg1 willDownloadVariants:(id)arg2;	// IMP=0x0010000000010ee0
- (void)assetDownloadSession:(id)arg1 didUpdateProgressWithExpectedBytes:(unsigned long long)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x0010000000010e8d
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x0010000000010e00
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x0010000000010d2d
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x0010000000010c39
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0010000000010b66
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x0010000000010ad8
- (void)startLoadingMetadata;	// IMP=0x0010000000010a87
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x00100000000109fb
- (void)cancel;	// IMP=0x001000000001098e
- (void)suspend;	// IMP=0x0010000000010921
- (void)resume;	// IMP=0x0010000000010877
- (void)releasePowerAssertion;	// IMP=0x001000000001078d
- (void)takePowerAssertion;	// IMP=0x00100000000104f3
- (void)disavowSession;	// IMP=0x0010000000010446
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000fa0a
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000f802
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x001000000000f7e7
