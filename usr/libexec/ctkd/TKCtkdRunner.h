...
- (void).cxx_destruct;	// IMP=0x00200000000030be
...
- (void)run;	// IMP=0x0010000000002a3a
- (void)ensureSlotWatcherIsRunning;	// IMP=0x00100000000029b4
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x00100000000027bb
...
- (void)initializeSandBox;	// IMP=0x00100000000026a1
