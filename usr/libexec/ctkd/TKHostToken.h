...
+ (id)keychainItemClasses;	// IMP=0x00200000000021db
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001960
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000002454
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000230f
- (id)connectionWithError:(id *)arg1;	// IMP=0x0010000000001b59
- (id)description;	// IMP=0x0010000000001a82
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x0010000000001968
