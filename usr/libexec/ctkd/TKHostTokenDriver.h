...
- (void).cxx_destruct;	// IMP=0x0020000000013492
...
- (void)dealloc;	// IMP=0x001000000001334b
- (void)releaseTokenWithTokenID:(id)arg1;	// IMP=0x0010000000013213
- (_Bool)configureWithError:(id *)arg1;	// IMP=0x001000000001304e
- (id)acquireTokenWithSlot:(id)arg1 AID:(id)arg2 tokenID:(id *)arg3 error:(id *)arg4;	// IMP=0x0010000000012acd
- (id)acquireTokenWithTokenID:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000012590
@property(readonly, nonatomic) TKTokenDriverHostContext *context;
- (id)contextWithError:(id *)arg1;	// IMP=0x0010000000011619
@property(readonly, nonatomic) _Bool valid;
- (void)invalidate;	// IMP=0x001000000001154c
- (void)keepAlive:(_Bool)arg1;	// IMP=0x001000000001140a
@property(readonly, nonatomic) NSString *classID;
- (id)description;	// IMP=0x00100000000111bf
- (id)initWithExtension:(id)arg1 cache:(id)arg2;	// IMP=0x0010000000011125
