...
- (void).cxx_destruct;	// IMP=0x002000000000eb60
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000ea6e
- (unsigned long long)hash;	// IMP=0x001000000000ea01
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e921
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e85d
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e7da
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e760
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e5d4
- (id)dictionaryRepresentation;	// IMP=0x001000000000e52a
- (id)description;	// IMP=0x001000000000e47b
