...
+ (id)monitor;	// IMP=0x0020000000001e19
- (void).cxx_destruct;	// IMP=0x0020000000001d42
...
- (void)_onqueueRecheck;	// IMP=0x0010000000001bc2
- (void)recheck;	// IMP=0x0010000000001b77
- (void)connectTo:(id)arg1;	// IMP=0x0010000000001b4c
- (void)notifyListener;	// IMP=0x0010000000001ae5
- (void)handleNotification:(const char *)arg1;	// IMP=0x0010000000001a99
- (id)init;	// IMP=0x001000000000192c
