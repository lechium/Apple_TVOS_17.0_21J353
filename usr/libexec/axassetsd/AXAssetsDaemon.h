...
+ (id)sharedInstance;	// IMP=0x002000000000e63f
- (void).cxx_destruct;	// IMP=0x002000000000f145
...
- (void)willBecomeIdle:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000eeca
- (void)_updateAssetForAssetType:(id)arg1;	// IMP=0x001000000000ee59
- (void)_refreshAssetCatalogForAssetType:(id)arg1 withOverrideTimeout:(id)arg2 forceCatalogRefresh:(_Bool)arg3;	// IMP=0x001000000000edbc
- (id)_managedAssetForAssetType:(id)arg1;	// IMP=0x001000000000eba8
- (void)run;	// IMP=0x001000000000ea3d
- (void)registerManagedAssets:(id)arg1;	// IMP=0x001000000000e9d4
- (void)registerManagedAsset:(id)arg1;	// IMP=0x001000000000e96b
- (id)_init;	// IMP=0x001000000000e6a4
