...
+ (id)taskWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0020000000001dee
- (void).cxx_destruct;	// IMP=0x00200000000026d5
...
- (_Bool)_deferIfNeeded;	// IMP=0x001000000000249f
- (id)_restorationExitStatusForResult:(unsigned long long)arg1;	// IMP=0x0010000000002474
- (void)_completeWithResult:(unsigned long long)arg1;	// IMP=0x001000000000219b
@property(readonly, copy) NSString *description;
- (id)initWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000001e93
