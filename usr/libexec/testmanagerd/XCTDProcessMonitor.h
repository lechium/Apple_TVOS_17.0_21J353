...
+ (id)processStateDescriptor;	// IMP=0x0020000000020973
+ (id)predicatesForBundleIDs:(id)arg1;	// IMP=0x00100000000207a6
+ (id)stateSnapshotFromRBSState:(id)arg1 forRBSBundle:(id)arg2 pid:(int)arg3;	// IMP=0x00100000000204d5
- (void).cxx_destruct;	// IMP=0x0020000000021bd7
...
- (id)bundleIDForPID:(int)arg1 error:(id *)arg2;	// IMP=0x0010000000021abf
- (id)processSpecifierForPID:(int)arg1 error:(id *)arg2;	// IMP=0x0010000000021a73
- (void)startMonitoringApplicationWithBundleID:(id)arg1 path:(id)arg2;	// IMP=0x0010000000020a11
- (void)guardIsValid:(CDUnknownBlockType)arg1;	// IMP=0x0010000000020460
- (void)invalidate;	// IMP=0x0010000000020371
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000202fe
- (id)initWithDelegate:(id)arg1 processMonitor:(id)arg2 processHandleClass:(Class)arg3;	// IMP=0x00100000000201f8
