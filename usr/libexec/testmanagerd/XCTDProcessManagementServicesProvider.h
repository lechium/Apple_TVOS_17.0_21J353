...
- (void).cxx_destruct;	// IMP=0x002000000001ce22
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x001000000001cd56
- (id)init;	// IMP=0x001000000001ccde
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x001000000001cc47
- (void)invalidate;	// IMP=0x001000000001cb04
- (void)dealloc;	// IMP=0x001000000001ca52
