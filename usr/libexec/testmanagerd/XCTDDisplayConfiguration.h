...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x002000000003ffe6
+ (id)sharedDisplayMonitor;	// IMP=0x001000000003ff91
- (void).cxx_destruct;	// IMP=0x0020000000040850
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x0010000000040013
