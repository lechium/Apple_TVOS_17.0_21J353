...
- (void).cxx_destruct;	// IMP=0x002000000002d45c
...
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000002d27a
- (id)initWithApplicationLauncher:(id)arg1 siriInterface:(id)arg2 systemConfiguration:(id)arg3 axManager:(id)arg4 touchGesturePerformer:(id)arg5;	// IMP=0x001000000002d130
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000002cf02
- (void)unloadAccessibility;	// IMP=0x001000000002cdab
- (void)invalidate;	// IMP=0x001000000002cc05
- (void)dealloc;	// IMP=0x001000000002cad9
