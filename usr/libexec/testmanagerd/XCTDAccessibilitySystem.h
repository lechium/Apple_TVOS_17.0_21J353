...
+ (id)sharedSystem;	// IMP=0x002000000001ce53
- (void).cxx_destruct;	// IMP=0x002000000001e6cb
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001e4f4
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001e2e4
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001e165
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001dedc
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001dcb3
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001dabc
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001d6fa
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001d38a
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001d0e3
- (void)dealloc;	// IMP=0x001000000001cfe2
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000001cefb
