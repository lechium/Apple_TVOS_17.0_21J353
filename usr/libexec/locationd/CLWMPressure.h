...
- (id).cxx_construct;	// IMP=0x0020000000f9376a
- (void).cxx_destruct;	// IMP=0x0010000000f93727
- (int)getSampleCount;	// IMP=0x0010000000f93717
- (void)setWriter:(shared_ptr_da0ccc6f)arg1;	// IMP=0x0010000000f93703
- (void)onPressureData:(const Sample_b71dd899 *)arg1;	// IMP=0x0010000000f935dc
- (void)teardownListeners;	// IMP=0x0010000000f93403
- (void)setupListener;	// IMP=0x0010000000f93329
- (id)initWithDelegate:(id)arg1 universeCopy:(id)arg2 settings:(struct SettingStructure)arg3;	// IMP=0x0010000000f93266
