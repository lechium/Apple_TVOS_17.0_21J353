...
- (void)resume:(id *)arg1;	// IMP=0x00100000007be5c4
- (void)suspend;	// IMP=0x00100000007be5ad
- (void)setHasChangesAvailable;	// IMP=0x00100000007be596
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00100000007be590
- (id)initWithService:(id)arg1 priority:(long long)arg2 asMasterStore:(_Bool)arg3 options:(id)arg4;	// IMP=0x00100000007be556
