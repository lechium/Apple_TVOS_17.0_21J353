...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000262b9c
- (unsigned long long)hash;	// IMP=0x001000000026278b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000262673
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000262599
- (void)copyTo:(id)arg1;	// IMP=0x00100000002624fd
- (void)writeTo:(id)arg1;	// IMP=0x0010000000262409
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002623fc
- (id)dictionaryRepresentation;	// IMP=0x0010000000261e22
- (id)description;	// IMP=0x0010000000261dab
