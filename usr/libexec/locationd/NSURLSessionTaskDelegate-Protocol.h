...
@class MISSING_TYPE, NSError, NSHTTPURLResponse, NSURLRequest, NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics;
...
- (MISSING_TYPE *)URLSession:task:didReceiveChallenge:completionHandler: /* Error: Ran out of types for this method. */;
