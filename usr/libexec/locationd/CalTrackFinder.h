...
- (void)_clearBuffers;	// IMP=0x0010000000a9505f
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x0010000000a94e0f
- (void)_closeCurrentTrack;	// IMP=0x0010000000a94187
- (void)_closeTrackCheckPedometer;	// IMP=0x0010000000a93590
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x0010000000a92bc3
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x0010000000a92689
- (void)_closeTrackCheckGpsLocation;	// IMP=0x0010000000a923ee
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000a918e9
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x0010000000a91885
- (id)_filterGpsLocationBuffer;	// IMP=0x0010000000a9121a
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x0010000000a910cc
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000a90db1
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x0010000000a90ccf
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x0010000000a904ba
- (void)stop;	// IMP=0x0010000000a90316
- (void)dealloc;	// IMP=0x0010000000a9029b
- (id)init;	// IMP=0x0010000000a90030
