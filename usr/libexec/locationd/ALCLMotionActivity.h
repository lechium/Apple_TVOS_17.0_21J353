...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001b3a2a
- (MISSING_TYPE *)hash;	// IMP=0x00100000001b3575
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b3369
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b3204
- (void)copyTo:(id)arg1;	// IMP=0x00100000001b30dd
- (void)writeTo:(id)arg1;	// IMP=0x00100000001b2f4d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001b2f40
- (id)dictionaryRepresentation;	// IMP=0x00100000001b2189
- (id)description;	// IMP=0x00100000001b2112
@property(nonatomic) _Bool hasIsVehicleConnected;
@property(nonatomic) _Bool hasStartTime;
@property(nonatomic) _Bool hasEstExitTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000001b1fcb
- (id)exitStateAsString:(int)arg1;	// IMP=0x00100000001b1f92
...
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x00100000001b1e28
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000001b1def
...
- (int)StringAsMountedState:(id)arg1;	// IMP=0x00100000001b1d3d
- (id)mountedStateAsString:(int)arg1;	// IMP=0x00100000001b1cfe
@property(nonatomic) _Bool hasMountedState;
@property(nonatomic) int mountedState; // @synthesize mountedState=_mountedState;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x00100000001b1c2c
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000001b1bf3
@property(nonatomic) _Bool hasConfidence;
@property(nonatomic) int confidence; // @synthesize confidence=_confidence;
- (int)StringAsType:(id)arg1;	// IMP=0x00100000001b165c
- (id)typeAsString:(int)arg1;	// IMP=0x00100000001b1294
