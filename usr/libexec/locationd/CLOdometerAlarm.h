...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x0010000000a50bb0
- (void)invalidate;	// IMP=0x0010000000a50b47
- (void)dealloc;	// IMP=0x0010000000a50af0
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000a509ed
- (id)init;	// IMP=0x0010000000a509be
