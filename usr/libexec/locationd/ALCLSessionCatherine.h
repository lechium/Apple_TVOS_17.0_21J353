...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000003f16fe
- (unsigned long long)hash;	// IMP=0x00100000003f097a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000003f04f5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003f022b
- (void)copyTo:(id)arg1;	// IMP=0x00100000003eff9f
- (void)writeTo:(id)arg1;	// IMP=0x00100000003efc79
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000003efc6c
- (id)dictionaryRepresentation;	// IMP=0x00100000003ee6f0
- (id)description;	// IMP=0x00100000003ee679
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00100000003ee4e1
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000003ee4a6
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000003ed99c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000003ed5d4
