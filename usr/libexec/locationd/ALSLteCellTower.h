...
// Error: Property attributes should begin with the type ('T') attribute, property name: tacID
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000960e6d
- (unsigned long long)hash;	// IMP=0x0010000000960d6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000960c0a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000960ae6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000960a02
- (void)writeTo:(id)arg1;	// IMP=0x00100000009608f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009608ec
- (id)dictionaryRepresentation;	// IMP=0x00100000009601ee
- (id)description;	// IMP=0x0010000000960177
...
- (void)dealloc;	// IMP=0x001000000095ff68
