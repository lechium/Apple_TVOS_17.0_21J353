...
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x0010000000b571f3
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x0010000000b571d5
- (id)initWithAppMonitorProxy:(id)arg1;	// IMP=0x0010000000b5718b
