...
- (id)description;	// IMP=0x0010000000c6ffbd
- (id)jsonObject;	// IMP=0x0010000000c6ff59
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000c6fc63
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000c6fc13
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000c6fb79
- (void)dealloc;	// IMP=0x0010000000c6fb21
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000c6fa9e
