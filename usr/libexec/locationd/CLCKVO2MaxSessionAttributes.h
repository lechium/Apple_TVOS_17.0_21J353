...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000acf899
- (unsigned long long)hash;	// IMP=0x0010000000acf55b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000acf410
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000acf321
- (void)copyTo:(id)arg1;	// IMP=0x0010000000acf270
- (void)writeTo:(id)arg1;	// IMP=0x0010000000acf17d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000acf170
- (id)dictionaryRepresentation;	// IMP=0x0010000000acebb3
- (id)description;	// IMP=0x0010000000aceb3c
