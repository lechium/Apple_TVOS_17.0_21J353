...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000007d0258
- (unsigned long long)hash;	// IMP=0x00100000007cf9a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007cf6a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007cf4b9
- (void)copyTo:(id)arg1;	// IMP=0x00100000007cf30e
- (void)writeTo:(id)arg1;	// IMP=0x00100000007cf0f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000007cf0e8
- (id)dictionaryRepresentation;	// IMP=0x00100000007ce56e
- (id)description;	// IMP=0x00100000007ce4f7
