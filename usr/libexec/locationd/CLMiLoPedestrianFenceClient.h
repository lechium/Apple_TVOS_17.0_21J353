...
- (void)sessionStatusReport:(id)arg1;	// IMP=0x0010000000102ebc
- (void)didFailWithError:(long long)arg1;	// IMP=0x0010000000102d13
- (void)didExitFence:(id)arg1;	// IMP=0x00100000001029f4
- (void)endSession;	// IMP=0x00100000001028d4
- (void)startSession;	// IMP=0x00100000001027b4
- (void)clearFence;	// IMP=0x0010000000102469
- (void)setFence;	// IMP=0x0010000000102064
- (void)dealloc;	// IMP=0x0010000000101fea
- (id)initInUniverse:(id)arg1 andIdentifier:(id)arg2 andRadiusInMeters:(float)arg3 andCallback:(CDUnknownBlockType)arg4 andStatusCallback:(CDUnknownBlockType)arg5 andErrorCallback:(CDUnknownBlockType)arg6;	// IMP=0x0010000000101e98
- (id)init;	// IMP=0x0010000000101e80
