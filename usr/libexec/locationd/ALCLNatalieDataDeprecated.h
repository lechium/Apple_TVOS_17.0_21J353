...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000a97481
- (unsigned long long)hash;	// IMP=0x0010000000a9700e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a96e67
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a96d3e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000a96c53
- (void)writeTo:(id)arg1;	// IMP=0x0010000000a96b09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000a96afc
- (id)dictionaryRepresentation;	// IMP=0x0010000000a95eed
- (id)description;	// IMP=0x0010000000a95e76
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0010000000a957d0
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000a9540b
