...
- (id).cxx_construct;	// IMP=0x00100000004bf41a
...
- (void)dealloc;	// IMP=0x00100000004bf3b1
- (id)initWithTimestamp:(time_point_60143bad)arg1 RSSI:(int)arg2 uuid:(id)arg3 ipv4:(unsigned int)arg4 channel:(int)arg5;	// IMP=0x00100000004bf334
- (struct CLATVAirplayDeviceInternal)cppObject;	// IMP=0x00100000004bf428
