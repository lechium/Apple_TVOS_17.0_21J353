...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000019fde2
- (unsigned long long)hash;	// IMP=0x001000000019f62d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019f45e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019f31c
- (void)copyTo:(id)arg1;	// IMP=0x001000000019f218
- (void)writeTo:(id)arg1;	// IMP=0x001000000019f085
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019f078
- (id)dictionaryRepresentation;	// IMP=0x001000000019e739
- (id)description;	// IMP=0x001000000019e6c2
