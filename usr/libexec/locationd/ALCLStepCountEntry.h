...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a0f8c
- (unsigned long long)hash;	// IMP=0x00100000001a0c37
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a0b14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a0a33
- (void)copyTo:(id)arg1;	// IMP=0x00100000001a0990
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a0891
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a0884
- (id)dictionaryRepresentation;	// IMP=0x00100000001a01b8
- (id)description;	// IMP=0x00100000001a0141
