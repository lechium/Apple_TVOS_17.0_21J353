...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000021c720
- (unsigned long long)hash;	// IMP=0x001000000021c504
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021c444
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021c399
- (void)copyTo:(id)arg1;	// IMP=0x001000000021c32c
- (void)writeTo:(id)arg1;	// IMP=0x001000000021c285
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000021c278
- (id)dictionaryRepresentation;	// IMP=0x001000000021be58
- (id)description;	// IMP=0x001000000021bde1
