...
- (id)description;	// IMP=0x0010000000d16252
- (id)jsonObject;	// IMP=0x0010000000d160d8
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x0010000000d15f67
- (void)refresh;	// IMP=0x0010000000d15e7b
- (void)dealloc;	// IMP=0x0010000000d15df9
- (id)init;	// IMP=0x0010000000d15c56
