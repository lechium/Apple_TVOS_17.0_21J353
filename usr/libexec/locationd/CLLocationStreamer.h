...
+ (_Bool);	// IMP=0x00200000004a8272
+ (id)getSilo;	// IMP=0x00100000004a8216
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000004a81fd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000004a81a0
- (id).cxx_construct;	// IMP=0x00200000004aaf25
- (void).cxx_destruct;	// IMP=0x00100000004aae94
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x00100000004aac1d
- (void)successfullySentMessage:(id)arg1;	// IMP=0x00100000004aab37
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x00100000004aaa2b
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x00100000004aa623
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x00100000004aa32a
- (void)sendMotionState;	// IMP=0x00100000004aa17a
- (void)stopMotionAlarm;	// IMP=0x00100000004aa04d
- (void)startMotionAlarm;	// IMP=0x00100000004a9f28
- (void)reevaluateMotionSubscription;	// IMP=0x00100000004a9d46
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x00100000004a9815
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5 hasMapMatching:(_Bool)arg6;	// IMP=0x00100000004a94d0
- (void)stopLocation;	// IMP=0x00100000004a8ee1
- (void)unregisterAllLocationNotifications;	// IMP=0x00100000004a8e5b
- (void)sendAliveAgainMessage;	// IMP=0x00100000004a8cc4
- (void)endService;	// IMP=0x00100000004a8b9e
- (void)beginService;	// IMP=0x00100000004a8317
- (id)init;	// IMP=0x00100000004a82da
