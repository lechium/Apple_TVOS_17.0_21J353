...
- (void)onScenarioTrigger:(id)arg1;	// IMP=0x00100000007f0ed0
- (void)onVisit:(id)arg1;	// IMP=0x00100000007f0caa
- (id)initWithFenceMonitor:(void *)arg1;	// IMP=0x00100000007f0c60
