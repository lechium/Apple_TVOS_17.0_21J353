...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000099317b
- (unsigned long long)hash;	// IMP=0x00100000009930de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000993009
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000992f29
- (void)copyTo:(id)arg1;	// IMP=0x0010000000992e9f
- (void)writeTo:(id)arg1;	// IMP=0x0010000000992dee
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000992de1
- (id)dictionaryRepresentation;	// IMP=0x00100000009929b3
- (id)description;	// IMP=0x001000000099293c
@property(nonatomic) _Bool hasNumZaxisHarvestTraces;
@property(nonatomic) _Bool hasChannel;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000992842
