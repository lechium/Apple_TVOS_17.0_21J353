...
@property(retain, nonatomic) NSString *precipitationType; // @synthesize precipitationType=_precipitationType;
@property(nonatomic) float weatherPressure; // @synthesize weatherPressure=_weatherPressure;
@property(nonatomic) double timestamp; // @synthesize timestamp=_timestamp;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000084b88f
