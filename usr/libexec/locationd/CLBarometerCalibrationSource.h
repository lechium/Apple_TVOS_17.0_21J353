...
- (void)disableSource;	// IMP=0x00200000002fae5b
- (void)enableSource;	// IMP=0x00100000002fae55
- (void)dealloc;	// IMP=0x00100000002fae1f
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000002fad6c
