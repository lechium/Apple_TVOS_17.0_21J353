...
+ (id)withEvent:(long long)arg1 andPredicate:(id)arg2;	// IMP=0x00200000006051dd
...
- (void)dealloc;	// IMP=0x00100000006052a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000605143
- (unsigned long long)hash;	// IMP=0x00100000006050d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000605020
