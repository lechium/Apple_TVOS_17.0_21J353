...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000dbcd6c
- (unsigned long long)hash;	// IMP=0x0010000000dbc5ed
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000dbc421
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000dbc2e2
- (void)copyTo:(id)arg1;	// IMP=0x0010000000dbc1e1
- (void)writeTo:(id)arg1;	// IMP=0x0010000000dbc08d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000dbc080
- (id)dictionaryRepresentation;	// IMP=0x0010000000dbb92d
- (id)description;	// IMP=0x0010000000dbb8b6
- (int)StringAsQuality:(id)arg1;	// IMP=0x0010000000dbb830
- (id)qualityAsString:(int)arg1;	// IMP=0x0010000000dbb7f7
