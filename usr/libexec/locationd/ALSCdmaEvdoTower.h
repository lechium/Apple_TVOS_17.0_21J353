...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000939316
- (unsigned long long)hash;	// IMP=0x0010000000939261
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000093916c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000093906d
- (void)copyTo:(id)arg1;	// IMP=0x0010000000938fbf
- (void)writeTo:(id)arg1;	// IMP=0x0010000000938ef9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000938eec
- (id)dictionaryRepresentation;	// IMP=0x00100000009389e5
- (id)description;	// IMP=0x001000000093896e
...
- (void)dealloc;	// IMP=0x0010000000938814
