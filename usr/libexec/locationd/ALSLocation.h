...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000956780
- (unsigned long long)hash;	// IMP=0x0010000000956662
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009564d9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009563b4
- (void)copyTo:(id)arg1;	// IMP=0x00100000009562cd
- (void)writeTo:(id)arg1;	// IMP=0x0010000000956179
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000095616c
- (id)dictionaryRepresentation;	// IMP=0x0010000000955884
- (id)description;	// IMP=0x001000000095580d
