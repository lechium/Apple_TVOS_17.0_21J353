...
@class CLCircularRegion, CLLocation, NSArray, NSDate, NSString, NSUUID, RTPlaceInferenceOptions, RTStoredLocationEnumerationOptions, RTStoredVisitFetchOptions;
...
- (void)fetchDedupedLocationOfInterestIdentifiersWithIdentifier:(NSUUID *)arg1 withReply:(void (^)(NSArray *, NSError *))arg2;
