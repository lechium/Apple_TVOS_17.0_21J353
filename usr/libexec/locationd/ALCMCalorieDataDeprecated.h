...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000068f5a4
- (unsigned long long)hash;	// IMP=0x001000000068efa1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000068edff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000068ecdd
- (void)copyTo:(id)arg1;	// IMP=0x001000000068ebf9
- (void)writeTo:(id)arg1;	// IMP=0x001000000068ea99
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000068ea8c
- (id)dictionaryRepresentation;	// IMP=0x001000000068de53
- (id)description;	// IMP=0x001000000068dddc
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x001000000068dc77
- (id)metSourceAsString:(int)arg1;	// IMP=0x001000000068dc3e
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000068d710
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000068d34b
