...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000021db40
- (unsigned long long)hash;	// IMP=0x001000000021d933
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021d759
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021d5e2
- (void)copyTo:(id)arg1;	// IMP=0x001000000021d4b4
- (void)writeTo:(id)arg1;	// IMP=0x001000000021d36d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000021d360
- (id)dictionaryRepresentation;	// IMP=0x001000000021cb2c
- (id)description;	// IMP=0x001000000021cab5
...
- (void)dealloc;	// IMP=0x001000000021c7e4
