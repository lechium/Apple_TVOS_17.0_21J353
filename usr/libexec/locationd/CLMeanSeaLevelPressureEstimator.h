...
- (id).cxx_construct;	// IMP=0x0020000000db8734
- (void).cxx_destruct;	// IMP=0x0010000000db870d
...
- (void)retrieveMeanSeaLevelPressureEstimatorState;	// IMP=0x0010000000db7b2a
- (void)saveInVisitStateToPlist;	// IMP=0x0010000000db78e2
- (void)saveInVisitRebasedMslpToPlist;	// IMP=0x0010000000db7553
- (void)saveMeanSeaLevelPressureArrayToPlist;	// IMP=0x0010000000db7023
- (void)clearMeanSeaLevelPressureArrayInPlist;	// IMP=0x0010000000db6e17
- (void)clearInVisitRebasedMslpInPlist;	// IMP=0x0010000000db6c24
- (void)resetInVisitRebasedMslp;	// IMP=0x0010000000db6a34
- (void)onMslp:(const struct CMMeanSeaLevelPressure *)arg1;	// IMP=0x0010000000db67c7
- (void)writeInitialHistoricalMeanSeaLevelPressureToMslwithTimestamp:(double)arg1;	// IMP=0x0010000000db6315
- (void)updateHistoricalMeanSeaLevelPressureArray:(id)arg1 withRebaseTag:(_Bool)arg2;	// IMP=0x0010000000db59a0
- (void)getLastHistoricalMeanSeaLevelPressureData:(double *)arg1;	// IMP=0x0010000000db58e2
- (void)updateUncertinatyAndSendCurrentEstimateMeanSeaLevelPressure;	// IMP=0x0010000000db54cd
- (void)getAndSendCurrentEstimateMeanSeaLevelPressure;	// IMP=0x0010000000db5485
- (void)refreshHistoricalMeanSeaLevelPressureWithStartTime:(double)arg1 andEndTime:(double)arg2;	// IMP=0x0010000000db4ab1
- (void)getMslpDriftRate:(double *)arg1;	// IMP=0x0010000000db4a07
- (_Bool)getLastPressureSample:(double *)arg1;	// IMP=0x0010000000db46f6
- (void)gaussianProcess:(id)arg1;	// IMP=0x0010000000db2578
- (id)getEstimatedMeanSeaLevelPressure;	// IMP=0x0010000000db22eb
- (void)printMeanSeaLevelPressureElement:(id)arg1 withPrePhrase:(basic_string_d1f930f6)arg2;	// IMP=0x0010000000db1fe6
- (void)printMeanSeaLevelPressureArray:(id)arg1 withPrePhrase:(basic_string_d1f930f6)arg2;	// IMP=0x0010000000db11f5
- (void)dealloc;	// IMP=0x0010000000db1154
- (id)initWithContextManager:(id)arg1 andUniverse:(id)arg2 andDelegate:(id)arg3 andBuffers:(void *)arg4;	// IMP=0x0010000000db0cd0
