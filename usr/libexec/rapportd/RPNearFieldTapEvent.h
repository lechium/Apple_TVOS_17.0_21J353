...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000009b403
- (void).cxx_destruct;	// IMP=0x002000000009bc22
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x001000000009b9c6
- (id)description;	// IMP=0x001000000009b9af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000009b803
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000009b40b
- (id)initWithIdentifier:(id)arg1 applicationLabel:(id)arg2 pkData:(id)arg3 bonjourListenerUUID:(id)arg4 isSameAccount:(_Bool)arg5 contactID:(id)arg6 forceSingleBandAWDLMode:(_Bool)arg7 knownIdentity:(_Bool)arg8;	// IMP=0x001000000009b29c
