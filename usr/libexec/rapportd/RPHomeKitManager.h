...
- (void).cxx_destruct;	// IMP=0x0020000000055150
...
- (void)home:(id)arg1 didUpdateRoom:(id)arg2 forAccessory:(id)arg3;	// IMP=0x0010000000054e43
- (void)user:(id)arg1 didUpdateAssistantAccessControl:(id)arg2 forHome:(id)arg3;	// IMP=0x0010000000054cac
- (void)_setupHome;	// IMP=0x0010000000054ade
- (_Bool)personalRequestsStateForAccessory:(id)arg1;	// IMP=0x001000000005465e
- (id)homeHubDeviceWithIdentifier:(id)arg1;	// IMP=0x00100000000545d7
- (void)resetHomeKitUserIdentifiers;	// IMP=0x00100000000545ad
- (id)filterHomeKitUserIdentifiers:(id)arg1;	// IMP=0x0010000000053ff8
- (id)homeKitUserIdentifiers;	// IMP=0x0010000000053cdd
- (void)invalidate;	// IMP=0x0010000000053bd4
- (id)initWithQueue:(id)arg1;	// IMP=0x0010000000053b00
