...
@class MISSING_TYPE, NISession, NSSet, NSString;
...
@interface RPNIProximityEstimator : NSObject
{
    ...
    MISSING_TYPE *_session;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x002000000006b029
...
- (void)session:(id)arg1 object:(id)arg2 didUpdateRegion:(id)arg3 previousRegion:(id)arg4;	// IMP=0x001000000006ac56
- (void)invalidate;	// IMP=0x001000000006ab61
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006a7fd
- (id)init;	// IMP=0x001000000006a79c
