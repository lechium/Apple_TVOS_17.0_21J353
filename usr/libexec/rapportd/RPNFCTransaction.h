...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001ce4
- (void).cxx_destruct;	// IMP=0x0020000000002bc8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000002738
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000025ba
- (void)setState:(long long)arg1;	// IMP=0x00100000000023b2
- (void)setError:(id)arg1;	// IMP=0x0010000000001d99
- (id)initWithRole:(long long)arg1;	// IMP=0x0010000000001cec
