...
@interface RPDaemon : NSObject
{
    ...
    MISSING_TYPE *_dispatchQueue;	// 136 = 0x88
    unsigned long long _errorFlags;	// 144 = 0x90
}

+ (id)sharedDaemon;	// IMP=0x0020000000047d62
- (void).cxx_destruct;	// IMP=0x002000000004b21e
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x001000000004afd8
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004aca5
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004a999
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x001000000004a805
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x001000000004a306
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x001000000004a23b
- (void)_updateErrorFlags;	// IMP=0x001000000004a0e1
- (void)_prefsChanged;	// IMP=0x0010000000049faa
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x0010000000049db5
- (id)keychainStateString;	// IMP=0x0010000000049b1a
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000498c1
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x00100000000497a0
- (void)invalidate;	// IMP=0x001000000004939d
- (void)activate;	// IMP=0x0010000000048860
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0010000000048005
- (id)init;	// IMP=0x0010000000047db7
