...
- (void).cxx_destruct;	// IMP=0x002000000006b701
...
- (id)description;	// IMP=0x001000000006b5c0
- (void)invalidate;	// IMP=0x001000000006b34a
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006b149
