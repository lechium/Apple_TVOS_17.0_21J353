...
- (void).cxx_destruct;	// IMP=0x00200000000e2e7e
...
- (void)main;	// IMP=0x00100000000e2de1
- (int)mainInternal;	// IMP=0x00100000000e2dd6
- (_Bool)isCancelled;	// IMP=0x00100000000e2d86
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000e2cd1
- (id)init;	// IMP=0x00100000000e2cc3
