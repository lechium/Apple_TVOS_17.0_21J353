...
- (unsigned long long)assetCountWithLivePhotoEffectsAnalyzed;	// IMP=0x0010000000041774
- (unsigned long long)firstFailedSubClassifierCounter:(unsigned long long)arg1;	// IMP=0x0010000000041766
- (unsigned long long)stablizeResultsCounter:(unsigned long long)arg1;	// IMP=0x0010000000041758
- (unsigned long long)activityDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000004174a
- (unsigned long long)gatingDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000004173f
- (void)addLivePhotoEffectsAnalyzedCount:(unsigned long long)arg1;	// IMP=0x0010000000041732
- (void)addCount:(unsigned long long)arg1 toFirstFailedSubClassifierCounter:(unsigned long long)arg2;	// IMP=0x0010000000041724
- (void)addCount:(unsigned long long)arg1 toStablizeResultsCounter:(unsigned long long)arg2;	// IMP=0x0010000000041716
- (void)addCount:(unsigned long long)arg1 toActivityDecisionCounter:(unsigned long long)arg2;	// IMP=0x0010000000041708
- (void)addCount:(unsigned long long)arg1 toGatingDecisionCounter:(unsigned long long)arg2;	// IMP=0x00100000000416fd
- (id)init;	// IMP=0x001000000004169c
