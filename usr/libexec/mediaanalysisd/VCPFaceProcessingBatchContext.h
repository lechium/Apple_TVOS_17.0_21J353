...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000008cebf
- (void).cxx_destruct;	// IMP=0x002000000008d702
...
- (_Bool)downloadTimedout;	// IMP=0x001000000008d497
- (void)updateLastestDownloadTimestamp;	// IMP=0x001000000008d363
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x001000000008d0e0
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000008cf70
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000008cca0
