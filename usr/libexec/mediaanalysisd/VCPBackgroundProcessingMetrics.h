...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000072fbb
- (void).cxx_destruct;	// IMP=0x0020000000073bea
- (int)persist;	// IMP=0x0010000000073493
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000731c4
- (void)dealloc;	// IMP=0x0010000000072f38
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000072590
