...
+ (id)taskWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00400000000c3536
- (void).cxx_destruct;	// IMP=0x00200000000c500d
- (_Bool)run:(id *)arg1;	// IMP=0x00100000000c3c7d
- (void)publishResults:(id)arg1;	// IMP=0x00100000000c35ee
- (id)initWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000c3224
