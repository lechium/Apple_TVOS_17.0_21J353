...
@interface VCPProgressStatistics : NSObject
{
    ...
    MISSING_TYPE *_numExistingAssetsNotUpdatedWithoutResources;	// 416 = 0x1a0
}
...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418f0
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418e2
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418d4
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418c6
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418bb
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418b0
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000418a5
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000004189a
- (id)init;	// IMP=0x0010000000041839
