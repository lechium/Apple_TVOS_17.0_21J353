...
+ (id)entryWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x004000000000f61f
- (void).cxx_destruct;	// IMP=0x002000000000f710
...
- (id)initWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000000f530
