...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSMutableData, NSNumber, NSObject, SDAutoUnlockMacIconCache, SDUnlockMotionDetector, SDUnlockSessionKeyExchangeResponse;
...
@interface SDAutoUnlockKeySession
{
    ...
    MISSING_TYPE *_proxyRequestData;	// 104 = 0x68
...
- (void).cxx_destruct;	// IMP=0x0020000000016102
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000015c40
- (void)logAutoUnlockStart;	// IMP=0x0010000000015c3a
- (void)invalidateAssertionTimer;	// IMP=0x0010000000015b64
- (void)restartAssertionTimer;	// IMP=0x0010000000015953
- (void)releaseIdleSleepAssertion;	// IMP=0x00100000000158b4
- (void)declareSystemActivityAssertion;	// IMP=0x0010000000015620
- (void)sendConfirmationACK;	// IMP=0x0010000000015409
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014f98
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014caa
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000149be
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000143b0
- (void)handleCleanUpAWDL;	// IMP=0x0010000000014322
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x0010000000013ed8
- (void)createAuthTokenIfReady;	// IMP=0x0010000000013665
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000013447
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000013182
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0010000000012c8b
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00100000000126a4
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000011f20
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x0010000000011e81
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000011dc9
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000011be9
- (void)createWiFiRequest;	// IMP=0x00100000000113d1
- (void)alertOfUnlock;	// IMP=0x00100000000112b5
- (void)promptForApproval;	// IMP=0x00100000000112af
- (void)systemIsActive:(id)arg1;	// IMP=0x00100000000110fb
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000010eb1
- (void)removeObservers;	// IMP=0x0010000000010e5e
- (void)addObservers;	// IMP=0x0010000000010d60
- (void)postBeganUnlockingNotification;	// IMP=0x0010000000010ccd
- (void)beginAKSSession;	// IMP=0x0010000000010cc7
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000010b01
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000010afb
- (_Bool)keyInState;	// IMP=0x0010000000010965
- (void)_invalidate;	// IMP=0x00100000000106d1
- (void)invalidateOnQueue;	// IMP=0x0010000000010692
- (void)invalidate;	// IMP=0x0010000000010611
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0010000000010364
