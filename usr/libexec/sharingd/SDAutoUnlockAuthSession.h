...
- (void).cxx_destruct;	// IMP=0x002000000013d8d9
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x001000000013d0b5
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000013cafd
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000013cae5
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x001000000013c422
- (void)sendAWDLInfo;	// IMP=0x001000000013c40e
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000013c371
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000013c280
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000013c26e
- (void)_start;	// IMP=0x001000000013c25c
- (void)start;	// IMP=0x001000000013c1d5
- (id)getAppName;	// IMP=0x001000000013c1cd
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000013c1c7
- (void)connectionActivated;	// IMP=0x001000000013c1c1
- (void)invalidate;	// IMP=0x001000000013c0c8
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x001000000013c02b
