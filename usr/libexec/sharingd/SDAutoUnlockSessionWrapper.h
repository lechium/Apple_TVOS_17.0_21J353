...
- (void).cxx_destruct;	// IMP=0x00200000000bb93a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000bb694
- (unsigned long long)hash;	// IMP=0x00100000000bb514
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000bb2af
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bb0c1
- (void)copyTo:(id)arg1;	// IMP=0x00100000000baf49
- (void)writeTo:(id)arg1;	// IMP=0x00100000000badc9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000badbc
- (id)dictionaryRepresentation;	// IMP=0x00100000000ba610
- (id)description;	// IMP=0x00100000000ba561
