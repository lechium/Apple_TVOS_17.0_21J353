...
- (void).cxx_destruct;	// IMP=0x00200000000bc808
...
- (id)getEscrowSecretCopyIfValid;	// IMP=0x00100000000bc749
- (_Bool)isValid;	// IMP=0x00100000000bc661
- (id)initWithEscrowSecret:(id)arg1;	// IMP=0x00100000000bc501
