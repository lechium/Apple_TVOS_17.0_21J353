...
- (void).cxx_destruct;	// IMP=0x0020000000156bbd
...
- (void)logClientReceived;	// IMP=0x0010000000156929
- (void)logClientSent;	// IMP=0x00100000001568c9
- (void)writeNetworkStream;	// IMP=0x00100000001567b2
- (void)readClientStream;	// IMP=0x001000000015658d
- (void)writeClientStream;	// IMP=0x0010000000156287
- (void)handleOpenedStream;	// IMP=0x00100000001561f4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000156016
- (void)streamHandlerDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000155dbc
- (void)streamHandler:(id)arg1 didReceiveStreamData:(id)arg2;	// IMP=0x0000000000155d59
- (void)streamHandler:(id)arg1 bufferSpaceChanged:(_Bool)arg2;	// IMP=0x0010000000155ce4
- (void)handleStreamResponse:(id)arg1;	// IMP=0x0010000000155b06
- (void)handleStreamRequest:(id)arg1;	// IMP=0x0010000000155873
- (void)streamHandler:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x001000000015564a
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00100000001555a5
- (int)setBufferSize:(int)arg1 socket:(int)arg2;	// IMP=0x001000000015554e
@property(readonly) NSFileHandle *fileHandle; // @synthesize fileHandle=_fileHandle;
- (void)notifyStreamRequestWithError:(id)arg1;	// IMP=0x0010000000154f93
- (void)switchToStreaming;	// IMP=0x0010000000154f09
- (void)sendInitialResponse:(_Bool)arg1;	// IMP=0x0010000000154c46
- (void)sendInitialRequest;	// IMP=0x0010000000154926
- (void)startBrowser;	// IMP=0x0010000000154854
- (void)getStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001547ff
- (void)setBundleID:(id)arg1;	// IMP=0x0010000000154753
- (void)stopIfReady;	// IMP=0x0010000000154711
- (void)stop;	// IMP=0x0010000000154370
- (void)start;	// IMP=0x001000000015433a
- (void)dealloc;	// IMP=0x00100000001542fc
- (id)initWithAuthorData:(id)arg1 streamHandler:(id)arg2;	// IMP=0x00100000001541d7
- (id)initWithStreamHandler:(id)arg1;	// IMP=0x00100000001541c0
