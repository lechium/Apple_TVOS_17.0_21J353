...
- (void).cxx_destruct;	// IMP=0x00200000000a05e1
...
- (void)stop;	// IMP=0x00100000000a0525
- (int)start;	// IMP=0x00100000000a0202
- (void)mount;	// IMP=0x00100000000a01fc
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x001000000009ff23
- (void)mountDiskImageAsync;	// IMP=0x001000000009ff1d
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x001000000009fdfa
- (void)dealloc;	// IMP=0x001000000009fdc0
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x001000000009fd3a
