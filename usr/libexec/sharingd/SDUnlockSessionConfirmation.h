...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000ea96
- (unsigned long long)hash;	// IMP=0x001000000000e9f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e8b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e7e2
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e737
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e661
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e654
- (id)dictionaryRepresentation;	// IMP=0x001000000000e04e
- (id)description;	// IMP=0x001000000000df9f
