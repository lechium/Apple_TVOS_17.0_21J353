...
- (void).cxx_destruct;	// IMP=0x002000000013947e
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000001393a5
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000139193
- (void)disableService:(id)arg1;	// IMP=0x0010000000139109
- (void)enableService:(id)arg1;	// IMP=0x001000000013908b
- (id)streamHandlerForService:(id)arg1;	// IMP=0x0010000000139028
- (void)stop;	// IMP=0x0010000000138dba
- (void)start;	// IMP=0x0010000000138d67
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000138c70
