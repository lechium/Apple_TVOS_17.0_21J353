...
- (void).cxx_destruct;	// IMP=0x00200000001a194a
...
- (void)cancel;	// IMP=0x00100000001a17f5
- (void)resolve;	// IMP=0x00100000001a1366
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00100000001a0fc5
- (void)notifyClient:(int)arg1;	// IMP=0x00100000001a0f72
- (void)dealloc;	// IMP=0x00100000001a0f34
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00100000001a0dfd
