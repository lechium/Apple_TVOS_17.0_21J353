...
- (void).cxx_destruct;	// IMP=0x00200000000de775
...
- (void)stop;	// IMP=0x00100000000de6c7
- (int)start;	// IMP=0x00100000000de62b
- (void)eject;	// IMP=0x00100000000de416
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x00100000000de410
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x00100000000de2a5
- (void)dealloc;	// IMP=0x00100000000de26b
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00100000000de1f0
