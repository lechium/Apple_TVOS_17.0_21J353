...
- (void).cxx_destruct;	// IMP=0x00200000000fe695
...
- (unsigned long long)hash;	// IMP=0x00100000000fe4a3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fe3d9
- (id)description;	// IMP=0x00100000000fe2e1
- (void)dealloc;	// IMP=0x00100000000fe22a
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x00100000000fe04b
