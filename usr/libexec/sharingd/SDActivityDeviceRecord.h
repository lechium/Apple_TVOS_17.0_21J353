...
- (void).cxx_destruct;	// IMP=0x002000000001ef5d
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000001defc
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001dee4
- (id)description;	// IMP=0x001000000001ddff
- (id)initWithDevice:(id)arg1;	// IMP=0x001000000001dd6d
