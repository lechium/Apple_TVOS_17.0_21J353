...
- (void).cxx_destruct;	// IMP=0x00200000001050b5
...
- (id)trimHeader:(id)arg1;	// IMP=0x0010000000104d4a
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x0010000000104caf
- (void)handleMessageWritten:(id)arg1;	// IMP=0x0010000000104bc8
- (void)handleSpaceForMessage;	// IMP=0x0010000000104700
- (void)resetReadState;	// IMP=0x00100000001046bc
- (void)handleMessageRead;	// IMP=0x0010000000104647
- (void)handleHeaderRead;	// IMP=0x0010000000104527
- (void)handleBytesForMessage;	// IMP=0x0010000000104245
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x00100000001041de
- (id)messageWithData:(id)arg1;	// IMP=0x001000000010416a
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000103e59
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000103e18
- (void)handleSpaceForStream;	// IMP=0x0010000000103b2a
- (void)handleBytesForStream;	// IMP=0x0010000000103858
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x00100000001036d5
- (void)handleSpaceAvailable;	// IMP=0x00100000001035c2
- (void)handleBytesAvailable;	// IMP=0x00100000001034af
- (void)handleOpenedStream:(id)arg1;	// IMP=0x001000000010329d
- (void)setTCPProperties:(id)arg1;	// IMP=0x00100000001031a8
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000010301f
- (_Bool)evaluateCert;	// IMP=0x0010000000102d28
- (void)applySSLSettings:(id)arg1;	// IMP=0x00100000001029d3
- (void)invalidateOpenTimer;	// IMP=0x0010000000102941
- (void)openTimerFired:(id)arg1;	// IMP=0x0010000000102779
- (void)startOpenTimer;	// IMP=0x00100000001026a2
- (void)logTransfer;	// IMP=0x00100000001024d8
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x00100000001021b0
- (void)stopIfReady;	// IMP=0x001000000010216e
- (void)stop;	// IMP=0x001000000010212e
- (void)start;	// IMP=0x0010000000101e53
- (void)dealloc;	// IMP=0x0010000000101d97
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x0010000000101bec
