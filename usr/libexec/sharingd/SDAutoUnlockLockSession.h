...
- (void).cxx_destruct;	// IMP=0x00200000001ad0ca
...
// Error: Property attributes should begin with the type ('T') attribute, property name: exchageResponseDate
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x00100000001ac016
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00100000001ac001
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x00100000001abf5f
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00100000001abcb6
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00100000001ab43f
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00100000001ab002
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001aac3c
- (void)consumeAuthTokenIfReady;	// IMP=0x00100000001aa516
- (void)startAWDL;	// IMP=0x00100000001a9afc
- (void)handleConfirmationACK;	// IMP=0x00100000001a987e
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00100000001a93a8
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00100000001a8a4e
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00100000001a8709
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00100000001a800c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001a7bc1
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000001a797a
- (void)handleWiFiRequestInvalidated;	// IMP=0x00100000001a791e
- (void)handleRangingStarted;	// IMP=0x00100000001a781a
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00100000001a775b
- (void)handleAWDLUp;	// IMP=0x00100000001a75a6
- (void)handlePeerOutOfRange;	// IMP=0x00100000001a72b9
- (void)handlePeerInRange;	// IMP=0x00100000001a6fd1
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00100000001a6e2d
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00100000001a68d6
- (void)invalidateConfirmationTimer;	// IMP=0x00100000001a6800
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00100000001a6579
- (void)handleTimerFired;	// IMP=0x00100000001a6005
- (void)invalidateTimerIfReady;	// IMP=0x00100000001a5fba
- (id)aksPeerAvailable;	// IMP=0x00100000001a5dd5
- (void)deviceConnected:(id)arg1;	// IMP=0x00100000001a5a00
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00100000001a572a
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00100000001a56cb
- (void)connectionActivated;	// IMP=0x00100000001a53fe
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00100000001a4cf4
- (id)getAppName;	// IMP=0x00100000001a4cec
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00100000001a4bbb
- (_Bool)isAcceptor;	// IMP=0x00100000001a4bb3
- (id)attemptResults;	// IMP=0x00100000001a3f5e
- (void)logResults;	// IMP=0x00100000001a30fc
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00100000001a3060
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00100000001a2fc4
- (void)removeObservers;	// IMP=0x00100000001a2f71
- (void)addObservers;	// IMP=0x00100000001a2e73
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00100000001a2d22
- (void)_handleCanceledAfterSuccess;	// IMP=0x00100000001a2c1b
- (void)handleCanceledAfterSuccess;	// IMP=0x00100000001a2b94
- (void)lockKeyBagIfNeeded;	// IMP=0x00100000001a2ab7
- (void)cancelWiFiRequest;	// IMP=0x00100000001a28d0
- (void)_cancel;	// IMP=0x00100000001a2585
- (void)cancel;	// IMP=0x00100000001a24fe
- (void)tearDownAWDLIfNecessary;	// IMP=0x00100000001a232a
- (void)completeAttemptIfNecessary;	// IMP=0x00100000001a2168
- (void)invalidateNoDisconnect;	// IMP=0x00100000001a2139
- (void)invalidate;	// IMP=0x00100000001a1f1e
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001a1b34
