...
- (_Bool)sd_connectionCanShareURL:(id)arg1;	// IMP=0x00100000000034f8
- (_Bool)sd_connectionHasEntitlement:(id)arg1;	// IMP=0x001000000000349e
...
- (_Bool)_connectionHasEntitlement:(id)arg1;	// IMP=0x0010000000091734
@end
