...
- (void).cxx_destruct;	// IMP=0x0020000000077461
...
- (_Bool)stateIsNearby;	// IMP=0x001000000007707b
- (_Bool)stateIsMedium;	// IMP=0x001000000007704a
- (_Bool)stateIsClose;	// IMP=0x0010000000077038
- (void)resetTicks;	// IMP=0x0010000000076ea1
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000076bbc
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000076ac7
- (id)description;	// IMP=0x00100000000767ac
