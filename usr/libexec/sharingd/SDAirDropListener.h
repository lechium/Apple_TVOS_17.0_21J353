...
- (void).cxx_destruct;	// IMP=0x002000000008d605
...
- (void)dealloc;	// IMP=0x001000000008d518
- (void)stop;	// IMP=0x001000000008d4c9
- (void)start;	// IMP=0x001000000008d456
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x001000000008d139
- (id)init;	// IMP=0x001000000008d0eb
