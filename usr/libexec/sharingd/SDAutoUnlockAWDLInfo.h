...
- (void).cxx_destruct;	// IMP=0x002000000009da16
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009d7b8
- (unsigned long long)hash;	// IMP=0x001000000009d553
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009d2bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009d0fd
- (void)copyTo:(id)arg1;	// IMP=0x001000000009cf90
- (void)writeTo:(id)arg1;	// IMP=0x001000000009ce01
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009cdf4
- (id)dictionaryRepresentation;	// IMP=0x001000000009c486
- (id)description;	// IMP=0x001000000009c3d7
