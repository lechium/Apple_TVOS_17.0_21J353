...
- (void).cxx_destruct;	// IMP=0x002000000000b32c
...
- (void)handleBioLockoutStateChanged:(unsigned long long)arg1;	// IMP=0x001000000000b2d8
- (_Bool)shouldPrewarmAttempt;	// IMP=0x001000000000b2c6
- (void)deviceUnlockedWithMask:(_Bool)arg1;	// IMP=0x001000000000b21a
- (void)lockDevice;	// IMP=0x001000000000b214
- (void)lockWithBioLockOut;	// IMP=0x001000000000b202
- (_Bool)supportsPeriocular;	// IMP=0x001000000000b1fa
- (_Bool)faceIDEnabled;	// IMP=0x001000000000b1f2
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000000b19d
- (id)init;	// IMP=0x001000000000b184
