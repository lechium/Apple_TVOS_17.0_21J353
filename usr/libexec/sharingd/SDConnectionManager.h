...
+ (id)sharedManager;	// IMP=0x00200000000b7210
- (void).cxx_destruct;	// IMP=0x00200000000b8433
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00100000000b824d
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000000b8237
- (void)appleAccountSignedOut;	// IMP=0x00100000000b81bf
- (void)appleAccountSignedIn;	// IMP=0x00100000000b8147
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b80c1
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b7e13
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b7acc
- (void)cleanUpConnections;	// IMP=0x00100000000b77c1
- (void)start;	// IMP=0x00100000000b73b2
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00100000000b7265
