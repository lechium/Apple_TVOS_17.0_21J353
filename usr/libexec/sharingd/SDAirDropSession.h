...
- (void).cxx_destruct;	// IMP=0x002000000000afe4
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000ab71
- (void)handleConversionProgress:(id)arg1;	// IMP=0x001000000000aa99
- (void)startProgress;	// IMP=0x001000000000a7f2
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x001000000000a7ec
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0010000000009fe4
- (void)removeClientAlerts;	// IMP=0x0010000000009eaf
- (void)dealloc;	// IMP=0x0010000000009e2e
- (void)stop;	// IMP=0x0010000000009c23
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x00100000000098b3
- (void)serversChanged:(id)arg1;	// IMP=0x001000000000953b
- (_Bool)send;	// IMP=0x00100000000093f2
- (void)start;	// IMP=0x00100000000090ec
- (void)releaseSandboxExtensions;	// IMP=0x0010000000008fb5
- (void)consumeSandboxExtensions;	// IMP=0x0010000000008cdd
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000008cb1
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0010000000008a84
