...
- (void).cxx_destruct;	// IMP=0x00200000000cf775
...
- (id)mappedContactIdentifierForContactIdentifier:(id)arg1;	// IMP=0x00100000000cf6f2
- (id)setMappedContactIdentifier:(id)arg1 relatedContactIdentifiers:(id)arg2;	// IMP=0x00100000000cf3b2
- (id)coalescedNodesForNewAvailableNodes:(id)arg1;	// IMP=0x00100000000ce354
- (id)init;	// IMP=0x00100000000ce2df
