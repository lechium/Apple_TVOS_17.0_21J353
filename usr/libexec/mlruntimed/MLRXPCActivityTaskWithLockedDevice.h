...
- (void)stop;	// IMP=0x0010000000003460
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003318
- (id)createTaskScheduler;	// IMP=0x00100000000032e8
- (id)criteria;	// IMP=0x0010000000003193
