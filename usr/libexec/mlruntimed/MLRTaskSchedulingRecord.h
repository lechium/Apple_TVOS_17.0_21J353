...
- (void).cxx_destruct;	// IMP=0x002000000000e0a5
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000e030
- (id)description;	// IMP=0x001000000000dfb2
- (id)initWithTaskID:(id)arg1;	// IMP=0x001000000000deb0
