...
- (void).cxx_destruct;	// IMP=0x0020000000005382
...
- (void)stopProducingData;	// IMP=0x001000000000529e
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004fbe
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000004ec0
