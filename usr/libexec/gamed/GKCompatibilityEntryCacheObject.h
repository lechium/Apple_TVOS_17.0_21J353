...
+ (id)entityName;	// IMP=0x004000000012ef52
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000012f570
- (id)internalRepresentation;	// IMP=0x001000000012ef5f
