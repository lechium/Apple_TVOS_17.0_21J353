...
+ (id)bagKey;	// IMP=0x00200000000f8437
- (void).cxx_destruct;	// IMP=0x00200000000f8b86
...
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000f8a14
@property(readonly, copy) NSString *description;
- (id)requestIdentifier;	// IMP=0x00100000000f88a5
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f8892
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f87b1
- (id)taskInfo;	// IMP=0x00100000000f8691
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x00100000000f8591
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f84e5
- (id)postBody;	// IMP=0x00100000000f8444
