...
+ (id)entityName;	// IMP=0x004000000013f7de
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000013fdfd
- (id)internalRepresentation;	// IMP=0x001000000013fa13
- (Class)classForInternalRepresentation;	// IMP=0x001000000013fa02
- (_Bool)hasDetails;	// IMP=0x001000000013f7eb
