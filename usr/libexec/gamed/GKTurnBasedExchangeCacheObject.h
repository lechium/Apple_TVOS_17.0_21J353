...
+ (id)entityName;	// IMP=0x004000000013a4aa
- (id)internalRepresentation;	// IMP=0x002000000013ae55
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x001000000013a4b7
