...
+ (id)deduperForPool:(id)arg1;	// IMP=0x004000000010afd7
+ (id)deduper;	// IMP=0x001000000010afbe
- (void).cxx_destruct;	// IMP=0x002000000010c6d7
...
- (void)notifyOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x001000000010c4f5
- (void)openRequestForResources:(id)arg1 processCallback:(CDUnknownBlockType)arg2;	// IMP=0x001000000010b43f
- (void)getTransactionPool:(CDUnknownBlockType)arg1;	// IMP=0x001000000010b148
- (id)initWithPool:(id)arg1;	// IMP=0x001000000010b038
- (id)init;	// IMP=0x001000000010b024
