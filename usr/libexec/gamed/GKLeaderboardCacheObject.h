...
+ (id)entityName;	// IMP=0x0020000000134167
- (id)internalRepresentation;	// IMP=0x0020000000133c93
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000001333cc
