...
+ (id)bagKey;	// IMP=0x00200000000f7a7c
- (void).cxx_destruct;	// IMP=0x00200000000f83d8
...
- (id)requestIdentifier;	// IMP=0x00100000000f820f
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f81fc
- (id)taskInfo;	// IMP=0x00100000000f801c
- (id)postBody;	// IMP=0x00100000000f800a
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000f7f79
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00100000000f7cbf
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f7b35
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f7a89
