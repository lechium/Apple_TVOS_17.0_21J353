...
+ (id)entityName;	// IMP=0x004000000013ae5d
- (id)internalRepresentation;	// IMP=0x002000000013b1bd
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000013ae6a
