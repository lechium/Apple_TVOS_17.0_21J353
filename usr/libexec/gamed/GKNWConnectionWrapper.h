...
- (void).cxx_destruct;	// IMP=0x002000000016af3a
...
- (void)cancelConnection;	// IMP=0x001000000016aea0
- (void)readData;	// IMP=0x001000000016ae9a
- (void)_sendData:(id)arg1;	// IMP=0x001000000016ae94
- (_Bool)sendData:(id)arg1;	// IMP=0x001000000016ae2f
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000016ac32
- (void)dealloc;	// IMP=0x001000000016ab95
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x001000000016aaaf
