...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001446c6
- (void).cxx_destruct;	// IMP=0x0020000000145c86
...
// Error: Property attributes should begin with the type ('T') attribute, property name: resolvedBundleID
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000145063
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001447ad
- (id)initWithChallenge:(id)arg1;	// IMP=0x0010000000144742
- (id)challengeInternalObject;	// IMP=0x001000000014473a
- (id)description;	// IMP=0x00100000001446ce
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001445f5
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000014441d
