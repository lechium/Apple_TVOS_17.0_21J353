...
+ (id)transportWithBag:(id)arg1 clientProxy:(id)arg2 credential:(id)arg3;	// IMP=0x0040000000112647
- (void).cxx_destruct;	// IMP=0x00200000001134f5
...
- (id)language;	// IMP=0x0010000000113473
- (void)postRequest:(id)arg1 forBagKey:(id)arg2 result:(CDUnknownBlockType)arg3;	// IMP=0x00100000001130d4
- (void)postRequest:(id)arg1 forBagKey:(id)arg2 response:(CDUnknownBlockType)arg3;	// IMP=0x0010000000112aa7
- (id)errorForBagError:(id)arg1 serverError:(id)arg2;	// IMP=0x0010000000112963
- (id)initWithBag:(id)arg1 clientProxy:(id)arg2 credential:(id)arg3;	// IMP=0x00100000001126d7
