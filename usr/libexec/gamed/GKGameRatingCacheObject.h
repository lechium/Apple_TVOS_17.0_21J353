...
+ (id)entityName;	// IMP=0x0040000000129d2b
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000129801
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0020000000129ab8
