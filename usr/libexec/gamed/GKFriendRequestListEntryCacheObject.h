...
+ (id)entityName;	// IMP=0x0040000000132200
- (id)internalRepresentation;	// IMP=0x0020000000131f47
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000131bd8
