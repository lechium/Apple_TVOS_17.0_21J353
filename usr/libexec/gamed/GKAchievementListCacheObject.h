...
+ (id)entityName;	// IMP=0x0040000000126a44
- (id)internalRepresentation;	// IMP=0x0020000000126d67
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000126ae1
- (_Bool)isValid;	// IMP=0x0010000000126a51
