...
+ (long long)coalescingDelay;	// IMP=0x00200000000f525f
+ (id)bagKey;	// IMP=0x00100000000f5252
- (void).cxx_destruct;	// IMP=0x00200000000f64e9
...
- (id)requestIdentifier;	// IMP=0x00100000000f6341
- (id)taskInfo;	// IMP=0x00100000000f61c6
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000f5ed6
- (id)postBody;	// IMP=0x00100000000f5e48
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f5e33
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000f5e20
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000f59ca
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f56f7
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000f5316
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f526a
