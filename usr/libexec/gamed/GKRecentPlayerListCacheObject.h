...
+ (Class)entryClass;	// IMP=0x0040000000134181
+ (id)entityName;	// IMP=0x0010000000134174
- (id)internalRepresentation;	// IMP=0x0020000000134418
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000134192
