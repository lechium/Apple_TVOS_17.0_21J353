...
+ (id)sharedManager;	// IMP=0x00200000000fd477
- (void).cxx_destruct;	// IMP=0x00200000000fdbdf
...
- (void)accountController:(id)arg1 accountAdded:(id)arg2;	// IMP=0x00100000000fd93c
- (void)fetchIDSDataForHandles:(id)arg1 service:(id)arg2 infoTypes:(unsigned long long)arg3 performingBlockPerBatch:(CDUnknownBlockType)arg4;	// IMP=0x00100000000fd633
- (_Bool)isReady;	// IMP=0x00100000000fd5e8
- (void)dealloc;	// IMP=0x00100000000fd5a3
- (id)init;	// IMP=0x00100000000fd4cc
