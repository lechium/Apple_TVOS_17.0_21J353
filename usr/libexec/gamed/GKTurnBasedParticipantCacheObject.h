...
+ (id)entityName;	// IMP=0x004000000013a077
- (id)internalRepresentation;	// IMP=0x002000000013a4a2
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000013a084
