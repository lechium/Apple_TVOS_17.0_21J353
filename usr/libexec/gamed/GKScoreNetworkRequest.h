...
+ (long long)coalescingDelay;	// IMP=0x00200000000f4fee
+ (id)bagKey;	// IMP=0x00100000000f447d
- (void).cxx_destruct;	// IMP=0x00200000000f51f3
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f4e0d
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000f4dfa
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000f4cd1
- (id)requestIdentifier;	// IMP=0x00100000000f4cc7
- (id)taskInfo;	// IMP=0x00100000000f4aec
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000f4a09
- (id)postBody;	// IMP=0x00100000000f4910
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithScores:(id)arg1 bundleID:(id)arg2 eligibleChallenges:(id)arg3;	// IMP=0x00100000000f454b
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f449f
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f448a
