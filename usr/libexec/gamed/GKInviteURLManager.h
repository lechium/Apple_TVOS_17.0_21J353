...
+ (id)sharedManager;	// IMP=0x00400000000c616e
- (void).cxx_destruct;	// IMP=0x00200000000c6685
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000000c63c0
- (id)init;	// IMP=0x00100000000c630c
