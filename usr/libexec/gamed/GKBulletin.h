...
@class GKBulletinAction, GKGameDescriptor, NSDate, NSString, NSURL;
...
+ (_Bool)playerIsLocal:(id)arg1;	// IMP=0x001000000018f97d
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x001000000018f3c9
+ (_Bool)shouldProcessNotification;	// IMP=0x001000000018f0ba
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000018ece4
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000018e0e3
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000018d909
+ (id)syncQueue;	// IMP=0x001000000018d888
+ (id)cacheTransactionGroup;	// IMP=0x0010000000190f61
- (void).cxx_destruct;	// IMP=0x002000000019017e
...
- (id)description;	// IMP=0x001000000018fcf2
- (void)reportMetricsForActionID:(id)arg1 withAdditionalFields:(id)arg2;	// IMP=0x001000000018f790
- (void)handleAction:(id)arg1;	// IMP=0x001000000018f568
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x001000000018f247
- (id)initWithPushNotification:(id)arg1;	// IMP=0x001000000018ee89
- (id)dataFrom64String:(id)arg1;	// IMP=0x001000000018ecec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000018e7b0
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000018e261
