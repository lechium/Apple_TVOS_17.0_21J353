...
+ (id)entityName;	// IMP=0x00200000001260a8
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000123ffb
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000123e36
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x0010000000123c71
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x0010000000123965
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x001000000012386a
+ (id)fetchSortDescriptors;	// IMP=0x001000000012378b
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000012377e
+ (id)uniqueAttributeName;	// IMP=0x0010000000123771
- (id)gameDescriptor;	// IMP=0x0020000000125c8c
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0010000000125bec
- (id)internalRepresentation;	// IMP=0x0010000000125a3d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000125034
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0010000000124714
- (_Bool)isValid;	// IMP=0x0010000000124696
