...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0020000000107c48
- (void).cxx_destruct;	// IMP=0x00200000001080ed
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000107d58
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0010000000107cba
