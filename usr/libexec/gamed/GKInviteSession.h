...
- (_Bool)shouldBeCleared;	// IMP=0x001000000017c7ab
- (void)removeAllResponses;	// IMP=0x001000000017c619
- (void)addResponse:(id)arg1;	// IMP=0x001000000017c5c9
- (void)removeAllInvitees;	// IMP=0x001000000017c27e
- (id)allInvitees;	// IMP=0x001000000017c25e
- (id)referencesForInvitee:(id)arg1;	// IMP=0x001000000017c1fb
- (void)removeInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x001000000017b837
- (void)addInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x001000000017b6b6
- (void)performSync:(CDUnknownBlockType)arg1;	// IMP=0x001000000017b6a5
- (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x001000000017b52a
- (id)initWithSessionToken:(id)arg1;	// IMP=0x001000000017b4d0
- (id)init;	// IMP=0x001000000017b3bb
