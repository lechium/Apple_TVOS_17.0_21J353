...
@class MISSING_TYPE, NSDate, NSOrderedSet, NSSet, NSString;

@interface GKChallengeCacheObject
{
}

+ (id)entityName;	// IMP=0x002000000013ea5c
+ (id)fetchSortDescriptors;	// IMP=0x001000000013da45
+ (id)challengeWithServerRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x001000000013d6a3
+ (id)challengesWithChallengeIDs:(id)arg1 context:(id)arg2;	// IMP=0x001000000013d485
+ (MISSING_TYPE *)uniqueObjectIDLookupKey;	// IMP=0x001000000013d478
+ (id)uniqueAttributeName;	// IMP=0x001000000013d46b
- (void)invalidate;	// IMP=0x002000000013ec25
- (_Bool)hasDetails;	// IMP=0x001000000013ea69
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000013e307
- (id)orderedSetOfCompatibleBundleIDs;	// IMP=0x001000000013df4c
- (id)internalRepresentation;	// IMP=0x001000000013dae6
- (Class)classForInternalRepresentation;	// IMP=0x001000000013dade
