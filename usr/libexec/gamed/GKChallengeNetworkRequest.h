...
+ (id)bagKey;	// IMP=0x00200000000f653d
- (void).cxx_destruct;	// IMP=0x00200000000f6d5d
...
- (id)requestIdentifier;	// IMP=0x00100000000f6bc8
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000f6a58
- (id)taskInfo;	// IMP=0x00100000000f68dd
- (id)postBody;	// IMP=0x00100000000f684f
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000f67a3
- (void)mergeRequestData:(id)arg1;	// IMP=0x00100000000f6717
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000f6686
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000f655d
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000f654a
