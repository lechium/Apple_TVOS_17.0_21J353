...
- (id)init;	// IMP=0x00200000001e7937
- (void)fairPlaySessionWithStoreBag:(GKStoreBag *)arg1 reporter:(GKReporter *)arg2 completionHandler:(void (^)(GKFairPlaySAPSession *, NSError *))arg3;	// IMP=0x00100000001e6ad8
- (id)initWithSession:(id)arg1;	// IMP=0x00100000001e5059
