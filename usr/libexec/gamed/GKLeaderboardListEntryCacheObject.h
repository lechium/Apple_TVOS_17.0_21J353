...
+ (id)entityName;	// IMP=0x004000000012aa57
- (id)internalRepresentation;	// IMP=0x002000000012acd7
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000012aa64
