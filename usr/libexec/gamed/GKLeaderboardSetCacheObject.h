...
+ (id)entityName;	// IMP=0x002000000012a845
- (id)internalRepresentation;	// IMP=0x002000000012a539
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000129ee5
