...
+ (id)entityName;	// IMP=0x00400000001276ff
- (id)internalRepresentation;	// IMP=0x00200000001276f7
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000012741b
