...
+ (id)searchCriterionForSenderAddresses:(id)arg1;	// IMP=0x0020000000008d62
- (void).cxx_destruct;	// IMP=0x0020000000009900
...
- (void)search:(id)arg1 didFinishWithError:(id)arg2;	// IMP=0x001000000000973b
- (_Bool)search:(id)arg1 didFindResults:(id)arg2;	// IMP=0x00100000000093e5
- (id)nextOutgoingMessageBatch;	// IMP=0x001000000000928e
- (void)searchMailWithSenderAddresses:(id)arg1;	// IMP=0x00100000000090de
- (void)searchAccounts:(id)arg1;	// IMP=0x0010000000008b61
- (void)initializeSearchIfNecessary;	// IMP=0x0010000000008884
- (id)init;	// IMP=0x001000000000882a
- (void)dealloc;	// IMP=0x00100000000087d0
