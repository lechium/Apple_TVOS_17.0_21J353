...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000081b64
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x0010000000081882
- (void)run;	// IMP=0x00100000000815c7
- (void)dealloc;	// IMP=0x0010000000081561
