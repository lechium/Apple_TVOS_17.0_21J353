...
- (void).cxx_destruct;	// IMP=0x00200000000669c4
- (void)_runForIdentity:(id)arg1;	// IMP=0x0010000000065f4c
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x00100000000659d5
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x00100000000657a8
- (void)run;	// IMP=0x00100000000653a5
