...
- (void).cxx_destruct;	// IMP=0x0020000000171305
- (id)_requestURL;	// IMP=0x00100000001711c2
- (void)main;	// IMP=0x0010000000170757
@property(readonly, copy) NSArray *statusPollRequests;
@property(copy) CDUnknownBlockType responseBlock;
- (id)initWithStatusPollRequests:(id)arg1;	// IMP=0x00100000001705a8
