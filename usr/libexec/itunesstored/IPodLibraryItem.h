...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00200000000f6783
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00200000000f7d9f
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x00100000000f7c38
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00100000000f733f
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f65cc
- (void)dealloc;	// IMP=0x00100000000f655d
- (id)init;	// IMP=0x00100000000f650f
