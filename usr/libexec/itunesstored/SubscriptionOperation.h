...
- (void).cxx_destruct;	// IMP=0x00200000000b5d81
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00100000000b5d79
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00100000000b5c49
- (void)run;	// IMP=0x00100000000b5be0
