...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x00400000000622ef
...
- (id)copyProduct;	// IMP=0x0010000000061ef7
- (void)dealloc;	// IMP=0x0010000000061e75
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000006178d
