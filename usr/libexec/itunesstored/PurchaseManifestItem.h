...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000f755
...
- (void)dealloc;	// IMP=0x001000000000f60c
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000f5b5
- (id)init;	// IMP=0x001000000000f569
