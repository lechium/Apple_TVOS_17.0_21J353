...
- (void).cxx_destruct;	// IMP=0x002000000006bdad
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x001000000006b730
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006a8bd
- (void)run;	// IMP=0x001000000006a81f
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x001000000006a678
