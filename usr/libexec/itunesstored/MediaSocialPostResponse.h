...
+ (id)_unrecoverableErrors;	// IMP=0x0020000000140a09
- (void).cxx_destruct;	// IMP=0x0020000000140b57
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x001000000014098f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001408de
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x00100000001404c6
