...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012b49
- (void).cxx_destruct;	// IMP=0x002000000001307d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012eb1
- (id)copyXPCEncoding;	// IMP=0x0010000000012df4
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000012be7
