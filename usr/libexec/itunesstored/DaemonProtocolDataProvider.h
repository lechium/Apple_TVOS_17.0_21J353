...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a0c1e
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001a0b8a
- (void)dealloc;	// IMP=0x00100000001a0b48
