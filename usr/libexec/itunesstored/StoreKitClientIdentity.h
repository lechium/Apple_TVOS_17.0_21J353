...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x0020000000198008
+ (void)initialize;	// IMP=0x0010000000197fda
...
- (id)description;	// IMP=0x00100000001987a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001986a7
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x001000000019841a
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x001000000019825a
- (void)dealloc;	// IMP=0x00100000001981ed
