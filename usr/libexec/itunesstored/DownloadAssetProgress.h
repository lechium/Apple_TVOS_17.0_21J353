...
- (void).cxx_destruct;	// IMP=0x00200000001ce871
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001ce707
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001ce6fd
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001ce570
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001ce4f4
