...
- (void).cxx_destruct;	// IMP=0x002000000000be6c
- (id)_loadStatusOnce:(id *)arg1;	// IMP=0x001000000000bab1
- (id)_getInitialStatus:(id *)arg1;	// IMP=0x001000000000b783
- (_Bool)_carrierBundleStatusIsValidForCachedStatus:(id)arg1;	// IMP=0x001000000000b5eb
- (void)_cacheAccountEligibilityWithStatus:(id)arg1;	// IMP=0x001000000000b2f8
- (void)run;	// IMP=0x001000000000a7ad
