...
- (void).cxx_destruct;	// IMP=0x00200000001c97c6
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001c90e4
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001c90de
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001c90d8
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001c90bc
- (void)dealloc;	// IMP=0x00100000001c908d
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001c8fbe
