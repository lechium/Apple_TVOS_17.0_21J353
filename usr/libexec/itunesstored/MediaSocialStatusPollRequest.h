...
- (void).cxx_destruct;	// IMP=0x0020000000026289
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000026137
- (unsigned long long)hash;	// IMP=0x0010000000026121
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002605d
