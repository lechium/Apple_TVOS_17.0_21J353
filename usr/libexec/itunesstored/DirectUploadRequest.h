...
- (void).cxx_destruct;	// IMP=0x002000000018ea62
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018e8fc
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x001000000018e619
