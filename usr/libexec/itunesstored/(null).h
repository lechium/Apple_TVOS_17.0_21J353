...
+ (id)propertiesForDownloadEntities;	// IMP=0x0040000000185e1a
+ (id)downloadEntityFromContext:(id)arg1;	// IMP=0x0010000000185dcd
- (void)awakeFromInsert;	// IMP=0x00200000001862f9
- (void)setValuesWithAssetDictionary:(id)arg1;	// IMP=0x0010000000185fd4
- (id)copySKDownload;	// IMP=0x0010000000185e85
