...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017d636
- (unsigned long long)hash;	// IMP=0x001000000017d62c
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x001000000017d605
@property(copy, nonatomic) NSString *statusDescription;
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x001000000017d5a0
@property(nonatomic) long long sessionState;
- (void)setSessionPropertyValues:(id)arg1;	// IMP=0x001000000017d4d6
...
- (void)dealloc;	// IMP=0x001000000017d274
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000017d239
- (id)init;	// IMP=0x001000000017d1c6
