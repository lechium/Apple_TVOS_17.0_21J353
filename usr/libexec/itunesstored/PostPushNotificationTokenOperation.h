...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x0020000000099315
- (void)run;	// IMP=0x0010000000098d51
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x0010000000098bf9
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x0010000000098b71
- (id)init;	// IMP=0x0010000000098b5b
