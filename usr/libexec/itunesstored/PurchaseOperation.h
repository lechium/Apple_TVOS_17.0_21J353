...
+ (double)_randomDouble;	// IMP=0x0020000000024520
+ (void)reportAnonymousPings:(id)arg1;	// IMP=0x00100000000179fd
- (void).cxx_destruct;	// IMP=0x0020000000025117
...
- (id)_URLBagContext;	// IMP=0x0010000000024dd5
- (_Bool)_shouldUseClientAuthentication;	// IMP=0x00100000000248f3
- (_Bool)_shouldSendSBSyncData;	// IMP=0x001000000002483d
- (_Bool)_shouldSendKeyBagSyncData;	// IMP=0x0010000000024648
- (void)_setMoveToiOS;	// IMP=0x001000000002455a
- (_Bool)_shouldDisableReversePush;	// IMP=0x0010000000024159
- (void)_setChangedBuyParameters:(id)arg1 fromDataProvider:(id)arg2;	// IMP=0x0010000000023fef
- (void)_scoreDeviceRetryFailedV2Score;	// IMP=0x0010000000023afc
- (void)_scoreDevice;	// IMP=0x001000000002323a
- (void)_runPurchaseRequest;	// IMP=0x00100000000223e0
- (void)_runDialogOperationForDialog:(id)arg1;	// IMP=0x00100000000201cb
- (id)_recordEngagementEventWithResult:(id)arg1 error:(id)arg2;	// IMP=0x001000000001f7da
- (long long)_purchaseType;	// IMP=0x001000000001f70b
- (id)_priceFromBuyParams;	// IMP=0x001000000001f605
- (void)_performAutoEnrollmentCheck;	// IMP=0x001000000001f457
- (void)_performApplePayClassicCheck;	// IMP=0x001000000001f2a9
- (void)_performMachineDataActionForURLResponse:(id)arg1;	// IMP=0x001000000001edfc
- (void)_performDelayedGotoForOperation:(id)arg1;	// IMP=0x001000000001ec74
- (id)_newRequestParameters;	// IMP=0x001000000001e431
- (id)_newPurchaseRequestOperation;	// IMP=0x001000000001c9f9
- (void)_handleFailureForOperation:(id)arg1;	// IMP=0x001000000001ba01
- (id)_fairPlaySubscriptionController;	// IMP=0x001000000001b9a5
- (id);	// IMP=0x001000000001b912
- (id)_countryCode;	// IMP=0x001000000001b50b
- (void)_continueTouchIDSessionWithDialog:(id)arg1;	// IMP=0x001000000001b2e0
- (_Bool)_clientIsViewService;	// IMP=0x001000000001b165
- (id)_buyParamProductType;	// IMP=0x001000000001aeeb
- (void)_addFairPlayToRequestProperties:(id)arg1 withAccountIdentifier:(unsigned long long)arg2;	// IMP=0x001000000001aee5
- (id)_accountWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000001adc1
- (id)_account;	// IMP=0x001000000001ac89
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;	// IMP=0x001000000001aa6e
- (void)sender:(id)arg1 shouldContinueTouchIDSession:(_Bool)arg2;	// IMP=0x001000000001aa4f
- (void)sender:(id)arg1 didFallbackToPassword:(_Bool)arg2;	// IMP=0x001000000001aa30
- (void)operation:(id)arg1 willSendRequest:(id)arg2;	// IMP=0x001000000001a972
- (void)operation:(id)arg1 shouldAuthenticateWithContext:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001a872
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x001000000001a503
- (id)uniqueKey;	// IMP=0x001000000001a4f6
- (void)run;	// IMP=0x0010000000018767
- (id)authenticatedAccountDSID;	// IMP=0x00100000000186f8
...
- (id)initWithPurchase:(id)arg1;	// IMP=0x00100000000174f2
- (id)init;	// IMP=0x00100000000174de
