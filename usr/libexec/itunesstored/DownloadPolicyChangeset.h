...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001766c8
- (void)dealloc;	// IMP=0x001000000017667e
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000176627
