...
+ (id)defaultProperties;	// IMP=0x0020000000175195
+ (Class)databaseEntityClass;	// IMP=0x0010000000175184
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00200000001751bc
@property(copy, nonatomic) NSData *policyData;
@property(readonly, nonatomic) SSDownloadPolicy *downloadPolicy;
- (void)dealloc;	// IMP=0x0010000000174ee9
