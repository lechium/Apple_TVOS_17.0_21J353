...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x0010000000084cbb
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x0010000000084bca
- (void)run;	// IMP=0x0010000000084ae6
- (void)dealloc;	// IMP=0x0010000000084a64
