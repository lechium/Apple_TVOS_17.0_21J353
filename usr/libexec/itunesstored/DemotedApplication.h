...
- (void).cxx_destruct;	// IMP=0x002000000003123e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000310a4
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000030b27
- (id)initWithApplication:(id)arg1;	// IMP=0x0010000000030996
