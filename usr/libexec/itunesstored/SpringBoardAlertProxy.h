...
- (void).cxx_destruct;	// IMP=0x002000000004b10e
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x001000000004af52
- (void)_disconnect;	// IMP=0x001000000004ae39
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x001000000004ace8
- (void)dealloc;	// IMP=0x000000000004ab7c
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000004a7fc
