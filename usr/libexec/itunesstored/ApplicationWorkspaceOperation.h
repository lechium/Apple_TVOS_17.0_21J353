...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000004d029
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x001000000004cfa8
- (void)dealloc;	// IMP=0x001000000004cf6d
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x001000000004cf16
