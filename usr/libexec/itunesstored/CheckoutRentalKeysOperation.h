...
- (void)_showErrorDialogForOutput:(id)arg1;	// IMP=0x001000000002979b
- (void)_run;	// IMP=0x001000000002912d
- (id)_primarySINF;	// IMP=0x00100000000290e8
- (_Bool)_performCheckout:(id *)arg1;	// IMP=0x0010000000028cd0
- (_Bool)_haveValidRentalInformation;	// IMP=0x001000000002872d
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000280f2
- (id)_copyRentalIdentifier;	// IMP=0x001000000002806c
- (id)_copyAccountIdentifier;	// IMP=0x0010000000027fe6
- (id)_bodyData;	// IMP=0x0010000000027571
- (void)run;	// IMP=0x0010000000027537
...
- (void)dealloc;	// IMP=0x0010000000027290
- (id)initWithStoreDownloadSinfs:(id)arg1;	// IMP=0x00100000000270b3
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x0010000000026fa5
- (id)initWithSinfs:(id)arg1;	// IMP=0x0010000000026ed1
- (id)init;	// IMP=0x0010000000026ebd
