...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010980
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x001000000001001a
- (id)_cachePath;	// IMP=0x001000000000ff8e
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000000fd9a
- (void)run;	// IMP=0x001000000000f7f1
- (void)dealloc;	// IMP=0x001000000000f78b
