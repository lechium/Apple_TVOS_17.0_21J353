...
- (void)_setInsertedItemPersistentIdentifier:(long long)arg1;	// IMP=0x002000000009de95
- (id)_libraryItem;	// IMP=0x001000000009de40
- (void)run;	// IMP=0x001000000009dc42
@property(readonly) NSNumber *insertedItemPersistentIdentifier;
@property(readonly) IPodLibraryItem *IPodLibraryItem;
- (void)dealloc;	// IMP=0x001000000009db3c
- (id)initWithIPodLibraryItem:(id)arg1;	// IMP=0x001000000009dade
