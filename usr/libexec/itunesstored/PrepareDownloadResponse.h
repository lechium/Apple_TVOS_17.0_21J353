...
- (void).cxx_destruct;	// IMP=0x002000000016c7c5
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000016bba7
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000016b51a
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000016b1bd
- (id)sessionConfiguration;	// IMP=0x001000000016afe8
