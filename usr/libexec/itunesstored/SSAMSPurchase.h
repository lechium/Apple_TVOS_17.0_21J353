...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001769a1
- (void).cxx_destruct;	// IMP=0x0020000000176cdb
...
- (_Bool)isEqualToPurchase:(id)arg1;	// IMP=0x0010000000176adc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000176a70
- (unsigned long long)hash;	// IMP=0x00100000001769a9
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000176893
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000017679b
