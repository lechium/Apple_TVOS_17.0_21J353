...
- (id)description;	// IMP=0x0020000000025d5e
...
- (id)resetDisavowedSessionProperties;	// IMP=0x00100000000258e3
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x00100000000254d7
- (void)dealloc;	// IMP=0x001000000002547f
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0010000000025435
