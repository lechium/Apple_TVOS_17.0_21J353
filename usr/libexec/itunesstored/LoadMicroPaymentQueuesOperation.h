...
- (void).cxx_destruct;	// IMP=0x0020000000083cf7
...
- (id)_URLBagContext;	// IMP=0x0010000000083c19
- (_Bool)_shouldCheckAutoRenewQueue;	// IMP=0x0010000000083b2d
- (_Bool)_appendToResponse:(id)arg1 usingOperation:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000083649
- (_Bool)_appendNormalQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000834e4
- (_Bool)_appendAutoRenewQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008337f
- (void)run;	// IMP=0x0010000000082c58
