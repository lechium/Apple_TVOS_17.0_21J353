...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x001000000018ebe7
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x001000000018ebc0
- (void)dealloc;	// IMP=0x001000000018eb68
