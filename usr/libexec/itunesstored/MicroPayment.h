...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x004000000003f1bf
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x001000000003f172
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x001000000004043f
- (id)_temporaryIdentifier;	// IMP=0x00100000000403f0
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x0010000000040394
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x001000000004030d
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x001000000003ff2f
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x001000000003fe48
- (void)setFailedWithError:(id)arg1;	// IMP=0x001000000003fd78
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x001000000003f999
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x001000000003f7a3
- (id)copyPaymentTransaction;	// IMP=0x001000000003f20b
- (void)dealloc;	// IMP=0x001000000003f124
