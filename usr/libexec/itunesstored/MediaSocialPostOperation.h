...
- (void).cxx_destruct;	// IMP=0x002000000018bf22
@property(nonatomic) long long postID; // @synthesize postID=_postID;
- (id)_targetDictionaryWithContentItem:(id)arg1;	// IMP=0x001000000018be29
- (id)_requestBodyDictionary;	// IMP=0x001000000018b6aa
- (id)_externalServiceDictionaryWithDestination:(id)arg1;	// IMP=0x001000000018b4e4
- (id)_attachmentDictionaryWithAttachment:(id)arg1;	// IMP=0x001000000018aedc
- (void)run;	// IMP=0x0010000000189fdf
@property(copy) NSString *userAgent;
@property(copy) CDUnknownBlockType resultBlock;
- (id)initWithPostEntity:(id)arg1;	// IMP=0x0010000000189a4a
- (id)initWithPostDescription:(id)arg1;	// IMP=0x00100000001898cc
