...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000264a6
- (unsigned long long)hash;	// IMP=0x001000000002649c
- (id)description;	// IMP=0x0010000000026436
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000026376
- (void)dealloc;	// IMP=0x001000000002631e
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000262bc
