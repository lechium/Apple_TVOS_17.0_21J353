...
- (void).cxx_destruct;	// IMP=0x00100000000120ac
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x0010000000011fa7
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x0010000000011cb0
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000011afc
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x0010000000010bb9
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000010ba4
- (id)init;	// IMP=0x0010000000010b92
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0010000000010b3a
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x001000000015feb0
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000015f5a8
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x001000000015f53f
