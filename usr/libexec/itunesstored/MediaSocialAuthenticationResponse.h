...
- (void).cxx_destruct;	// IMP=0x00200000000d5b77
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d5a83
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000d5a29
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000d59cf
- (id)init;	// IMP=0x00100000000d595a
