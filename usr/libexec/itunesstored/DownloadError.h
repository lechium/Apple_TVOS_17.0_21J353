...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000108099
- (_Bool)representsDownloadWithIdentifier:(long long)arg1;	// IMP=0x0010000000108038
- (void)removeDownloadIdentifier:(long long)arg1;	// IMP=0x0010000000107fde
- (void)performActionForResponseFlags:(unsigned long long)arg1;	// IMP=0x0010000000107fd8
...
- (id)copyUserNotification;	// IMP=0x0010000000107faa
- (_Bool)canCoalesceWithError:(id)arg1;	// IMP=0x0010000000107fa2
- (void)addDownloadIdentifiers:(id)arg1;	// IMP=0x0010000000107f65
- (void)addDownloadIdentifier:(long long)arg1;	// IMP=0x0010000000107ef4
- (void)dealloc;	// IMP=0x0010000000107e9c
