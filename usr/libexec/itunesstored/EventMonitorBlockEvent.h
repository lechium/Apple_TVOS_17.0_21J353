...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000126251
- (void)performAction;	// IMP=0x0010000000126237
- (_Bool)hasOccurred;	// IMP=0x000000000012621b
- (void)dealloc;	// IMP=0x00100000001261c3
