...
- (void)addRefreshed:(id)arg1;	// IMP=0x001000000010e182
- (void)addRevoked:(id)arg1;	// IMP=0x001000000010e126
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000010e048
- (void)dealloc;	// IMP=0x001000000010dfe2
