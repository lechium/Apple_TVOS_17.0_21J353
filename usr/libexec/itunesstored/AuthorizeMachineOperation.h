...
- (void)_setResponse:(id)arg1;	// IMP=0x002000000008d982
- (_Bool)_runAuthorizationWithAuthentication:(_Bool)arg1 error:(id *)arg2;	// IMP=0x001000000008d319
- (_Bool)_runAuthentication:(id *)arg1;	// IMP=0x001000000008d0fb
- (void)_run;	// IMP=0x001000000008cbea
- (id)_newURLOperation;	// IMP=0x001000000008c96e
- (id)_newMachineDataOperationWithResponse:(id)arg1;	// IMP=0x001000000008c8bd
- (id)_newBodyDictionary;	// IMP=0x001000000008c742
- (id)_newAuthenticationContext;	// IMP=0x001000000008c617
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008c39b
- (id)_accountIdentifier;	// IMP=0x001000000008c346
- (void)run;	// IMP=0x001000000008c30c
...
- (void)dealloc;	// IMP=0x001000000008bb77
- (id)initWithAuthorizationRequest:(id)arg1;	// IMP=0x001000000008ba53
