...
- (void).cxx_destruct;	// IMP=0x002000000009c751
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009c55a
- (id)copyXPCEncoding;	// IMP=0x001000000009c469
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x001000000009c28d
