...
- (void).cxx_destruct;	// IMP=0x0010000000106b85
...
- (id)description;	// IMP=0x0010000000106918
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000106391
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x001000000010622e
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000106bb8
