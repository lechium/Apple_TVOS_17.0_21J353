...
@interface VOTElementGesturedTextInputAttributes : NSObject
{
    ...
    _Bool _isActiveResponder;	// 13 = 0xd
...
- (void).cxx_destruct;	// IMP=0x00200000000622c2
@property(retain, nonatomic) NSString *language; // @synthesize language=_language;
@property(nonatomic) _Bool isActiveResponder; // @synthesize isActiveResponder=_isActiveResponder;
...
- (id)description;	// IMP=0x0010000000062003
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x0010000000061fe5
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x0010000000061f23
- (id)initWithAttributes:(id)arg1;	// IMP=0x0010000000061be2
