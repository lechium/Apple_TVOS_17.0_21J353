...
- (void).cxx_destruct;	// IMP=0x0020000000062a84
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x001000000006297a
- (long long)_currentGestureRepeaterEvent;	// IMP=0x0010000000062955
- (double)_delayForCurrentRepeatCount;	// IMP=0x0010000000062947
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x0010000000062867
- (void)updateWithEvent:(id)arg1;	// IMP=0x0010000000062622
- (void)dealloc;	// IMP=0x001000000006251f
- (id)initWithThread:(id)arg1;	// IMP=0x00100000000622d2
