...
- (void).cxx_destruct;	// IMP=0x0020000000251a7a
...
- (id)dictionaryRepresentation;	// IMP=0x00100000002519b6
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x00100000002518ce
