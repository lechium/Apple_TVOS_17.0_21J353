...
+ (id)sharedInstance;	// IMP=0x00400000002eda90
- (void).cxx_destruct;	// IMP=0x00200000002ed91a
...
- (_Bool)dictationOnlySyncDisabled;	// IMP=0x00100000002ed82b
- (_Bool)siriVocabularyNotificationForAddressBookSyncEnabled;	// IMP=0x00100000002ed70f
- (_Bool)_getConfigValueForFactor:(id)arg1;	// IMP=0x00100000002ed60b
- (void)_populateConfiguration;	// IMP=0x00100000002ed349
- (void)_registerUpdateHandler;	// IMP=0x00100000002ed17e
- (id)_initWithTriClient:(id)arg1;	// IMP=0x00100000002ed060
- (id)init;	// IMP=0x00100000002ed001
