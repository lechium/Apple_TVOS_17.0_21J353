...
@class AFAudioPlaybackRequest, AFBluetoothDeviceInfo, AFCompanionDeviceInfo, AFDeleteSiriHistoryContext, AFMyriadAdvertisementContext, AFRequestInfo, AFSpeechRecognition, AFVoiceInfo, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSURL, NSUUID, SAConfidenceScores;
...
- (void)JSCapableHomeDevices:(void (^)(NSArray *))arg1;
...
- (MISSING_TYPE *)trimRecordedAudioWithIdentifier:offset:duration:outputFileType:completion: /* Error: Ran out of types for this method. */;
...
- (oneway void)_isDisablingDictationOnlySyncSupported:(void (^)(_Bool))arg1;
- (oneway void)_isSiriVocabularyNotificationForAddressBookSyncSupported:(void (^)(_Bool))arg1;
