...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000016bebf
- (void).cxx_destruct;	// IMP=0x002000000016be81
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000016bcb1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000016bc03
