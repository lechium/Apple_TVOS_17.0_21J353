...
@class ACAccount, HMAccessory, HMAccessorySettings, HMCharacteristic, HMDevice, HMFPairingIdentity, HMFSoftwareVersion, HMFWiFiNetworkInfo, HMService, HMSymptomsHandler, MISSING_TYPE, NSString;
...
- (MISSING_TYPE *)accessory:didRemoveControlTarget: /* Error: Ran out of types for this method. */;
