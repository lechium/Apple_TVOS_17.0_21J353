...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x002000000010c642
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a90e6
- (void).cxx_destruct;	// IMP=0x002000000010c4df
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010bc42
- (unsigned long long)hash;	// IMP=0x001000000010b8c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010b347
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010ad75
- (void)copyTo:(id)arg1;	// IMP=0x001000000010a983
- (void)writeTo:(id)arg1;	// IMP=0x001000000010a528
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000109cce
- (id)dictionaryRepresentation;	// IMP=0x00100000001096a8
- (id)description;	// IMP=0x00100000001095f9
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001094bf
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000001094a2
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x0010000000109438
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x001000000010941b
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c94ca
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014dd40
