...
- (void).cxx_destruct;	// IMP=0x00200000000e197c
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000e163b
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000e1340
- (void)dealloc;	// IMP=0x00100000000e1072
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000e0f67
- (id)init;	// IMP=0x00100000000e0f59
