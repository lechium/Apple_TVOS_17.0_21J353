...
- (void).cxx_destruct;	// IMP=0x002000000012fb27
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x001000000012fad7
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x001000000012fa89
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x001000000012f9c3
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x001000000012f92c
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x001000000012f893
