...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00200000000a90fc
- (void).cxx_destruct;	// IMP=0x002000000010f263
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010f12c
- (unsigned long long)hash;	// IMP=0x001000000010f0a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010ef9c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010eeb2
- (void)copyTo:(id)arg1;	// IMP=0x001000000010ee0f
- (void)writeTo:(id)arg1;	// IMP=0x001000000010ed78
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000010ebb6
- (id)dictionaryRepresentation;	// IMP=0x001000000010eae5
- (id)description;	// IMP=0x001000000010ea36
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c9631
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014df49
