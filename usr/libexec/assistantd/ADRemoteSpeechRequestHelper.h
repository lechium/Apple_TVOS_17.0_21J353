...
- (void).cxx_destruct;	// IMP=0x00200000001381bf
...
- (void)reset;	// IMP=0x001000000013815d
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001380a0
