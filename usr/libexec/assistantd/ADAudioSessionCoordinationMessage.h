...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002f9f6f
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000002f9f22
- (void).cxx_destruct;	// IMP=0x00200000002f9abe
...
- (id)buildDictionaryRepresentation;	// IMP=0x00100000002f9830
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000002f9378
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002f923d
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002f9007
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002f8ffc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002f8d4e
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x00100000002f8b57
@property(readonly, copy) NSString *description;
- (id)initWithHostTime:(unsigned long long)arg1 type:(long long)arg2 payloadBeginAudioSessionRequest:(id)arg3 payloadBeginAudioSessionResponse:(id)arg4 payloadKeepAudioSessionAliveRequest:(id)arg5 payloadKeepAudioSessionAliveResponse:(id)arg6 payloadEndAudioSessionRequest:(id)arg7 payloadEndAudioSessionResponse:(id)arg8;	// IMP=0x00100000002f89b9
- (id)init;	// IMP=0x00100000002f89a5
- (id)initWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000002f8738
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x00100000002f9f77
