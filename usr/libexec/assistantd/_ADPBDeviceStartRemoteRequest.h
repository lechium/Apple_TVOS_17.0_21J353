...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00200000000a90db
- (void).cxx_destruct;	// IMP=0x00000000001ddd96
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001ddbea
- (unsigned long long)hash;	// IMP=0x00100000001ddb18
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001dd9a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001dd866
- (void)copyTo:(id)arg1;	// IMP=0x00100000001dd783
- (void)writeTo:(id)arg1;	// IMP=0x00100000001dd6a8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001dd425
- (id)dictionaryRepresentation;	// IMP=0x00100000001dd2c8
- (id)description;	// IMP=0x00100000001dd219
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c93f1
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014dc2c
