...
- (void).cxx_destruct;	// IMP=0x0020000000211f18
...
- (id)analyticsDictionary;	// IMP=0x0010000000211c31
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x0010000000211c23
- (void)markSucceeded;	// IMP=0x0010000000211c19
- (void)markEndTime;	// IMP=0x0010000000211be0
- (void)markStartTime;	// IMP=0x0010000000211ba7
- (_Bool)hasFailureType;	// IMP=0x0010000000211b99
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x0010000000211b1a
