...
- (void).cxx_destruct;	// IMP=0x00200000001ce7ba
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ce6df
- (unsigned long long)hash;	// IMP=0x00100000001ce630
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001ce58f
- (id)description;	// IMP=0x00100000001ce4b1
