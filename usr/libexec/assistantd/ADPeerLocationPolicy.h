...
- (void).cxx_destruct;	// IMP=0x00200000001e755f
...
- (void)_resetTimer;	// IMP=0x00100000001e741b
- (void)_cancelTimer;	// IMP=0x00100000001e73e5
- (void)locationPeerDidChange;	// IMP=0x00100000001e739a
- (void)locationDataWasRecievedFromPeer;	// IMP=0x00100000001e734f
- (id)init;	// IMP=0x00100000001e72b8
