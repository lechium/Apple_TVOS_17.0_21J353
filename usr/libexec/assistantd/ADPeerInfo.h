...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x00200000002f8556
+ (id)locallyPairedPeerInfo;	// IMP=0x00100000002f8466
+ (id)_queue;	// IMP=0x00100000002f8436
- (void).cxx_destruct;	// IMP=0x00200000002f81d4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002f7f10
- (unsigned long long)hash;	// IMP=0x00100000002f7efa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002f7eef
- (id)afPeerInfo;	// IMP=0x00100000002f7e92
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x00100000002f7d7b
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x00100000002f79c4
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x00100000002f7957
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x00100000002f793d
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x00100000002f7826
