...
- (void).cxx_destruct;	// IMP=0x00200000000b71f2
...
- (void)dealloc;	// IMP=0x00100000000b703c
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2 shouldEmitInstrumentationEvent:(_Bool)arg3;	// IMP=0x00100000000b6fe4
- (id)initWithRemoteAnnouncement:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b6e6d
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b6daf
- (id)_initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 announcementIdentifier:(id)arg3 timeOfRequestArrival:(id)arg4 startLocalRequest:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00100000000b6c0f
