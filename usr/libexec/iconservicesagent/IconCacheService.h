...
- (void)clearCache;	// IMP=0x001000000000362a
- (void)scheduleCacheOperation:(unsigned long long)arg1;	// IMP=0x001000000000350a
- (void)start;	// IMP=0x00100000000033f6
- (id)initWithServiceName:(id)arg1;	// IMP=0x00100000000030ec
- (id)generateStoreUnitWithRequest:(id)arg1 validationToken:(id *)arg2;	// IMP=0x001000000000437b
- (void)clearCachedItemsForBundeID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004321
- (void)generateImageWithRequest:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003b9e
- (void)fetchCacheConfigurationWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000000397f
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000037c0
