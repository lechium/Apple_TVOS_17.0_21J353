...
- (void).cxx_destruct;	// IMP=0x0020000000288cbd
...
// Error: Property attributes should begin with the type ('T') attribute, property name: remoteSKEData
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x001000000028883b
- (void)_addRemotePacketOutage;	// IMP=0x00100000002887ad
- (id)description;	// IMP=0x00100000002886bf
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x0010000000288384
