...
- (void).cxx_destruct;	// IMP=0x002000000000a09f
...
- (id)messageBody;	// IMP=0x0010000000009a29
- (id)requiredKeys;	// IMP=0x00100000000099ef
- (id)bagKey;	// IMP=0x00100000000099e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000009914
