...
- (void).cxx_destruct;	// IMP=0x0020000000426066
...
- (id)description;	// IMP=0x0010000000425f9c
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x0010000000425f03
