...
- (void).cxx_destruct;	// IMP=0x002000000013838d
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000137f7f
- (id)additionalMessageHeaders;	// IMP=0x0010000000137df4
- (id)messageBody;	// IMP=0x0010000000137bf5
- (id)requiredKeys;	// IMP=0x0010000000137b9c
- (id)bagKey;	// IMP=0x0010000000137b8f
- (long long)responseCommand;	// IMP=0x0010000000137b84
- (long long)command;	// IMP=0x0010000000137b79
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000137b71
- (_Bool)wantsCompressedBody;	// IMP=0x0010000000137b69
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000137b61
- (_Bool)wantsBagKey;	// IMP=0x0010000000137b59
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001379c2
- (void)addPhoneAuthenticationCertificate:(id)arg1 withUserID:(id)arg2;	// IMP=0x001000000013790e
- (id)init;	// IMP=0x0010000000137846
