...
@interface IDSRegistration : NSObject
{
    ...
    NSDictionary *_migrationContext;	// 208 = 0xd0
...
- (void).cxx_destruct;	// IMP=0x001000000040c554
...
// Error: Property attributes should begin with the type ('T') attribute, property name: uris
...
- (id)debugDescription;	// IMP=0x0010000000409ed9
- (id)description;	// IMP=0x0010000000409b1a
- (id)_userStore;	// IMP=0x0010000000409a99
- (id)_user;	// IMP=0x0010000000409a36
- (void)voidPassword;	// IMP=0x00100000004097fc
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x001000000040965b
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004084d2
...
- (id)_userID;	// IMP=0x001000000040746b
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x001000000040734d
- (void)addCandidateEmail:(id)arg1;	// IMP=0x001000000040726f
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x0010000000407206
- (_Bool)removeFromKeychain;	// IMP=0x00100000004071ae
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000404cd2
- (id)init;	// IMP=0x0010000000404c78
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x0010000000404bda
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000404bcf
- (id)_keychain_comparisonValue;	// IMP=0x0010000000214b78
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x00100000002149d1
