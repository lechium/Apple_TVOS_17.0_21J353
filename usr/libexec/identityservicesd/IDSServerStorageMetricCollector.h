...
- (void).cxx_destruct;	// IMP=0x002000000027fb69
...
- (id)dictionaryMetric;	// IMP=0x001000000027f932
- (void)reportMetric;	// IMP=0x001000000027f785
- (void)endCollector;	// IMP=0x001000000027f728
- (void)incrementMessageCount;	// IMP=0x001000000027f6f6
- (id)awdLogger;	// IMP=0x001000000027f6dd
- (id)initWithTopic:(id)arg1 isPrimary:(_Bool)arg2;	// IMP=0x001000000027f618
