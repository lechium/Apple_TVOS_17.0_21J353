...
- (void).cxx_destruct;	// IMP=0x00200000002d675b
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000002d6577
- (id)bagKey;	// IMP=0x00100000002d656a
- (id)messageBody;	// IMP=0x00100000002d648a
- (id)additionalMessageHeaders;	// IMP=0x00100000002d6352
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002d61b5
