...
- (void).cxx_destruct;	// IMP=0x00200000002839a0
...
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000283951
- (id)messageBody;	// IMP=0x001000000028384d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002837d7
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x001000000028371f
