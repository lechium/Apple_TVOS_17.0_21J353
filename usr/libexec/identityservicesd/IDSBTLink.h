...
- (void).cxx_destruct;	// IMP=0x0020000000438bce
...
- (void)injectFakePacket:(CDStruct_a8d8a807 *)arg1;	// IMP=0x0010000000438a0f
- (void)suspendLink:(_Bool)arg1;	// IMP=0x00100000004387ed
- (_Bool)isLinkSuspended;	// IMP=0x00100000004387e1
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000043856a
- (void)_processOutgoingPacket;	// IMP=0x001000000043812e
- (void)_processIncomingPacket;	// IMP=0x001000000043697e
- (long long)_readFromDataChannel:(void *)arg1 size:(unsigned long long)arg2 withFlags:(int)arg3 isSynced:(_Bool *)arg4;	// IMP=0x0010000000436971
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000004366a8
- (void)flushBuffer:(unsigned long long)arg1;	// IMP=0x0010000000436696
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000043668b
- (unsigned long long)sendPacketBuffer:(CDStruct_a8d8a807 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000004362bf
- (void)invalidate;	// IMP=0x0010000000436286
- (void)remoteDetectedCorruption;	// IMP=0x0010000000436149
- (void)start;	// IMP=0x00100000004360aa
- (void)triggerBTCorruptionRecovery;	// IMP=0x0010000000436098
- (void)_submitMagnetCorruptionMetricsToAWD;	// IMP=0x0010000000435e4f
- (void)_resetMagnetCorruptionMetrics;	// IMP=0x0010000000435e3a
- (void)_dumpLogs:(double)arg1 isDownstream:(_Bool)arg2;	// IMP=0x0010000000435974
- (void)_localDetectedCorruption;	// IMP=0x0010000000435844
- (void)dealloc;	// IMP=0x0010000000435643
- (id)initWithPipe:(id)arg1 useSkywalkChannel:(_Bool)arg2 withDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000434fed
- (id)copyLinkStatsDict;	// IMP=0x0010000000434ed2
