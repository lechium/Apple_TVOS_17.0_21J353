...
+ (id)sharedInstance;	// IMP=0x0040000000421d76
- (void).cxx_destruct;	// IMP=0x0020000000422305
...
- (void)_timerFiredOnMain;	// IMP=0x0010000000422237
- (void)_timerFired;	// IMP=0x001000000042208b
- (void)removeTarget:(id)arg1;	// IMP=0x001000000042200e
- (void)addTarget:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000421f2c
- (_Bool)hasActionForTarget:(id)arg1;	// IMP=0x0010000000421ef5
- (id)initWithTimerBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000421e57
