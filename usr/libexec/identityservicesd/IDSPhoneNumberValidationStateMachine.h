...
- (void).cxx_destruct;	// IMP=0x002000000027b70d
...
- (void)persistNumberOfPreflightAttempts:(unsigned int)arg1;	// IMP=0x001000000027b467
- (unsigned int)loadNumberOfPreflightAttempts;	// IMP=0x001000000027b44f
- (void)persistNumberOfSuccessfulValidationSends:(unsigned int)arg1;	// IMP=0x001000000027b434
- (unsigned int)loadNumberOfSuccessfulValidationSends;	// IMP=0x001000000027b41c
- (void)heartbeat;	// IMP=0x001000000027af50
- (void)removePhoneNumberValidationRequestor:(id)arg1;	// IMP=0x001000000027addb
- (id)identifyPhoneNumberForRequestor:(id)arg1 queue:(id)arg2;	// IMP=0x001000000027ad19
- (void)addPhoneNumberValidationRequestor:(id)arg1;	// IMP=0x001000000027abfd
- (void)removeListener:(id)arg1;	// IMP=0x001000000027abe7
- (void)addListener:(id)arg1;	// IMP=0x001000000027ab65
- (void)timedOutWaitingForSMS;	// IMP=0x001000000027a761
- (void)resetSMSCounter;	// IMP=0x001000000027a60d
- (void)handleIncomingSMSForResponse:(id)arg1;	// IMP=0x0010000000279de8
- (void)handleRegistrationSMSSuccessfullyDeliveredWithTelephonyTimeout:(id)arg1;	// IMP=0x001000000027997f
- (void)handleRegistrationSMSDeliveryFailedWithShouldBypassRetry:(_Bool)arg1;	// IMP=0x00100000002793e9
- (void)handleRegistrationSMSDeliveryFailed;	// IMP=0x00100000002793d5
- (void)_requestUserConsentForPhoneNumberValidationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000002792c6
- (void)_tryToSendSMSIdentification;	// IMP=0x00100000002787d2
- (void)_sendPreflightVerificationWithIMSI:(id)arg1 PLMN:(id)arg2;	// IMP=0x0010000000277f34
- (void)_performHighestPriorityPreflightVerification;	// IMP=0x0010000000277ee8
- (void)_popHighestPriorityPreflightVerification;	// IMP=0x0010000000277e2d
- (id)_getHighestPriorityMechanism;	// IMP=0x0010000000277d90
- (void)_sendPreflightVerificationIfNeeded;	// IMP=0x0010000000277a5e
- (void)_issueAsyncCoreTelephonyPhoneNumberValidationRequestWithPushToken:(id)arg1 mechanism:(id)arg2;	// IMP=0x0010000000277a58
- (void)_sendSMSVerificationWithMechanism:(id)arg1;	// IMP=0x0010000000277720
- (void)_lastSendSMSTimerFiredOnMain;	// IMP=0x00100000002776a1
- (void)_setSMSDeliveryTimeout:(double)arg1;	// IMP=0x00100000002774fd
- (_Bool)_canDeliverSMSNow;	// IMP=0x00100000002774ef
- (void)_smsDeliveryClear;	// IMP=0x0010000000277372
- (void)_clearSMSDeliveryTimeout;	// IMP=0x0010000000277340
- (void)_keychainMigrationComplete:(id)arg1;	// IMP=0x0010000000277271
- (void)_SIMSetupDidComplete;	// IMP=0x00100000002771e0
- (void)systemRestoreStateDidChange;	// IMP=0x001000000027713b
- (void)systemDidStopBackup;	// IMP=0x0010000000277096
- (void)systemDidFinishMigration;	// IMP=0x0010000000276f4c
- (void)PNRResponseReceivedWithResponseData:(id)arg1;	// IMP=0x0010000000276bcc
- (void)PNRRequestSentWithRequestData:(id)arg1;	// IMP=0x0010000000276888
- (void)PNRReadyStateChanged:(_Bool)arg1;	// IMP=0x001000000027676a
- (void)_deviceIDChangedNotification:(id)arg1;	// IMP=0x0010000000276668
- (void)_registerForLockdownNotifications;	// IMP=0x0010000000276572
- (void)_lockdownStateChanged:(id)arg1;	// IMP=0x001000000027643e
- (_Bool)_validSIMStateForRegistration;	// IMP=0x001000000027639a
- (_Bool)_deviceCanRegisterPresently;	// IMP=0x0010000000276216
- (long long)_errorCodeForRegistrationError:(long long)arg1;	// IMP=0x00100000002761af
- (void)_failPromisesWithError:(long long)arg1;	// IMP=0x0010000000276017
- (void)_fulfillPromisesWithPhoneNumber:(id)arg1 token:(id)arg2;	// IMP=0x0010000000275e5c
- (void)_notifySuccess:(id)arg1;	// IMP=0x00100000002756c2
- (void)_notifyFailureWithError:(long long)arg1;	// IMP=0x0010000000274fd2
- (_Bool)_isAwaitingUserSelectionDuringSetup;	// IMP=0x0010000000274fca
- (_Bool)_isUserSubscriptionSelectionStillPending;	// IMP=0x0010000000274e35
- (_Bool)_userHasDisabledSMSRegistration;	// IMP=0x0010000000274e2d
- (long long)_registrationControlStatus;	// IMP=0x0010000000274dde
@property(copy, nonatomic) IDSPreflightStack *currentPreflightStack;
- (void)_registerForDeviceCenterNotifications;	// IMP=0x0010000000274c65
- (void)dealloc;	// IMP=0x0010000000274c27
- (void)invalidate;	// IMP=0x0010000000274b3d
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2;	// IMP=0x0010000000274995
- (id)initWithCTPNR:(id)arg1 preflightStackStore:(id)arg2 HTTPDelivery:(id)arg3 pushHandler:(id)arg4 lockdownManager:(id)arg5 systemMonitor:(id)arg6 arbiter:(id)arg7 systemAccountAdapter:(id)arg8;	// IMP=0x0010000000274530
- (void)_cancelScheduledSMSTimeout;	// IMP=0x00100000002744a8
- (void)_scheduleSMSTimeout:(double)arg1;	// IMP=0x0010000000274355
- (void)_cancelScheduledHeartbeat;	// IMP=0x00100000002742cd
- (void)_scheduleHeartbeat:(double)arg1;	// IMP=0x0010000000274141
@property(readonly, copy) NSString *description;
- (_Bool)_isPhoneNumberIdentificationSupported;	// IMP=0x001000000027403d
