...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000046b05
- (void).cxx_destruct;	// IMP=0x0020000000046d33
...
- (id)description;	// IMP=0x0010000000046c94
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000046b9c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000046b0d
