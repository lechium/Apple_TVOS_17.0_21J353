...
- (void).cxx_destruct;	// IMP=0x002000000018d10e
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000018cdc6
- (id)messageBody;	// IMP=0x001000000018cce7
- (id)requiredKeys;	// IMP=0x001000000018ccad
- (_Bool)requiresPushTokenKeys;	// IMP=0x001000000018cca5
- (double)anisetteHeadersTimeout;	// IMP=0x001000000018cc97
- (_Bool)wantsBinaryPush;	// IMP=0x001000000018cc8f
- (_Bool)wantsCompressedBody;	// IMP=0x001000000018cc87
- (_Bool)wantsHTTPHeaders;	// IMP=0x001000000018cc7f
- (_Bool)wantsBagKey;	// IMP=0x001000000018cc77
- (_Bool)wantsBodySignature;	// IMP=0x001000000018cc6f
- (_Bool)wantsBodySigningOnly;	// IMP=0x001000000018cc67
- (id)bagKey;	// IMP=0x001000000018cc5a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018cb37
