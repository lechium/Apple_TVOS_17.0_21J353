...
+ (id)sharedInstance;	// IMP=0x002000000017f765
- (void).cxx_destruct;	// IMP=0x0020000000183538
...
- (void)_postPendingConsentAlerts;	// IMP=0x0010000000183196
- (void)requestUserConsentToValidatePhoneNumberForCTPNR:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000182773
- (void)_sendABCForFailureForIdentifier:(id)arg1 WithEvent:(long long)arg2 context:(id)arg3;	// IMP=0x00100000001825d1
- (void)_resetRateLimitersForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x0010000000182572
- (_Bool)_hasThresholdReachedForSMSTimeoutForIdentifier:(id)arg1;	// IMP=0x00100000001824e9
- (void)validator:(id)arg1 handleABCEvent:(long long)arg2;	// IMP=0x00100000001823d9
- (void)validator:(id)arg1 failedIdentificationWithRegistrationError:(long long)arg2;	// IMP=0x0010000000182330
- (void)validator:(id)arg1 identifiedPhoneNumber:(id)arg2 token:(id)arg3 phoneBookNumber:(id)arg4;	// IMP=0x0010000000182117
- (id)_identifierForValidator:(id)arg1;	// IMP=0x0010000000181f71
- (void)_notifyNeedsNewIdentification;	// IMP=0x0010000000181d83
- (void)_notifySuccess:(id)arg1 token:(id)arg2 identifier:(id)arg3;	// IMP=0x00100000001813c9
- (void)_notifyFailureWithError:(long long)arg1 registration:(id)arg2 identifier:(id)arg3;	// IMP=0x0010000000180d7f
- (void)removeListener:(id)arg1;	// IMP=0x0010000000180d69
- (void)addListener:(id)arg1;	// IMP=0x0010000000180ce7
- (void)_noteRegistrationAttemptForIdentifier:(id)arg1 withRegistrationInfo:(id)arg2;	// IMP=0x00100000001809b2
- (void)notePhoneNumberRegistrationReset;	// IMP=0x0010000000180862
- (void)cancelActionsForRegistrationInfo:(id)arg1;	// IMP=0x00100000001807e4
- (void)_clearConsentDenialsForUniqueIdentifier:(id)arg1;	// IMP=0x0010000000180687
- (void)clearConsentDenialsForPhoneUser:(id)arg1;	// IMP=0x0010000000180638
- (void)clearConsentDenialsForRegistration:(id)arg1;	// IMP=0x00100000001805e9
- (void)_cleanupUntrackedValidators;	// IMP=0x00100000001802ac
- (void)sendRegistration:(id)arg1;	// IMP=0x001000000017fc0d
- (void)dealloc;	// IMP=0x001000000017fa5c
- (id)initWithRestoreMonitor:(id)arg1 systemMonitor:(id)arg2;	// IMP=0x001000000017f89e
- (id)init;	// IMP=0x001000000017f81d
