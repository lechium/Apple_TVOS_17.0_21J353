...
- (void).cxx_destruct;	// IMP=0x002000000037000a
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x001000000036f4fb
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x001000000036f0be
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x001000000036ef25
- (void)invalidate;	// IMP=0x001000000036e920
- (void)dealloc;	// IMP=0x001000000036e897
- (void)_closeSockets;	// IMP=0x001000000036e491
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x001000000036e1c0
- (id)flagsString;	// IMP=0x001000000036e110
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x001000000036e103
- (id)description;	// IMP=0x001000000036dcf3
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x001000000036d9cb
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x001000000036d6ad
