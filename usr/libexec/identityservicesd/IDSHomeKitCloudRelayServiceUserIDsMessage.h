...
- (void).cxx_destruct;	// IMP=0x00200000004009c9
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000400824
- (id)messageBody;	// IMP=0x00100000004007a6
- (id)bagKey;	// IMP=0x0010000000400799
- (id)additionalMessageHeaders;	// IMP=0x00100000004006ba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004005db
