...
+ (id)sharedInstance;	// IMP=0x004000000042e254
- (void).cxx_destruct;	// IMP=0x002000000042edb4
...
- (void)setState:(unsigned long long)arg1 forProperty:(unsigned long long)arg2 deviceUniqueID:(id)arg3;	// IMP=0x001000000042e7d1
- (void)updateStateForDeviceWithUniqueID:(id)arg1;	// IMP=0x001000000042e75b
- (unsigned long long)_getCurrentState:(id)arg1;	// IMP=0x001000000042e5ce
- (void)dealloc;	// IMP=0x001000000042e3dd
- (id)initWithUTunDeliveryController:(id)arg1 pairingManager:(id)arg2;	// IMP=0x001000000042e32a
- (id)init;	// IMP=0x001000000042e2a9
