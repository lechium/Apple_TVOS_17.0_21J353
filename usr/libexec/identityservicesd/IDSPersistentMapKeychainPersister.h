...
- (void).cxx_destruct;	// IMP=0x0020000000354a65
...
- (void)purgeData;	// IMP=0x0010000000354908
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000003546cf
- (id)data;	// IMP=0x00100000003544d1
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00100000003543d1
