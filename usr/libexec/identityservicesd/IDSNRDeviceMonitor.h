...
- (void).cxx_destruct;	// IMP=0x0020000000004de1
...
- (id)init;	// IMP=0x0010000000004d93
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000004d85
