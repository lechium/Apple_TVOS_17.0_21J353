...
- (void).cxx_destruct;	// IMP=0x0020000000356620
...
- (void)purgeData;	// IMP=0x001000000035645f
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000003563af
- (id)data;	// IMP=0x0010000000356365
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x0010000000356142
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000003560ab
