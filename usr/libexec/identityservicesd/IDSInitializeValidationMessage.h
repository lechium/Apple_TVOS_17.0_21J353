...
- (void).cxx_destruct;	// IMP=0x0020000000421cce
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000421a29
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000421a21
- (id)additionalMessageHeaders;	// IMP=0x00100000004218e2
- (id)messageBody;	// IMP=0x0010000000421786
- (id)requiredKeys;	// IMP=0x001000000042174c
- (id)bagKey;	// IMP=0x001000000042173f
- (long long)responseCommand;	// IMP=0x0010000000421734
- (long long)command;	// IMP=0x0010000000421729
- (double)anisetteHeadersTimeout;	// IMP=0x001000000042171b
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000421713
- (_Bool)wantsCompressedBody;	// IMP=0x001000000042170b
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000421703
- (_Bool)wantsBagKey;	// IMP=0x00100000004216fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000421508
- (id)init;	// IMP=0x0010000000421440
