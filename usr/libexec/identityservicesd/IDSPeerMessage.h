...
@interface IDSPeerMessage : IDSMessage
{
    ...
    NSNumber *_sendMode;	// 352 = 0x160
}

- (void).cxx_destruct;	// IMP=0x00200000000f9b83
...
- (id)messageBody;	// IMP=0x00100000000f931f
- (id)requiredKeys;	// IMP=0x00100000000f9266
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f8fcc
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x00100000000f8f71
- (id)init;	// IMP=0x00100000000f8f20
