...
- (void).cxx_destruct;	// IMP=0x002000000042dd1e
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x001000000042d9b6
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x001000000042d476
- (double)lastSocketActivityTime;	// IMP=0x001000000042d46b
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000042ce37
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000042ce23
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x001000000042c591
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x001000000042c57f
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x001000000042bff4
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000042bf7b
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x001000000042bee1
- (void)endSession;	// IMP=0x001000000042bdba
- (void)dealloc;	// IMP=0x001000000042bd31
- (void)start;	// IMP=0x001000000042b86f
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x001000000042b69f
