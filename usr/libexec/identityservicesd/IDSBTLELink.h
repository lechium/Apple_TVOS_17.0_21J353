...
@interface IDSBTLELink : NSObject
{
    ...
    CDStruct_a8d8a807 *_incomingPacketBuffer;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x00200000000f77eb
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x00100000000f74b0
- (void)_didReceiveData:(id)arg1;	// IMP=0x00100000000f6da9
- (void)didReceiveData:(id)arg1;	// IMP=0x00100000000f6d0a
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x00100000000f6ac1
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000000f6ab6
- (unsigned long long)sendPacketBuffer:(CDStruct_a8d8a807 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000000f6869
- (id)copyLinkStatsDict;	// IMP=0x00100000000f674e
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x00100000000f66dc
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000000f66ca
- (void)_localDetectedCorruption;	// IMP=0x00100000000f66c4
- (void)dealloc;	// IMP=0x00100000000f6679
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000000f6537
