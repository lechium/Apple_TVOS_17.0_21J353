...
- (void).cxx_destruct;	// IMP=0x002000000027e8cb
...
- (void)_negotiationTimerFiredOnMain;	// IMP=0x001000000027e7cb
- (void)setNegotiationTimer;	// IMP=0x001000000027e602
- (void)_handleNegotiationTimeout;	// IMP=0x001000000027e015
- (void)removeNegotiationTimer;	// IMP=0x001000000027deb6
- (void)dealloc;	// IMP=0x001000000027de5d
- (id)initWithToken:(id)arg1;	// IMP=0x001000000027ddf2
