...
+ (id)sharedInstance;	// IMP=0x0040000000042988
- (void).cxx_destruct;	// IMP=0x0020000000043968
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x00100000000433cc
- (void)_initializePlugin;	// IMP=0x00100000000431fb
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x0010000000043168
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x00100000000430fc
- (void)notifyWatchToStopAdvertising;	// IMP=0x0010000000042f2e
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000042ded
- (void)notifyWatchToStartAdvertising;	// IMP=0x0010000000042c1f
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000042af5
- (id)init;	// IMP=0x00100000000429dd
