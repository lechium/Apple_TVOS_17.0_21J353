...
- (void).cxx_destruct;	// IMP=0x00200000003f1a52
...
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00100000003f18f2
- (long long)realm;	// IMP=0x00100000003f18e7
- (id)initWithPhoneAuthenticationCertificate:(id)arg1;	// IMP=0x00100000003f17cb
