...
@class IDSPushToken, NSData, NSDate, NSString;
...
@interface IDSRealTimeEncryptionIdentity : NSObject
{
    ...
    IDSPushToken *_pushToken;	// 40 = 0x28
...
@property(copy, nonatomic) IDSPushToken *pushToken; // @synthesize pushToken=_pushToken;
...
- (id)description;	// IMP=0x001000000041c98f
- (void)dealloc;	// IMP=0x001000000041c960
- (id)init;	// IMP=0x001000000041c925
