...
- (void).cxx_destruct;	// IMP=0x002000000035606d
...
- (void)purgeData;	// IMP=0x0010000000355d79
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x0010000000355259
- (id)data;	// IMP=0x0010000000354c21
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x0010000000354abe
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x0010000000354a98
