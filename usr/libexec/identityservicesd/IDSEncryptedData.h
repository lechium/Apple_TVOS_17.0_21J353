...
- (void).cxx_destruct;	// IMP=0x00200000000e4e40
...
- (id)description;	// IMP=0x00100000000e4d8c
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x00100000000e4ce7
