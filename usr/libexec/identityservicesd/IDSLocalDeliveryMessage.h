...
// Error: Property attributes should begin with the type ('T') attribute, property name: toURI
...
- (id)socketPairMessage;	// IMP=0x00100000001b7971
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000001b7959
- (void)kickProgressBlock;	// IMP=0x00100000001b7806
- (id)init;	// IMP=0x00100000001b76b4
