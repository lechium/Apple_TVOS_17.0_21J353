...
- (void).cxx_destruct;	// IMP=0x002000000013166e
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x0010000000131533
- (void)sendMonitorMessage;	// IMP=0x0010000000130e63
- (void)checkConnectivityState:(id)arg1;	// IMP=0x0010000000130bc5
- (id)init;	// IMP=0x0010000000130b96
