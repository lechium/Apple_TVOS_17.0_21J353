...
- (void).cxx_destruct;	// IMP=0x0020000000305cd2
...
- (_Bool)_isSecKeyType;	// IMP=0x0010000000305c40
- (_Bool)_isNGMKeyType;	// IMP=0x0010000000305c28
- (_Bool)verifySignedData:(id)arg1 matchesData:(id)arg2 forType:(long long)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x00100000003057d2
- (void)verifySignedData:(id)arg1 matchesData:(id)arg2 forType:(long long)arg3 onQueue:(id)arg4 withCompletion:(CDUnknownBlockType)arg5;	// IMP=0x0010000000305457
- (void)decryptData:(id)arg1 guid:(id)arg2 usingIdentifier:(id)arg3 onQueue:(id)arg4 isRetry:(_Bool)arg5 replayKey:(id)arg6 withCompletion:(CDUnknownBlockType)arg7;	// IMP=0x0010000000305423
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x0010000000304c7c
- (id)decryptData:(id)arg1 usingIdentifier:(id)arg2 isRetry:(_Bool)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x00100000003046f5
- (id)encryptData:(id)arg1 forceSizeOptimizations:(_Bool)arg2 resetState:(_Bool)arg3 withEncryptedAttributes:(id)arg4 usedIdentifier:(id *)arg5 onQueue:(id)arg6 metadata:(id *)arg7 error:(id *)arg8;	// IMP=0x001000000030417f
- (id)initWithEndpoint:(id)arg1 fullDeviceIdentitySigner:(id)arg2 keyType:(unsigned int)arg3 keyDiversifier:(id)arg4;	// IMP=0x00100000003040ba
- (id)initWithEndpoint:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 replayCommitter:(id)arg3 forceLegacyPK:(_Bool)arg4;	// IMP=0x0010000000303ff5
