...
- (void).cxx_destruct;	// IMP=0x002000000020f87e
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000020f59f
- (double)anisetteHeadersTimeout;	// IMP=0x001000000020f591
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x001000000020f589
- (id)messageBody;	// IMP=0x001000000020f1e2
- (id)requiredKeys;	// IMP=0x001000000020f159
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x001000000020f151
- (id)bagKey;	// IMP=0x001000000020f144
- (_Bool)requiresPushTokenKeys;	// IMP=0x001000000020f13c
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x001000000020f088
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020ee0b
