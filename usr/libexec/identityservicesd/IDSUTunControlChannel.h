...
- (void).cxx_destruct;	// IMP=0x00200000001375e7
...
- (void)setChecksumEnabled:(_Bool)arg1;	// IMP=0x001000000013756f
- (_Bool)checksumEnabled;	// IMP=0x0010000000137563
...
- (void)resumeOTRNegotiation;	// IMP=0x00100000001374b8
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00100000001374b2
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001374aa
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001374a4
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000136f9a
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x0010000000136f94
- (void)_destroyFairplayDeviceSession;	// IMP=0x0010000000136f8e
- (void)_destroyFairplayHostSession;	// IMP=0x0010000000136f88
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x0010000000136ef3
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x0010000000136eeb
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x0010000000136ee3
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x0010000000136edb
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x0010000000136ed3
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x0010000000136ecb
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x0010000000136ec3
- (void)dealloc;	// IMP=0x0010000000136e85
- (void)invalidate;	// IMP=0x0010000000136e30
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x0010000000136dcb
- (void)sendMessage:(id)arg1;	// IMP=0x0010000000136d66
- (void)_checkSendNewMessage;	// IMP=0x00100000001360c4
- (void)_clearChannel;	// IMP=0x0010000000135f96
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x0010000000135f6a
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x0010000000135df8
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x0010000000135dcc
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x001000000013527c
- (void)writeToConnection;	// IMP=0x0010000000134bc9
- (void)readFromConnection;	// IMP=0x0010000000133889
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x001000000013387b
- (void)simulateDecryptionFailure;	// IMP=0x00100000001337e6
- (void)_cleanupConnection;	// IMP=0x0010000000133775
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000133557
- (id)description;	// IMP=0x0010000000133498
