...
- (void).cxx_destruct;	// IMP=0x002000000000fc80
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000000f81d
- (_Bool)requiresPushTokenKeys;	// IMP=0x001000000000f815
- (id)bagKey;	// IMP=0x001000000000f808
- (id)requiredKeys;	// IMP=0x001000000000f7ef
- (id)messageBody;	// IMP=0x001000000000f453
- (id)additionalMessageHeaders;	// IMP=0x001000000000f34b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000f0fc
