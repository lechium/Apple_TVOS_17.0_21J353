...
- (void).cxx_destruct;	// IMP=0x00200000004169ac
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000041676a
- (id)bagKey;	// IMP=0x001000000041675d
- (id)requiredKeys;	// IMP=0x0010000000416744
- (id)messageBody;	// IMP=0x00100000004164a7
- (id)additionalMessageHeaders;	// IMP=0x00100000004162a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004160b3
