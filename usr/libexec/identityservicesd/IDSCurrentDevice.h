...
+ (id)sharedInstance;	// IMP=0x0040000000303c2c
- (void).cxx_destruct;	// IMP=0x0020000000303fe5
- (void)regenerateDeviceIdentifier;	// IMP=0x0010000000303ec4
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x0010000000303cf5
...
- (id)init;	// IMP=0x0010000000303c81
