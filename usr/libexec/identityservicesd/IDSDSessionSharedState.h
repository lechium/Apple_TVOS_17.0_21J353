...
@class IDSMPFullLegacyIdentity, IDSMPPublicLegacyIdentity, IDSURI, IMTimer, NSArray, NSData, NSDate, NSDictionary, NSError, NSNumber, NSSet, NSString, NSUUID, _IDSSessionConnection;
...
- (void).cxx_destruct;	// IMP=0x002000000034ac70
...
- (_Bool);	// IMP=0x001000000034a92b
@property(nonatomic) double inviteSentTime; // @synthesize inviteSentTime=_inviteSentTime;
@property(retain, nonatomic) NSString *groupID; // @synthesize groupID=_groupID;
@property(retain, nonatomic) IDSURI *fromURI; // @synthesize fromURI=_fromURI;
...
@property(retain) NSSet *destinations; // @synthesize destinations=_destinations;
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x001000000034a38f
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x001000000034a2e4
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x001000000034a296
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x0010000000349fd8
- (_Bool)supportsReinitiate;	// IMP=0x0010000000349f3d
- (void)_endSessionTimedOut;	// IMP=0x0010000000349e37
- (void)_endSessionTimerFiredOnMain;	// IMP=0x0010000000349db8
- (void)setEndSessionTimeoutTimer;	// IMP=0x0010000000349bf0
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x0010000000349a91
- (void)_clearPacketLossTimer;	// IMP=0x0010000000349993
- (void)_connectionTimedOut;	// IMP=0x001000000034989a
- (void)_connectionTimerFiredOnMain;	// IMP=0x001000000034981b
- (void)setConnectionTimer;	// IMP=0x0010000000349575
- (void)_clearConnectionTimer;	// IMP=0x0010000000349416
- (void)_clearInvitationTimer;	// IMP=0x00100000003492b7
- (void)_inviteTimedOut;	// IMP=0x001000000034916c
- (void)_inviteTimerFiredOnMain;	// IMP=0x00100000003490ed
- (void)setInvitationTimer;	// IMP=0x0010000000348f11
- (void)clearAllTimers;	// IMP=0x0010000000348ec9
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x001000000034778d
