...
- (void).cxx_destruct;	// IMP=0x002000000003c7c2
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000003c4ff
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x001000000003c4cb
- (void)_endSession;	// IMP=0x001000000003c2a5
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000003bf72
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000003bf5e
- (void)_sendToConnectedSocket;	// IMP=0x001000000003b715
- (_Bool)_queueNextOutgoingData;	// IMP=0x001000000003ab38
- (void)_processBytesAvailable;	// IMP=0x0010000000039fad
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x00100000000396c2
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000039462
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0010000000038f63
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0010000000038ce5
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000038bf5
...
- (void)endSession;	// IMP=0x00100000000385b9
- (void)dealloc;	// IMP=0x0010000000038530
- (void)start;	// IMP=0x00100000000383f6
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x001000000003808a
