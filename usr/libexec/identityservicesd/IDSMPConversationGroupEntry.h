...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0040000000105a74
- (void).cxx_destruct;	// IMP=0x0020000000106093
...
// Error: Property attributes should begin with the type ('T') attribute, property name: signature
// Property attributes: (null)

@property(retain, nonatomic) NSData *data; // @synthesize data=_data;
@property(retain, nonatomic) NSData *publicKeyData; // @synthesize publicKeyData=_publicKeyData;
- (id)description;	// IMP=0x0010000000105e92
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x0010000000105c89
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00100000001058e4
