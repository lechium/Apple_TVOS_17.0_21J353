...
- (void).cxx_destruct;	// IMP=0x002000000004249a
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000042383
- (id)bagKey;	// IMP=0x0010000000042376
- (id)messageBody;	// IMP=0x0010000000042254
- (id)additionalMessageHeaders;	// IMP=0x001000000004211c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000041fb3
