...
- (void).cxx_destruct;	// IMP=0x0020000000037fea
...
- (void)osChannelInfoLog;	// IMP=0x0010000000037edb
- (void)invalidate;	// IMP=0x0010000000037ed5
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x0010000000037ecd
- (_Bool)writePacketBuffer:(CDStruct_a8d8a807 *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x0010000000037ec5
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x0010000000037ebd
- (void)connectWithProtocoHandler;	// IMP=0x0010000000037eb7
- (_Bool)connectWithTransportThread;	// IMP=0x0010000000037eaf
- (id)initWithDestination:(id)arg1;	// IMP=0x0010000000037e3c
