...
- (void).cxx_destruct;	// IMP=0x00200000002836d6
...
- (void)handler:(id)arg1 receivedOfflineMessagePendingForTopic:(id)arg2 messageContext:(id)arg3;	// IMP=0x0010000000283520
- (void)handler:(id)arg1 didReceiveMessage:(id)arg2 forTopic:(id)arg3 fromID:(id)arg4 messageContext:(id)arg5;	// IMP=0x0010000000282a15
- (void)sendCertifiedDeliveryReceipt:(id)arg1;	// IMP=0x00100000002827b6
- (void)sendMessageData:(id)arg1 onTopic:(id)arg2 withOptions:(id)arg3 identifier:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0010000000281fa0
- (void)setupServerMessagingClient:(id)arg1 withUUID:(id)arg2 forTopic:(id)arg3;	// IMP=0x0010000000281a6f
- (void)_recalculateTopics;	// IMP=0x0010000000281917
- (id)_topics;	// IMP=0x001000000028189d
- (id)_commands;	// IMP=0x0010000000281861
- (_Bool)_entitledForTopic:(id)arg1;	// IMP=0x00100000002816fd
- (id)initWithQueue:(id)arg1 connection:(id)arg2 messageDelivery:(id)arg3 pushHandler:(id)arg4;	// IMP=0x001000000028114d
