...
+ (id)builderWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x00400000000d3e95
- (void).cxx_destruct;	// IMP=0x00200000000d494b
...
- (id)verifierWithEndpoint:(id)arg1 keyType:(unsigned int)arg2 keyDiversifier:(id)arg3;	// IMP=0x00100000000d47bb
- (id)verifierWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5 keyType:(unsigned int)arg6 keyDiversifier:(id)arg7;	// IMP=0x00100000000d4624
- (id)signerWithKeyType:(unsigned int)arg1 keyDiversifier:(id)arg2 service:(id)arg3;	// IMP=0x00100000000d4569
- (id)encrypterWithOTRToken:(id)arg1;	// IMP=0x00100000000d450c
- (id)encrypterWithEndpoint:(id)arg1;	// IMP=0x00100000000d4426
- (id)encrypterWithDeviceID:(id)arg1;	// IMP=0x00100000000d437c
- (id)encrypterWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00100000000d41b0
- (id)_createHashingDeviceIdentityEncrypter;	// IMP=0x00100000000d4117
- (id)initWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x00100000000d3fbf
