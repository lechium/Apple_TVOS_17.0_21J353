...
- (void).cxx_destruct;	// IMP=0x002000000018d30a
...
- (unsigned long long)count;	// IMP=0x001000000018d275
- (_Bool)isEmpty;	// IMP=0x001000000018d22d
- (id)initWithTopic:(id)arg1 sendMode:(id)arg2;	// IMP=0x001000000018d194
