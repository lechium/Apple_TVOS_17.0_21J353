...
- (void).cxx_destruct;	// IMP=0x00200000000662dc
...
- (id)messageBody;	// IMP=0x00100000000657f9
- (id)requiredKeys;	// IMP=0x001000000006576b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000653e4
- (unsigned long long)sizeOfKeysWithValues;	// IMP=0x0010000000065159
- (void)logFailureInfo;	// IMP=0x0010000000064d3f
- (_Bool)expectingMoreResponses;	// IMP=0x0010000000064d1b
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x0010000000064156
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00100000000639f4
- (void)callAllAckBlocks;	// IMP=0x001000000006387d
- (void)clearAllPendingResponseTokens;	// IMP=0x001000000006381d
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00100000000636a8
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00100000000635c8
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00100000000634bd
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x0010000000063482
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x0010000000063044
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x0010000000062fd2
- (id)init;	// IMP=0x0010000000062f81
