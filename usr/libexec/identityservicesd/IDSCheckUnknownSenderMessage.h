...
- (void).cxx_destruct;	// IMP=0x00200000001b6c5b
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000001b6a04
- (_Bool)wantsHTTPGet;	// IMP=0x00100000001b69fc
- (id)additionalQueryStringParameters;	// IMP=0x00100000001b6897
- (id)additionalMessageHeaders;	// IMP=0x00100000001b66fc
- (id)bagKey;	// IMP=0x00100000001b66ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b6532
