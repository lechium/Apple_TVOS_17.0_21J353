...
- (void).cxx_destruct;	// IMP=0x0020000000129a2c
...
- (id)_legacyIdentity;	// IMP=0x001000000012997e
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x00100000001297d1
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x00100000001296c0
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x001000000012961d
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x0010000000129599
