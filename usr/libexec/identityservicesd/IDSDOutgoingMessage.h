...
@interface IDSDOutgoingMessage : NSObject
{
    ...
    _Bool _alwaysIncludeSelf;	// 257 = 0x101
    _Bool _wantsFirewallDonation;	// 258 = 0x102
    NSNumber *_pushPriority;	// 264 = 0x108
    NSDictionary *_ktUriVerificationMap;	// 272 = 0x110
    NSNumber *_sendMode;	// 280 = 0x118
    NSNumber *_deliveryMinimumTimeDelay;	// 288 = 0x120
}

- (void).cxx_destruct;	// IMP=0x002000000032bc9d
...
@property(copy) NSDictionary *ktUriVerificationMap; // @synthesize ktUriVerificationMap=_ktUriVerificationMap;
@property(readonly) NSArray *combinedMessages; // @synthesize combinedMessages=_combinedMessages;
@property _Bool wantsFirewallDonation; // @synthesize wantsFirewallDonation=_wantsFirewallDonation;
...
@property _Bool alwaysIncludeSelf; // @synthesize alwaysIncludeSelf=_alwaysIncludeSelf;
...
- (void)setQueueOneIdentifier:(id)arg1;	// IMP=0x001000000032ba21
- (id)queueOneIdentifier;	// IMP=0x001000000032ba0d
