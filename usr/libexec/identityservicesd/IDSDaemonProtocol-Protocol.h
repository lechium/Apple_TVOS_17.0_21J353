...
@class ENGroupID, IDSMessagingCapabilities, IDSPseudonym, IDSPseudonymProperties, IDSPseudonymRequestProperties, IDSSigningOptions, IDSURI, MISSING_TYPE, NSArray, NSData, NSDictionary, NSNumber, NSObject, NSSet, NSString, NSURL, NSUUID;
...
- (MISSING_TYPE *)registrationControlGetRegistrationStateForRegistrationType:requestID: /* Error: Ran out of types for this method. */;
