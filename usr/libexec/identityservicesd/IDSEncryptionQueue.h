...
- (void).cxx_destruct;	// IMP=0x00200000001293b8
...
- (void);	// IMP=0x001000000012933f
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000129328
- (id)initWithName:(char *)arg1 qosClass:(unsigned int)arg2 specific:(char *)arg3;	// IMP=0x001000000012925f
