...
- (void).cxx_destruct;	// IMP=0x00200000000f7ed1
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000000f7ca4
- (id)bagKey;	// IMP=0x00100000000f7c97
- (id)requiredKeys;	// IMP=0x00100000000f7c7e
- (id)messageBody;	// IMP=0x00100000000f7b42
- (id)additionalMessageHeaders;	// IMP=0x00100000000f7a3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f78a3
