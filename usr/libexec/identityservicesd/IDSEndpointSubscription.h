...
- (void).cxx_destruct;	// IMP=0x002000000000deba
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x001000000000dd85
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x001000000000d954
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x001000000000d752
- (id)resolvedEndpoints;	// IMP=0x001000000000d5b0
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000d183
- (id)peerIDManager;	// IMP=0x001000000000d16a
- (id)description;	// IMP=0x001000000000d090
- (void)dealloc;	// IMP=0x001000000000d01a
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x001000000000ceeb
