...
- (void).cxx_destruct;	// IMP=0x0020000000433128
...
- (_Bool)_missingDeviceIdentity:(_Bool *)arg1;	// IMP=0x00100000004330d6
- (void)recertifyDeviceIfNeeded;	// IMP=0x00100000004330d0
- (void)_repairTimerHit:(id)arg1;	// IMP=0x00100000004330be
- (id)init;	// IMP=0x0010000000432fb9
