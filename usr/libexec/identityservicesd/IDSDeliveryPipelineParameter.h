...
@interface IDSDeliveryPipelineParameter : NSObject
{
    ...
    id <IDSPrioritizedTokenList> _prioritizedTokenList;	// 104 = 0x68
...
- (void).cxx_destruct;	// IMP=0x00200000003583ce
...
- (id)description;	// IMP=0x001000000035806f
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x0010000000358053
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x0010000000357b3d
