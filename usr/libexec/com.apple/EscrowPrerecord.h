...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000581f7
- (void).cxx_destruct;	// IMP=0x001000000004caba
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004c780
- (unsigned long long)hash;	// IMP=0x001000000004c61f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004c3b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004c17c
- (void)copyTo:(id)arg1;	// IMP=0x001000000004bfd9
- (void)writeTo:(id)arg1;	// IMP=0x001000000004be51
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004be44
- (id)dictionaryRepresentation;	// IMP=0x001000000004b8a7
- (id)description;	// IMP=0x001000000004b7f8
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x001000000004b72f
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x001000000004b6e6
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x0010000000057f9c
