...
- (void).cxx_destruct;	// IMP=0x002000000001b36f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001b1f3
- (unsigned long long)hash;	// IMP=0x001000000001b154
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001b01c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001af04
- (void)copyTo:(id)arg1;	// IMP=0x001000000001ae41
- (void)writeTo:(id)arg1;	// IMP=0x001000000001ad8d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000001ad80
- (id)dictionaryRepresentation;	// IMP=0x001000000001aaa8
- (id)description;	// IMP=0x001000000001a9f9
