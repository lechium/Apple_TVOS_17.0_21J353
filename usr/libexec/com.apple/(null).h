...
- (void).cxx_destruct;	// IMP=0x002000000001482f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000146b3
- (unsigned long long)hash;	// IMP=0x0010000000014614
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000144dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000143c4
- (void)copyTo:(id)arg1;	// IMP=0x0010000000014301
- (void)writeTo:(id)arg1;	// IMP=0x001000000001424d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000014240
- (id)dictionaryRepresentation;	// IMP=0x0010000000013f68
- (id)description;	// IMP=0x0010000000013eb9
