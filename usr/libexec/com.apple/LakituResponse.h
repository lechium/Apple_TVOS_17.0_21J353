...
- (void).cxx_destruct;	// IMP=0x002000000001a95c
- (id)httpResponse;	// IMP=0x001000000001a952
...
- (id)initWithURLResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001a348
- (id)_parsePlistFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001a18b
