...
- (void).cxx_destruct;	// IMP=0x002000000001d875
...
- (id)additionalHeaders;	// IMP=0x001000000001d39a
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x001000000001d2e8
- (id)urlString;	// IMP=0x001000000001d238
- (id)urlRequest;	// IMP=0x001000000001d0f8
- (id)authorizationHeader;	// IMP=0x001000000001cfe7
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x001000000001cdef
- (id)bodyDictionary;	// IMP=0x001000000001cab4
- (id)validateInput;	// IMP=0x001000000001c76a
...
- (id)currentAccount;	// IMP=0x001000000001c2eb
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x001000000001c117
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000001bbf1
