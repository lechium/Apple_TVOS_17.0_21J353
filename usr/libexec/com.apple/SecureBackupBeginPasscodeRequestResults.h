...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000010e82
- (void).cxx_destruct;	// IMP=0x0020000000011148
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000010fa2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000010e8a
- (id)description;	// IMP=0x0010000000010d4c
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x0010000000010c20
