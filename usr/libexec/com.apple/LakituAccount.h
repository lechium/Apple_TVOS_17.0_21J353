...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x004000000005904f
- (void).cxx_destruct;	// IMP=0x0020000000059b41
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x00100000000592ac
