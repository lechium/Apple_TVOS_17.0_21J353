...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000057493
- (void).cxx_destruct;	// IMP=0x00200000000579a4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000057880
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000575c0
- (id)initWithOperationId:(id)arg1 activityId:(id)arg2 activityLabel:(id)arg3 recordId:(id)arg4 type:(unsigned long long)arg5 context:(id)arg6;	// IMP=0x001000000005749b
