...
- (void).cxx_destruct;	// IMP=0x0020000000047917
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000004711b
- (id)sessionConfig;	// IMP=0x0010000000046fe8
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000046c7c
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x0010000000046bc0
- (id)credential;	// IMP=0x0010000000046bb8
- (id)validateInput;	// IMP=0x0010000000046a68
- (id)additionalHeaders;	// IMP=0x0010000000046a5b
- (id)authorizationHeader;	// IMP=0x0010000000046a53
- (id)bodyDictionary;	// IMP=0x0010000000046a4b
