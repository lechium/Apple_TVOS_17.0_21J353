...
- (void).cxx_destruct;	// IMP=0x002000000011667b
...
- (id)URLForKey:(id)arg1 account:(id)arg2;	// IMP=0x00100000001165a5
- (id)URLForKey:(id)arg1;	// IMP=0x001000000011658f
- (id)stringForKey:(id)arg1;	// IMP=0x0010000000116579
- (id)integerForKey:(id)arg1;	// IMP=0x0010000000116563
- (id)doubleForKey:(id)arg1;	// IMP=0x001000000011654d
- (id)dictionaryForKey:(id)arg1;	// IMP=0x001000000011633a
- (id)boolForKey:(id)arg1;	// IMP=0x0010000000116324
- (id)arrayForKey:(id)arg1;	// IMP=0x001000000011630e
- (void)createSnapshotWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000001162f8
...
- (void)dealloc;	// IMP=0x001000000011492f
- (id)init;	// IMP=0x0010000000114923
