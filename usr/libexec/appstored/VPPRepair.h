...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000000857ae
- (void).cxx_destruct;	// IMP=0x0020000000085eaf
@property(retain, nonatomic) _TtC9appstored6LogKey *logKey; // @synthesize logKey=_logKey;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008595e
...
- (id)init;	// IMP=0x0010000000085525
