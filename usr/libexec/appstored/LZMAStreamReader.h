...
- (void).cxx_destruct;	// IMP=0x00200000000a6bf2
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000a682d
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000a654f
- (void)open;	// IMP=0x00100000000a6503
- (void)close;	// IMP=0x00100000000a64a1
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x00100000000a61ea
