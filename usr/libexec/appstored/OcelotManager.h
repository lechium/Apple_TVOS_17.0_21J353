...
- (void).cxx_destruct;	// IMP=0x002000000016d248
- (void)_handleRepairBundleIDNotification:(id)arg1;	// IMP=0x001000000016b37e
- (void)_handleNetworkStateDidChangeNotification:(id)arg1;	// IMP=0x001000000016ab99
- (void)decorateMetricsEvent:(id)arg1 context:(id)arg2;	// IMP=0x001000000016984d
- (id)createMetricsEventsForEventType:(unsigned char)arg1 context:(id)arg2;	// IMP=0x00100000001694e7
- (id)init;	// IMP=0x00100000001622c8
