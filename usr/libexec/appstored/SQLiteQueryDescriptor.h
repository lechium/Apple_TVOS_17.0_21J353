...
- (void).cxx_destruct;	// IMP=0x0020000000109052
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00100000001089be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001088cc
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x001000000010882d
