...
- (void).cxx_destruct;	// IMP=0x002000000012dd34
- (unsigned long long)hash;	// IMP=0x001000000012d907
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012d2c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000012cc85
- (void)writeTo:(id)arg1;	// IMP=0x001000000012c79d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000012c790
- (id)dictionaryRepresentation;	// IMP=0x001000000012b5c3
- (id)description;	// IMP=0x001000000012b514
