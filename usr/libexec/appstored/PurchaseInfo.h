...
- (void).cxx_destruct;	// IMP=0x002000000016183f
...
- (void)updateLogKey;	// IMP=0x0010000000161655
@property(readonly, getter=isUserInitiated) _Bool userInitiated;
- (void)updateGeneratedProperties;	// IMP=0x00100000001612b8
- (id)init;	// IMP=0x0010000000161250
