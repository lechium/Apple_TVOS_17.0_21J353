...
- (void).cxx_destruct;	// IMP=0x00400000000045c0
- (id)init;	// IMP=0x0010000000004560
- (id)initWithAvailableUpdateCount:(long long)arg1 shouldNotifyOfChanges:(_Bool)arg2 bundleIDs:(id)arg3 result:(_Bool)arg4;	// IMP=0x00100000000044e0
