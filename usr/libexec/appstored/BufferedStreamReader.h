...
- (void).cxx_destruct;	// IMP=0x0020000000042fe9
- (void)close;	// IMP=0x0010000000042f9f
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000042efb
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x0010000000042d9c
