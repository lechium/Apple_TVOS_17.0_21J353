...
+ (id)defaultProperties;	// IMP=0x00200000000ed95f
+ (Class)databaseEntityClass;	// IMP=0x00100000000ed94e
- (void).cxx_destruct;	// IMP=0x00100000000eda42
...
- (id)purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x00100000000eda0e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ed91f
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) long long softwarePlatform;
- (void)setUpdateState:(long long)arg1;	// IMP=0x00100000000ed7a0
@property(nonatomic, getter=isPerDevice) _Bool perDevice;
- (void)setMetricsData:(id)arg1;	// IMP=0x00100000000ed72d
...
- (id)rawUpdateDictionary;	// IMP=0x00100000000ed5ed
...
- (id)initWithUpdateDictionary:(id)arg1;	// IMP=0x00100000000ec4fc
- (id)init;	// IMP=0x00100000000ec4cd
- (id)purchase_purchaseInfoForUpdateUserInitiated:(_Bool)arg1;	// IMP=0x001000000015a957
