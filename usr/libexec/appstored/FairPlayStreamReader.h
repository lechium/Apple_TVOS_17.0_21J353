...
- (void).cxx_destruct;	// IMP=0x002000000013462f
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000134061
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000133d2c
- (void)close;	// IMP=0x0010000000133cca
- (void)open;	// IMP=0x0010000000133c7e
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x0010000000133ac2
