...
@class AssetPromise, AssetRequestProperties, KeepAlive, LogKey, NSError, NSProgress, NSString, NSURLRequest, NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics;
@protocol OS_nw_activity;

@interface AssetTaskInfo : NSObject
{
    _Bool _cacheServerLocated;	// 8 = 0x8
    _Bool _ignoreAssetCache;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x002000000006b4f8
