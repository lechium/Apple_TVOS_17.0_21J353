...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x002000000006c8a2
- (void).cxx_destruct;	// IMP=0x002000000006cab0
@property(nonatomic) __weak id <ApplicationRepairDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006c8aa
