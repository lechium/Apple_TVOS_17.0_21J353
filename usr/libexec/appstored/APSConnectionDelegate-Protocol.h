...
@class APSAppTokenInfo, APSConnection, APSIncomingMessage, APSOutgoingMessage, APSURLToken, APSURLTokenInfo, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (MISSING_TYPE *)connection:didReceiveURLTokenError:forInfo: /* Error: Ran out of types for this method. */;
