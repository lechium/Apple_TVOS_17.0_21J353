...
- (void).cxx_destruct;	// IMP=0x0020000000073fde
- (void)main;	// IMP=0x001000000006f110
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000006e92b
