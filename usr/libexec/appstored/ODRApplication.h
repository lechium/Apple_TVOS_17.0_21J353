...
- (void).cxx_destruct;	// IMP=0x002000000019e2b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019db69
- (unsigned long long)hash;	// IMP=0x001000000019da49
- (id)description;	// IMP=0x001000000019d8e3
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019d801
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019d5ef
