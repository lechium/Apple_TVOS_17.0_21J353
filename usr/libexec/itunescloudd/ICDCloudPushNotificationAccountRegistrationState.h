...
- (void).cxx_destruct;	// IMP=0x00200000000ffac4
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000ffa14
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000ff971
