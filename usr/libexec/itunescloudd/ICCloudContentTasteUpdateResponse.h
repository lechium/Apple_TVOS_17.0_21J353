...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x004000000004a34d
- (void).cxx_destruct;	// IMP=0x002000000004a325
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x001000000004a230
