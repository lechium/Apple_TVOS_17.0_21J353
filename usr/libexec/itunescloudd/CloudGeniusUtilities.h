...
- (void).cxx_destruct;	// IMP=0x002000000009c310
...
- (void)_initializeMappings;	// IMP=0x001000000009b145
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x001000000009b0c0
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x001000000009b0aa
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x001000000009b025
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x001000000009b00f
- (id)init;	// IMP=0x001000000009afc3
