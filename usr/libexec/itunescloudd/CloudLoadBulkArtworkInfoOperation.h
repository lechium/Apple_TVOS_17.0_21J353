...
- (void).cxx_destruct;	// IMP=0x002000000004be9a
...
- (void)main;	// IMP=0x001000000004b907
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x001000000004b7e5
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x001000000004b781
