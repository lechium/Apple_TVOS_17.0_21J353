...
+ (Class)contentFeaturesType;	// IMP=0x00200000000e1500
- (void).cxx_destruct;	// IMP=0x00200000000e1057
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000e0de8
- (unsigned long long)hash;	// IMP=0x00100000000e0d2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000e0bde
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e096b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000e081c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000e063f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000e0632
- (id)dictionaryRepresentation;	// IMP=0x00100000000e0236
- (id)description;	// IMP=0x00100000000e0187
- (id)contentFeaturesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000e016a
- (unsigned long long)contentFeaturesCount;	// IMP=0x00100000000e014d
- (void)addContentFeatures:(id)arg1;	// IMP=0x00100000000e00e3
- (void)clearContentFeatures;	// IMP=0x00100000000e00c6
...
- (int)StringAsContentType:(id)arg1;	// IMP=0x00100000000dfecd
- (id)contentTypeAsString:(int)arg1;	// IMP=0x00100000000dfe85
