...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x00400000000a6972
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000a68b4
- (void).cxx_destruct;	// IMP=0x00200000000a686b
...
- (id)description;	// IMP=0x00100000000a677c
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000a665d
