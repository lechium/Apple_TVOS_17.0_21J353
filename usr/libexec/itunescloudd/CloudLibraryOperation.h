...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008a89c
- (void).cxx_destruct;	// IMP=0x002000000008a805
...
- (id)description;	// IMP=0x001000000008a6d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008a641
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008a565
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x001000000008a40b
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000008a3a9
- (id)init;	// IMP=0x001000000008a369
