...
- (void).cxx_destruct;	// IMP=0x00200000001163f2
...
- (void)_clearAllCloudIDs;	// IMP=0x0010000000116168
- (id)_determineResultsURLWhenReadyWithUpdateID:(id)arg1 retryTimeout:(double)arg2 responseStatusCode:(out long long *)arg3;	// IMP=0x0010000000115a5c
- (_Bool)_updateLibrary;	// IMP=0x0010000000114708
- (void)_prepareLibraryForInitialUpdate;	// IMP=0x001000000011460c
- (_Bool)_uploadLibrary;	// IMP=0x00100000001118ab
- (_Bool)_ensureDeviceIsRegistered;	// IMP=0x001000000011178d
- (void)main;	// IMP=0x001000000010ffef
- (void)cancel;	// IMP=0x001000000010fea5
@property(readonly, nonatomic) float progress;
@property(readonly, nonatomic, getter=isInitialUpdate) _Bool initialUpdate;
- (void)dealloc;	// IMP=0x001000000010fe35
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 reason:(long long)arg3 updateTaskHelper:(id)arg4;	// IMP=0x001000000010fda0
