...
- (void).cxx_destruct;	// IMP=0x00200000000c8440
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000c8011
- (void)cancel;	// IMP=0x00100000000c7fb8
- (void)start;	// IMP=0x00100000000c7564
- (id)description;	// IMP=0x00100000000c74d6
- (void)callCompletionHandlers;	// IMP=0x00100000000c7347
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000c72a9
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000c7180
