...
- (void).cxx_destruct;	// IMP=0x00200000000fd965
...
- (void)_adjustOperationQueueStatusForMediaDownloads;	// IMP=0x00100000000fd71d
- (void)downloadManager:(id)arg1 didCancelAssets:(id)arg2;	// IMP=0x00100000000fd70b
- (MISSING_TYPE *)downloadManager:didFinishAsset:withError: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000fd6f9
- (void)downloadManager:(id)arg1 didUpdateDownloadProgress:(id)arg2;	// IMP=0x00100000000fd6e7
- (void)downloadManager:(id)arg1 didEnqueueAssetDownloads:(id)arg2 didRemoveAssetDownloads:(id)arg3;	// IMP=0x00100000000fd6d5
- (void)cancelAllImports;	// IMP=0x00100000000fd6c1
- (void)cancelAllImportsAndWaitForOperationsToFinish:(_Bool)arg1;	// IMP=0x00100000000fd4f0
- (void)increasePriorityForAllOperations;	// IMP=0x00100000000fd47f
- (void)decreasePriorityForAllOperations;	// IMP=0x00100000000fd40e
- (void)deprioritizeImportArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2;	// IMP=0x00100000000fd387
- (void)importCloudArtworkForRequests:(id)arg1;	// IMP=0x00100000000fd2cf
- (void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2 token:(id)arg3 mediaType:(unsigned int)arg4 allowsCellularData:(_Bool)arg5 clientIdentity:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000fd163
- (void)dealloc;	// IMP=0x00100000000fd05b
- (id)initWithConfiguration:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00100000000fcacb
