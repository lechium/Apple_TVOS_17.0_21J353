...
- (void).cxx_destruct;	// IMP=0x00200000000cf1d5
...
- (id)metadataFilter;	// IMP=0x00100000000cf14b
- (id)queryFilter;	// IMP=0x00100000000cf0de
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000cf0bb
- (void)main;	// IMP=0x00100000000ce9ff
