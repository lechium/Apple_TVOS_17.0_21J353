...
- (void).cxx_destruct;	// IMP=0x002000000002398c
- (void)cancel;	// IMP=0x0010000000023943
- (void)main;	// IMP=0x0010000000022f3c
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 dictionary:(id)arg3;	// IMP=0x0010000000022d84
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000022cfe
