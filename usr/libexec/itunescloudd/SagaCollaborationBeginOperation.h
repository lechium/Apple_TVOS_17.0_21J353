...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000002014d
...
- (void)start;	// IMP=0x001000000001f8be
- (_Bool)isPersistent;	// IMP=0x001000000001f8b6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001f816
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001f773
- (id)description;	// IMP=0x001000000001f72b
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 playlistPersistentID:(long long)arg3 sharingMode:(unsigned long long)arg4;	// IMP=0x001000000001f6d5
