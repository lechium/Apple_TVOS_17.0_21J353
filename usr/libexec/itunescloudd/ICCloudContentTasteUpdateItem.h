...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000ab566
- (void).cxx_destruct;	// IMP=0x00200000000ab528
...
- (unsigned long long)hash;	// IMP=0x00100000000a8069
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a7e84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000a7dae
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000a7c22
- (id)description;	// IMP=0x00100000000a7b40
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x00100000000a79f7
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x00100000000a78c8
