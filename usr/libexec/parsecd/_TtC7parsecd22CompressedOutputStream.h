...
- (void).cxx_destruct;	// IMP=0x004000000001640d
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x00100000000163aa
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000001637f
- (id)initToMemory;	// IMP=0x0010000000016354
- (void)close;	// IMP=0x001000000001630d
- (void)open;	// IMP=0x0010000000015ffc
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x0010000000015ea5
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0010000000015a32
- (id)init;	// IMP=0x00100000000157b9
