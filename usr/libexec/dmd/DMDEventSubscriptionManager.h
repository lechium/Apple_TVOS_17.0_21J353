...
- (void).cxx_destruct;	// IMP=0x002000000004b3ca
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x001000000004b155
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004ab4c
- (id)init;	// IMP=0x001000000004aaf6
