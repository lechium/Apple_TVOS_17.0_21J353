...
- (void).cxx_destruct;	// IMP=0x0020000000005628
...
- (void)main;	// IMP=0x00100000000054b8
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000005416
