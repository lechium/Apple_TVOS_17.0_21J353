...
+ (id)sharedController;	// IMP=0x0020000000072689
- (void).cxx_destruct;	// IMP=0x00200000000736ad
...
- (void)_notificationRef:(struct __CFUserNotification *)arg1 wasDismissedWithFlags:(unsigned long long)arg2;	// IMP=0x00100000000733aa
- (void)_completeNotification:(id)arg1 response:(unsigned long long)arg2;	// IMP=0x0010000000073208
- (void)_showNextNotification;	// IMP=0x0010000000072e33
- (id)_dictFromNotification:(id)arg1;	// IMP=0x0010000000072c52
- (void)showNotification:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000727d8
- (id)initPrivate;	// IMP=0x001000000007271e
