...
- (void).cxx_destruct;	// IMP=0x002000000000aa9f
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000a80e
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000a31b
- (void)_registerPredicateObserver;	// IMP=0x0010000000009e52
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x0010000000009506
- (id)metadata;	// IMP=0x00100000000093d5
- (void)updateObserverRegistration;	// IMP=0x00100000000093c3
- (void)invalidate;	// IMP=0x0010000000009206
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0010000000008c72
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x0010000000008b81
