...
- (void).cxx_destruct;	// IMP=0x002000000004aac3
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x001000000004a97b
- (id)description;	// IMP=0x001000000004a8de
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x001000000004a80e
