...
+ (id)sharedServer;	// IMP=0x002000000006932b
- (void).cxx_destruct;	// IMP=0x00200000000695bc
...
- (void)invalidate;	// IMP=0x0010000000069493
- (void)run;	// IMP=0x0010000000069380
- (id)init;	// IMP=0x0010000000069039
