...
- (void).cxx_destruct;	// IMP=0x00200000000053e5
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005351
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005048
...
- (void)main;	// IMP=0x0010000000004e87
- (_Bool)isAsynchronous;	// IMP=0x0010000000004e7f
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000004ddd
