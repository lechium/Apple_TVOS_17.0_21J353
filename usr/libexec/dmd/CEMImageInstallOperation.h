...
- (void).cxx_destruct;	// IMP=0x0020000000005ee6
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005e52
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005b49
...
- (void)main;	// IMP=0x0010000000005988
- (_Bool)isAsynchronous;	// IMP=0x0010000000005980
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00100000000058de
