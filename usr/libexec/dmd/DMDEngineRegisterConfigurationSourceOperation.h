...
- (void).cxx_destruct;	// IMP=0x00200000000472dc
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x0010000000047137
- (void)main;	// IMP=0x00100000000468b7
