...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000006a9e4
- (void).cxx_destruct;	// IMP=0x002000000006af70
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006acc8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006a9ec
