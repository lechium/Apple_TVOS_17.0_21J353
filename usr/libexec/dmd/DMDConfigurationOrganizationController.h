...
- (void).cxx_destruct;	// IMP=0x00200000000340dc
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x0010000000033f39
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000033d81
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000033bc9
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x0010000000033b39
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x001000000003394a
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x0010000000033873
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x0010000000032da0
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000032caa
