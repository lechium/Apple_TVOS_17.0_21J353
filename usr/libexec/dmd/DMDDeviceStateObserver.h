...
- (void)networkDidChange;	// IMP=0x001000000003b876
- (void)keybagLockStateDidChange;	// IMP=0x001000000003b83e
- (void)stopObservingChanges;	// IMP=0x001000000003b806
- (void)startObservingChanges;	// IMP=0x001000000003b676
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x001000000003b596
