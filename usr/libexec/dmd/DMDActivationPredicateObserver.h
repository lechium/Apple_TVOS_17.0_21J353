...
- (void).cxx_destruct;	// IMP=0x002000000000db4c
...
- (id)calendarForIdentifier:(id)arg1;	// IMP=0x001000000000d859
- (void)reportActivationPredicateObserverDidTrigger;	// IMP=0x001000000000d796
- (id)metadata;	// IMP=0x001000000000d67f
- (void)invalidate;	// IMP=0x001000000000d66b
- (void)updateObserverRegistration;	// IMP=0x001000000000d665
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000d65d
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 predicate:(id)arg3;	// IMP=0x001000000000d55d
