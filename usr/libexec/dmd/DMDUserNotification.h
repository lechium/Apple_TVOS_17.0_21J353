...
- (void).cxx_destruct;	// IMP=0x0020000000072635
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x001000000007254c
- (struct __CFUserNotification *)notificationRef;	// IMP=0x0010000000072542
- (void)dealloc;	// IMP=0x0010000000072503
- (id)init;	// IMP=0x00100000000724a1
