...
- (void).cxx_destruct;	// IMP=0x00200000000704e9
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000703e3
- (id)initWithTaskServer:(id)arg1;	// IMP=0x0010000000070378
