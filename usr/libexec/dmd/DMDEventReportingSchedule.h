...
- (void).cxx_destruct;	// IMP=0x0020000000049817
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000495fe
- (unsigned long long)hash;	// IMP=0x00100000000494ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004927e
- (id)description;	// IMP=0x00100000000491cb
- (void)dealloc;	// IMP=0x0010000000049189
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x0010000000048ec8
