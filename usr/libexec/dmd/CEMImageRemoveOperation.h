...
- (void).cxx_destruct;	// IMP=0x0020000000006129
...
- (void)main;	// IMP=0x0010000000005fb9
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000005f17
