...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000066da6
- (void).cxx_destruct;	// IMP=0x0020000000067011
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000066ef9
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000066dae
