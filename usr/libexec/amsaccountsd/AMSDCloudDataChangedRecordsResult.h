...
- (void).cxx_destruct;	// IMP=0x002000000000cd7a
...
- (id)initWithChangedRecords:(id)arg1 deletedRecords:(id)arg2 errors:(id)arg3 changeTokens:(id)arg4;	// IMP=0x001000000000ca9c
