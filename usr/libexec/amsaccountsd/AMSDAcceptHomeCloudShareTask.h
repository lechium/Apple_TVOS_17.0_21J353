...
- (void).cxx_destruct;	// IMP=0x0020000000003972
...
- (id)_generateInviteCodeWithError:(id *)arg1;	// IMP=0x00100000000035a9
- (id)performTask;	// IMP=0x0010000000002e8e
- (id)initWithController:(id)arg1 cloudShare:(id)arg2;	// IMP=0x0010000000002dec
