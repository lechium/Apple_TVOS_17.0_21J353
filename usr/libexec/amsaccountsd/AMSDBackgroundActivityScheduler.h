...
- (void).cxx_destruct;	// IMP=0x0020000000006c62
...
- (void)schedule;	// IMP=0x00100000000061fe
- (void)invalidate;	// IMP=0x0010000000006185
- (void)checkIn;	// IMP=0x0010000000005f81
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0010000000005ec7
