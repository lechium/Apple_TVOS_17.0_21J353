...
- (void).cxx_destruct;	// IMP=0x002000000003d290
...
- (id)_stringForRefreshType:(unsigned long long)arg1;	// IMP=0x001000000003d1f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003d0e7
@property(readonly, nonatomic) NSString *hashedDescription;
- (id)initWithReason:(id)arg1;	// IMP=0x001000000003ce8c
