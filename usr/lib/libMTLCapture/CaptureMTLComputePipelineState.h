...
- (void).cxx_destruct;	// IMP=0x000000000005b262
...
- (unsigned long long)imageblockMemoryLengthForDimensions:(CDStruct_14f26992)arg1;	// IMP=0x000000000005b1fd
- (void)dealloc;	// IMP=0x000000000005b112
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000005afa5
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000005af94
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000005aed3
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x000000000005ae73
- (id)originalObject;	// IMP=0x000000000005ae65
@property(readonly) id <MTLComputePipelineState> baseObject;
- (_Bool)newFunctionHandle:(out id *)arg1 associatedWithBaseFunctionHandle:(id)arg2 captureFunction:(id)arg3;	// IMP=0x000000000005ad3f
- (id)functionHandleMap;	// IMP=0x000000000005ace7
- (id)initWithBaseObject:(id)arg1 captureComputePipelineState:(id)arg2;	// IMP=0x000000000005abfc
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x000000000005ab0c
