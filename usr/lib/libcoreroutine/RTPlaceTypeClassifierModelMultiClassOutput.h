...
- (void).cxx_destruct;	// IMP=0x00000000001371a3
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000001370bf
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithTarget:(long long)arg1 classProbability:(id)arg2;	// IMP=0x0000000000137028
