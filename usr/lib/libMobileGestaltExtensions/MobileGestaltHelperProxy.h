...
+ (id)proxy;	// IMP=0x0060000000001f4b
...
- (_Bool)proxySetCacheSentinel;	// IMP=0x0000000000001e89
- (_Bool)proxyRebuildCache;	// IMP=0x0000000000001db4
- (void)invalidate;	// IMP=0x0000000000001d92
- (id)init;	// IMP=0x0000000000001b23
- (void)dealloc;	// IMP=0x0000000000001ac8
