...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000040bb6
- (void).cxx_destruct;	// IMP=0x0000000000040fde
...
- (id)summary;	// IMP=0x0000000000040bd0
- (id)description;	// IMP=0x0000000000040bbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000409fa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000407ac
- (id)initWithClientRequest:(id)arg1 withAssetSelector:(id)arg2 forClientDomain:(id)arg3 forSetIdentifier:(id)arg4;	// IMP=0x0000000000040249
- (id)initWithAssetSelector:(id)arg1;	// IMP=0x000000000004022c
- (id)initWithClientRequest:(id)arg1;	// IMP=0x0000000000040212
