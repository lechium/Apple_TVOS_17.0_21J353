...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000ad00b
- (void).cxx_destruct;	// IMP=0x00000000000aefab
...
- (id)newIdentityName;	// IMP=0x00000000000aeb5e
- (id)newSummaryWithoutEntryID;	// IMP=0x00000000000ada39
- (id)summary;	// IMP=0x00000000000ad3e3
- (id)description;	// IMP=0x00000000000ad3d1
- (id)copy;	// IMP=0x00000000000ad013
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000acbdd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ac752
- (id)initForClientDomainName:(id)arg1 forAssetSetIdentifier:(id)arg2 withDiscoveredAtomicInstance:(id)arg3 withDiscoveredAtomicEntries:(id)arg4;	// IMP=0x00000000000ac5bc
