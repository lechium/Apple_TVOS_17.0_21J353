...
- (void).cxx_destruct;	// IMP=0x000000000008c4ba
...
- (id)description;	// IMP=0x000000000008be87
- (id)_taskState;	// IMP=0x000000000008bdfc
- (void)clearCacheServerUrl;	// IMP=0x000000000008bddc
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x000000000008bdbc
- (double)currentEstimate;	// IMP=0x000000000008bb70
- (void)updateDownloadData:(long long)arg1;	// IMP=0x000000000008ba26
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x000000000008b803
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x000000000008b593
- (id)initWithUrl:(id)arg1 forAssetType:(id)arg2 withPurpose:(id)arg3 clientName:(id)arg4 options:(id)arg5;	// IMP=0x000000000008b277
- (id)initForAssetType:(id)arg1 withPurpose:(id)arg2 clientName:(id)arg3 options:(id)arg4;	// IMP=0x000000000008b24a
- (id)initWithUrl:(id)arg1 clientName:(id)arg2 options:(id)arg3;	// IMP=0x000000000008b223
