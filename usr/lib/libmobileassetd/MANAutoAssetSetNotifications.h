...
+ (id)notifyRegistrationName:(id)arg1 forAssetSetIdentifier:(id)arg2;	// IMP=0x001000000008db74
+ (id)notifyRegistrationName:(id)arg1;	// IMP=0x001000000008db3d
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000008d88f
...
- (id)summary;	// IMP=0x000000000008d9df
- (id)description;	// IMP=0x000000000008d9cd
- (id)copy;	// IMP=0x000000000008d897
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008d733
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008d610
- (id)init;	// IMP=0x000000000008d5d0
