...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001bcdcd
- (void).cxx_destruct;	// IMP=0x00000000001bd0a4
...
- (void)updateSafeSummary;	// IMP=0x00000000001bcfa2
- (id)summary;	// IMP=0x00000000001bcf90
- (id)_newSummary;	// IMP=0x00000000001bcde7
- (id)description;	// IMP=0x00000000001bcdd5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bcc05
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bc885
- (id)initWithParamType:(long long)arg1 withSafeSummary:(id)arg2 withMonitorSelectors:(id)arg3 withSelectorsNoRetry:(id)arg4 withSelectorsRequiringRetry:(id)arg5 withFinishedAssetSelector:(id)arg6 withPotentialNetworkFailure:(_Bool)arg7 withObservedNetworkPath:(id)arg8;	// IMP=0x00000000001bc736
- (id)initWithObservedNetworkPath:(id)arg1;	// IMP=0x00000000001bc6fa
- (id)initWithScheduledSelectorFinished:(id)arg1 withPotentialNetworkFailure:(_Bool)arg2;	// IMP=0x00000000001bc6c7
- (id)initWithMonitorSelectors:(id)arg1 withSelectorsNoRetry:(id)arg2 withSelectorsRequiringRetry:(id)arg3;	// IMP=0x00000000001bc696
- (id)initWithSafeSummary:(id)arg1;	// IMP=0x00000000001bc658
