...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000008c833
...
- (id)summary;	// IMP=0x000000000008cac6
- (id)description;	// IMP=0x000000000008cab4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008c917
- (id)copy;	// IMP=0x000000000008c83b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008c72e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008c639
- (id)init;	// IMP=0x000000000008c5ee
