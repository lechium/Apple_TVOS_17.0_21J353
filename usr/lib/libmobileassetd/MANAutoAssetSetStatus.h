...
+ (id)newSelectorsForStagingSummary:(id)arg1;	// IMP=0x001000000009219e
+ (id)newCurrentLockUsageDetailed:(id)arg1;	// IMP=0x00100000000920c4
+ (id)newCurrentLockUsageSummary:(id)arg1;	// IMP=0x0010000000091cde
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000008fba3
- (void).cxx_destruct;	// IMP=0x00000000000927cb
