...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000013ebf0
- (void).cxx_destruct;	// IMP=0x000000000013f192
...
- (id)summary;	// IMP=0x000000000013ee80
- (id)description;	// IMP=0x000000000013ebf8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013e9e4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013e66c
- (id)initUsingClientDomain:(id)arg1 forClientName:(id)arg2 withProcessName:(id)arg3 withProcessID:(long long)arg4 forAssetSetIdentifier:(id)arg5 forAtomicInstance:(id)arg6 comprisedOfEntries:(id)arg7 asEntriesWhenTargeting:(id)arg8 associatingFrameworkUUID:(id)arg9;	// IMP=0x000000000013e4fb
