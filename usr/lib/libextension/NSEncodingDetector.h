...
+ (CDUnknownFunctionPointerType)recognizeFuncForCFStringEncoding:(unsigned int)arg1;	// IMP=0x00600000006e9ac4
+ (id)detectorForCFStringEncoding:(unsigned int)arg1 allowBackupDetectors:(_Bool)arg2;	// IMP=0x00600000006e9a2d
...
- (unsigned long long)recognizeString:(const char *)arg1 withDataLength:(unsigned long long)arg2 intoBuffer:(id)arg3;	// IMP=0x00000000006e9ab0
- (double)multiBytesRatio;	// IMP=0x00000000006e99a9
- (double)_singleByte_confidence;	// IMP=0x00000000006e98e9
- (double)_ASCII_confidence;	// IMP=0x00000000006e985d
- (double)confidenceWith2Chars;	// IMP=0x00000000006e97d0
- (double)confidence;	// IMP=0x00000000006e96cb
- (id)initWithNSStringEncoding:(unsigned long long)arg1 CFStringEncoding:(unsigned int)arg2 recognizeFunc:(CDUnknownFunctionPointerType)arg3;	// IMP=0x00000000006e963c
- (unsigned long long)maxSkipBytes;	// IMP=0x00000000006e95f7
- (double)bytesRatio;	// IMP=0x00000000006e95aa
- (void)softReset;	// IMP=0x00000000006e955e
- (void)reset;	// IMP=0x00000000006e9500
