...
- (_Bool)assetPacksBecameUnavailable:(id)arg1 error:(id *)arg2;	// IMP=0x000000000070b9be
- (_Bool)assetPacksBecameAvailable:(id)arg1 error:(id *)arg2;	// IMP=0x000000000070b8b0
- (id)description;	// IMP=0x000000000070b826
- (void)dealloc;	// IMP=0x000000000070b74a
- (id)initWithBundle:(id)arg1;	// IMP=0x000000000070b050
