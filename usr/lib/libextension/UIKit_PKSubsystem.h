...
+ (id)initForPlugInKit;	// IMP=0x0010000000807325
+ (id)initForPlugInKitWithOptions:(id)arg1;	// IMP=0x001000000080730c
+ (id)sharedInstance;	// IMP=0x0010000000807274
...
- (void)endUsing:(id)arg1;	// IMP=0x000000000080726e
- (void)beginUsing:(id)arg1 withBundle:(id)arg2;	// IMP=0x0000000000807053
- (void)dealloc;	// IMP=0x0000000000806ff5
