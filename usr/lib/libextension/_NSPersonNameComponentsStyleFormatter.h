...
- (void)dealloc;	// IMP=0x0000000000801f1b
@property(readonly, copy) NSArray *fallbackDescriptor;
- (void)_releaseIvars;	// IMP=0x0000000000801d98
- (id)annotatedStringFromPersonNameComponents:(id)arg1;	// IMP=0x0000000000801c18
- (id)_formattedStringFromOrderedKeys:(id)arg1 components:(id)arg2 attributesByRange:(id)arg3;	// IMP=0x0000000000801751
- (id)_delimiterBetweenString:(id)arg1 andString:(id)arg2 isPhonetic:(_Bool)arg3;	// IMP=0x0000000000801678
- (id)_orderedNonEmptyKeysFromComponents:(id)arg1;	// IMP=0x0000000000801532
- (id)stringFromComponents:(id)arg1 attributesByRange:(id)arg2;	// IMP=0x0000000000801385
@property(readonly) NSArray *orderedTemplate;
@property long long ordering;
- (_Bool)fullComponentsAreValid:(id)arg1;	// IMP=0x0000000000801304
...
- (id)initWithMasterFormatter:(id)arg1;	// IMP=0x0000000000800fb4
