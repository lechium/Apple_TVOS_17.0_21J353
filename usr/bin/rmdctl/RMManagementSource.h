...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x0020000000010a1d
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x0010000000010976
+ (id)fetchRequestWithEnrollmentType:(long long)arg1;	// IMP=0x00100000000108f3
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x0010000000010870
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(long long)arg2;	// IMP=0x00100000000107bb
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x0010000000010714
- (id)reportDetails;	// IMP=0x0010000000010ac4
- (void)awakeFromInsert;	// IMP=0x0010000000010681
