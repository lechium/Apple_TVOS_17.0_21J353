...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000004e5b
- (id)reportDetails;	// IMP=0x00200000000056b2
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000005137
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000004ecb
