...
- (void)markPending;	// IMP=0x0020000000005efd
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000005bb4
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000005846
- (void)markQueued;	// IMP=0x00100000000057e3
