...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000162d
...
- (id)description;	// IMP=0x00000000000014f0
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001302
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000126d
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001084
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000176b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001635
