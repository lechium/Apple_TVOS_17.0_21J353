...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000006185
...
- (id)description;	// IMP=0x0000000000006048
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000005e5a
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000005dc5
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000005bdc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000062c3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000618d
