...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001a51
...
- (id)description;	// IMP=0x0000000000001914
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001726
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001691
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000014a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001b8f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001a59
