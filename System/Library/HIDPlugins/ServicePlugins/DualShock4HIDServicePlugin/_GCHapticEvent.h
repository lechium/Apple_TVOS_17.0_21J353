...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001799
...
- (id)description;	// IMP=0x000000000000165c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x000000000000146e
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x00000000000013d9
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000011f0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000018d7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000017a1
