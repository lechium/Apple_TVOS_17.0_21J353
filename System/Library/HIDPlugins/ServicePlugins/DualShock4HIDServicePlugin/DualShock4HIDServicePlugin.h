...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x00100000000023d4
- (void).cxx_destruct;	// IMP=0x0000000000005fd6
@property(nonatomic) _Bool extendedSupportEnabled; // @synthesize extendedSupportEnabled=_extendedSupportEnabled;
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005ee2
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x0000000000005d96
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005d7d
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005c99
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x0000000000005a9e
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000059bb
- (id)defaultHapticMotors;	// IMP=0x00000000000058dc
- (float)defaultHapticDispatchFrequency;	// IMP=0x00000000000058ce
- (void)dispatchHapticEvent;	// IMP=0x000000000000588d
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x000000000000587b
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005764
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x0000000000005419
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x0000000000005253
- (void)dispatchOutputReport;	// IMP=0x0000000000004e8b
- (void)setupRawReportHandling;	// IMP=0x0000000000004285
- (void)requestPairingInfo;	// IMP=0x0000000000003f6a
- (void)requestSensorCalibrationInfo;	// IMP=0x000000000000305f
- (void)requestFirmwareInfo;	// IMP=0x0000000000002a08
- (void)determineSupportMode;	// IMP=0x0000000000002705
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000002491
