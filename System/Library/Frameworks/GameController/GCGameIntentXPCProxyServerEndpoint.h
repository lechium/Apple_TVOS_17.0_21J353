...
- (void).cxx_destruct;	// IMP=0x000000000003a9ad
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000003a8f7
- (void)invalidateConnection;	// IMP=0x000000000003a844
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000003a5d9
- (void)invalidateClient;	// IMP=0x000000000003a518
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x000000000003a4c7
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x000000000003a436
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000003a3c1
