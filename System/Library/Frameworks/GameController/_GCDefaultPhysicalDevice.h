...
+ (id)identifierForService:(id)arg1;	// IMP=0x001000000007d329
- (void).cxx_destruct;	// IMP=0x000000000007d9d3
...
- (void)updateGlyphFlags;	// IMP=0x000000000007d4d2
- (void)eaAccessoriesDidChange;	// IMP=0x000000000007d452
- (id)propertyForKey:(id)arg1;	// IMP=0x000000000007d2aa
@property(readonly) NSSet *components;
- (id)driverConnection;	// IMP=0x000000000007d280
- (void)setDriverConnection:(id)arg1;	// IMP=0x000000000007c63e
- (void)setFilterConnection:(id)arg1;	// IMP=0x000000000007c2b9
@property(readonly, copy) NSString *debugDescription;
- (id)redactedDescription;	// IMP=0x000000000007c16b
@property(readonly, copy) NSString *description;
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000007bf43
- (void)dealloc;	// IMP=0x000000000007bead
- (id)init;	// IMP=0x000000000007be82
- (void)_workaround_backbone_97462229:(id)arg1;	// IMP=0x000000000007bce8
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2;	// IMP=0x000000000007bbf7
@property(readonly) id <_GCGamepadEventSourceDescription> gamepadEventSource;
- (_Bool)supportsGamepad;	// IMP=0x000000000007dad2
...
- (_Bool)supportsMotion;	// IMP=0x000000000007dde0
@property long long indicatedPlayerIndex;
- (_Bool)supportsPlayerIndicator;	// IMP=0x000000000007e155
...
- (_Bool)supportsLight;	// IMP=0x000000000007e257
...
- (void)setAdaptiveTriggersPayload:(id)arg1 forIndex:(int)arg2;	// IMP=0x000000000007e70e
@property(copy, nonatomic) CDUnknownBlockType deviceAdaptiveTriggersServiceConnectedHandler;
- (_Bool)supportsAdaptiveTriggers;	// IMP=0x000000000007e5c7
- (void)updateAdaptiveTriggerStatusWithLeftMode:(unsigned char)arg1 leftStatus:(unsigned char)arg2 leftArmPosition:(unsigned char)arg3 rightMode:(unsigned char)arg4 rightStatus:(unsigned char)arg5 rightArmPosition:(unsigned char)arg6;	// IMP=0x000000000007e95b
...
- (_Bool)supportsBattery;	// IMP=0x000000000007eb99
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x000000000007ee9c
...
- (_Bool)supportsHapticCapabilities;	// IMP=0x000000000007f037
@property(copy, nonatomic) CDUnknownBlockType deviceGameIntentComponentGameIntentTriggeredHandler;
- (void)setEnableGlobalGameControllerFunctionality:(_Bool)arg1;	// IMP=0x000000000007f190
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x000000000007f207
- (unsigned long long)getGlyphFlags;	// IMP=0x000000000007f3f6
