...
- (double)lastEventTimestamp;	// IMP=0x00000000000af6da
- (_Bool)isSnapshot;	// IMP=0x00000000000af6d2
- (void)updateViewStateIfNeeded;	// IMP=0x00000000000af689
- (id)popTransaction;	// IMP=0x00000000000af5b2
- (id)physicalInput;	// IMP=0x00000000000af511
- (void)setDataSource:(id)arg1;	// IMP=0x00000000000af381
- (void)setDevice:(id)arg1;	// IMP=0x00000000000af324
- (void)dealloc;	// IMP=0x00000000000af13a
- (id)initWithFacade:(id)arg1 elements:(id)arg2;	// IMP=0x00000000000ae637
- (id)initWithFacade:(id)arg1 elements:(id)arg2 attributes:(id)arg3;	// IMP=0x00000000000ae48f
