...
+ (_Bool)automaticallyNotifiesObserversOfQueue;	// IMP=0x0010000000043429
- (id)changedElements;	// IMP=0x00000000000438b8
- (long long)changeForElement:(id)arg1;	// IMP=0x00000000000437e1
- (id)nextInputState;	// IMP=0x0000000000043774
@property long long inputStateQueueDepth;
@property(copy) CDUnknownBlockType inputStateAvailableHandler;
- (id)capture;	// IMP=0x000000000004357d
@property(copy) CDUnknownBlockType elementValueDidChangeHandler;
@property(retain) NSObject<OS_dispatch_queue> *queue;
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x00000000000433f8
...
- (id)alternatePhysicalInputWithAttribute:(id)arg1;	// IMP=0x00000000000431fd
- (id)initWithTemplate:(id)arg1 context:(id)arg2;	// IMP=0x00000000000431ce
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000004319f
