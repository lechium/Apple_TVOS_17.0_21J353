...
- (void).cxx_destruct;	// IMP=0x00000000000acd61
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000acca3
- (void)invalidateConnection;	// IMP=0x00000000000acbff
- (void)refreshStatuses;	// IMP=0x00000000000acad2
- (void)newStatuses:(id)arg1;	// IMP=0x00000000000ac9b3
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x00000000000ac862
- (void)setController:(id)arg1;	// IMP=0x00000000000ac7bc
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000ac58e
- (id)init;	// IMP=0x00000000000ac563
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000ac369
