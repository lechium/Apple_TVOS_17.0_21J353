...
- (void).cxx_destruct;	// IMP=0x000000000000bfe7
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000bf27
- (void)invalidateConnection;	// IMP=0x000000000000be74
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000bdca
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b9c2
- (void)invalidateClient;	// IMP=0x000000000000b901
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000000b845
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000000b79d
