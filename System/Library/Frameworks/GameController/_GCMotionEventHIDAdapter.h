...
- (void).cxx_destruct;	// IMP=0x000000000009f9dc
...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000009f62d
- (void)dealloc;	// IMP=0x000000000009f5d4
- (id)init;	// IMP=0x000000000009f5a9
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000009ef8a
