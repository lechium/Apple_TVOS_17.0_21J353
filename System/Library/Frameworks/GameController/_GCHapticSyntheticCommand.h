...
- (void).cxx_destruct;	// IMP=0x00000000000f1333
...
- (id)description;	// IMP=0x00000000000f12c0
...
- (void)cancel;	// IMP=0x00000000000f126d
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x00000000000f11e0
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x00000000000f10ef
