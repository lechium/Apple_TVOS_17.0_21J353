...
- (void).cxx_destruct;	// IMP=0x000000000009c142
...
- (void)processChangedElements:(id)arg1 atTimestamp:(unsigned long long)arg2;	// IMP=0x000000000009b7a4
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2 slidingWindowTotalDuration:(double)arg3 slidingWindowSegmentDuration:(double)arg4 deadzone:(double)arg5 sensitivity:(int)arg6;	// IMP=0x000000000009b5b6
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000009b583
