...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000008374c
- (void)invalidateConnection;	// IMP=0x0000000000083699
- (void)fetchProfileWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000835ef
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000083239
- (void)invalidateClient;	// IMP=0x0000000000083189
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForProfile:(id)arg1;	// IMP=0x00000000000830cd
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x0000000000083025
