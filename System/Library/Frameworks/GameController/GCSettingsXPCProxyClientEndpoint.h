...
- (void).cxx_destruct;	// IMP=0x0000000000082fc8
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000082f31
- (void)invalidateConnection;	// IMP=0x0000000000082e8d
- (void)refreshProfile;	// IMP=0x0000000000082d6e
- (void)newProfile:(id)arg1;	// IMP=0x0000000000082c5a
- (void)_remoteEndpointHasSetProfile:(id)arg1;	// IMP=0x0000000000082b2a
- (void)setController:(id)arg1;	// IMP=0x0000000000082b19
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000082904
- (id)init;	// IMP=0x00000000000828d9
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000008279b
