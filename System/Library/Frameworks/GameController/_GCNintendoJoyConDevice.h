...
- (void).cxx_destruct;	// IMP=0x000000000003771c
...
- (void)playerIndicatorXPCProxyServerEndpoint:(id)arg1 didReceivePlayerIndexChange:(long long)arg2;	// IMP=0x0000000000037546
- (void)activateLogical;	// IMP=0x000000000003752f
@property(readonly) NSSet *underlyingDevices;
- (id)propertyForKey:(id)arg1;	// IMP=0x00000000000374bd
...
- (void)setDriverConnection:(id)arg1;	// IMP=0x0000000000036b87
- (id)init;	// IMP=0x0000000000036b5c
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2 type:(unsigned char)arg3;	// IMP=0x0000000000036905
- (id)makeControllerForClient:(id)arg1;	// IMP=0x0000000000037b6a
- (void)_removeClient:(id)arg1;	// IMP=0x0000000000037a53
- (void)_addClient:(id)arg1;	// IMP=0x00000000000377b9
...
- (void)propagateBattery:(id)arg1;	// IMP=0x00000000000394ae
- (id)readBattery;	// IMP=0x0000000000039303
...
- (void)homeButtonLongPressGesture:(_Bool)arg1;	// IMP=0x00000000000398a8
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x000000000003993e
- (id)hapticDriver;	// IMP=0x000000000003999a
