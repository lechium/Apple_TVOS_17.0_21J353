...
- (void).cxx_destruct;	// IMP=0x000000000005fbe3
@property(readonly, nonatomic) __weak id <_GCIPCProcess> process; // @synthesize process=_process;
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000005fb9f
- (id)initWithConnection:(id)arg1 fromProcess:(id)arg2;	// IMP=0x000000000005fa35
