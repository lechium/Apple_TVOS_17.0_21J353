...
- (void).cxx_destruct;	// IMP=0x0000000000055941
...
- (void)sendEvent:(id)arg1 toSubscriber:(id)arg2;	// IMP=0x000000000005561f
- (void)sendEvent:(id)arg1;	// IMP=0x00000000000551f3
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x0000000000054d8a
- (id)initWithStreamName:(id)arg1 isStatefulEventPublisher:(_Bool)arg2;	// IMP=0x0000000000054a53
- (id)initWithStreamName:(id)arg1;	// IMP=0x0000000000054a3f
