...
- (double)lastEventTimestamp;	// IMP=0x00000000000d98ea
- (_Bool)isSnapshot;	// IMP=0x00000000000d9598
- (id)description;	// IMP=0x00000000000d9500
- (id)physicalInput;	// IMP=0x00000000000d948a
- (_Bool)allowsWeakReference;	// IMP=0x00000000000d9482
- (void)dealloc;	// IMP=0x00000000000d9410
