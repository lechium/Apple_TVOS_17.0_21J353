...
- (void).cxx_destruct;	// IMP=0x000000000006e005
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006df45
- (void)invalidateConnection;	// IMP=0x000000000006de92
- (void)fetchLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006dde8
- (void)newLight:(id)arg1;	// IMP=0x000000000006dcfa
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000006d8f2
- (void)invalidateClient;	// IMP=0x000000000006d831
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000006d775
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000006d6cd
