...
- (void)triggerGestureGameIntentGameCenter;	// IMP=0x000000000003a281
- (void)triggerGestureGameIntentAppLibrary;	// IMP=0x000000000003a19c
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000003a13c
- (void)invalidateConnection;	// IMP=0x000000000003a098
- (void)setController:(id)arg1;	// IMP=0x000000000003a087
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000039e69
- (id)init;	// IMP=0x0000000000039e3e
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000039d3a
