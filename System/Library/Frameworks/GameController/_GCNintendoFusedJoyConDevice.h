...
+ (id)identifierForFusedJoyConDeviceWithLeftDevice:(id)arg1 rightDevice:(id)arg2;	// IMP=0x001000000005c67d
- (void).cxx_destruct;	// IMP=0x000000000005c7a9
...
- (void)deactivate;	// IMP=0x000000000005c677
- (void)activateLogical;	// IMP=0x000000000005c632
@property(readonly) NSSet *underlyingDevices;
- (id)propertyForKey:(id)arg1;	// IMP=0x000000000005c582
@property(readonly) NSSet *components;
- (void)playerIndicatorXPCProxyServerEndpoint:(id)arg1 didReceivePlayerIndexChange:(long long)arg2;	// IMP=0x000000000005c410
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000005c350
- (void)dealloc;	// IMP=0x000000000005c28b
- (id)init;	// IMP=0x000000000005c260
- (id)initWithLeft:(id)arg1 right:(id)arg2 manager:(id)arg3;	// IMP=0x000000000005bda1
- (id)makeControllerForClient:(id)arg1;	// IMP=0x000000000005cbb2
- (void)_removeClient:(id)arg1;	// IMP=0x000000000005ca8b
- (void)_addClient:(id)arg1;	// IMP=0x000000000005c848
@property(readonly, nonatomic) GCDeviceBattery *battery;
- (void)_propagateBattery;	// IMP=0x000000000005f50f
- (void)_refreshBattery;	// IMP=0x000000000005f417
...
- (id)persistentIdentifierForSettings;	// IMP=0x000000000005f9b6
- (void)settingsDidChange;	// IMP=0x000000000005f67b
