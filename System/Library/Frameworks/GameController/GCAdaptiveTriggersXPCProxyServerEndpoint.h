...
- (void).cxx_destruct;	// IMP=0x00000000000ad7cb
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ad6d5
- (void)invalidateConnection;	// IMP=0x00000000000ad622
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x00000000000ad524
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ad47a
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000ad060
- (void)invalidateClient;	// IMP=0x00000000000acf9f
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x00000000000acee3
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000acdd4
