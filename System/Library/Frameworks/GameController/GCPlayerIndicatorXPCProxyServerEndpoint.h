...
- (void).cxx_destruct;	// IMP=0x00000000000edb4b
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000eda8b
- (void)invalidateConnection;	// IMP=0x00000000000ed9d8
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ed92e
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000ed880
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000ed49c
- (void)invalidateClient;	// IMP=0x00000000000ed3db
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000ed341
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000ed2c1
