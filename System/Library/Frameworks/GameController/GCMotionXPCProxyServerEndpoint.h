...
- (void).cxx_destruct;	// IMP=0x000000000002a758
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000002a699
- (void)invalidateConnection;	// IMP=0x000000000002a5e6
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000002a53c
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x000000000002a492
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002a0af
- (void)invalidateClient;	// IMP=0x0000000000029fee
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x0000000000029f56
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x0000000000029ed7
