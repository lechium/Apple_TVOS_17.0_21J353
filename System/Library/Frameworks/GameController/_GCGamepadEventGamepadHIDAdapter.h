...
- (void).cxx_destruct;	// IMP=0x00000000000846ad
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000842fe
- (void)dealloc;	// IMP=0x00000000000842a5
- (id)init;	// IMP=0x000000000008427a
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x0000000000083f9a
