...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x0000000000108d8a
- (id)executeRequest;	// IMP=0x000000000010897f
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x0000000000108908
- (id)processReply:(id)arg1;	// IMP=0x0000000000107924
- (id)acmeRequest;	// IMP=0x000000000010729d
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x000000000010725f
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x0000000000106bca
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x0000000000106b62
- (id)attestationChainPEMRepresentation;	// IMP=0x0000000000106a93
- (id)createCertificate;	// IMP=0x000000000010696f
- (id)createAttestation;	// IMP=0x0000000000106620
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x0000000000106262
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x00000000001061f8
- (_Bool)deviceAttestationSupported;	// IMP=0x00000000001061f0
- (id)createCSR;	// IMP=0x00000000001060f5
- (id)createKeyPair;	// IMP=0x0000000000106028
- (id)sanitizeParameters;	// IMP=0x0000000000105ef7
- (id)sanitizeSubject;	// IMP=0x0000000000105dfc
- (id)serialNumber;	// IMP=0x0000000000105d1e
- (void)dealloc;	// IMP=0x0000000000105c7d
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x0000000000105bb1
