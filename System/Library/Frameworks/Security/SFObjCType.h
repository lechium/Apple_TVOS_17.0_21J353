...
+ (id)typeForValue:(id)arg1;	// IMP=0x0060000000043de4
+ (id)typeForEncoding:(const char *)arg1;	// IMP=0x0060000000043879
- (void).cxx_destruct;	// IMP=0x0000000000043846
...
- (void)getBytes:(void *)arg1 forObject:(id)arg2;	// IMP=0x0000000000043780
- (id)objectWithBytes:(const void *)arg1;	// IMP=0x0000000000043599
...
- (id)initWithCode:(long long)arg1 encoding:(id)arg2 name:(id)arg3 className:(id)arg4 size:(unsigned long long)arg5 flags:(unsigned long long)arg6;	// IMP=0x000000000004348f
