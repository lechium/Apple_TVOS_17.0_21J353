...
- (void).cxx_destruct;	// IMP=0x0000000000069971
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000006987f
- (unsigned long long)hash;	// IMP=0x0000000000069812
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000069732
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006966e
- (void)copyTo:(id)arg1;	// IMP=0x00000000000695eb
- (void)writeTo:(id)arg1;	// IMP=0x0000000000069571
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000693e5
- (id)dictionaryRepresentation;	// IMP=0x000000000006933b
- (id)description;	// IMP=0x000000000006928c
