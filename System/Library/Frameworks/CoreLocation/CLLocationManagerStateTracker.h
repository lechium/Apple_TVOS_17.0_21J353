...
+ (const char *)trackerStateTypeName;	// IMP=0x0060000000012802
+ (unsigned long long)trackerStateSize;	// IMP=0x00600000000127f7
- (void *)identifier;	// IMP=0x000000000001280f
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x0000000000012644
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012294
...
- (void)dealloc;	// IMP=0x000000000000f9f6
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000f583
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000f56e
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000f50d
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000f4f8
