...
- (void)createConnection;	// IMP=0x0000000000037ec2
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x0000000000037dfc
- (void)dealloc;	// IMP=0x0000000000037d6d
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x0000000000037c64
