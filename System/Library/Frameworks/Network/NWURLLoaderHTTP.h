...
- (void).cxx_destruct;	// IMP=0x0000000000770600
@property(readonly, nonatomic) NWConcrete_nw_connection *underlyingConnection;
- (void)responseIsMixed;	// IMP=0x00000000007705d0
- (void)writeData:(id)arg1 complete:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000007705c0
@property(readonly, nonatomic) _Bool allowsWrite;
@property(readonly, nonatomic) NSObject<OS_sec_trust> *peerTrust;
- (void)readDataOfMinimumIncompleteLength:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000770150
- (void)readResponse:(CDUnknownBlockType)arg1;	// IMP=0x0000000000770120
- (void)updateClient:(id)arg1;	// IMP=0x00000000007700d0
- (void)stop;	// IMP=0x000000000076ff30
- (void)start:(CDUnknownBlockType)arg1;	// IMP=0x000000000076faf0
