...
- (void).cxx_destruct;	// IMP=0x000000000071f460
...
- (_Bool)cancel;	// IMP=0x000000000071f1c0
- (_Bool)resume;	// IMP=0x000000000071f0e0
- (_Bool)isSuspended;	// IMP=0x000000000071f0d0
- (_Bool)suspend;	// IMP=0x000000000071eff0
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000071ed80
- (id)start;	// IMP=0x000000000071ed70
