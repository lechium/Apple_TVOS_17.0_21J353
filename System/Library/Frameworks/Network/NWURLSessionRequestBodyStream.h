...
- (void).cxx_destruct;	// IMP=0x0000000000216ae0
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0000000000216a00
- (void)close;	// IMP=0x0000000000216980
- (void)readMinimumIncompleteLength:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002168b0
