...
- (void).cxx_destruct;	// IMP=0x0000000000584810
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x00000000005847c0
- (id)description;	// IMP=0x00000000005847a0
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x00000000005843c0
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x0000000000583aa0
