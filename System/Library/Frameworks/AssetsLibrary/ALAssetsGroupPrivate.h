...
- (void).cxx_destruct;	// IMP=0x000000000000c50f
...
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000c202
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000c195
- (void)populateAssets;	// IMP=0x000000000000c177
- (void)updateAlbumFiltering;	// IMP=0x000000000000c12b
- (void)resetAssets;	// IMP=0x000000000000c0e5
- (int)albumFilter;	// IMP=0x000000000000c061
- (void)dealloc;	// IMP=0x000000000000bfad
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000bed1
