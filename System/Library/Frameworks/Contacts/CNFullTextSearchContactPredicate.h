...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000254ae
- (void).cxx_destruct;	// IMP=0x0000000000025905
...
- (id)description;	// IMP=0x0000000000025787
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000256cd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000254b6
- (id)initWithSearchString:(id)arg1 containerIdentifiers:(id)arg2 groupIdentifiers:(id)arg3;	// IMP=0x00000000000253ae
