...
- (void).cxx_destruct;	// IMP=0x00000000000e58b0
@property(readonly, nonatomic) CRRecentContactsLibrary *library; // @synthesize library=_library;
- (id)recentContactsForHandle:(id)arg1;	// IMP=0x00000000000e5365
- (id)initWithRecentContactsLibrary:(id)arg1;	// IMP=0x00000000000e52e7
- (id)init;	// IMP=0x00000000000e51f4
