...
- (void).cxx_destruct;	// IMP=0x0000000000042f15
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x0000000000041f97
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x0000000000041ec9
