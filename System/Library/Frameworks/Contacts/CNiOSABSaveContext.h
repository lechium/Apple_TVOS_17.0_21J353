...
- (void).cxx_destruct;	// IMP=0x000000000006144c
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x000000000006137d
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x0000000000061367
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x0000000000061351
- (void)_populateSaveRequestIndexTables;	// IMP=0x0000000000060ee8
- (void)dealloc;	// IMP=0x0000000000060ea9
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x0000000000060cc0
