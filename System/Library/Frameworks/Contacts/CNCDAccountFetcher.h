...
+ (id)accountsForPredicate:(id)arg1 inPersistenceStack:(id)arg2 error:(id *)arg3;	// IMP=0x00600000000614cc
...
- (id)fetchAccounts:(id *)arg1;	// IMP=0x0000000000061788
- (id)initWithPredicate:(id)arg1 persistenceContext:(id)arg2;	// IMP=0x00000000000616df
- (id)init;	// IMP=0x00000000000616a2
