...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00000000000ccdd9
+ (id)os_log;	// IMP=0x00000000000cbef2
- (void).cxx_destruct;	// IMP=0x00000000000ccfe8
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000ccde1
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000cc13b
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000cc133
- (void)resetAllData;	// IMP=0x00000000000cc08b
