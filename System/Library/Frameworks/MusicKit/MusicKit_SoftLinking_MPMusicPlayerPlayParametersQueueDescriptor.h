...
- (void).cxx_destruct;	// IMP=0x00000000000044ac
...
- (void)setEndTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x0000000000004434
- (void)setStartTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x00000000000043da
@property(readonly, nonatomic) MPMusicPlayerPlayParametersQueueDescriptor *_underlyingQueueDescriptor;
- (id)initWithPlayParametersQueue:(id)arg1;	// IMP=0x0000000000003f54
