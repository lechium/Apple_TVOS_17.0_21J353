...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x0060000000008580
- (void).cxx_destruct;	// IMP=0x000000000000a7c9
...
- (id)description;	// IMP=0x000000000000a3d1
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x0000000000008be3
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x0000000000008802
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000008662
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x00000000000085d2
