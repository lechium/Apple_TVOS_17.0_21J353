...
+ (id)_musicKit_modelObjectStorageDictionaryForStoreBrowseContentItem:(id)arg1;	// IMP=0x00100000000030a4
+ (id)_musicKit_modelObjectStorageDictionaryForPlaylistEntry:(id)arg1;	// IMP=0x0010000000002fcc
+ (id)_musicKit_modelObjectStorageDictionaryForGenericModelObject:(id)arg1;	// IMP=0x0010000000002ed3
@property(readonly, nonatomic) NSDictionary *musicKit_modelObjectStorageDictionary;
- (id)_musicKit_modelObjectRawStorageDictionary;	// IMP=0x0010000000002ad4
...
- (id)_musicKit_innerModelObject;	// IMP=0x00100000000031dd
@property(readonly, nonatomic) long long musicKit_nowPlayingInfoAudioFormat_badging;
- (id)_musicKit_self_nowPlayingInfoAudioFormat;	// IMP=0x0010000000005ba4
- (_Bool)intersectsSet:(id)arg1;	// IMP=0x0010000000006ddb
...
- (id)_musicKit_self_identifierSet;	// IMP=0x0010000000006050
...
- (id)_musicKit_self_artworkColorAnalysis;	// IMP=0x0010000000021d4d
- (void)musicKit_requestColorAnalysisWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000022809
- (void)musicKit_requestImageDataWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000225b9
...
- (id)_musicKit_self_artworkCatalog;	// IMP=0x0010000000021ff9
- (id)musicKit_artworkCatalogForProperty:(id)arg1;	// IMP=0x0010000000022a87
