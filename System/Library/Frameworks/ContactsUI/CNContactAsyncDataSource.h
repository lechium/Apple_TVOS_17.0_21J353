...
- (void).cxx_destruct;	// IMP=0x00000000000c8868
...
- (void)invalidate;	// IMP=0x00000000000c8764
- (void)invalidateSearch;	// IMP=0x00000000000c86e7
- (void)invalidateResults;	// IMP=0x00000000000c8661
- (void)reloadWithRequest:(id)arg1;	// IMP=0x00000000000c80f2
- (void)reload;	// IMP=0x00000000000c7f5b
@property(readonly, nonatomic) CNContactFilter *effectiveFilter;
- (id)indexPathForContact:(id)arg1;	// IMP=0x00000000000c7de4
- (id)completeContactFromContact:(id)arg1 fromMainStoreOnly:(_Bool)arg2 keysToFetch:(id)arg3;	// IMP=0x00000000000c7c4d
...
- (void)dealloc;	// IMP=0x00000000000c7a85
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c7942
- (id)initWithStore:(id)arg1;	// IMP=0x00000000000c7757
