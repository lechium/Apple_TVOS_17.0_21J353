...
- (void).cxx_destruct;	// IMP=0x0000000000082655
...
- (void)reject;	// IMP=0x00000000000825d0
- (void)confirm;	// IMP=0x000000000008257e
- (_Bool)_confirmOrReject:(_Bool)arg1;	// IMP=0x0000000000082576
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x000000000008224f
