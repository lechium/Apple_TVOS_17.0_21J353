...
+ (id)descriptorForRequiredKeys;	// IMP=0x0060000000052656
- (void).cxx_destruct;	// IMP=0x0000000000054241
...
- (void)cellWasSingleTapped:(id)arg1;	// IMP=0x0000000000054010
- (void)cellWasLongPressed:(id)arg1;	// IMP=0x0000000000053fc0
- (void)showMenu;	// IMP=0x0000000000053edc
- (void)menuDidHide:(id)arg1;	// IMP=0x0000000000053e7f
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000053e77
- (void)copy:(id)arg1;	// IMP=0x0000000000053de3
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000053da7
- (void)setMeContact:(id)arg1 footnoteTitle:(id)arg2 footnoteValue:(id)arg3;	// IMP=0x0000000000053a26
- (id)footnoteTextColor;	// IMP=0x000000000005383e
- (id)footnoteFont;	// IMP=0x00000000000537b0
- (_Bool)displaysContactInfo;	// IMP=0x000000000005377d
- (void)updateFontRelatedConstraints;	// IMP=0x00000000000534e3
- (void)dealloc;	// IMP=0x000000000005346e
- (id)init;	// IMP=0x0000000000052785
