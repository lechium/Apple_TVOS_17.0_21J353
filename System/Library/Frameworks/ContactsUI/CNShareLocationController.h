...
+ (id)fmfHandleFromContactProperty:(id)arg1;	// IMP=0x006000000009b770
+ (id)fmfHandlesFromContact:(id)arg1;	// IMP=0x006000000009b20b
- (void).cxx_destruct;	// IMP=0x000000000009b96f
...
- (void)notifySharingStatusDidChange;	// IMP=0x000000000009b69e
- (void)initiateIDSRequest;	// IMP=0x000000000009b205
- (id)endOfDayDate;	// IMP=0x000000000009b16c
- (void)stopSharingLocation;	// IMP=0x000000000009b081
- (void)shareLocationUntilEndDate:(id)arg1;	// IMP=0x000000000009ae9a
- (void)perform:(id)arg1;	// IMP=0x000000000009a635
@property(readonly, nonatomic) _Bool isSharing;
@property(readonly, nonatomic) _Bool canShare;
- (id)initWithIDSAvailabilityProvider:(id)arg1;	// IMP=0x000000000009a2dc
