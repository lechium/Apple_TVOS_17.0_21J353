...
- (void).cxx_destruct;	// IMP=0x00000000000acb3b
...
@property(copy, nonatomic) CDUnknownBlockType nameProvider; // @synthesize nameProvider=_nameProvider;
@property(nonatomic, getter=isSelected) _Bool selected; // @synthesize selected=_selected;
@property(retain, nonatomic) NSString *name; // @synthesize name=_name;
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000000ac9e9
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000000ac6ee
- (void)_setSelected:(_Bool)arg1;	// IMP=0x00000000000ac273
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000ac052
