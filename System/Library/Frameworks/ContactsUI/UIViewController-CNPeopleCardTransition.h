...
- (id)_cardViewControllerTransitioning;	// IMP=0x00300000000cd9ca
- (void)set_cardViewControllerTransitioning:(id)arg1;	// IMP=0x00300000000cd9b4
- (void)cnui_addChildViewController:(id)arg1;	// IMP=0x00300000000cdd6a
...
- (_Bool)_ab_isInPopoverRecursive:(_Bool)arg1;	// IMP=0x00300000000cdac6
