...
- (void).cxx_destruct;	// IMP=0x000000000001991b
...
- (id)description;	// IMP=0x00000000000197fa
- (void)performWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000019171
- (id)subtitleForContext:(long long)arg1;	// IMP=0x0000000000019114
- (id)titleForContext:(long long)arg1;	// IMP=0x000000000001901a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018f12
- (id)initWithActions:(id)arg1;	// IMP=0x0000000000018ea6
