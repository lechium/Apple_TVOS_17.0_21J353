...
- (void).cxx_destruct;	// IMP=0x00000000000c7749
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x00000000000c767b
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000c7600
