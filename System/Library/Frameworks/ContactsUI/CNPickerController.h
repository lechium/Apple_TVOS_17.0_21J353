...
- (void).cxx_destruct;	// IMP=0x00000000000681d6
...
- (id)_itemAtIndexPath:(id)arg1;	// IMP=0x0000000000067ebe
- (unsigned long long)_indexForCustomItemAtIndexPath:(id)arg1;	// IMP=0x0000000000067dff
- (void)tableView:(id)arg1 didEndEditingRowAtIndexPath:(id)arg2;	// IMP=0x0000000000067ded
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x0000000000067d88
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000067cc4
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0000000000067bd4
- (void)tableView:(id)arg1 commitEditingStyle:(long long)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x0000000000067a1a
- (_Bool)tableView:(id)arg1 shouldIndentWhileEditingRowAtIndexPath:(id)arg2;	// IMP=0x0000000000067a12
- (long long)tableView:(id)arg1 editingStyleForRowAtIndexPath:(id)arg2;	// IMP=0x00000000000679e7
- (void)tableView:(id)arg1 willDisplayHeaderView:(id)arg2 forSection:(long long)arg3;	// IMP=0x00000000000679d2
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x0000000000067908
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000000006769e
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000067479
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000000000673ab
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000000000672c2
- (_Bool)isEditing;	// IMP=0x000000000006727e
- (void)_updateRightButtonItem;	// IMP=0x0000000000067138
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000066a9b
- (void)removeCustomItem:(id)arg1;	// IMP=0x0000000000066a95
- (void)customLabelUpdated:(id)arg1;	// IMP=0x0000000000066a24
- (void)donePicker:(id)arg1;	// IMP=0x00000000000669b3
- (void)cancelPicker:(id)arg1;	// IMP=0x0000000000066967
- (id)titleForAddCustomItem;	// IMP=0x0000000000066909
- (id)titleForPickerItem:(id)arg1;	// IMP=0x0000000000066869
- (id)_titleForPickerItem:(id)arg1;	// IMP=0x0000000000066863
- (void)dealloc;	// IMP=0x00000000000667ee
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000666aa
