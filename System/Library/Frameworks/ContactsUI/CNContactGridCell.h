...
+ (double)actionsLeftMargin;	// IMP=0x00600000000a2d08
- (void).cxx_destruct;	// IMP=0x00000000000a4793
...
- (_Bool)isHighlighted;	// IMP=0x00000000000a44ef
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a44a5
- (void)_updateActionsMask;	// IMP=0x00000000000a43d9
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000000a42fe
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000000a3cf4
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000000a322d
- (void)_createViewsIfNeeded;	// IMP=0x00000000000a2ee4
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000000a2ece
