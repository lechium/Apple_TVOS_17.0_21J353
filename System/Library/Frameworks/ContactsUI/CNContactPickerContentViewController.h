...
+ (id)descriptorForContactPropertiesSupportingPredicateEvaluation;	// IMP=0x00100000000c27af
- (void).cxx_destruct;	// IMP=0x00000000000c5883
...
- (void)_selectedProperties:(id)arg1;	// IMP=0x00000000000c520b
- (void)_selectedContacts:(id)arg1;	// IMP=0x00000000000c4f6a
- (void)_selectedProperty:(id)arg1;	// IMP=0x00000000000c4dd0
- (void)_selectedContact:(id)arg1;	// IMP=0x00000000000c4ce8
- (id)descriptorsForKeysRequiredByDelegate;	// IMP=0x00000000000c4c58
- (void)contactNavigationControllerDidCancel:(id)arg1;	// IMP=0x00000000000c4c1b
- (void)contactNavigationControllerDidComplete:(id)arg1;	// IMP=0x00000000000c4b7f
- (_Bool)contactNavigationController:(id)arg1 presentContactViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000c4ab0
- (_Bool)contactNavigationController:(id)arg1 shouldPerformDefaultActionForContactProperty:(id)arg2;	// IMP=0x00000000000c48df
- (_Bool)contactNavigationControllerShouldShowContactsOnKeyCommands:(id)arg1;	// IMP=0x00000000000c48d7
- (_Bool)contactNavigationController:(id)arg1 shouldShowCardForContact:(id)arg2;	// IMP=0x00000000000c46d8
- (_Bool)contactNavigationController:(id)arg1 shouldSelectContact:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x00000000000c3bcf
- (_Bool)contactNavigationController:(id)arg1 canSelectContact:(id)arg2;	// IMP=0x00000000000c3a7e
- (void)invalidate;	// IMP=0x00000000000c3a78
- (void)invalidateSelectionAnimated:(_Bool)arg1;	// IMP=0x00000000000c38cf
@property(readonly, nonatomic) UINavigationController *navigationController;
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000000c3831
- (void)_updatePromptWithViewSize:(struct CGSize)arg1 transitionCoordinator:(id)arg2;	// IMP=0x00000000000c3620
- (id)_validatePredicatesWithError:(id *)arg1;	// IMP=0x00000000000c3277
- (void)setupWithOptions:(id)arg1 readyBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c285f
- (id)init;	// IMP=0x00000000000c27c8
