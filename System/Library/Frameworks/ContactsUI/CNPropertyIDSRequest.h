...
+ (id)sharedWorkQueue;	// IMP=0x0010000000059ed8
- (void).cxx_destruct;	// IMP=0x000000000005b236
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x000000000005a43c
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x000000000005a372
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x000000000005a28a
- (void)cleanupDelegate;	// IMP=0x000000000005a1e5
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000059f5b
