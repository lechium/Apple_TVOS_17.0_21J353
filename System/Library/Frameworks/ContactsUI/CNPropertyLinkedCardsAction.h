...
- (void).cxx_destruct;	// IMP=0x000000000008d6bb
...
- (void)setPreferredForName;	// IMP=0x000000000008d452
- (void)setPreferredForImage;	// IMP=0x000000000008d264
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x000000000008cb14
- (void)dealloc;	// IMP=0x000000000008cad2
- (id)initWithContact:(id)arg1;	// IMP=0x000000000008caa3
