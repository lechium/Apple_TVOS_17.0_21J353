...
- (void).cxx_destruct;	// IMP=0x00000000000aee18
...
- (void)setServerFilterForItem:(id)arg1;	// IMP=0x00000000000aebcb
@property(copy, nonatomic) CNContactStoreFilter *filter;
- (void)_applyFilter;	// IMP=0x00000000000ae51c
- (void)_reloadSections;	// IMP=0x00000000000acc36
- (void)reload;	// IMP=0x00000000000acc22
- (id)initWithStore:(id)arg1;	// IMP=0x00000000000acb82
