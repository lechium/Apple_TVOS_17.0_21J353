...
- (void).cxx_destruct;	// IMP=0x0000000000016b19
...
- (void)contactViewController:(id)arg1 didCompleteWithContact:(id)arg2;	// IMP=0x0000000000016a1c
- (void)contactPicker:(id)arg1 didSelectContact:(id)arg2;	// IMP=0x00000000000168c8
- (void)contactPickerDidCancel:(id)arg1;	// IMP=0x0000000000016865
- (void)performActionWithSender:(id)arg1;	// IMP=0x0000000000016742
