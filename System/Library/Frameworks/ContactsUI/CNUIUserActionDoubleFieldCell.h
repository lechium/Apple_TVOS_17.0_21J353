...
+ (id)subtitleTextColor;	// IMP=0x006000000007822e
- (void).cxx_destruct;	// IMP=0x0000000000078b11
...
- (void)updateFonts;	// IMP=0x0000000000078823
- (void)viewWillMoveToSuperview:(id)arg1;	// IMP=0x00000000000787d6
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000078262
