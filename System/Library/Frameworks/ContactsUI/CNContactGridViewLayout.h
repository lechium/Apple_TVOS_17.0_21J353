...
- (void).cxx_destruct;	// IMP=0x000000000009dbd1
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x000000000009d9cd
- (void)_updateLayoutMetrics;	// IMP=0x000000000009d00b
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000009cd66
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000009ca47
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000000009ca18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009c943
