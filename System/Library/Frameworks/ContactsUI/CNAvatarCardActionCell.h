...
+ (id)animatingCell;	// IMP=0x006000000004eab2
+ (id)cellNibForContacts;	// IMP=0x006000000004eaaa
+ (id)cellNibForMode:(long long)arg1;	// IMP=0x006000000004eaa2
...
- (void)trackHighlight:(id)arg1;	// IMP=0x000000000005168d
- (void)_animateActions:(id)arg1 fromIndex:(unsigned long long)arg2 withDelta:(long long)arg3 scrollDirection:(unsigned long long)arg4;	// IMP=0x0000000000050f10
- (void)trackSwipe:(id)arg1;	// IMP=0x00000000000509be
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000507e8
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000506e4
- (void)reloadData;	// IMP=0x000000000004f97e
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x000000000004f5fe
- (void)prepareForReuse;	// IMP=0x000000000004f562
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000004f24a
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000004f233
- (void)awakeFromNib;	// IMP=0x000000000004ecf5
- (void)_updateFonts;	// IMP=0x000000000004eba5
