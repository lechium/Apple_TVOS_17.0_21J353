...
- (void)_computeUsageForArguments:(id)arg1 function:(id)arg2;	// IMP=0x000000000011ce21
- (_Bool)matchesRenderPassDescriptor:(id)arg1;	// IMP=0x000000000011ccbe
- (id)description;	// IMP=0x000000000011c5d0
- (void)dealloc;	// IMP=0x000000000011c53a
- (id)init;	// IMP=0x000000000011c500
