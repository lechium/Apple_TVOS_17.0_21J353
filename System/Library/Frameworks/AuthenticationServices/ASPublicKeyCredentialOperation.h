...
- (void).cxx_destruct;	// IMP=0x000000000000eeb8
...
- (void)tearDownIfNecessary;	// IMP=0x000000000000ec61
...
- (void)selectSecurityKeyAssertion:(id)arg1;	// IMP=0x000000000000eb5d
- (void)selectPlatformAssertion:(id)arg1;	// IMP=0x000000000000eab7
- (void)setSecurityKeyAssertionSelectionCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000000ea56
- (void)setPlatformAssertionSelectionCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e9f5
- (void)mergeIdentifiersToAssertionResponses:(id)arg1;	// IMP=0x000000000000e78f
@property(readonly, copy, nonatomic) NSDictionary *identifiersToAssertionResponses;
- (id)initWithRelyingPartyIdentifier:(id)arg1 delegate:(id)arg2 parentActivity:(id)arg3;	// IMP=0x000000000000e643
