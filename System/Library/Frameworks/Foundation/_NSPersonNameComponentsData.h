...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000065d6eb
...
- (void)dealloc;	// IMP=0x000000000065daac
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000065d9af
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000065d6f3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000065d631
- (id)init;	// IMP=0x000000000065d5c3
