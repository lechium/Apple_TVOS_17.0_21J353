...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000800b35
...
- (void)dealloc;	// IMP=0x0000000000800db5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000800c32
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000800b3d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008009d5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000800968
