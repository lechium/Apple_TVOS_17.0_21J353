...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x006000000068aac1
...
- (void)dealloc;	// IMP=0x000000000068aa63
- (id)initWithIndex:(long long)arg1 specifierRangeInFormatString:(struct _NSRange)arg2 replacementRangeInResult:(struct _NSRange)arg3 replacementKind:(long long)arg4 argument:(id)arg5;	// IMP=0x000000000068a9b6
- (id)_initWithMetadata:(id)arg1;	// IMP=0x000000000068a6b1
