...
- (id).cxx_construct;	// IMP=0x0000000000184cdc
- (void).cxx_destruct;	// IMP=0x0000000000184c7a
...
- (void)requestMutation:(id)arg1;	// IMP=0x000000000018479b
- (void)notifyClientsOfCustomPropertyChange:(struct AudioObjectPropertyAddress)arg1;	// IMP=0x000000000018467b
