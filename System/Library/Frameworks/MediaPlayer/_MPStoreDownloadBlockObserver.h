...
- (void).cxx_destruct;	// IMP=0x000000000031708c
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x0000000000316ef2
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x0000000000316d74
- (id)initWithDownload:(id)arg1;	// IMP=0x0000000000316c64
