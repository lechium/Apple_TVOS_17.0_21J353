...
- (void).cxx_destruct;	// IMP=0x0000000000064aa9
...
- (id)_startEntryProxy;	// IMP=0x0000000000064991
- (id)nextObject;	// IMP=0x00000000000648ac
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x0000000000063edc
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000063b14
