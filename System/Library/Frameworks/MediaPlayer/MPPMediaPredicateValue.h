...
- (void).cxx_destruct;	// IMP=0x00000000002d4fcd
...
- (unsigned long long)hash;	// IMP=0x00000000002d4c7e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d4b12
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d49da
- (void)copyTo:(id)arg1;	// IMP=0x00000000002d4847
- (void)writeTo:(id)arg1;	// IMP=0x00000000002d4705
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002d46f8
- (id)dictionaryRepresentation;	// IMP=0x00000000002d44d1
- (id)description;	// IMP=0x00000000002d4422
...
- (void)dealloc;	// IMP=0x00000000002d4278
