...
+ (id)allSupportedItemProperties;	// IMP=0x0060000000239393
+ (id)allSupportedGroupProperties;	// IMP=0x00600000002392b9
- (void).cxx_destruct;	// IMP=0x0000000000238888
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000002383b4
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x00000000002382a6
