...
- (void).cxx_destruct;	// IMP=0x00000000002af336
...
- (unsigned long long)hash;	// IMP=0x00000000002af247
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002af11f
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x00000000002af084
