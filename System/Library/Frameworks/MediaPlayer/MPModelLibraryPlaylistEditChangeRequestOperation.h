...
+ (id)requiredPlaylistEntryProperties;	// IMP=0x00600000001a1ac7
- (void).cxx_destruct;	// IMP=0x00000000001a3e48
...
- (id)_collaborationTrackEdits;	// IMP=0x00000000001a3a0a
- (_Bool)_isCloudLibraryEnabled;	// IMP=0x00000000001a396d
- (void)execute;	// IMP=0x00000000001a1bcb
