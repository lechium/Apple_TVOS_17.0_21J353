...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x001000000018511a
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000185088
- (void).cxx_destruct;	// IMP=0x0000000000185060
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x000000000018500e
