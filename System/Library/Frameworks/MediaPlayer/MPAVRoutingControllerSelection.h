...
- (void).cxx_destruct;	// IMP=0x0000000000081b17
...
- (id)description;	// IMP=0x0000000000081a64
- (id)initWithRoutes:(id)arg1 selectionOperation:(long long)arg2;	// IMP=0x00000000000819ed
