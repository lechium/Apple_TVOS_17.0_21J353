...
- (id).cxx_construct;	// IMP=0x000000000014ad5c
- (void).cxx_destruct;	// IMP=0x000000000014ad0b
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPModelLibrarySearchRequest *request; // @synthesize request=_request;
- (void)cancel;	// IMP=0x000000000014ac4d
- (void)execute;	// IMP=0x000000000014a0d1
- (id)init;	// IMP=0x000000000014a072
