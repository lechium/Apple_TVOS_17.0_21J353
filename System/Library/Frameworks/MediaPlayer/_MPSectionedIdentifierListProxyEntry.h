...
+ (id)endEntry;	// IMP=0x00100000000639eb
+ (id)startEntry;	// IMP=0x00100000000639ca
...
- (id)trackingEntryResult;	// IMP=0x00000000000639b0
- (id)itemResult;	// IMP=0x00000000000639a8
