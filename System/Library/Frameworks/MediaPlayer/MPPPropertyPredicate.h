...
- (void).cxx_destruct;	// IMP=0x0000000000267ad3
...
- (unsigned long long)hash;	// IMP=0x0000000000267a03
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000267933
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000267875
- (void)copyTo:(id)arg1;	// IMP=0x000000000026777b
- (void)writeTo:(id)arg1;	// IMP=0x000000000026767f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000267672
- (id)dictionaryRepresentation;	// IMP=0x0000000000267566
- (id)description;	// IMP=0x00000000002674b7
@property(nonatomic) _Bool hasComparisonType;
@property(readonly, nonatomic) _Bool hasValue;
@property(readonly, nonatomic) _Bool hasProperty;
- (void)dealloc;	// IMP=0x00000000002673f1
