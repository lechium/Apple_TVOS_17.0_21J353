...
+ (id)allSupportedProperties;	// IMP=0x0060000000227736
- (void).cxx_destruct;	// IMP=0x0000000000227486
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x000000000022726d
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x00000000002271e0
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x000000000022665f
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x000000000022655a
