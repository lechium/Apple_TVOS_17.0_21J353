...
- (void).cxx_destruct;	// IMP=0x00000000001e83a9
...
- (_Bool)_errorIsFairPlayError:(id)arg1;	// IMP=0x00000000001e836b
- (void)requestDidFinish:(id)arg1;	// IMP=0x00000000001e8193
- (void)request:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000001e7f86
- (void)resolveError:(id)arg1;	// IMP=0x00000000001e7da4
- (void)dealloc;	// IMP=0x00000000001e7d3f
- (id)initWithItemID:(unsigned long long)arg1 homeSharingID:(unsigned long long)arg2 rentalID:(unsigned long long)arg3 accountID:(unsigned long long)arg4;	// IMP=0x00000000001e7cc5
