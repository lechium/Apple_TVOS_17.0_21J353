...
- (unsigned long long)hash;	// IMP=0x000000000025522b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025513f
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x00000000002550e4
