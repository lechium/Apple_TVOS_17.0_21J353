...
+ (id)headEntryWithSectionIdentifier:(id)arg1;	// IMP=0x001000000006dd33
- (void).cxx_destruct;	// IMP=0x000000000006dce0
...
- (void)setBranchDepth:(long long)arg1;	// IMP=0x000000000006dbea
- (id)nextEntries;	// IMP=0x000000000006db43
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)initWithPositionKey:(id)arg1 sectionIdentifier:(id)arg2;	// IMP=0x000000000006d9d8
