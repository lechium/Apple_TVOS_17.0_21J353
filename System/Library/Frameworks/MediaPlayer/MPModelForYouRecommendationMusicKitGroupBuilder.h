...
+ (id)allSupportedItemProperties;	// IMP=0x00600000001e128a
+ (id)allSupportedGroupProperties;	// IMP=0x00600000001e118f
- (void).cxx_destruct;	// IMP=0x00000000001df7b0
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001df407
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001df2da
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001df1ad
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001deea6
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001ded6e
