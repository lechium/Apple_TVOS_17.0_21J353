...
+ (id)translatorWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000003d973
+ (id)translatorWithKeyPath:(id)arg1;	// IMP=0x001000000003d938
- (void).cxx_destruct;	// IMP=0x000000000003da2a
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x000000000003d9cb
