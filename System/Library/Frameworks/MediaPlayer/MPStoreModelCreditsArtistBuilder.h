...
+ (id)allSupportedProperties;	// IMP=0x00600000002468dc
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000246a3c
