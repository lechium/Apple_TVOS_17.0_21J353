...
- (void).cxx_destruct;	// IMP=0x000000000019ae6b
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x000000000019abab
- (id)_parsedElements:(id)arg1;	// IMP=0x000000000019a982
- (id)_parsedSectionedCollection;	// IMP=0x000000000019a1e0
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000019a07a
