...
+ (id)personalizedResponseForContentDescriptor:(id)arg1 requestedProperties:(id)arg2;	// IMP=0x006000000018b019
- (void).cxx_destruct;	// IMP=0x00000000001890da
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPStoreLibraryPersonalizationRequest *request; // @synthesize request=_request;
- (void)execute;	// IMP=0x0000000000187d5f
- (void)cancel;	// IMP=0x0000000000187d16
