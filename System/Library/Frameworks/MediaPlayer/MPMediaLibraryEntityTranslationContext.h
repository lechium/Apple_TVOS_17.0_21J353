...
@interface MPMediaLibraryEntityTranslationContext : NSObject
{
    ...
    _Bool _sortUsingAllowedEntityIdentifiers;	// 9 = 0x9
    ...
    NSArray *_propertyFilters;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00000000002e4917
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e4526
