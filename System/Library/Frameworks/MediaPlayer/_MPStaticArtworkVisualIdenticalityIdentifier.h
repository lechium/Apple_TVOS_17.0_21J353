...
- (void).cxx_destruct;	// IMP=0x00000000000c2263
...
- (id)stringRepresentation;	// IMP=0x00000000000c216c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c2119
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c1ff7
