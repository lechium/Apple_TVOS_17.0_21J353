...
- (void).cxx_destruct;	// IMP=0x0000000000265bad
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x0000000000265abd
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x00000000002659cb
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x00000000002656b7
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x00000000002654c1
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x00000000002651af
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x00000000002645e6
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x00000000002638ad
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x00000000002631e3
- (void)_parse;	// IMP=0x0000000000262fe7
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x0000000000262da4
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x0000000000262cc0
