...
- (void).cxx_destruct;	// IMP=0x00000000002264fb
...
- (void)_purge;	// IMP=0x0000000000225f16
- (void)_checkCadence;	// IMP=0x0000000000225f04
- (void)addPayload:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000225dd4
- (id)initWithEventCadence:(double)arg1 maximumLatency:(double)arg2 serverObjectDatabase:(id)arg3 queue:(id)arg4;	// IMP=0x0000000000225cfa
