...
- (void).cxx_destruct;	// IMP=0x00000000001080e1
...
- (id)stringRepresentation;	// IMP=0x0000000000107fea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000107f97
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000107e75
