...
+ (id)allSupportedProperties;	// IMP=0x0060000000168a6d
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000168b3e
