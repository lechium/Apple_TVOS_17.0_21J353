...
- (void).cxx_destruct;	// IMP=0x000000000012441b
- (id)sectionInfo;	// IMP=0x000000000012440a
@property(readonly, nonatomic) id <MPMediaLibraryResultSet> resultSet; // @synthesize resultSet=_resultSet;
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000012432d
- (_Bool)isQueryResultSetInvalidated;	// IMP=0x00000000001242db
- (unsigned long long)count;	// IMP=0x00000000001242be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001242b3
- (id)initWithResultSet:(id)arg1 queryCriteria:(id)arg2 entityType:(long long)arg3 library:(id)arg4;	// IMP=0x0000000000124056
