...
- (void).cxx_destruct;	// IMP=0x00000000002588c4
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x000000000025867d
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000258434
- (void)ingestNotificationName:(id)arg1;	// IMP=0x0000000000258055
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000257ef5
