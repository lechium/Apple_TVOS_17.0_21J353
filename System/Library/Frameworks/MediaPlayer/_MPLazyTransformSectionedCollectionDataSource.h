...
- (void).cxx_destruct;	// IMP=0x000000000005aaa7
...
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x000000000005aa24
- (unsigned long long)numberOfSections;	// IMP=0x000000000005aa0e
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x000000000005a9f8
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x000000000005a97b
- (id)initWithSectionedCollection:(id)arg1 sectionTransform:(CDUnknownBlockType)arg2 itemTransform:(CDUnknownBlockType)arg3;	// IMP=0x000000000005a8b1
