...
+ (id)_createVisualEffectView;	// IMP=0x00600000000af92c
+ (id)_createBackgroundView;	// IMP=0x00600000000af4d1
- (void).cxx_destruct;	// IMP=0x00000000000aea0f
...
- (id)_collectionViewLayout;	// IMP=0x00000000000ae66e
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000ae5b7
- (void)layoutSubviews;	// IMP=0x00000000000ae443
- (id)preferredFocusEnvironments;	// IMP=0x00000000000ae41c
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000ae3ff
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000ae3df
- (void)dealloc;	// IMP=0x00000000000ae38c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ad225
