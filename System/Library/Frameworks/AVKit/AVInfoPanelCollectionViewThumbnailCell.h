...
+ (id)_imageWithColor:(id)arg1 andSize:(struct CGSize)arg2;	// IMP=0x0060000000048e4b
+ (id)_checkmarkImage;	// IMP=0x0060000000048df0
+ (id)_labelFontForCellWithImage;	// IMP=0x0060000000048dd7
- (void).cxx_destruct;	// IMP=0x000000000004841e
- (id)_placeholderImage;	// IMP=0x00000000000482d8
- (void)_updateAppearanceWithAnimationCoordinator:(id)arg1;	// IMP=0x0000000000048156
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000048026
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000047f68
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000047eef
@property(retain, nonatomic) NSString *title;
@property(retain, nonatomic) id <AVImageProxyProtocol> imageProxy;
- (void)_updateImage;	// IMP=0x00000000000475d2
- (void)prepareForReuse;	// IMP=0x0000000000047578
- (void)dealloc;	// IMP=0x000000000004752f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000046344
