...
- (void).cxx_destruct;	// IMP=0x00000000000765fd
...
- (void)setState:(long long)arg1;	// IMP=0x00000000000764fd
- (id)view;	// IMP=0x00000000000764eb
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000007646c
