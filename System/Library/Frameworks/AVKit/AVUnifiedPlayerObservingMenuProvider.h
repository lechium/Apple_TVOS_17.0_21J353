...
- (void).cxx_destruct;	// IMP=0x00000000001316c2
...
- (void)_notifyDelegateOfChanges;	// IMP=0x0000000000131647
- (void)_handleChange:(id)arg1 forMenuElement:(id)arg2;	// IMP=0x0000000000131635
- (void)_startObservingMenuElements:(id)arg1;	// IMP=0x0000000000131390
- (void)_stopObservingMenuElements:(id)arg1;	// IMP=0x00000000001311b0
- (void)prepareForDisplay;	// IMP=0x0000000000131083
@property(readonly, nonatomic) NSArray *menuElements;
- (void)dealloc;	// IMP=0x0000000000131033
- (id)init;	// IMP=0x0000000000130f72
