...
+ (void)setCornerRadius:(double)arg1;	// IMP=0x00400000000ec76d
+ (double)cornerRadius;	// IMP=0x00400000000ec75f
- (void).cxx_destruct;	// IMP=0x00000000000ec72e
...
- (struct CGSize)contentSizeForWidth:(double)arg1;	// IMP=0x00000000000ec672
- (void)loadView;	// IMP=0x00000000000ebf6f
