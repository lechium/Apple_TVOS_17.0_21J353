...
- (void).cxx_destruct;	// IMP=0x0000000000061a7f
...
- (void)didFinishAnimations:(_Bool)arg1;	// IMP=0x00000000000618c7
- (void)performCoordinatedAnimations;	// IMP=0x000000000006172f
- (void)addCoordinatedAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000615f4
- (id)init;	// IMP=0x0000000000061557
