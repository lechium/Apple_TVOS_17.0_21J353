...
+ (id)airMessageParser;	// IMP=0x0040000000083a6f
- (void).cxx_destruct;	// IMP=0x00000000000825a5
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000008230f
- (id)init;	// IMP=0x0000000000082150
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x000000000008206f
