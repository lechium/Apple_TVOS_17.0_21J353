...
+ (id)menuProviderWithTitle:(id)arg1 image:(id)arg2;	// IMP=0x0010000000100366
+ (id)inlineMenuProviderWithTitle:(id)arg1;	// IMP=0x0010000000100315
- (void).cxx_destruct;	// IMP=0x00000000001002cc
...
- (_Bool)matchesMenu:(id)arg1;	// IMP=0x0000000000100096
@property(readonly, nonatomic) NSArray *children;
- (void)prepareForDisplay;	// IMP=0x0000000000100063
@property(readonly, nonatomic) NSArray *menuElements;
- (id)initWithTitle:(id)arg1 image:(id)arg2 menuOptions:(unsigned long long)arg3;	// IMP=0x00000000000fff44
