...
@interface AVTheme : NSObject
{
    ...
    UIColor *_transportBarLivePlaybackColor;	// 232 = 0xe8
    id <AVUnifiedPlayerInfoPanelDescriptionTheme> _infoPanelDescriptionTheme;	// 240 = 0xf0
    id <AVUnifiedPlayerInfoPanelNavigationTheme> _infoPanelNavigationTheme;	// 248 = 0xf8
    id <AVUnifiedPlayerContextMenuTheme> _contextMenuTheme;	// 256 = 0x100
    id <AVUnifiedPlayerPlaybackMetadataTheme> _playbackMetadataTheme;	// 264 = 0x108
    UIImageSymbolConfiguration *_imageSymbolConfigurationForTransportBar;	// 272 = 0x110
}

- (void).cxx_destruct;	// IMP=0x0000000000062208
...
- (id)transportBarSystemImage:(id)arg1;	// IMP=0x0000000000061fea
@property(readonly, nonatomic) UIFont *infoPanelImageListItemFont;
- (id)initWithStyle:(unsigned long long)arg1;	// IMP=0x0000000000061aa7
