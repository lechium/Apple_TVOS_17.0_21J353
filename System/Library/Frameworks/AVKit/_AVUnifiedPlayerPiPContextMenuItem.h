...
+ (id)moveItem;	// IMP=0x001000000010e729
+ (id)swapItem;	// IMP=0x001000000010e652
+ (id)stopItem;	// IMP=0x001000000010e57b
- (void).cxx_destruct;	// IMP=0x000000000010e548
...
- (id)initWithTitle:(id)arg1 image:(id)arg2;	// IMP=0x000000000010e46a
- (_Bool)updateImageToPictureInPictureQuadrant:(long long)arg1;	// IMP=0x000000000010e3a4
