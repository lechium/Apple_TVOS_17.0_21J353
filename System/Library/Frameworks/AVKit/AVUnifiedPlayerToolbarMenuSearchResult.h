...
+ (id)searchResultForMenu:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0060000000009a01
+ (id)searchResultForPiPMenuAtIndex:(unsigned long long)arg1;	// IMP=0x00600000000099d0
...
- (id)initWithMenu:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0000000000009923
