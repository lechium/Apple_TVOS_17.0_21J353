...
- (void).cxx_destruct;	// IMP=0x00000000000b5a2a
...
- (void)_didSelectItemAtIndexPath:(id)arg1;	// IMP=0x00000000000b58d8
- (id)mediaOptionAtIndexPath:(id)arg1;	// IMP=0x00000000000b57ad
- (void)collectionView:(id)arg1 didDeselectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000b5763
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000b56ec
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x00000000000b56a8
- (void)viewDidLoad;	// IMP=0x00000000000b55ed
