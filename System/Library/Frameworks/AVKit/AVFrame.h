...
- (void).cxx_destruct;	// IMP=0x0000000000016b17
...
- (unsigned long long)estimatedSizeOfImageInMemory;	// IMP=0x0000000000016a73
- (id)description;	// IMP=0x00000000000169c4
- (id)initWithImage:(id)arg1 actualTime:(double)arg2 frameIndex:(long long)arg3;	// IMP=0x0000000000016936
