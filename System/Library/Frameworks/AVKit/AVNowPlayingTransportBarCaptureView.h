...
+ (Class)layerClass;	// IMP=0x00600000000aa2e8
- (void).cxx_destruct;	// IMP=0x00000000000aa23d
...
- (void)layoutSubviews;	// IMP=0x00000000000aa10c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a9f49
