...
- (void).cxx_destruct;	// IMP=0x000000000002fd99
...
- (id)debugDescription;	// IMP=0x000000000002f976
- (id)_descriptionOfBooleanProperty:(id)arg1;	// IMP=0x000000000002f8d2
- (id)_descriptionOfTrueBooleanProperty:(id)arg1;	// IMP=0x000000000002f833
@property(readonly, getter=isOffOptionAvailableForSubtitles) _Bool offOptionAvailableForSubtitles;
- (id)init;	// IMP=0x000000000002f70b
