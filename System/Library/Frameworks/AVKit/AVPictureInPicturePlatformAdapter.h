...
+ (id)stopPictureInPictureButtonImageName;	// IMP=0x0010000000128313
+ (id)startPictureInPictureButtonImageName;	// IMP=0x0010000000128306
+ (_Bool)isPictureInPictureSupported;	// IMP=0x00100000001282fe
+ (id)imageSymbolConfiguration;	// IMP=0x00100000001282f6
- (void).cxx_destruct;	// IMP=0x00000000001284ce
...
- (void)updateLayoutDependentBehaviors;	// IMP=0x0000000000128342
- (void)stopPictureInPictureAndRestoreUserInterface:(_Bool)arg1;	// IMP=0x000000000012833c
- (void)startPictureInPicture;	// IMP=0x0000000000128336
- (id)initWithSource:(id)arg1;	// IMP=0x0000000000128328
- (_Bool)isPictureInPicturePossible;	// IMP=0x0000000000128320
- (void)_setRoutingVideoToHostedWindow:(_Bool)arg1 pictureInPictureViewController:(id)arg2 source:(id)arg3;	// IMP=0x000000000007b8a1
- (void)_updateStatusUsingProposedStatus:(long long)arg1;	// IMP=0x000000000007b090
- (void)_updateStatus;	// IMP=0x000000000007b05f
- (void)_setStatusAndNotifyDelegateIfNeeded:(long long)arg1;	// IMP=0x000000000007af3d
