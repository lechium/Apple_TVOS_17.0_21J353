...
- (void).cxx_destruct;	// IMP=0x00000000000174b5
...
- (void)prefetchForTimes:(id)arg1;	// IMP=0x000000000001730e
- (void)prefetchForTime:(double)arg1;	// IMP=0x0000000000017259
- (void)setExactTimeInterval:(double)arg1;	// IMP=0x0000000000017247
@property(readonly) UIImage *image;
- (long long)desiredFrameIndex;	// IMP=0x0000000000017102
- (_Bool)isExact;	// IMP=0x00000000000170a8
@property(readonly) double actualTimeInterval;
- (id)initWithFrameSet:(id)arg1;	// IMP=0x0000000000016ed8
- (id)init;	// IMP=0x0000000000016ec4
