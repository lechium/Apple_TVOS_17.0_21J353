...
+ (_Bool)_isMenuEmpty:(id)arg1;	// IMP=0x0010000000078d3b
+ (unsigned long long)_typeForMenuElement:(id)arg1;	// IMP=0x0010000000078cbb
- (void).cxx_destruct;	// IMP=0x0000000000078cab
