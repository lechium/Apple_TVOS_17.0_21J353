...
@interface _CTSplicedFontKey : NSObject
{
    ...
    double _lineSpacingOverride;	// 56 = 0x38
    long long _legibilityWeight;	// 64 = 0x40
    unsigned long long _sizeCategory;	// 72 = 0x48
    NSString *_design;	// 80 = 0x50
    double _weight;	// 88 = 0x58
...
- (id)description;	// IMP=0x000000000008a94a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008a6ac
- (unsigned long long)hash;	// IMP=0x000000000008a6a2
- (void)dealloc;	// IMP=0x000000000008a651
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008a646
