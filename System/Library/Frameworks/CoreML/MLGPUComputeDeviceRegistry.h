...
+ (id)sharedRegistry;	// IMP=0x001000000001356f
+ (id)registryWithMetalDeviceObserver:(id)arg1;	// IMP=0x00100000000134eb
- (id).cxx_construct;	// IMP=0x00000000000133bb
- (void).cxx_destruct;	// IMP=0x0000000000013374
...
- (void)registerGPUDevices;	// IMP=0x0000000000012ad5
- (void)dealloc;	// IMP=0x00000000000129f2
- (id)initWithMetalDeviceObserver:(id)arg1;	// IMP=0x0000000000012908
