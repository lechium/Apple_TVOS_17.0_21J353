...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001173a7
- (unsigned long long)hash;	// IMP=0x000000000011732b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011721f
- (id)initWithSize:(struct CGSize)arg1 pixelFormatType:(unsigned int)arg2;	// IMP=0x00000000001171c6
