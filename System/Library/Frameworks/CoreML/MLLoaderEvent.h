...
- (void).cxx_destruct;	// IMP=0x000000000010bf11
...
- (id)numberFromCString:(const char *)arg1;	// IMP=0x000000000010bb84
- (void)extractAndSetModelDetailsFromArchive:(void *)arg1;	// IMP=0x000000000010b021
