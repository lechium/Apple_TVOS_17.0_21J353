...
- (void).cxx_destruct;	// IMP=0x00000000001beac1
@property(readonly, nonatomic) NSEnumerator *labelEnumerator;
- (id)labelAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001bea95
@property(readonly, nonatomic) unsigned long long uniqueLabelCount;
@property(readonly, nonatomic) unsigned long long count;
- (unsigned long long)indexOfLabel:(id)arg1;	// IMP=0x00000000001be9fd
- (id)initWithLabels:(id)arg1;	// IMP=0x00000000001be700
