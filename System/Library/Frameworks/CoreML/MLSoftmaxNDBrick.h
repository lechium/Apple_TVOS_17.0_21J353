...
- (void).cxx_destruct;	// IMP=0x000000000003505a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000034a51
- (_Bool)hasGPUSupport;	// IMP=0x0000000000034a49
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000347d4
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000347be
