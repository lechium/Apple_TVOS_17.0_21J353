...
- (void).cxx_destruct;	// IMP=0x000000000017e584
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000017e2fc
- (_Bool)hasGPUSupport;	// IMP=0x000000000017e2f4
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000017e1bb
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000017e112
