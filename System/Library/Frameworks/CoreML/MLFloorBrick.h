...
@interface MLFloorBrick : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000c2715
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000c2514
- (_Bool)hasGPUSupport;	// IMP=0x00000000000c250c
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000c23d3
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000c23bd
