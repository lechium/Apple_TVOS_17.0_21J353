...
- (void).cxx_destruct;	// IMP=0x00000000000bbfde
...
- (id)unionFeatureProvider;	// IMP=0x00000000000bbcc7
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000bbc27
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFeaturesFrom:(id)arg1 addedToFeaturesFrom:(id)arg2;	// IMP=0x00000000000bbac7
