...
@interface MLSineBrick : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x000000000007a283
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000007a082
- (_Bool)hasGPUSupport;	// IMP=0x000000000007a07a
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000079f41
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000079f2b
