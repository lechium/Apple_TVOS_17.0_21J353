...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000018bf7e
- (_Bool)hasGPUSupport;	// IMP=0x000000000018bf76
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000018bd01
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000018b93c
