...
@interface MLCeilBrick : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000ed1b3
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000ecfb2
- (_Bool)hasGPUSupport;	// IMP=0x00000000000ecfaa
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000ece71
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000ece5b
