...
- (void).cxx_destruct;	// IMP=0x000000000016c697
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000016c02c
- (_Bool)hasGPUSupport;	// IMP=0x000000000016c024
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000016bd57
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000016bac5
