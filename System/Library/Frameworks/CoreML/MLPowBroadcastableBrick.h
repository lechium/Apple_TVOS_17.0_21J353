...
@interface MLPowBroadcastableBrick : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000cdac4
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000cd199
- (_Bool)hasGPUSupport;	// IMP=0x00000000000cd191
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000ccf48
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000ccc45
