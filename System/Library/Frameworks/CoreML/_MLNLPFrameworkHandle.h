...
+ (id)sharedHandle;	// IMP=0x0060000000183605
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001833c0
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000183267
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000183111
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000182fbb
- (void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000182f73
- (void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000182f2e
- (void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000182ee9
- (void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000182ea4
- (id)init;	// IMP=0x0000000000182bf4
