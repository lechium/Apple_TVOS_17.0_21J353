...
- (void).cxx_destruct;	// IMP=0x000000000002316a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000022791
- (_Bool)hasGPUSupport;	// IMP=0x0000000000022789
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000022540
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002223d
