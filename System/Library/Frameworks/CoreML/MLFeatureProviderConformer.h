...
- (void).cxx_destruct;	// IMP=0x000000000003478b
...
- (_Bool)_sequenceConcatConsumesOptionalInputNamed:(id)arg1;	// IMP=0x0000000000034699
- (id)_fabricateFeatureForDescription:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000033b09
- (id)conformFeatures:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000032b40
- (id)initWithFeatureDescriptions:(id)arg1 defaultValues:(id)arg2 usingRank5Mapping:(_Bool)arg3 optionalInputTypes:(id)arg4;	// IMP=0x0000000000032a1c
