...
- (void).cxx_destruct;	// IMP=0x0000000000082ce0
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000082345
- (_Bool)hasGPUSupport;	// IMP=0x000000000008233d
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000820f4
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000081df1
