...
- (void).cxx_destruct;	// IMP=0x000000000002718f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000026fef
- (unsigned long long)hash;	// IMP=0x0000000000026f22
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000026db4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000026c80
- (void)copyTo:(id)arg1;	// IMP=0x0000000000026b9d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000026ae9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000026adc
- (id)dictionaryRepresentation;	// IMP=0x000000000002691b
- (id)description;	// IMP=0x000000000002686c
- (void)clearOneofValuesForKey;	// IMP=0x000000000002680c
- (int)StringAsKey:(id)arg1;	// IMP=0x0000000000026775
- (id)keyAsString:(int)arg1;	// IMP=0x000000000002672d
