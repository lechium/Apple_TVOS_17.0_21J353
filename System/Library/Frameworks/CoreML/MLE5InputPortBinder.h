...
- (void).cxx_destruct;	// IMP=0x000000000002516e
...
- (void)reset;	// IMP=0x00000000000250d5
- (_Bool)copyFeatureValueToPortAndReturnError:(id *)arg1;	// IMP=0x0000000000024f43
- (_Bool)bindMemoryObjectToPort:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000249df
- (id)initWithPort:(struct e5rt_io_port *)arg1 featureDescription:(id)arg2;	// IMP=0x000000000002494e
