...
- (void)reset;	// IMP=0x00000000001829d2
- (_Bool)prepareWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000182884
...
- (void)dealloc;	// IMP=0x00000000001825d8
- (id)initWithPortHandle:(struct e5rt_io_port *)arg1 name:(id)arg2 featureDescription:(id)arg3;	// IMP=0x00000000001824c3
