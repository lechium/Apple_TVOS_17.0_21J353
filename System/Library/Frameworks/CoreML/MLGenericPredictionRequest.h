...
- (void).cxx_destruct;	// IMP=0x0000000000176e28
...
- (void)cancel;	// IMP=0x0000000000176d9a
- (void)submitWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000176b79
- (id)initForModel:(id)arg1 inputFeatures:(id)arg2 options:(id)arg3;	// IMP=0x00000000001768a4
