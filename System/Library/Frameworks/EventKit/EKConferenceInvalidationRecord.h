...
- (void).cxx_destruct;	// IMP=0x00000000001235b2
...
- (void)finishWithURL:(id)arg1 error:(id)arg2;	// IMP=0x00000000001233a6
- (void)generateNewValidURLForOriginalURL:(id)arg1;	// IMP=0x0000000000123057
