...
+ (id)classesForKey;	// IMP=0x006000000004f5b6
- (void).cxx_destruct;	// IMP=0x000000000004f790
@property(copy, nonatomic) CalLocation *calLocation; // @synthesize calLocation=_calLocation;
- (id)createStructuredLocation;	// IMP=0x000000000004f70b
- (id)initWithStructuredLocation:(id)arg1;	// IMP=0x000000000004f676
