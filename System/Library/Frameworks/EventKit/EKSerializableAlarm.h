...
+ (id)classesForKey;	// IMP=0x0060000000128f5a
- (void).cxx_destruct;	// IMP=0x00000000001294e0
...
- (id)createAlarm:(id *)arg1;	// IMP=0x000000000012923e
- (id)initWithAlarm:(id)arg1;	// IMP=0x0000000000129121
