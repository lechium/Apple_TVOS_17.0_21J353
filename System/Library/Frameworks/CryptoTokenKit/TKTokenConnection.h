...
- (void).cxx_destruct;	// IMP=0x000000000002c67b
...
- (void)dealloc;	// IMP=0x000000000002c5c6
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002c503
- (void)invalidate;	// IMP=0x000000000002c4ed
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002c3a2
