...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000033403
- (void).cxx_destruct;	// IMP=0x0000000000033608
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000334ee
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003340b
- (id)initWithTermsOfService:(id)arg1 privacyPolicyText:(id)arg2 privacyPolicyURL:(id)arg3;	// IMP=0x000000000003334b
