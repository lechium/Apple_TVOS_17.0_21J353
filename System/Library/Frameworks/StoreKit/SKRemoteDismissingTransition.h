...
- (void).cxx_destruct;	// IMP=0x0000000000015ed5
...
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000015ea0
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000015e8e
- (void)dismissRemoteViewController:(id)arg1;	// IMP=0x0000000000015d96
- (id)initWithViewController:(id)arg1;	// IMP=0x0000000000015d2e
