...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x001000000000665b
- (void).cxx_destruct;	// IMP=0x0000000000006b8f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000069c3
- (id)copyXPCEncoding;	// IMP=0x0000000000006906
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000066f9
