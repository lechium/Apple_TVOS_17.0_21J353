...
- (void).cxx_destruct;	// IMP=0x00000000000258db
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000025396
- (void)stopListeningForScrollingOfView:(id)arg1;	// IMP=0x00000000000250c6
- (void)findAndListenForScrollingOfView:(id)arg1;	// IMP=0x0000000000024daf
- (void)dealloc;	// IMP=0x0000000000024bbc
- (id)init;	// IMP=0x0000000000024ba8
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000024b2a
