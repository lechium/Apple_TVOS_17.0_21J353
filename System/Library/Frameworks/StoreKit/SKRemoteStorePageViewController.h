...
+ (id)serviceViewControllerInterface;	// IMP=0x001000000003b6b9
+ (id)exportedInterface;	// IMP=0x001000000003b699
...
- (void)showProductPageWithItemIdentifier:(id)arg1;	// IMP=0x000000000003b630
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000003b5a5
