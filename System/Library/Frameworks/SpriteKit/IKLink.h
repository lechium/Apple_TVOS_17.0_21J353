...
- (void).cxx_destruct;	// IMP=0x000000000002cfb9
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002ccad
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002cc4e
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002cb75
