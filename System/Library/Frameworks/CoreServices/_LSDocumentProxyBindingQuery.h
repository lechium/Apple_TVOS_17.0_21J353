...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000c69eb
- (void).cxx_destruct;	// IMP=0x00000000000c6cb8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c6b11
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c69f3
- (unsigned long long)hash;	// IMP=0x00000000000c68e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c66ef
- (_Bool)_requiresDatabaseMappingEntitlement;	// IMP=0x00000000000c66e7
- (void)_enumerateWithXPCConnection:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c5f07
- (id)initWithDocumentProxy:(id)arg1 style:(unsigned char)arg2 handlerRank:(id)arg3;	// IMP=0x00000000000c5e1a
