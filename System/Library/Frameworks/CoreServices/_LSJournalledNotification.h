...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000166024
- (void).cxx_destruct;	// IMP=0x00000000001662f5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000166177
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001660d6
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x000000000016602c
