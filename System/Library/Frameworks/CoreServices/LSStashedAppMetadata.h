...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000278c6
- (void).cxx_destruct;	// IMP=0x0000000000027faa
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x0000000000027b35
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000027a8f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000278ce
