...
@class FSMimic, NSArray, NSSet, NSString, _LSDiskUsage;
...
- (void)getResourceValuesForKeys:(NSSet *)arg1 mimic:(FSMimic *)arg2 preferredLocalizations:(NSArray *)arg3 completionHandler:(void (^)(NSDictionary *, NSSet *, NSError *))arg4;
