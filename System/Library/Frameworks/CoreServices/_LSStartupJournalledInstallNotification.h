...
- (void).cxx_destruct;	// IMP=0x000000000015bb84
...
- (void)dispatchToObserver:(id)arg1 forInstallProgressService:(id)arg2;	// IMP=0x000000000015b9f2
- (id)initWithNotification:(int)arg1 appProxies:(id)arg2 plugins:(_Bool)arg3;	// IMP=0x000000000015b969
