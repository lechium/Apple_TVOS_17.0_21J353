...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000004c938
+ (id)plugInClasses;	// IMP=0x006000000004c8cc
- (void).cxx_destruct;	// IMP=0x000000000004cbd9
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x000000000004cb30
