...
- (void).cxx_destruct;	// IMP=0x00000000000198d8
- (id)nextObject;	// IMP=0x000000000001971f
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x0000000000019417
