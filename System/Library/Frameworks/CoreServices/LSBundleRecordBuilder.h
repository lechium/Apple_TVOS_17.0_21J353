...
@interface LSBundleRecordBuilder
{
    ...
    NSMutableSet *_equivalentBundleIDs;	// 464 = 0x1d0
    ...
    NSDictionary *_localizedNames;	// 720 = 0x2d0
    NSDictionary *_localizedShortNames;	// 728 = 0x2d8
    NSDictionary *_localizedStrings;	// 736 = 0x2e0
    NSDictionary *_unlocalizedNamesWithContext;	// 744 = 0x2e8
...
- (void).cxx_destruct;	// IMP=0x000000000007d445
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007c46d
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x000000000007c394
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007a030
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x0000000000079b49
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x00000000000798e6
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x0000000000078736
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x0000000000076bf0
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x0000000000076981
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x000000000007669d
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x0000000000076534
- (void)parseIconFilenamesFromDict:(id)arg1 forPlatform:(unsigned int)arg2;	// IMP=0x000000000007644e
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x0000000000075e32
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x0000000000075dc4
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x0000000000075c8e
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x0000000000075a02
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x000000000007575d
- (id)_LSKeyTypeMap;	// IMP=0x0000000000075567
- (id)_LSPlistRaritiesMap;	// IMP=0x0000000000075357
- (id)_LSBundleFlagMap;	// IMP=0x0000000000074e49
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x0000000000074c05
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x0000000000074820
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x0000000000074810
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x0000000000074800
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x00000000000747f0
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x00000000000747df
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x00000000000746cd
