...
+ (id)springBoardDeadlockPreventionQueue;	// IMP=0x001000000012fb4a
+ (id)springBoardQueue;	// IMP=0x001000000012fac9
- (void).cxx_destruct;	// IMP=0x000000000012fa80
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012f8c2
- (id)debugDescription;	// IMP=0x000000000012f786
- (void)callWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012f50f
@property(copy) NSDictionary *launchOptions; // @synthesize launchOptions=_launchOptions;
- (void)promptAndCallSpringBoardWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000130a93
- (void)lieWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000130959
- (void)callSpringBoardWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012fbcb
