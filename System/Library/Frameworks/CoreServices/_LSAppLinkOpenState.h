...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004a7cc
- (id).cxx_construct;	// IMP=0x000000000004abda
- (void).cxx_destruct;	// IMP=0x000000000004ab91
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004a904
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004a7d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a6db
- (id)debugDescription;	// IMP=0x000000000004a57a
