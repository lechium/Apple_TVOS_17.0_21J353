...
+ (_Bool)reconstructHighlightFor:(id)arg1;	// IMP=0x006000000032bda7
...
- (void)highlight;	// IMP=0x000000000032b8ea
- (id)initWithTextLine:(id)arg1 inZone:(id)arg2 ofColor:(struct CGColor *)arg3;	// IMP=0x000000000032b897
