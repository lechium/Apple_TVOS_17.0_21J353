...
- (unsigned int)usedGraphicCount;	// IMP=0x00000000000bf6cc
- (void)incrementUsedGraphicCount;	// IMP=0x00000000000bf6bc
- (id)backgroundGraphicAtIndex:(unsigned int)arg1;	// IMP=0x00000000000bf695
- (void)setBackgroundGraphics:(id)arg1;	// IMP=0x00000000000bf59a
- (struct CGColor *)backgroundColor;	// IMP=0x00000000000bf4eb
@property(nonatomic) unsigned int columnCount;
@property(nonatomic) unsigned int rowCount;
- (void)dealloc;	// IMP=0x00000000000bf3e1
- (void)finalize;	// IMP=0x00000000000bf3a3
- (void)dispose;	// IMP=0x00000000000bf2c5
- (id)initWithBounds:(struct CGRect)arg1;	// IMP=0x00000000000bf276
