...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x000000000007116d
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070e4b
- (unsigned char)resolveLocalPromisedData;	// IMP=0x0000000000070d9e
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x0000000000070c74
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x0000000000070b3b
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x0000000000070787
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(unsigned char)arg1;	// IMP=0x000000000007062c
@property(readonly) unsigned char hasLocalPromise;
- (struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x00000000000704d7
- (id)_createXPCData;	// IMP=0x0000000000070482
- (void)setData:(struct __CFData *)arg1;	// IMP=0x00000000000703ec
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x000000000007024d
- (void)dealloc;	// IMP=0x000000000007017d
- (id)initWithFlavorName:(struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x00000000000700e1
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x0000000000108045
