...
- (id).cxx_construct;	// IMP=0x000000000000839a
- (void).cxx_destruct;	// IMP=0x0000000000008347
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000006074
