...
- (void).cxx_destruct;	// IMP=0x000000000141ba63
- (id)init;	// IMP=0x000000000141ba14
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x000000000141b95d
