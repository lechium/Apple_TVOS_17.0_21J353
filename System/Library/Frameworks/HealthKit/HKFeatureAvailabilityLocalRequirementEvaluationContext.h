...
- (void).cxx_destruct;	// IMP=0x0000000000212791
...
- (id)featureStatusForFeatureWithIdentifier:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000212554
- (id)isWatchAppInstalledWithBundleIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000212427
- (id)onboardingRecordForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002122fa
- (id)onboardingEligibilityForFeatureWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002121cd
