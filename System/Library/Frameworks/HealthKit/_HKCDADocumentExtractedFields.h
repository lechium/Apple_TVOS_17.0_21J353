...
- (void).cxx_destruct;	// IMP=0x00000000000beece
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000becf5
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000beaf3
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000bea53
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000be791
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000be729
