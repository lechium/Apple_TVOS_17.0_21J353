...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000053d7
- (void).cxx_destruct;	// IMP=0x0000000000017b10
@property(copy, nonatomic) NSDictionary *collectionIntervals; // @synthesize collectionIntervals=_collectionIntervals;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000015aa81
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002ad8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015aa1c
