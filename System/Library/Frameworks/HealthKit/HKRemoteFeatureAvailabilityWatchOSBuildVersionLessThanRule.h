...
+ (id)ruleIdentifier;	// IMP=0x001000000018b791
- (void).cxx_destruct;	// IMP=0x000000000018b933
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000018b7f7
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000018b79e
