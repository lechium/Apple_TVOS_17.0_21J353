...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001021b3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000102299
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001021bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010210d
