...
+ (id)ruleIdentifier;	// IMP=0x001000000005d7b3
- (void).cxx_destruct;	// IMP=0x000000000005d956
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000005d819
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000005d7c0
