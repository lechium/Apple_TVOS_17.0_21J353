...
+ (id)ruleIdentifier;	// IMP=0x001000000012faa6
- (void).cxx_destruct;	// IMP=0x000000000012fc48
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000012fb0c
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000012fab3
