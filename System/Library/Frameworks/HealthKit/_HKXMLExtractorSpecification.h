...
- (void).cxx_destruct;	// IMP=0x00000000001fda08
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x00000000001fd8cb
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x00000000001fd647
