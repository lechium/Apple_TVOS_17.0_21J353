...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001fafe9
- (void).cxx_destruct;	// IMP=0x00000000001fb372
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001fb190
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001faff1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001faf13
