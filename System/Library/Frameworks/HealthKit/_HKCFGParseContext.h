...
- (void).cxx_destruct;	// IMP=0x0000000000019af1
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019522
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019127
- (void)decrementRecursiveDepth;	// IMP=0x000000000001952c
- (void)incrementRecursiveDepth;	// IMP=0x0000000000019131
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x000000000001867a
