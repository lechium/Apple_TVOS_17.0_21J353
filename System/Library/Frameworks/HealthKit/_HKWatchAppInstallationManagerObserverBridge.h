...
- (void).cxx_destruct;	// IMP=0x000000000026ea07
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)watchAppInstallationManagerDidObserveChange:(id)arg1;	// IMP=0x000000000026e7e0
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000026e775
