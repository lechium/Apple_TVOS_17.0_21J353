...
+ (id)ruleIdentifier;	// IMP=0x00100000000875d9
- (void).cxx_destruct;	// IMP=0x0000000000087bcb
...
- (_Bool)evaluate;	// IMP=0x0000000000087950
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000000875e6
