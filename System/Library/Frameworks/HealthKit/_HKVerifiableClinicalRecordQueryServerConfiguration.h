...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001703a0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000170523
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001703a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017032a
