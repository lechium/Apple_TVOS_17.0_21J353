...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000025b3e8
- (void).cxx_destruct;	// IMP=0x000000000025b644
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000025b520
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000025b3f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025b35a
