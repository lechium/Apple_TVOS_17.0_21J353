...
- (void).cxx_destruct;	// IMP=0x00000000001fd61f
...
- (_Bool)matchesElement:(id)arg1;	// IMP=0x00000000001fd302
- (id)initWithElementName:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001fd249
- (id)initWithTagSpecification:(id)arg1;	// IMP=0x00000000001fcefa
