...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000019bc66
- (void).cxx_destruct;	// IMP=0x000000000019c0db
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019be7f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019bc6e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019bb60
