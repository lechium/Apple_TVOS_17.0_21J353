...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000019adf8
- (void).cxx_destruct;	// IMP=0x000000000019b150
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019aff3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019ae00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019ad52
