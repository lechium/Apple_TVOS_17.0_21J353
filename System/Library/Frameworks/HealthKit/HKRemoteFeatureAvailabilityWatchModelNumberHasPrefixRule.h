...
+ (id)ruleIdentifier;	// IMP=0x001000000014d857
- (void).cxx_destruct;	// IMP=0x000000000014d9a9
@property(retain, nonatomic) NSString *modelNumberPrefix; // @synthesize modelNumberPrefix=_modelNumberPrefix;
- (_Bool)evaluate;	// IMP=0x000000000014d8bd
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000014d864
