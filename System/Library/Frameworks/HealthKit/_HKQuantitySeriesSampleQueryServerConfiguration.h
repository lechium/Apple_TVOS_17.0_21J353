...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000ebc96
- (void).cxx_destruct;	// IMP=0x00000000000ec166
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ebf35
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ebc9e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ebb44
