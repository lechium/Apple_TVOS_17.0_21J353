...
- (void).cxx_destruct;	// IMP=0x000000000015afe6
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000015ae7e
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000015ae13
