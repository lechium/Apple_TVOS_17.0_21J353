...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000006b695
- (void).cxx_destruct;	// IMP=0x000000000006b997
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006b7eb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006b69d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006b5d6
