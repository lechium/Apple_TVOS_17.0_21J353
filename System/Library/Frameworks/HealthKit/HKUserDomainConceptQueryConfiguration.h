...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000d6f18
- (void).cxx_destruct;	// IMP=0x00000000000d717b
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKQueryAnchor *anchor; // @synthesize anchor=_anchor;
@property(copy, nonatomic) NSArray *sortDescriptors; // @synthesize sortDescriptors=_sortDescriptors;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d7057
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d6f20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d6e4c
