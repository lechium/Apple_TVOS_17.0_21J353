...
+ (Class)ruleClassForRawValue:(id)arg1;	// IMP=0x006000000011717c
- (void).cxx_destruct;	// IMP=0x0000000000117935
@property(nonatomic) __weak id <HKRemoteFeatureAvailabilityDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (_Bool)evaluate;	// IMP=0x000000000029da80
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000029da5c
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000117839
