...
+ (id)ruleIdentifier;	// IMP=0x00100000000334e9
- (void).cxx_destruct;	// IMP=0x000000000003363b
@property(retain, nonatomic) NSString *productType; // @synthesize productType=_productType;
- (_Bool)evaluate;	// IMP=0x000000000003354f
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000000334f6
