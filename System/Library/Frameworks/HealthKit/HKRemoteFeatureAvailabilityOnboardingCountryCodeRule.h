...
+ (id)ruleIdentifier;	// IMP=0x00100000001bc150
- (void).cxx_destruct;	// IMP=0x00000000001bc355
@property(retain, nonatomic) NSString *onboardingCountryCode; // @synthesize onboardingCountryCode=_onboardingCountryCode;
- (_Bool)evaluate;	// IMP=0x00000000001bc1c7
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000001bc15d
