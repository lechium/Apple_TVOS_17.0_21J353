...
- (void).cxx_destruct;	// IMP=0x00000000000b444b
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000b441a
- (id)_label;	// IMP=0x00000000000b440d
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x00000000000b43a1
