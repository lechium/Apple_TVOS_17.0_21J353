...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000014b65b
- (void).cxx_destruct;	// IMP=0x000000000014baef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014b895
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014b663
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014b59c
