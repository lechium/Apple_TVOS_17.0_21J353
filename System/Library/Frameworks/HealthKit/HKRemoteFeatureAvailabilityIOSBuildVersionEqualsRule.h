...
+ (id)ruleIdentifier;	// IMP=0x0010000000226c70
- (void).cxx_destruct;	// IMP=0x0000000000226e2f
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x0000000000226cf2
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000226c7d
