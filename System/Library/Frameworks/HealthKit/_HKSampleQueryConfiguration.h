...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000017bdc
- (void).cxx_destruct;	// IMP=0x0000000000011402
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009653f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002024
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000096481
