...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000227df7
- (void).cxx_destruct;	// IMP=0x000000000022812b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000227f88
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000227dff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000227d39
