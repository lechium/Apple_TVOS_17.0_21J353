...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000000912d
- (void).cxx_destruct;	// IMP=0x0000000000017adf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f6969
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002d13
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f687a
