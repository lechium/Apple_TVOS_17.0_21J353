...
- (void).cxx_destruct;	// IMP=0x0000000000172e4b
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000172d3c
- (id)initWithHandle:(id)arg1;	// IMP=0x0000000000172cd1
