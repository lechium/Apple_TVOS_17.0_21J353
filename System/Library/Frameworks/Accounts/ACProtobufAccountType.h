...
- (void).cxx_destruct;	// IMP=0x0000000000057dc3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000057b32
- (unsigned long long)hash;	// IMP=0x00000000000579cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005779b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000575e0
- (void)copyTo:(id)arg1;	// IMP=0x000000000005748c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000057335
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000057328
- (id)dictionaryRepresentation;	// IMP=0x0000000000056bc3
- (id)description;	// IMP=0x0000000000056b14
