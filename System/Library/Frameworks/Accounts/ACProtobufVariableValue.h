...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000060f9
- (unsigned long long)hash;	// IMP=0x0000000000005eba
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005c66
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005a73
- (void)copyTo:(id)arg1;	// IMP=0x00000000000058f2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005775
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005768
- (id)dictionaryRepresentation;	// IMP=0x0000000000004f28
- (id)description;	// IMP=0x0000000000004e79
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x000000000005364e
- (id)initWithObjectValue:(id)arg1;	// IMP=0x00000000000535d5
