...
- (id)bestMoveForActivePlayer;	// IMP=0x0000000000031354
- (_Bool)validateRandomSource;	// IMP=0x00000000000312df
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x0000000000031198
- (void)dealloc;	// IMP=0x000000000003114a
- (id)init;	// IMP=0x00000000000310bf
