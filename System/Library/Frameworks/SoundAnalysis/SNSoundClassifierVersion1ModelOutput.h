...
- (void).cxx_destruct;	// IMP=0x000000000010dc48
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000010db19
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_9:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000010da60
