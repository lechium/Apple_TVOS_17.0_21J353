...
- (id).cxx_construct;	// IMP=0x00000000000ea87b
- (void).cxx_destruct;	// IMP=0x00000000000ea809
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000e9ef7
