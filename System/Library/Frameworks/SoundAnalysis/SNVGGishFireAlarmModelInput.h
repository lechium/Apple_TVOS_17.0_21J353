...
- (void).cxx_destruct;	// IMP=0x0000000000107c70
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000107ac7
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000001079ef
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000001079d8
