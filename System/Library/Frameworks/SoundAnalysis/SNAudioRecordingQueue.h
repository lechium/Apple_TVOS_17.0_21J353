...
- (void).cxx_destruct;	// IMP=0x00000000000e6ed2
- (void)stop;	// IMP=0x00000000000e6ec8
- (_Bool)start;	// IMP=0x00000000000e69db
- (void)dealloc;	// IMP=0x00000000000e68c7
- (id)initWithFormat:(id)arg1 audioQueueConfiguration:(id)arg2 audioSession:(id)arg3 queue:(id)arg4 audioBufferHandler:(CDUnknownBlockType)arg5 interruptionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000000e677b
- (id)init;	// IMP=0x00000000000e6732
