...
@interface SNVGGishFireAlarmModelOutput : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x0000000000107f2c
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000107dab
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000107ca3
