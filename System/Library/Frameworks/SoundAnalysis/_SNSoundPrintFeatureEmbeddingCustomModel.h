...
- (void).cxx_destruct;	// IMP=0x00000000000fb9c3
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000fb8c7
- (id)initWithModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x00000000000fb6ff
