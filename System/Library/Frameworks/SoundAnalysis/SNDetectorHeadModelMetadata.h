...
- (void).cxx_destruct;	// IMP=0x00000000000fec2a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fea54
- (unsigned long long)hash;	// IMP=0x00000000000fe932
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fe66a
