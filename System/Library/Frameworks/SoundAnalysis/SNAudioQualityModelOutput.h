...
- (void).cxx_destruct;	// IMP=0x0000000000113d8e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000113c5f
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFinal_output:(id)arg1 classLabel:(id)arg2;	// IMP=0x0000000000113ba6
