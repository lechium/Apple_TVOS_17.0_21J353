...
- (void).cxx_destruct;	// IMP=0x00000000000c7968
- (void)removeAllRequests;	// IMP=0x00000000000c7826
- (void)removeRequest:(id)arg1;	// IMP=0x00000000000c766b
- (_Bool)addRequest:(id)arg1 withObserver:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000c715c
- (void)setAudioConfiguration:(id)arg1;	// IMP=0x00000000000c6f13
- (id)init;	// IMP=0x00000000000c6582
