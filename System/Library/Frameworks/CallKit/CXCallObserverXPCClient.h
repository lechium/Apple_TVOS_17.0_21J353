...
+ (void)releaseSharedXPCClient;	// IMP=0x001000000004336d
+ (id)sharedXPCClient;	// IMP=0x00100000000432b2
+ (id)sharedXPCClientSemaphore;	// IMP=0x001000000004325f
- (void).cxx_destruct;	// IMP=0x0000000000045021
...
- (oneway void)removeCall:(id)arg1;	// IMP=0x0000000000044f02
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x0000000000044e2d
- (id)_remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1 isSynchronous:(_Bool)arg2;	// IMP=0x0000000000044d87
- (void)_invalidate;	// IMP=0x0000000000044878
- (void)_requestCalls;	// IMP=0x0000000000044517
- (void)_removeCall:(id)arg1;	// IMP=0x0000000000044261
- (void)_addOrUpdateCall:(id)arg1;	// IMP=0x0000000000043f87
- (void)_markAllCallsAsEnded;	// IMP=0x0000000000043d3b
- (void)invalidate;	// IMP=0x0000000000043ce0
- (void)requestTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000043a7a
- (void)removeDelegate:(id)arg1;	// IMP=0x00000000000439e2
- (void)addDelegate:(id)arg1;	// IMP=0x000000000004394a
@property(readonly, copy, nonatomic) NSDictionary *callUUIDToCallMap;
- (void)dealloc;	// IMP=0x00000000000437b5
- (id)_init;	// IMP=0x000000000004344f
- (id)init;	// IMP=0x0000000000043414
