...
- (void).cxx_destruct;	// IMP=0x000000000004e057
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000004de78
- (oneway void)requestVoicemails:(CDUnknownBlockType)arg1;	// IMP=0x000000000004dd6b
- (oneway void)removeVoicemails:(id)arg1;	// IMP=0x000000000004dd02
- (oneway void)addOrUpdateVoicemails:(id)arg1;	// IMP=0x000000000004dc99
...
- (void)dealloc;	// IMP=0x000000000004dae2
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x000000000004d3e0
- (id)init;	// IMP=0x000000000004d3d2
