...
- (void).cxx_destruct;	// IMP=0x0000000000047bf4
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000479f1
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x00000000000478e4
- (oneway void)removeCall:(id)arg1;	// IMP=0x000000000004787b
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x0000000000047812
...
- (void)dealloc;	// IMP=0x00000000000475bd
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000046fae
- (id)init;	// IMP=0x0000000000046fa0
