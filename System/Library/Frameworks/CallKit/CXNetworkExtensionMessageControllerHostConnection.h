...
- (void).cxx_destruct;	// IMP=0x000000000005176b
...
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000000051521
- (void)invalidate;	// IMP=0x00000000000514c1
...
- (void)dealloc;	// IMP=0x00000000000513df
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000050f9e
