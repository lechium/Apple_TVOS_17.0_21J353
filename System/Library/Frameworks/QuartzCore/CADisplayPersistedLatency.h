...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000287471
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000028733b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000028720d
- (id)description;	// IMP=0x0000000000287175
- (void)dealloc;	// IMP=0x0000000000287108
