...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x0000000000022be4
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x00000000000228af
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x00000000000227c2
- (id)initWithResourceDir:(id)arg1;	// IMP=0x0000000000022760
- (void)dealloc;	// IMP=0x00000000000226f3
