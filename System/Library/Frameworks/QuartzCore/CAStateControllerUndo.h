...
- (void)dealloc;	// IMP=0x0000000000026980
- (void)addTransition:(id)arg1;	// IMP=0x0000000000026943
- (void)willAddLayer:(id)arg1;	// IMP=0x000000000002693d
- (void)addElement:(id)arg1;	// IMP=0x0000000000026900
