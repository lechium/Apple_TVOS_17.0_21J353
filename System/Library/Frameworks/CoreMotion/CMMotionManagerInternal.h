...
@interface CMMotionManagerInternal : NSObject
{
    ...
    CDUnknownBlockType fKeyboardMotionHandler;	// 1016 = 0x3f8
    NSOperationQueue *fKeyboardMotionQueue;	// 1024 = 0x400
    struct Dispatcher *fKeyboardMotionDMDispatcher;	// 1032 = 0x408
    double fKeyboardMotionTimestampGravityHidReportPrev;	// 1040 = 0x410
    struct CMVector<float, 3UL> fKeyboardMotionGravityHIDReportPrev;	// 1048 = 0x418
    float fKeyboardMotionGravityDeltaThreshold;	// 1060 = 0x424
    float fKeyboardMotionGravityNotificationFrequency;	// 1064 = 0x428
    struct Dispatcher *fKeyboardMotionDispatcher;	// 1072 = 0x430
    NSOperationQueue *_fDeviceMotionLiteClientQueue;	// 1080 = 0x438
    CDUnknownBlockType _fDeviceMotionLiteFusedHandler;	// 1088 = 0x440
    NSString *_fDeviceMotionLitePhysicalDeviceID;	// 1096 = 0x448
}

- (id).cxx_construct;	// IMP=0x000000000016c843
- (void).cxx_destruct;	// IMP=0x000000000016c7e5
...
- (void)teardownPrivate;	// IMP=0x000000000016c748
- (void)dealloc;	// IMP=0x000000000016c6ee
- (id)init;	// IMP=0x000000000016c3d1
