...
- (void)simulateMotionStateYouthWithState:(long long)arg1;	// IMP=0x00000000001cea20
- (void)simulateMotionState:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x00000000001ce828
- (void)overrideOscarSideband:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x00000000001ce630
- (void)stopActivityUpdatesPrivate;	// IMP=0x00000000001ce489
- (void)startActivityUpdatesWithHandlerPrivate:(CDUnknownBlockType)arg1;	// IMP=0x00000000001ce310
- (void)disconnect;	// IMP=0x00000000001ce2e0
- (void)connect;	// IMP=0x00000000001cd4ca
- (void)dealloc;	// IMP=0x00000000001cd448
- (id)init;	// IMP=0x00000000001cd3fa
