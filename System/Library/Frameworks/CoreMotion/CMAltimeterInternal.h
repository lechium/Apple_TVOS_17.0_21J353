...
- (id).cxx_construct;	// IMP=0x0000000000239f44
- (void).cxx_destruct;	// IMP=0x0000000000239f36
- (void)_stopRelativeAltitudeUpdates;	// IMP=0x0000000000239d8e
- (void)_startRelativeAltitudeUpdates;	// IMP=0x0000000000239bf5
- (void)_querySignificantElevationChangeFromDate:(id)arg1 toDate:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000023933c
- (void)_stopSignificantElevationUpdates;	// IMP=0x000000000023919b
- (void)_startSignificantElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000238fc4
- (void)_stopElevationUpdates;	// IMP=0x0000000000238e03
- (void)_startElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000238c2c
- (void)_teardown;	// IMP=0x0000000000238b9a
- (void)dealloc;	// IMP=0x0000000000238b22
- (id)init;	// IMP=0x00000000002378ec
