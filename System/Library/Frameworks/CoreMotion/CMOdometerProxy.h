...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x000000000016a285
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001699e6
- (void)_stopOdometerUpdates;	// IMP=0x000000000016985d
- (void)_stopOdometerGpsAvailability;	// IMP=0x00000000001696e8
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000168f57
- (void)_startDaemonConnection;	// IMP=0x0000000000168817
- (void)_teardown;	// IMP=0x00000000001687bc
- (void)dealloc;	// IMP=0x0000000000168772
- (id)initWithOdometer:(id)arg1;	// IMP=0x0000000000168690
