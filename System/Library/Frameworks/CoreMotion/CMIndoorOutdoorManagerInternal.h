...
- (void)_lastKnownIndoorOutdoorStateWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000191f0e
- (void)_stopIndoorOutdoorUpdates;	// IMP=0x0000000000191ba8
- (void)_startIndoorOutdoorUpdates;	// IMP=0x00000000001915a9
- (void)_teardown;	// IMP=0x0000000000191520
- (void)dealloc;	// IMP=0x00000000001914de
- (id)init;	// IMP=0x0000000000190f9e
