...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000014e460
...
- (id)description;	// IMP=0x000000000014e571
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014e505
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014e468
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014e40b
- (void)dealloc;	// IMP=0x000000000014e3dc
- (id)initWithLowerBound:(double)arg1 upperBound:(double)arg2 classificationType:(long long)arg3;	// IMP=0x000000000014e381
