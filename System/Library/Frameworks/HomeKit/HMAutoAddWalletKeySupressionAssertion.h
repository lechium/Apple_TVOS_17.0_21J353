...
- (void).cxx_destruct;	// IMP=0x000000000028e00e
...
- (void)invalidate;	// IMP=0x000000000028dd70
- (void)acquireWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000028da47
- (id)initWithHomeManager:(id)arg1 homeUUID:(id)arg2;	// IMP=0x000000000028d972
