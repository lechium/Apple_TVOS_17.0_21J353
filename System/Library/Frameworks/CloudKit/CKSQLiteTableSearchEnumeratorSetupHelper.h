...
- (void).cxx_destruct;	// IMP=0x0000000000074d9c
...
- (void)setupStatement:(id)arg1;	// IMP=0x0000000000074bee
- (void)orderDescendingByProperty:(id)arg1;	// IMP=0x0000000000074b74
- (void)orderAscendingByProperty:(id)arg1;	// IMP=0x0000000000074afa
