...
- (void).cxx_destruct;	// IMP=0x00000000001cccbf
...
- (id)targetDescription;	// IMP=0x00000000001cca7f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001cc8d4
- (unsigned long long)hash;	// IMP=0x00000000001cc844
