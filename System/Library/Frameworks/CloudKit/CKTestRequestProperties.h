...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019be51
- (void).cxx_destruct;	// IMP=0x000000000019d218
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019c131
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019be59
- (id)initWithEquivalencyProperties:(id)arg1;	// IMP=0x000000000019bde6
