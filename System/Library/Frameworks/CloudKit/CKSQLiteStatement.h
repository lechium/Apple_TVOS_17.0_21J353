...
- (void).cxx_destruct;	// IMP=0x00000000001eeda2
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000001ee51b
- (void)invalidate:(id)arg1;	// IMP=0x00000000001ee1a1
