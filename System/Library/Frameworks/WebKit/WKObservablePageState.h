...
- (id).cxx_construct;	// IMP=0x00000000001ed61c
- (void).cxx_destruct;	// IMP=0x00000000001ed5d5
...
- (void)dealloc;	// IMP=0x00000000001ed350
- (id)initWithPage:(void *)arg1;	// IMP=0x00000000001ed28b
