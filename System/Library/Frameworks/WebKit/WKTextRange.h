...
+ (id)textRangeWithState:(_Bool)arg1 isRange:(_Bool)arg2 isEditable:(_Bool)arg3 startRect:(struct CGRect)arg4 endRect:(struct CGRect)arg5 selectionRects:(id)arg6 selectedTextLength:(unsigned long long)arg7;	// IMP=0x006000000082021a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000820521
- (_Bool)isEmpty;	// IMP=0x000000000082050c
- (id)end;	// IMP=0x00000000008204af
- (id)start;	// IMP=0x0000000000820452
- (id)description;	// IMP=0x000000000082036d
- (void)dealloc;	// IMP=0x000000000082032b
- (_Bool)_isRanged;	// IMP=0x0000000000820205
- (_Bool)_isCaret;	// IMP=0x00000000008201f3
