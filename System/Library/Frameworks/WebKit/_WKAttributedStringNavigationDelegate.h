...
- (void)webView:(id)arg1 didFinishNavigation:(id)arg2;	// IMP=0x00000000001f97e5
- (void)webView:(id)arg1 didFailNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x00000000001f97c6
- (void)webView:(id)arg1 didFailProvisionalNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x00000000001f97a7
- (void)webView:(id)arg1 decidePolicyForNavigationAction:(id)arg2 decisionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001f977e
- (void)webViewWebContentProcessDidTerminate:(id)arg1;	// IMP=0x00000000001f9765
- (void)dealloc;	// IMP=0x00000000001f96eb
