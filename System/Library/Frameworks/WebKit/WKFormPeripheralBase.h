...
- (id).cxx_construct;	// IMP=0x000000000041a0d1
- (void).cxx_destruct;	// IMP=0x000000000041a0b1
...
- (_Bool)handleKeyEvent:(id)arg1;	// IMP=0x0000000000419f7e
@property(readonly, nonatomic) NSObject<WKFormControl> *control;
- (id)assistantView;	// IMP=0x0000000000419f5e
- (void)endEditing;	// IMP=0x0000000000419f3c
- (void)beginEditing;	// IMP=0x0000000000419f1a
- (id)initWithView:(id)arg1 control:(void *)arg2;	// IMP=0x0000000000419eb0
