...
- (id).cxx_construct;	// IMP=0x0000000000806344
- (void).cxx_destruct;	// IMP=0x00000000008062d1
- (void)reloadFocusedElementContextView;	// IMP=0x00000000008062b3
- (void)invalidate;	// IMP=0x000000000080626c
@property(readonly, nonatomic) _Bool requiresStrongPasswordAssistance;
@property(copy, nonatomic) NSArray *suggestions;
- (void)endEditing;	// IMP=0x00000000008061a5
...
- (id)initWithContentView:(id)arg1 focusedElementInfo:(id)arg2 requiresStrongPasswordAssistance:(_Bool)arg3;	// IMP=0x0000000000805eae
