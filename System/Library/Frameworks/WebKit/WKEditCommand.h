...
- (id).cxx_construct;	// IMP=0x0000000000394f02
- (void).cxx_destruct;	// IMP=0x0000000000394ee1
- (void *)command;	// IMP=0x0000000000394ed7
- (id)initWithWebEditCommandProxy:(void *)arg1;	// IMP=0x0000000000394e74
