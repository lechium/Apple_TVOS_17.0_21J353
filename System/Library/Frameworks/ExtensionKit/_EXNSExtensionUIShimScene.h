...
- (void).cxx_destruct;	// IMP=0x0000000000009423
@property(retain) UIViewController *viewController; // @synthesize viewController;
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x0000000000009343
- (void)connectToSession:(id)arg1;	// IMP=0x00000000000091a7
- (id)makePrincipalObjectForExtension:(id)arg1;	// IMP=0x00000000000090ad
