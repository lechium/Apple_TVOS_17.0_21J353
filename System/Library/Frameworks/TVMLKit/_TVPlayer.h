...
- (void).cxx_destruct;	// IMP=0x00000000000d6f6c
...
- (void)_present:(_Bool)arg1 andPlay:(_Bool)arg2;	// IMP=0x00000000000d6ad8
- (id)_ikMediaItemForPublicObj:(id)arg1;	// IMP=0x00000000000d6952
- (void)dispatchEvent:(id)arg1 userInfo:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d67bc
- (void)presentWithAnimation:(_Bool)arg1;	// IMP=0x00000000000d6766
- (void)stopObservingEvent:(id)arg1;	// IMP=0x00000000000d66ee
- (void)startObservingEvent:(id)arg1 extraInfo:(id)arg2;	// IMP=0x00000000000d664e
- (void)cleanup;	// IMP=0x00000000000d663c
- (void)scan:(double)arg1;	// IMP=0x00000000000d65de
- (void)setElapsedTime:(double)arg1;	// IMP=0x00000000000d658f
...
- (void)changeToMediaAtIndex:(long long)arg1;	// IMP=0x00000000000d552c
- (void)previous;	// IMP=0x00000000000d54e4
- (void)next;	// IMP=0x00000000000d549c
- (void)stop;	// IMP=0x00000000000d545f
- (void)pause;	// IMP=0x00000000000d5417
- (void)play;	// IMP=0x00000000000d53e1
- (void)present;	// IMP=0x00000000000d53c8
@property(readonly, nonatomic) long long state;
@property(copy, nonatomic) NSDictionary *userInfo;
- (void)reset;	// IMP=0x00000000000d526c
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000d4f65
- (void)dealloc;	// IMP=0x00000000000d4f13
- (id)initWithIKAppPlayer:(id)arg1 navigationController:(id)arg2;	// IMP=0x00000000000d4e0e
- (id)initWithPlayer:(id)arg1;	// IMP=0x00000000000d4ace
