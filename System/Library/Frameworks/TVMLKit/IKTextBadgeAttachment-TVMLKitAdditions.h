...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x003000000009e94d
- (void)tv_setImage:(id)arg1;	// IMP=0x003000000009e6b2
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x003000000009e543
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x003000000009e497
- (id)tv_imageProxy;	// IMP=0x003000000009e486
@end
