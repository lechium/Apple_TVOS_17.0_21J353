...
- (void).cxx_destruct;	// IMP=0x00000000000b2891
...
- (void)_onPan:(id)arg1;	// IMP=0x00000000000b24d2
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000b2441
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000b2374
