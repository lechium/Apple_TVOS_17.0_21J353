...
- (void).cxx_destruct;	// IMP=0x00000000000d88d2
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d7f58
- (id)identifier;	// IMP=0x00000000000d79dd
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x00000000000d7924
