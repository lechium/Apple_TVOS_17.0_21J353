...
- (void).cxx_destruct;	// IMP=0x0000000000077f2a
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x0000000000077bdc
- (long long)_positionFromView:(id)arg1;	// IMP=0x0000000000077bba
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000776be
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000775d2
- (id)preferredFocusEnvironments;	// IMP=0x0000000000077376
- (_Bool)canBecomeFocused;	// IMP=0x000000000007736e
- (void)tv_setShowcaseFactor:(double)arg1;	// IMP=0x0000000000077130
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000007711b
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000076c59
- (void)layoutSubviews;	// IMP=0x000000000007578f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000755d1
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x0000000000074053
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x0000000000072bc1
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000072ab0
