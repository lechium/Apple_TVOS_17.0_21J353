...
- (void).cxx_destruct;	// IMP=0x00000000000292c8
...
- (void)reset;	// IMP=0x000000000002926c
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000028fb1
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000028e5b
- (id)init;	// IMP=0x0000000000028e4d
