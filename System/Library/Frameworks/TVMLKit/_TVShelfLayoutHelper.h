...
- (void).cxx_destruct;	// IMP=0x0000000000099d35
...
- (void)_freeBuffers;	// IMP=0x0000000000099c81
- (void)_compute;	// IMP=0x0000000000098f7e
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000098ee2
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000098ea7
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000098e6c
- (void)dealloc;	// IMP=0x0000000000098e2e
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000098dba
