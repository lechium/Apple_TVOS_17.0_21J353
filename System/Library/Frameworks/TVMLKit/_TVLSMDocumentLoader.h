...
+ (id)sharedInstance;	// IMP=0x006000000003b20f
- (void).cxx_destruct;	// IMP=0x000000000003c105
...
- (void)_updatePriorityForRequest:(id)arg1;	// IMP=0x000000000003be69
- (void)cancelProxy:(id)arg1;	// IMP=0x000000000003bb23
- (void)loadProxy:(id)arg1 onlyIfCached:(_Bool)arg2;	// IMP=0x000000000003b32e
- (id)init;	// IMP=0x000000000003b294
