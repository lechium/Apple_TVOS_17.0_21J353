...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000e3f47
- (void).cxx_destruct;	// IMP=0x00000000000e6071
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000e5c54
- (void)layoutSubviews;	// IMP=0x00000000000e5438
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000e4e7b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000e4e2e
- (double)minimumHeaderWidth;	// IMP=0x00000000000e4ae3
