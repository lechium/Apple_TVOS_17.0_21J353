...
- (void).cxx_destruct;	// IMP=0x00000000000c2112
...
- (id)preferredFocusEnvironments;	// IMP=0x00000000000c1f54
- (void)configureSupplementaryCellLayoutAttributesWithAutomaticInsets:(struct UIEdgeInsets)arg1 sectionIndex:(long long)arg2;	// IMP=0x00000000000c169b
- (void)layoutSubviews;	// IMP=0x00000000000c0e41
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c0bbe
