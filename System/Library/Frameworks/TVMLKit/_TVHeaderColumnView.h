...
- (void).cxx_destruct;	// IMP=0x000000000016c038
@property(nonatomic) double lineSpacing; // @synthesize lineSpacing=_lineSpacing;
@property(copy, nonatomic) NSArray *labelViews; // @synthesize labelViews=_labelViews;
- (void)layoutSubviews;	// IMP=0x000000000016bd7c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000016bb79
