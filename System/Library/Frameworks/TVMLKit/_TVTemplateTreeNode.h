...
- (void).cxx_destruct;	// IMP=0x0000000000029485
...
- (void)addDerivedTemplateNode:(id)arg1;	// IMP=0x00000000000293e5
@property(readonly, copy, nonatomic) NSArray *derivedTemplateNodes;
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2 abstract:(_Bool)arg3;	// IMP=0x0000000000029305
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2;	// IMP=0x00000000000292f0
