...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00600000000507eb
- (void).cxx_destruct;	// IMP=0x0000000000050f49
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000050c87
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000050b85
