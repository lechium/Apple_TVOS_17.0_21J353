...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014ea87
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014e775
- (void).cxx_destruct;	// IMP=0x000000000014fe19
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000014f3ee
- (_Bool)canBecomeFocused;	// IMP=0x000000000014f3e6
