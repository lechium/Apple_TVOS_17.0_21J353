...
- (void).cxx_destruct;	// IMP=0x0000000000154879
...
- (void)animateTransition:(id)arg1;	// IMP=0x000000000015433b
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000015426b
- (id)initWithInlineFrame:(struct CGRect)arg1 playerViewController:(id)arg2;	// IMP=0x00000000001541eb
