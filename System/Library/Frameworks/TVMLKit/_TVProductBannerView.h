...
+ (id)productBannerViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x001000000009a658
- (void).cxx_destruct;	// IMP=0x000000000009bc42
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x000000000009ba41
- (void)layoutSubviews;	// IMP=0x000000000009b11c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000009b10a
- (id)preferredFocusEnvironments;	// IMP=0x000000000009ae39
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009addf
