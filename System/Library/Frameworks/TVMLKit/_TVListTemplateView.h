...
- (void).cxx_destruct;	// IMP=0x00000000000b91e0
...
- (void)layoutSubviews;	// IMP=0x00000000000b81af
@property(readonly, nonatomic) long long listAlignment;
- (void)adjustScrollForListView:(id)arg1;	// IMP=0x00000000000b802f
- (id)preferredFocusEnvironments;	// IMP=0x00000000000b7fb6
- (void)setOverlayBlurOffset:(double)arg1;	// IMP=0x00000000000b7e4c
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000000b78aa
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b77d7
