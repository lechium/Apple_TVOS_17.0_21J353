...
- (void).cxx_destruct;	// IMP=0x00000000000b5a15
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2;	// IMP=0x00000000000b5700
- (void)cancel;	// IMP=0x00000000000b56ea
@property(readonly, nonatomic) GEOMapRegion *boundingRegion;
- (id)traits;	// IMP=0x00000000000b56c6
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000b565b
