...
- (void).cxx_destruct;	// IMP=0x000000000006a264
@property(nonatomic) _Bool needsLayoutOnBoundsChange; // @synthesize needsLayoutOnBoundsChange=_needsLayoutOnBoundsChange;
- (void)setContentsScale:(double)arg1;	// IMP=0x000000000006a0b3
- (void)setMask:(id)arg1;	// IMP=0x0000000000069f91
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000069ceb
- (void)sizeSublayerToBounds:(id)arg1;	// IMP=0x0000000000069c92
