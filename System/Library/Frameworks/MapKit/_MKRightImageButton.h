...
- (void).cxx_destruct;	// IMP=0x00000000000da56a
- (_Bool)isHighlighted;	// IMP=0x00000000000da55a
@property(readonly, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
@property(readonly, nonatomic) _MKUILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000da498
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000da483
@property(retain, nonatomic) UIImage *image;
@property(retain, nonatomic) NSString *title;
- (void)updateConstraints;	// IMP=0x00000000000da14e
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000da0df
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000da026
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000d9c1d
