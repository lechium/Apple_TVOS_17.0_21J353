...
- (void).cxx_destruct;	// IMP=0x00000000000707f6
...
- (id)description;	// IMP=0x000000000007070b
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x0000000000070672
