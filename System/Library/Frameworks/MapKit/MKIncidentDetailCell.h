...
- (void).cxx_destruct;	// IMP=0x000000000016e55e
@property(retain, nonatomic) NSDate *lastUpdated; // @synthesize lastUpdated=_lastUpdated;
@property(retain, nonatomic) UIImage *icon; // @synthesize icon=_icon;
@property(copy, nonatomic) NSString *title; // @synthesize title=_title;
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x000000000016e4d7
- (void)_updateLastUpdatedLabel;	// IMP=0x000000000016e290
@property(copy, nonatomic) NSString *incidentDescription;
- (void)didMoveToWindow;	// IMP=0x000000000016e170
- (void)_contentSizeCategoryDidChange;	// IMP=0x000000000016e0ac
- (void)dealloc;	// IMP=0x000000000016e037
- (void)_updateConstraintValues;	// IMP=0x000000000016df08
- (void)updateConstraints;	// IMP=0x000000000016db89
- (void)_setConstraints;	// IMP=0x000000000016d36d
- (void)infoCardThemeChanged;	// IMP=0x000000000016d20c
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x000000000016cae5
