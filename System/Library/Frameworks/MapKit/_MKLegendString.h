...
- (void).cxx_destruct;	// IMP=0x0000000000174d3f
...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000174d14
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000174c48
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000174b55
- (void)sizeToFit;	// IMP=0x0000000000174a4c
- (void)dealloc;	// IMP=0x0000000000174a06
- (id)init;	// IMP=0x000000000017497c
