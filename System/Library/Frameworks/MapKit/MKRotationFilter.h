...
- (void).cxx_destruct;	// IMP=0x00000000001c8dd3
...
- (_Bool)hasAdditionalSnappingAngle;	// IMP=0x00000000001c8cee
- (void)updateSnappedToNorth;	// IMP=0x00000000001c8af7
- (void)snapToNorthAnimated:(_Bool)arg1 forceTrueNorth:(_Bool)arg2;	// IMP=0x00000000001c891d
- (void)stopRotatingWithFocusPoint:(struct CGPoint)arg1;	// IMP=0x00000000001c88d5
- (void)updateRotationWithFocusPoint:(struct CGPoint)arg1 newValue:(double)arg2;	// IMP=0x00000000001c8628
- (void)startRotatingWithFocusPoint:(struct CGPoint)arg1 withSnapping:(_Bool)arg2;	// IMP=0x00000000001c8513
- (id)initWithMapLayer:(id)arg1;	// IMP=0x00000000001c84af
- (id)init;	// IMP=0x00000000001c8485
