...
- (void).cxx_destruct;	// IMP=0x0000000000152e5b
...
- (void)reset;	// IMP=0x0000000000152b22
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x0000000000152a45
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x0000000000152710
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x00000000001521ad
