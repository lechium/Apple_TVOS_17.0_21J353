...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000cafd7
- (void).cxx_destruct;	// IMP=0x00000000000cb488
...
- (void)setCustomFeature:(id)arg1;	// IMP=0x00000000000cb168
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000cb098
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cafdf
