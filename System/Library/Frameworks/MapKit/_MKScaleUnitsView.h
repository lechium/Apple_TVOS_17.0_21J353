...
@interface _MKScaleUnitsView : UIView
{
    ...
    double _legendMarginLeft;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x00000000001764fe
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001762cd
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x0000000000176007
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x0000000000175a16
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001752d5
- (void)setUnits:(id)arg1;	// IMP=0x000000000017507d
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x0000000000174f72
- (void)clearCaches:(id)arg1;	// IMP=0x0000000000174f55
- (id)init;	// IMP=0x0000000000174d52
