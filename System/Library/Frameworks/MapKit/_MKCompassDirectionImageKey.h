...
- (void).cxx_destruct;	// IMP=0x000000000018835b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001882de
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001881c6
- (unsigned long long)hash;	// IMP=0x0000000000188176
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x00000000001880cc
