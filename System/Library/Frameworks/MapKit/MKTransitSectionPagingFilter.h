...
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x006000000005df7b
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x006000000005df6e
+ (id)defaultFilterForInactiveLines;	// IMP=0x006000000005deed
+ (id)defaultFilterForDepartures;	// IMP=0x006000000005de6c
