...
- (void).cxx_destruct;	// IMP=0x00000000000a1c8a
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000a1b8c
- (void)keyDown:(id)arg1;	// IMP=0x00000000000a1a8c
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000a19cf
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000a18e7
