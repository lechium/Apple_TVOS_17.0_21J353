...
- (void).cxx_destruct;	// IMP=0x0000000000072da9
...
- (void)hoursViewDidUpdate:(id)arg1;	// IMP=0x0000000000072b5d
- (void)_setUpConstraints;	// IMP=0x0000000000072865
- (void)_setUpViewsForPlaceHoursDayRow;	// IMP=0x00000000000727f2
- (id)initWithBusinessHours:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x000000000007272e
