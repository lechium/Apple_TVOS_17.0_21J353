...
- (id).cxx_construct;	// IMP=0x00000000001e967e
- (void).cxx_destruct;	// IMP=0x00000000001e95f6
- (void)flush;	// IMP=0x00000000001e9504
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x00000000001e90d9
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x00000000001e8ea5
- (id)init;	// IMP=0x00000000001e8c6e
