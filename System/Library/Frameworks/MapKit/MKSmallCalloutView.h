...
- (void).cxx_destruct;	// IMP=0x000000000021253c
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x0000000000212513
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000211b25
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000210e12
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000020ffbb
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000020fc80
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x000000000020fa7d
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x000000000020f9de
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x000000000020f9bd
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x000000000020f9ac
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000020f97d
- (void)beginMapsTransitionMovingSideways;	// IMP=0x000000000020f8e8
- (void)reset;	// IMP=0x000000000020f75b
- (void)_updateTransformForMotionEffectDirection:(struct CGPoint)arg1 forSubview:(id)arg2;	// IMP=0x000000000020f388
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x000000000020f222
- (void)dealloc;	// IMP=0x000000000020ee8e
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000020ebe7
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x000000000020d8ab
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020d809
