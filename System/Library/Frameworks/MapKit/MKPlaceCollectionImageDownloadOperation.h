...
- (void).cxx_destruct;	// IMP=0x00000000000d8176
...
- (void)cancel;	// IMP=0x00000000000d8007
- (_Bool)isFinished;	// IMP=0x00000000000d7ff7
- (_Bool)isExecuting;	// IMP=0x00000000000d7fe7
- (void)markOperationAsComplete;	// IMP=0x00000000000d7eaf
- (void)main;	// IMP=0x00000000000d76f4
- (void)start;	// IMP=0x00000000000d7646
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x00000000000d7554
