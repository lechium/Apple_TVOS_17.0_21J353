...
- (id).cxx_construct;	// IMP=0x000000000010d760
- (void).cxx_destruct;	// IMP=0x000000000010d6d4
...
- (void)_updateFromGameController:(id)arg1;	// IMP=0x000000000010d478
- (void)_handleGamepadDirectionalPress:(id)arg1;	// IMP=0x000000000010d30f
- (void)_handleDirectionalPress:(id)arg1;	// IMP=0x000000000010d1c4
- (void)_handlePan:(id)arg1;	// IMP=0x000000000010d07c
- (void)_considerChangingSelection;	// IMP=0x000000000010cb85
- (void)_updateDebugView;	// IMP=0x000000000010c888
@property(readonly, nonatomic) UIView *debugView;
- (id)initWithGestureTargetView:(id)arg1 moreImportantGestureRecognizers:(id)arg2;	// IMP=0x000000000010c15c
- (id)init;	// IMP=0x000000000010c118
