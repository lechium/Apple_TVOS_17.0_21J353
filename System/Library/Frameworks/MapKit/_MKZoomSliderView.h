...
- (void)updateConstraints;	// IMP=0x0000000000093972
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000093920
- (void)didMoveToWindow;	// IMP=0x00000000000937d9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000092997
