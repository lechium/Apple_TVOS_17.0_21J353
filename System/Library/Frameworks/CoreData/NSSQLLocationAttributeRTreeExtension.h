...
- (_Bool)validate:(id *)arg1;	// IMP=0x000000000024e965
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x000000000024e772
...
- (void)dealloc;	// IMP=0x000000000024e698
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000024e428
