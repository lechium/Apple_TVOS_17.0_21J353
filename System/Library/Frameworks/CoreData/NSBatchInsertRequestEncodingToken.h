...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b07c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b43a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b084
- (void)dealloc;	// IMP=0x000000000000b018
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000af69
