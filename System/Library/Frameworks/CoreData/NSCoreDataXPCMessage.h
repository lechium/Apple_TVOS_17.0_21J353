...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000032919
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000032ae8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003299b
- (void)dealloc;	// IMP=0x0000000000032921
