...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000005ea0d
+ (int)migrationDebugLevel;	// IMP=0x006000000005e9f4
- (void)dealloc;	// IMP=0x000000000005ea8f
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x000000000005ea26
