...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002a3de4
- (void)executeEpilogue;	// IMP=0x00000000002a2d8c
- (void)executePrologue;	// IMP=0x00000000002a2d24
- (_Bool)isWritingRequest;	// IMP=0x00000000002a2d1c
- (id)rowCache;	// IMP=0x00000000002a2d0a
- (void)dealloc;	// IMP=0x00000000002a2ba6
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002a29ec
