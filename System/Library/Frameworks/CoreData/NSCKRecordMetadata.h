...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004de73
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x004000000004dce3
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x004000000004b6b0
+ (id)entityPath;	// IMP=0x00400000000483f2
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004d667
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000004d4a7
- (id)createRecordFromSystemFields;	// IMP=0x00000000000485cd
