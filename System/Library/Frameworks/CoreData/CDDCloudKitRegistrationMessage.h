...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001a02c4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a01a0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019ffe8
- (void)dealloc;	// IMP=0x000000000019ff4a
