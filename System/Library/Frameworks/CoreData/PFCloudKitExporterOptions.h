...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025750f
- (id)copy;	// IMP=0x00000000002574c6
- (void)dealloc;	// IMP=0x000000000025746d
- (id)initWithDatabase:(id)arg1 options:(id)arg2;	// IMP=0x00000000002573f4
