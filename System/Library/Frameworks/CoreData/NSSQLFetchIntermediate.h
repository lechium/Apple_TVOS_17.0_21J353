...
- (id)fetchIntermediateForKeypathExpression:(id)arg1;	// IMP=0x000000000019302f
- (id)generateSQLStringInContext:(id)arg1;	// IMP=0x0000000000192a04
- (id)selectIntermediate;	// IMP=0x000000000019210a
- (_Bool)isFunctionScoped;	// IMP=0x000000000019209a
- (id)fetchIntermediate;	// IMP=0x0000000000192091
- (void)dealloc;	// IMP=0x0000000000191fcc
- (id)initWithScope:(id)arg1;	// IMP=0x0000000000191f62
