...
- (void)dealloc;	// IMP=0x00000000000e9c64
- (_Bool)_isDeallocating;	// IMP=0x00000000000e9c3b
- (_Bool)_tryRetain;	// IMP=0x00000000000e9c33
- (unsigned long long)retainCount;	// IMP=0x00000000000e9c26
- (oneway void)release;	// IMP=0x00000000000e9bf8
- (id)retain;	// IMP=0x00000000000e9beb
