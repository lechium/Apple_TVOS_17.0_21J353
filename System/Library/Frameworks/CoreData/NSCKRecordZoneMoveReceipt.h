...
+ (id)countMoveReceiptsInStore:(id)arg1 matchingPredicate:(id)arg2 withManagedObjectContext:(id)arg3 error:(id *)arg4;	// IMP=0x0040000000142256
+ (id)moveReceiptsMatchingRecordIDs:(id)arg1 inManagedObjectContext:(id)arg2 persistentStore:(id)arg3 error:(id *)arg4;	// IMP=0x0040000000141b14
+ (id)entityPath;	// IMP=0x0040000000141a03
- (id)createRecordIDForMovedRecord;	// IMP=0x0000000000141a6c
