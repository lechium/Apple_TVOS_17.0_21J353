...
- (void)executeEpilogue;	// IMP=0x0000000000064ba1
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x0000000000064704
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000000646d6
- (void)executePrologue;	// IMP=0x00000000000646d0
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x000000000006455a
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000000643ec
