...
@interface NSStoreMigrationPolicy : NSObject
{
    ...
    void *_reserved2;	// 136 = 0x88
    void *_reserved3;	// 144 = 0x90
    void *_reserved4;	// 152 = 0x98
}

+ (id)migrationStoreOptionsFromStoreOptions:(id)arg1;	// IMP=0x0060000000209ff1
+ (id)destinationURLForMigrationSourceURL:(id)arg1 createDocumentReplacementDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x006000000020b3d6
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000020b2b3
+ (int)migrationDebugLevel;	// IMP=0x006000000020b29a
- (id)migrateStoreAtURL:(id)arg1 withManager:(id)arg2 metadata:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x000000000020b14a
- (id)createMigrationManagerForSourceModel:(id)arg1 destinationModel:(id)arg2 error:(id *)arg3;	// IMP=0x000000000020afc8
- (id)sourceModelForStoreAtURL:(id)arg1 metadata:(id)arg2 error:(id *)arg3;	// IMP=0x000000000020a77a
- (void)dealloc;	// IMP=0x000000000020a152
