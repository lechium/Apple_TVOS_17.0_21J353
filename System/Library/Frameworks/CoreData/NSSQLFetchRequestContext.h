...
- (void)executeEpilogue;	// IMP=0x00000000002a24b7
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002a23e6
- (void)executePrologue;	// IMP=0x00000000002a226a
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x00000000002a20fa
- (void)visitPredicate:(id)arg1;	// IMP=0x00000000002a20f4
- (id)_createStatement;	// IMP=0x00000000002a1fa6
@property(retain, nonatomic) NSSQLiteStatement *fetchStatement;
- (id)manyToManyPrefetchRequestsForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002a112b
- (id)manyToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002a10f2
- (id)inverseIsToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002a10b9
@property(readonly, nonatomic) NSFetchRequest *request;
- (id)createChildContextForNestedFetchRequest:(id)arg1;	// IMP=0x00000000002a0fdf
- (void)dealloc;	// IMP=0x00000000002a0e83
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002a05d6
