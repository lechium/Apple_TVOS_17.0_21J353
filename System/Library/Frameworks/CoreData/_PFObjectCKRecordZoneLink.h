...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014ccfb
- (void)dealloc;	// IMP=0x000000000014ccb1
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x000000000014cc48
