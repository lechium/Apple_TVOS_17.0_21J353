...
- (void).cxx_destruct;	// IMP=0x00000000002d2122
- (id)description;	// IMP=0x00000000002d1057
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d0e82
- (void)dealloc;	// IMP=0x00000000002d0e13
- (id)initWithStore:(id)arg1;	// IMP=0x00000000002d0dc1
