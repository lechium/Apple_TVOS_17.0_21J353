...
- (void).cxx_destruct;	// IMP=0x00000000002873d1
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x000000000028736c
- (void)applicationDidActivate:(id)arg1;	// IMP=0x000000000028735b
- (void)dealloc;	// IMP=0x00000000002872da
- (id)init;	// IMP=0x0000000000286b78
