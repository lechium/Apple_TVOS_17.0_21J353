...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c61a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c70a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c622
- (void)dealloc;	// IMP=0x000000000000c5d7
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c549
