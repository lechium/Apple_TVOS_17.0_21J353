...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x006000000021f3f6
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x006000000021f3cc
...
- (void)dealloc;	// IMP=0x000000000021f75c
