...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cb94
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cdb5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cb9c
- (void)dealloc;	// IMP=0x000000000000cb30
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000ca03
