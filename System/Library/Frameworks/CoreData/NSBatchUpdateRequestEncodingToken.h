...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000bb1c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000bd59
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000bb24
- (void)dealloc;	// IMP=0x000000000000bab8
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000b7d4
