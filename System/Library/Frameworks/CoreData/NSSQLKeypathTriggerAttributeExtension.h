...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x0000000000253d71
- (_Bool)validate:(id *)arg1;	// IMP=0x00000000002518ad
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000025178d
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002516d8
