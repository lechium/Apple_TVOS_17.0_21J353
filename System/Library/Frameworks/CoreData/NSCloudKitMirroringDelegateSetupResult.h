...
- (void)dealloc;	// IMP=0x00000000002cf433
- (id)initWithRequest:(id)arg1 storeIdentifier:(id)arg2 success:(_Bool)arg3 error:(id)arg4 container:(id)arg5 database:(id)arg6;	// IMP=0x00000000002cf3ba
