...
- (void).cxx_destruct;	// IMP=0x000000000002bef0
...
- (void)_updateDigitViews;	// IMP=0x000000000002bc7b
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000002bc0a
- (void)shakeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ba0e
- (void)_commonInit;	// IMP=0x000000000002b7b7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002b754
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002b6f1
