...
+ (id)v1_0_1;	// IMP=0x00600000000068f0
+ (id)v1_0_0;	// IMP=0x0060000000006884
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000006b66
- (_Bool)isEqualToVersion:(id)arg1;	// IMP=0x0000000000006b4d
- (_Bool)isLessThanVersion:(id)arg1;	// IMP=0x0000000000006b33
- (_Bool)isGreaterThanVersion:(id)arg1;	// IMP=0x0000000000006b19
- (id)initWithVersionString:(id)arg1;	// IMP=0x000000000000695c
