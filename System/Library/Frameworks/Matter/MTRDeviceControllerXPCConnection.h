...
+ (id)connectionWithWorkQueue:(id)arg1 connectBlock:(CDUnknownBlockType)arg2;	// IMP=0x006000000060d605
- (void).cxx_destruct;	// IMP=0x000000000060e951
...
- (void)callSubscriptionEstablishedHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000060e8c2
- (void)handleReportWithController:(id)arg1 nodeId:(unsigned long long)arg2 values:(id)arg3 error:(id)arg4;	// IMP=0x000000000060e589
- (void)deregisterReportHandlersWithController:(id)arg1 nodeID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000060dfa3
- (void)registerReportHandlerWithController:(id)arg1 nodeID:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000060dc8c
- (void)getProxyHandleWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000060d692
- (id)initWithWorkQueue:(id)arg1 connectBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000060d4bf
