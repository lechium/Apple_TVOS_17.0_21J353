...
- (void).cxx_destruct;	// IMP=0x000000000003c977
...
- (void)executionDidBegin;	// IMP=0x000000000003c75f
- (void)_didSaveAccounts:(id)arg1 withResult:(_Bool)arg2 error:(id)arg3;	// IMP=0x000000000003c64a
- (id)initWithUnsavedAccounts:(id)arg1 accountStore:(id)arg2;	// IMP=0x000000000003c51e
- (id)init;	// IMP=0x000000000003c4af
