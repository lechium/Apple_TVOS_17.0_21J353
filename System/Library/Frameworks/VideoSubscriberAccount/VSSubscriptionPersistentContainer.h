...
- (void).cxx_destruct;	// IMP=0x0000000000061754
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000006169b
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000061687
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x0000000000061306
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x0000000000060864
- (void)_removePersistentStore;	// IMP=0x000000000006074b
- (id)init;	// IMP=0x00000000000603f5
