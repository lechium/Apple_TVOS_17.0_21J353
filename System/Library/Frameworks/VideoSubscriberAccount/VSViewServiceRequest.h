...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000215c7
...
- (id)description;	// IMP=0x0000000000021705
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000216ad
- (unsigned long long)hash;	// IMP=0x0000000000021674
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021624
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000215cf
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000021547
- (id)init;	// IMP=0x00000000000214b3
