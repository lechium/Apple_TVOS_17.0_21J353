...
- (void).cxx_destruct;	// IMP=0x0000000000073f14
...
- (void)transitionToDoneState;	// IMP=0x0000000000073d7e
- (void)transitionToFetchingScriptState;	// IMP=0x0000000000073806
- (void)transitionToEnqueueingNextUrlState;	// IMP=0x00000000000735e3
- (void)start;	// IMP=0x0000000000073456
- (id)initWithApp:(id)arg1 urls:(id)arg2;	// IMP=0x0000000000073259
