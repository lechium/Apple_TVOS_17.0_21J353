...
- (void).cxx_destruct;	// IMP=0x000000000006525f
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x0000000000064c3c
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x0000000000064a99
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x0000000000064884
- (id)getResponseHeader:(id)arg1;	// IMP=0x000000000006479c
- (id)getAllResponseHeaders;	// IMP=0x0000000000064595
- (void)abort;	// IMP=0x0000000000064581
- (void)send:(id)arg1;	// IMP=0x0000000000063e90
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x0000000000063ce2
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000063c9e
- (id)init;	// IMP=0x0000000000063bcb
