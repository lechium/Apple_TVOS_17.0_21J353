...
- (id)vs_JSONValueTransformer;	// IMP=0x003000000002a213
...
- (id)vs_propertyListValueTransformer;	// IMP=0x0030000000029b70
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x0030000000029a03
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0030000000029779
@end
