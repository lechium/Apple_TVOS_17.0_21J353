...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000045f45
- (void).cxx_destruct;	// IMP=0x000000000004632e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000461ff
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000045f9e
- (id)init;	// IMP=0x0000000000045f4d
