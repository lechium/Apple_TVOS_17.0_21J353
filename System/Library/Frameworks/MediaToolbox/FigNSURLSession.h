...
- (void)dealloc;	// IMP=0x000000000032689b
- (void)releaseOSTransaction;	// IMP=0x0000000000326874
- (unsigned char)acquireOSTransaction;	// IMP=0x0000000000326836
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x00000000003266b6
- (void)debug;	// IMP=0x000000000032665a
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x0000000000326544
