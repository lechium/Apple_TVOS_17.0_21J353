...
- (void).cxx_destruct;	// IMP=0x00000000001c2603
...
- (_Bool)isExecuting;	// IMP=0x00000000001c258d
- (_Bool)isFinished;	// IMP=0x00000000001c257d
- (void)start;	// IMP=0x00000000001c2489
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001c238c
