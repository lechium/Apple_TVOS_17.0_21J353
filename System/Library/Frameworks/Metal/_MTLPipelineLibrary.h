...
- (id)newRenderPipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b3946
- (id)newComputePipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b390b
- (id)newRenderPipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000b385f
- (id)newComputePipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000b37b3
...
- (void)dealloc;	// IMP=0x00000000000b36c3
- (id)initWithDevice:(id)arg1 pipelineLibraryData:(void *)arg2;	// IMP=0x00000000000b364e
