...
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000007233c
- (id)airData;	// IMP=0x000000000007230e
- (oneway void)release;	// IMP=0x000000000007225c
- (void)dealloc;	// IMP=0x00000000000721b1
- (id)initWithURL:(id)arg1 device:(id)arg2 options:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x0000000000070d8b
- (id)initWithLibrary:(struct MTLLibraryData *)arg1 binaryData:(id)arg2 device:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000070b64
