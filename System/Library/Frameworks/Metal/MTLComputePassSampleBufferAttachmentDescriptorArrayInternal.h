...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000a9ba1
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000a9b22
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000a9aa7
- (void)dealloc;	// IMP=0x00000000000a9a46
