...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000110c8d
- (id)description;	// IMP=0x0000000000110c79
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000110a8d
- (void)dealloc;	// IMP=0x0000000000110a43
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x00000000001109bd
