...
@interface MTLBindingInternal : MTLArgument
{
    ...
    _Bool _argument;	// 96 = 0x60
    _Bool _aliasImplicitImageBlock;	// 97 = 0x61
    _Bool _vertexDescriptorBuffer;	// 98 = 0x62
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001107a4
@property _Bool isUsed;
@property(readonly, getter=isUsed) _Bool used;
@property(readonly, getter=isActive) _Bool active;
@property(readonly, copy) NSString *description;
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000110396
- (id)dataTypeDescription;	// IMP=0x0000000000110385
...
- (void)dealloc;	// IMP=0x0000000000110052
@property(readonly) MTLStructType *structType; // @dynamic structType;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6 typeDescription:(id)arg7;	// IMP=0x000000000010ff8b
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6;	// IMP=0x000000000010fed0
