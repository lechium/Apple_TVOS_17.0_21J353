...
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x0000000000005e4c
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x0000000000005ded
