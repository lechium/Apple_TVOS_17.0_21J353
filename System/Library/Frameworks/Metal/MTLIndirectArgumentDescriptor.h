...
+ (id)indirectArgumentDescriptor;	// IMP=0x006000000009c87a
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x006000000009c807
+ (id)alloc;	// IMP=0x006000000009c7fd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009c872
