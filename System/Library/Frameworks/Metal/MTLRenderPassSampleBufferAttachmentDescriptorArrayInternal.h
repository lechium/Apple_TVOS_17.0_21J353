...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000105aca
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x0000000000105a4b
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000001059d0
- (void)dealloc;	// IMP=0x000000000010596f
