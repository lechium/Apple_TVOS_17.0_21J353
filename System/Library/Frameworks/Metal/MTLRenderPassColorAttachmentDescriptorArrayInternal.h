...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001055b9
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000001054f6
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x000000000010547b
- (void)dealloc;	// IMP=0x00000000001053fe
