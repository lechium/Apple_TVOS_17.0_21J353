...
- (id)description;	// IMP=0x000000000006a4f4
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x000000000006a387
- (id)describe;	// IMP=0x000000000006a2fa
- (void)dealloc;	// IMP=0x000000000006a2b3
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x000000000006a235
