...
- (void).cxx_destruct;	// IMP=0x00000000002adb45
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x00000000002ad9d9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ad8fa
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002ad833
