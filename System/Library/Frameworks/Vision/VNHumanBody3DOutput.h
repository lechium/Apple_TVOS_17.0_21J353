...
- (void).cxx_destruct;	// IMP=0x00000000002607cc
...
- (id)initWithSkeleton:(id)arg1 intrinsics:(CDStruct_8e0628e6)arg2 inputSize:(struct CGSize)arg3;	// IMP=0x00000000002606cc
