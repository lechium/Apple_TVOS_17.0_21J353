...
- (void).cxx_destruct;	// IMP=0x00000000001e00c8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001dfff3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001dff86
