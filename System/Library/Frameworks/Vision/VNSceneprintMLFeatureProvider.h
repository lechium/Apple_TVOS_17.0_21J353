...
- (void).cxx_destruct;	// IMP=0x00000000001bce19
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000001bcd31
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithSceneprint:(id)arg1 dataType:(long long)arg2 forKey:(id)arg3 originalFeatureProvider:(id)arg4;	// IMP=0x00000000001bcb84
