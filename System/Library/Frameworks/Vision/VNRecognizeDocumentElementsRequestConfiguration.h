...
- (void).cxx_destruct;	// IMP=0x0000000000222493
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000222357
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000022226a
