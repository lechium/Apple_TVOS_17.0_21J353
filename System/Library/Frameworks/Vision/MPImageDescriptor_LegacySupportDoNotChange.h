...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001b905f
- (void).cxx_destruct;	// IMP=0x00000000001b902c
...
- (void)dealloc;	// IMP=0x00000000001b8ecb
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001b8bea
- (unsigned long long)serializedLength;	// IMP=0x00000000001b8bca
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b8ba8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b86e1
