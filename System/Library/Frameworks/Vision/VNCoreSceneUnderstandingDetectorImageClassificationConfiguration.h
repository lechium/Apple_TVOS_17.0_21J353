...
- (void).cxx_destruct;	// IMP=0x00000000001f7f4f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f7e3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f7c60
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x00000000001f7aee
