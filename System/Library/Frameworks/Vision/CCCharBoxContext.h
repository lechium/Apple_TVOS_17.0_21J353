...
- (void)releaseAllocations;	// IMP=0x000000000022552b
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x000000000022545f
- (void)dealloc;	// IMP=0x00000000002253ec
- (void)resetBoxBounds;	// IMP=0x00000000002253db
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x00000000002253aa
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000225395
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000225382
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000225372
