...
- (void).cxx_destruct;	// IMP=0x0000000000270dd5
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000270d45
@property(readonly, copy) NSString *description;
@property(readonly) id <MLComputeDeviceProtocol> computeDevice;
@property(readonly) VNProcessingDevice *processingDevice;
- (id)initWithProcessingDevice:(id)arg1;	// IMP=0x0000000000270bf3
