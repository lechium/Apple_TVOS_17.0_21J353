...
- (void).cxx_destruct;	// IMP=0x000000000021d580
- (id)sceneLabelOperationPointsForOriginatingRequestSpecifier:(id)arg1 error:(id *)arg2;	// IMP=0x000000000021d3fb
- (id)initWithInferenceNetworkDescriptor:(id)arg1;	// IMP=0x000000000021d336
