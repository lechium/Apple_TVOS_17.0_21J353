...
- (void).cxx_destruct;	// IMP=0x000000000021ff83
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021fdb9
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000021fcf3
