...
- (void).cxx_destruct;	// IMP=0x00000000000d64d9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d62d9
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000d6242
