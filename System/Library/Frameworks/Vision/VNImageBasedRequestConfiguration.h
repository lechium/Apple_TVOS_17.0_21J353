...
- (void).cxx_destruct;	// IMP=0x0000000000165b32
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001659fb
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001659a9
