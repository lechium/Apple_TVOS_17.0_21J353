...
- (void).cxx_destruct;	// IMP=0x00000000001324d4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001323d7
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001322e4
