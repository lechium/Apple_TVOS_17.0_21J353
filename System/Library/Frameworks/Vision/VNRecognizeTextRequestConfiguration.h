...
- (void).cxx_destruct;	// IMP=0x000000000023b3bd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023b210
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000023b11c
