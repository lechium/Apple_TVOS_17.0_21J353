...
- (void).cxx_destruct;	// IMP=0x000000000004eb49
...
- (id)description;	// IMP=0x000000000004e93b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004e87b
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000004e82c
