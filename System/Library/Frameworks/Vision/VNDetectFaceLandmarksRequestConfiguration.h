...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x0060000000133b2f
- (void).cxx_destruct;	// IMP=0x0000000000133b1c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000133957
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000013389d
