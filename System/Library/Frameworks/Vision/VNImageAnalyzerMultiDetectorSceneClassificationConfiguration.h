...
- (void).cxx_destruct;	// IMP=0x00000000002055c8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000205480
- (unsigned int)labelsListType;	// IMP=0x0000000000205475
- (unsigned int)analysisTypes;	// IMP=0x000000000020546a
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x00000000002052ae
