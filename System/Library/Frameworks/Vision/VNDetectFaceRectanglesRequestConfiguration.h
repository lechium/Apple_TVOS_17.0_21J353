...
- (void).cxx_destruct;	// IMP=0x00000000001f023e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001eff96
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001efe96
