...
- (void).cxx_destruct;	// IMP=0x000000000021fc9e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021fbbf
- (unsigned int)labelsListType;	// IMP=0x000000000021fbb4
- (unsigned int)analysisTypes;	// IMP=0x000000000021fba9
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x000000000021fb52
