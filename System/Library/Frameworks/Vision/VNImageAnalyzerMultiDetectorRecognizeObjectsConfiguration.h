...
- (void).cxx_destruct;	// IMP=0x000000000020d4a6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020d3c2
- (unsigned int)labelsListType;	// IMP=0x000000000020d3b7
- (unsigned int)analysisTypes;	// IMP=0x000000000020d3ac
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x000000000020d35c
