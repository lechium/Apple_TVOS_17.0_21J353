...
- (id).cxx_construct;	// IMP=0x00000000001b9767
- (void).cxx_destruct;	// IMP=0x00000000001b9738
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x00000000001b9230
- (_Bool)ICShouldBeCanceled;	// IMP=0x00000000001b9228
- (void)dealloc;	// IMP=0x00000000001b91ac
- (id)init;	// IMP=0x00000000001b906f
