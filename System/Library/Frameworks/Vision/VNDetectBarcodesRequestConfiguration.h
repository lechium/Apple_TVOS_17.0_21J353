...
- (void).cxx_destruct;	// IMP=0x000000000010a84c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010a706
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000010a674
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x000000000010a504
