...
+ (id)customAttributes;	// IMP=0x0060000000048b20
...
- (id)outputImage;	// IMP=0x0000000000048ea3
- (_Bool)_isIdentity;	// IMP=0x0000000000048e9b
- (id)_kernel;	// IMP=0x0000000000048b00
