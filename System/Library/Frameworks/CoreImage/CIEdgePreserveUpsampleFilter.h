...
+ (id)customAttributes;	// IMP=0x0060000000089fa2
...
- (id)outputImage;	// IMP=0x000000000008a2e4
- (id)_kernelGuideMono;	// IMP=0x000000000008a2c4
- (id)_kernelGuideCombine4;	// IMP=0x000000000008a2a4
- (id)_kernelGuideCombine;	// IMP=0x000000000008a284
- (id)_kernelJointUpsampRG;	// IMP=0x000000000008a264
- (id)_kernelJointUpsamp;	// IMP=0x000000000008a244
