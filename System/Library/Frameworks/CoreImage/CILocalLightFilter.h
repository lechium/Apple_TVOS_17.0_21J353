...
+ (id)customAttributes;	// IMP=0x006000000011dc78
- (id)outputImage;	// IMP=0x000000000011e029
- (id)_polyKernel;	// IMP=0x000000000011e009
- (id)_shadowKernel;	// IMP=0x000000000011dfe9
