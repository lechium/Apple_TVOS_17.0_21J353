...
+ (id)customAttributes;	// IMP=0x0060000000199458
...
- (id)outputImage;	// IMP=0x0000000000199f0f
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000199e6e
- (id)_kernelRH;	// IMP=0x0000000000199e4e
- (id)_kernelH;	// IMP=0x0000000000199e2e
- (id)_kernelC;	// IMP=0x0000000000199e0e
- (id)_kernelBpos;	// IMP=0x0000000000199dee
- (id)_kernelBneg;	// IMP=0x0000000000199dce
- (void)dealloc;	// IMP=0x0000000000199d51
- (_Bool)_isIdentity;	// IMP=0x0000000000199c1b
