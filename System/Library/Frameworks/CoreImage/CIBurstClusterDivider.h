...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001fe8a
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001fe17
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001fd9e
