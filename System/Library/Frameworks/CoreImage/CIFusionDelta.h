...
+ (id)customAttributes;	// IMP=0x00600000000d04db
- (id)outputImage;	// IMP=0x00000000000d0609
- (_Bool)_isIdentity;	// IMP=0x00000000000d05af
- (id)kernel;	// IMP=0x00000000000d04bb
