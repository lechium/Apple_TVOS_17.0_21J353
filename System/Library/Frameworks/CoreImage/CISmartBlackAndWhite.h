...
+ (id)customAttributes;	// IMP=0x0060000000196622
...
- (id)outputImage;	// IMP=0x0000000000196b9e
- (id)_kernel;	// IMP=0x0000000000196b7e
- (id)hueArrayImage:(float *)arg1;	// IMP=0x000000000019646c
- (float *)createHueArray;	// IMP=0x000000000019631f
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x0000000000195ff3
