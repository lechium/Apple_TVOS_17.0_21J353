...
- (_Bool)compute;	// IMP=0x00000000001360b4
- (void)dealloc;	// IMP=0x0000000000136079
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x0000000000135f27
