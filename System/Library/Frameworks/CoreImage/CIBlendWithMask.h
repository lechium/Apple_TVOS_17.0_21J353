...
+ (id)customAttributes;	// IMP=0x0060000000018ff7
...
- (id)outputImage;	// IMP=0x00000000000191c9
- (float)_maskFillColorValue;	// IMP=0x0000000000019138
- (id)_kernelB0;	// IMP=0x0000000000019118
- (id)_kernel;	// IMP=0x00000000000190f8
