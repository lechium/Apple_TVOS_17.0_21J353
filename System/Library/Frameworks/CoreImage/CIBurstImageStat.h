...
- (float *)colorHistogram;	// IMP=0x0000000000039c66
- (long long)compareImageOrder:(id)arg1;	// IMP=0x0000000000039c05
- (long long)compareImageStats:(id)arg1;	// IMP=0x0000000000039bfd
- (float)computeScore:(float)arg1;	// IMP=0x0000000000039ac9
- (unsigned short *)aeMatrix;	// IMP=0x0000000000039abc
- (void)computeAEMatrix:(id)arg1;	// IMP=0x00000000000398e0
- (int)setAEMatrix:(id)arg1;	// IMP=0x000000000003986e
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000039834
- (float)computeImageDistance:(id)arg1;	// IMP=0x00000000000397e5
- (float)computeSmilePercentage;	// IMP=0x00000000000396d9
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000039443
- (float)computeFacialFocusScoreSum;	// IMP=0x0000000000038ed5
- (void)collapseSharpnessGrid;	// IMP=0x0000000000038c06
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x00000000000389c2
- (void)writeGridROI:(id)arg1;	// IMP=0x00000000000388ed
- (int)canRegister;	// IMP=0x00000000000388cc
- (void)computeImageProjections:(id)arg1;	// IMP=0x0000000000038823
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x0000000000037b05
- (void)flagAsGarbage;	// IMP=0x0000000000037ae4
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x00000000000379d7
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x0000000000037733
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x000000000003743f
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x00000000000372c2
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x00000000000372b3
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x000000000003712c
- (void)dealloc;	// IMP=0x000000000003709f
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000036fd9
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x0000000000036f2e
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x0000000000036e82
