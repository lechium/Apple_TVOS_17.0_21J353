...
- (id)featuresInImage:(id)arg1;	// IMP=0x000000000001457b
- (id)featuresInImage:(id)arg1 options:(id)arg2;	// IMP=0x000000000001394d
- (void)dealloc;	// IMP=0x00000000000138f7
- (id)initWithContext:(id)arg1 options:(id)arg2;	// IMP=0x00000000000137b0
