...
@interface CIDepthEffectApplyBlurMap : CIFilter
{
    ...
    NSNumber *inputBestHairQuality;	// 152 = 0x98
    NSString *inputCaptureFolderMiscPath;	// 160 = 0xa0
}

+ (id)customAttributes;	// IMP=0x00600000001c1e8c
...
- (id)outputImage;	// IMP=0x00000000001c27bb
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001c2481
- (id)alterBlurmap;	// IMP=0x00000000001c235c
