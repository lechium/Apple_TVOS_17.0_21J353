...
+ (id)customAttributes;	// IMP=0x00600000001b94c2
...
- (id)outputImage;	// IMP=0x00000000001b9942
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x00000000001b9633
