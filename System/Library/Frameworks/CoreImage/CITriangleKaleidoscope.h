...
+ (id)customAttributes;	// IMP=0x00600000001abdfd
...
- (id)outputImage;	// IMP=0x00000000001ac164
- (id)_geomKernel;	// IMP=0x00000000001ac144
- (id)_colorKernel;	// IMP=0x00000000001ac124
