...
+ (id)customAttributes;	// IMP=0x0060000000147257
- (id).cxx_construct;	// IMP=0x0000000000147af2
...
- (id)outputImage;	// IMP=0x0000000000147984
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x0000000000147651
- (void)computeCameraIntrinsics;	// IMP=0x00000000001474da
