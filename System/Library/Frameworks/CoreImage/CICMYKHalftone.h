...
+ (id)customAttributes;	// IMP=0x006000000003be69
...
- (id)outputImage;	// IMP=0x000000000003b636
- (id)_CICMYK_black;	// IMP=0x000000000003b616
- (id)_CICMYK_yellow;	// IMP=0x000000000003b5f6
- (id)_CICMYK_magenta;	// IMP=0x000000000003b5d6
- (id)_CICMYK_cyan;	// IMP=0x000000000003b5b6
- (id)_CICMYK_convert;	// IMP=0x000000000003b596
- (id)_CIWhite;	// IMP=0x000000000003b576
