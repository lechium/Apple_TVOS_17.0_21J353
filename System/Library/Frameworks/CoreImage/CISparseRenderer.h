...
+ (id)customAttributes;	// IMP=0x0060000000157abb
...
- (id)outputImage;	// IMP=0x0000000000158b3a
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000158a04
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001588ce
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x00000000001587e5
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x00000000001586c8
- (id)baseVecsLUTGenerator;	// IMP=0x000000000015865b
- (id)stepsLUTGenerator;	// IMP=0x00000000001585ee
- (_Bool)_useD2XRenderer;	// IMP=0x00000000001584cd
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x0000000000157c2e
