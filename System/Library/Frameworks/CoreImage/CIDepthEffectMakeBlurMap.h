...
+ (id)customAttributes;	// IMP=0x00600000001b9e1d
...
- (id)outputImage;	// IMP=0x00000000001be9b2
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001bdd39
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x00000000001bc7c5
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x00000000001bc427
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x00000000001bbc39
- (id)blurMapV2:(id)arg1;	// IMP=0x00000000001bbb67
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x00000000001bbaa7
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x00000000001bb698
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x00000000001bb4a6
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x00000000001bae72
- (_Bool)needToRunFaceMask;	// IMP=0x00000000001bad67
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x00000000001babfa
- (id)lensModelParams:(id)arg1;	// IMP=0x00000000001ba9c9
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x00000000001ba776
- (float)intrinsicMatrixFocalLength;	// IMP=0x00000000001ba737
- (struct CGSize)originalShiftMapSize;	// IMP=0x00000000001ba65e
- (id)calibrationData;	// IMP=0x00000000001ba627
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001ba5c7
