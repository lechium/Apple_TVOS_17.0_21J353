...
+ (id)customAttributes;	// IMP=0x006000000019c2fa
...
- (id)outputImage;	// IMP=0x000000000019c934
- (_Bool)_isIdentity;	// IMP=0x000000000019c7c0
- (struct vec2)_scale;	// IMP=0x000000000019c74b
