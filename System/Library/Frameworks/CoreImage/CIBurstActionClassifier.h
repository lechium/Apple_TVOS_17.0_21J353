...
- (_Bool)isBurstAction;	// IMP=0x000000000001fb6e
- (float)predictResult;	// IMP=0x000000000001fa9a
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001fa20
- (void)scaleVector;	// IMP=0x000000000001f8e0
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001f877
- (id)init;	// IMP=0x000000000001f828
