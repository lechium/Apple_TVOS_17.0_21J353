...
+ (id)customAttributes;	// IMP=0x00600000001c4adf
+ (int)getDraftMode:(id)arg1;	// IMP=0x00600000001c91b1
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x00600000001c90da
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x00600000001c9012
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x00600000001c9005
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x00600000001c8ffd
...
- (id)outputImage;	// IMP=0x00000000001c5613
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x00000000001c5337
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001c514f
- (void)prewarm:(id)arg1;	// IMP=0x00000000001c4429
