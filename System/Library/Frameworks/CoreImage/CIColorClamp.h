...
+ (id)customAttributes;	// IMP=0x00600000000418d6
...
- (id)outputImage;	// IMP=0x0000000000041abc
- (id)_kernelAlphaPreserving;	// IMP=0x0000000000041893
- (id)_kernel;	// IMP=0x0000000000041873
