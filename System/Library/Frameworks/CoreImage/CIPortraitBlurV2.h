...
+ (id)customAttributes;	// IMP=0x00600000001596c5
...
- (id)outputImage;	// IMP=0x0000000000159bd2
- (double)effectiveScale;	// IMP=0x0000000000159b3d
- (id)sensorSize;	// IMP=0x0000000000159a17
