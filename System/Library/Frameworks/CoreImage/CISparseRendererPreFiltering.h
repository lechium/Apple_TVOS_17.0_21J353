...
- (id)outputImage;	// IMP=0x000000000015791e
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x00000000001576b9
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x0000000000157251
- (id)_kernel:(_Bool)arg1;	// IMP=0x0000000000157188
