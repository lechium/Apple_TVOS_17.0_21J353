...
- (float)overlapWithSwRect:(struct CGRect)arg1;	// IMP=0x0000000000020449
- (float)overlapWithHwRect:(struct CGRect)arg1;	// IMP=0x0000000000020384
- (struct CGRect)swFaceRect;	// IMP=0x00000000000202c8
- (struct CGRect)hwFaceRect;	// IMP=0x000000000002020c
- (id)init;	// IMP=0x00000000000200fd
