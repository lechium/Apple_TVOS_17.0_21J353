...
+ (id)customAttributes;	// IMP=0x00600000000ce2b2
...
- (id)outputImage;	// IMP=0x00000000000ce8c3
- (id)_geomKernel;	// IMP=0x00000000000ce8a3
- (id)_colorKernel;	// IMP=0x00000000000ce883
