...
- (id)outputImage;	// IMP=0x000000000015aca6
- (id)_ourBlendKernelMetal;	// IMP=0x000000000015ac49
- (id)nonMetalKernelYCC;	// IMP=0x000000000015ac29
- (id)nonMetalKernel;	// IMP=0x000000000015ac09
- (id)_blendKernel:(_Bool)arg1;	// IMP=0x000000000015ab40
