...
+ (id)customAttributes;	// IMP=0x00600000000477ea
...
- (id)outputImage;	// IMP=0x0000000000047f58
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000047e93
- (_Bool)_isIdentity;	// IMP=0x0000000000047ba9
- (id)_kernelRGB;	// IMP=0x00000000000477a7
- (id)_kernel;	// IMP=0x0000000000047787
