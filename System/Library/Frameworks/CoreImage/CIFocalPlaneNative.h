...
+ (id)customAttributes;	// IMP=0x00600000000cfa44
- (id)outputImage;	// IMP=0x00000000000cff87
- (id)_focalPlanePreProcessorKernelPow2;	// IMP=0x00000000000cff67
- (id)_focalPlanePreProcessorKernel;	// IMP=0x00000000000cff47
