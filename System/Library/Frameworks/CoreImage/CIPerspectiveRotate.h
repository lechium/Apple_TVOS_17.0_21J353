...
+ (id)customAttributes;	// IMP=0x00600000001465fa
- (id).cxx_construct;	// IMP=0x0000000000147221
...
- (id)outputImage;	// IMP=0x0000000000146d37
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x0000000000146984
