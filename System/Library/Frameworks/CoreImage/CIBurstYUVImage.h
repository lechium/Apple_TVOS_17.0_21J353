...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x000000000003b50e
- (void)dealloc;	// IMP=0x000000000003b49e
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000003b1f0
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000003b023
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x000000000003aad7
