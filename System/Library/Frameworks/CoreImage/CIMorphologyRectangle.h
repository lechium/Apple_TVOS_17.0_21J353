...
+ (id)customAttributes;	// IMP=0x006000000012d5fd
...
- (id)outputImage;	// IMP=0x000000000012d8cf
- (_Bool)_doMinimum;	// IMP=0x000000000012d8c7
- (_Bool)_isIdentity;	// IMP=0x000000000012d87a
