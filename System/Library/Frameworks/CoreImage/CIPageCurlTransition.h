...
+ (id)customAttributes;	// IMP=0x00600000001326ea
...
- (id)outputImage;	// IMP=0x000000000013093a
- (id)_CIPageCurlTransNoEmap;	// IMP=0x000000000013091a
- (id)_CIPageCurlTransition;	// IMP=0x00000000001308fa
