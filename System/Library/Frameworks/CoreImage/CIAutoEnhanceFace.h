...
- (struct CGRect)faceRect;	// IMP=0x00000000001d4d20
- (id)description;	// IMP=0x00000000001d4ce2
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001d4947
