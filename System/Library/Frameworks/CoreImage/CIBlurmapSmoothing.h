...
+ (id)customAttributes;	// IMP=0x00000000001505df
...
- (id)outputImage;	// IMP=0x0000000000150bf9
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x00000000001507c5
- (id)_kernelV;	// IMP=0x00000000001507a5
- (id)_kernelH;	// IMP=0x0000000000150785
