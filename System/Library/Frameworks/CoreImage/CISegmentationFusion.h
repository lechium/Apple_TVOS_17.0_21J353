...
+ (id)customAttributes;	// IMP=0x00600000001b6fe5
- (id)outputImage;	// IMP=0x00000000001b73ae
- (_Bool)_isIdentity;	// IMP=0x00000000001b7354
- (id)kernel;	// IMP=0x00000000001b6fc5
