...
- (void)dealloc;	// IMP=0x00000000001fc9bc
- (void)_syncCookies;	// IMP=0x00000000001fc946
- (void)registerForPostingNotificationsWithContext:(id)arg1;	// IMP=0x00000000001fc7e1
