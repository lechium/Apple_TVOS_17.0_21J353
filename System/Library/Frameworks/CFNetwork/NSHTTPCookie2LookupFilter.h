...
- (void).cxx_destruct;	// IMP=0x00000000001311d0
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x00000000001307fd
- (long long)_flags;	// IMP=0x00000000001302d8
- (id)initWithCookie:(id)arg1;	// IMP=0x0000000000130144
