...
- (void).cxx_destruct;	// IMP=0x000000000008843f
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008811a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008810f
- (id)description;	// IMP=0x0000000000087f03
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x0000000000087cc6
