...
- (void).cxx_destruct;	// IMP=0x000000000015cf3a
- (id)finish:(int)arg1;	// IMP=0x000000000015cd6c
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015c42f
