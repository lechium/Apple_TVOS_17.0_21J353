...
- (void)dealloc;	// IMP=0x000000000018003b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000180035
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017feda
- (id)init;	// IMP=0x000000000017fea2
