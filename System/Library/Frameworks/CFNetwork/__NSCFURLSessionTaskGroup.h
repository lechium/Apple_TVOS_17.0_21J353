...
- (id)uploadTaskWithStreamedRequest:(id)arg1;	// IMP=0x00000000001c4134
- (id)dataTaskWithRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001c40ba
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x00000000001c4052
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001c4021
- (void)dealloc;	// IMP=0x00000000001c3fd7
