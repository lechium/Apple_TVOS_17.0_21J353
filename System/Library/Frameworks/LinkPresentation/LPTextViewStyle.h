...
- (id)adjustedForString:(id)arg1;	// IMP=0x0000000000048f27
- (void)_adjustForString:(id)arg1;	// IMP=0x0000000000048e46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048cf9
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x0000000000048b4c
