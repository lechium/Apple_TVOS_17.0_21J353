...
+ (id)systemPillButtonStyleForPlatform:(long long)arg1;	// IMP=0x006000000004afce
- (void).cxx_destruct;	// IMP=0x000000000004bb7b
...
- (id)initWithPlatform:(long long)arg1;	// IMP=0x000000000004aee3
