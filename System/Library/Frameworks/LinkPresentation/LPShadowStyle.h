...
+ (id)collaborationPreviewShadow;	// IMP=0x006000000004ab9d
+ (id)cardHeadingIconShadow;	// IMP=0x006000000004aac3
- (void).cxx_destruct;	// IMP=0x000000000004ad21
@property(retain, nonatomic) LPSize *offset; // @synthesize offset=_offset;
@property(retain, nonatomic) UIColor *color; // @synthesize color=_color;
@property(nonatomic) double opacity; // @synthesize opacity=_opacity;
@property(nonatomic) double radius; // @synthesize radius=_radius;
- (id)init;	// IMP=0x000000000004aa75
