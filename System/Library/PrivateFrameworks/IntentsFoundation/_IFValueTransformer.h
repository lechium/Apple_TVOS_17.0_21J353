...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001039
- (void).cxx_destruct;	// IMP=0x0000000000001008
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000000f74
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000000f02
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000000e3b
