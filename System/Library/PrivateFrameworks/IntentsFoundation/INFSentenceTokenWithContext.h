...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0060000000001c7f
- (void).cxx_destruct;	// IMP=0x0000000000001c4c
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x0000000000001b52
