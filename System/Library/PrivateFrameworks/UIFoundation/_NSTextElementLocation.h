...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000084ce0
- (_Bool)isEqualToTextLocation:(id)arg1;	// IMP=0x0000000000084cc7
- (long long)compare:(id)arg1;	// IMP=0x0000000000084c3f
- (void)updateBaseLocation;	// IMP=0x0000000000084b64
- (void)dealloc;	// IMP=0x0000000000084b08
- (id)initWithTextElement:(id)arg1 baseLocation:(id)arg2 offset:(long long)arg3;	// IMP=0x0000000000084a03
