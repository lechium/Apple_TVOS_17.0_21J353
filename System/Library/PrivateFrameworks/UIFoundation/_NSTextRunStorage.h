...
- (void)invalidateElementsInRange:(id)arg1 delta:(long long)arg2;	// IMP=0x00000000000cf82f
- (void)setObject:(id)arg1 forRange:(id)arg2;	// IMP=0x00000000000cf13d
- (id)enumerateObjectsFromLocation:(id)arg1 options:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000ce843
@property(readonly) long long baseIndex;
@property(readonly) id <NSTextLocation> baseLocation;
@property(readonly) _Bool isEmpty;
- (id)description;	// IMP=0x00000000000ce19c
- (void)dealloc;	// IMP=0x00000000000ce141
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000ce040
