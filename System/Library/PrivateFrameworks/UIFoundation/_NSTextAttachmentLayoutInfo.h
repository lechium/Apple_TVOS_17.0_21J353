...
- (void)invalidateAttachmentMeasurements;	// IMP=0x000000000011b3d0
- (void)_invalidateLocations;	// IMP=0x000000000011b3ae
...
- (id)textLayoutFragment;	// IMP=0x000000000011b193
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x000000000011afd2
- (void)_queryLayout;	// IMP=0x000000000011ad21
- (void)dealloc;	// IMP=0x000000000011acc2
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x000000000011ab77
