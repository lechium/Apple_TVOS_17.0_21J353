...
+ (id)handlerForRequest:(id)arg1;	// IMP=0x0010000000009779
+ (id)urlPath;	// IMP=0x0010000000009768
- (void).cxx_destruct;	// IMP=0x000000000000af10
...
- (void)_withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000ae77
...
- (void)_querySendResults;	// IMP=0x000000000000a608
- (void)_queryHandleResults:(id)arg1 error:(id)arg2;	// IMP=0x000000000000a38d
- (void)_queryStart;	// IMP=0x0000000000009f5f
- (void)_requestParse;	// IMP=0x0000000000009b98
- (void)provideResponseData:(CDUnknownBlockType)arg1;	// IMP=0x0000000000009a21
- (int)prepareResponse:(id)arg1;	// IMP=0x00000000000098ee
- (_Bool)validateRequest;	// IMP=0x00000000000097c2
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000965c
- (id)_initWithRequest:(id)arg1;	// IMP=0x00000000000095d9
