...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001b75d
- (void)serverInvalidated:(id)arg1 withError:(id)arg2;	// IMP=0x000000000001b4f8
- (void)_setupQuery;	// IMP=0x000000000001a777
- (void)_stopServer;	// IMP=0x000000000001a620
- (void)_startServer;	// IMP=0x000000000001a3f5
- (_Bool)_shouldRunServer;	// IMP=0x000000000001a1fb
- (void)_updateState;	// IMP=0x000000000001a151
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000019f68
- (id)initWithQueryRunner:(id)arg1;	// IMP=0x0000000000019daa
