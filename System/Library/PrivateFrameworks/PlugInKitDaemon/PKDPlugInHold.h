...
- (void).cxx_destruct;	// IMP=0x000000000000c9e0
...
- (id)description;	// IMP=0x000000000000c780
- (unsigned long long)hash;	// IMP=0x000000000000c730
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c660
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x000000000000c4e0
