...
- (void).cxx_destruct;	// IMP=0x0000000000010c70
...
- (void)stop;	// IMP=0x00000000000107e0
- (void)unholdClient:(id)arg1;	// IMP=0x0000000000010540
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000000010230
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0000000000010190
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x000000000000fea0
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000000f6f0
- (void)removedPlugIns:(id)arg1;	// IMP=0x000000000000f610
- (void)run;	// IMP=0x000000000000f550
- (id)initWithConnection:(id)arg1 queue:(id)arg2 database:(id)arg3 proxyFactory:(id)arg4;	// IMP=0x000000000000f000
- (id)initForService:(const char *)arg1 database:(id)arg2 proxyFactory:(id)arg3;	// IMP=0x000000000000ef30
- (id)init;	// IMP=0x000000000000ee80
- (void)_startSandbox;	// IMP=0x000000000000ee70
