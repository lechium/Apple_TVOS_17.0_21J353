...
- (void).cxx_destruct;	// IMP=0x000000000001bb80
...
- (id)description;	// IMP=0x000000000001b8c0
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x000000000001b860
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x000000000001b7b0
@property(readonly) int pid;
- (void)dead;	// IMP=0x000000000001b6d0
- (void)dying;	// IMP=0x000000000001b680
- (void)dealloc;	// IMP=0x000000000001b640
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000000001ac10
