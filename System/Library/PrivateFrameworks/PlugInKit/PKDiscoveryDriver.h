...
- (void)removeWatchers;	// IMP=0x000000000000c7c0
- (void)installWatchers;	// IMP=0x000000000000c4f0
- (void)cancel;	// IMP=0x000000000000c250
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000bcb0
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000b560
- (void)dealloc;	// IMP=0x000000000000b410
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000af70
