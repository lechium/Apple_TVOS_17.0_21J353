...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00200000007eaac1
@property(readonly, nonatomic) NSURL *px_navigationURL;
- (id)px_navigationURLWithSelectedObject:(id)arg1;	// IMP=0x00200000007ea905
- (id)px_navigationURLComponents;	// IMP=0x00200000007ea7b3
- (id)px_navigationURLQueryItemWithPrefix:(id)arg1;	// IMP=0x00200000007ea678
- (id)px_navigationWellKnownName;	// IMP=0x00200000007ea5d0
- (id)px_navigationURLHost;	// IMP=0x00200000007ea528
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x00200000007ea3b8
- (_Bool)px_fetchIsEmpty;	// IMP=0x00200000007ea33d
- (id)px_fetchContainedAssetCollections;	// IMP=0x00200000007ea280
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x00200000007ea0d9
- (id)px_fetchContainerTitle;	// IMP=0x00200000007e9f82
