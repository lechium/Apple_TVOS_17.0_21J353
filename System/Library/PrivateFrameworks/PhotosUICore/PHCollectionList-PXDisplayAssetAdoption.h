...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x00100000007ed7ff
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x00100000007ec633
+ (id)_isValidGazeRectPredicate;	// IMP=0x00100000007ec52a
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x00100000007ec462
+ (id)px_transientIdentifierForWellKnownFolderName:(id)arg1;	// IMP=0x00100000007ec3f6
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00100000007eb0cc
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x00100000007eafa3
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x00100000007ead9c
- (id)px_navigationWellKnownName;	// IMP=0x00100000007ead26
- (id)px_navigationURLHost;	// IMP=0x00100000007ead19
