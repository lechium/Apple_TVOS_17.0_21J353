...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000dcf4
- (void).cxx_destruct;	// IMP=0x000000000000f438
...
- (unsigned long long)hash;	// IMP=0x000000000000eb89
- (id)populateOrderedInputFeature;	// IMP=0x000000000000e70d
- (id)description;	// IMP=0x000000000000e3dc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000dcfc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000dcac
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d780
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000d511
- (id)initWithBiasEstimatorFeatures:(id)arg1;	// IMP=0x000000000000d189
