...
- (id)calculateDuration:(id)arg1 and:(id)arg2;	// IMP=0x0000000000006061
- (void)setAbsintheConnectionMethodWith:(id)arg1;	// IMP=0x000000000000601a
- (void)setAbsintheAuthenticationTimestampForKey:(id)arg1;	// IMP=0x0000000000005f0b
- (void)reportAbsintheAuthenticationDurations;	// IMP=0x0000000000005b75
- (id)init;	// IMP=0x0000000000005b00
