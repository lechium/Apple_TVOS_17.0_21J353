...
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x0000000000013bfa
- (void)waitUntilComplete;	// IMP=0x0000000000013bf4
- (_Bool)isPurgeable;	// IMP=0x0000000000013bec
- (_Bool)isComplete;	// IMP=0x0000000000013be4
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x0000000000013bb4
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000013b9f
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000013b87
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x0000000000013a36
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x000000000001399c
- (void)makeAliasable;	// IMP=0x00000000000138fe
- (_Bool)isAliasable;	// IMP=0x00000000000138f5
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x000000000001389e
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x00000000000137d3
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x0000000000013737
