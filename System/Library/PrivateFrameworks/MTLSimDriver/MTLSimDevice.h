...
@interface MTLSimDevice : _MTLDevice
{
    ...
    MTLArchitecture *architecture;	// 720 = 0x2d0
}

- (id).cxx_construct;	// IMP=0x0000000000007e95
- (void).cxx_destruct;	// IMP=0x0000000000007e84
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x0000000000007daa
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x0000000000007da2
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x0000000000007d8b
...
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x0000000000007ac4
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x00000000000077b0
- (id)newSharedEventWithOptions:(long long)arg1;	// IMP=0x0000000000007595
- (id)newEventWithOptions:(long long)arg1;	// IMP=0x0000000000007583
- (id)newSharedEvent;	// IMP=0x0000000000007374
- (id)newEvent;	// IMP=0x0000000000007362
...
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x000000000000733e
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000007336
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000007315
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000072f4
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000072d0
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000072ac
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000007288
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000007267
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x00000000000070ff
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000006f3b
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x0000000000006f0e
- (_Bool)setResourcesPurgeableState:(id *)arg1 newState:(unsigned long long)arg2 oldState:(unsigned long long *)arg3 count:(int)arg4;	// IMP=0x0000000000006f06
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000006d80
- (id)vendorName;	// IMP=0x0000000000006d73
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x0000000000006d5d
- (int)llvmVersion;	// IMP=0x0000000000006d52
- (id)productName;	// IMP=0x0000000000006d45
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 offset:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5;	// IMP=0x0000000000006d21
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned long long)arg5 bytesPerRow:(unsigned long long)arg6;	// IMP=0x0000000000006cfd
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000006cd9
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x0000000000006cb5
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000006c91
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x0000000000006a16
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x00000000000067c6
- (id)familyName;	// IMP=0x00000000000067b9
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(id)arg2 errorMessage:(id *)arg3;	// IMP=0x00000000000064de
- (id)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x00000000000064c7
- (id)wrapComputeState:(id)arg1 descriptor:(id)arg2;	// IMP=0x00000000000064a3
- (id)pipelinePerformanceStatisticsWithComputeVariant:(id)arg1 compileTimeOutput:(id)arg2;	// IMP=0x0000000000006434
- (id)pipelinePerformanceStatisticsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 vertexCompileTimeOutput:(id)arg3 fragmentCompileTimeOutput:(id)arg4;	// IMP=0x000000000000631b
- (CDStruct_9028b892)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2;	// IMP=0x0000000000006313
- (id)newRenderPipelineWithDescriptor:(id)arg1 vertexVariant:(id)arg2 fragmentVariant:(id)arg3 errorMessage:(id *)arg4;	// IMP=0x0000000000006093
- (id)newVertexVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x000000000000607c
- (id)newFragmentVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000006065
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000005d91
- (id)reportLeaks;	// IMP=0x0000000000005cb1
- (void)freeVertexFunctionKey:(void *)arg1 vertexKeySize:(unsigned long long)arg2;	// IMP=0x0000000000005cab
- (void)freeFragmentFunctionKey:(void *)arg1 fragmentKeySize:(unsigned long long)arg2;	// IMP=0x0000000000005ca5
- (void *)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 nextStageVariant:(id)arg3 vertexKeySize:(unsigned long long *)arg4;	// IMP=0x0000000000005c96
- (void *)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 previousStateVariant:(id)arg3 fragmentKeySize:(unsigned long long *)arg4;	// IMP=0x0000000000005c87
- (id)wrapRenderState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000005c63
- (void)registerViewTexture:(id)arg1 baseTextureView:(id)arg2;	// IMP=0x0000000000005c5d
@property(readonly) _Bool deserializerSupportsSharedTextures;
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x0000000000005813
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x00000000000054e3
- (id)_fixUpSwizzleForTexture:(id)arg1 key:(unsigned int)arg2;	// IMP=0x00000000000053a4
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000005256
- (void)dispatchNotificationWithReference:(unsigned int)arg1;	// IMP=0x0000000000005135
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(unsigned long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000000005058
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000005034
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x0000000000004dc3
- (id)newFence;	// IMP=0x0000000000004b31
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x00000000000049e3
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000049ba
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x000000000000498c
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000004957
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004699
- (void)releaseCommandBufferRef:(unsigned int)arg1;	// IMP=0x00000000000045e5
- (unsigned int)registerCommandBuffer:(id)arg1;	// IMP=0x0000000000004452
- (id)commandBufferForReference:(unsigned int)arg1;	// IMP=0x00000000000042e5
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x000000000000406d
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x0000000000004030
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000003e99
- (unsigned int)getNewResourceID;	// IMP=0x0000000000003e86
- (id)compiler;	// IMP=0x0000000000003d5d
- (id)_deviceWrapper;	// IMP=0x0000000000003d33
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x0000000000003d22
- (void)dealloc;	// IMP=0x0000000000003c29
- (id)init;	// IMP=0x000000000000330c
...
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x0000000000002f8c
