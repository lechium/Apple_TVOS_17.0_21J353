...
- (id)pipelineBinaries;	// IMP=0x000000000001372a
- (unsigned long long)imageblockMemoryLengthForDimensions:(CDStruct_da2e99ad)arg1;	// IMP=0x0000000000013722
@property(readonly) unsigned long long imageblockSampleLength;
- (unsigned int)getVertexShaderTelemetryID;	// IMP=0x0000000000013712
- (unsigned int)getFragmentShaderTelemetryID;	// IMP=0x000000000001370a
- (id)newVertexShaderDebugInfo;	// IMP=0x0000000000013702
- (id)newFragmentShaderDebugInfo;	// IMP=0x00000000000136fa
- (unsigned int)pipelineRef;	// IMP=0x00000000000136ea
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (void)dealloc;	// IMP=0x0000000000013483
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x0000000000013418
