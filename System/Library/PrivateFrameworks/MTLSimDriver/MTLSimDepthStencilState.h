...
- (unsigned int)depthStencilRef;	// IMP=0x0000000000013408
- (void)dealloc;	// IMP=0x000000000001333e
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x00000000000132f6
