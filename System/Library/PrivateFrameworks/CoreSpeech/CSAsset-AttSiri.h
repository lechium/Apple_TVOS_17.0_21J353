...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0020000000016c2c
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0020000000016bba
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x0020000000016b4d
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0020000000016adb
...
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x001000000000a9e6
- (_Bool)isJSVoiceTrigger:(id)arg1;	// IMP=0x001000000000a93b
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x001000000000a882
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x001000000000a860
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x001000000000a7ae
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x001000000000a6fc
...
- (id)nldaConfigFile;	// IMP=0x001000000000a55d
...
- (id)mitigatonConfigFile;	// IMP=0x001000000000a3fe
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000015fee
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000012b6e
- (id)_userSelectedPhraseTypeToRTModelPhraseType:(id)arg1;	// IMP=0x001000000005c294
- (_Bool)_allowMultiPhrase:(id)arg1 forceSkipEngineVersionCheck:(_Bool)arg2;	// IMP=0x001000000005c0d7
- (id)_rtModelWithRequestOptions:(id)arg1 accessoryBlobs:(id)arg2;	// IMP=0x001000000005bdeb
- (id)_getFilteredAccessoryRTBlobListForRequestOptions:(id)arg1 accessoryBlobs:(id)arg2 forceSkipEngineVersionCheck:(_Bool)arg3;	// IMP=0x001000000005bbee
- (id)_splitBlobsByPhraseType:(id)arg1;	// IMP=0x001000000005b7ef
- (id)_buildRTModelWithBlobConfig:(id)arg1 requestOptions:(id)arg2;	// IMP=0x001000000005b1c7
- (id)_sha256:(id)arg1;	// IMP=0x001000000005b10f
- (id)_sha1:(id)arg1;	// IMP=0x001000000005b024
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000005ae23
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000005adef
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000005add6
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000005adbd
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000005ada4
- (id)hearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000005ad92
- (id)rtModelWithRequestOptions:(id)arg1;	// IMP=0x001000000005ab9d
- (id)latestHearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000005a6c6
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000005a660
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000005a5d7
...
- (long long)multiUserDeltaScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000092e6f
@property(readonly, nonatomic) long long multiUserConfidentScoreThreshold;
- (long long)multiUserConfidentScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000092d33
@property(readonly, nonatomic) long long multiUserHighScoreThreshold;
- (long long)multiUserHighScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000092bf7
@property(readonly, nonatomic) long long multiUserLowScoreThreshold;
- (long long)multiUserLowScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000092abb
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000092985
- (id)getPhraseConfig:(unsigned long long)arg1;	// IMP=0x0010000000092875
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00100000000c8d64
