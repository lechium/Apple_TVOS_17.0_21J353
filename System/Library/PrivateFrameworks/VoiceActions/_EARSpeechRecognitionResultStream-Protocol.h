...
#import <VoiceActions/NSObject-Protocol.h>
...
- (void)speechRecognizer:(_EARSpeechRecognizer *)arg1 didProduceLoggableMultiUserPackages:(NSDictionary *)arg2;
- (void)speechRecognizer:(_EARSpeechRecognizer *)arg1 didRecognizeFinalResultMultiUserPackages:(NSDictionary *)arg2;
