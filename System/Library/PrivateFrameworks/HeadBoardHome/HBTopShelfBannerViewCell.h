...
- (void).cxx_destruct;	// IMP=0x000000000005abf7
@property(nonatomic) __weak id <HBTopShelfBannerViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)shouldHideFocusForReasons:(unsigned long long)arg1;	// IMP=0x000000000005abd3
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000005ab4f
- (void)_setFocusDirection:(struct CGPoint)arg1;	// IMP=0x000000000005aaa6
