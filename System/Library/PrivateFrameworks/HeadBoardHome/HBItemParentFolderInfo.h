...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003dfef
- (void).cxx_destruct;	// IMP=0x000000000003e02b
...
- (id)description;	// IMP=0x000000000003df1b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003dea6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003dddd
