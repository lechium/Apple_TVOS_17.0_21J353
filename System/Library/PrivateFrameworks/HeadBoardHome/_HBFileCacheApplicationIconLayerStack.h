...
- (void).cxx_destruct;	// IMP=0x000000000005f796
...
- (void)_deflateLayerStack;	// IMP=0x000000000005f5c8
- (void)_inflateLayerStack;	// IMP=0x000000000005f167
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000005eff5
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000005eb54
