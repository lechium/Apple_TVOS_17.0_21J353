...
- (void).cxx_destruct;	// IMP=0x000000000004da38
...
- (id)installApplicationProgress;	// IMP=0x000000000004da02
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000004d970
- (void)updateInstallApplicationPercentage:(double)arg1;	// IMP=0x000000000004d847
- (id)initWithInstallApplicationAction:(id)arg1;	// IMP=0x000000000004d7a1
