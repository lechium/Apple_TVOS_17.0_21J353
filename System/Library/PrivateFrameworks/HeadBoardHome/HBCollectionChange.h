...
- (void).cxx_destruct;	// IMP=0x000000000004dc5c
...
- (id)description;	// IMP=0x000000000004db42
- (id)init;	// IMP=0x000000000004db29
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000000004da69
