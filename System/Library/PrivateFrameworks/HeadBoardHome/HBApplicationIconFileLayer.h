...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000071367
- (void).cxx_destruct;	// IMP=0x0000000000071567
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000711be
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070fe0
- (id)_init;	// IMP=0x0000000000070fb1
