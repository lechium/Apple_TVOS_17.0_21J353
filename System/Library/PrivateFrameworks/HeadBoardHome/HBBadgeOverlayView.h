...
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x0000000000037669
- (void)layoutSubviews;	// IMP=0x00000000000374cc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000037431
