...
+ (id)_fileDataWithMetadataData:(id)arg1 flattenedImageData:(id)arg2 radiosityImageData:(id)arg3;	// IMP=0x00600000000726ef
+ (id)_imageDataWithImage:(struct CGImage *)arg1 extraOptions:(id)arg2;	// IMP=0x0060000000072580
+ (id)iconFileDataWithApplication:(id)arg1 error:(id *)arg2;	// IMP=0x0060000000071d1a
- (void).cxx_destruct;	// IMP=0x000000000007292e
...
- (id)radiosityImage;	// IMP=0x00000000000724b6
@property(readonly, nonatomic) NSArray *layers;
@property(readonly, nonatomic) double imageScale;
@property(readonly, nonatomic) struct CGSize imageSize;
- (id)flattenedImage;	// IMP=0x00000000000722f2
- (id)description;	// IMP=0x0000000000071b04
- (id)initWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000718d2
