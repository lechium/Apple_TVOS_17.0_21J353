...
- (void).cxx_destruct;	// IMP=0x000000000005c08d
...
- (void)_deflateLayerStack;	// IMP=0x000000000005bebf
- (void)_inflateLayerStack;	// IMP=0x000000000005ba5e
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000005b8ec
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000005b559
