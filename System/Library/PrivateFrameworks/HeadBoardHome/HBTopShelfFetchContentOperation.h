...
- (void).cxx_destruct;	// IMP=0x000000000006c4c2
...
- (id)description;	// IMP=0x000000000006c2a7
- (void)cancel;	// IMP=0x000000000006c1b8
- (void)_executionDidBegin;	// IMP=0x000000000006bab2
- (id)initWithApplicationIdentifier:(id)arg1 fetchIdentifier:(id)arg2 contentExtensionController:(id)arg3;	// IMP=0x000000000006b9bd
