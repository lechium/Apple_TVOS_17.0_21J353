...
- (void).cxx_destruct;	// IMP=0x0000000000047e94
...
- (_Bool)_imageURLHasExtension:(id)arg1;	// IMP=0x0000000000047dc4
- (id)description;	// IMP=0x0000000000047c4c
...
- (id)initWithTopShelfImageRequest:(id)arg1;	// IMP=0x0000000000047abf
