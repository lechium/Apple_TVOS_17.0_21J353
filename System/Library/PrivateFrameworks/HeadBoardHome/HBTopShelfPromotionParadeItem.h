...
- (id)_promotionImageName;	// IMP=0x000000000005c864
- (id)_topShelfPromotionCarouselItem;	// IMP=0x000000000005c852
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000005c787
...
- (id)initWithTopShelfPromotionCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x000000000005c608
