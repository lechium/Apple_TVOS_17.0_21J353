...
- (void).cxx_destruct;	// IMP=0x000000000000aec6
...
- (void)_invalidate;	// IMP=0x000000000000ad68
- (void)invalidate;	// IMP=0x000000000000ac7f
- (id)remoteObjectProxy;	// IMP=0x000000000000ac2f
- (void)addFailureBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000a9a2
- (id)initWithFMNSXPCConnection:(id)arg1;	// IMP=0x000000000000a904
