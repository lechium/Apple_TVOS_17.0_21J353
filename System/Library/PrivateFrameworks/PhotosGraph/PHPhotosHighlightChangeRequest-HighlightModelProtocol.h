...
- (void)enumerateMomentChangeRequestsForUUIDs:(id)arg1 inPhotoLibrary:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00200000004a4bc4
- (void)clearCurations;	// IMP=0x00200000004a4b84
