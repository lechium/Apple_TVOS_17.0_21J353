...
- (void).cxx_destruct;	// IMP=0x000000000014a1a0
- (id)init;	// IMP=0x000000000014a140
- (id)copyWithZone:(void *)arg1;	// IMP=0x000000000014a130
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x000000000014a110
- (id)oppositeNodeFromNode:(id)arg1;	// IMP=0x000000000014a0c0
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 properties:(id)arg3 sourceNode:(id)arg4 targetNode:(id)arg5;	// IMP=0x0000000000149e90
