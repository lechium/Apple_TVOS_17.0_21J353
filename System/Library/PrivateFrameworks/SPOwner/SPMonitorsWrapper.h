...
- (void)resume;	// IMP=0x00000000000137cc
- (void)pause;	// IMP=0x0000000000013754
- (void)stop;	// IMP=0x00000000000136ed
- (void)start;	// IMP=0x000000000001356f
- (unsigned long long)powerState;	// IMP=0x0000000000013567
- (_Bool)isNetworkUp;	// IMP=0x0000000000013523
- (id)initWithBeaconManager:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000013448
