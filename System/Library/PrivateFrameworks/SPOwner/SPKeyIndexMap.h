...
- (void).cxx_destruct;	// IMP=0x00000000000431ca
...
- (id)headerString;	// IMP=0x000000000004310f
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x000000000004308e
- (void)dealloc;	// IMP=0x0000000000043054
- (id)init;	// IMP=0x0000000000043029
