...
- (void).cxx_destruct;	// IMP=0x00000000000352a9
...
- (void)peripheralManager:(id)arg1 offlineAdvPayloadRequestedWithReason:(long long)arg2;	// IMP=0x000000000003507d
- (void)processKeyResponse:(id)arg1;	// IMP=0x0000000000034bb1
- (long long)transformReason:(long long)arg1;	// IMP=0x0000000000034b60
- (void)enterLowPowerMode;	// IMP=0x0000000000034a57
- (void)peripheralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000003486b
- (id)userAgentSyncProxy;	// IMP=0x0000000000034859
- (id)syncProxy;	// IMP=0x00000000000345f6
- (id)userAgentProxy;	// IMP=0x00000000000345e4
- (id)proxy;	// IMP=0x00000000000343ea
- (id)remoteInterface;	// IMP=0x00000000000342ce
- (id)initWithBeaconManager:(id)arg1;	// IMP=0x00000000000340b1
