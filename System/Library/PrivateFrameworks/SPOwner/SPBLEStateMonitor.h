...
- (void).cxx_destruct;	// IMP=0x000000000004d71d
...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000004d5b3
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x000000000004d538
- (void)startMonitoring;	// IMP=0x000000000004d457
- (id)init;	// IMP=0x000000000004d41b
