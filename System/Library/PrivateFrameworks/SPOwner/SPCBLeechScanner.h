...
+ (id)remoteInterface;	// IMP=0x0010000000027857
- (void).cxx_destruct;	// IMP=0x0000000000027b77
...
- (void)centralManager:(id)arg1 didDiscoverPeripheral:(id)arg2 advertisementData:(id)arg3 RSSI:(id)arg4;	// IMP=0x0000000000027904
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x00000000000278c3
- (void)invalidationHandler:(id)arg1;	// IMP=0x0000000000027477
- (void)interruptionHandler:(id)arg1;	// IMP=0x00000000000273d2
- (void)stopScanning;	// IMP=0x00000000000272f6
- (void)startScanning;	// IMP=0x0000000000027140
- (void)handleStateChange:(unsigned long long)arg1;	// IMP=0x0000000000026ca6
- (id)init;	// IMP=0x000000000002696f
