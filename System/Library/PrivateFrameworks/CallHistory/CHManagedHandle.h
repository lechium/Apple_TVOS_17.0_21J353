...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000ca2e
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000c7c4
+ (id)fetchRequest;	// IMP=0x008000000000e147
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000ccfd
