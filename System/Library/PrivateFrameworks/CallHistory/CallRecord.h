...
+ (id)fetchRequest;	// IMP=0x008000000001c24a
...
- (_Bool)supportsJunkConfidence;	// IMP=0x0000000000009732
...
- (id)compositeVerificationStatusForContext:(id)arg1;	// IMP=0x0000000000009561
- (id)compositeServiceProviderForContext:(id)arg1;	// IMP=0x00000000000094c3
- (id)compositeRemoteParticipantHandlesForContext:(id)arg1;	// IMP=0x000000000000923b
- (id)compositeParticipantGroupUUIDForContext:(id)arg1;	// IMP=0x00000000000091f7
- (id)compositeOutgoingLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x00000000000091b3
- (id)compositeLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x000000000000916f
- (id)compositeJunkConfidenceForContext:(id)arg1;	// IMP=0x000000000000910f
- (id)compositeHandleTypeForContext:(id)arg1;	// IMP=0x00000000000090da
- (id)compositeCallCategoryForContext:(id)arg1;	// IMP=0x0000000000009026
