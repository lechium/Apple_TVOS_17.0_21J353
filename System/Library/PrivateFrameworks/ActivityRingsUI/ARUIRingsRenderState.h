...
- (void).cxx_destruct;	// IMP=0x0000000000018787
...
- (_Bool)shouldRunStateForRing:(id)arg1;	// IMP=0x0000000000018757
- (void)didInitialize;	// IMP=0x0000000000018741
- (id)name;	// IMP=0x0000000000018739
- (id)initWithPipelineLibrary:(id)arg1;	// IMP=0x0000000000018665
- (id)renderPipelineDescriptorFromLibrary:(id)arg1;	// IMP=0x000000000001865d
@property(retain, nonatomic) id <MTLRenderPipelineState> renderPipelineState;
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000018558
