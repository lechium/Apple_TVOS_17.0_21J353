...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000e618
- (void).cxx_destruct;	// IMP=0x000000000000e9a8
...
- (void)completeAnimation;	// IMP=0x000000000000e8d5
- (_Bool)isAnimating;	// IMP=0x000000000000e8be
- (void)update:(double)arg1;	// IMP=0x000000000000e7fc
- (void)dealloc;	// IMP=0x000000000000e79e
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000e6b0
