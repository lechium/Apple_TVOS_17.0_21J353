...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001df6b
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001db47
- (void *)uniformsBytes;	// IMP=0x000000000001db3a
- (void *)vertexAttributesBytes;	// IMP=0x000000000001db30
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001da8c
