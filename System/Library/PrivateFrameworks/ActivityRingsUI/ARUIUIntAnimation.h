...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001b9a5
- (void).cxx_destruct;	// IMP=0x000000000001bd59
...
- (void)completeAnimation;	// IMP=0x000000000001bc8a
- (_Bool)isAnimating;	// IMP=0x000000000001bc79
- (void)update:(double)arg1;	// IMP=0x000000000001bb76
- (void)dealloc;	// IMP=0x000000000001bb18
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001ba3b
