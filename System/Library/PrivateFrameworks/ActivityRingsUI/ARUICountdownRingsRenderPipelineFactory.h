...
- (void).cxx_destruct;	// IMP=0x00000000000140d0
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x0000000000013ff0
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x0000000000013eef
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000013dd0
