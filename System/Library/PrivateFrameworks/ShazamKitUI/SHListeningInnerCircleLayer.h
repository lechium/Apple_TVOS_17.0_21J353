...
- (void).cxx_destruct;	// IMP=0x0000000000007102
...
- (struct CGPath *)circlePathForRect:(struct CGRect)arg1;	// IMP=0x000000000000707a
- (void)layoutSublayers;	// IMP=0x0000000000006e19
- (void)setup;	// IMP=0x0000000000006c2a
