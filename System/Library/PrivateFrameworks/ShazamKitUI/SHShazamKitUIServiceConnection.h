...
- (void).cxx_destruct;	// IMP=0x0000000000006c02
...
- (void)tearDownConnection;	// IMP=0x0000000000006af1
- (void)attachDefaultConnectionHandlers;	// IMP=0x000000000000681f
@property(readonly, nonatomic) NSXPCConnection *connection; // @synthesize connection=_connection;
- (id)initWithConnectionProvider:(id)arg1;	// IMP=0x00000000000066f1
