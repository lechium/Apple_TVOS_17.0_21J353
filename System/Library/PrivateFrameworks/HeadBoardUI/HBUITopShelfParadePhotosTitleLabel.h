...
- (_Bool)_isSupportedCharacterSetForFont:(id)arg1 string:(id)arg2;	// IMP=0x0000000000001f28
- (void)setText:(id)arg1;	// IMP=0x0000000000001da1
- (double)_firstBaselineOffsetFromTop;	// IMP=0x0000000000001c10
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x0000000000001b94
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000001b3d
