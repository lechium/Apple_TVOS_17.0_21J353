...
- (void).cxx_destruct;	// IMP=0x0000000000028a05
...
- (void)_addTransformAnimations;	// IMP=0x0000000000028564
- (void)_addFadeAnimations;	// IMP=0x0000000000028220
- (void)_prepareForTransition;	// IMP=0x0000000000028027
- (void)_addAnimations;	// IMP=0x0000000000027fcc
- (void)_didComplete;	// IMP=0x0000000000027eb6
- (void)_begin;	// IMP=0x0000000000027e60
- (id)debugDescription;	// IMP=0x0000000000027d00
- (id)initWithContainerViewController:(id)arg1 fromViewController:(id)arg2 toViewController:(id)arg3 animationDirection:(long long)arg4 isBackgroundUpdate:(_Bool)arg5;	// IMP=0x0000000000027ad2
