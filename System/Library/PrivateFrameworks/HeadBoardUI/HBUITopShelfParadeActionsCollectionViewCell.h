...
- (void)paradeContentViewDidChange:(id)arg1;	// IMP=0x0000000000010cff
- (void)paradeBackgroundViewDidChange:(id)arg1;	// IMP=0x0000000000010c38
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000010a03
