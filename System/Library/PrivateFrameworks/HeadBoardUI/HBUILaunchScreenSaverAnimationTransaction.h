...
- (void).cxx_destruct;	// IMP=0x000000000002cd7b
...
- (void)willInterruptTransaction:(id)arg1;	// IMP=0x000000000002cb66
- (_Bool)_canBeInterrupted;	// IMP=0x000000000002cb49
- (void)_didComplete;	// IMP=0x000000000002c6d8
- (void)_begin;	// IMP=0x000000000002bcab
- (id)debugDescription;	// IMP=0x000000000002bbc4
- (id)initWithContext:(id)arg1 topShelfAnimation:(id)arg2 appGridAnimation:(id)arg3;	// IMP=0x000000000002b89e
