...
- (void).cxx_destruct;	// IMP=0x000000000000b3f5
...
- (void)_handleDisplayLink:(id)arg1;	// IMP=0x000000000000b25e
- (void)invalidate;	// IMP=0x000000000000b208
- (void)setVolume:(float)arg1;	// IMP=0x000000000000b1f4
- (void)setVolume:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000000b020
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000000af34
