...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005484e
- (void).cxx_destruct;	// IMP=0x000000000005506d
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000000054e11
- (id)description;	// IMP=0x0000000000054dfa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000054c4e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000054856
- (id)initWithIdentifier:(id)arg1 applicationLabel:(id)arg2 pkData:(id)arg3 bonjourListenerUUID:(id)arg4 isSameAccount:(_Bool)arg5 contactID:(id)arg6 forceSingleBandAWDLMode:(_Bool)arg7 knownIdentity:(_Bool)arg8;	// IMP=0x00000000000546e7
