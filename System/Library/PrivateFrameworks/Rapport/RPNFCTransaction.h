...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000020e9
- (void).cxx_destruct;	// IMP=0x0000000000002fcd
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002b3d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000029bf
- (void)setState:(long long)arg1;	// IMP=0x00000000000027b7
- (void)setError:(id)arg1;	// IMP=0x000000000000219e
- (id)initWithRole:(long long)arg1;	// IMP=0x00000000000020f1
