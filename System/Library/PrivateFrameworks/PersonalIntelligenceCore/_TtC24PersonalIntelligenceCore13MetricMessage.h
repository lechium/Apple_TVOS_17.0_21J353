...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x0010000000005cf9
- (void).cxx_destruct;	// IMP=0x0000000000005fb4
- (id)init;	// IMP=0x0000000000005f81
- (id)json;	// IMP=0x0000000000005ee7
- (id)serialize;	// IMP=0x0000000000005dbb
