...
- (void).cxx_destruct;	// IMP=0x0000000000049204
...
- (id)_fetchedObjectDictionaryForEntity:(void *)arg1;	// IMP=0x0000000000048f41
- (id)_properties:(id)arg1 forEntityIfNotSeen:(void *)arg2 objectExists:(_Bool *)arg3;	// IMP=0x000000000004881c
@property(readonly, nonatomic) NSArray *fetchedObjectWrappers;
- (id)addEntity:(void *)arg1;	// IMP=0x00000000000484ab
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2 relatedObjectPropertiesToLoad:(id)arg3;	// IMP=0x000000000004837b
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2;	// IMP=0x0000000000048366
