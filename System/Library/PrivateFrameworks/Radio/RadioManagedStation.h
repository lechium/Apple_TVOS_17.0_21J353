...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001ecb
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x0000000000005226
- (id)streamCertificateURL;	// IMP=0x0000000000005189
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x0000000000004882
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x0000000000004793
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x00000000000023aa
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000001fbe
