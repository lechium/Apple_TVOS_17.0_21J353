...
- (void).cxx_destruct;	// IMP=0x000000000010bf7b
...
- (id)description;	// IMP=0x000000000010bece
- (void)updateWithValue:(unsigned long long)arg1;	// IMP=0x000000000010be2f
- (id)init;	// IMP=0x000000000010bdd1
