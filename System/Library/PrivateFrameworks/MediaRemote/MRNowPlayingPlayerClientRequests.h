...
- (void).cxx_destruct;	// IMP=0x0000000000225669
...
- (void)restoreNowPlayingClientState;	// IMP=0x000000000022555e
- (void)handlePlayerPropertiesRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002251a3
- (void)handlePlaybackStateRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000224dff
- (void)handleSupportedCommandsRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000224a65
- (void)enqueuePlaybackQueueRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000224356
- (void)updateSupportedCommandsIfUninitialized:(id)arg1;	// IMP=0x0000000000224271
- (void)updatePlaybackStateIfUninitialized:(unsigned int)arg1;	// IMP=0x00000000002241fa
- (void)updatePlaybackQueueIfUninitialized:(id)arg1;	// IMP=0x0000000000224115
- (void)updateContentItemArtwork:(id)arg1;	// IMP=0x0000000000223c11
- (void)updateContentItems:(id)arg1;	// IMP=0x000000000022390c
...
- (id)debugDescription;	// IMP=0x0000000000223025
- (void)dealloc;	// IMP=0x0000000000222fb0
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0000000000222e0c
