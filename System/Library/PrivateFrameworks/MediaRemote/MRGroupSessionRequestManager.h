...
+ (id)sharedManager;	// IMP=0x0060000000042bf3
- (void).cxx_destruct;	// IMP=0x0000000000043180
...
- (void)handleGroupSessionNearbyContactDiscoveryDidChange:(id)arg1;	// IMP=0x00000000000430a5
- (void)updateLocalIdentity:(id)arg1;	// IMP=0x0000000000042fd7
- (void)updateGroupSessionInfo:(id)arg1;	// IMP=0x0000000000042f0d
@property(readonly, nonatomic) MRGroupSessionInfo *groupSessionInfo; // @synthesize groupSessionInfo=_groupSessionInfo;
- (void)augmentLocalCommandOptions:(id)arg1;	// IMP=0x0000000000042dcb
- (void)restoreState;	// IMP=0x0000000000042d93
- (void)registerObservers;	// IMP=0x0000000000042ce5
- (id)init;	// IMP=0x0000000000042c92
