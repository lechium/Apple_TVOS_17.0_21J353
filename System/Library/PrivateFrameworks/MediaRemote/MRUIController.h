...
- (void).cxx_destruct;	// IMP=0x0000000000220c39
...
- (void)releaseRouteRecommendationAssertion;	// IMP=0x0000000000220b7a
- (void)acquireRouteRecommendationAssertion;	// IMP=0x0000000000220b1b
- (id)contextForActivityIdentifier:(id)arg1;	// IMP=0x00000000002209ea
- (void)releaseScreenMirroringQuickControlsAssertion;	// IMP=0x000000000022098e
- (void)acquireScreenMirroringQuickControlsAssertion;	// IMP=0x000000000022092f
- (void)releaseQuickControlsAssertion;	// IMP=0x00000000002208d3
- (id)acquireQuickControlsAssertion;	// IMP=0x0000000000220784
- (void)releaseLockScreenControlsAssertion;	// IMP=0x0000000000220728
- (void)acquireLockScreenControlsAssertion;	// IMP=0x00000000002206c9
@property(readonly, nonatomic) id <MRUIServerXPCProtocol> server;
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (_Bool)hasUIAssertions;	// IMP=0x0000000000220043
- (void)dealloc;	// IMP=0x000000000021fd83
- (void)_restoreState;	// IMP=0x000000000021fa85
- (id)init;	// IMP=0x000000000021f9b6
