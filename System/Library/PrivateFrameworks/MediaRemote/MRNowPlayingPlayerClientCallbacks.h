...
- (void).cxx_destruct;	// IMP=0x00000000001ced09
...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001cea6b
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001ce679
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001ce2d0
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001cde31
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001cddc9
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001cdbd0
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001cdac2
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001cd9ef
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001cc560
