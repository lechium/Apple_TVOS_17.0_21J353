...
- (void).cxx_destruct;	// IMP=0x000000000026877b
...
- (void)sendMessage:(CDUnknownBlockType)arg1;	// IMP=0x000000000026865b
- (id)server;	// IMP=0x000000000026850f
- (void)initializeConnection;	// IMP=0x0000000000267e37
- (void)dealloc;	// IMP=0x0000000000267de3
- (id)initWithClientObject:(id)arg1 invalidationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000267c82
