...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016606e
- (void).cxx_destruct;	// IMP=0x00000000001660d8
...
- (id)description;	// IMP=0x0000000000166076
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000165fca
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000165c1c
- (id)initWithItem:(id)arg1 request:(id)arg2;	// IMP=0x00000000001659f9
