...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x0000000000025a78
- (void)dealloc;	// IMP=0x00000000000259c7
- (id)init;	// IMP=0x0000000000025751
