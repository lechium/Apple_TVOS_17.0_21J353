...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004480c
- (void)_returnPacketArrived;	// IMP=0x00000000000447ee
- (void)_markPacketAsTimedOut:(double)arg1;	// IMP=0x0000000000044762
- (id)initWithSequeneceNumber:(int)arg1 timesent:(struct timeval *)arg2 error:(int)arg3;	// IMP=0x000000000004470c
