...
- (void).cxx_destruct;	// IMP=0x00000000007d2290
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000007d1ab0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000007d1520
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000007d0ee0
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000007d05c0
- (void)dealloc;	// IMP=0x00000000007d0590
- (id)init;	// IMP=0x00000000007d0360
