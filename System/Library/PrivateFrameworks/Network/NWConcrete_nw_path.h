...
- (void).cxx_destruct;	// IMP=0x0000000000724160
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007240a0
- (id)redactedDescription;	// IMP=0x0000000000724080
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000722c40
- (id)init;	// IMP=0x0000000000722a00
