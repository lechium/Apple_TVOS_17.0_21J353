...
@interface NWConcrete_nw_parameters : NSObject
{
    ...
    NWConcrete_nw_path_parameters *path_parameters;	// 104 = 0x68
    char *e_bundle_id;	// 112 = 0x70
    char *proxy_bundle_id;	// 120 = 0x78
    NSObject<OS_xpc_object> *tls_session_id;	// 128 = 0x80
    NSObject<OS_xpc_object> *extra_parent_ids;	// 136 = 0x88
    NSObject<OS_dispatch_data> *initial_data_payload;	// 144 = 0x90
    NWConcrete_nw_protocol_stack *default_stack;	// 152 = 0x98
    NSObject<OS_nw_array> *transforms;	// 160 = 0xa0
    NSObject<OS_nw_array> *proxy_options;	// 168 = 0xa8
    NSObject<OS_nw_array> *custom_proxy_configs;	// 176 = 0xb0
    NSObject<OS_nw_proxy_config> *effective_proxy_config;	// 184 = 0xb8
    NSObject<OS_nw_proxy_config> *raced_proxy_config;	// 192 = 0xc0
    NSObject<OS_nw_endpoint> *url_endpoint;	// 200 = 0xc8
    NSObject<OS_nw_endpoint> *main_document_url_endpoint;	// 208 = 0xd0
    NSObject<OS_xpc_object> *metadata;	// 216 = 0xd8
}

- (void).cxx_destruct;	// IMP=0x000000000028f970
- (id)redactedDescription;	// IMP=0x000000000028f950
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000028f8a0
