...
- (void).cxx_destruct;	// IMP=0x00000000001acc00
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000001acb50
- (id)initWithType:(int)arg1 member:(id)arg2 groupID:(unsigned char [16])arg3;	// IMP=0x00000000001ac670
