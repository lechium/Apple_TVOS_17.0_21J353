...
- (id).cxx_construct;	// IMP=0x0000000000814b90
- (void).cxx_destruct;	// IMP=0x0000000000814980
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x0000000000814200
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x0000000000812590
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x0000000000811a10
- (void)startWithHandler:(id)arg1;	// IMP=0x000000000080f320
- (void)dealloc;	// IMP=0x000000000080eb40
- (id)init;	// IMP=0x000000000080e900
