...
- (void).cxx_destruct;	// IMP=0x0000000000523d50
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x0000000000523740
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000523130
- (void)startThrottlePolicyEventListener;	// IMP=0x00000000005230e0
- (_Bool)startXPCListener;	// IMP=0x0000000000522ad0
- (void)registerHelperFunctions;	// IMP=0x0000000000521f50
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(int)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000000520e10
