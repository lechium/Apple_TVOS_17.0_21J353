...
- (void).cxx_destruct;	// IMP=0x00000000003a73a0
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x00000000003a6bc0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x00000000003a6630
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x00000000003a5fc0
- (void)startWithHandler:(id)arg1;	// IMP=0x00000000003a4f60
- (void)dealloc;	// IMP=0x00000000003a4f30
- (id)init;	// IMP=0x00000000003a4d00
