...
- (void).cxx_destruct;	// IMP=0x00000000000d1cc0
...
- (id)snapshot;	// IMP=0x00000000000d1900
- (void)reset;	// IMP=0x00000000000d18a0
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x00000000000d1500
- (id)description;	// IMP=0x00000000000d1460
- (void)dealloc;	// IMP=0x00000000000d13d0
- (id)initWithName:(id)arg1;	// IMP=0x00000000000d1250
