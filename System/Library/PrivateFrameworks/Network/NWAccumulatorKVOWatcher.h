...
- (void).cxx_destruct;	// IMP=0x00000000000d5db0
...
- (void)updateWithState:(id)arg1;	// IMP=0x00000000000d5a50
- (id)description;	// IMP=0x00000000000d5960
- (id)init;	// IMP=0x00000000000d5920
