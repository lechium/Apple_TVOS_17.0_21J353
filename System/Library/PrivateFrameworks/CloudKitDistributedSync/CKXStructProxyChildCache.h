...
- (id).cxx_construct;	// IMP=0x00000000000e5f11
- (void).cxx_destruct;	// IMP=0x00000000000e5ed7
@property(readonly, nonatomic) __weak CKXStructProxyBase *proxy; // @synthesize proxy=_proxy;
- (id)structListProxyForListReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000e5d67
- (id)structProxyForStructReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000e5c0d
- (void)reset;	// IMP=0x00000000000e5bbe
- (id)initWithProxy:(id)arg1;	// IMP=0x00000000000e5b46
