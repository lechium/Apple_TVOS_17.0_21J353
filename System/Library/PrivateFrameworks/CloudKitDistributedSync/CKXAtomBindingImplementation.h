...
- (void).cxx_destruct;	// IMP=0x00000000000ccad7
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (id)orcHelpers;	// IMP=0x00000000000cca25
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000cc917
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000cc809
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000cc620
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000cc616
- (id)init;	// IMP=0x00000000000cc59c
