...
#import <HomePodSettingsDaemon/HMHomeDelegate-Protocol.h>
...
- (void)home:(HMHome *)arg1 didUpdateEventLogEnabled:(_Bool)arg2;
...
- (void)home:(HMHome *)arg1 didUpdateOnboardAudioAnalysis:(_Bool)arg2;
