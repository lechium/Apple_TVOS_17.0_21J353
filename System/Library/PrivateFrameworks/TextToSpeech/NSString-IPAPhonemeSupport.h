...
+ (id)binaryStringRepresentationOfInt:(long long)arg1 numberOfDigits:(unsigned int)arg2 chunkLength:(unsigned int)arg3;	// IMP=0x0020000000065857
+ (id)binaryStringRepresentationOfInt:(long long)arg1;	// IMP=0x002000000006583a
