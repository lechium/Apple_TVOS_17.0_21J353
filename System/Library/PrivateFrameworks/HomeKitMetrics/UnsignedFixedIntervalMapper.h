...
- (void).cxx_destruct;	// IMP=0x0000000000002aa5
...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x00000000000029d1
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x000000000000284f
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000002585
