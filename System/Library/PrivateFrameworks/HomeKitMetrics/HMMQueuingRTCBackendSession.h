...
+ (id)logCategory;	// IMP=0x00100000000045b0
- (void).cxx_destruct;	// IMP=0x0000000000004569
...
- (void)dealloc;	// IMP=0x00000000000044ee
- (void)close;	// IMP=0x00000000000043d2
@property(readonly, nonatomic) double lastEventTime; // @synthesize lastEventTime=_lastEventTime;
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000004316
- (id)initWithServiceName:(id)arg1 sessionUUID:(id)arg2 isRealtime:(_Bool)arg3 submitter:(id)arg4 timeSourceBlock:(CDUnknownBlockType)arg5;	// IMP=0x00000000000041e6
