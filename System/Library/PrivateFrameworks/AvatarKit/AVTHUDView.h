...
- (void).cxx_destruct;	// IMP=0x000000000004d3e9
- (void)_tapAction:(id)arg1;	// IMP=0x000000000004d2b6
- (void)_loadSubviews;	// IMP=0x000000000004ccf3
- (id)_label;	// IMP=0x000000000004cb7f
- (void)_updateLatencyGraph:(CDStruct_53ba08a1 *)arg1;	// IMP=0x000000000004c533
- (void)_updateLatencyBar:(CDStruct_53ba08a1 *)arg1;	// IMP=0x000000000004c21e
- (void)layoutSubviews;	// IMP=0x000000000004bec4
- (void)updateWithData:(CDStruct_53ba08a1)arg1;	// IMP=0x000000000004bb2b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004ba8d
