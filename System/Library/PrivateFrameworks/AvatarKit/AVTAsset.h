...
- (void).cxx_destruct;	// IMP=0x0000000000014e36
...
- (id)assetImageForAsset:(id)arg1;	// IMP=0x0000000000014d40
- (id)resourceByCachingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000014c51
- (id)instantiateResource;	// IMP=0x00000000000146f3
@property(readonly) _Bool is3DAsset;
@property(readonly) _Bool is2DAsset;
- (void)decrUseCount;	// IMP=0x000000000001465e
- (void)freeCache;	// IMP=0x0000000000014644
- (void)incrUseCount;	// IMP=0x000000000001461e
- (id)description;	// IMP=0x00000000000145f5
- (void)enumerateVariantDependenciesOfKind:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000001440c
- (id)initWithType:(long long)arg1 path:(id)arg2 packID:(id)arg3;	// IMP=0x0000000000013b05
