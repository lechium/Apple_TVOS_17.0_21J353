...
- (void).cxx_destruct;	// IMP=0x00000000002eb8bb
...
- (_Bool)matchesImageAsset:(id)arg1;	// IMP=0x00000000002eb844
- (id)initWithImageAsset:(id)arg1 instanceMaskObservation:(id)arg2 regionOfInterest:(struct CGRect)arg3;	// IMP=0x00000000002eb778
