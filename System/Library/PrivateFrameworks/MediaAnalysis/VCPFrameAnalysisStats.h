...
@interface VCPFrameAnalysisStats : NSObject
{
    ...
    float _subtleMotionScore;	// 24 = 0x18
    float _interestingnessScore;	// 28 = 0x1c
    float _obstructionScore;	// 32 = 0x20
    float _exposureScore;	// 36 = 0x24
    float _colorfulnessScore;	// 40 = 0x28
    float _frameExpressionScore;	// 44 = 0x2c
    float _faceArea;	// 48 = 0x30
    float _humanPoseScore;	// 52 = 0x34
    float _humanActionScore;	// 56 = 0x38
    float _petsActionScore;	// 60 = 0x3c
...
- (void).cxx_destruct;	// IMP=0x00000000001bfbcf
...
@property(nonatomic) float subtleMotionScore; // @synthesize subtleMotionScore=_subtleMotionScore;
...
- (void)reset;	// IMP=0x00000000001bf939
- (id)init;	// IMP=0x00000000001bf803
