...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x001000000006d94d
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x001000000006d7f4
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andBodyObservation:(id)arg2;	// IMP=0x001000000006d6e6
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000006cc70
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000006bfda
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalHeadObservations:(id)arg3 animalBodyObservations:(id)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11 animalResults:(id *)arg12;	// IMP=0x001000000006b5b8
+ (id)_animalHeadsOnlyFromAnimalHeadObservations:(id)arg1 matchedHead:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000006b0b4
+ (id)_animalBodiesOnlyFromAnimalBodyObservations:(id)arg1 matchedBody:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000006acd4
+ (id)_animalHeadsBodiesFromAnimalHeadObservations:(id)arg1 animalBodyObservations:(id)arg2 matchedHead:(void *)arg3 matchedBody:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 processingVersion:(int)arg8;	// IMP=0x001000000006a455
+ (id)faceFromAnimalHeadObservation:(id)arg1 animalBodyObservation:(id)arg2 animalLabel:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 processingVersion:(int)arg7;	// IMP=0x0010000000069fd5
+ (id)_animalImageprintWrapperFromObservation:(id)arg1 visionRequests:(id)arg2 processingVersion:(int)arg3;	// IMP=0x001000000006976a
+ (id)_filterAnimalObservations:(id)arg1 colocatingWithFaceObservations:(id)arg2 orHumanObservations:(id)arg3;	// IMP=0x0010000000069584
+ (id)_peopleTorsosOnlyFromHumanObservations:(id)arg1 matchedTorso:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x0010000000068a10
+ (id)_peopleFacesOnlyFromFaceObservations:(id)arg1 matchedFace:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 blurScorePerFace:(id)arg6 exposureScorePerFace:(id)arg7 tooSmallFaceObservations:(id)arg8 processingVersion:(int)arg9;	// IMP=0x0010000000068353
+ (id)_peopleFacesTorsosFromFaceObservations:(id)arg1 humanObservations:(id)arg2 matchedFace:(void *)arg3 matchedTorso:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11;	// IMP=0x001000000006791b
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x001000000006437d
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x0010000000061c8e
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x0010000000061c29
- (void).cxx_destruct;	// IMP=0x000000000006e58d
...
- (double)photosFaceRepresentationQuality;	// IMP=0x000000000006e0b1
- (double)photosFaceRepresentationRoll;	// IMP=0x000000000006e09f
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x000000000006e08d
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x000000000006e07b
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x000000000006e069
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x000000000006e057
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x000000000006e045
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x000000000006e033
- (double)photosFaceRepresentationBlurScore;	// IMP=0x000000000006e021
- (double)photosFaceRepresentationSize;	// IMP=0x000000000006e00f
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000006dffd
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000006dfeb
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000006dfd9
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x000000000006dfc7
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x000000000006de6b
- (id)gist;	// IMP=0x000000000006d474
- (struct CGRect)normalizedBodyRect;	// IMP=0x000000000006d3d2
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000006d355
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000006d2b6
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000006ce98
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000061ad0
