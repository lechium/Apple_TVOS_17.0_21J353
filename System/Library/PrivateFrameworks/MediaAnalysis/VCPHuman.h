...
+ (unsigned long long)flagsFromKeypoints:(id)arg1 withMinConfidence:(float)arg2;	// IMP=0x0060000000131d6c
- (void).cxx_destruct;	// IMP=0x0000000000132077
...
- (id)init;	// IMP=0x0000000000131ce4
