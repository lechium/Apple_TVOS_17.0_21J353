...
- (void).cxx_destruct;	// IMP=0x00000000001a413a
...
- (int)trackObjectInFrame:(struct __CVBuffer *)arg1;	// IMP=0x00000000001a3d0d
- (id)initWithObjectBounds:(struct CGRect)arg1 inFrame:(struct __CVBuffer *)arg2 timestamp:(CDStruct_1b6d18a9)arg3;	// IMP=0x00000000001a3a20
