...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x00800000002d75ee
- (id)typeDescription;	// IMP=0x00000000002d7771
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1 orientation:(unsigned int *)arg2;	// IMP=0x00000000002d7955
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x00000000002d7931
...
- (struct CGSize)originalMovieSize;	// IMP=0x00000000002d7b8b
- (id)originalMovie;	// IMP=0x00000000002d7b67
- (id)streamedMovie;	// IMP=0x00000000002d7b5f
- (_Bool)isMovieResourceLocalAvailable;	// IMP=0x00000000002d7b3b
- (id)movie;	// IMP=0x00000000002d7b17
