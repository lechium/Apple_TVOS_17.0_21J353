...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000aabfc
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000aaaf7
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000aaa73
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000aaa09
- (id)init;	// IMP=0x00000000000aa995
