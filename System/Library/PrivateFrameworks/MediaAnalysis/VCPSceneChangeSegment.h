...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000002c8212
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000002c810d
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000002c8089
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000002c801f
- (id)init;	// IMP=0x00000000002c7fab
