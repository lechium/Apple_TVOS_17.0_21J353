...
- (void).cxx_destruct;	// IMP=0x00000000000c996a
...
- (void)checkAutoPlayable;	// IMP=0x00000000000c9688
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000c9521
- (_Bool)isShort;	// IMP=0x00000000000c94d6
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000c8fe1
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000c8f59
