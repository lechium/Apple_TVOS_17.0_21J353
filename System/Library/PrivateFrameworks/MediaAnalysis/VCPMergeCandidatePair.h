...
+ (id)mergeCandidatePairWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x0060000000135962
- (void).cxx_destruct;	// IMP=0x0000000000135e80
...
- (id)description;	// IMP=0x0000000000135d89
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000135b3e
- (unsigned long long)hash;	// IMP=0x0000000000135b34
- (id)initWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000135a13
