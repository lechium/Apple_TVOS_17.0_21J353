...
+ (id)sharedModel:(id)arg1 outputNames:(id)arg2 properties:(id)arg3;	// IMP=0x0060000000129b79
- (void).cxx_destruct;	// IMP=0x000000000012a31e
...
- (int)inference:(float *)arg1 settling:(_Bool)arg2;	// IMP=0x000000000012a06d
- (id)initWithConfig:(id)arg1;	// IMP=0x0000000000129d3f
