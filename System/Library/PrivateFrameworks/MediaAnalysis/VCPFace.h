...
@interface VCPFace : NSObject
{
    ...
    struct CGRect _torsoBounds;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00000000000e3a1b
...
- (struct CGRect)faceBoundsWithTransform:(unsigned long long)arg1 height:(unsigned long long)arg2 transform:(struct CGAffineTransform)arg3;	// IMP=0x00000000000e3876
- (struct CGRect)faceBounds:(unsigned long long)arg1 height:(unsigned long long)arg2;	// IMP=0x00000000000e3817
- (unsigned long long)flagsForOrientation:(_Bool)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;	// IMP=0x00000000000e37ad
- (id)init;	// IMP=0x00000000000e374a
