...
- (void).cxx_destruct;	// IMP=0x00000000001f470f
@property(copy, nonatomic) CDUnknownBlockType progressHandler; // @synthesize progressHandler=_progressHandler;
@property(retain, nonatomic) NSDictionary *decoderSettings; // @synthesize decoderSettings=_decoderSettings;
- (void)cancel;	// IMP=0x00000000001f46d0
- (_Bool)analyzeWithError:(id *)arg1;	// IMP=0x00000000001f4599
- (_Bool)addFrameProcessingRequest:(CDUnknownBlockType)arg1 withConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001f44fa
- (_Bool)processConfiguration:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000001f42c1
- (id)initWithURL:(id)arg1;	// IMP=0x00000000001f41fe
