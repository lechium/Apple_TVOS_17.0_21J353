...
+ (_Bool)isLivePhotoKeyFrameEnabled;	// IMP=0x00600000000d233d
- (void).cxx_destruct;	// IMP=0x00000000000d45dd
...
- (void)printStats;	// IMP=0x00000000000d427b
- (_Bool)hasGoodSubjectAction;	// IMP=0x00000000000d424f
- (float)computeScoreFromExposure;	// IMP=0x00000000000d421c
- (float)computeScoreFromColorfulness;	// IMP=0x00000000000d41f2
- (float)computeExpressionScore;	// IMP=0x00000000000d3eee
- (float)computeScoreFromAction;	// IMP=0x00000000000d3ea7
- (void)computeCurationScore;	// IMP=0x00000000000d3e16
- (void)computeCurationScoreComponents;	// IMP=0x00000000000d3d8c
- (void)storeFrameResults;	// IMP=0x00000000000d34b7
- (float)computePenaltyScore;	// IMP=0x00000000000d312e
- (float)computeContentScore;	// IMP=0x00000000000d30c6
- (float)computeVisualPleasingScore;	// IMP=0x00000000000d305c
- (float)computeGlobalQuality;	// IMP=0x00000000000d2fe5
- (void)computeGlobalQualityForLivePhoto;	// IMP=0x00000000000d2f97
- (void)setMotionStatsFlag:(_Bool)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(_Bool)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(_Bool)arg11;	// IMP=0x00000000000d2f35
- (void)setFaceStatsFlag:(_Bool)arg1 detectedFaces:(id)arg2;	// IMP=0x00000000000d2d95
- (void)resetStatsFlag;	// IMP=0x00000000000d2d87
- (int)loadKeyFrameResult:(id)arg1 timestamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000d2539
- (void)copyFrom:(id)arg1;	// IMP=0x00000000000d2345
- (id)initWithLivePhoto:(_Bool)arg1;	// IMP=0x00000000000d21d3
