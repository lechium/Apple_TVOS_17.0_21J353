...
- (void).cxx_destruct;	// IMP=0x0000000000071d50
...
- (id)initWithSceneId:(id)arg1 withDuration:(float)arg2 withConfidence:(float)arg3 withAdjustConfidence:(float)arg4;	// IMP=0x0000000000071bf0
