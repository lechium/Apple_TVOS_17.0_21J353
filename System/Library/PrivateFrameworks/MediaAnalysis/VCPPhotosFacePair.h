...
+ (id)pairWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x00600000002a0cf0
- (void).cxx_destruct;	// IMP=0x00000000002a0d97
...
- (id)initWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x00000000002a0c47
