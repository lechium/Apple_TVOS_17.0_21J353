...
+ (_Bool)supportVectorForward;	// IMP=0x00600000002b7adc
+ (_Bool)supportGPU;	// IMP=0x00600000002b7ad4
- (void).cxx_destruct;	// IMP=0x00000000002b7b66
...
- (int)execute;	// IMP=0x00000000002b7af2
- (id)initNewContext:(_Bool)arg1;	// IMP=0x00000000002b7ae4
