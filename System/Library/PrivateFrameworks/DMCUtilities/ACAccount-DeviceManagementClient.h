...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x0020000000000fb7
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x0010000000001de6
- (id)dmc_accountQuotaString;	// IMP=0x0010000000001861
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000001816
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x001000000000178a
