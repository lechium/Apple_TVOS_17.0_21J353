...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x0060000000006e42
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x0060000000006e20
- (void).cxx_destruct;	// IMP=0x0000000000006ebb
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x0000000000006449
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x00000000000050b2
- (void)dealloc;	// IMP=0x0000000000005056
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x0000000000004fb5
