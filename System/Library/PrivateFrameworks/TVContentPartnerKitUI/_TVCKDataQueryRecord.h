...
- (void).cxx_destruct;	// IMP=0x000000000001fa2b
...
- (void)invalidate;	// IMP=0x000000000001f975
- (id)initWithQuery:(id)arg1 priority:(long long)arg2 processAsync:(_Bool)arg3 withCompletionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000001f88e
