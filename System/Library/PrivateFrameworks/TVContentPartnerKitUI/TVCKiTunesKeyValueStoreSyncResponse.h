...
- (void).cxx_destruct;	// IMP=0x0000000000030bc6
...
- (id)_initWithSuccess:(_Bool)arg1 domainVersion:(id)arg2 peerPutItems:(id)arg3 putOKKeys:(id)arg4 rejectedKeys:(id)arg5;	// IMP=0x0000000000030a76
