...
- (void).cxx_destruct;	// IMP=0x000000000009b3cd
...
- (void)enumerateValuesForProperties:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000009b193
- (id)_uppDictionary;	// IMP=0x000000000009ae91
- (void)markAsUnwatched;	// IMP=0x000000000009ad9c
- (void)markAsWatched;	// IMP=0x000000000009ac6e
