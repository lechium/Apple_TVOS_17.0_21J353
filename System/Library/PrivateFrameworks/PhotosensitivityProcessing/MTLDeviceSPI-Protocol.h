...
- (MTLTileRenderPipelineDescriptor *)newTileRenderPipelineDescriptorWithSerializedData:(OS_dispatch_data *)arg1 deserializationContext:(id <MTLDeserializationContext>)arg2;
...
- (OS_dispatch_data *)serializeTileRenderPipelineDescriptor:(MTLTileRenderPipelineDescriptor *)arg1;
...
- (id <MTLFunction>)newFunctionWithGLESIR:(void *)arg1 inputsDescription:(OS_dispatch_data *)arg2 functionType:(unsigned long long)arg3;
- (id <MTLFunction>)newFunctionWithGLESIR:(void *)arg1 functionType:(unsigned long long)arg2;
- (id <MTLFunction>)newFunctionWithGLCoreIR:(void *)arg1 inputsDescription:(OS_dispatch_data *)arg2 functionType:(unsigned long long)arg3;
