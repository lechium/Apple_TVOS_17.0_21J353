...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002c659
- (void)setTruncated;	// IMP=0x000000000002c651
- (void)setPublic;	// IMP=0x000000000002c630
- (void)_initBlob;	// IMP=0x000000000002c582
