...
- (void).cxx_destruct;	// IMP=0x000000000004a963
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x000000000004a92f
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x000000000004a679
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004a0fd
