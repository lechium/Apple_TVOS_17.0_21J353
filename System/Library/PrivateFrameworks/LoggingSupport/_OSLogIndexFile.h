...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x00000000000172dd
- (_Bool)_determineTimespan;	// IMP=0x0000000000017122
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x0000000000016efd
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x0000000000016e39
- (void)dealloc;	// IMP=0x0000000000016dff
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016d3f
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016c0d
