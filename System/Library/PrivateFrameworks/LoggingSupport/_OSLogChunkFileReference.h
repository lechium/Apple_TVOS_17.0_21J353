...
- (void).cxx_destruct;	// IMP=0x0000000000016b66
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x0000000000016a36
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x00000000000167f0
- (void)dealloc;	// IMP=0x00000000000167b6
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x0000000000016737
