...
- (void).cxx_destruct;	// IMP=0x0000000000010e01
...
- (void)dealloc;	// IMP=0x0000000000010d8c
- (id)initWithSimualatedDevice:(id)arg1;	// IMP=0x0000000000010cd0
- (id)initWithMobileDevice:(void *)arg1 andUDID:(id)arg2;	// IMP=0x0000000000010c55
- (id)description;	// IMP=0x0000000000010a3b
- (id)init;	// IMP=0x00000000000109d0
