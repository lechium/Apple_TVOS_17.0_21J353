...
- (void).cxx_destruct;	// IMP=0x000000000003e7fe
...
- (id)stringForIndex:(id)arg1;	// IMP=0x000000000003e6be
- (id)indexForString:(id)arg1;	// IMP=0x000000000003e5b2
- (id)dataRepresentation;	// IMP=0x000000000003e19a
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x000000000003dd10
- (id)init;	// IMP=0x000000000003dcaa
