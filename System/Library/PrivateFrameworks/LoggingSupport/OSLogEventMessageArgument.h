...
{
    OSLogEventDecomposedMessage *_decomposedMessage;	// 8 = 0x8
    struct os_log_fmt_raw_placeholder *_rawArg;	// 16 = 0x10
    unsigned long long _sizeofLong;	// 24 = 0x18
}
...
- (id)initWithProxy:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x000000000000f13c
