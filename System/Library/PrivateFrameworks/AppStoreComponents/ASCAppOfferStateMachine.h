...
- (void).cxx_destruct;	// IMP=0x000000000000e952
...
- (void)invalidateTemporaryStateForcingUpdate:(_Bool)arg1;	// IMP=0x000000000000e799
- (void)installTemporaryWaitingState;	// IMP=0x000000000000e513
- (id)performActionWithActivity:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000000e457
- (void)offerStatusTextDidChange:(id)arg1;	// IMP=0x000000000000e385
- (void)offerStateDidChange:(id)arg1 withMetadata:(id)arg2 flags:(long long)arg3;	// IMP=0x000000000000e007
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000de53
- (void)removeDelegate:(id)arg1;	// IMP=0x000000000000dd46
- (void)addDelegate:(id)arg1;	// IMP=0x000000000000dad8
- (void)dealloc;	// IMP=0x000000000000d8e5
- (id)initWithOffer:(id)arg1 stateCenter:(id)arg2;	// IMP=0x000000000000d824
