...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000043dca
- (void).cxx_destruct;	// IMP=0x0000000000044ef4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000044666
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000442ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000442e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000440d5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000043dd2
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000043c18
