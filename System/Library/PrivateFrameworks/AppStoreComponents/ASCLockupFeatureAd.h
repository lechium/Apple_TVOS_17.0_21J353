...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001b1fa
- (void).cxx_destruct;	// IMP=0x000000000001bd2d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b720
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b59e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b40d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b202
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x000000000001b0a7
