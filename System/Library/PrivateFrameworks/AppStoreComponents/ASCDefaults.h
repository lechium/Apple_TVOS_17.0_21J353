...
+ (id)daemonDefaults;	// IMP=0x0040000000015648
- (void).cxx_destruct;	// IMP=0x0000000000016226
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x000000000001617e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016073
- (unsigned long long)hash;	// IMP=0x0000000000015ff8
...
- (id)objectForKey:(id)arg1;	// IMP=0x00000000000157a9
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000015727
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000000000156b4
