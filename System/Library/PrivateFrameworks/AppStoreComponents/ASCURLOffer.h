...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000047f7f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000048747
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000004844f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048444
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004827c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000047f87
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x0000000000047e11
