...
+ (id)log;	// IMP=0x0010000000004628
- (void).cxx_destruct;	// IMP=0x0000000000006f95
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000006e08
- (void)disappearIfNeeded;	// IMP=0x0000000000006c3e
@property(readonly, nonatomic) _Bool canDisappear;
- (void)appearIfNeeded;	// IMP=0x0000000000006590
@property(readonly, nonatomic) _Bool canAppear;
- (void)viewDidRetryFailedRequest;	// IMP=0x0000000000005d99
- (void)viewDidFailRequest:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000005a12
- (void)viewDidEndRenderWithPredicate:(id)arg1;	// IMP=0x00000000000057b6
- (void)viewDidAction;	// IMP=0x00000000000055cf
- (void)viewDidSetHidden;	// IMP=0x0000000000005472
- (void)viewDidMoveToWindow;	// IMP=0x000000000000518e
- (void)hostWillEnterForeground;	// IMP=0x00000000000050b3
- (void)hostDidEnterBackground;	// IMP=0x0000000000004fd8
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000489d
- (id)initWithView:(id)arg1;	// IMP=0x00000000000047f7
- (id)initWithView:(id)arg1 metrics:(id)arg2 notificationCenter:(id)arg3;	// IMP=0x0000000000004684
