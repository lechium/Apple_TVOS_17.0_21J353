...
- (void).cxx_destruct;	// IMP=0x00000000000174a0
...
- (void)reset;	// IMP=0x00000000000173dc
- (double)nextSleepTimeInterval;	// IMP=0x00000000000172fa
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000001727e
