...
+ (id)sharedContext;	// IMP=0x004000000003f4e4
- (void).cxx_destruct;	// IMP=0x000000000003fad8
...
- (id)description;	// IMP=0x000000000003f9a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003f773
- (unsigned long long)hash;	// IMP=0x000000000003f693
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x000000000003f5db
