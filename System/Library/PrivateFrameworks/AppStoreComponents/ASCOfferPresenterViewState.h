...
- (id)description;	// IMP=0x000000000003bc50
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003baad
- (unsigned long long)hash;	// IMP=0x000000000003b9fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003b9f0
- (id)initWithMetadata:(id)arg1 theme:(id)arg2;	// IMP=0x000000000003b937
