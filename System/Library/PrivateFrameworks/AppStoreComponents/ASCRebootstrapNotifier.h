...
+ (id)sharedNotifier;	// IMP=0x004000000003fb0b
...
- (void)postLocalNotification;	// IMP=0x000000000003ff1c
- (void)postLocalNotificationIfNeeded;	// IMP=0x000000000003fe8c
- (void)dealloc;	// IMP=0x000000000003fe30
- (id)_initSingleton;	// IMP=0x000000000003fb70
