...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000003330
- (void).cxx_destruct;	// IMP=0x00000000000045b3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003c5d
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000038a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000389d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000365d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003338
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0000000000003148
