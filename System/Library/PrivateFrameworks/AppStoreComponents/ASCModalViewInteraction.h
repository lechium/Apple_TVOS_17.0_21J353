...
- (void).cxx_destruct;	// IMP=0x0000000000032ec7
...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x0000000000032dca
- (void)invalidate;	// IMP=0x0000000000032b29
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000032646
- (void)dealloc;	// IMP=0x0000000000032608
- (id)initWithView:(id)arg1;	// IMP=0x000000000003258a
