...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000eb3c
- (void).cxx_destruct;	// IMP=0x000000000000faa5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000f355
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000f033
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000f028
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ee50
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000eb44
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x000000000000e9a4
