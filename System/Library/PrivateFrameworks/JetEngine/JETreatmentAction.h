...
+ (id)treatmentActionWithField:(id)arg1 configuration:(id)arg2 topic:(id)arg3;	// IMP=0x006000000002a125
- (void).cxx_destruct;	// IMP=0x000000000002b5f5
- (id)performAction:(id)arg1 context:(id)arg2;	// IMP=0x000000000002ad9d
- (void)performActionWithContext:(id)arg1;	// IMP=0x000000000002a777
- (id)initWithField:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000002a30b
