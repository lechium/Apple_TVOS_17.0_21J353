...
- (void).cxx_destruct;	// IMP=0x000000000005bfb0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005bf50
- (void)layoutSubviews;	// IMP=0x000000000005bbd0
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005b4b0
