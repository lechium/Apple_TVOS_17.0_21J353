...
- (void)stopAndInvalidateKeysWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000287080
- (void)processKeyWith:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000286f80
- (void)deregister;	// IMP=0x0000000000286ef0
- (void)register;	// IMP=0x0000000000286ed0
