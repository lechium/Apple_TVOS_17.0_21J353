...
@interface _EARResultContext : NSObject
{
    ...
    basic_string_d1f930f6 _prevBestRecogText;	// 72 = 0x48
...
- (id).cxx_construct;	// IMP=0x00000000000b2fdf
- (void).cxx_destruct;	// IMP=0x00000000000b2f6a
...
@property(nonatomic) basic_string_d1f930f6 prevBestRecogText; // @synthesize prevBestRecogText=_prevBestRecogText;
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000b2c15
- (id)description;	// IMP=0x00000000000b2b35
- (void)resetPartialResultContext;	// IMP=0x00000000000b2ae2
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000b29ff
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000b29f5
