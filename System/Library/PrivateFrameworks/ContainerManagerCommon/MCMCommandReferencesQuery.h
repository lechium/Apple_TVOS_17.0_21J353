...
+ (Class)incomingMessageClass;	// IMP=0x001000000005e421
+ (unsigned long long)command;	// IMP=0x001000000005e3eb
- (void).cxx_destruct;	// IMP=0x000000000005e1c3
...
- (void)execute;	// IMP=0x000000000005dc78
- (_Bool)preflightClientAllowed;	// IMP=0x000000000005dbe4
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000005dac5
