...
+ (Class)incomingMessageClass;	// IMP=0x001000000000cc72
+ (unsigned long long)command;	// IMP=0x001000000000cc3c
- (void).cxx_destruct;	// IMP=0x000000000000c9f4
...
- (id)_resolveUserIdentity;	// IMP=0x000000000000c682
- (void)execute;	// IMP=0x000000000000bb85
- (_Bool)preflightClientAllowed;	// IMP=0x000000000000baf1
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000000b9ab
