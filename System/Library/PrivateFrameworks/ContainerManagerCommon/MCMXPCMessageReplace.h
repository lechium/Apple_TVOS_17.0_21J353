...
- (void).cxx_destruct;	// IMP=0x000000000005fd0c
...
- (unsigned int)disposition;	// IMP=0x000000000005fbf6
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000005f7bc
