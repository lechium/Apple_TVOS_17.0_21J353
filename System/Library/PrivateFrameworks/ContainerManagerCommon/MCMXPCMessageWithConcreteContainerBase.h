...
- (void).cxx_destruct;	// IMP=0x000000000006d620
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000006d351
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x000000000006d2b6
