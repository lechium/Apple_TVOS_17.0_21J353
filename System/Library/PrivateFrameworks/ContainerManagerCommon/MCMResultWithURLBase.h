...
- (void).cxx_destruct;	// IMP=0x00000000000b0f56
...
- (void)dealloc;	// IMP=0x00000000000b0de3
- (id)initWithPath:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b0d19
- (id)initWithURL:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b0c56
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000b0ab2
