...
- (void).cxx_destruct;	// IMP=0x0000000000087e98
...
- (id)containerIdentityFromXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000087ba7
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000087ab4
