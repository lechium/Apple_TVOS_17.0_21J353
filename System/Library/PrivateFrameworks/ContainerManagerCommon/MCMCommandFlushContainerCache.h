...
+ (Class)incomingMessageClass;	// IMP=0x00100000000138e5
+ (unsigned long long)command;	// IMP=0x00100000000138af
- (void).cxx_destruct;	// IMP=0x0000000000013871
...
- (void)execute;	// IMP=0x00000000000135d7
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000013543
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000013452
