...
- (void).cxx_destruct;	// IMP=0x0000000000045864
...
- (id)initWithContainers:(id)arg1 clientIdentity:(id)arg2 issueSandboxExtensions:(_Bool)arg3 includePath:(_Bool)arg4 includeInfo:(_Bool)arg5 legacyPersonaPolicy:(_Bool)arg6 legacyExtensionPolicy:(_Bool)arg7 includeUserManagedAssetsRelPath:(_Bool)arg8;	// IMP=0x0000000000045563
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000451a1
- (void)_compileContainerDataForIndex:(unsigned long long)arg1 container:(struct container_object_s **)arg2 infos:(id)arg3 tokens:(id)arg4;	// IMP=0x0000000000044d47
