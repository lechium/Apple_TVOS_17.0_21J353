...
+ (Class)incomingMessageClass;	// IMP=0x00100000000301ab
+ (unsigned long long)command;	// IMP=0x0010000000030175
...
- (void)execute;	// IMP=0x000000000002f5a3
- (_Bool)preflightClientAllowed;	// IMP=0x000000000002f50f
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000002f3d8
