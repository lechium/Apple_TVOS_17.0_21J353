...
- (void).cxx_destruct;	// IMP=0x00000000000033e9
...
- (id)description;	// IMP=0x0000000000003229
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003192
- (unsigned long long)hash;	// IMP=0x0000000000003125
- (id)initWithMetadata:(id)arg1 codeSignIdentifiersToRemove:(id)arg2 manifest:(id)arg3;	// IMP=0x000000000000304d
