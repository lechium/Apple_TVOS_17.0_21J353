...
- (void).cxx_destruct;	// IMP=0x000000000008ca66
@property(retain, nonatomic) NSObject<OS_xpc_object> *xpcToMerge; // @synthesize xpcToMerge=_xpcToMerge;
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000008c836
- (void)mergeWithXPCResult:(id)arg1;	// IMP=0x000000000008c7f9
