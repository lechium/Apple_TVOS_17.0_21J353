...
+ (Class)incomingMessageClass;	// IMP=0x001000000008edfe
+ (unsigned long long)command;	// IMP=0x001000000008edc8
- (void).cxx_destruct;	// IMP=0x000000000008ed30
...
- (void)execute;	// IMP=0x000000000008e63b
- (_Bool)preflightClientAllowed;	// IMP=0x000000000008e53b
- (void)dealloc;	// IMP=0x000000000008e4b7
- (void)_commonInit:(id)arg1;	// IMP=0x000000000008e01f
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000008de7c
