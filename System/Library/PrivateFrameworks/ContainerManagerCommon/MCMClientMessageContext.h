...
- (void).cxx_destruct;	// IMP=0x0000000000088221
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087fc4
- (id)initForCurrentThreadContextWithXPCMessage:(id)arg1 userIdentityCache:(id)arg2;	// IMP=0x0000000000087ed6
