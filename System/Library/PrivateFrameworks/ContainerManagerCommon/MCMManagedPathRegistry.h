...
- (void).cxx_destruct;	// IMP=0x00000000000325ef
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x0000000000031dc5
- (void)_addPaths:(id)arg1;	// IMP=0x0000000000031d6c
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000000031b96
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x00000000000317fc
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x0000000000031663
