...
- (void).cxx_destruct;	// IMP=0x0000000000067e28
...
- (void)dealloc;	// IMP=0x0000000000067cf0
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x0000000000067ba0
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x0000000000067aa3
