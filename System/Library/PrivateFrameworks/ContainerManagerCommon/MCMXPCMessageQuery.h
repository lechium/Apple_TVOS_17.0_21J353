...
- (void).cxx_destruct;	// IMP=0x000000000008796b
...
- (unsigned int)disposition;	// IMP=0x0000000000087429
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000086a23
