...
- (id)description;	// IMP=0x00000000000b7904
- (unsigned long long)hash;	// IMP=0x00000000000b77af
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b747b
- (id)serialize;	// IMP=0x00000000000b71b9
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x00000000000b6f8d
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000000000b6f4e
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x00000000000b6e96
