...
+ (Class)incomingMessageClass;	// IMP=0x001000000009c50f
+ (unsigned long long)command;	// IMP=0x001000000009c4d9
- (void).cxx_destruct;	// IMP=0x000000000009c306
...
- (void)execute;	// IMP=0x000000000009bac8
- (_Bool)preflightClientAllowed;	// IMP=0x000000000009ba34
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000009b8e8
