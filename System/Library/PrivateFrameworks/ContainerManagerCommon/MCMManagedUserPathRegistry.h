...
- (void).cxx_destruct;	// IMP=0x0000000000032d23
...
- (void)_initPathPropertiesWithUserIdentity:(id)arg1;	// IMP=0x0000000000032875
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x00000000000326cc
