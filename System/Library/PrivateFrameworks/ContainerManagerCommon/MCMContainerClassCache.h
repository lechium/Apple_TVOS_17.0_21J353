...
- (void).cxx_destruct;	// IMP=0x000000000003b262
...
- (void)_handleUnrecoverableCorruptContainerPath:(id)arg1;	// IMP=0x000000000003ad5b
- (id)_setEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x000000000003ab24
- (id)_concurrent_generateCacheEntryWithURL:(id)arg1 identifier:(id)arg2 containerPath:(id)arg3 schemaVersion:(id)arg4 uuid:(id)arg5 metadata:(id)arg6;	// IMP=0x000000000003a9f0
- (id)_concurrent_slowGenerateCacheEntryWithFileHandle:(id)arg1 URL:(id)arg2 identifier:(id)arg3 uuid:(id)arg4 schemaVersion:(id)arg5 containerPath:(id)arg6;	// IMP=0x000000000003a5f7
- (void)_concurrent_processCorruptEntry:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003a2c8
- (void)_concurrent_processURL:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039ec1
- (void)_processCorruptEntries:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039dfe
- (void)_processURLs:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000039d3b
- (void)_queue_syncWithDisk;	// IMP=0x00000000000390ac
- (_Bool)_checkExistanceOfCacheEntry:(id)arg1 libraryRepair:(id)arg2;	// IMP=0x0000000000038f37
- (void)forceWriteThrough;	// IMP=0x0000000000038df8
- (void)asyncStartSynchronization;	// IMP=0x0000000000038d19
- (void)flush;	// IMP=0x0000000000038c55
- (void)waitForSynchronizationToComplete;	// IMP=0x0000000000038c06
- (_Bool)enumerateCacheEntriesWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x000000000003898d
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2 writeThrough:(_Bool)arg3;	// IMP=0x00000000000388d7
- (id)setCacheEntry:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0000000000038894
- (id)cacheEntryForIdentifier:(id)arg1;	// IMP=0x000000000003871d
- (id)initWithContainerClassPath:(id)arg1 cacheEntryClass:(Class)arg2 targetQueue:(id)arg3 userIdentityCache:(id)arg4;	// IMP=0x000000000003848c
