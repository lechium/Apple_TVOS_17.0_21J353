...
- (void).cxx_destruct;	// IMP=0x000000000008f794
...
- (id)initWithContainers:(id)arg1 includePath:(_Bool)arg2 includeInfo:(_Bool)arg3 includeUserManagedAssetsRelPath:(_Bool)arg4 clientIdentity:(id)arg5 skipSandboxExtensions:(_Bool)arg6;	// IMP=0x000000000008f47f
- (id)initWithContainerPaths:(id)arg1 containerIdentities:(id)arg2 includePath:(_Bool)arg3 clientIdentity:(id)arg4 skipSandboxExtensions:(_Bool)arg5;	// IMP=0x000000000008f340
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000008efc7
