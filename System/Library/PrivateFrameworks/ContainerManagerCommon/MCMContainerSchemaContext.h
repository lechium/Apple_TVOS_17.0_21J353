...
+ (id)contextWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x00600000000632de
- (void).cxx_destruct;	// IMP=0x0000000000063272
...
- (id)initWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x0000000000062f90
