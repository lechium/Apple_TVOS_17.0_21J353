...
+ (Class)incomingMessageClass;	// IMP=0x001000000006f087
+ (unsigned long long)command;	// IMP=0x001000000006f051
- (void).cxx_destruct;	// IMP=0x000000000006f013
...
- (void)execute;	// IMP=0x000000000006ea81
- (_Bool)preflightClientAllowed;	// IMP=0x000000000006e9ed
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000006e8fc
