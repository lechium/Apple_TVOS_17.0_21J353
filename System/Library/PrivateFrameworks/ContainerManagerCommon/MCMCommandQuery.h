...
+ (Class)incomingMessageClass;	// IMP=0x001000000008688d
+ (unsigned long long)command;	// IMP=0x0010000000086857
- (void).cxx_destruct;	// IMP=0x00000000000867e1
...
- (id)_containerIdentifiersIncludingUnownedForContainerClass:(unsigned long long)arg1 canAccessAllContainers:(_Bool *)arg2 error:(id *)arg3;	// IMP=0x0000000000085f7e
- (id)_setOfUserIdentities;	// IMP=0x00000000000858d8
- (id)_setOfUserIdentitiesForIdentifiers:(id)arg1 isGroupClass:(_Bool)arg2;	// IMP=0x0000000000084a08
- (id)_queryPlanWithIdentifiers:(id)arg1 isGroupClass:(_Bool)arg2 clientIdentity:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000842ad
- (_Bool)_executeQueryPlan:(id)arg1 resultContainers:(id)arg2 error:(id *)arg3;	// IMP=0x000000000008405a
- (id)_executeQueryForContainerIdentity:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000083d7f
- (void)execute;	// IMP=0x0000000000082a43
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000082981
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000082656
- (id)initWithPlatform:(unsigned int)arg1 explicitFlags:(unsigned long long)arg2 identifiers:(id)arg3 containerClass:(unsigned long long)arg4 groupIdentifiers:(id)arg5 internalUUID:(id)arg6 createIfNecessary:(_Bool)arg7 includeInfoInResult:(_Bool)arg8 includePathInResult:(_Bool)arg9 issueSandboxExtensions:(_Bool)arg10 UID:(unsigned int)arg11 userIdentity:(id)arg12 transient:(_Bool)arg13 fuzzyMatchTransient:(_Bool)arg14 fuzzyMatchInternalUUID:(_Bool)arg15 includeUnowned:(_Bool)arg16 expectSingleResult:(_Bool)arg17 legacyPersonaPolicy:(_Bool)arg18 includeUserManagedAssetsRelPath:(_Bool)arg19 context:(id)arg20 resultPromise:(id)arg21;	// IMP=0x000000000008243a
