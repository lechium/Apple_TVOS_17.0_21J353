...
- (void).cxx_destruct;	// IMP=0x000000000001d1b6
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001d10a
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001d0ba
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001d085
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x000000000001d02d
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x000000000001cffa
- (id)newCommandQueue;	// IMP=0x000000000001cfcc
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x000000000001cd7c
