...
- (void).cxx_destruct;	// IMP=0x000000000001d830
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001d79f
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001d74f
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001d71a
@property(readonly) id <MTLDevice> device;
- (id)commandBuffer;	// IMP=0x000000000001d6d4
- (id)commandBufferWithUnretainedReferences;	// IMP=0x000000000001d699
- (id)initWithCMMTLDevice:(id)arg1 descriptor:(id)arg2;	// IMP=0x000000000001d4f4
- (id)initWithCMMTLDevice:(id)arg1 maxCommandBufferCount:(unsigned long long)arg2;	// IMP=0x000000000001d366
- (id)initWithCMMTLDevice:(id)arg1;	// IMP=0x000000000001d1de
