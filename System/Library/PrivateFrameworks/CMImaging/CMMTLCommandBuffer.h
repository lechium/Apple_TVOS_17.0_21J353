...
- (void).cxx_destruct;	// IMP=0x000000000001e21d
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001e171
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001e121
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001e0ec
- (void)commit;	// IMP=0x000000000001daa9
- (id)initWithCMMTLCommandQueue:(id)arg1 unretained:(_Bool)arg2;	// IMP=0x000000000001d89d
- (void)waitUntilScheduled;	// IMP=0x000000000001d887
- (void)waitUntilCompleted;	// IMP=0x000000000001d871
