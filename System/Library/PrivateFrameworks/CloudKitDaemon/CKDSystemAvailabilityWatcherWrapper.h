...
- (void).cxx_destruct;	// IMP=0x000000000011fc67
...
- (id)description;	// IMP=0x000000000011fb29
- (unsigned long long)hash;	// IMP=0x000000000011fb1f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011fa9a
- (void)postSystemAvailabilityChanged:(unsigned long long)arg1;	// IMP=0x000000000011fa10
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000011f98d
