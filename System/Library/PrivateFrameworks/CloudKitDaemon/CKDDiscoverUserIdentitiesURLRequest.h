...
- (void).cxx_destruct;	// IMP=0x000000000027a0f5
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000279e2f
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000279192
- (id)generateRequestOperations;	// IMP=0x0000000000278f50
- (id)requestOperationClasses;	// IMP=0x0000000000278ee4
- (long long)databaseScope;	// IMP=0x0000000000278ed9
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000278ddc
- (id)initWithOperation:(id)arg1 lookupInfos:(id)arg2 adopterProvidedLookupInfos:(_Bool)arg3;	// IMP=0x0000000000278d31
