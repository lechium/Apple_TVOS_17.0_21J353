...
- (id)MMCSOptions;	// IMP=0x00000000002e23b4
- (_Bool)usesBackgroundSession;	// IMP=0x00000000002e2363
- (id)description;	// IMP=0x00000000002e2351
- (id)CKPropertiesDescription;	// IMP=0x00000000002e1e81
- (id)initWithOperation:(id)arg1;	// IMP=0x00000000002e1aa1
