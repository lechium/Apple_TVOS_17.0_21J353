...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000003693e4
- (void).cxx_destruct;	// IMP=0x000000000036dbf0
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000036d9f6
- (void)main;	// IMP=0x000000000036d8fa
- (id)assetOrPackageForMetadata:(id)arg1 inRecord:(id)arg2;	// IMP=0x000000000036d6f3
- (id)repairContainer;	// IMP=0x000000000036d339
- (void)_updateMissingAssetServerStatus;	// IMP=0x000000000036bdc9
- (void)_uploadAssetsModify;	// IMP=0x000000000036a20f
- (void)_fetchAssetMetadata;	// IMP=0x000000000036943a
- (_Bool)makeStateTransition;	// IMP=0x00000000003692d9
- (id)activityCreate;	// IMP=0x00000000003692b0
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000368c2c
