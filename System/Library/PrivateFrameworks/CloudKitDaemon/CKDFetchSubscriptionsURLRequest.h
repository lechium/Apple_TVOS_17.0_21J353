...
- (void).cxx_destruct;	// IMP=0x00000000001b447c
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001b41cf
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001b3b09
- (id)generateRequestOperations;	// IMP=0x00000000001b36e7
- (id)requestOperationClasses;	// IMP=0x00000000001b367b
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001b35b4
- (id)initWithOperation:(id)arg1 subscriptionIDs:(id)arg2;	// IMP=0x00000000001b34e9
