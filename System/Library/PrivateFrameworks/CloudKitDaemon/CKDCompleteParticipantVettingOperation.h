...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x0060000000102e00
- (void).cxx_destruct;	// IMP=0x0000000000104ee3
...
- (void)main;	// IMP=0x0000000000104d89
- (void)_verifyOONParticipant;	// IMP=0x0000000000104541
- (void)_reconstructShareURL;	// IMP=0x00000000001042f0
- (void)_forceFetchShareMetadata;	// IMP=0x0000000000103b9c
- (void)_performAuthKitVerification;	// IMP=0x0000000000103589
- (void)_reconstructShortToken;	// IMP=0x0000000000102ffb
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x0000000000102fe6
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x0000000000102ee8
- (_Bool)makeStateTransition;	// IMP=0x0000000000102ca4
- (id)activityCreate;	// IMP=0x0000000000102c7b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000102a54
