...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000002bfeba
- (void).cxx_destruct;	// IMP=0x00000000002c067d
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002c0586
- (void)main;	// IMP=0x00000000002bfecd
- (int)operationType;	// IMP=0x00000000002bfec2
- (void)_handleNotificationID:(id)arg1 withResponse:(id)arg2;	// IMP=0x00000000002bfbc6
- (id)activityCreate;	// IMP=0x00000000002bfb9d
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002bface
