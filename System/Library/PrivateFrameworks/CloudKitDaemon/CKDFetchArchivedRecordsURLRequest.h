...
- (void).cxx_destruct;	// IMP=0x0000000000288725
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002880f7
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000287d2f
- (id)_handleRecords:(id)arg1;	// IMP=0x0000000000287a22
- (id)generateRequestOperations;	// IMP=0x00000000002872f5
- (id)requestOperationClasses;	// IMP=0x0000000000287289
- (id)zoneIDsToLock;	// IMP=0x0000000000287277
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000002871e6
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000286ebd
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x0000000000286d07
