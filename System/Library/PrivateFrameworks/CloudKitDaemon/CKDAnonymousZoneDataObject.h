...
- (void).cxx_destruct;	// IMP=0x0000000000204006
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x0000000000203f5d
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x0000000000203eea
