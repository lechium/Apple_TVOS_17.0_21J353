...
- (void).cxx_destruct;	// IMP=0x00000000002fba71
...
- (void)requestDidComplete;	// IMP=0x00000000002fb822
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002fb311
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002faacf
- (id)_handleRecordChanges:(id)arg1 deltaChanges:(id)arg2 forZoneID:(id)arg3;	// IMP=0x00000000002f8d46
- (id)generateRequestOperations;	// IMP=0x00000000002f7ad7
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002f7acf
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002f7a62
- (id)requestOperationClasses;	// IMP=0x00000000002f79f6
- (id)zoneIDsToLock;	// IMP=0x00000000002f79e4
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002f79ca
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000002f7939
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002f7610
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002f7429
