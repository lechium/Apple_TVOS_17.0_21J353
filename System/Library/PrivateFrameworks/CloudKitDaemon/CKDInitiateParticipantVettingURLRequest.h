...
- (void).cxx_destruct;	// IMP=0x0000000000121585
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000012142d
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000121208
- (id)generateRequestOperations;	// IMP=0x0000000000120fa9
- (id)requestOperationClasses;	// IMP=0x0000000000120f3d
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x0000000000120e57
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000120d83
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x0000000000120c84
