...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000002be630
- (void).cxx_destruct;	// IMP=0x00000000002bec4a
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002be958
- (void)main;	// IMP=0x00000000002be914
- (void)_willRetryFetch;	// IMP=0x00000000002be71b
- (_Bool)_savePCSDataToCache;	// IMP=0x00000000002be713
- (_Bool)_saveUpdatedPCSToServer;	// IMP=0x00000000002be70b
- (_Bool)_decryptPCS;	// IMP=0x00000000002be703
- (_Bool)_fetchDependentPCS;	// IMP=0x00000000002be6fb
- (_Bool)_createAdditionalPCS;	// IMP=0x00000000002be6f3
- (_Bool)_fetchPCSDataFromServer;	// IMP=0x00000000002be6eb
- (_Bool)_fetchPCSDataFromDatabase;	// IMP=0x00000000002be6e3
- (_Bool)needsAdditionalPCSCreation;	// IMP=0x00000000002be6db
@property(readonly, nonatomic) _Bool hasAllPCSData;
@property(readonly, nonatomic) NSString *itemTypeName;
- (_Bool)makeStateTransition;	// IMP=0x00000000002bdb4f
- (_Bool)canBeUsedForOperation:(id)arg1 withOptions:(unsigned long long)arg2;	// IMP=0x00000000002bd9ff
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002bd901
