...
- (void).cxx_destruct;	// IMP=0x000000000028145b
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x000000000028132a
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002812bb
