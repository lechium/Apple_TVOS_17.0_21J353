...
- (void).cxx_destruct;	// IMP=0x0000000000371c42
...
- (void)cancelAllOperations;	// IMP=0x000000000037186b
- (void)requestFetchOfZoneWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003713ca
- (void)requestFetchOfShareWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000370ea8
- (void)requestFetchOfRecordWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000037081f
- (_Bool)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2;	// IMP=0x0000000000370294
- (id)_lockedGetQueuedFetchForOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x000000000036fc3d
- (void)_lockedRescheduleFetchTimer;	// IMP=0x000000000036f949
- (void)_lockedTearDownFetchTimer;	// IMP=0x000000000036f8c1
- (void)_lockedFetchesAreReady;	// IMP=0x000000000036eb8d
- (void)dealloc;	// IMP=0x000000000036eb4e
- (id)initWithContainer:(id)arg1;	// IMP=0x000000000036e88c
- (id)init;	// IMP=0x000000000036e82c
