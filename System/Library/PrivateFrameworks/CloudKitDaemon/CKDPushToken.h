...
- (void).cxx_destruct;	// IMP=0x00000000003829fc
...
- (unsigned long long)hash;	// IMP=0x000000000038295c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000038281c
- (id)initWithAPSEnvironmentString:(id)arg1 apsToken:(id)arg2;	// IMP=0x0000000000382763
