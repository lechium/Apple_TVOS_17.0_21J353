...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000024c304
- (void).cxx_destruct;	// IMP=0x000000000024e15b
...
- (void)_serialize;	// IMP=0x000000000024d09a
- (void)_setupTranslator;	// IMP=0x000000000024ccc2
- (void)_preflightRecords;	// IMP=0x000000000024c676
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000024c580
- (_Bool)validateAgainstLiveContainer:(id)arg1 error:(id *)arg2;	// IMP=0x000000000024c36e
- (void)main;	// IMP=0x000000000024c35a
- (_Bool)makeStateTransition;	// IMP=0x000000000024c1f7
- (id)activityCreate;	// IMP=0x000000000024c1ce
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024c10c
