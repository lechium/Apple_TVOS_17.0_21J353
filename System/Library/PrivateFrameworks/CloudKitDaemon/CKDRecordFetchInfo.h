...
- (void).cxx_destruct;	// IMP=0x0000000000232893
...
- (id)description;	// IMP=0x00000000002327a6
- (id)CKPropertiesDescription;	// IMP=0x0000000000232461
- (void)performCallback;	// IMP=0x00000000002320b8
- (id)initWithAggregator:(id)arg1;	// IMP=0x0000000000231fd3
