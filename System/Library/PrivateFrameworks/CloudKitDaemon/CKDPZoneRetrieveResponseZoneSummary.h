...
- (void).cxx_destruct;	// IMP=0x0000000000143d14
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001439a1
- (unsigned long long)hash;	// IMP=0x00000000001437e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000143521
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001432fb
- (void)copyTo:(id)arg1;	// IMP=0x0000000000143145
- (void)writeTo:(id)arg1;	// IMP=0x0000000000142f85
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000142f78
- (id)dictionaryRepresentation;	// IMP=0x000000000014253e
- (id)description;	// IMP=0x000000000014248f
