...
- (void).cxx_destruct;	// IMP=0x0000000000237826
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000002375c9
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000023750c
- (void)_finishRecordFetchAggregator;	// IMP=0x0000000000237104
- (void)finishIfAppropriate;	// IMP=0x0000000000236fc6
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000236ca8
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002360e6
- (void)main;	// IMP=0x0000000000235e3f
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x00000000002359ea
- (void)_recordFetchesAvailable;	// IMP=0x0000000000235920
- (void)_lockedSendFetchRequest;	// IMP=0x0000000000233d11
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x0000000000233ca1
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x0000000000233adf
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x000000000023386f
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x00000000002335fe
- (int)operationType;	// IMP=0x00000000002335f6
- (id)description;	// IMP=0x00000000002335e4
- (id)CKPropertiesDescription;	// IMP=0x0000000000233081
- (void)dealloc;	// IMP=0x0000000000233026
- (id)activityCreate;	// IMP=0x0000000000232ffd
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000232a2c
