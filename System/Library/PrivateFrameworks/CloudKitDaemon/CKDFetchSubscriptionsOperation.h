...
- (void).cxx_destruct;	// IMP=0x00000000001b83df
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001b8312
- (void)main;	// IMP=0x00000000001b7c25
- (int)operationType;	// IMP=0x00000000001b7c1a
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x00000000001b7882
- (id)activityCreate;	// IMP=0x00000000001b7859
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001b77ae
