...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002a80d6
- (void).cxx_destruct;	// IMP=0x00000000002a85cc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002a823a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002a80de
