...
- (void).cxx_destruct;	// IMP=0x000000000009231f
...
- (id)CKPropertiesDescription;	// IMP=0x0000000000092277
- (id)description;	// IMP=0x0000000000092265
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x0000000000092159
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x0000000000092063
