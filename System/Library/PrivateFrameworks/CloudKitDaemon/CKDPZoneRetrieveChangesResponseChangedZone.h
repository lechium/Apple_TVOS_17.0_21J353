...
- (void).cxx_destruct;	// IMP=0x0000000000255a3e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000025589a
- (unsigned long long)hash;	// IMP=0x00000000002557b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000255652
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025552e
- (void)copyTo:(id)arg1;	// IMP=0x000000000025544b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000255361
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000255354
- (id)dictionaryRepresentation;	// IMP=0x0000000000254cdc
- (id)description;	// IMP=0x0000000000254c2d
...
- (int)StringAsDeleteType:(id)arg1;	// IMP=0x0000000000254b1b
- (id)deleteTypeAsString:(int)arg1;	// IMP=0x0000000000254ad0
@property(nonatomic) _Bool hasDeleteType;
@property(nonatomic) int deleteType; // @synthesize deleteType=_deleteType;
- (int)StringAsChangeType:(id)arg1;	// IMP=0x00000000002549fa
- (id)changeTypeAsString:(int)arg1;	// IMP=0x00000000002549a4
