...
- (void).cxx_destruct;	// IMP=0x000000000023bee4
...
- (void)main;	// IMP=0x000000000023b5ef
- (int)operationType;	// IMP=0x000000000023b5e4
- (id)activityCreate;	// IMP=0x000000000023b5bb
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000023b50a
