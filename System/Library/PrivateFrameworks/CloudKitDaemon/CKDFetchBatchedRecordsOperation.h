...
- (void).cxx_destruct;	// IMP=0x00000000002a8061
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000002a7ed7
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x00000000002a7e5d
- (void)_noteOperationEnding;	// IMP=0x00000000002a7de3
- (void)_noteOperationBeginning;	// IMP=0x00000000002a7d69
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x00000000002a7cef
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x00000000002a7c72
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x00000000002a7bf5
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x00000000002a7b7b
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x00000000002a7b01
- (id)activityCreate;	// IMP=0x00000000002a7a84
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x00000000002a79ff
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002a78b4
- (void)main;	// IMP=0x00000000002a6d34
- (id)_possiblyWrapError:(id)arg1 forRecordWithID:(id)arg2 withCode:(long long)arg3 format:(id)arg4;	// IMP=0x00000000002a6b1a
- (void)_sendFetchChangesRequestForZoneIDs:(id)arg1 withOptions:(id)arg2 previousRequestSchedulerInfo:(id)arg3;	// IMP=0x00000000002a5bd5
- (void)_handleRecordDelete:(id)arg1 recordType:(id)arg2 perRequestSchedulerInfo:(id)arg3;	// IMP=0x00000000002a5934
- (void)_handleChangedRecords:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000002a4a1d
- (void)_handleFetchChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000002a49a3
- (id)relevantZoneIDs;	// IMP=0x00000000002a498e
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002a481b
