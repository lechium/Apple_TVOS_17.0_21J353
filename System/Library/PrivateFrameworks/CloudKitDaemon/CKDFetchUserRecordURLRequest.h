...
- (void).cxx_destruct;	// IMP=0x00000000001d1c98
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001d1815
- (id)generateRequestOperations;	// IMP=0x00000000001d1747
- (id)requestOperationClasses;	// IMP=0x00000000001d16db
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001d16ac
