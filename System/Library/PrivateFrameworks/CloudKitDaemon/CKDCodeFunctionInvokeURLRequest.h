...
- (void).cxx_destruct;	// IMP=0x00000000001b3463
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001b32c6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001b2f73
- (id)generateRequestOperations;	// IMP=0x00000000001b2a81
- (_Bool)requestGETPreAuth;	// IMP=0x00000000001b2a36
- (id)requestOperationClasses;	// IMP=0x00000000001b29ca
- (long long)databaseScope;	// IMP=0x00000000001b292a
- (id)additionalHeaderValues;	// IMP=0x00000000001b282b
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000001b2811
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001b273d
- (id)initWithOperation:(id)arg1 serviceName:(id)arg2 functionName:(id)arg3 serializedParameters:(id)arg4 attestationEntropy:(id)arg5 pccWrappedInvocationKeys:(id)arg6 trustedTargetWrappedInvocationKey:(id)arg7;	// IMP=0x00000000001b25f5
