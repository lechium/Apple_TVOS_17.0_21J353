...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000191418
- (unsigned long long)hash;	// IMP=0x000000000019137a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000191259
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019118d
- (void)copyTo:(id)arg1;	// IMP=0x00000000001910e4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000191011
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000191004
- (id)dictionaryRepresentation;	// IMP=0x0000000000190a0c
- (id)description;	// IMP=0x000000000019095d
