...
- (void).cxx_destruct;	// IMP=0x0000000000313d14
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x00000000003139b5
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x000000000031383f
- (id)init;	// IMP=0x00000000003137c3
