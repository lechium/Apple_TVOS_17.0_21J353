...
- (void)main;	// IMP=0x0000000000119979
- (int)operationType;	// IMP=0x000000000011996e
- (id)activityCreate;	// IMP=0x0000000000119945
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000119916
