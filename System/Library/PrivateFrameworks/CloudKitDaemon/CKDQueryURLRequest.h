...
- (void).cxx_destruct;	// IMP=0x000000000010aba3
...
- (void)requestDidComplete;	// IMP=0x000000000010a993
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000010a6b8
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000109eb8
- (id)generateRequestOperations;	// IMP=0x00000000001092ae
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000010924c
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x0000000000109244
- (id)zoneIDsToLock;	// IMP=0x0000000000109186
- (_Bool)requestGETPreAuth;	// IMP=0x0000000000109119
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000001090ff
- (id)requestOperationClasses;	// IMP=0x0000000000109093
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x0000000000108fa5
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000108e9c
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x0000000000108d16
