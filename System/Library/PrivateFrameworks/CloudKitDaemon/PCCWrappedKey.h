...
- (void).cxx_destruct;	// IMP=0x0000000000392804
...
- (void)dealloc;	// IMP=0x0000000000392786
- (void)clear;	// IMP=0x0000000000392780
- (id)data;	// IMP=0x0000000000392756
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x0000000000391fba
