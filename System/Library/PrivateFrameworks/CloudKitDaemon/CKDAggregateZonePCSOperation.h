...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x0060000000275a64
- (void).cxx_destruct;	// IMP=0x0000000000278aaf
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000278831
- (void)_setPermanentFailure;	// IMP=0x00000000002785ad
- (void)_handleZoneSavedWithID:(id)arg1 responseCode:(id)arg2;	// IMP=0x0000000000277978
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x0000000000277766
- (void)_sychronizeUserKeyRegistryIfNeeded;	// IMP=0x00000000002772df
- (int)operationType;	// IMP=0x00000000002772d4
- (_Bool)_saveTargetZone;	// IMP=0x0000000000276b74
- (void)_prepareTargetZonePCS;	// IMP=0x00000000002763a6
- (void)_fetchPCSDataForZoneID:(id)arg1;	// IMP=0x0000000000275d70
- (void)_fetchZonePCS;	// IMP=0x0000000000275ace
- (void)main;	// IMP=0x0000000000275aba
- (_Bool)makeStateTransition;	// IMP=0x0000000000275850
- (id)relevantZoneIDs;	// IMP=0x000000000027575d
- (id)activityCreate;	// IMP=0x0000000000275734
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000275610
