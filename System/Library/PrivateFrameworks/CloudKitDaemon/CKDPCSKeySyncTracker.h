...
@interface CKDPCSKeySyncTracker : NSObject
{
    ...
    NSString *_requestorOperationID;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x00000000001b4eec
...
- (void)waitOnSyncWithQueue:(id)arg1 waiterOperationID:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001b4aec
