...
- (void).cxx_destruct;	// IMP=0x00000000000ff23c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ff209
- (unsigned long long)hash;	// IMP=0x00000000000ff1ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fef7d
- (id)description;	// IMP=0x00000000000fef6b
- (id)CKPropertiesDescription;	// IMP=0x00000000000fed58
@property(readonly, nonatomic) _Bool isCrossOwner;
- (id)initWithDestinationZoneID:(id)arg1 destinationDatabaseScope:(long long)arg2 sourceZoneID:(id)arg3 sourceDatabaseScope:(long long)arg4;	// IMP=0x00000000000fec11
- (id)initWithDestinationZoneID:(id)arg1 destinationDatabaseScope:(long long)arg2;	// IMP=0x00000000000febf9
