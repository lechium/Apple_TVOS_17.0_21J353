...
- (void).cxx_destruct;	// IMP=0x000000000031dad3
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000031d753
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000031d132
- (id)generateRequestOperations;	// IMP=0x000000000031cc6f
- (id)anonymousUserIDForHTTPHeader;	// IMP=0x000000000031cbf5
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000031cbed
- (id)requestOperationClasses;	// IMP=0x000000000031cb81
- (id)zoneIDsToLock;	// IMP=0x000000000031cab7
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000031ca9d
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000031ca0c
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000031c924
- (id)initWithOperation:(id)arg1 mergeableValueIDs:(id)arg2 previousContinuationTokens:(id)arg3;	// IMP=0x000000000031c82c
