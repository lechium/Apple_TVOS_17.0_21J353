...
- (void).cxx_destruct;	// IMP=0x0000000000376eb2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000376bc9
- (unsigned long long)hash;	// IMP=0x0000000000376a52
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000376802
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037660b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000376487
- (void)writeTo:(id)arg1;	// IMP=0x000000000037630d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000376300
- (id)dictionaryRepresentation;	// IMP=0x0000000000375b70
- (id)description;	// IMP=0x0000000000375ac1
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000037590b
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x00000000003758c2
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x00000000003757f3
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000037579e
