...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000007abdc
- (void).cxx_destruct;	// IMP=0x000000000007ce39
...
- (void)_postflightRecords;	// IMP=0x000000000007c8ca
- (void)_deserialize;	// IMP=0x000000000007b358
- (void)_setupTranslator;	// IMP=0x000000000007af80
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000007ae58
- (_Bool)validateAgainstLiveContainer:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007ac46
- (void)main;	// IMP=0x000000000007ac32
- (_Bool)makeStateTransition;	// IMP=0x000000000007aad0
- (id)activityCreate;	// IMP=0x000000000007aaa7
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000007aa18
