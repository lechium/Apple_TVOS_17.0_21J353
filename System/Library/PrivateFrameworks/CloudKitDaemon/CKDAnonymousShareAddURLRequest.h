...
- (void).cxx_destruct;	// IMP=0x00000000002fc2c2
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002fc111
- (id)generateRequestOperations;	// IMP=0x00000000002fbd1f
- (id)requestOperationClasses;	// IMP=0x00000000002fbcb3
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002fbbcb
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToAdd:(id)arg2;	// IMP=0x00000000002fbb32
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002fbb2a
