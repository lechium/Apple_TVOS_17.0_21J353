...
+ (unsigned long long)_sizeForItem:(id)arg1;	// IMP=0x006000000036dcba
- (void).cxx_destruct;	// IMP=0x000000000036e804
...
- (double)updateProgressWithItem:(id)arg1 progress:(double)arg2;	// IMP=0x000000000036e503
- (unsigned long long)_updateTotalCompletedBytes;	// IMP=0x000000000036e42b
- (unsigned long long)_updateTotalBytes;	// IMP=0x000000000036e34c
- (void)stopTrackingItems:(id)arg1;	// IMP=0x000000000036e0db
- (void)startTrackingItems:(id)arg1;	// IMP=0x000000000036de64
- (id)initWithTrackingID:(id)arg1;	// IMP=0x000000000036de0a
- (id)init;	// IMP=0x000000000036dda4
