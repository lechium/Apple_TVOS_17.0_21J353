...
- (void).cxx_destruct;	// IMP=0x00000000002ae497
...
- (id)analyticsPayload;	// IMP=0x00000000002ae1c0
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002ae125
- (void)main;	// IMP=0x00000000002adf58
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x00000000002ad37e
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000002ab47b
- (int)operationType;	// IMP=0x00000000002ab470
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000002aaf94
- (id)activityCreate;	// IMP=0x00000000002aaf6b
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x00000000002aadd9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002aab65
