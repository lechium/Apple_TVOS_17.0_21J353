...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000002afb54
- (void).cxx_destruct;	// IMP=0x00000000002bcaac
...
- (id)relevantZoneIDs;	// IMP=0x00000000002bc46b
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000002bc463
- (void)main;	// IMP=0x00000000002bc133
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002bbe8a
- (void)finishWithError:(id)arg1;	// IMP=0x00000000002bbdfa
- (void)_downloadMergeableValues;	// IMP=0x00000000002bb0b1
- (void)_downloadAssets;	// IMP=0x00000000002b96db
- (void)_fetchCloudCerts;	// IMP=0x00000000002b9020
- (void)_didDownloadAssetsWithError:(id)arg1;	// IMP=0x00000000002b8e4a
- (void)_finishAllDownloadTasksWithError:(id)arg1;	// IMP=0x00000000002b8d2a
- (void)_addMergeableValueDownloadTasksForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b8534
- (void)_addAssetDownloadTaskForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b69fb
- (void)_addDownloadTasksForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b675b
- (int)_prepareAsset:(id)arg1 record:(id)arg2 recordKey:(id)arg3 assetTransferOptions:(id)arg4;	// IMP=0x00000000002b5e71
- (void)_decryptPropertiesIfNeededForRecord:(id)arg1 record:(id)arg2;	// IMP=0x00000000002b5d96
- (void)_handleSharePCSPrepForShare:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002b54ea
- (void)_handleRecordFetch:(id)arg1 recordID:(id)arg2 etagMatched:(_Bool)arg3 responseCode:(id)arg4;	// IMP=0x00000000002b4475
- (void)_fetchPCSForMergeableValueDeltaRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002b3f74
- (void)_reallyDecryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002b39db
- (void)_decryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002b3951
...
- (void)_continueHandleFetchedRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002b228d
- (void)setError:(id)arg1 forRecordID:(id)arg2;	// IMP=0x00000000002b2182
- (id)errorForRecordID:(id)arg1;	// IMP=0x00000000002b20b2
- (void)fetchRecordsWithIDs:(id)arg1 andFullRecords:(id)arg2;	// IMP=0x00000000002b08b6
- (int)operationType;	// IMP=0x00000000002b08ab
- (void)_findSpecialParticipantsOnShare:(id)arg1 identityDelegate:(id)arg2;	// IMP=0x00000000002b0416
- (void)_saveUpdatedShareRecords;	// IMP=0x00000000002aff4e
- (id)desiredIndexedListKeys;	// IMP=0x00000000002afbaa
- (_Bool)makeStateTransition;	// IMP=0x00000000002af7e2
- (id)activityCreate;	// IMP=0x00000000002af7b9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002af386
