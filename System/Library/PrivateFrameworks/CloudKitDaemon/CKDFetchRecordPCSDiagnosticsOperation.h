...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x0060000000099ad1
- (void).cxx_destruct;	// IMP=0x000000000009aa1e
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000009a877
- (void)main;	// IMP=0x000000000009a6a8
@property(readonly, nonatomic) NSArray *corruptRecords;
- (void)_fetchZones;	// IMP=0x000000000009a1dd
- (void)_checkRecordPCSForAllZones;	// IMP=0x0000000000099b33
- (_Bool)makeStateTransition;	// IMP=0x0000000000099a00
- (id)activityCreate;	// IMP=0x00000000000999d7
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000099908
