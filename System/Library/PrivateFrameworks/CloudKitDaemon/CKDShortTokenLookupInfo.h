...
- (void).cxx_destruct;	// IMP=0x000000000013611f
...
- (unsigned long long)hash;	// IMP=0x0000000000135ff4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000135cbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000135bd1
