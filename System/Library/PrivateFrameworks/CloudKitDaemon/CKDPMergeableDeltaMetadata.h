...
+ (Class)replacedDeltaIdentifiersType;	// IMP=0x001000000034b08e
- (void).cxx_destruct;	// IMP=0x000000000034c02a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000034bd2c
- (unsigned long long)hash;	// IMP=0x000000000034bc73
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000034bb0f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000034b895
- (void)copyTo:(id)arg1;	// IMP=0x000000000034b737
- (void)writeTo:(id)arg1;	// IMP=0x000000000034b571
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000034b564
- (id)dictionaryRepresentation;	// IMP=0x000000000034b14e
- (id)description;	// IMP=0x000000000034b09f
- (id)replacedDeltaIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x000000000034b071
- (unsigned long long)replacedDeltaIdentifiersCount;	// IMP=0x000000000034b054
- (void)addReplacedDeltaIdentifiers:(id)arg1;	// IMP=0x000000000034afea
- (void)clearReplacedDeltaIdentifiers;	// IMP=0x000000000034afcd
