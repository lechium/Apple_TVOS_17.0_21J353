...
- (void).cxx_destruct;	// IMP=0x00000000002e4e84
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002e4d4d
- (unsigned long long)hash;	// IMP=0x00000000002e4cc9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e4bbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e4ad3
- (void)copyTo:(id)arg1;	// IMP=0x00000000002e4a30
- (void)writeTo:(id)arg1;	// IMP=0x00000000002e4999
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002e498c
- (id)dictionaryRepresentation;	// IMP=0x00000000002e46f7
- (id)description;	// IMP=0x00000000002e4648
