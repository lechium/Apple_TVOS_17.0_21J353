...
- (void).cxx_destruct;	// IMP=0x0000000000368bd9
...
- (id)description;	// IMP=0x0000000000368b17
- (id)CKPropertiesDescription;	// IMP=0x00000000003689a6
- (_Bool)isEmptyOfRereferencesAssets;	// IMP=0x00000000003688bb
- (_Bool)isEmptyOfAssets;	// IMP=0x00000000003687d0
- (_Bool)isRereferenceAssetBatch;	// IMP=0x00000000003686bf
- (_Bool)isPackageSectionBatch;	// IMP=0x00000000003685ae
- (id)firstMMCSItemError;	// IMP=0x000000000036845f
- (void)failIfNotDoneAllRegularAndSectionAndRereferenceItemsWithError:(id)arg1;	// IMP=0x00000000003682b2
@property(readonly, nonatomic) NSArray *allRegularAndSectionAndRereferenceItems;
- (id)allMMCSAndSectionItems;	// IMP=0x000000000036807b
...
- (void)addAssetRecord:(id)arg1;	// IMP=0x0000000000367e80
- (id)initWithAssetZone:(id)arg1;	// IMP=0x0000000000367dfb
