...
- (void).cxx_destruct;	// IMP=0x000000000033455f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000334448
- (unsigned long long)hash;	// IMP=0x0000000000334404
- (void)dealloc;	// IMP=0x00000000003343bd
