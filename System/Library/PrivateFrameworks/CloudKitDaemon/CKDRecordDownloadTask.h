...
- (void).cxx_destruct;	// IMP=0x00000000002af24e
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x00000000002aecb7
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x00000000002aeb93
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x00000000002ae9cd
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 packageIndexSets:(id)arg5 assetURLInfosToFillOut:(id)arg6;	// IMP=0x00000000002ae530
