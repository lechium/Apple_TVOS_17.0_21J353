...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000000f2d1c
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000000f0073
- (void).cxx_destruct;	// IMP=0x00000000000f35b0
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000f2f6c
- (void)main;	// IMP=0x00000000000f2d24
- (void)_fetchRecords;	// IMP=0x00000000000f2512
- (void)_handleRecordFetched:(id)arg1 recordID:(id)arg2 error:(id)arg3;	// IMP=0x00000000000f1619
- (struct _PCSIdentityData *)_copyShareProtectionFromRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f119c
- (void)_saveRecords;	// IMP=0x00000000000f0730
- (void)_handleRecordSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000000f00d5
- (_Bool)makeStateTransition;	// IMP=0x00000000000efedf
- (id)activityCreate;	// IMP=0x00000000000efeb6
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000efd8d
