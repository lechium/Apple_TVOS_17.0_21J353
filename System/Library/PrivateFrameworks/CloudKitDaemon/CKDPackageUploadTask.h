...
- (void).cxx_destruct;	// IMP=0x000000000031ffb2
...
- (void)cancel;	// IMP=0x000000000031fec8
...
- (id)activityCreate;	// IMP=0x000000000031fc5c
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x000000000031fab6
