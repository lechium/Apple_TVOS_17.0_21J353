...
- (void).cxx_destruct;	// IMP=0x00000000000ab787
...
- (void)start;	// IMP=0x00000000000aa823
- (void)createFetchOperationForItemIDs:(id)arg1 operationQueue:(id)arg2 operationConfigurationBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000aa7a9
- (_Bool)dependentOperationListContainsOperationID:(id)arg1;	// IMP=0x00000000000aa6f1
- (_Bool)dependentOperationListContainsRunningFetch:(id)arg1;	// IMP=0x00000000000aa581
- (_Bool)canBeUsedForPendingFetch:(id)arg1;	// IMP=0x00000000000aa4b4
- (_Bool)canBeUsedForOperation:(id)arg1;	// IMP=0x00000000000aa400
- (id)description;	// IMP=0x00000000000aa3ee
- (id)CKPropertiesDescription;	// IMP=0x00000000000aa2bc
- (void)cancelFetchOperation;	// IMP=0x00000000000aa215
- (void)finishFetchOperationWithError:(id)arg1;	// IMP=0x00000000000a9d4d
- (void)performCallbacksForItemWithID:(id)arg1 withItem:(id)arg2 error:(id)arg3;	// IMP=0x00000000000a992e
- (id)allItemIDs;	// IMP=0x00000000000a986a
- (id)callbacksForItemWithID:(id)arg1;	// IMP=0x00000000000a9777
- (void)removeCallbacksForItemWithID:(id)arg1;	// IMP=0x00000000000a9477
- (void)addCallbackForItemWithID:(id)arg1 operation:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x00000000000a90ac
- (int)numberOfCallbacks;	// IMP=0x00000000000a8ec2
@property(nonatomic) _Bool isCancelled; // @synthesize isCancelled=_isCancelled;
@property(nonatomic) _Bool isFinished; // @synthesize isFinished=_isFinished;
- (id)initWithOperation:(id)arg1 container:(id)arg2 operationQueue:(id)arg3;	// IMP=0x00000000000a8846
- (id)init;	// IMP=0x00000000000a87e6
