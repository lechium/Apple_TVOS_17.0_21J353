...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000350930
+ (id)dataWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00100000003504bb
+ (id)dataWithShare:(id)arg1 serviceType:(unsigned long long)arg2;	// IMP=0x001000000035021c
- (void).cxx_destruct;	// IMP=0x00000000003512ba
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000350de7
- (id)itemID;	// IMP=0x0000000000350dd5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000350b76
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000350938
- (id)CKPropertiesDescription;	// IMP=0x0000000000350758
@property(nonatomic) struct _OpaquePCSShareProtection *invitedPCS;
- (void)dealloc;	// IMP=0x0000000000350531
- (id)initWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00000000003501a4
