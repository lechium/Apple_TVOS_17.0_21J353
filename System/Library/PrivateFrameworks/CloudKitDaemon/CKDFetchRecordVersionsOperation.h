...
- (void).cxx_destruct;	// IMP=0x00000000002e7480
...
- (id)relevantZoneIDs;	// IMP=0x00000000002e71b1
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002e6e0f
- (void)main;	// IMP=0x00000000002e6960
- (int)operationType;	// IMP=0x00000000002e6955
- (void)_handleRecordVersionsFetchedForID:(id)arg1 isDeleted:(_Bool)arg2 versions:(id)arg3 responseCode:(id)arg4;	// IMP=0x00000000002e5c24
- (_Bool)hasDecryptOperation;	// IMP=0x00000000002e5be3
@property(readonly, nonatomic) CKDDecryptRecordsOperation *recordDecryptOperation;
- (id)activityCreate;	// IMP=0x00000000002e596d
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002e5773
