...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001cf807
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001cf70b
+ (Class)localizedArgumentsType;	// IMP=0x00100000001cf5bb
- (void).cxx_destruct;	// IMP=0x00000000001d15c0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001d0f6b
- (unsigned long long)hash;	// IMP=0x00000000001d0dfa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d0b62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d0581
- (void)copyTo:(id)arg1;	// IMP=0x00000000001d025b
- (void)writeTo:(id)arg1;	// IMP=0x00000000001cfe49
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001cfe3c
- (id)dictionaryRepresentation;	// IMP=0x00000000001cf8c7
- (id)description;	// IMP=0x00000000001cf818
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001cf7ea
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x00000000001cf7cd
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001cf763
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000001cf746
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001cf6ee
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x00000000001cf6d1
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001cf667
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000001cf64a
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001cf59e
- (unsigned long long)localizedArgumentsCount;	// IMP=0x00000000001cf581
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x00000000001cf517
- (void)clearLocalizedArguments;	// IMP=0x00000000001cf4fa
