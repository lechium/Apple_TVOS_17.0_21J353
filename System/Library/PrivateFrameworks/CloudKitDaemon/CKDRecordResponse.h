...
- (void).cxx_destruct;	// IMP=0x0000000000278cfe
...
- (id)description;	// IMP=0x0000000000278cce
- (id)CKPropertiesDescription;	// IMP=0x0000000000278bff
- (id)initWithRecordID:(id)arg1 record:(id)arg2 etag:(id)arg3;	// IMP=0x0000000000278b24
