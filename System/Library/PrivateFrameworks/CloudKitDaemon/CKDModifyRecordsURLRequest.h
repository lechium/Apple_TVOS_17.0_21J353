...
- (void).cxx_destruct;	// IMP=0x0000000000360790
...
- (void)requestDidComplete;	// IMP=0x000000000035ffd9
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000035fa0b
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000035ec25
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x000000000035e4fe
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000035d368
- (id)generateRequestOperations;	// IMP=0x000000000035abd5
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x000000000035abc3
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000035abbb
- (int)isolationLevel;	// IMP=0x000000000035ab9e
- (id)requestOperationClasses;	// IMP=0x000000000035aa84
- (id)zoneIDsToLock;	// IMP=0x000000000035a748
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000035a72e
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000035a628
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000035a4b9
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x000000000035a28c
