...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000034da24
- (void).cxx_destruct;	// IMP=0x000000000034dcc6
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000034db57
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000034da2c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000034d8cf
- (id)description;	// IMP=0x000000000034d8bd
- (id)CKPropertiesDescription;	// IMP=0x000000000034d776
...
- (_Bool)shouldEncodePCSData;	// IMP=0x000000000034d672
- (void)dealloc;	// IMP=0x000000000034d62b
- (id)initWithPCSData:(id)arg1;	// IMP=0x000000000034d5b8
