...
- (void).cxx_destruct;	// IMP=0x000000000016b751
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016ac69
- (unsigned long long)hash;	// IMP=0x000000000016a725
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000169e5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000169638
- (void)copyTo:(id)arg1;	// IMP=0x0000000000168ff5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000168a45
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000168a38
- (id)dictionaryRepresentation;	// IMP=0x0000000000166a62
- (id)description;	// IMP=0x00000000001669b3
