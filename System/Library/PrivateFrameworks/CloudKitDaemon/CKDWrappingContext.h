...
- (void).cxx_destruct;	// IMP=0x00000000000c74ff
...
- (id)encryptedDataContextString;	// IMP=0x00000000000c7354
- (id)assetContextString;	// IMP=0x00000000000c6f39
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2 mergeableDeltaID:(id)arg3 fileSignature:(id)arg4 referenceSignature:(id)arg5;	// IMP=0x00000000000c6d20
