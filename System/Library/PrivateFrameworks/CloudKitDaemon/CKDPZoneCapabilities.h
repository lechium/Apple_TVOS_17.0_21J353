...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002a4703
- (unsigned long long)hash;	// IMP=0x00000000002a4643
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a44b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a43cd
- (void)copyTo:(id)arg1;	// IMP=0x00000000002a4305
- (void)writeTo:(id)arg1;	// IMP=0x00000000002a420d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002a4200
- (id)dictionaryRepresentation;	// IMP=0x00000000002a3aef
- (id)description;	// IMP=0x00000000002a3a40
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x00000000002a390d
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x00000000002a38c2
