...
- (void).cxx_destruct;	// IMP=0x000000000009e369
...
- (id)relevantZoneIDs;	// IMP=0x000000000009e0f4
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000009e08e
- (void)main;	// IMP=0x000000000009d6bb
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000009c3e6
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000009b6e2
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x000000000009b4cf
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000009adf8
- (id)activityCreate;	// IMP=0x000000000009adcf
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x000000000009adb7
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000009aa60
