...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000029a990
- (void).cxx_destruct;	// IMP=0x000000000029f016
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000029ece9
- (void)main;	// IMP=0x000000000029ecd5
- (id)checkPreconditions;	// IMP=0x000000000029ebfb
- (id)assetOrPackageForFetchedRecord;	// IMP=0x000000000029ea46
- (id)repairContainer;	// IMP=0x000000000029e62b
- (void)_markAssetBroken;	// IMP=0x000000000029d19f
- (int)operationType;	// IMP=0x000000000029d194
- (void)_breakAsset;	// IMP=0x000000000029c401
- (void)_touchCreateRepairZone;	// IMP=0x000000000029bb01
- (void)_touchFetchRepairZone;	// IMP=0x000000000029b1ec
- (void)_fetchRecord;	// IMP=0x000000000029a9e6
- (_Bool)makeStateTransition;	// IMP=0x000000000029a51e
- (id)activityCreate;	// IMP=0x000000000029a4f5
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000029a390
