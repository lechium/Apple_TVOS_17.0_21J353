...
- (void).cxx_destruct;	// IMP=0x00000000001d455c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001d437e
- (unsigned long long)hash;	// IMP=0x00000000001d42af
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d4139
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d3fff
- (void)copyTo:(id)arg1;	// IMP=0x00000000001d3f1c
- (void)writeTo:(id)arg1;	// IMP=0x00000000001d3e41
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001d3e34
- (id)dictionaryRepresentation;	// IMP=0x00000000001d393e
- (id)description;	// IMP=0x00000000001d388f
