...
- (void).cxx_destruct;	// IMP=0x000000000018c3d5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000018c2db
- (unsigned long long)hash;	// IMP=0x000000000018c23d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018c126
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018c04b
- (void)copyTo:(id)arg1;	// IMP=0x000000000018bfab
- (void)writeTo:(id)arg1;	// IMP=0x000000000018befd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000018bef0
- (id)dictionaryRepresentation;	// IMP=0x000000000018bae8
- (id)description;	// IMP=0x000000000018ba39
@property(nonatomic) _Bool hasSkipBundleIDCheck;
- (int)StringAsApnsEnv:(id)arg1;	// IMP=0x000000000018b98b
- (id)apnsEnvAsString:(int)arg1;	// IMP=0x000000000018b936
