...
- (void).cxx_destruct;	// IMP=0x0000000000291d58
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000290fdb
- (id)generateRequestOperations;	// IMP=0x0000000000290dc3
- (id)requestOperationClasses;	// IMP=0x0000000000290d57
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000290d4f
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000290d35
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000290c9a
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x0000000000290b90
