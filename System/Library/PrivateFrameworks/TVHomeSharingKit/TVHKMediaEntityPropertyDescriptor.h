...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x001000000008570e
- (void).cxx_destruct;	// IMP=0x00000000000858c2
...
- (id)description;	// IMP=0x0000000000085373
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008523d
- (id)init;	// IMP=0x0000000000084e20
