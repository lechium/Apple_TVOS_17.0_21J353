...
+ (id)new;	// IMP=0x0060000000097eef
- (void).cxx_destruct;	// IMP=0x00000000000988c5
...
- (void)addEpisode:(id)arg1;	// IMP=0x0000000000098049
- (id)initWithShow:(id)arg1;	// IMP=0x0000000000097f8d
- (id)init;	// IMP=0x0000000000097f1e
