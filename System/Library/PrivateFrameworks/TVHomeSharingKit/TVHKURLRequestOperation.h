...
+ (id)new;	// IMP=0x0060000000037bbe
- (void).cxx_destruct;	// IMP=0x000000000003818b
...
- (void)_handleResponse:(id)arg1 responseData:(id)arg2 error:(id)arg3;	// IMP=0x0000000000038094
- (void)cancel;	// IMP=0x0000000000038016
- (void)executionDidBegin;	// IMP=0x0000000000037e0a
@property(readonly, nonatomic) unsigned long long elapsedTimeInMilliseconds;
- (id)initWithRequest:(id)arg1 session:(id)arg2;	// IMP=0x0000000000037c70
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000037c5c
- (id)init;	// IMP=0x0000000000037bed
