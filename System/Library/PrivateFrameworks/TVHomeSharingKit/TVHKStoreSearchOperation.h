...
+ (id)_clientApplicationParameterValueForSearchType:(unsigned long long)arg1;	// IMP=0x00600000000b7e43
+ (id)new;	// IMP=0x00600000000b759e
...
- (void)_handleResponse:(id)arg1;	// IMP=0x00000000000b7b30
- (void)cancel;	// IMP=0x00000000000b7ab2
- (void)executionDidBegin;	// IMP=0x00000000000b7727
- (id)initWithSearchTerm:(id)arg1 andType:(unsigned long long)arg2;	// IMP=0x00000000000b763c
- (id)init;	// IMP=0x00000000000b75cd
