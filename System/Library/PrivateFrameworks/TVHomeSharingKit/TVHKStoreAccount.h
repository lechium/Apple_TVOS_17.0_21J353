...
+ (id)new;	// IMP=0x0060000000089844
- (void).cxx_destruct;	// IMP=0x0000000000089e92
...
- (void)homeSharingGroupIDWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000008999b
- (id)initWithAccountName:(id)arg1 andPassword:(id)arg2;	// IMP=0x00000000000898e2
- (id)init;	// IMP=0x0000000000089873
