...
+ (id)_nonPersistentIDsFromMediaEntityIdentifiers:(id)arg1;	// IMP=0x0010000000037048
+ (id)_nonPersistentIDFromMediaEntityIdentifier:(id)arg1;	// IMP=0x0010000000036f9f
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaItemType:(unsigned long long)arg2 mediaCategoryType:(unsigned long long)arg3;	// IMP=0x0010000000036f19
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0010000000036f02
+ (id)_mediaEntityTypePredicateWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0010000000036ee8
+ (id)_sortedMediaEntitiesWithMediaEntities:(id)arg1;	// IMP=0x0010000000036e0d
+ (_Bool)_updateMediaEntitiesDictionary:(id)arg1 withMediaEntityFetchResponse:(id)arg2;	// IMP=0x0010000000036725
+ (id)new;	// IMP=0x0010000000035473
- (void).cxx_destruct;	// IMP=0x00000000000373e6
...
- (id)_albumsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000036d42
- (id)_albumArtistsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000036c77
- (id)_mediaItemsWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0000000000036abc
- (void)_updateAlbumsWithAlbumsResponse:(id)arg1;	// IMP=0x000000000003669c
- (void)_updateAlbumArtistsWithAlbumArtistResponse:(id)arg1;	// IMP=0x0000000000036613
- (void)_updateMediaItemsWithMediaItemsResponse:(id)arg1;	// IMP=0x000000000003658a
- (void)_clearCachedMediaItemArrays;	// IMP=0x00000000000364c2
- (void)_clearCachedAlbumArrays;	// IMP=0x0000000000036463
- (void)_clearCachedAlbumArtistArrays;	// IMP=0x0000000000036431
- (id)description;	// IMP=0x0000000000035df3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035d20
- (void)reset;	// IMP=0x00000000000356fa
- (void)updateWithSearchFetchResponse:(id)arg1 searchText:(id)arg2;	// IMP=0x00000000000355ef
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x0000000000035511
- (id)init;	// IMP=0x00000000000354a2
