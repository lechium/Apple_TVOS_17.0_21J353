...
+ (id)new;	// IMP=0x00600000000b3818
- (void).cxx_destruct;	// IMP=0x00000000000b426e
...
- (id)_requestForAttributeCode:(id)arg1;	// IMP=0x00000000000b3d31
- (void)cancel;	// IMP=0x00000000000b3cb3
- (void)_saveNextAttribute;	// IMP=0x00000000000b3a0b
- (void)executionDidBegin;	// IMP=0x00000000000b39f9
- (id)initWithMediaItemID:(unsigned long long)arg1 sessionState:(id)arg2 requestSession:(id)arg3;	// IMP=0x00000000000b38b6
- (id)init;	// IMP=0x00000000000b3847
