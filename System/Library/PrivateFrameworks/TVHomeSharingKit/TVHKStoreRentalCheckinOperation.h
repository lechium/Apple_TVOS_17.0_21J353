...
+ (id)new;	// IMP=0x00600000000b5c1a
- (void).cxx_destruct;	// IMP=0x00000000000b627f
...
- (void)cancel;	// IMP=0x00000000000b6189
- (void)executionDidBegin;	// IMP=0x00000000000b5e09
- (id)initWithRentalItem:(id)arg1;	// IMP=0x00000000000b5cb8
- (id)init;	// IMP=0x00000000000b5c49
