...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000002474
+ (Class)transformedValueClass;	// IMP=0x0060000000002463
- (void).cxx_destruct;	// IMP=0x0000000000002dd7
...
- (id)transformedValue:(id)arg1;	// IMP=0x000000000000247c
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x00000000000023b6
- (id)init;	// IMP=0x0000000000002347
