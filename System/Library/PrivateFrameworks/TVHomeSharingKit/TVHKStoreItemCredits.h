...
+ (id)new;	// IMP=0x0060000000085fbe
- (void).cxx_destruct;	// IMP=0x0000000000086ce0
...
- (id)description;	// IMP=0x0000000000086b31
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000867fc
- (unsigned long long)hash;	// IMP=0x00000000000866c0
- (id)_init;	// IMP=0x000000000008605c
- (id)init;	// IMP=0x0000000000085fed
