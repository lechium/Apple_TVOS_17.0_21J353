...
+ (id)_mediaEntityCollectionProperties;	// IMP=0x0060000000025516
+ (id)_mediaItemProperties;	// IMP=0x00600000000253c0
+ (void)_updateMediaCategoryDictionary:(id)arg1 withMediaItem:(id)arg2 forMediaEntityCollectionType:(unsigned long long)arg3;	// IMP=0x0060000000024fb2
+ (id)new;	// IMP=0x0060000000023aad
- (void).cxx_destruct;	// IMP=0x0000000000025792
...
- (void)_finishExecution;	// IMP=0x0000000000025281
- (void)_startSubOperation:(id)arg1;	// IMP=0x000000000002522f
- (void)_populateMediaCategoryDictionaries;	// IMP=0x0000000000024d3e
- (void)_startAlbumArtistsFetchOperation;	// IMP=0x000000000002483d
- (void)_startAlbumsFetchOperation;	// IMP=0x00000000000243a0
- (void)_startMediaItemsFetchOperation;	// IMP=0x0000000000023f4a
- (void)_updateFetchRequest:(id)arg1 properties:(id)arg2;	// IMP=0x0000000000023e5c
- (void)cancel;	// IMP=0x0000000000023d62
- (void)executionDidBegin;	// IMP=0x0000000000023cc4
- (id)initWithMediaServerIdentifier:(id)arg1 searchText:(id)arg2 fromRevision:(unsigned long long)arg3 toRevision:(unsigned long long)arg4 sessionState:(id)arg5 requestSession:(id)arg6;	// IMP=0x0000000000023b4b
- (id)init;	// IMP=0x0000000000023adc
