...
+ (id)_contributorsFromStoreCredits:(id)arg1;	// IMP=0x006000000005c833
+ (id)new;	// IMP=0x006000000005c058
- (void).cxx_destruct;	// IMP=0x000000000005cc5a
...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000005c4a2
- (void)cancel;	// IMP=0x000000000005c424
- (void)executionDidBegin;	// IMP=0x000000000005c182
- (id)initWithItemTitle:(id)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x000000000005c0f6
- (id)init;	// IMP=0x000000000005c087
