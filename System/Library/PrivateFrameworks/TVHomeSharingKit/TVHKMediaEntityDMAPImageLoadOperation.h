...
- (void).cxx_destruct;	// IMP=0x000000000000bd90
...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000000bad5
- (id)_mediaEntityImageLoadParams;	// IMP=0x000000000000bac3
- (void)cancel;	// IMP=0x000000000000ba45
- (void)executionDidBegin;	// IMP=0x000000000000b70b
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3 sessionState:(id)arg4 requestSession:(id)arg5;	// IMP=0x000000000000b5e2
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000000b573
