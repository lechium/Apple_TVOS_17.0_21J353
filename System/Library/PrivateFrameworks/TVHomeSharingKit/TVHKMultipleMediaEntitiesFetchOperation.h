...
- (void)_runNextFetchOperationIfPossible;	// IMP=0x00000000000312b2
- (void)cancel;	// IMP=0x0000000000031234
- (void)executionDidBegin;	// IMP=0x0000000000031222
- (id)initWithRequests:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x000000000003104d
- (id)init;	// IMP=0x0000000000030fde
