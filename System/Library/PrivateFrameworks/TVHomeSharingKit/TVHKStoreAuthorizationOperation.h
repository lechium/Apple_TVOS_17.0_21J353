...
+ (id)new;	// IMP=0x006000000000acf1
- (void).cxx_destruct;	// IMP=0x000000000000b4fe
...
- (void)cancel;	// IMP=0x000000000000b3e1
- (void)executionDidBegin;	// IMP=0x000000000000af1f
- (id)initWithAccountIdentifier:(id)arg1 tokenData:(id)arg2 keybagPath:(id)arg3;	// IMP=0x000000000000ad8f
- (id)init;	// IMP=0x000000000000ad20
