...
- (void)_handleResponse:(id)arg1 andData:(id)arg2;	// IMP=0x00000000000676f9
- (void)cancel;	// IMP=0x000000000006767b
- (void)executionDidBegin;	// IMP=0x00000000000672c3
- (id)initWithTemplateImageURLString:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x0000000000067190
- (id)init;	// IMP=0x0000000000067121
