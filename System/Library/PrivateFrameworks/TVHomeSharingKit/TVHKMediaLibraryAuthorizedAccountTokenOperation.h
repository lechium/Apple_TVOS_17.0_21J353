...
- (id)_decryptTokenData:(id)arg1;	// IMP=0x000000000006a174
- (void)_handleResponse:(id)arg1;	// IMP=0x0000000000069db5
- (id)initWithUserIdentifier:(id)arg1 sessionState:(id)arg2 useTokenEncryption:(_Bool)arg3 requestSession:(id)arg4;	// IMP=0x0000000000069be3
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x0000000000069b74
