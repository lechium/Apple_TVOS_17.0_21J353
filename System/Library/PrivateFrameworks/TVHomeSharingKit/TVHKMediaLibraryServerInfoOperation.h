...
- (void).cxx_destruct;	// IMP=0x00000000000a2bf5
...
- (void)_parseServerHeaderValue:(id)arg1 serverApplicationName:(id *)arg2 serverApplicationVersion:(unsigned long long *)arg3;	// IMP=0x00000000000a2796
- (void)_handleResponse:(id)arg1;	// IMP=0x00000000000a2429
- (id)initWithAccessMode:(unsigned long long)arg1 homeSharingGroupIdentifier:(id)arg2 requestSession:(id)arg3;	// IMP=0x00000000000a2348
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x00000000000a22d9
