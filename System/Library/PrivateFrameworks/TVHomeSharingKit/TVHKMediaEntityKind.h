...
- (void).cxx_destruct;	// IMP=0x0000000000096902
...
- (id)description;	// IMP=0x000000000009668e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000965d1
- (id)sortingPropertyDescriptorForName:(id)arg1;	// IMP=0x0000000000096557
- (id)propertyDescriptorForName:(id)arg1;	// IMP=0x00000000000964dd
@property(readonly, copy, nonatomic) NSDictionary *propertyDescriptorByName;
- (id)init;	// IMP=0x00000000000963e6
