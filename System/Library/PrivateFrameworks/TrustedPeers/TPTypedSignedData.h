...
- (void).cxx_destruct;	// IMP=0x000000000001b8df
...
- (_Bool)checkSignatureWithKey:(id)arg1;	// IMP=0x000000000001b611
- (id)initWithData:(id)arg1 sig:(id)arg2 signatureTypeName:(id)arg3;	// IMP=0x000000000001b5f9
- (id)initWithData:(id)arg1 key:(id)arg2 signatureTypeName:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001b500
- (id)initWithData:(id)arg1 sig:(id)arg2 pubkey:(id)arg3 sigTypeName:(id)arg4;	// IMP=0x000000000001b373
