...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d3fc
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d377
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d318
- (void)_didFinishPreparing;	// IMP=0x000000000000d2c6
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d2b4
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d1d3
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000d12f
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000cef9
- (void)startPlayback;	// IMP=0x000000000000ce6e
- (void)activeDidChange;	// IMP=0x000000000000cdee
- (void)videoDidPlayToEnd;	// IMP=0x000000000000cdaa
- (void)_handleDidFinish;	// IMP=0x000000000000cd3b
- (void)videoWillPlayToEnd;	// IMP=0x000000000000cbba
- (long long)behaviorType;	// IMP=0x000000000000cbaf
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000ca73
