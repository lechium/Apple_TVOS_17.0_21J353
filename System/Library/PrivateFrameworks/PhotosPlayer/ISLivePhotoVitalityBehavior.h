...
- (void).cxx_destruct;	// IMP=0x0000000000013568
...
- (void)cancelSettleToPhoto;	// IMP=0x00000000000133bf
- (void)_didReachTransitionToPhotoTime;	// IMP=0x000000000001316a
- (void)_didReachTransitionTime;	// IMP=0x000000000001304f
- (void)_startVideoPlayback;	// IMP=0x0000000000012f23
- (void)videoReadyForDisplayDidChange;	// IMP=0x0000000000012eba
- (void)playVitality;	// IMP=0x0000000000012e29
- (long long)behaviorType;	// IMP=0x0000000000012e1e
- (void)_handleDidFinishPreroll;	// IMP=0x0000000000012dc5
- (void)_handleDidSeekToStartTime;	// IMP=0x0000000000012ca5
- (void)_stopObservingVideo;	// IMP=0x0000000000012c08
- (void)_startObservingVideo;	// IMP=0x00000000000127c8
- (void)prepareForVitality;	// IMP=0x000000000001250f
- (void)activeDidChange;	// IMP=0x0000000000012475
- (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(_Bool)arg6 assetOptions:(unsigned long long)arg7;	// IMP=0x00000000000123bd
- (void)dealloc;	// IMP=0x0000000000012300
