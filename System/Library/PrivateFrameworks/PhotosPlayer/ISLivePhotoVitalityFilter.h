...
- (void).cxx_destruct;	// IMP=0x00000000000138f1
...
- (void)updateOutput;	// IMP=0x000000000001388c
- (void)invalidateOutput;	// IMP=0x0000000000013875
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000137e2
- (void)setState:(long long)arg1;	// IMP=0x0000000000013764
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000136f9
- (id)init;	// IMP=0x00000000000136e5
