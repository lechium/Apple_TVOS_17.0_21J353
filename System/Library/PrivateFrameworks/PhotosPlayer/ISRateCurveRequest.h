...
- (void).cxx_destruct;	// IMP=0x0000000000002f55
...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002ea0
- (void)dealloc;	// IMP=0x0000000000002e62
- (void)cancel;	// IMP=0x0000000000002e4c
- (void)_didReachTargetTime;	// IMP=0x0000000000002cb7
- (void)_stepDownRate;	// IMP=0x0000000000002a1c
- (void)start;	// IMP=0x000000000000275b
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000002683
