...
- (void)inputDidChange;	// IMP=0x00000000000254d7
- (void)_invalidateOutput;	// IMP=0x00000000000254c0
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000253ea
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025357
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000252ec
- (id)init;	// IMP=0x00000000000252d8
