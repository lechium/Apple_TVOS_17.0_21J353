...
- (void).cxx_destruct;	// IMP=0x000000000004c3a9
...
- (id)emailCompatibleMargin;	// IMP=0x000000000004c0f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004bef2
- (id)init;	// IMP=0x000000000004bd9b
