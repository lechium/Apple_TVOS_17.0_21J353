...
- (void).cxx_destruct;	// IMP=0x0000000000061c37
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x0000000000061b95
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x0000000000061463
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x0000000000061077
- (id)init;	// IMP=0x0000000000060feb
