...
+ (id)typeForOffer:(id)arg1;	// IMP=0x00600000000382e9
+ (id)previewURLForOffer:(id)arg1;	// IMP=0x0060000000037e45
+ (_Bool)hasVideoForOffer:(id)arg1;	// IMP=0x0060000000037e31
+ (_Bool)hasAudioForOffer:(id)arg1;	// IMP=0x0060000000037b7b
- (void).cxx_destruct;	// IMP=0x0000000000038392
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000037a3b
