...
- (void).cxx_destruct;	// IMP=0x000000000004eb1e
...
- (id)rightAccessory;	// IMP=0x000000000004e972
- (id)leftAccessory;	// IMP=0x000000000004e92e
- (id)rightIcon;	// IMP=0x000000000004e8ea
- (id)leftIcon;	// IMP=0x000000000004e8a6
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000004dbe9
