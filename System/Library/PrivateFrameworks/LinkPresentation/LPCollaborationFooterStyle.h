...
@interface LPCollaborationFooterStyle : NSObject
{
    ...
    _Bool _ignoreSafeAreaInset;	// 12 = 0xc
...
- (void).cxx_destruct;	// IMP=0x000000000004db7f
...
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000004d6a3
