...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000059ea
- (id)remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000059aa
- (id)remoteObjectProxy;	// IMP=0x000000000000596c
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000005820
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000057c4
- (void)dealloc;	// IMP=0x000000000000575e
- (id)initWithConnection:(id)arg1 interface:(id)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000056bc
