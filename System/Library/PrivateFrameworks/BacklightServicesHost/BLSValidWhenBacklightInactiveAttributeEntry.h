...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000006ba49
- (void).cxx_destruct;	// IMP=0x000000000006bc06
...
- (void)invalidate;	// IMP=0x000000000006bbbe
- (_Bool)reactivateIfPossible;	// IMP=0x000000000006bbb6
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000006bb00
