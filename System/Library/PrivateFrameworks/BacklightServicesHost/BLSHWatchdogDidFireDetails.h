...
@interface BLSHWatchdogDidFireDetails : NSObject
{
    ...
    NSString *_abortReasonString;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x0000000000040a5b
@property(nonatomic) _Bool debugLogsEnabled; // @synthesize debugLogsEnabled=_debugLogsEnabled;
@property(copy, nonatomic) NSString *abortReasonString; // @synthesize abortReasonString=_abortReasonString;
...
- (id)initWithWatchdogDidFireDictionary:(id)arg1;	// IMP=0x000000000004077f
