...
- (void).cxx_destruct;	// IMP=0x0000000000076ef8
...
- (void)invalidate:(unsigned long long)arg1;	// IMP=0x0000000000076eb7
- (id)initWithExplanation:(id)arg1;	// IMP=0x0000000000076e44
