...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000037d21
- (void).cxx_destruct;	// IMP=0x00000000000381cf
...
- (void)invalidate;	// IMP=0x0000000000037fa6
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000037f75
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0000000000037ea1
