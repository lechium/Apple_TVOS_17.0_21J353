...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000000a79c
- (void).cxx_destruct;	// IMP=0x000000000000aced
...
- (void)systemSleepMonitor:(id)arg1 prepareForSleepWithCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ac79
- (void)systemSleepMonitor:(id)arg1 sleepRequestedWithResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ac36
- (void)invalidate;	// IMP=0x000000000000ab7b
- (_Bool)reactivateIfPossible;	// IMP=0x000000000000ab73
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000000a82c
