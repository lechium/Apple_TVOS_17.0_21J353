...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000051e84
- (void).cxx_destruct;	// IMP=0x0000000000052158
...
- (void)invalidate;	// IMP=0x0000000000052110
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000052108
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x0000000000052052
