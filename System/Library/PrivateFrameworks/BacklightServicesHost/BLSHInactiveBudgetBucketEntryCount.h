...
- (void).cxx_destruct;	// IMP=0x000000000003e9f6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e987
- (double)timeIntervalFromLastEntryToDate:(id)arg1;	// IMP=0x000000000003e96b
- (_Bool)countSpecifier:(id)arg1 hasSecondsBudget:(_Bool)arg2 isCoalesceAllowed:(_Bool)arg3;	// IMP=0x000000000003e795
- (id)description;	// IMP=0x000000000003e659
