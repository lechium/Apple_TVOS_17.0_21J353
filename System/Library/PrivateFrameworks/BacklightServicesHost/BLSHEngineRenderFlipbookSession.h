...
- (void).cxx_destruct;	// IMP=0x000000000001dc4e
@property(readonly, nonatomic) BLSHBacklightEnvironmentPresentation *presentation; // @synthesize presentation=_presentation;
- (id)telemetryDataWithEndTime:(double)arg1 reasonEnded:(id)arg2 preventedSleepDuration:(double)arg3;	// IMP=0x000000000001c8af
- (void)prepareAndRenderFrameSpecifier:(id)arg1;	// IMP=0x000000000001bea6
- (void)invalidate;	// IMP=0x000000000001bc9b
...
- (void)dealloc;	// IMP=0x000000000001b6ef
- (id)initWithDelegate:(id)arg1 flipbook:(id)arg2 presentation:(id)arg3 osInterfaceProvider:(id)arg4;	// IMP=0x000000000001b32a
