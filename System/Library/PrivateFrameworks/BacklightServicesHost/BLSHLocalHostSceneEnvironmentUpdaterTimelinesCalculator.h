...
- (void).cxx_destruct;	// IMP=0x0000000000061fa6
- (void)requestDatesOperation:(id)arg1 didTimeoutPendingEnvironments:(id)arg2;	// IMP=0x0000000000061f35
- (void)requestDatesOperation:(id)arg1 environment:(id)arg2 didProvideSpecifiers:(id)arg3 forPresentationInterval:(id)arg4 isComplete:(_Bool)arg5;	// IMP=0x0000000000061ca8
- (void)lock_completeAllTimelineEntries;	// IMP=0x0000000000061acb
- (void)callCompletionIfDone;	// IMP=0x0000000000061a13
- (void)calculateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000615b6
