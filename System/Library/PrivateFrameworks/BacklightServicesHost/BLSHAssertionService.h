...
+ (id)serviceWithOSInterfaceProvider:(id)arg1 localOnly:(_Bool)arg2;	// IMP=0x006000000007849a
- (void).cxx_destruct;	// IMP=0x0000000000078a8b
...
- (id)initWithOSInterfaceProvider:(id)arg1 localOnly:(_Bool)arg2;	// IMP=0x00000000000784f0
