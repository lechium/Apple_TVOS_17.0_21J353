...
- (void).cxx_destruct;	// IMP=0x0000000000066a3a
...
- (id)toURL;	// IMP=0x000000000006651b
- (id)initWithDesignation:(unsigned long long)arg1 radarTitle:(id)arg2 radarDescription:(id)arg3;	// IMP=0x0000000000066384
