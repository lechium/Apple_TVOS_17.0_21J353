...
- (void).cxx_destruct;	// IMP=0x0000000000040c5b
...
- (id)initWithDelegate:(id)arg1 abortContext:(id)arg2 isPotentialHang:(_Bool)arg3 hasSleepBeenRequested:(_Bool)arg4 sleepImminent:(_Bool)arg5 sleepImminentSinceScheduled:(_Bool)arg6 timeInSleepImminent:(double)arg7 explanation:(id)arg8;	// IMP=0x0000000000040aa4
