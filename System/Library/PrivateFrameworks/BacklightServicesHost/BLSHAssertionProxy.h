...
- (oneway void)serviceDidResume;	// IMP=0x0000000000035e95
- (oneway void)serviceDidPause;	// IMP=0x0000000000035e61
- (oneway void)serviceDidCancelWithError:(id)arg1;	// IMP=0x0000000000035df3
- (oneway void)serviceWillCancel;	// IMP=0x0000000000035dbf
- (oneway void)serviceFailedToAcquireWithError:(id)arg1;	// IMP=0x0000000000035d78
- (oneway void)serviceDidAcquire;	// IMP=0x0000000000035d2a
...
- (void)invalidate;	// IMP=0x0000000000035cc3
- (id)initWithIdentifier:(id)arg1 descriptor:(id)arg2 remoteTarget:(id)arg3;	// IMP=0x0000000000035bc8
