...
+ (id)preparedPhotoSettingsArrayRequestWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000003297c
...
- (void)_setRequestID:(unsigned long long)arg1;	// IMP=0x0000000000032aac
@property(readonly) unsigned long long requestID;
- (void)dealloc;	// IMP=0x0000000000032a58
- (id)_initWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000329b8
