...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x000000000009e51b
- (id)uniqueConnections:(id)arg1;	// IMP=0x000000000009e4a3
- (id)uniqueOutputs:(id)arg1;	// IMP=0x000000000009e42b
- (id)uniqueInputs:(id)arg1;	// IMP=0x000000000009e3b3
- (void)dealloc;	// IMP=0x000000000009e35b
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x000000000009e2bb
