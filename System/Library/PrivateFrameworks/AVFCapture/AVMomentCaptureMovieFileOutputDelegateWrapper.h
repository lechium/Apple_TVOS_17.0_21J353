...
+ (id)wrapperWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0060000000004ce5
...
- (void)dealloc;	// IMP=0x0000000000004e8c
- (id)initWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0000000000004d30
