...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x006000000009f79d
...
- (void)dealloc;	// IMP=0x000000000009f83d
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000009f7d4
