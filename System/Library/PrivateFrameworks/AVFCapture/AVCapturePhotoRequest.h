...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0060000000043f31
+ (void)initialize;	// IMP=0x0060000000043f20
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000044184
...
- (void)dealloc;	// IMP=0x0000000000044066
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0000000000043f7c
