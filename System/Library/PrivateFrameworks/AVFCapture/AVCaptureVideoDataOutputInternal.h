...
@interface AVCaptureVideoDataOutputInternal : NSObject
{
    ...
    NSArray *requestedBufferAttachments;	// 64 = 0x40
    _Bool videoSettingsDimensionsOverrideEnabled;	// 72 = 0x48
    _Bool videoSettingsDimensionsOverrideEnabledByClient;	// 73 = 0x49
    NSArray *availableVideoCVPixelFormatTypes;	// 80 = 0x50
    AVCaptureDataOutputDelegateCallbackHelper *delegateCallbackHelper;	// 88 = 0x58
}

- (void)dealloc;	// IMP=0x0000000000035ac7
- (id)init;	// IMP=0x0000000000035a21
