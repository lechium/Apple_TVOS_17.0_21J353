...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00200000000c7b62
- (id)af_assistedSelectionItem;	// IMP=0x00200000000c7aea
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00200000000c787e
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00200000000c7680
