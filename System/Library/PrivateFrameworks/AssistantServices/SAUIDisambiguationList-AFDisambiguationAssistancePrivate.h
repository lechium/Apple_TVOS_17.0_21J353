...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00200000000c634d
- (id)af_assistedSelectionItem;	// IMP=0x00200000000c627a
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00200000000c60c3
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00200000000c6016
