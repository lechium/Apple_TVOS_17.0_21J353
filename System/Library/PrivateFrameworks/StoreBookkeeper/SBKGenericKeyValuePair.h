...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000005ecb
+ (id)pairWithKVSKey:(id)arg1 kvsPayload:(id)arg2;	// IMP=0x0010000000005e5d
...
- (double)timestamp;	// IMP=0x0000000000005e18
- (id)kvsValueDescription;	// IMP=0x0000000000005d8e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005d21
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005c47
- (id)initWithKVSKey:(id)arg1 kvsPayload:(id)arg2;	// IMP=0x0000000000005bae
