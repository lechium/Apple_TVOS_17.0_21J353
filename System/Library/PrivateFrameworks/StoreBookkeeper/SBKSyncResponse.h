...
+ (id)responseWithResponse:(id)arg1 transaction:(id)arg2;	// IMP=0x006000000001be7f
- (void).cxx_destruct;	// IMP=0x000000000001bf9d
@property(readonly, nonatomic) SBKSyncResponseData *syncResponseData; // @synthesize syncResponseData=_syncResponseData;
- (void)deserializeResponseBodyWithTransaction:(id)arg1;	// IMP=0x000000000001bef3
