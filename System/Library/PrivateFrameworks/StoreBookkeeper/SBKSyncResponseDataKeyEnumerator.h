...
- (void).cxx_destruct;	// IMP=0x000000000001d37b
...
- (void)_processNextKey;	// IMP=0x000000000001d1c1
- (void)_processDeletedKey:(id)arg1 isDirty:(_Bool *)arg2;	// IMP=0x000000000001d145
- (void)_processUpdatedKey:(id)arg1 isConflict:(_Bool)arg2 isDirty:(_Bool *)arg3;	// IMP=0x000000000001d08c
- (void)enumerateKeysInResponseForTransaction:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000001cf45
- (id)initWithResponseData:(id)arg1;	// IMP=0x000000000001ceda
