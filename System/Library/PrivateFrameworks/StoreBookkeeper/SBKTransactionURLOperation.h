...
+ (id)operationWithRequest:(id)arg1 delegate:(id)arg2;	// IMP=0x006000000000d463
...
- (id)description;	// IMP=0x000000000000d37c
@property(nonatomic) _Bool shouldAuthenticate; // @synthesize shouldAuthenticate=_shouldAuthenticate;
- (id)_init;	// IMP=0x000000000000d1af
- (id)init;	// IMP=0x000000000000d128
