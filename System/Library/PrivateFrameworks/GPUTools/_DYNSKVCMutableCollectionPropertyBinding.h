...
- (id)underlyingIvarValueForObject:(id)arg1;	// IMP=0x000000000001fe2d
- (void)dealloc;	// IMP=0x000000000001fde3
- (id)initWithKey:(id)arg1 underlyingIvarName:(id)arg2;	// IMP=0x000000000001fd69
