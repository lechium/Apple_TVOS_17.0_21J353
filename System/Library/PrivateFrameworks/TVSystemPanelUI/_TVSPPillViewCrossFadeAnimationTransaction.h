...
- (void)_didComplete;	// IMP=0x0000000000006690
- (void)_willFailWithReason:(id)arg1;	// IMP=0x0000000000006500
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x0000000000006330
- (void)_begin;	// IMP=0x0000000000005cb0
- (_Bool)_canBeInterrupted;	// IMP=0x0000000000005c90
- (id)initWithPillView:(id)arg1 animationContext:(id)arg2;	// IMP=0x0000000000005b90
