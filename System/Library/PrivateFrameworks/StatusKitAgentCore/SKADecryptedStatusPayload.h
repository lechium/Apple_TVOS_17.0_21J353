...
- (void).cxx_destruct;	// IMP=0x0000000000059f08
...
- (id)description;	// IMP=0x0000000000059e3e
- (id)initWithStatusPayload:(id)arg1 invitation:(id)arg2;	// IMP=0x0000000000059da5
