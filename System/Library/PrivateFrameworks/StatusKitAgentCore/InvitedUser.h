...
+ (id)channelKeyPath;	// IMP=0x004000000007aba6
+ (id)senderHandleKeyPath;	// IMP=0x004000000007ab99
+ (id)invitedHandleKeyPath;	// IMP=0x004000000007ab8c
+ (id)predicateForChannel:(id)arg1;	// IMP=0x004000000007ace7
+ (id)predicateForSenderHandle:(id)arg1;	// IMP=0x004000000007ac4d
+ (id)predicateForInvitedHandle:(id)arg1;	// IMP=0x004000000007abb3
+ (id)fetchRequest;	// IMP=0x004000000007c0fa
