...
- (void).cxx_destruct;	// IMP=0x0000000000010d3f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000010bd6
- (unsigned long long)hash;	// IMP=0x0000000000010b2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000109ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000108da
- (void)copyTo:(id)arg1;	// IMP=0x0000000000010816
- (void)writeTo:(id)arg1;	// IMP=0x0000000000010759
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001074c
- (id)dictionaryRepresentation;	// IMP=0x00000000000103c1
- (id)description;	// IMP=0x0000000000010312
