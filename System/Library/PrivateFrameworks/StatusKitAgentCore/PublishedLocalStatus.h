...
+ (id)identifierKeyPath;	// IMP=0x004000000000f6df
+ (id)predicateForPublishedLocalStatusIdentifiers:(id)arg1;	// IMP=0x004000000000f6ec
+ (id)fetchRequest;	// IMP=0x004000000007c13a
