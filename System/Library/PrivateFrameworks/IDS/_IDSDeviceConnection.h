...
- (id)deviceConnectionKey;	// IMP=0x000000000007e391
- (void)_daemonDied:(id)arg1;	// IMP=0x000000000007e257
- (void)_cleanupCompletionBlock;	// IMP=0x000000000007e207
- (void)xpcObject:(id)arg1 objectContext:(id)arg2;	// IMP=0x000000000007dbaa
- (void)_close;	// IMP=0x000000000007d716
- (void)close;	// IMP=0x000000000007d66a
- (_Bool)updateConnectionWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007d2c5
- (void)setStreamPairWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x000000000007d0f8
...
- (void)_connect;	// IMP=0x000000000007cb88
- (void)dealloc;	// IMP=0x000000000007ca66
- (id)initWithDevice:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 queue:(id)arg4;	// IMP=0x000000000007bb77
