...
- (void).cxx_destruct;	// IMP=0x000000000012455b
...
- (id)accountForAlias:(id)arg1;	// IMP=0x00000000001244ba
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x0000000000124402
