...
+ (_Bool)isDirectMessagingRequested:(id)arg1;	// IMP=0x006000000000dc25
- (void).cxx_destruct;	// IMP=0x0000000000014256
...
- (void)logConnectionStatisticsInPowerDictionary;	// IMP=0x0000000000013bfc
- (void)startPowerLogReportTimer;	// IMP=0x0000000000013acf
- (void)clearPowerAssertion;	// IMP=0x0000000000013a74
- (void)getPowerAssertion;	// IMP=0x00000000000138ed
- (void)dequeueMessages;	// IMP=0x000000000001346e
- (void)sendMessageWithParameters:(id)arg1 options:(id)arg2;	// IMP=0x0000000000012636
- (void)failedToSendMessage:(id)arg1 responseCode:(long long)arg2;	// IMP=0x00000000000123dd
- (void)suspendPendingAckTimer;	// IMP=0x00000000000123b5
- (void)resumePendingAckTimer;	// IMP=0x000000000001238d
- (void)cancelPendingAckTimer;	// IMP=0x000000000001234c
- (id)createDispatchDataForMessageSend:(id)arg1 isAck:(_Bool)arg2 ackMessageId:(unsigned int)arg3;	// IMP=0x00000000000118c8
- (unsigned char)getMessageTypeForFirstMessage;	// IMP=0x000000000001171a
- (void)sendAppAckWithGUID:(id)arg1;	// IMP=0x0000000000010e1c
- (void)sendAckForMessageID:(unsigned int)arg1 guidToAck:(id)arg2;	// IMP=0x0000000000010b47
- (void)processIncomingMessage:(id)arg1 messageType:(unsigned char)arg2 messageIdentifier:(unsigned int)arg3;	// IMP=0x000000000000fb8f
- (void)receiveMessages;	// IMP=0x000000000000f66b
- (void)setupConnectionIfApplicable;	// IMP=0x000000000000f618
- (void)receivedDirectMessagingSocketWithContext:(id)arg1;	// IMP=0x000000000000f24f
- (void)setupIDSDeviceConnection;	// IMP=0x000000000000edcb
- (void)updateTrafficClass:(unsigned short)arg1;	// IMP=0x000000000000edb3
- (void)updateConnection:(id)arg1;	// IMP=0x000000000000eaf1
- (void)resetConnection;	// IMP=0x000000000000e9e9
- (void)updateMetadata:(id)arg1;	// IMP=0x000000000000e500
- (void)updateConnectedDevices:(id)arg1;	// IMP=0x000000000000e0b1
- (_Bool)isMessageEligible:(id)arg1 options:(id)arg2 destinationDevice:(id)arg3;	// IMP=0x000000000000dd08
- (_Bool)canUseDirectMessaging;	// IMP=0x000000000000dc0e
- (void)setDestinationDevice:(id)arg1;	// IMP=0x000000000000daa0
- (void)invalidate;	// IMP=0x000000000000d9a4
- (void)cancel;	// IMP=0x000000000000d8e3
- (id)description;	// IMP=0x000000000000d850
- (void)dealloc;	// IMP=0x000000000000d74e
- (void)parseDirectMessagingState;	// IMP=0x000000000000d5cb
- (id)initWithServiceName:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000000d2b4
