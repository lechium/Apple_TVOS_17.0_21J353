...
- (void).cxx_destruct;	// IMP=0x00000000000ea1df
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x00000000000ea0f3
- (void)_setAccount:(id)arg1;	// IMP=0x00000000000ea011
- (void)_stateChanged;	// IMP=0x00000000000e9e9f
- (void)_cloudConnectedStateChanged;	// IMP=0x00000000000e9d60
- (void)_connectedStateChanged;	// IMP=0x00000000000e9c21
- (void)_nearbyStateChanged;	// IMP=0x00000000000e9ae2
- (_Bool)isTinker;	// IMP=0x00000000000e9aca
- (void)_addIdentity:(id)arg1;	// IMP=0x00000000000e977d
...
- (id)compactDescription;	// IMP=0x00000000000e7a84
- (id)description;	// IMP=0x00000000000e75ff
- (id)fullDescription;	// IMP=0x00000000000e714b
...
- (void)dealloc;	// IMP=0x00000000000e6a3d
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000e6294
