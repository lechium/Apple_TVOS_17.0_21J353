...
- (_Bool)equivalentToRecipients:(id)arg1;	// IMP=0x003000000005da1c
- (id)indexesOfPartsOfMessageItem:(id)arg1;	// IMP=0x003000000008749b
- (id)indexesOfPartsOfMessage:(id)arg1;	// IMP=0x0030000000087305
- (id)__imItems;	// IMP=0x00300000000def8f
- (void)__enumerateItemsWithOptions:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00300000000dee20
@property(readonly, nonatomic) IMMessageItem *__imLastMessageItem;
- (id)messages;	// IMP=0x00300000000dec45
- (void)enumerateMessagesWithOptions:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00300000000deb35
