...
- (void).cxx_destruct;	// IMP=0x00000000000f026a
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000f0106
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000000f00a7
- (id)initWithDaemonController:(id)arg1 synchronousReplies:(_Bool)arg2;	// IMP=0x00000000000f0070
