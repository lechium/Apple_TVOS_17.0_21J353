...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x006000000006b7d6
- (void).cxx_destruct;	// IMP=0x000000000006bbe1
...
- (void)invalidate;	// IMP=0x000000000006bae2
- (void)triggerTimeout;	// IMP=0x000000000006ba45
- (void)timerCallback;	// IMP=0x000000000006b9b0
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x000000000006b7de
