...
@class AFMultiUserSpeechPackage, AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, LBLocalSpeechRecognizerClient, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTTRPCandidate, SMTTRPDetected;
...
- (void)localSpeechRecognizerClient:(LBLocalSpeechRecognizerClient *)arg1 receivedEagerRecognitionCandidateWithRequestId:(NSString *)arg2 rcId:(unsigned long long)arg3 multiUserSpeechPackage:(AFMultiUserSpeechPackage *)arg4 duration:(double)arg5;
- (void)localSpeechRecognizerClient:(LBLocalSpeechRecognizerClient *)arg1 receivedFinalResultWithRequestId:(NSString *)arg2 multiUserSpeechPackage:(AFMultiUserSpeechPackage *)arg3;
