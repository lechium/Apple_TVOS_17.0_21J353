...
- (void).cxx_destruct;	// IMP=0x0000000000033010
...
- (id)shortDescription;	// IMP=0x0000000000032cfa
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000032c84
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x00000000000324ad
- (void)trackPersonBlob:(id)arg1;	// IMP=0x000000000003245e
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000032229
