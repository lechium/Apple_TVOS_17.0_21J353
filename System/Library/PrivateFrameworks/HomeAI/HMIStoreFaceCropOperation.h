...
+ (id)logCategory;	// IMP=0x00600000000104b6
- (void).cxx_destruct;	// IMP=0x00000000000104ec
...
- (void)main;	// IMP=0x0000000000010174
- (id)initWithDataSource:(id)arg1 faceCrop:(id)arg2;	// IMP=0x00000000000100ca
