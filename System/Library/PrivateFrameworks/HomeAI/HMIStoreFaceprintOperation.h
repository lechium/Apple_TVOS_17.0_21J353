...
+ (id)logCategory;	// IMP=0x0060000000010909
- (void).cxx_destruct;	// IMP=0x000000000001093f
...
- (void)main;	// IMP=0x00000000000105c7
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x000000000001051d
