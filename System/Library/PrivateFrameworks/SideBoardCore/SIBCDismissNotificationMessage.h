...
+ (id)messageId;	// IMP=0x001000000000cda3
- (void).cxx_destruct;	// IMP=0x000000000000ce81
...
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x000000000000ca3c
- (id)dictionaryEncoding;	// IMP=0x000000000000ca34
