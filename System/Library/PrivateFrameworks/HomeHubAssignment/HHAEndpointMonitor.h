...
- (void).cxx_destruct;	// IMP=0x000000000001db3d
...
- (void)_processEndpointStatus:(id)arg1;	// IMP=0x000000000001d7c7
- (void)updateEndpointIdleStatus:(id)arg1;	// IMP=0x000000000001d5e1
...
- (void)provider:(id)arg1 didUpdateEndpointWithStatus:(id)arg2;	// IMP=0x000000000001d02c
- (void)provider:(id)arg1 didRemoveEndpointWithIdentifier:(id)arg2;	// IMP=0x000000000001cefb
- (void)informer:(id)arg1 didUpdateEndpointTrait:(id)arg2;	// IMP=0x000000000001cdcb
@property(readonly, nonatomic) NSSet *inactiveEndpoints;
@property(readonly, nonatomic) NSSet *unassignedEndpoints;
- (id)endpointsNotAssignedToPreferredHubs:(id)arg1;	// IMP=0x000000000001caaa
@property(readonly, nonatomic) NSSet *endpointsRequestingAssignment;
@property(readonly, nonatomic) NSSet *allEndpoints;
- (id)endpointsAssignedToHub:(id)arg1;	// IMP=0x000000000001c91b
- (id)_endpointsPassingTest:(CDUnknownBlockType)arg1;	// IMP=0x000000000001c73f
- (void)_requestTraitsForEndpoint:(id)arg1;	// IMP=0x000000000001c2a0
- (void)receivedTraits:(id)arg1 forEndpoint:(id)arg2;	// IMP=0x000000000001c152
@property(readonly, nonatomic) NSArray *endpointAssignmentStatuses;
- (void)dealloc;	// IMP=0x000000000001bf7b
- (void)stopMonitor;	// IMP=0x000000000001bed7
- (void)startMonitorWithObserver:(id)arg1 statusProvider:(id)arg2 traitInformer:(id)arg3 endpoints:(id)arg4;	// IMP=0x000000000001bccf
- (void)_clearEndpointList;	// IMP=0x000000000001bb7f
- (id)initWithQueue:(id)arg1 endpointFactory:(id)arg2;	// IMP=0x000000000001bac9
