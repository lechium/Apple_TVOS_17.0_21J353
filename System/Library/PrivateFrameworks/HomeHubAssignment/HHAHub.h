...
- (void).cxx_destruct;	// IMP=0x00000000000161ee
...
- (void)updateActivity;	// IMP=0x000000000001605e
...
- (_Bool)hubAttributesChanged:(id)arg1;	// IMP=0x0000000000015c54
- (void)revokeEndpoint:(id)arg1;	// IMP=0x0000000000015b4f
- (void)setAssignedEndpoints:(id)arg1;	// IMP=0x0000000000015b22
- (void)assignEndpoint:(id)arg1;	// IMP=0x0000000000015a3a
@property(readonly, nonatomic) NSDictionary *descriptionDictionaryWithAttributes;
- (id)descriptionDictionaryWithLeaderId:(id)arg1;	// IMP=0x0000000000015518
- (long long)compare:(id)arg1;	// IMP=0x000000000001535c
- (id)description;	// IMP=0x00000000000152d4
- (void)_preferOthersTimerExpired;	// IMP=0x0000000000015280
- (void)invalidate;	// IMP=0x000000000001526a
- (id)initWithAttributes:(id)arg1 timerFactory:(id)arg2 queue:(id)arg3;	// IMP=0x000000000001514f
