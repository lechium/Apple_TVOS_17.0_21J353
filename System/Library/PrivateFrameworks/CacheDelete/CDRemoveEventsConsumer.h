...
- (void).cxx_destruct;	// IMP=0x000000000002bb74
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000002b5cf
- (void)callback:(id)arg1;	// IMP=0x000000000002a8e3
- (void)dealloc;	// IMP=0x000000000002a86c
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000002a77f
