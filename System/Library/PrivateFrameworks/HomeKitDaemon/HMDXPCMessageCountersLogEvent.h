...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00600000003547b9
- (void).cxx_destruct;	// IMP=0x0000000000354766
...
- (_Bool)shouldSubmit;	// IMP=0x00000000003546d3
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000003545a3
