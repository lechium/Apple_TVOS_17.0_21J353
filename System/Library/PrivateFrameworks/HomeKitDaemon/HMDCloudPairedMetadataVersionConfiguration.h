...
+ (id)logCategory;	// IMP=0x0010000000940759
- (void).cxx_destruct;	// IMP=0x0000000000940728
...
- (id)attributeDescriptions;	// IMP=0x0000000000940521
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x00000000009400fe
- (id)initWithAccessoryIdentifier:(id)arg1 diagnostics:(id)arg2;	// IMP=0x000000000094004d
