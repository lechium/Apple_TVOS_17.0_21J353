...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007cacd
- (void).cxx_destruct;	// IMP=0x000000000007ca7a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007c91e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007c63c
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007c417
- (_Bool)_parseFromTLVData;	// IMP=0x000000000007c12c
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x000000000007be4c
