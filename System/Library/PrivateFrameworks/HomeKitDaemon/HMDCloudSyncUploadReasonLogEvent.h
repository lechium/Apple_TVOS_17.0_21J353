...
+ (id)uploadReason:(id)arg1 acceptedHomeManagerZonePush:(_Bool)arg2;	// IMP=0x00600000005b97a7
+ (id)uploadReason:(id)arg1 acceptedHomeZonePush:(_Bool)arg2;	// IMP=0x00600000005b9740
+ (id)uploadReason:(id)arg1 acceptedLegacyPush:(_Bool)arg2;	// IMP=0x00600000005b96d9
- (void).cxx_destruct;	// IMP=0x00000000005b96c6
...
- (id)initWithUploadReason:(id)arg1 legacyPushCount:(long long)arg2 homeZonePushCount:(long long)arg3 homeManagerPushCount:(long long)arg4;	// IMP=0x00000000005b95dd
