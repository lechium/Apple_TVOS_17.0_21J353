...
+ (id)sharedInstance;	// IMP=0x00100000004f3586
- (void).cxx_destruct;	// IMP=0x00000000004f3573
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000004f3435
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x00000000004f33b2
- (void)completeCurrentReport;	// IMP=0x00000000004f322e
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x00000000004f31f9
- (void)incrementWatchAddedNotificationCount;	// IMP=0x00000000004f31c4
- (id)init;	// IMP=0x00000000004f311f
