...
- (void).cxx_destruct;	// IMP=0x0000000000233ebd
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000233869
- (id)attributeDescriptions;	// IMP=0x00000000002335f4
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x00000000002333f6
