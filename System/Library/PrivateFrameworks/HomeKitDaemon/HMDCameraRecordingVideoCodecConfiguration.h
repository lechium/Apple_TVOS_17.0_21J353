...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009465af
- (void).cxx_destruct;	// IMP=0x0000000000946520
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000094640a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000094624e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000946052
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000945c70
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x0000000000945ba6
