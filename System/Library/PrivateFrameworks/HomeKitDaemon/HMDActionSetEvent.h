...
- (void).cxx_destruct;	// IMP=0x0000000000670c7a
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000006706e9
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000025b65
