...
+ (id)logCategory;	// IMP=0x001000000058c475
- (void).cxx_destruct;	// IMP=0x000000000058b5ee
...
- (id)logIdentifier;	// IMP=0x000000000058b331
- (void)_submitMetric;	// IMP=0x000000000058afba
- (void)submitMetric;	// IMP=0x000000000058af49
@property(readonly, nonatomic) NSError *topError;
- (id)state;	// IMP=0x000000000058a9ca
- (void)updateReachableState:(_Bool)arg1;	// IMP=0x000000000058a950
- (void)updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 withError:(id)arg4;	// IMP=0x000000000058a85d
- (id)expectedTransport;	// IMP=0x000000000058a7cf
...
- (_Bool)isCurrentPrimaryResident;	// IMP=0x000000000058a5d4
@property(readonly, nonatomic) double sessionCheckIntervalSec;
- (id)attributeDescriptions;	// IMP=0x0000000000589d37
- (void)_resetSessionMetric;	// IMP=0x0000000000589ad0
- (void)resetSessionMetric;	// IMP=0x0000000000589a5f
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000589813
