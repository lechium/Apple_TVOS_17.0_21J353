...
- (void).cxx_destruct;	// IMP=0x0000000000b48448
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x0000000000b482ec
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x0000000000b4805d
- (id)description;	// IMP=0x0000000000b47f9d
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000b47ee8
