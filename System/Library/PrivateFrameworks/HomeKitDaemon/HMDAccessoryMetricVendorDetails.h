...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00400000005886f2
- (void).cxx_destruct;	// IMP=0x0000000000588570
...
- (id)attributeDescriptions;	// IMP=0x00000000005882da
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x0000000000588194
- (id)initWithAccessory:(id)arg1;	// IMP=0x0000000000587a4f
