...
+ (id)properties;	// IMP=0x0010000000ad1df1
+ (id)shareTokenFromKeyedArchiveData:(id)arg1;	// IMP=0x00100000007d42ec
+ (id)keyedArchiveToken:(id)arg1;	// IMP=0x00100000007d42c3
+ (id)cd_getHMDUserFromMKFUser:(id)arg1;	// IMP=0x00100000007d4090
+ (id)cd_getMKFUserFromUUID:(id)arg1;	// IMP=0x00100000007d3ef6
+ (Class)cd_entityClass;	// IMP=0x00100000007d3ee5
+ (id)cd_parentReferenceName;	// IMP=0x00100000007d3ed8
...
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000007d37f8
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000007d358b
