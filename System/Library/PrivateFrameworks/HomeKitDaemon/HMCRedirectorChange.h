...
- (void).cxx_destruct;	// IMP=0x0000000000c4a847
...
- (void)dumpForLoggingWithPrefix:(id)arg1 logType:(unsigned char)arg2;	// IMP=0x0000000000c4a5fb
- (id)descriptionLines;	// IMP=0x0000000000c4a32e
- (id)description;	// IMP=0x0000000000c4a231
