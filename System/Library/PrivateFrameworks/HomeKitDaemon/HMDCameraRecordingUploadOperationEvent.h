...
- (void).cxx_destruct;	// IMP=0x0000000000a5c764
...
- (id)attributeDescriptions;	// IMP=0x0000000000a5c32d
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x0000000000a5c27a
