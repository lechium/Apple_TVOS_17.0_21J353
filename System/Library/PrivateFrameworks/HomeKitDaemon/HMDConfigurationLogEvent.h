...
- (void).cxx_destruct;	// IMP=0x00000000002a5c0e
...
- (_Bool)isSubmitted;	// IMP=0x00000000002a5945
...
- (id)initWithHomeConfigurations:(id)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00000000002a4ec6
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x00000000002a4c33
