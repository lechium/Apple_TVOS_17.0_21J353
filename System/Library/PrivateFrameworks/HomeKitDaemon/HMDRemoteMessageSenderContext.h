...
- (void).cxx_destruct;	// IMP=0x0000000000b437e6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b43746
@property(readonly, copy) NSString *propertyDescription;
@property(readonly, copy) NSString *mergeID;
- (id)initWithDeviceHandle:(id)arg1 accountHandle:(id)arg2 accountIdentifier:(id)arg3 deviceVersion:(id)arg4 pairingIdentityIdentifier:(id)arg5;	// IMP=0x0000000000b43461
