...
+ (id)logCategory;	// IMP=0x001000000065589d
- (void).cxx_destruct;	// IMP=0x000000000065584a
...
- (void)authenticate;	// IMP=0x000000000065575e
- (id)logIdentifier;	// IMP=0x000000000065574c
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x000000000065564f
