...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0010000000416171
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0000000000416106
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000ccc6d4
