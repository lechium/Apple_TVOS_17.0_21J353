...
+ (id)backingModelProtocol;	// IMP=0x001000000089603c
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000895f88
+ (Class)cd_modelClass;	// IMP=0x00100000002baca3
+ (id)fetchRequest;	// IMP=0x0010000000cf66de
- (id)castIfAccountHandle;	// IMP=0x0000000000896083
