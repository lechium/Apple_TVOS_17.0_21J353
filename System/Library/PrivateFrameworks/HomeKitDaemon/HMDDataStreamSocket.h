...
+ (id)logCategory;	// IMP=0x001000000055d6e9
- (void).cxx_destruct;	// IMP=0x000000000055d437
...
- (void)closeInitiated;	// IMP=0x000000000055d3a2
- (void)handleIncomingData:(id)arg1;	// IMP=0x000000000055d2d7
- (void)closeWithError:(id)arg1;	// IMP=0x000000000055d1ee
- (id)readData;	// IMP=0x000000000055d193
- (void)_writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000055d0b5
- (void)writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000055d00b
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000055cf76
- (void)close;	// IMP=0x000000000055cf62
...
- (id)initWithStreamProtocol:(id)arg1 applicationProtocolName:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000055cce1
