...
+ (id)sharedManager;	// IMP=0x0060000000a73872
- (void).cxx_destruct;	// IMP=0x0000000000a73448
...
- (void)dealloc;	// IMP=0x0000000000a73226
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000a72f1d
