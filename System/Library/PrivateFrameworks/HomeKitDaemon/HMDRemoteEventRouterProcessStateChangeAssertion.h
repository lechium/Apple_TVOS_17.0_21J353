...
+ (id)logCategory;	// IMP=0x00100000009691a0
- (void).cxx_destruct;	// IMP=0x0000000000968b5a
...
- (void)_backgroundTimerDidExpire:(id)arg1;	// IMP=0x000000000096861b
- (void)_removeBackgroundTimer:(id)arg1;	// IMP=0x00000000009684e8
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)arg1;	// IMP=0x000000000096827b
- (void)foregroundStateChangedWithBundleIdentifier:(id)arg1 applicationState:(unsigned long long)arg2;	// IMP=0x0000000000968173
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 applicationsAndIntervals:(id)arg3 dataSource:(id)arg4;	// IMP=0x0000000000968002
