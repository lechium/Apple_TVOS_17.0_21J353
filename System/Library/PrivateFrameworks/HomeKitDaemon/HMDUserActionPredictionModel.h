...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x00600000003c8e6f
+ (id)hmbProperties;	// IMP=0x00600000003c8e3f
- (id)userActionPrediction;	// IMP=0x00000000003c99f2
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x00000000003c93ed
