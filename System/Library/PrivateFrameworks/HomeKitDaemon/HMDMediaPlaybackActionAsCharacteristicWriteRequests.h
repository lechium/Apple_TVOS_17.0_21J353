...
- (void).cxx_destruct;	// IMP=0x00000000004f8de2
...
- (id)initWithAction:(id)arg1 characteristicWriteRequests:(id)arg2;	// IMP=0x00000000004f8d14
- (id)init;	// IMP=0x00000000004f8c6c
