...
- (void).cxx_destruct;	// IMP=0x0000000000226fd1
...
- (id)description;	// IMP=0x0000000000226dc6
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 uuid:(id)arg5;	// IMP=0x0000000000226caf
