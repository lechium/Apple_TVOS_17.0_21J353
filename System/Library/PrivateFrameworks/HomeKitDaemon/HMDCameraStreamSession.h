...
+ (id)logCategory;	// IMP=0x0010000000bf19b2
- (void).cxx_destruct;	// IMP=0x0000000000bf194e
...
- (id)logIdentifier;	// IMP=0x0000000000bf186d
- (id)negotiatedParameters;	// IMP=0x0000000000bf1718
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000bf1398
