...
+ (id)backingModelProtocol;	// IMP=0x001000000022aa0b
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000022a957
+ (Class)cd_modelClass;	// IMP=0x0010000000c08166
+ (id)fetchRequest;	// IMP=0x0010000000cf6fbe
- (void)removeAccessoriesObject:(id)arg1;	// IMP=0x000000000022ab1e
- (void)addAccessoriesObject:(id)arg1;	// IMP=0x000000000022ab02
@property(readonly, retain, nonatomic) NSArray *accessories;
@property(readonly) id <MKFHome> home;
- (id)castIfMediaPlaybackAction;	// IMP=0x000000000022aa52
