...
+ (id)logCategory;	// IMP=0x00100000002521dc
- (void).cxx_destruct;	// IMP=0x0000000000252051
...
- (void)_handleSnapshotFile:(id)arg1 error:(id)arg2;	// IMP=0x0000000000251d55
- (void)_getSnapshot:(unsigned long long)arg1;	// IMP=0x0000000000251c32
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x0000000000251bb6
- (id)logIdentifier;	// IMP=0x0000000000251b66
- (void)dealloc;	// IMP=0x0000000000251a81
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 snapshotRequestHandler:(id)arg6;	// IMP=0x000000000025194b
