...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000075661
- (void).cxx_destruct;	// IMP=0x0000000000075574
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000075418
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000075110
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000074f31
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000074b79
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x0000000000074a7c
