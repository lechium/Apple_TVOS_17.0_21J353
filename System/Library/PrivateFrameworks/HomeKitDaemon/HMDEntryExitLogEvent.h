...
+ (id)exitLogEvent:(double)arg1 isFalse:(_Bool)arg2;	// IMP=0x0010000000c653dc
+ (id)entryLogEvent:(double)arg1 isFalse:(_Bool)arg2;	// IMP=0x0010000000c6539c
...
- (id)initWithReason:(unsigned long long)arg1 isFalse:(_Bool)arg2 lastFired:(double)arg3;	// IMP=0x0000000000c65068
