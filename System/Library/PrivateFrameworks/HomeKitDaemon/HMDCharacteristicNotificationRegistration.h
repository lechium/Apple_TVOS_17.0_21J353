...
- (void).cxx_destruct;	// IMP=0x0000000000b0dffb
...
- (id)attributeDescriptions;	// IMP=0x0000000000b0dcda
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b0dccf
- (unsigned long long)hash;	// IMP=0x0000000000b0dc19
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0d8e2
- (id)initWithAccessoryUUID:(id)arg1 characteristicInstanceID:(id)arg2 deviceIdsDestination:(id)arg3 userUUID:(id)arg4 lastModified:(id)arg5 enabled:(_Bool)arg6;	// IMP=0x0000000000b0d79f
