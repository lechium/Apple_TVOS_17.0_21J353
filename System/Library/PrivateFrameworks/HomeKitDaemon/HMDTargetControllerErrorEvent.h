...
+ (id)errorEventWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0060000000c20cf0
- (void).cxx_destruct;	// IMP=0x0000000000c20cdf
...
- (id)initWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0000000000c20c3c
