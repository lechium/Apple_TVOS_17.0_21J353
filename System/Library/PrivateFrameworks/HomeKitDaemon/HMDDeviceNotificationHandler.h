...
+ (id)logCategory;	// IMP=0x00100000001f8a32
- (void).cxx_destruct;	// IMP=0x00000000001f7acc
...
- (id)logIdentifier;	// IMP=0x00000000001f78e8
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000001f773a
- (void)_dispatchNotificationUpdate:(id)arg1;	// IMP=0x00000000001f6c19
- (void)_dispatchNotification;	// IMP=0x00000000001f69db
- (void)_beginCoalesce:(_Bool)arg1;	// IMP=0x00000000001f65aa
- (void)sendNotificationForMediaProperties:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3;	// IMP=0x00000000001f6228
- (id)_notificationUpdateWithRequestID:(id)arg1 allowAdd:(_Bool)arg2;	// IMP=0x00000000001f6000
- (void)sendCoalescedRemoteNotificationForAccessories:(id)arg1;	// IMP=0x00000000001f5d6c
- (void)sendNotificationForCharacteristicUpdates:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000001f55a1
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5 dataSource:(id)arg6;	// IMP=0x00000000001f5441
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5;	// IMP=0x00000000001f535c
