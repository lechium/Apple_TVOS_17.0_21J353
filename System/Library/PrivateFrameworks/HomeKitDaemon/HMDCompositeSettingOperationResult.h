...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002e7271
- (void).cxx_destruct;	// IMP=0x00000000002e721e
...
- (id)attributeDescriptions;	// IMP=0x00000000002e6ff4
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002e6f06
