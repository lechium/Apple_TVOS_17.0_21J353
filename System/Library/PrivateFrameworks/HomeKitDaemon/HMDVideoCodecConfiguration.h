...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000073693
- (void).cxx_destruct;	// IMP=0x0000000000073521
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007340b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000731a7
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000072fdb
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000072bf2
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000072b28
