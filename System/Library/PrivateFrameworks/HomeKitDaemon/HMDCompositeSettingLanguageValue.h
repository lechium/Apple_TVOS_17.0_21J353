...
- (void).cxx_destruct;	// IMP=0x00000000002e684d
...
- (id)attributeDescriptions;	// IMP=0x00000000002e6623
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x00000000002e6526
