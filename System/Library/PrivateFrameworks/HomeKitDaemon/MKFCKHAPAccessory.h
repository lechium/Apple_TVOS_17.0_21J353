...
+ (id)fetchWithLocalModel:(id)arg1 context:(id)arg2;	// IMP=0x00800000007b98cb
+ (id)fetchRequest;	// IMP=0x0080000000cf69fe
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x00000000007ba099
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x00000000007b9947
- (id)fetchLocalModelWithContext:(id)arg1;	// IMP=0x00000000007b9909
