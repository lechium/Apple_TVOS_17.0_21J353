...
+ (id)logCategory;	// IMP=0x0000000000940fe8
- (void).cxx_destruct;	// IMP=0x0000000000940c02
...
- (void)markSiriReady;	// IMP=0x0000000000940aeb
- (void)markCoreDataFirstImportComplete;	// IMP=0x0000000000940a5d
- (void)markCurrentAccessoryAddComplete;	// IMP=0x00000000009409cf
- (void)markPairingIdentityCreated;	// IMP=0x0000000000940941
- (void)markSettingsCreated;	// IMP=0x00000000009408b3
- (id)initWithSetupSessionStartTime:(unsigned long long)arg1 setupSessionEndTime:(unsigned long long)arg2 logEventSubmitter:(id)arg3;	// IMP=0x000000000094089a
- (id)initWithSetupSessionStartTime:(unsigned long long)arg1 setupSessionEndTime:(unsigned long long)arg2 logEventSubmitter:(id)arg3 currentUpTicksFactory:(CDUnknownBlockType)arg4;	// IMP=0x00000000009407c0
