...
+ (id)logCategory;	// IMP=0x00100000009780df
- (void).cxx_destruct;	// IMP=0x000000000097808c
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000977f92
- (id)initWithOptions:(id)arg1 changeToken:(id)arg2 promise:(id)arg3 database:(id)arg4 useAnonymousRequests:(_Bool)arg5 interestedRecordIDs:(id)arg6 mirrorInput:(id)arg7;	// IMP=0x0000000000977dc6
