...
- (void).cxx_destruct;	// IMP=0x00000000007b19b1
...
- (id)initWithExistingDestinationType:(id)arg1 destinationType:(id)arg2 isTriggeredOnControllerDevice:(id)arg3 userPrivilege:(id)arg4;	// IMP=0x00000000007b1854
