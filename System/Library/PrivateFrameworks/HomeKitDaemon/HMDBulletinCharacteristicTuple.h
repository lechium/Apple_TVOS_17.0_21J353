...
+ (id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x0060000000017043
- (void).cxx_destruct;	// IMP=0x0000000000016fdf
...
- (void)updatePostingTime;	// IMP=0x0000000000016f13
- (id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x0000000000016dd0
