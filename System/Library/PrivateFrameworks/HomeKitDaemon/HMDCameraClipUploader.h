...
+ (id)logCategory;	// IMP=0x0010000000ae2a7c
- (void).cxx_destruct;	// IMP=0x0000000000ae26a0
...
- (id)attributeDescriptions;	// IMP=0x0000000000ae2392
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x0000000000ae2308
- (void)_handleFatalOperationFailure;	// IMP=0x0000000000ae212d
- (void)_startNextOperation;	// IMP=0x0000000000ae1ff4
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x0000000000ae1d69
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x0000000000ae1acd
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000ae1900
- (id)_createClip;	// IMP=0x0000000000ae1779
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x0000000000ae1746
- (id)finish;	// IMP=0x0000000000ae164a
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x0000000000ae1342
- (id)addVideoInitData:(id)arg1;	// IMP=0x0000000000ae10a8
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000ae0d5e
- (id)createClip;	// IMP=0x0000000000ae0b6f
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x0000000000ae08af
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x0000000000ae0798
