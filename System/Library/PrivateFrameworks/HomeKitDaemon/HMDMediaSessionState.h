...
- (void).cxx_destruct;	// IMP=0x00000000007575fb
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x0000000000757451
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000075709f
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x0000000000756b00
