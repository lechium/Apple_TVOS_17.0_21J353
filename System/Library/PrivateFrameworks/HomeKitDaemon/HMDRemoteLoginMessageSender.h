...
+ (id)logCategory;	// IMP=0x001000000076a991
- (void).cxx_destruct;	// IMP=0x000000000076a800
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000076a3a6
- (id)logIdentifier;	// IMP=0x000000000076a356
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x000000000076a236
