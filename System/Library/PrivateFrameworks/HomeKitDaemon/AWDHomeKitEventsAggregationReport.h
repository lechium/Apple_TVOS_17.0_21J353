...
@interface AWDHomeKitEventsAggregationReport : PBCodable
{
...
- (void).cxx_destruct;	// IMP=0x000000000055ccce
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000055c7ef
- (unsigned long long)hash;	// IMP=0x000000000055c49f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055bfad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055bc55
- (void)copyTo:(id)arg1;	// IMP=0x000000000055b92c
- (void)writeTo:(id)arg1;	// IMP=0x000000000055b5b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000055a63d
- (id)dictionaryRepresentation;	// IMP=0x0000000000559d3f
- (id)description;	// IMP=0x0000000000559c90
