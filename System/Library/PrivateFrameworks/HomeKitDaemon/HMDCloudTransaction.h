...
+ (id)shortDescription;	// IMP=0x0060000000bec4b0
- (void).cxx_destruct;	// IMP=0x0000000000bec41b
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x0000000000bebea8
- (void)loadObjectChanges;	// IMP=0x0000000000bebe85
- (id)changeWithRecordName:(id)arg1;	// IMP=0x0000000000bebe0b
- (id)changeWithObjectID:(id)arg1;	// IMP=0x0000000000bebd91
...
- (void)updateCloudCache;	// IMP=0x0000000000bebb71
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x0000000000bebb08
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x0000000000beba9f
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x0000000000beba36
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x0000000000beb9cd
- (_Bool)moreChangesToProcess;	// IMP=0x0000000000beb989
- (void)setAllChangedAsProcessed;	// IMP=0x0000000000beb94c
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x0000000000beb7b7
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000beb72c
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x0000000000beb6b2
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x0000000000beb600
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x0000000000beb592
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x0000000000beb4e5
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x0000000000beb47c
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x0000000000beb413
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x0000000000beb3aa
...
- (id)description;	// IMP=0x0000000000beb0cd
- (id)shortDescription;	// IMP=0x0000000000beafdc
- (void)updateCloudZone:(id)arg1;	// IMP=0x0000000000beaf55
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x0000000000beaeb2
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x0000000000beae9d
- (id)init;	// IMP=0x0000000000beadf5
