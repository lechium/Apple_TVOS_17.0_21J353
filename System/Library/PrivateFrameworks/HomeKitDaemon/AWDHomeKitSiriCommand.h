...
@interface AWDHomeKitSiriCommand : PBCodable
{
...
- (void).cxx_destruct;	// IMP=0x0000000000693f89
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000693d7c
- (unsigned long long)hash;	// IMP=0x0000000000693c2b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006939f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000069384d
- (void)copyTo:(id)arg1;	// IMP=0x00000000006936e6
- (void)writeTo:(id)arg1;	// IMP=0x0000000000693548
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000692e48
- (id)dictionaryRepresentation;	// IMP=0x0000000000692a34
- (id)description;	// IMP=0x0000000000692985
...
- (int)StringAsOutcome:(id)arg1;	// IMP=0x00000000006925e8
- (id)outcomeAsString:(int)arg1;	// IMP=0x00000000006925a0
@property(nonatomic) _Bool hasOutcome;
@property(nonatomic) int outcome; // @synthesize outcome=_outcome;
@property(nonatomic) _Bool hasDuration;
- (int)StringAsActionType:(id)arg1;	// IMP=0x00000000006923ae
- (id)actionTypeAsString:(int)arg1;	// IMP=0x0000000000692366
