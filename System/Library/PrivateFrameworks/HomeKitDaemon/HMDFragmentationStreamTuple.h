...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0060000000ab8f66
- (void).cxx_destruct;	// IMP=0x0000000000ab8f13
...
- (void)close;	// IMP=0x0000000000ab8e92
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000ab8cc0
