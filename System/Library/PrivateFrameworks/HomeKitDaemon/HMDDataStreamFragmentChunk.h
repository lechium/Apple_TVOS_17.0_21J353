...
- (void).cxx_destruct;	// IMP=0x0000000000553b61
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000553aec
- (unsigned long long)hash;	// IMP=0x00000000005539d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000553761
- (id)attributeDescriptions;	// IMP=0x00000000005534ea
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000552cef
- (id)initWithData:(id)arg1 sequenceNumber:(id)arg2 fragmentSequenceNumber:(id)arg3 type:(id)arg4 isLast:(_Bool)arg5;	// IMP=0x0000000000552b56
