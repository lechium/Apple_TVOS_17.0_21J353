...
- (void).cxx_destruct;	// IMP=0x0000000000224196
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x0000000000224098
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x000000000022400f
