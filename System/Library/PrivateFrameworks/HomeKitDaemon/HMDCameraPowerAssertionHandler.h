...
+ (id)logCategory;	// IMP=0x0010000000896efd
+ (id)sharedHandler;	// IMP=0x0010000000896ecd
- (void).cxx_destruct;	// IMP=0x0000000000896793
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x0000000000896699
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x00000000008965bb
- (id)init;	// IMP=0x00000000008964c5
