...
- (void).cxx_destruct;	// IMP=0x0000000000c20ba5
...
- (id)initWithGarageDoorStatus:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 timeStamp:(id)arg4 homeUUID:(id)arg5 homePresence:(id)arg6 triggerSource:(id)arg7 bundleId:(id)arg8 userUUID:(id)arg9;	// IMP=0x0000000000c2072a
