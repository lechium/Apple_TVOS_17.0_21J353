...
+ (id)properties;	// IMP=0x00100000005ee26f
+ (id)cd_createMKFCharacteristicFromDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0010000000bd8c82
+ (id)cd_modelTypeForCharacteristicFormat:(id)arg1;	// IMP=0x0010000000bd8c26
+ (Class)cd_entityClass;	// IMP=0x0010000000bd8c15
+ (id)cd_parentReferenceName;	// IMP=0x0010000000bd8c08
- (void).cxx_destruct;	// IMP=0x00000000005ee23e
...
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000bd84c0
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000bd81d4
- (_Bool)cd_updateManagedObjectInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000bd8101
