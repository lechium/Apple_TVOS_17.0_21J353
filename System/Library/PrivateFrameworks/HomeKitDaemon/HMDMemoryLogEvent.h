...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x0000000000b433c6
- (id)init;	// IMP=0x0000000000b4331e
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000ccc6da
