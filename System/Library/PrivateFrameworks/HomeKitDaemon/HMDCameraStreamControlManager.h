...
+ (id)logCategory;	// IMP=0x0010000000998a93
- (void).cxx_destruct;	// IMP=0x0000000000998946
...
- (id)logIdentifier;	// IMP=0x0000000000998836
- (void)_callStreamStoppedWithError:(id)arg1;	// IMP=0x00000000009985e4
- (void)_callStreamReconfigured;	// IMP=0x000000000099843a
- (void)_callStreamFirstFrameReceived;	// IMP=0x0000000000998290
- (void)_callStreamStarted;	// IMP=0x00000000009980e6
- (void)_callStreamRemoteConnectionSetup;	// IMP=0x0000000000997f3c
- (void)_callStreamNegotiated:(id)arg1;	// IMP=0x0000000000997d61
- (id)managerProtocol;	// IMP=0x0000000000997d25
- (void)_reportInternalErrorCode:(long long)arg1;	// IMP=0x0000000000997cd2
- (void)_reportErrorCode:(long long)arg1;	// IMP=0x0000000000997c7f
- (void)_cleanUpStreamSessionWithError:(id)arg1;	// IMP=0x0000000000997bcb
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 accessory:(id)arg6 streamManagementService:(id)arg7 isLocal:(_Bool)arg8;	// IMP=0x0000000000997997
