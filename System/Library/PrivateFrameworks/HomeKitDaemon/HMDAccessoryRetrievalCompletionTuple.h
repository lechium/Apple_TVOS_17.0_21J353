...
- (void).cxx_destruct;	// IMP=0x0000000000a0b74f
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a0b374
- (void)stop;	// IMP=0x0000000000a0b2ca
- (void)start;	// IMP=0x0000000000a0b151
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a0b083
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000a0af62
