...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000006b6ec7
- (void).cxx_destruct;	// IMP=0x00000000006b6d6e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000006b6c41
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000006b6a76
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000006b6901
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000006b65c2
- (id)initWithPrebufferLength:(id)arg1 eventTriggerOptions:(unsigned long long)arg2 mediaContainerConfigurations:(id)arg3;	// IMP=0x00000000006b650d
