...
+ (id)logCategory;	// IMP=0x0010000000290d3c
- (void).cxx_destruct;	// IMP=0x0000000000290cae
...
- (id)logIdentifier;	// IMP=0x0000000000290c0c
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x0000000000290a4a
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x0000000000290888
@property(readonly, nonatomic) int remoteAudioSocket;
@property(readonly, nonatomic) int remoteVideoSocket;
- (void)setUpRemoteConnectionWithDevice:(id)arg1;	// IMP=0x0000000000290748
@property(readonly) IDSSession *session;
- (void)dealloc;	// IMP=0x000000000029065b
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 delegate:(id)arg3 delegateQueue:(id)arg4;	// IMP=0x00000000002904f8
