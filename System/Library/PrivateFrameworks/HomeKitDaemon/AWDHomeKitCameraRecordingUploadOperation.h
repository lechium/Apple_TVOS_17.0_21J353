...
- (void).cxx_destruct;	// IMP=0x00000000009ee787
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000009ee578
- (unsigned long long)hash;	// IMP=0x00000000009ee405
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009ee1da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009ee053
- (void)copyTo:(id)arg1;	// IMP=0x00000000009edf04
- (void)writeTo:(id)arg1;	// IMP=0x00000000009edd98
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009ed79c
- (id)dictionaryRepresentation;	// IMP=0x00000000009ed433
- (id)description;	// IMP=0x00000000009ed384
@property(nonatomic) _Bool hasOperationStartTime;
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000009ed24d
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000009ed202
