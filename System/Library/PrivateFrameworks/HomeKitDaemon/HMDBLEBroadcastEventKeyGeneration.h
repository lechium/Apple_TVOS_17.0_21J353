...
+ (id)broadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x00600000008a6be5
- (void).cxx_destruct;	// IMP=0x00000000008a6bd2
...
- (id)initBroadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x00000000008a6b32
