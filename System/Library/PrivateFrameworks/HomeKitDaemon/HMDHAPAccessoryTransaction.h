...
+ (id)properties;	// IMP=0x0010000000446f33
+ (id)cd_getMKFHAPAccessoryFromAccessoryUUID:(id)arg1;	// IMP=0x00100000008bd19c
+ (id)cd_getMKFHAPAccessoryFromAccessory:(id)arg1;	// IMP=0x00100000008bd049
+ (id)cd_getMKFServiceFromAccessoryUUID:(id)arg1 serviceInstanceId:(id)arg2;	// IMP=0x00100000008bcdce
+ (Class)cd_entityClass;	// IMP=0x00100000008bcdbd
+ (id)cd_parentReferenceName;	// IMP=0x00100000008bcdb0
- (void).cxx_destruct;	// IMP=0x0000000000446f20
...
- (id)dependentUUIDs;	// IMP=0x0000000000446751
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000008bc8d4
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000008bc25d
