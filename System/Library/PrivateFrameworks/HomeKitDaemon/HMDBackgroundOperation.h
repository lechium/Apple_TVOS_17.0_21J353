...
+ (id)logCategory;	// IMP=0x001000000072c163
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000072c15b
+ (id)predicate;	// IMP=0x001000000072c0b3
+ (_Bool)persistent;	// IMP=0x001000000072c00b
- (void).cxx_destruct;	// IMP=0x000000000072bf54
...
- (id)dumpState;	// IMP=0x000000000072bc6d
- (id)attributeDescriptions;	// IMP=0x000000000072b9b1
- (id)logIdentifier;	// IMP=0x000000000072b961
- (id)AllDependencies;	// IMP=0x000000000072b901
- (_Bool)hasDependency:(id)arg1;	// IMP=0x000000000072b85f
- (void)removeDependency:(id)arg1;	// IMP=0x000000000072b7cb
- (void)addDependency:(id)arg1;	// IMP=0x000000000072b734
- (_Bool)isDeferred;	// IMP=0x000000000072b68d
@property(retain) NSDate *deferralDate; // @synthesize deferralDate=_deferralDate;
- (void)deferWithFailureCount:(long long)arg1;	// IMP=0x000000000072b510
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000072b1f9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000072b043
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000072aef7
- (void)markOperationFinished;	// IMP=0x000000000072aee0
- (_Bool)runOperation:(id)arg1;	// IMP=0x000000000072aa49
- (id)initWithUserData:(id)arg1 dataSource:(id)arg2 backGroundOpsManager:(id)arg3;	// IMP=0x000000000072a938
- (id)initWithUserData:(id)arg1;	// IMP=0x000000000072a8a2
- (id)initWithUUID:(id)arg1 userData:(id)arg2 backGroundOpsManager:(id)arg3 scheduledDate:(id)arg4 expirationDate:(id)arg5 dataSource:(id)arg6 dependentOperations:(id)arg7;	// IMP=0x000000000072a6c8
- (_Bool)mainWithError:(id *)arg1;	// IMP=0x000000000072a620
