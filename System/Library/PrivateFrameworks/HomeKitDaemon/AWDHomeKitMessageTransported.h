...
- (void).cxx_destruct;	// IMP=0x00000000005353f5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000053521d
- (unsigned long long)hash;	// IMP=0x00000000005350dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000534eef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000534d66
- (void)copyTo:(id)arg1;	// IMP=0x0000000000534c2f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000534ae4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005345df
- (id)dictionaryRepresentation;	// IMP=0x00000000005342bf
- (id)description;	// IMP=0x0000000000534210
@property(readonly, nonatomic) _Bool hasMessageName;
- (int)StringAsDirection:(id)arg1;	// IMP=0x0000000000534196
- (id)directionAsString:(int)arg1;	// IMP=0x0000000000534141
@property(nonatomic) _Bool hasDirection;
@property(nonatomic) int direction; // @synthesize direction=_direction;
- (int)StringAsTransport:(id)arg1;	// IMP=0x0000000000533fbd
- (id)transportAsString:(int)arg1;	// IMP=0x0000000000533f75
@property(nonatomic) _Bool hasTransport;
@property(nonatomic) int transport; // @synthesize transport=_transport;
- (int)StringAsMessageType:(id)arg1;	// IMP=0x0000000000533e57
- (id)messageTypeAsString:(int)arg1;	// IMP=0x0000000000533e0f
