...
+ (id)backingModelProtocol;	// IMP=0x0010000000901c50
+ (id)homeRelation;	// IMP=0x0010000000901c20
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000901b6c
+ (id)fetchRequest;	// IMP=0x0010000000cf6ffe
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistration;	// IMP=0x0000000000901cd5
