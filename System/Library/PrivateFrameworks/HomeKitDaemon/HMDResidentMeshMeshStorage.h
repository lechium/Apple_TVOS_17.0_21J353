...
- (void).cxx_destruct;	// IMP=0x000000000079ff41
...
- (void)_requestStatus;	// IMP=0x000000000079fb46
- (id)initWithResidentDevice:(id)arg1 owner:(id)arg2;	// IMP=0x000000000079f9f7
