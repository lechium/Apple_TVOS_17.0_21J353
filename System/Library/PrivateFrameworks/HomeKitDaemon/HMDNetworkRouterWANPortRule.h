...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000057e0d6
- (void).cxx_destruct;	// IMP=0x000000000057e082
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057d8f3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000057d7c1
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000057d16c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000057cb73
- (id)initWithProtocol:(id)arg1 hostDNSName:(id)arg2 hostIPStart:(id)arg3 hostIPEnd:(id)arg4 hostPortStart:(id)arg5 hostPortEnd:(id)arg6;	// IMP=0x000000000057ca4c
- (id)init;	// IMP=0x000000000057ca1d
- (void)addTo:(id)arg1;	// IMP=0x00000000004ea3e9
