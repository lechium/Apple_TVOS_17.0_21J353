...
- (void).cxx_destruct;	// IMP=0x000000000080c72f
@property(readonly, nonatomic) id <HMMLogEventSubmitting> logEventSubmitter; // @synthesize logEventSubmitter=_logEventSubmitter;
- (void)_handleHomeDataChanged:(id)arg1;	// IMP=0x000000000080c03d
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000080bfc6
- (void)performResidentRequest:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000080bdf2
- (void)handlePrimaryResidentChanged:(id)arg1;	// IMP=0x000000000080bc1b
- (void)performSync;	// IMP=0x000000000080bbc8
- (void)stop;	// IMP=0x000000000080bb88
- (id)start;	// IMP=0x000000000080b9dc
- (id)initWithHome:(id)arg1 codingModel:(id)arg2 dispatcher:(id)arg3 residentDeviceManager:(id)arg4 notificationCenter:(id)arg5 persistence:(id)arg6 isResidentCapable:(_Bool)arg7 dataSource:(id)arg8 logEventSubmitter:(id)arg9;	// IMP=0x000000000080b831
