...
+ (id)backingModelProtocol;	// IMP=0x001000000062c6b5
+ (id)homeRelation;	// IMP=0x001000000062c685
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000062c5d1
+ (id)fetchRequest;	// IMP=0x0010000000cf67de
@property(readonly) id <MKFHome> home;
- (id)castIfBulletinCondition;	// IMP=0x000000000062c73a
