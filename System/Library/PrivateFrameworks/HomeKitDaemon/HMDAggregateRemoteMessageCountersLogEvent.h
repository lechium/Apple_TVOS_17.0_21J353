...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000005f1618
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x00100000005f1540
- (void).cxx_destruct;	// IMP=0x00000000005f14dc
...
- (id)__initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x00000000005f1166
- (id)init;	// IMP=0x00000000005f10be
