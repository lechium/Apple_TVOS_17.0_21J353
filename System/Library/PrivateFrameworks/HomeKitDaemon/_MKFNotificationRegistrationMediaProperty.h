...
+ (id)backingModelProtocol;	// IMP=0x001000000094122e
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000094117a
+ (id)fetchRequest;	// IMP=0x0010000000cf703e
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistrationMediaProperty;	// IMP=0x0000000000941121
@property(readonly, copy, nonatomic) MKFNotificationRegistrationMediaPropertyDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x000000000094104f
