...
+ (id)logCategory;	// IMP=0x00100000006733db
- (void).cxx_destruct;	// IMP=0x0000000000673a7e
...
- (void)_handleXPCEvent:(id)arg1;	// IMP=0x0000000000673885
- (void)_startUpEmptyMachServices;	// IMP=0x0000000000673513
- (void)configureWithQueue:(id)arg1;	// IMP=0x0000000000673442
