...
+ (id)logCategory;	// IMP=0x00600000000ac46d
- (void).cxx_destruct;	// IMP=0x00000000000ac370
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000000abca7
- (id)createSelectedAudioParameters;	// IMP=0x00000000000ab8c5
- (id)createSRTPParamters;	// IMP=0x00000000000ab83a
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x00000000000ab28b
- (_Bool)selectAudioParameters;	// IMP=0x00000000000aaa7b
- (id)logIdentifier;	// IMP=0x00000000000aaa2b
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000000aa89e
