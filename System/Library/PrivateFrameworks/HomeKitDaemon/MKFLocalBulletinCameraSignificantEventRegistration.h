...
+ (id)fetchCameraSignificantEventRegistrationForAccessoryUUID:(id)arg1 managedObjectContext:(id)arg2;	// IMP=0x00800000002983a4
+ (id)fetchRequest;	// IMP=0x0080000000cf64fe
