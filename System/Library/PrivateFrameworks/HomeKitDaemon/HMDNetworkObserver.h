...
+ (id)supportedEventClasses;	// IMP=0x001000000049df03
- (void).cxx_destruct;	// IMP=0x000000000049db15
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000049d942
- (void)checkNetworkChange;	// IMP=0x000000000049d477
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x000000000049d3bc
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x000000000049d301
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x000000000049cdb5
- (void)runDailyTask;	// IMP=0x000000000049c8a5
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000049c7dc
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x000000000049c5dd
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x000000000049c361
- (void)_clearNonPersistentCounters;	// IMP=0x000000000049c29e
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x000000000049c168
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x000000000049c088
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x000000000049bed3
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x000000000049bdec
- (void)stop;	// IMP=0x000000000049bc6d
- (void)start;	// IMP=0x000000000049ba41
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x000000000049b849
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x000000000049b6e1
