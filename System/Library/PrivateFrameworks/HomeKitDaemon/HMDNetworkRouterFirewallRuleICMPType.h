...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x006000000090740c
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x006000000090720c
- (void).cxx_destruct;	// IMP=0x00000000009071e4
...
- (id)description;	// IMP=0x000000000090706e
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (unsigned long long)hash;	// IMP=0x0000000000906e84
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000906d1a
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x0000000000906c77
