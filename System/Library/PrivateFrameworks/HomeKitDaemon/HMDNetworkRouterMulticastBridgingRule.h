...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000579f28
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000004ec150
- (void).cxx_destruct;	// IMP=0x0000000000579eea
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005799c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005798e5
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000579458
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000578fc2
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 destinationIPAddress:(id)arg3 destinationPort:(id)arg4;	// IMP=0x0000000000578eda
- (id)init;	// IMP=0x0000000000578eab
- (void)addTo:(id)arg1;	// IMP=0x00000000004ea695
