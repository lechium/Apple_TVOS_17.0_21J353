...
- (void).cxx_destruct;	// IMP=0x000000000023d97d
...
- (id)description;	// IMP=0x000000000023d783
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x000000000023d5e5
- (id)init;	// IMP=0x000000000023d53d
