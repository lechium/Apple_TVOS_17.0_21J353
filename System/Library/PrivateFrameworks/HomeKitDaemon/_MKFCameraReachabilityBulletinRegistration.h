...
+ (id)backingModelProtocol;	// IMP=0x00100000006c66b0
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000006c65fc
+ (id)fetchRequest;	// IMP=0x0010000000cf687e
@property(readonly) id <MKFHome> home;
- (id)castIfCameraReachabilityBulletinRegistration;	// IMP=0x00000000006c65a3
@property(readonly, copy, nonatomic) MKFCameraReachabilityBulletinRegistrationDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x00000000006c64d1
