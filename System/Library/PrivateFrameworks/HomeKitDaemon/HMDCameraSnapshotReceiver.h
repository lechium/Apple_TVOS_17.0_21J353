...
+ (id)logCategory;	// IMP=0x0010000000874cca
- (void).cxx_destruct;	// IMP=0x0000000000874c24
...
- (id)logIdentifier;	// IMP=0x0000000000874b0b
- (void)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008749b8
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x00000000008747f3
- (void)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x00000000008744a0
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegateQueue:(id)arg4 uniqueIdentifier:(id)arg5 snapshotRequestHandler:(id)arg6 residentMessageHandler:(id)arg7 remoteDevice:(id)arg8;	// IMP=0x000000000087424f
