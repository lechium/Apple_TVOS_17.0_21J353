...
+ (id)logCategory;	// IMP=0x0010000000a44a88
- (void).cxx_destruct;	// IMP=0x0000000000a43d0f
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000a430ed
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000a42f74
