...
- (void).cxx_destruct;	// IMP=0x0000000000345df8
...
- (id)attributeDescriptions;	// IMP=0x0000000000345b76
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x0000000000345ac0
