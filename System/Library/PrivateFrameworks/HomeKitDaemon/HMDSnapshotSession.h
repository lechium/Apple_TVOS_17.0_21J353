...
+ (id)logCategory;	// IMP=0x001000000082b8de
- (void).cxx_destruct;	// IMP=0x000000000082b87a
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x000000000082b3a7
- (void)dealloc;	// IMP=0x000000000082b32b
- (id)logIdentifier;	// IMP=0x000000000082b2db
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x000000000082b104
