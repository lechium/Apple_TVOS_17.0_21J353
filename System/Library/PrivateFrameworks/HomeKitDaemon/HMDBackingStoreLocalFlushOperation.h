...
- (void).cxx_destruct;	// IMP=0x0000000000842cab
...
- (void)main;	// IMP=0x0000000000842684
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008425b7
