...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000ae0314
- (unsigned long long)hash;	// IMP=0x0000000000ae0291
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ae018f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ae00dc
- (void)copyTo:(id)arg1;	// IMP=0x0000000000ae004c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000adff98
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000adfc22
- (id)dictionaryRepresentation;	// IMP=0x0000000000adfa7c
- (id)description;	// IMP=0x0000000000adf9cd
