...
- (void).cxx_destruct;	// IMP=0x0000000000bd7430
...
- (id)attributeDescriptions;	// IMP=0x0000000000bd712d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bd70a8
- (unsigned long long)hash;	// IMP=0x0000000000bd7064
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000bd69f7
- (long long)compare:(id)arg1;	// IMP=0x0000000000bd69e3
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000bd653d
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000bd6347
