...
+ (id)logCategory;	// IMP=0x001000000060a62e
- (void).cxx_destruct;	// IMP=0x000000000060a5b9
...
- (void)runHomeutilTask;	// IMP=0x000000000060a4b6
- (void)runDailyTask;	// IMP=0x000000000060a3ec
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 dailyScheduler:(id)arg3 logEventSubmitter:(id)arg4 dateProvider:(id)arg5 requestCountProvider:(id)arg6 logEventFactories:(id)arg7;	// IMP=0x000000000060a12c
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 accessoryDetailsManager:(id)arg3 dailyScheduler:(id)arg4 logEventSubmitter:(id)arg5 dateProvider:(id)arg6 activityContributors:(id)arg7;	// IMP=0x0000000000609d5a
