...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00600000000c0193
- (void).cxx_destruct;	// IMP=0x00000000000c012f
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x00000000000bff86
- (id)retrieveAndClearAllResponses;	// IMP=0x00000000000bfed0
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x00000000000bfe00
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000000bfd38
