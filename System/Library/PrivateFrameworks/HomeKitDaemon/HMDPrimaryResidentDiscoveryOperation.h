...
+ (id)logCategory;	// IMP=0x001000000049f342
- (void).cxx_destruct;	// IMP=0x000000000049ebf4
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000049e81a
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000049e7b0
- (void)finish;	// IMP=0x000000000049e746
- (void)main;	// IMP=0x000000000049e3b8
- (void)cancel;	// IMP=0x000000000049e389
- (void)run;	// IMP=0x000000000049e32e
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x000000000049dfc1
