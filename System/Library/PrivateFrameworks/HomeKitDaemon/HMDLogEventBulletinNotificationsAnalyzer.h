...
+ (id)managedEventCounterRequestGroups;	// IMP=0x001000000034506e
- (void).cxx_destruct;	// IMP=0x0000000000344c60
...
- (void)runDailyTask;	// IMP=0x0000000000344b7c
- (void)resetAggregationAnalysisContext;	// IMP=0x0000000000344b3f
- (void)populateAggregationAnalysisLogEvent:(id)arg1;	// IMP=0x0000000000344ac2
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000003449c1
- (long long)cameraReachabilityThresholdFromConfiguration:(id)arg1;	// IMP=0x0000000000344985
- (void)configurationChanged:(id)arg1;	// IMP=0x0000000000344929
- (id)initWithDataSource:(id)arg1 notificationSettingsProvider:(id)arg2;	// IMP=0x0000000000344476
