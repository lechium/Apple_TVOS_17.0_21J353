...
- (void).cxx_destruct;	// IMP=0x00000000009e1b53
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x00000000009e1abf
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x00000000009e198c
- (id)initWithName:(id)arg1;	// IMP=0x00000000009e18d8
