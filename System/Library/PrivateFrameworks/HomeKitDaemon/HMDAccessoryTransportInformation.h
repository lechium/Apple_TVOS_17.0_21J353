...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004ada44
- (void).cxx_destruct;	// IMP=0x00000000004ad9e0
...
- (id)attributeDescriptions;	// IMP=0x00000000004ad7cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004ad6fb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004ad4ea
- (id)report;	// IMP=0x00000000004ad2fb
...
- (id)initWithServerIdentifier:(id)arg1 instanceID:(id)arg2 linkType:(long long)arg3;	// IMP=0x00000000004ace63
