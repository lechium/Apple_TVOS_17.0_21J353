...
+ (id)supportedEventClasses;	// IMP=0x00100000009b473f
- (void).cxx_destruct;	// IMP=0x00000000009b4396
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x00000000009b3fdf
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x00000000009b3fd9
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x00000000009b3fd3
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x00000000009b3f18
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x00000000009b3e5d
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x00000000009b3d27
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x00000000009b3c47
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x00000000009b3277
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x00000000009b2acc
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x00000000009b28fb
- (void)runDailyTask;	// IMP=0x00000000009b2877
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000009b27ae
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x00000000009b2628
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x00000000009b2485
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x00000000009b239e
- (void)stop;	// IMP=0x00000000009b22c2
- (void)start;	// IMP=0x00000000009b216b
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x00000000009b2144
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x00000000009b1f9f
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x00000000009b1ea9
