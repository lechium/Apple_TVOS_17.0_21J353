...
+ (id)logCategory;	// IMP=0x001000000089e32e
+ (id)timeToLiveHeaderKey;	// IMP=0x001000000089e321
+ (id)requestStartTimeHeaderKey;	// IMP=0x001000000089e314
- (void).cxx_destruct;	// IMP=0x0000000000898f5d
...
- (void)configureWithHomeMembershipVerifier:(id)arg1;	// IMP=0x0000000000898ddc
- (void)transport:(id)arg1 idsIdentifier:(id)arg2 didAppearReachable:(_Bool)arg3;	// IMP=0x0000000000898d65
- (void)messageTransport:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x0000000000898c87
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000898a02
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x0000000000898929
- (id)start;	// IMP=0x00000000008986e4
- (long long)qualityOfService;	// IMP=0x00000000008986d9
- (_Bool)isSecure;	// IMP=0x00000000008986d1
- (id)initWithAccountRegistry:(id)arg1 rapportTransport:(id)arg2 idsTransport:(id)arg3 contextManager:(id)arg4 systemDateProvider:(id)arg5 idsDateProvider:(id)arg6 timerProvider:(id)arg7;	// IMP=0x000000000089848b
- (id)initWithAccountRegistry:(id)arg1;	// IMP=0x0000000000898360
