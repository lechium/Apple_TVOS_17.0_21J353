...
- (void).cxx_destruct;	// IMP=0x000000000090867f
...
- (id)mainReturningError;	// IMP=0x0000000000908167
- (id)initWithAtomicSaveEnabled:(_Bool)arg1 transaction:(id)arg2;	// IMP=0x00000000009080d4
- (id)initWithTransaction:(id)arg1;	// IMP=0x000000000090808d
