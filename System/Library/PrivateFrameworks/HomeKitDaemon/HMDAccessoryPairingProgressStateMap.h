...
- (void).cxx_destruct;	// IMP=0x00000000005c444f
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x00000000005c432c
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x00000000005c3cfa
- (id)initWithDate:(id)arg1;	// IMP=0x00000000005c3c75
