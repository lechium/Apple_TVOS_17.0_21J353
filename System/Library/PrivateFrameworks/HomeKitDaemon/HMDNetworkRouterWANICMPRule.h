...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000057c970
- (void).cxx_destruct;	// IMP=0x000000000057c932
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057c40c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000057c32d
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000057bea0
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000057ba0a
- (id)initWithHostDNSName:(id)arg1 hostIPStart:(id)arg2 hostIPEnd:(id)arg3 icmpTypes:(id)arg4;	// IMP=0x000000000057b922
- (id)init;	// IMP=0x000000000057b8f3
- (void)addTo:(id)arg1;	// IMP=0x00000000004ea494
