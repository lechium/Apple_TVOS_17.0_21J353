...
+ (id)updateWithInvitationState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00100000006742d4
+ (id)updateWithState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x001000000067429b
...
- (id)initWithHomeInviteLogEventState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x0000000000673af2
