...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004bde46
- (unsigned long long)hash;	// IMP=0x00000000004bde02
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004bdd4f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004bdcd2
- (void)copyTo:(id)arg1;	// IMP=0x00000000004bdc78
- (void)writeTo:(id)arg1;	// IMP=0x00000000004bdc05
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004bdbf8
- (id)dictionaryRepresentation;	// IMP=0x00000000004bdaff
- (id)description;	// IMP=0x00000000004bda50
