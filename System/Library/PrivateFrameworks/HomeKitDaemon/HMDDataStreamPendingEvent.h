...
- (void).cxx_destruct;	// IMP=0x00000000003615f1
...
- (id)initWithProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000003614dc
