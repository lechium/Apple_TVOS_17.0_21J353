...
+ (id)properties;	// IMP=0x0010000000cc6127
+ (id)cd_getMKFRoom:(id)arg1;	// IMP=0x001000000084ae83
+ (id)cd_getMKFAccessoryFromAccessory:(id)arg1;	// IMP=0x001000000084ace9
+ (id)cd_getMKFAccessoryFromAccessoryUUID:(id)arg1;	// IMP=0x001000000084ac57
+ (Class)cd_entityClass;	// IMP=0x001000000084ac46
+ (id)cd_parentReferenceName;	// IMP=0x001000000084ac39
- (void).cxx_destruct;	// IMP=0x0000000000cc6e43
...
- (id)dependentUUIDs;	// IMP=0x0000000000cc6c3f
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x000000000084a5a3
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x000000000084a3be
