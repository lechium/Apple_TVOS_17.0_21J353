...
+ (id)logCategory;	// IMP=0x001000000037e1ca
+ (unsigned long long)entitlementsForConnection:(id)arg1;	// IMP=0x001000000037de38
- (void).cxx_destruct;	// IMP=0x000000000037ce42
...
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000037cbda
- (void)updateUserInfo:(id)arg1;	// IMP=0x000000000037c910
- (void)handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000037c8fe
- (void)handleMessage:(id)arg1;	// IMP=0x000000000037c8ea
- (void)initiateRefresh;	// IMP=0x000000000037c84a
- (void)deactivate;	// IMP=0x000000000037c7f8
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000037c5da
- (void)_handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000037bc6f
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x000000000037afed
- (_Bool)shouldSendResponseForMessageIdentifier:(id)arg1;	// IMP=0x000000000037af6b
@property(readonly, nonatomic) NSSet *activeRequests;
- (void)updateSendPolicyParameters:(id)arg1;	// IMP=0x000000000037ae1f
...
- (void)__handleApplicationStateChange:(id)arg1;	// IMP=0x000000000037ab5b
...
- (id)_displayName;	// IMP=0x000000000037a7a1
...
- (id)counterIdentifierForMessage:(id)arg1;	// IMP=0x000000000037a304
...
- (id)attributeDescriptions;	// IMP=0x000000000037a010
- (id)shortDescription;	// IMP=0x0000000000379f27
- (void)dealloc;	// IMP=0x0000000000379dd4
- (id)initWithConnection:(id)arg1 counterTracker:(id)arg2;	// IMP=0x0000000000379b5f
