...
- (void).cxx_destruct;	// IMP=0x0000000000c3e4ce
...
- (id)attributeDescriptions;	// IMP=0x0000000000c3e2d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c3e2cb
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000c3e235
