...
+ (id)logCategory;	// IMP=0x0010000000098111
- (void).cxx_destruct;	// IMP=0x00000000000980e0
...
- (id)logIdentifier;	// IMP=0x0000000000098031
- (_Bool)shouldRetryImmediately:(double)arg1;	// IMP=0x0000000000098005
@property(readonly) double retryTimeInterval;
- (void)cancel;	// IMP=0x0000000000097f83
- (void)startWithDelegate:(id)arg1 delegateQueue:(id)arg2 responseTime:(double)arg3;	// IMP=0x0000000000097b9e
- (id)attributeDescriptions;	// IMP=0x0000000000097a6a
- (id)init;	// IMP=0x00000000000979fd
