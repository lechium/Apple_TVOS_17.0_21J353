...
+ (id)logCategory;	// IMP=0x0010000000848a81
- (void).cxx_destruct;	// IMP=0x0000000000847f54
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000847db4
- (void)stopWithReason:(unsigned short)arg1;	// IMP=0x0000000000847d72
- (void)start;	// IMP=0x0000000000847bd6
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readCallbackTimer:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000847ac5
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readTimeout:(double)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000847a00
