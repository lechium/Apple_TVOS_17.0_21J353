...
- (void).cxx_destruct;	// IMP=0x0000000000c773c1
...
- (void)rejectBulkSendSessionWithStatus:(unsigned short)arg1;	// IMP=0x0000000000c77312
- (void)acceptBulkSendSessionOnQueue:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c77284
- (id)initWithProtocol:(id)arg1 requestHeader:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000c771a4
