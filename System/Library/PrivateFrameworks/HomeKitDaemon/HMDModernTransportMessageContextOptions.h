...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000bdc18b
- (void).cxx_destruct;	// IMP=0x0000000000bdc158
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000bdbfd9
