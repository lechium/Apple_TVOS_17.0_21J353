...
+ (id)logCategory;	// IMP=0x0010000000cc75d0
+ (id)requestWithCharacteristic:(id)arg1;	// IMP=0x0010000000cc7587
- (void).cxx_destruct;	// IMP=0x0000000000cc7556
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cc73a5
- (id)attributeDescriptions;	// IMP=0x0000000000cc6f0f
- (id)initWithCharacteristic:(id)arg1;	// IMP=0x0000000000cc6e74
