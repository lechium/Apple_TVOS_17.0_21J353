...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000005c9f9a
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x00100000005c9eee
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x00100000005c9e68
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x00100000005c9df6
- (void).cxx_destruct;	// IMP=0x00000000005c9ca4
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x00000000005c95f0
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x00000000005c9566
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
- (id)getLowestError:(id)arg1;	// IMP=0x00000000005c8413
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x00000000005c78f8
- (_Bool)_isMatterAccessory;	// IMP=0x00000000005c78e3
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000005c783d
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x00000000005c73ed
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000005c7259
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x00000000005c6fe9
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x00000000005c6fd7
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x00000000005c6fc5
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000005c6757
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x00000000005c58bf
