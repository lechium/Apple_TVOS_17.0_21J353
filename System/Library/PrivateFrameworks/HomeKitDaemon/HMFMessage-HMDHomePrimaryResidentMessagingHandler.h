...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000035391e
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000003538a7
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000035377c
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000625ed2
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0020000000625e83
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000625e34
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000086d43a
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000086d3d0
- (_Bool)isRequestType;	// IMP=0x001000000005549c
- (unsigned long long)homeManagerOptions;	// IMP=0x001000000035372b
...
- (id)userForHome:(id)arg1;	// IMP=0x0010000000adebd6
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0010000000ade87c
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000cb1e9e
