...
+ (id)logCategory;	// IMP=0x006000000087160b
- (void).cxx_destruct;	// IMP=0x00000000008715c9
...
- (id)attributeDescriptions;	// IMP=0x00000000008711bf
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000008710c6
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000870cd5
