...
+ (id)backingModelProtocol;	// IMP=0x00100000007d46a5
+ (id)fetchRequest;	// IMP=0x0010000000cf71fe
@property(readonly) id <MKFHome> home;
- (id)castIfStringCharacteristic;	// IMP=0x00000000007d464c
@property(readonly, copy, nonatomic) MKFStringCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x00000000007d457e
