...
- (void).cxx_destruct;	// IMP=0x000000000089f80f
...
- (id)childActivityWithLabel:(unsigned long long)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000000089f60f
- (void)submitMetrics:(id)arg1 withName:(id)arg2;	// IMP=0x000000000089f4fc
- (void)completeWithSuccess:(_Bool)arg1;	// IMP=0x000000000089f4b1
- (void)setParent:(id)arg1;	// IMP=0x000000000089f3e6
- (void)activate;	// IMP=0x000000000089f3b1
...
- (id)initWithLabel:(unsigned long long)arg1;	// IMP=0x000000000089f276
