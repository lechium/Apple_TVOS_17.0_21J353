...
- (void).cxx_destruct;	// IMP=0x00000000005f2815
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000005f2735
- (void)stop;	// IMP=0x00000000005f26db
- (void)start;	// IMP=0x00000000005f2697
...
- (void)dealloc;	// IMP=0x00000000005f21f0
