...
- (void).cxx_destruct;	// IMP=0x0000000000cea928
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ce987f
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000ce9787
