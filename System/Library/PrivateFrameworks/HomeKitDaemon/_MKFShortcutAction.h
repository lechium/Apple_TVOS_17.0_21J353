...
+ (id)backingModelProtocol;	// IMP=0x0010000000743c7a
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000743bc6
+ (Class)cd_modelClass;	// IMP=0x0010000000c8b741
+ (id)fetchRequest;	// IMP=0x0010000000cf719e
@property(readonly) id <MKFHome> home;
- (id)castIfShortcutAction;	// IMP=0x0000000000743cc1
