...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000577697
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000004ecfbe
+ (id)ruleForHAP;	// IMP=0x00100000004ece03
- (void).cxx_destruct;	// IMP=0x0000000000576e2a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057669b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000576569
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000575f14
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000057591d
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 advertisementProtocol:(id)arg4 flags:(id)arg5 serviceType:(id)arg6;	// IMP=0x00000000005757f6
- (id)init;	// IMP=0x00000000005757c7
- (void)addTo:(id)arg1;	// IMP=0x00000000004ea9dd
