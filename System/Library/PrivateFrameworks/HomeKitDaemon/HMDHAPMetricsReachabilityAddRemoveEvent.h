...
- (void).cxx_destruct;	// IMP=0x0000000000a745d4
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000a744cb
- (id)coreAnalyticsEventName;	// IMP=0x0000000000a744be
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x0000000000a74434
