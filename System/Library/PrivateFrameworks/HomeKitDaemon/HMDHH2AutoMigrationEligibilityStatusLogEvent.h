...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000006733d3
- (void).cxx_destruct;	// IMP=0x0000000000673391
...
- (id)initWithAutoMigrationEligibilityResult:(id)arg1 migrationByOwnerManualEligibilityResult:(id)arg2 migrationByOwnerAutoEligibilityResult:(id)arg3 didRunMigrationTaskOnCurrentBuild:(_Bool)arg4 currentBuildStartedOnHH1:(_Bool)arg5;	// IMP=0x0000000000672b09
