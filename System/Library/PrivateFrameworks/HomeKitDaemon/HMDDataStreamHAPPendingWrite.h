...
- (void).cxx_destruct;	// IMP=0x000000000077b9b7
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x000000000077b899
- (_Bool)isComplete;	// IMP=0x000000000077b838
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000077b78c
