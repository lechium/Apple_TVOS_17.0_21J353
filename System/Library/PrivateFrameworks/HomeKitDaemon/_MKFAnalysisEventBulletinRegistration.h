...
+ (id)backingModelProtocol;	// IMP=0x0010000000907973
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000009078bf
+ (id)fetchRequest;	// IMP=0x0010000000cf675e
@property(readonly) id <MKFHome> home;
- (id)castIfAnalysisEventBulletinRegistration;	// IMP=0x00000000009079ba
