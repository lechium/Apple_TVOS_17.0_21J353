...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007e1de
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007e086
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007de35
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007dc99
- (_Bool)_parseFromTLVData;	// IMP=0x000000000007d9b5
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionControl:(id)arg1;	// IMP=0x000000000007d7cc
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2 audioParameters:(id)arg3;	// IMP=0x000000000007d702
