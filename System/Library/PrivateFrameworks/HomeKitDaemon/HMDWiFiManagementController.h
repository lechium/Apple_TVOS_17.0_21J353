...
+ (id)logCategory;	// IMP=0x00100000004a2775
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x00100000004a2502
- (void).cxx_destruct;	// IMP=0x00000000004a054e
...
- (id)logIdentifier;	// IMP=0x00000000004a03e7
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000049fd30
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000049fb03
- (void)_commitConfigurationUpdate;	// IMP=0x000000000049f9ca
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000049f829
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x000000000049f7b8
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000049f64c
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000049f50e
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000049f3a9
