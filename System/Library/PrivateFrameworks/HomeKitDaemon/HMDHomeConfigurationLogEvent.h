...
@interface HMDHomeConfigurationLogEvent : HMMLogEvent
{
    ...
    _Bool _isActivityHistoryEligible;	// 21 = 0x15
    _Bool _isActivityHistoryEnabled;	// 22 = 0x16
    _Bool _isSmokeAlarmEnabled;	// 23 = 0x17
    _Bool _isSiriPhraseOptionsHeySiriEnabled;	// 24 = 0x18
    _Bool _isSiriPhraseOptionsJustSiriEnabled;	// 25 = 0x19
...
- (void).cxx_destruct;	// IMP=0x0000000000596662
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x0000000000592135
- (id)initWithDataSource:(id)arg1 home:(id)arg2;	// IMP=0x000000000059049b
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000590486
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000590420
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000590359
- (void)setHomeConfigurationBitMasks;	// IMP=0x000000000059023d
