...
- (void)submitSuccess;	// IMP=0x00000000000a2ac6
- (void)submitFailureWithReason:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000000000a2a35
- (id)init;	// IMP=0x00000000000a2a06
