...
- (void).cxx_destruct;	// IMP=0x0000000000c52100
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c51f15
- (unsigned long long)hash;	// IMP=0x0000000000c51e2b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c51c91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c51b38
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c51a35
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c51964
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c5151a
- (id)dictionaryRepresentation;	// IMP=0x0000000000c512c3
- (id)description;	// IMP=0x0000000000c51214
- (void)clearOneofValuesForRequest;	// IMP=0x0000000000c5117e
- (int)StringAsRequest:(id)arg1;	// IMP=0x0000000000c5108c
- (id)requestAsString:(int)arg1;	// IMP=0x0000000000c51044
