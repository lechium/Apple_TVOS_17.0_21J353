...
+ (id)logCategory;	// IMP=0x0010000000267f77
+ (id)createSchedulerWithLogEventSubmitter:(id)arg1;	// IMP=0x0010000000267e6a
- (void).cxx_destruct;	// IMP=0x0000000000267b70
...
- (id)statusSummary;	// IMP=0x0000000000267993
- (void)runHomeutilTasks;	// IMP=0x00000000002676ba
- (void)runDailyTasks;	// IMP=0x0000000000267497
- (id)taskRunners;	// IMP=0x000000000026742f
- (void)registerDailyTaskRunner:(id)arg1;	// IMP=0x00000000002673b9
- (void)_runActivity:(id)arg1;	// IMP=0x0000000000266fb8
- (void)_handleCheckInForActivity:(id)arg1;	// IMP=0x0000000000266d2a
- (void)_registerActivity;	// IMP=0x0000000000266b4d
- (id)_criteriaForActivity;	// IMP=0x0000000000266aae
- (id)initWithIdentifier:(id)arg1 preferencesKey:(id)arg2 logEventSubmitter:(id)arg3 xpcActivityInterface:(id)arg4 dateFactory:(CDUnknownBlockType)arg5;	// IMP=0x00000000002668c2
