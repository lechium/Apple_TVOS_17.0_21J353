...
- (void).cxx_destruct;	// IMP=0x00000000005f1e43
...
- (id)attributeDescriptions;	// IMP=0x00000000005f1b6d
...
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x00000000005f1980
