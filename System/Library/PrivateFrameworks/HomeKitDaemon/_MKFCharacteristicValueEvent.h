...
+ (id)backingModelProtocol;	// IMP=0x0010000000568ac1
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000568a0d
+ (Class)cd_modelClass;	// IMP=0x00100000004223ab
+ (id)fetchRequest;	// IMP=0x0010000000cf693e
@property(readonly) id <MKFHome> home;
- (id)castIfCharacteristicValueEvent;	// IMP=0x0000000000568b27
@property(readonly, copy, nonatomic) MKFCharacteristicValueEventDatabaseID *databaseID;
- (_Bool)validateEventValue:(id *)arg1 error:(id *)arg2;	// IMP=0x0000000000568ad2
