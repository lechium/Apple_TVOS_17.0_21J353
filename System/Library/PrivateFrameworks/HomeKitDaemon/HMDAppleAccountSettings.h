...
+ (_Bool)supportsCloudSettings;	// IMP=0x00100000007b7794
+ (id)sharedSettings;	// IMP=0x00100000007b7764
+ (id)logCategory;	// IMP=0x00100000001c3cb0
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000007b76f5
- (void)synchronize;	// IMP=0x00000000007b76ef
...
- (id)attributeDescriptions;	// IMP=0x00000000001c3aba
