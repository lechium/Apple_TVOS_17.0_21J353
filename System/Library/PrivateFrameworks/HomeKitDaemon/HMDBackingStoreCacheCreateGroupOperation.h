...
- (void).cxx_destruct;	// IMP=0x0000000000225727
...
- (id)mainReturningError;	// IMP=0x00000000002253f6
- (id)initWithZone:(id)arg1 owner:(id)arg2 rootRecord:(id)arg3 subscriptionName:(id)arg4 subscription:(id)arg5 creationBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000000002252b4
