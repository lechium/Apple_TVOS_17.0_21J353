...
+ (id)logCategory;	// IMP=0x00100000004c0af4
- (void).cxx_destruct;	// IMP=0x00000000004c01c4
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000004bffac
- (void)monitorDidObserveExportComplete:(id)arg1;	// IMP=0x00000000004bff08
- (id)_retrieveExpectedObjectIDsTokenMap;	// IMP=0x00000000004bf78d
- (void)_stopWithError:(id)arg1;	// IMP=0x00000000004bf6e8
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000004bf624
- (void)configure;	// IMP=0x00000000004bf3d9
- (id)initWithCurrentAccessoryUUID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000004bf316
