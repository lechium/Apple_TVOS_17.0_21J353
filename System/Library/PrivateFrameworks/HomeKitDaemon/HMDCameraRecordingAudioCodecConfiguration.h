...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c9d70b
- (void).cxx_destruct;	// IMP=0x0000000000c9d6da
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c9d60a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c9d51e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000c9d3b4
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000c9d0b2
- (id)initWithAudioCodec:(id)arg1 codecParameters:(id)arg2;	// IMP=0x0000000000c9d010
