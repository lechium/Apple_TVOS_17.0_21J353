...
+ (id)logCategory;	// IMP=0x00100000007fccf0
- (void).cxx_destruct;	// IMP=0x00000000007fcc8c
...
- (void)dealloc;	// IMP=0x00000000007fcb00
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000007fc96f
