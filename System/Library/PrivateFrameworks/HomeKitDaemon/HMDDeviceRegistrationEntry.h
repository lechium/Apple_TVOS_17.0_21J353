...
- (void).cxx_destruct;	// IMP=0x00000000000c07f3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c06f9
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000c0657
