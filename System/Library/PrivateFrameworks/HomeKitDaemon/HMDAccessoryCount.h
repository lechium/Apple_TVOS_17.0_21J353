...
- (void).cxx_destruct;	// IMP=0x000000000054450c
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x0000000000544353
...
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000543f47
