...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003425ea
+ (id)logCategory;	// IMP=0x00100000003425ba
- (void).cxx_destruct;	// IMP=0x0000000000342512
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003420dc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000341dc2
- (id)logIdentifier;	// IMP=0x0000000000341db0
- (id)dumpDescription;	// IMP=0x0000000000341b96
- (_Bool)canPairGivenCapabilities:(unsigned long long)arg1;	// IMP=0x0000000000341a1d
- (id)addTransactionForHome:(id)arg1 configurationAppIdentifier:(id)arg2;	// IMP=0x0000000000341596
...
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x000000000034109d
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 requiredPairingCapabilities:(unsigned long long)arg4 minimumPairingSoftware:(id)arg5 productColor:(long long)arg6 idsIdentifierString:(id)arg7 rawAccessoryCapabilities:(id)arg8 rawResidentCapabilities:(id)arg9 messageDispatcher:(id)arg10;	// IMP=0x0000000000340f49
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 productColor:(long long)arg4 idsIdentifierString:(id)arg5 rawAccessoryCapabilities:(id)arg6 rawResidentCapabilities:(id)arg7 messageDispatcher:(id)arg8;	// IMP=0x0000000000340f09
- (id)modelForChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x0000000000340e88
