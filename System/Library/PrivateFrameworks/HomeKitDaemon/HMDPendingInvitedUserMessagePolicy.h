...
- (void).cxx_destruct;	// IMP=0x000000000041da87
@property(readonly, nonatomic) __weak HMDHomeManager *homeManager; // @synthesize homeManager=_homeManager;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000041da63
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000041d9fc
- (id)init;	// IMP=0x000000000041d954
