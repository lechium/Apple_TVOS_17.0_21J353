...
+ (id)logCategory;	// IMP=0x00100000004eddaf
- (void).cxx_destruct;	// IMP=0x00000000004edc72
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x00000000004ed82a
- (id)logIdentifier;	// IMP=0x00000000004ed7da
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x00000000004ed651
