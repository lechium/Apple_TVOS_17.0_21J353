...
+ (id)backingModelProtocol;	// IMP=0x00100000003440ce
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000034401a
+ (Class)cd_modelClass;	// IMP=0x00100000002388e3
+ (id)fetchRequest;	// IMP=0x0010000000cf6f7e
- (void)removeUserObject:(id)arg1;	// IMP=0x00000000003441a9
- (void)addUserObject:(id)arg1;	// IMP=0x000000000034418d
- (_Bool)synchronizeUserRelationWith:(id)arg1;	// IMP=0x000000000034416e
@property(readonly) id <MKFHome> home;
- (id)castIfLocationEvent;	// IMP=0x0000000000344115
