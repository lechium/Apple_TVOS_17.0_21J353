...
- (void).cxx_destruct;	// IMP=0x0000000000227d55
...
- (id)mainReturningError;	// IMP=0x00000000002276d7
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000002275f7
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x0000000000227517
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x0000000000227437
