...
+ (id)localizedBodyForAddedEcosystemHomeName:(id)arg1 accessoryName:(id)arg2 accessoryCategory:(id)arg3;	// IMP=0x0060000000a92927
+ (id)localizedTitleForAddedEcosystemName:(id)arg1;	// IMP=0x0060000000a9278e
- (void).cxx_destruct;	// IMP=0x0000000000a9272a
...
- (id)attributeDescriptions;	// IMP=0x0000000000a92409
- (id)initWithAddedPairing:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000a91e80
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x0000000000a91c8e
