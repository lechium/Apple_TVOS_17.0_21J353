...
+ (id)logCategory;	// IMP=0x001000000071f06c
- (void).cxx_destruct;	// IMP=0x000000000071ef98
...
- (id)logIdentifier;	// IMP=0x000000000071eefa
- (id)stateAsString;	// IMP=0x000000000071ee3e
- (_Bool)containsState:(long long)arg1;	// IMP=0x000000000071ee1b
- (void)updateState:(long long)arg1;	// IMP=0x000000000071ecc0
- (void)dealloc;	// IMP=0x000000000071ebdb
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 streamReceiver:(id)arg4 remoteCapabilities:(id)arg5 streamPreference:(id)arg6;	// IMP=0x000000000071eaae
