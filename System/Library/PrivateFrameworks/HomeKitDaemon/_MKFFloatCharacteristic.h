...
+ (id)backingModelProtocol;	// IMP=0x0010000000aef9bb
+ (id)fetchRequest;	// IMP=0x0010000000cf6cfe
@property(readonly) id <MKFHome> home;
- (id)castIfFloatCharacteristic;	// IMP=0x0000000000aef962
@property(readonly, copy, nonatomic) MKFFloatCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x0000000000aef838
