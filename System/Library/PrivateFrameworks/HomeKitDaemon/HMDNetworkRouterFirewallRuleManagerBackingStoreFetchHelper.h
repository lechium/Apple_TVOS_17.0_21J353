...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x0010000000015090
+ (unsigned long long)maxRetryCount;	// IMP=0x0010000000015072
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x0010000000014f8e
+ (id)logCategory;	// IMP=0x0010000000014f5e
- (void).cxx_destruct;	// IMP=0x0000000000014efa
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000014adb
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000014ac4
- (void)finishWithResult:(id)arg1;	// IMP=0x0000000000014ab0
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x00000000000145ac
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x00000000000143c5
