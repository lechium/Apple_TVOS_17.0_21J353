...
@interface AWDHomeKitAccessoryPairing : PBCodable
{
...
- (void).cxx_destruct;	// IMP=0x00000000008c3b6b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008c3660
- (unsigned long long)hash;	// IMP=0x00000000008c32e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008c2d48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008c29b5
- (void)copyTo:(id)arg1;	// IMP=0x00000000008c2685
- (void)writeTo:(id)arg1;	// IMP=0x00000000008c2308
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008c1450
- (id)dictionaryRepresentation;	// IMP=0x00000000008c0b62
- (id)description;	// IMP=0x00000000008c0ab3
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000008c063e
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000008c05f6
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000008c045a
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000008c0412
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000008c025b
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000008c0213
