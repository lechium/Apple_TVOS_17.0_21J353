...
+ (id)sharedState;	// IMP=0x00600000008bfe3e
- (void).cxx_destruct;	// IMP=0x00000000008bfe2b
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x00000000008bfdbe
- (void)registerDelegate:(id)arg1;	// IMP=0x00000000008bfd48
...
- (id)init;	// IMP=0x00000000008bf8e6
