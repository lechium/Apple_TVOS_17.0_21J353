...
+ (id)logCategory;	// IMP=0x0010000000043a68
- (void).cxx_destruct;	// IMP=0x000000000004382c
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x0000000000043799
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x00000000000436ae
...
- (id)userWithUUID:(id)arg1;	// IMP=0x00000000000433bc
- (id)userForMessage:(id)arg1;	// IMP=0x0000000000043342
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x000000000004328e
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x00000000000430c6
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x0000000000042f23
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x0000000000042d80
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x0000000000042bb8
...
- (void)configureWithMessageDispatcher:(id)arg1;	// IMP=0x00000000000422c3
- (id)initWithHome:(id)arg1 workQueue:(id)arg2 UUID:(id)arg3;	// IMP=0x0000000000042152
- (id)initWithHome:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000042091
