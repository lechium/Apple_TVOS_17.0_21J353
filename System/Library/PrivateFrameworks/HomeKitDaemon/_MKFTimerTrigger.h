...
+ (id)backingModelProtocol;	// IMP=0x0010000000690f7c
+ (id)homeRelation;	// IMP=0x0010000000690f4c
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000690e98
+ (Class)cd_modelClass;	// IMP=0x001000000082bf6b
+ (id)fetchRequest;	// IMP=0x0010000000cf727e
- (id)castIfTimerTrigger;	// IMP=0x0000000000690e8f
@property(readonly, copy, nonatomic) MKFTimerTriggerDatabaseID *databaseID;
- (void)awakeFromFetch;	// IMP=0x0000000000690c47
