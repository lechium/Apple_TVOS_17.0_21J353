...
+ (id)shortDescription;	// IMP=0x001000000087c763
- (void).cxx_destruct;	// IMP=0x000000000087c710
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x000000000087bf0a
- (void)resetRecord;	// IMP=0x000000000087becb
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x000000000087be62
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x000000000087b4c5
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x000000000087b3c0
- (void)updateCloudRecord:(id)arg1;	// IMP=0x000000000087aec1
- (void)forceChangeToInvalid;	// IMP=0x000000000087aead
- (void)forceChangeToDelete;	// IMP=0x000000000087adbd
...
- (id)shortDescription;	// IMP=0x000000000087a9c3
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x000000000087a9ac
- (id)initWithObjectChange:(id)arg1;	// IMP=0x000000000087a998
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x000000000087a66a
- (id)init;	// IMP=0x000000000087a5c2
