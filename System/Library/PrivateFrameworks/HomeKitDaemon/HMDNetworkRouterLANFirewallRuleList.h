...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000579fd5
- (void).cxx_destruct;	// IMP=0x0000000000571cea
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005717c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005716e5
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000570e20
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000570864
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x000000000057077c
- (id)init;	// IMP=0x000000000057074d
