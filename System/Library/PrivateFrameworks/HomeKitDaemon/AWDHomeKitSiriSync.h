...
+ (Class)reasonsType;	// IMP=0x0010000000c38c86
- (void).cxx_destruct;	// IMP=0x0000000000c38c73
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c389f2
- (unsigned long long)hash;	// IMP=0x0000000000c3891b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c387bf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c38544
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c383f0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c38200
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c37dab
- (id)dictionaryRepresentation;	// IMP=0x0000000000c37b89
- (id)description;	// IMP=0x0000000000c37ada
...
- (id)reasonsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000c379de
- (unsigned long long)reasonsCount;	// IMP=0x0000000000c379c1
- (void)addReasons:(id)arg1;	// IMP=0x0000000000c37957
- (void)clearReasons;	// IMP=0x0000000000c3793a
