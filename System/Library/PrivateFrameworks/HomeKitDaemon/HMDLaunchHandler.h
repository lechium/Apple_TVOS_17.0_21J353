...
+ (id)logCategory;	// IMP=0x00100000008def22
+ (id)sharedHandler;	// IMP=0x00100000008deebf
- (void).cxx_destruct;	// IMP=0x00000000008de93e
...
- (void)_setJetsamPriorityElevated:(_Bool)arg1;	// IMP=0x00000000008de6f0
- (void)_updateOrRemoveRelaunchPlist;	// IMP=0x00000000008de16f
- (void)deregisterRelaunchClientWithUUID:(id)arg1;	// IMP=0x00000000008de0b7
- (void)registerRelaunchClientWithUUID:(id)arg1;	// IMP=0x00000000008ddffe
- (void)removePersistentRelaunchRegistrationsIfNecessary;	// IMP=0x00000000008ddf8d
- (id)initWithRelaunchPlistFileURL:(id)arg1 fileManager:(id)arg2 jetsamPriorityHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008dde36
- (id)init;	// IMP=0x00000000008ddd95
