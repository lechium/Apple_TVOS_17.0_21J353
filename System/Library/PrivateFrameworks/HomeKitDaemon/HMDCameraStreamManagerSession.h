...
+ (id)logCategory;	// IMP=0x0010000000087721
- (void).cxx_destruct;	// IMP=0x00000000000876ac
...
- (id)logIdentifier;	// IMP=0x00000000000875b6
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000000873e7
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x0000000000087264
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x0000000000087131
