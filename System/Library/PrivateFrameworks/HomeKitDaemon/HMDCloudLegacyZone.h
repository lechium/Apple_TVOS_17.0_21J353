...
+ (void)createLegacyZoneWithName:(id)arg1 owner:(id)arg2 cacheZone:(id)arg3 cloudCache:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x006000000036f440
+ (id)zoneSubscriptionName:(id)arg1;	// IMP=0x006000000036f433
+ (id)zoneRootRecordName;	// IMP=0x006000000036f414
- (void).cxx_destruct;	// IMP=0x000000000036f39f
- (void)setServerChangeToken:(id)arg1;	// IMP=0x000000000036f35e
- (id)createCloudZoneChangeTemporaryCache:(_Bool)arg1;	// IMP=0x000000000036f325
- (void)dropCachedRecords;	// IMP=0x000000000036f28d
- (id)createCloudRecordWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x000000000036ed60
- (id)homeDataV3ModelWithPushDataPush:(id)arg1;	// IMP=0x000000000036ed47
- (id)homeDataModelWithPushDataPush:(id)arg1;	// IMP=0x000000000036ed2b
- (id)metadataModelWithPushDataPush:(id)arg1;	// IMP=0x000000000036ed12
...
- (_Bool)doesProcessChangeEvenIfDecryptionFails;	// IMP=0x000000000036e89c
