...
+ (id)logCategory;	// IMP=0x0060000000a5fd51
+ (id)shortDescription;	// IMP=0x0060000000a5fd3f
- (void).cxx_destruct;	// IMP=0x0000000000a5fccc
...
- (void)clearData;	// IMP=0x0000000000a5fb0e
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x0000000000a5f069
- (id)extractObjectChange;	// IMP=0x0000000000a5e580
- (id)description;	// IMP=0x0000000000a5e514
- (id)shortDescription;	// IMP=0x0000000000a5e428
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x0000000000a5e2d0
- (id)init;	// IMP=0x0000000000a5e228
