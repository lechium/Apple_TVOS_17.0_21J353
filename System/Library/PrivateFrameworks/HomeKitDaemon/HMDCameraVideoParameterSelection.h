...
+ (id)logCategory;	// IMP=0x0060000000762bee
- (void).cxx_destruct;	// IMP=0x0000000000762a3a
...
- (void)_generateAllCombinations;	// IMP=0x0000000000760dc7
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x0000000000760c5c
- (id)createSelectedVideoParameters;	// IMP=0x0000000000760872
- (id)createSRTPParamters;	// IMP=0x00000000007607e7
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x000000000075feef
- (_Bool)selectVideoParameters;	// IMP=0x000000000075ef19
- (id)logIdentifier;	// IMP=0x000000000075eec9
- (void)_setVideoResolutionPreference;	// IMP=0x000000000075eb00
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x000000000075e912
