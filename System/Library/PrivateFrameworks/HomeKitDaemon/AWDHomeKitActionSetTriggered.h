...
- (void).cxx_destruct;	// IMP=0x000000000067cb5a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000067c9d5
- (unsigned long long)hash;	// IMP=0x000000000067c8df
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000067c748
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000067c612
- (void)copyTo:(id)arg1;	// IMP=0x000000000067c518
- (void)writeTo:(id)arg1;	// IMP=0x000000000067c40c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000067bfa0
- (id)dictionaryRepresentation;	// IMP=0x000000000067bd3c
- (id)description;	// IMP=0x000000000067bc8d
@property(readonly, nonatomic) _Bool hasClientMetricIdentifier;
@property(nonatomic) _Bool hasNumAccessories;
- (int)StringAsTriggerSource:(id)arg1;	// IMP=0x000000000067bad7
- (id)triggerSourceAsString:(int)arg1;	// IMP=0x000000000067ba8f
