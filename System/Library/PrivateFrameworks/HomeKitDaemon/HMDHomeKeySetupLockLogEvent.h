...
- (void).cxx_destruct;	// IMP=0x000000000054066f
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000054055c
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x0000000000540319
- (void)submitSuccess;	// IMP=0x000000000054029d
- (_Bool)incrementCompleted;	// IMP=0x0000000000540229
- (id)initWithAccessoryUUID:(id)arg1 withKeyType:(unsigned long long)arg2 expectedCount:(long long)arg3 queue:(id)arg4;	// IMP=0x00000000005400f8
