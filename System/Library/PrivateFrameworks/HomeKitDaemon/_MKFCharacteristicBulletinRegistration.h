...
+ (id)backingModelProtocol;	// IMP=0x0010000000aeaff8
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000aeaf44
+ (id)fetchRequest;	// IMP=0x0010000000cf68de
@property(readonly) id <MKFHome> home;
- (id)castIfCharacteristicBulletinRegistration;	// IMP=0x0000000000aeb03f
