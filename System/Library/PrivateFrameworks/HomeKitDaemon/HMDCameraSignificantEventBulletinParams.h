...
- (void).cxx_destruct;	// IMP=0x00000000004fa8a6
...
- (id)initWithSignificantEvent:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x00000000004fa727
- (id)initWithUUID:(id)arg1 reason:(unsigned long long)arg2 dateOfOccurrence:(id)arg3 confidenceLevel:(unsigned long long)arg4 faceClassifications:(id)arg5 cameraProfileUUID:(id)arg6;	// IMP=0x00000000004fa60d
- (id)init;	// IMP=0x00000000004fa565
