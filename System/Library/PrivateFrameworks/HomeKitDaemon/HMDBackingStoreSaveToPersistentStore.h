...
- (void).cxx_destruct;	// IMP=0x0000000000ae5059
...
- (id)mainReturningError;	// IMP=0x0000000000ae4ea4
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x0000000000ae4de0
