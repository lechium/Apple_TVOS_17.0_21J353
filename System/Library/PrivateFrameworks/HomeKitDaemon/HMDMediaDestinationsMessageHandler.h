...
- (void).cxx_destruct;	// IMP=0x00000000009fa13a
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x00000000009fa049
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x00000000009f9c4a
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000009f9ad6
