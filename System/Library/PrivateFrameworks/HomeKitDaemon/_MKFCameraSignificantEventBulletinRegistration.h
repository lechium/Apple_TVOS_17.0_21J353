...
+ (id)backingModelProtocol;	// IMP=0x0010000000537393
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000005372df
+ (id)fetchRequest;	// IMP=0x0010000000cf689e
@property(readonly) id <MKFHome> home;
- (id)castIfCameraSignificantEventBulletinRegistration;	// IMP=0x0000000000537286
@property(readonly, copy, nonatomic) MKFCameraSignificantEventBulletinRegistrationDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x00000000005371b4
