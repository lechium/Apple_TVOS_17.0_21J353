...
- (void).cxx_destruct;	// IMP=0x00000000006c1ca8
...
- (void)main;	// IMP=0x00000000006c1a91
- (id)initWithIdentifiersToRemove:(id)arg1 followUpController:(id)arg2;	// IMP=0x00000000006c19a6
