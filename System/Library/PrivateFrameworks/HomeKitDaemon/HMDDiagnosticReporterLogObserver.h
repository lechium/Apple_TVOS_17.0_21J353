...
+ (id)logCategory;	// IMP=0x0010000000ccc5bf
+ (_Bool)isSupportedEvent:(id)arg1;	// IMP=0x0010000000ccc53d
+ (id)supportedEventClasses;	// IMP=0x0010000000ccc50d
- (void).cxx_destruct;	// IMP=0x0000000000ccc4c1
...
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000ccc3b4
- (void)stop;	// IMP=0x0000000000ccc2b4
- (void)start;	// IMP=0x0000000000ccc187
- (id)initWithLogEventDispatcher:(id)arg1;	// IMP=0x0000000000ccc00b
- (_Bool)shouldSubmitEvent:(id)arg1;	// IMP=0x0000000000ccbfbd
