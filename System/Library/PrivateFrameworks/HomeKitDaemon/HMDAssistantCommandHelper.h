...
+ (id)logCategory;	// IMP=0x0010000000359c7e
- (void).cxx_destruct;	// IMP=0x0000000000358ee8
...
- (void)removeResponses:(id)arg1;	// IMP=0x0000000000358ca4
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000358798
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000003583ad
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000357fc2
- (void)addMediaWriteRequests:(id)arg1 withRequestProperty:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000357898
- (void)handleAccessoryCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000003577e0
- (void)__handleAccessoryCharacteristicsChanged:(id)arg1;	// IMP=0x0000000000356833
- (void)_reportOperationStartedForAccessory:(id)arg1;	// IMP=0x0000000000355ff2
- (void)reportOperationStartedForAccessory:(id)arg1;	// IMP=0x0000000000355f3a
- (void)_reportResponses;	// IMP=0x0000000000355279
- (void)_reportResponsesForMediaRequests;	// IMP=0x0000000000354b56
- (void)timeoutAndReportResults;	// IMP=0x0000000000354ae5
- (void)_register;	// IMP=0x0000000000354a81
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)dealloc;	// IMP=0x00000000003549b5
- (id)initWithQueue:(id)arg1 msgDispatcher:(id)arg2;	// IMP=0x000000000035485e
