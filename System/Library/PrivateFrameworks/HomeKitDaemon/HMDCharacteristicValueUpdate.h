...
- (void).cxx_destruct;	// IMP=0x0000000000694566
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x0000000000694449
- (id)initWithError:(id)arg1;	// IMP=0x00000000006943db
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x0000000000694311
