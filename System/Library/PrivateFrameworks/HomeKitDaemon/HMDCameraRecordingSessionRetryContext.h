...
- (void).cxx_destruct;	// IMP=0x0000000000656d2f
...
- (void)computeNextRetryInterval;	// IMP=0x0000000000656c58
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x0000000000656985
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000006568ee
