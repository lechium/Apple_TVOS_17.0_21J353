...
- (void).cxx_destruct;	// IMP=0x0000000000b0cf08
...
- (void)persistDatabaseServerChangeToken;	// IMP=0x0000000000b0ce54
@property(retain, nonatomic) CKServerChangeToken *databaseServerChangeToken;
- (void)deleteHomeZoneWithName:(id)arg1;	// IMP=0x0000000000b0cbe0
- (void)deleteAllZones;	// IMP=0x0000000000b0c853
- (void)homeZoneWithName:(id)arg1 owner:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b0c6b6
- (id)homeZoneWithName:(id)arg1;	// IMP=0x0000000000b0c608
- (_Bool)homeZoneExists:(id)arg1;	// IMP=0x0000000000b0c551
- (id)allHomeZones;	// IMP=0x0000000000b0c4c4
- (void)createAndFetchZonesFromBackingStore:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b0c2d3
- (void)_createZones:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b0bd18
- (id)_findStoreCacheZone:(id)arg1 byName:(id)arg2;	// IMP=0x0000000000b0bb1f
...
- (id)initWithBackingStore:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000b0b7eb
- (id)init;	// IMP=0x0000000000b0b743
