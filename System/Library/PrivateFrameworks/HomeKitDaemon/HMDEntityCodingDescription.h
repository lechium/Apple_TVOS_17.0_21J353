...
- (void).cxx_destruct;	// IMP=0x00000000003df1c0
@property(readonly) NSArray *parentRelationships; // @synthesize parentRelationships=_parentRelationships;
- (id)descriptionForRelationship:(id)arg1;	// IMP=0x00000000003df033
- (id)descriptionForAttribute:(id)arg1;	// IMP=0x00000000003deeba
