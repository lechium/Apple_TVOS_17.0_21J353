...
- (_Bool)isValidValue:(id)arg1 error:(id *)arg2;	// IMP=0x000000000055d746
- (id)initWithMaxValue:(long long)arg1 minValue:(long long)arg2 stepValue:(long long)arg3;	// IMP=0x000000000055d6f3
