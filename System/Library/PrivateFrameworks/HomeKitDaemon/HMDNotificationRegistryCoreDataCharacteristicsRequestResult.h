...
- (void).cxx_destruct;	// IMP=0x0000000000b0ecef
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0ebe5
- (id)initWithCoreDataRequest:(id)arg1 didSucceed:(_Bool)arg2 didModify:(_Bool)arg3 modifiedCharacteristics:(id)arg4;	// IMP=0x0000000000b0eb20
