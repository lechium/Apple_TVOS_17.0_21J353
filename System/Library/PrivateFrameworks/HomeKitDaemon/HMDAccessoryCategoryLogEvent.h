...
+ (id)denominatorSpecifyingEvent;	// IMP=0x00100000003d074d
- (void).cxx_destruct;	// IMP=0x00000000003d073a
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x00000000003d06f4
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x00000000003d0435
