...
+ (id)backingModelProtocol;	// IMP=0x001000000059fbd0
+ (id)homeRelation;	// IMP=0x001000000059fba0
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000059faec
+ (id)fetchRequest;	// IMP=0x0010000000cf711e
- (id)castIfResident;	// IMP=0x000000000059fc55
