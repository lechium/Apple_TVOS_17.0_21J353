...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000007be44
- (void).cxx_destruct;	// IMP=0x000000000007bdbe
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007bb6e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007b6d9
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007b497
- (_Bool)_parseFromTLVData;	// IMP=0x000000000007b119
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x000000000007ade1
