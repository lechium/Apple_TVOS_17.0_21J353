...
+ (id)logCategory;	// IMP=0x00100000004b50ce
- (void).cxx_destruct;	// IMP=0x00000000004b4cd9
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00000000004b4690
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x00000000004b467e
- (void)subscribeToWiFiInfoUpdate;	// IMP=0x00000000004b4498
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000000004b43fe
