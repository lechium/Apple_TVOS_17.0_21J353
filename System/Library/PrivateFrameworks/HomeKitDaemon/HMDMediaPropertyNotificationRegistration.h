...
- (void).cxx_destruct;	// IMP=0x0000000000b0e8a5
...
- (id)attributeDescriptions;	// IMP=0x0000000000b0e584
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b0e579
- (unsigned long long)hash;	// IMP=0x0000000000b0e4c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0e18c
- (id)initWithMediaProfileUniqueIdentifier:(id)arg1 mediaProperty:(id)arg2 deviceIdsDestination:(id)arg3 userUUID:(id)arg4 lastModified:(id)arg5 enabled:(_Bool)arg6;	// IMP=0x0000000000b0e05f
