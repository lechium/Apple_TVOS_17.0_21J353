...
+ (id)allowedClasses;	// IMP=0x00600000002b6aed
+ (_Bool)isSupported;	// IMP=0x00600000002b6a45
+ (long long)role;	// IMP=0x00600000002b699d
- (void).cxx_destruct;	// IMP=0x00000000002b6d77
...
- (_Bool)processSessionData:(id)arg1 fromBundle:(id)arg2 outAccessoryUUID:(id *)arg3 outAccessoryIDSIdentifier:(id *)arg4 error:(id *)arg5;	// IMP=0x00000000002b6c2e
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000002b6bb8
