...
@interface AWDHomeKitHomeConfiguration : PBCodable
{
...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x00100000006d8a09
+ (Class)hapServicesListCertifiedType;	// IMP=0x00100000006d89f8
+ (Class)primaryHAPServicesListType;	// IMP=0x00100000006d89e7
+ (Class)hapServicesListType;	// IMP=0x00100000006d89d6
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x00100000006d89c5
+ (Class)eventTriggersType;	// IMP=0x00100000006d89b4
- (void).cxx_destruct;	// IMP=0x00000000006d5359
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000006d3896
- (unsigned long long)hash;	// IMP=0x00000000006d2ac5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d183b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006d0148
- (void)copyTo:(id)arg1;	// IMP=0x00000000006cef6d
- (void)writeTo:(id)arg1;	// IMP=0x00000000006cd9c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006cd9b8
- (id)dictionaryRepresentation;	// IMP=0x00000000006cab8b
- (id)description;	// IMP=0x00000000006caadc
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x00000000006ca5af
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x00000000006ca564
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c9c27
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x00000000006c9c0a
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x00000000006c9ba0
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x00000000006c9b83
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c9b66
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x00000000006c9b49
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x00000000006c9adf
- (void)clearHapServicesListCertifieds;	// IMP=0x00000000006c9ac2
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c9aa5
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x00000000006c9a88
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x00000000006c9a1e
- (void)clearPrimaryHAPServicesLists;	// IMP=0x00000000006c9a01
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c99e4
- (unsigned long long)hapServicesListsCount;	// IMP=0x00000000006c99c7
- (void)addHapServicesList:(id)arg1;	// IMP=0x00000000006c995d
- (void)clearHapServicesLists;	// IMP=0x00000000006c9940
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c9718
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x00000000006c96fb
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x00000000006c9691
- (void)clearHomeKitMultiUserSettings;	// IMP=0x00000000006c9674
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x00000000006c931a
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x00000000006c92d2
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006c8c71
- (unsigned long long)eventTriggersCount;	// IMP=0x00000000006c8c54
- (void)addEventTriggers:(id)arg1;	// IMP=0x00000000006c8bea
- (void)clearEventTriggers;	// IMP=0x00000000006c8bcd
