...
+ (id)backingModelProtocol;	// IMP=0x0010000000322a2a
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000322976
+ (id)fetchRequest;	// IMP=0x0010000000cf70be
- (void)removeUsersObject:(id)arg1;	// IMP=0x0000000000322b86
- (void)addUsersObject:(id)arg1;	// IMP=0x0000000000322b6a
- (id)findUsersRelationWithModelID:(id)arg1;	// IMP=0x0000000000322b47
- (id)materializeOrCreateUsersRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x0000000000322b21
@property(readonly, retain, nonatomic) NSArray *users;
@property(readonly) id <MKFHome> home;
- (id)castIfPresenceBulletinCondition;	// IMP=0x0000000000322a71
