...
- (void).cxx_destruct;	// IMP=0x00000000001feede
...
- (void)addModelToBeUpdated:(id)arg1;	// IMP=0x00000000001fee2e
- (void)removeModelWithIdentifier:(id)arg1;	// IMP=0x00000000001fedc5
- (void)addModel:(id)arg1;	// IMP=0x00000000001fed5c
- (void)addSettingModel:(id)arg1;	// IMP=0x00000000001fec1a
- (id)initForInitialCreationWithTransactionLabel:(id)arg1;	// IMP=0x00000000001feb4d
- (id)initWithTransactionLabel:(id)arg1;	// IMP=0x00000000001fea80
