...
+ (id)shortDescription;	// IMP=0x0010000000c1a41d
- (void).cxx_destruct;	// IMP=0x0000000000c1a40a
...
- (id)performOperation:(id)arg1;	// IMP=0x0000000000c1a376
...
- (id)init;	// IMP=0x0000000000c1a19a
