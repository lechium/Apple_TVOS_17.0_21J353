...
+ (id)logCategory;	// IMP=0x0010000000bead8e
- (void).cxx_destruct;	// IMP=0x0000000000beaa8e
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000bea809
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000bea68f
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000be9d23
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000be9bda
- (void)dealloc;	// IMP=0x0000000000be9a71
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000be9338
- (void)_startDataReceive;	// IMP=0x0000000000be9199
- (id)logIdentifier;	// IMP=0x0000000000be9149
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000be8f3b
