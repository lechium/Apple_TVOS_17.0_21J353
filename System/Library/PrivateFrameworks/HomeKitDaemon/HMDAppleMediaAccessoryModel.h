...
+ (id)properties;	// IMP=0x00100000006f98c3
+ (Class)cd_entityClass;	// IMP=0x00100000004263fc
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x000000000042608b
