...
- (id)initWithIdentifier:(id)arg1 startTime:(unsigned long long)arg2 endTime:(unsigned long long)arg3 role:(long long)arg4 accessoryUUID:(id)arg5 accessoryIDSIdentifier:(id)arg6 setupClientBundleID:(id)arg7;	// IMP=0x000000000003e6a6
