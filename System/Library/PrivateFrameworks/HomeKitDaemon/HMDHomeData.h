...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x0010000000545413
- (void).cxx_destruct;	// IMP=0x00000000005452f4
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x0000000000544e56
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000544e02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000544df7
