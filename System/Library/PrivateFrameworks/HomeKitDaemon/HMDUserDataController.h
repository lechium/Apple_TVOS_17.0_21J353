...
+ (id)logCategory;	// IMP=0x001000000098c849
- (void).cxx_destruct;	// IMP=0x000000000098c3b2
...
- (id)logIdentifier;	// IMP=0x000000000098c15d
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000098c0a5
- (void)mediaContentProfileAccessControlModelRemoved:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000098bf37
- (void)mediaContentProfileAccessControlModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000098bd0e
- (long long)sharedUserSettingsLogEventBackingStoreControllerRunState;	// IMP=0x000000000098bc9a
...
- (void)assistantAccessControlModelRemoved:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000098bb4f
- (void)assistantAccessControlModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000098b70e
- (void)sharedUserDataModelUpdated:(id)arg1 previousModel:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000098b6d9
@property(readonly, copy) HMBModel *assistantAccessControlModelToReset;
- (void)handleRemovedAccessory:(id)arg1;	// IMP=0x000000000098b5e9
- (void)handleMediaContentProfileAccessControlUpdatedAccessoryUUIDs:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000098b58f
- (void)handleAssistantAccessControlAccessoryUUIDsUpdated:(id)arg1 requireAuthenticationForSecureRequests:(_Bool)arg2 activityNotificationsEnabledForPersonalRequests:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000098b535
- (void)handleStartForZoneController:(id)arg1;	// IMP=0x000000000098b43d
- (void)_startupPrivateZone;	// IMP=0x000000000098b437
- (void)_startupSharedZone;	// IMP=0x000000000098b431
- (void)_invalidatePrivateZoneFirstLoadTimer;	// IMP=0x000000000098b3a4
- (void)_startPrivateZoneFirstLoadTimer;	// IMP=0x000000000098b1a1
- (void)performFirstRunOperationsOnPrivateZoneController:(id)arg1;	// IMP=0x000000000098b0ab
- (void)_invalidateSharedZoneFirstLoadTimer;	// IMP=0x000000000098b01e
- (void)_startSharedZoneFirstLoadTimer;	// IMP=0x000000000098ae1b
- (void)performFirstRunOperationsOnSharedZoneController:(id)arg1;	// IMP=0x000000000098ad54
- (void)initializePrivateZoneController:(id)arg1 userDataModel:(id)arg2;	// IMP=0x000000000098acbc
- (void)initializeSharedZoneController:(id)arg1 userDataModel:(id)arg2;	// IMP=0x000000000098a38c
- (void)eventDidInitializeSharedZone;	// IMP=0x000000000098a0af
- (void)eventDidInitializePrivateZone;	// IMP=0x0000000000989dde
@property unsigned long long state; // @synthesize state=_state;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000989b71
...
- (void)configure;	// IMP=0x00000000009899e7
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 queue:(id)arg3 userID:(id)arg4 homeID:(id)arg5 sharedSettingsController:(id)arg6 privateSettingsController:(id)arg7 isCurrentUser:(_Bool)arg8;	// IMP=0x00000000009898c6
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 queue:(id)arg3 userID:(id)arg4 homeID:(id)arg5 sharedSettingsController:(id)arg6 privateSettingsController:(id)arg7 timerCreator:(id)arg8 isCurrentUser:(_Bool)arg9;	// IMP=0x00000000009896ee
