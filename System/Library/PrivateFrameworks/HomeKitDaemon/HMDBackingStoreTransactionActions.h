...
+ (id)logCategory;	// IMP=0x0060000000418ae6
- (void).cxx_destruct;	// IMP=0x0000000000418a95
...
- (id)description;	// IMP=0x000000000041895a
- (id)logIdentifier;	// IMP=0x000000000041894d
@property(readonly, nonatomic) NSMutableDictionary *userInfo; // @synthesize userInfo=_userInfo;
- (void)invokePostApplyActions;	// IMP=0x000000000041878c
- (_Bool)addPostApplyActionIfNotPresent:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000004186b3
- (void)addPostApplyActionUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000004185fd
- (void)markSaveToSharedUserAccount;	// IMP=0x00000000004185ec
- (void)markSaveToAssistant;	// IMP=0x00000000004185db
- (void)markChanged;	// IMP=0x00000000004185ca
- (void)markLocalChanged;	// IMP=0x00000000004185b9
- (id)initWithBackingStore:(id)arg1 options:(id)arg2;	// IMP=0x0000000000418493
