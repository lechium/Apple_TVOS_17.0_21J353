...
- (void).cxx_destruct;	// IMP=0x00000000007f5ebd
...
- (id)attributeDescriptions;	// IMP=0x00000000007f5bf8
- (id)initWithEnable:(_Bool)arg1 user:(id)arg2 deviceIdsDestination:(id)arg3;	// IMP=0x00000000007f5b37
