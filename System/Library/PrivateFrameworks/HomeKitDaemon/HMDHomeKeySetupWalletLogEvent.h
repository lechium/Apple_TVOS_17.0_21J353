...
- (void).cxx_destruct;	// IMP=0x00000000004f8808
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000004f8760
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x00000000004f85bd
- (void)submitSuccess;	// IMP=0x00000000004f8541
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000004f8480
