...
+ (Class)topErrorsType;	// IMP=0x00100000004d993d
+ (Class)topReasonsType;	// IMP=0x00100000004d992c
- (void).cxx_destruct;	// IMP=0x00000000004d98fb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004d9320
- (unsigned long long)hash;	// IMP=0x00000000004d90a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004d8cd8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004d878f
- (void)copyTo:(id)arg1;	// IMP=0x00000000004d8457
- (void)writeTo:(id)arg1;	// IMP=0x00000000004d7ff8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004d74a4
- (id)dictionaryRepresentation;	// IMP=0x00000000004d6ab3
- (id)description;	// IMP=0x00000000004d6a04
...
- (int)StringAsDataSyncState:(id)arg1;	// IMP=0x00000000004d66b4
- (id)dataSyncStateAsString:(int)arg1;	// IMP=0x00000000004d666c
...
- (id)topErrorsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004d6500
- (unsigned long long)topErrorsCount;	// IMP=0x00000000004d64e3
- (void)addTopErrors:(id)arg1;	// IMP=0x00000000004d6479
- (void)clearTopErrors;	// IMP=0x00000000004d645c
- (id)topReasonsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004d643f
- (unsigned long long)topReasonsCount;	// IMP=0x00000000004d6422
- (void)addTopReasons:(id)arg1;	// IMP=0x00000000004d63b8
- (void)clearTopReasons;	// IMP=0x00000000004d639b
