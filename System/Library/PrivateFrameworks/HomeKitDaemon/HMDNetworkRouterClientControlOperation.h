...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000580203
- (void).cxx_destruct;	// IMP=0x00000000005801db
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000057fe5b
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000057fb92
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000057f860
- (id)initWithOperation:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000057f7c7
- (id)init;	// IMP=0x000000000057f798
