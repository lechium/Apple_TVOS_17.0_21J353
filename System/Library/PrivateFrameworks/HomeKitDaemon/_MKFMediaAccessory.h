...
+ (id)backingModelProtocol;	// IMP=0x0010000000766343
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000076632a
+ (Class)cd_modelClass;	// IMP=0x00100000007e888d
+ (id)fetchRequest;	// IMP=0x0010000000cf6f9e
- (id)castIfMediaAccessory;	// IMP=0x000000000076638a
