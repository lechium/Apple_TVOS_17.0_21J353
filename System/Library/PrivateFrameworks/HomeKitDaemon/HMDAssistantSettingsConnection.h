...
+ (id)logCategory;	// IMP=0x00100000002ee15b
- (void).cxx_destruct;	// IMP=0x00000000002edf91
...
- (id)deleteSiriHistoryOperationWithConnection:(id)arg1;	// IMP=0x00000000002edf01
- (id)connectionForEndpointUUID:(id)arg1;	// IMP=0x00000000002ede38
- (void)deleteSiriHistoryWithEndpointUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002eda01
- (id)initWithScheduler:(id)arg1;	// IMP=0x00000000002ed993
