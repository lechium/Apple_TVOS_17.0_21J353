...
+ (Class)characteristicsType;	// IMP=0x00100000002382e0
- (void).cxx_destruct;	// IMP=0x0000000000238249
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000237b49
- (unsigned long long)hash;	// IMP=0x00000000002377cb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000237239
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000236cd2
- (void)copyTo:(id)arg1;	// IMP=0x000000000023691f
- (void)writeTo:(id)arg1;	// IMP=0x00000000002364ac
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002357a1
- (id)dictionaryRepresentation;	// IMP=0x0000000000234d71
- (id)description;	// IMP=0x0000000000234cc2
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000234920
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000002348d8
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x000000000023471b
- (id)sourceAsString:(int)arg1;	// IMP=0x00000000002346d3
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000002344a3
- (id)transportTypeAsString:(int)arg1;	// IMP=0x000000000023445b
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002343d4
- (unsigned long long)characteristicsCount;	// IMP=0x00000000002343b7
- (void)addCharacteristics:(id)arg1;	// IMP=0x000000000023434d
- (void)clearCharacteristics;	// IMP=0x0000000000234330
