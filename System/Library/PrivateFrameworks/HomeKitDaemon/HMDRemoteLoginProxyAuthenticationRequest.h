...
+ (id)xpcMessageName;	// IMP=0x00100000003e32e8
+ (id)messageName;	// IMP=0x00100000003e32db
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003e32d3
+ (id)objWithMessage:(id)arg1;	// IMP=0x00100000003e313c
+ (id)objWithDict:(id)arg1;	// IMP=0x00100000003e2fc3
- (void).cxx_destruct;	// IMP=0x00000000003e2f70
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003e2d7b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003e2c40
