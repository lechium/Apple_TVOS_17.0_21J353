...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000578dfe
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000004ebb1b
- (void).cxx_destruct;	// IMP=0x0000000000578daa
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000057861b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005784e9
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000577e94
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000057789a
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 destinationIPAddress:(id)arg4 destinationPortStart:(id)arg5 destinationPortEnd:(id)arg6;	// IMP=0x0000000000577773
- (id)init;	// IMP=0x0000000000577744
- (void)addTo:(id)arg1;	// IMP=0x00000000004ea53f
