...
+ (id)sendingRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x00600000000a3255
+ (id)sendingRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x00600000000a3170
+ (id)receivedRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x00600000000a2ff9
+ (id)receivedRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x00600000000a2f14
- (void).cxx_destruct;	// IMP=0x00000000000a2ec1
...
- (id)initWithRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 sending:(_Bool)arg8 messageQoS:(long long)arg9;	// IMP=0x00000000000a2cb6
