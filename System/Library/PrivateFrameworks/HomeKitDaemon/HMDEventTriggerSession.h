...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x00100000005aa876
+ (id)logCategory;	// IMP=0x00100000005aa846
- (void).cxx_destruct;	// IMP=0x00000000005aa7c2
...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000005aa472
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000005aa3a6
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005aa277
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x00000000005aa241
@property(readonly, copy) NSString *description;
- (id)dumpState;	// IMP=0x00000000005aa0cd
- (void)_registerForMessages;	// IMP=0x00000000005aa0c7
- (void)dealloc;	// IMP=0x00000000005a9f2e
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000005a9d02
