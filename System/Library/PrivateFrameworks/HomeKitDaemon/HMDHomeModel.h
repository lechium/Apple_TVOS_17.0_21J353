...
+ (id)properties;	// IMP=0x001000000064707a
+ (id)cd_getHomeFromUUID:(id)arg1;	// IMP=0x0010000000ab88fc
+ (Class)cd_entityClass;	// IMP=0x0010000000ab88eb
+ (id)cd_parentReferenceName;	// IMP=0x0010000000ab88e3
...
- (id)audioAnalysisClassifierOptions;	// IMP=0x0000000000647cad
- (void)setAudioAnalysisClassifierOptions:(id)arg1;	// IMP=0x0000000000647c9b
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000ab7d54
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000ab738e
