...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000056ca6c
- (void).cxx_destruct;	// IMP=0x000000000056ca39
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000056c659
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056c5a1
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000056c1e5
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000056be0c
- (id)initWithClientIdentifier:(id)arg1 lastViolationTimestamp:(id)arg2 lastResetTimestamp:(id)arg3;	// IMP=0x000000000056bd54
- (id)init;	// IMP=0x000000000056bd25
