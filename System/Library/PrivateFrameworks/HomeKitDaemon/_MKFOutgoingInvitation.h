...
+ (id)backingModelProtocol;	// IMP=0x001000000084bb47
+ (id)homeRelation;	// IMP=0x001000000084bb17
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000084ba63
+ (Class)cd_modelClass;	// IMP=0x0010000000562ab8
+ (id)fetchRequest;	// IMP=0x0010000000cf705e
- (id)castIfOutgoingInvitation;	// IMP=0x000000000084bbcc
