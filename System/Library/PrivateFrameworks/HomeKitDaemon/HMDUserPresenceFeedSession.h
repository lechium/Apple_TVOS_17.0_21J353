...
+ (id)logCategory;	// IMP=0x001000000042415f
- (void).cxx_destruct;	// IMP=0x0000000000423d18
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000423a8e
- (id)logIdentifier;	// IMP=0x0000000000423a7c
- (void)_callDelegate;	// IMP=0x00000000004239bb
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x00000000004238a3
- (void)_send;	// IMP=0x0000000000422ae4
- (void)send;	// IMP=0x0000000000422a73
- (id)attributeDescriptions;	// IMP=0x0000000000422843
- (void)dealloc;	// IMP=0x00000000004226fb
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x00000000004223cd
