...
+ (id)shortDescription;	// IMP=0x0010000000a9aab1
- (void).cxx_destruct;	// IMP=0x0000000000a9aa9e
...
- (id)initWithDate:(id)arg1 reason:(unsigned long long)arg2 state:(unsigned long long)arg3;	// IMP=0x0000000000a9a8ae
