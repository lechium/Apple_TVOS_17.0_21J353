...
- (void).cxx_destruct;	// IMP=0x0000000000226027
...
- (id)mainReturningError;	// IMP=0x0000000000225c8e
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000225bd8
