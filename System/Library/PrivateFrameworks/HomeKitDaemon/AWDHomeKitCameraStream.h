...
@interface AWDHomeKitCameraStream : PBCodable
{
...
+ (Class)resolutionCountType;	// IMP=0x00100000004bd9b1
+ (Class)reconfigurationsType;	// IMP=0x00100000004bd9a0
- (void).cxx_destruct;	// IMP=0x00000000004bd8c5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004bd09c
- (unsigned long long)hash;	// IMP=0x00000000004bcdc1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004bc972
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004bc36b
- (void)copyTo:(id)arg1;	// IMP=0x00000000004bbfaa
- (void)writeTo:(id)arg1;	// IMP=0x00000000004bbb10
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004bb14c
- (id)dictionaryRepresentation;	// IMP=0x00000000004ba6fc
- (id)description;	// IMP=0x00000000004ba64d
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004ba630
- (unsigned long long)resolutionCountsCount;	// IMP=0x00000000004ba613
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000004ba5a9
- (void)clearResolutionCounts;	// IMP=0x00000000004ba58c
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x00000000004ba3e8
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x00000000004ba39d
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004ba14e
- (unsigned long long)reconfigurationsCount;	// IMP=0x00000000004ba131
- (void)addReconfigurations:(id)arg1;	// IMP=0x00000000004ba0c7
- (void)clearReconfigurations;	// IMP=0x00000000004ba0aa
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004b9ebe
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004b9e76
