...
+ (id)logCategory;	// IMP=0x001000000035017c
- (void).cxx_destruct;	// IMP=0x0000000000350147
@property(readonly) NSObject<OS_dispatch_queue> *workQueue; // @synthesize workQueue=_workQueue;
@property(readonly) __weak HMDAppleMediaAccessory *accessory; // @synthesize accessory=_accessory;
- (void)forwardEvent:(id)arg1 topic:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000350036
- (void)submitLogEvent:(id)arg1 error:(id)arg2;	// IMP=0x000000000034ffa7
- (void)submitLogEvent:(id)arg1;	// IMP=0x000000000034ff3a
@property(readonly) HMDBulletinBoard *bulletinBoard;
- (id)logIdentifier;	// IMP=0x000000000034fed1
...
- (id)initWithAccessory:(id)arg1 queue:(id)arg2;	// IMP=0x000000000034fb7d
