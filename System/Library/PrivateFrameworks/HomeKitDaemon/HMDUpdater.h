...
+ (id)logCategory;	// IMP=0x00100000007912f2
+ (id)sharedInstance;	// IMP=0x00100000007912c2
+ (void)initialize;	// IMP=0x0010000000791205
- (void).cxx_destruct;	// IMP=0x00000000007909e6
...
- (id)logIdentifier;	// IMP=0x0000000000790891
- (void)_scheduleUpdateCheck;	// IMP=0x00000000007904b7
- (void)updateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000790425
- (int)_executeScript:(const char *)arg1;	// IMP=0x000000000079041a
- (id)_downloadURL;	// IMP=0x000000000079010b
- (void)_clearInstalledRootUUID;	// IMP=0x00000000007900df
- (void)_info;	// IMP=0x000000000078ff4b
- (int)_clean;	// IMP=0x000000000078fdd0
- (int)_reboot;	// IMP=0x000000000078fc6f
- (int)_uninstall;	// IMP=0x000000000078fb44
- (int)_rebuild;	// IMP=0x000000000078fa33
- (int)_install;	// IMP=0x000000000078f828
- (int)_download;	// IMP=0x000000000078f628
- (void)_handleServerResponse:(id)arg1 withData:(id)arg2 error:(id)arg3;	// IMP=0x000000000078ee5b
- (void)_fetchManifestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000078ea1f
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000078e84b
- (id)init;	// IMP=0x000000000078e72d
