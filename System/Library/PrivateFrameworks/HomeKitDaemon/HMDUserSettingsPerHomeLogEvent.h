...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x0000000000af4c74
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)initWithUser:(id)arg1 userDataController:(id)arg2 homeUUID:(id)arg3;	// IMP=0x0000000000af48b8
- (id)initWithUser:(id)arg1;	// IMP=0x0000000000af47fb
