...
+ (id)backingModelProtocol;	// IMP=0x0010000000359dc9
+ (id)homeRelation;	// IMP=0x0010000000359d99
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000359ce5
+ (Class)cd_modelClass;	// IMP=0x0010000000544813
+ (id)fetchRequest;	// IMP=0x0010000000cf6ede
- (id)castIfHomeThreadNetwork;	// IMP=0x0000000000359e4e
