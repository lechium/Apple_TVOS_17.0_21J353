...
+ (id)backingModelProtocol;	// IMP=0x001000000041628e
+ (id)homeRelation;	// IMP=0x001000000041625e
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000004161aa
+ (Class)cd_modelClass;	// IMP=0x0010000000670e44
+ (id)fetchRequest;	// IMP=0x0010000000cf673e
- (void)removePairedUsersObject:(id)arg1;	// IMP=0x000000000041638f
- (void)addPairedUsersObject:(id)arg1;	// IMP=0x0000000000416373
@property(readonly, retain, nonatomic) NSArray *pairedUsers;
- (id)castIfAirPlayAccessory;	// IMP=0x0000000000416313
