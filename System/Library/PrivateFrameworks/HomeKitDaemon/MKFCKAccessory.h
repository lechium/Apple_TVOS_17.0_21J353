...
+ (id)fetchRequest;	// IMP=0x0080000000cf697e
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000870420
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x000000000086fba1
- (_Bool)isReadyToImportIntoLocalModelWithContext:(id)arg1;	// IMP=0x000000000086fa6a
