...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000000095f9
...
- (id)initWithIsPrimary:(_Bool)arg1 didChangePrimary:(_Bool)arg2;	// IMP=0x000000000000949e
