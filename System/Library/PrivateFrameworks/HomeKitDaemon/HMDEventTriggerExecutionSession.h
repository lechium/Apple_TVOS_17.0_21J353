...
+ (id)logCategory;	// IMP=0x0010000000c37744
- (void).cxx_destruct;	// IMP=0x0000000000c35e65
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c35c12
- (id)didOccurEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000c35b58
- (void)_callExecutionCompleteIfNoMoreOutstandingRequests;	// IMP=0x0000000000c358d3
- (void)handleSessionPlaybackStateUpdatedNotification:(id)arg1;	// IMP=0x0000000000c357d3
- (void)_handleMonitoringEvent:(id)arg1;	// IMP=0x0000000000c3546c
- (void)_restoreState;	// IMP=0x0000000000c34eae
- (void)_removeUserDialog;	// IMP=0x0000000000c34e0b
- (void)_callExecutionComplete:(id)arg1;	// IMP=0x0000000000c34df4
- (void)_submitAnalyticsData:(id)arg1;	// IMP=0x0000000000c34820
- (void)_callExecutionComplete:(id)arg1 callDelegate:(_Bool)arg2;	// IMP=0x0000000000c341e8
- (id)valueInActionSetWriteResponse:(id)arg1 actionSetUUID:(id)arg2 accUUID:(id)arg3 serviceID:(id)arg4 characteristicID:(id)arg5;	// IMP=0x0000000000c340c5
- (id)_monitoringEventsFromActionSetResponse:(id)arg1;	// IMP=0x0000000000c32f6c
- (void)_activateEvents:(id)arg1;	// IMP=0x0000000000c32c7b
- (void)_activateMonitoringEvents;	// IMP=0x0000000000c32c2f
- (void)_activateDurationEvents;	// IMP=0x0000000000c32be3
- (void)_handleActionSetExecutionResponse:(id)arg1 actionSetError:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c324bf
- (void)_directlyExecuteActionSetsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c32358
- (void)_addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000c31efe
- (void)addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000c31e20
- (void)_userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c317d2
- (void)userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c316e8
- (id)durationEndEvents;	// IMP=0x0000000000c314fd
- (void)postponeRestoreIfWaitingForEndEvent;	// IMP=0x0000000000c3148c
- (void)cancelSessionIfWaitingForUserResponse;	// IMP=0x0000000000c3141b
- (_Bool)containsSecureActionSet;	// IMP=0x0000000000c312dd
- (void)_executeTriggerAfterEvaluatingCondition:(id)arg1;	// IMP=0x0000000000c30b9e
- (void)_evaluateFiringTrigger;	// IMP=0x0000000000c2ffc7
- (void)evaluateFiringTrigger;	// IMP=0x0000000000c2ff56
- (id)dumpState;	// IMP=0x0000000000c2fbb0
- (_Bool)needsUserConfirmationForDevice:(id)arg1;	// IMP=0x0000000000c2f98e
- (id)logIdentifier;	// IMP=0x0000000000c2f97c
@property(readonly, copy) NSString *description;
- (id)initWithEventTrigger:(id)arg1 predicateUtilities:(id)arg2 triggerEvent:(id)arg3 causingDevice:(id)arg4 workQueue:(id)arg5 actionSets:(id)arg6 evaluationCondition:(id)arg7 recurrences:(id)arg8 endEvents:(id)arg9 msgDispatcher:(id)arg10;	// IMP=0x0000000000c2f4c7
