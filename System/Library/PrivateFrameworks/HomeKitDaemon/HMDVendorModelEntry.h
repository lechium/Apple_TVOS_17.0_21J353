...
- (void).cxx_destruct;	// IMP=0x0000000000c078b2
...
- (unsigned long long)hash;	// IMP=0x0000000000c075d4
- (long long)compare:(id)arg1;	// IMP=0x0000000000c074de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c07109
- (id)attributeDescriptions;	// IMP=0x0000000000c06e0a
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000c06c0a
