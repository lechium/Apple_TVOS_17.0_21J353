...
- (void).cxx_destruct;	// IMP=0x0000000000897ea1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000897b76
- (unsigned long long)hash;	// IMP=0x0000000000897a57
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000897857
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008976a1
- (void)copyTo:(id)arg1;	// IMP=0x000000000089755e
- (void)writeTo:(id)arg1;	// IMP=0x000000000089742c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000089741f
- (id)dictionaryRepresentation;	// IMP=0x0000000000897125
- (id)description;	// IMP=0x0000000000897076
