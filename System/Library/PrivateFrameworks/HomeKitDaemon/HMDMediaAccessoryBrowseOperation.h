...
+ (id)logCategory;	// IMP=0x00100000003fd226
+ (double)defaultTimeout;	// IMP=0x00100000003fd1f9
- (void).cxx_destruct;	// IMP=0x00000000003fcd54
@property(readonly, copy) NSString *accessoryIdentifier; // @synthesize accessoryIdentifier=_accessoryIdentifier;
- (void)cancel;	// IMP=0x00000000003fccf8
- (void)main;	// IMP=0x00000000003fcab6
...
- (void)dealloc;	// IMP=0x00000000003fc96d
- (id)initWithAccessoryIdentifier:(id)arg1 timeout:(double)arg2;	// IMP=0x00000000003fc7d4
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x00000000003fc7bf
