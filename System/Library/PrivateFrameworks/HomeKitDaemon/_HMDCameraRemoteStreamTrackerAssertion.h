...
- (void).cxx_destruct;	// IMP=0x000000000076c189
...
- (void)dealloc;	// IMP=0x000000000076c0db
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x000000000076c040
