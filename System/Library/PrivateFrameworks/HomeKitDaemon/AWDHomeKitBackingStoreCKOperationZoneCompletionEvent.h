...
- (void).cxx_destruct;	// IMP=0x00000000008ac507
@property(retain, nonatomic) NSString *errorDomain; // @synthesize errorDomain=_errorDomain;
@property(nonatomic) long long errorCode; // @synthesize errorCode=_errorCode;
@property(nonatomic) _Bool didSucceed; // @synthesize didSucceed=_didSucceed;
@property(nonatomic) unsigned long long timestamp; // @synthesize timestamp=_timestamp;
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008ac3dd
- (unsigned long long)hash;	// IMP=0x00000000008ac321
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008ac1be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008ac0b4
- (void)copyTo:(id)arg1;	// IMP=0x00000000008abfe1
- (void)writeTo:(id)arg1;	// IMP=0x00000000008abef0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008abab1
- (id)dictionaryRepresentation;	// IMP=0x00000000008ab858
- (id)description;	// IMP=0x00000000008ab7a9
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsZoneType:(id)arg1;	// IMP=0x00000000008ab6a2
- (id)zoneTypeAsString:(int)arg1;	// IMP=0x00000000008ab65a
@property(nonatomic) _Bool hasZoneType;
@property(nonatomic) int zoneType; // @synthesize zoneType=_zoneType;
- (int)StringAsContainerType:(id)arg1;	// IMP=0x00000000008ab53c
- (id)containerTypeAsString:(int)arg1;	// IMP=0x00000000008ab4f4
