...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000043bf11
- (unsigned long long)hash;	// IMP=0x000000000043be1d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000043bc85
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000043bb73
- (void)copyTo:(id)arg1;	// IMP=0x000000000043ba84
- (void)writeTo:(id)arg1;	// IMP=0x000000000043b951
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000043b944
- (id)dictionaryRepresentation;	// IMP=0x000000000043b647
- (id)description;	// IMP=0x000000000043b598
