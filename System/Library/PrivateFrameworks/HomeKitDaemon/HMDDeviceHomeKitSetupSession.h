...
- (void).cxx_destruct;	// IMP=0x0000000000925bda
...
- (void)markHasFailedRelayAttempt;	// IMP=0x0000000000925b66
@property(readonly) _Bool shouldRelayRequest;
- (id)initWithFirstResidentForHome:(_Bool)arg1 clientConnection:(id)arg2;	// IMP=0x0000000000925ab6
