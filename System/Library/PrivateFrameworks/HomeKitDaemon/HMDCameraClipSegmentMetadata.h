...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000009efda6
- (unsigned long long)hash;	// IMP=0x00000000009efb09
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009ef984
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009ef87e
- (void)copyTo:(id)arg1;	// IMP=0x00000000009ef79b
- (void)writeTo:(id)arg1;	// IMP=0x00000000009ef684
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009ef1cc
- (id)dictionaryRepresentation;	// IMP=0x00000000009eef06
- (id)description;	// IMP=0x00000000009eee57
@property(nonatomic) _Bool hasHeight;
@property(nonatomic) _Bool hasWidth;
- (int)StringAsType:(id)arg1;	// IMP=0x00000000009eed2a
- (id)typeAsString:(int)arg1;	// IMP=0x00000000009eece2
