...
- (void).cxx_destruct;	// IMP=0x000000000026f8f4
...
- (id)description;	// IMP=0x000000000026f855
- (void)dealloc;	// IMP=0x000000000026f765
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000026f691
