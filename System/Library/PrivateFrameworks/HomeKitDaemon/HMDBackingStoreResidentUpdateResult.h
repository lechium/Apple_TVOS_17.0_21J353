...
- (void).cxx_destruct;	// IMP=0x00000000009fd306
...
- (id)initWithAddedResidentDevices:(id)arg1 deletedResidentDevices:(id)arg2 reachabilityUpdates:(id)arg3;	// IMP=0x00000000009fd1f7
