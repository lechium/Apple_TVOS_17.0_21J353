...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x006000000081a737
- (void).cxx_destruct;	// IMP=0x000000000081a70f
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x000000000081a64b
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x000000000081a639
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x000000000081a54e
