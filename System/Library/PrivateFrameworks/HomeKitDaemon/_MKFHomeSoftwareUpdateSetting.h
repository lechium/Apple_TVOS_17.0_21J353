...
+ (id)backingModelProtocol;	// IMP=0x0010000000c526bf
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000c526a6
+ (Class)cd_modelClass;	// IMP=0x001000000062ca77
+ (id)fetchRequest;	// IMP=0x0010000000cf6ebe
- (id)castIfHomeSoftwareUpdateSetting;	// IMP=0x0000000000c52706
