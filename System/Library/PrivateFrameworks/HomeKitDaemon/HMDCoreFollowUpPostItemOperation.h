...
- (void).cxx_destruct;	// IMP=0x00000000004be3c8
...
- (void)main;	// IMP=0x00000000004be1d2
- (id)initWithItemToPost:(id)arg1 followUpController:(id)arg2;	// IMP=0x00000000004be107
