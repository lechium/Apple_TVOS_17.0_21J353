...
+ (id)logCategory;	// IMP=0x00100000006a1ef8
- (void).cxx_destruct;	// IMP=0x00000000006a1ea5
...
- (id)logIdentifier;	// IMP=0x00000000006a1dfd
- (void)dealloc;	// IMP=0x00000000006a1cdf
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3;	// IMP=0x00000000006a1b13
