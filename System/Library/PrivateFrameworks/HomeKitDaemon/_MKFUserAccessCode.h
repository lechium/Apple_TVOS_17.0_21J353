...
+ (id)backingModelProtocol;	// IMP=0x00100000005b4180
+ (id)homeRelation;	// IMP=0x00100000005b4150
+ (Class)cd_modelClass;	// IMP=0x0010000000836ce2
+ (id)fetchRequest;	// IMP=0x0010000000cf72de
@property(readonly) id <MKFHome> home;
- (id)castIfUserAccessCode;	// IMP=0x00000000005b4205
