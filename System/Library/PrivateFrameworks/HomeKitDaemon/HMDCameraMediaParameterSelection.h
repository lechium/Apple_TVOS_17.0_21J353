...
- (void).cxx_destruct;	// IMP=0x0000000000a6b25f
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x0000000000a6b094
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000a6aeec
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000a6ab17
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000a6a7a1
