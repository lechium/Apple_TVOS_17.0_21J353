...
- (void).cxx_destruct;	// IMP=0x000000000023d4ea
...
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x000000000023d222
- (id)init;	// IMP=0x000000000023d17a
