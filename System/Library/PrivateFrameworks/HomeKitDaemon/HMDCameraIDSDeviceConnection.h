...
+ (id)logCategory;	// IMP=0x00100000003ed0de
- (void).cxx_destruct;	// IMP=0x00000000003ebca7
...
- (id)logIdentifier;	// IMP=0x00000000003ebb88
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x00000000003ebad4
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x00000000003eba20
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003eb731
- (void)startKeepAlive;	// IMP=0x00000000003eb6c8
- (void)_createStreamSocketWithDevice:(id)arg1;	// IMP=0x00000000003ea151
- (void)dealloc;	// IMP=0x00000000003ea0aa
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 idsProxyStreamService:(id)arg3;	// IMP=0x00000000003e9e8a
