...
- (void).cxx_destruct;	// IMP=0x000000000086f718
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x000000000086f409
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x000000000086f207
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x000000000086f005
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000086ef36
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x000000000086edd3
- (void)_removeBrowser:(id)arg1;	// IMP=0x000000000086ed5d
- (void)_addBrowser:(id)arg1;	// IMP=0x000000000086ece7
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x000000000086eb32
- (void)_stopBrowsers;	// IMP=0x000000000086e6ad
- (void)stop;	// IMP=0x000000000086e63c
- (_Bool)_startBrowsers;	// IMP=0x000000000086e29e
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000086e1e6
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x000000000086df69
