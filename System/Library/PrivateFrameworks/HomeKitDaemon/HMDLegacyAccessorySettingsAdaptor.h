...
+ (id)parsedLanguageListSetting:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000b29a29
+ (id)parsedLanguageSetting:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000b2972e
+ (id)parsedIntegerSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000b29490
+ (id)parsedBoolSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000b29155
+ (id)logCategory;	// IMP=0x0010000000b29125
- (void).cxx_destruct;	// IMP=0x0000000000b2877f
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000b28304
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)arg1;	// IMP=0x0000000000b280cc
- (id)_settingValueForKeyPath:(id)arg1 value:(id)arg2;	// IMP=0x0000000000b278c3
- (id)languageValueList;	// IMP=0x0000000000b278b6
- (void)updateSettingWithKeyPath:(id)arg1 settingValue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b275b1
- (void)startup;	// IMP=0x0000000000b27245
- (id)initWithQueue:(id)arg1 homeUUID:(id)arg2 accessoryUUID:(id)arg3 settingsController:(id)arg4 subscriptionProvider:(id)arg5;	// IMP=0x0000000000b27143
