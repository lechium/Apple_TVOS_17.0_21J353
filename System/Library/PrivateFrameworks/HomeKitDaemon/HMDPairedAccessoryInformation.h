...
- (void).cxx_destruct;	// IMP=0x00000000009b6327
...
- (id)description;	// IMP=0x00000000009b624c
- (unsigned long long)hash;	// IMP=0x00000000009b6208
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009b612c
- (id)initWithIdentifier:(id)arg1 transports:(unsigned long long)arg2 setupHash:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000009b6042
- (id)init;	// IMP=0x00000000009b5f9a
