...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x00600000001c6fb5
- (void).cxx_destruct;	// IMP=0x00000000001c6fa7
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000001c6f1e
