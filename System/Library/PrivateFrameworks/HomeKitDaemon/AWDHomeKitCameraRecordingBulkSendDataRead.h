...
@interface AWDHomeKitCameraRecordingBulkSendDataRead : PBCodable
{
...
- (void).cxx_destruct;	// IMP=0x0000000000a15306
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a1507a
- (unsigned long long)hash;	// IMP=0x0000000000a14eea
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a14c82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a14ab7
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a1491e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a14764
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a1404c
- (id)dictionaryRepresentation;	// IMP=0x0000000000a13c48
- (id)description;	// IMP=0x0000000000a13b99
