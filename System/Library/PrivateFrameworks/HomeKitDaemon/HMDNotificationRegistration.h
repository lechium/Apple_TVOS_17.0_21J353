...
+ (id)logCategory;	// IMP=0x0010000000bf3280
- (void).cxx_destruct;	// IMP=0x0000000000bf3251
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000bf2f86
- (id)logIdentifier;	// IMP=0x0000000000bf2eb1
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000bf2e19
