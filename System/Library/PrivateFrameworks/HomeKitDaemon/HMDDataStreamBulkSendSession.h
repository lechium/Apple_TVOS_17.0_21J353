...
+ (id)logCategory;	// IMP=0x0010000000c77fb2
- (void).cxx_destruct;	// IMP=0x0000000000c77cdb
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000c77aa7
- (void)_closeSession;	// IMP=0x0000000000c779cd
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000c77915
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000c7785e
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c7771e
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000c7768d
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000c77547
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000c77408
