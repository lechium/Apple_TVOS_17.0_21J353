...
+ (id)logCategory;	// IMP=0x0010000000c7713d
- (void).cxx_destruct;	// IMP=0x0000000000c733af
...
- (id)logIdentifier;	// IMP=0x0000000000c7329d
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000c73209
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000c73175
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000c730e1
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000c72fee
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000c72ea5
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c72ddb
- (void)stop;	// IMP=0x0000000000c72d89
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000c72cb2
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000c72c1e
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c724fb
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c7243d
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000c722d4
@property(readonly, getter=isIdle) _Bool idle; // @synthesize idle=_idle;
- (void)setAuthenticated:(_Bool)arg1;	// IMP=0x0000000000c7225d
@property(readonly, getter=isAuthenticated) _Bool authenticated; // @synthesize authenticated=_authenticated;
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000c721e6
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000c7215b
...
- (void)dealloc;	// IMP=0x0000000000c71c8b
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4 accountRegistry:(id)arg5;	// IMP=0x0000000000c71a05
