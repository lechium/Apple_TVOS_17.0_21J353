...
- (void).cxx_destruct;	// IMP=0x00000000002296c0
...
- (id)mainReturningError;	// IMP=0x00000000002293f3
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x0000000000229337
