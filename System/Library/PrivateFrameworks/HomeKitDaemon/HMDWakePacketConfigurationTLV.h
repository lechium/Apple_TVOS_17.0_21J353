...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000081d9aa
- (void).cxx_destruct;	// IMP=0x000000000081d961
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000081d32d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000081d225
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000081cbc4
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000081c653
- (id)initWithWakePacketType:(id)arg1 wakeDestinationPort:(id)arg2 wakeDestinationAddress:(id)arg3 wakeType:(id)arg4 wakePattern:(id)arg5;	// IMP=0x000000000081c54c
- (id)init;	// IMP=0x000000000081c51d
