...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000000c05d9
- (void).cxx_destruct;	// IMP=0x00000000000c05c6
...
- (id)description;	// IMP=0x00000000000c03c6
- (unsigned long long)hash;	// IMP=0x00000000000c0382
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c02f1
