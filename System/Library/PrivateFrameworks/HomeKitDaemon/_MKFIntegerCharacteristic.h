...
+ (id)backingModelProtocol;	// IMP=0x001000000038ed0a
+ (id)fetchRequest;	// IMP=0x0010000000cf6f1e
@property(readonly) id <MKFHome> home;
- (id)castIfIntegerCharacteristic;	// IMP=0x000000000038ecb1
@property(readonly, copy, nonatomic) MKFIntegerCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x000000000038eb59
