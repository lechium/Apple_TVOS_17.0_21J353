...
- (void).cxx_destruct;	// IMP=0x00000000003d8435
...
- (id)description;	// IMP=0x00000000003d8302
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x00000000003d8227
