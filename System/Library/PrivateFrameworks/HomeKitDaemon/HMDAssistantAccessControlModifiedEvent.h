...
+ (id)eventWithIsEnabled:(_Bool)arg1 options:(unsigned long long)arg2 areActivityNotificationsEnabledForPersonalRequests:(_Bool)arg3 numEnabledAccessories:(unsigned long long)arg4 numCapableAccessories:(unsigned long long)arg5;	// IMP=0x00600000004b586c
