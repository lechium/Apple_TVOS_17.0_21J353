...
+ (id)logCategory;	// IMP=0x001000000029f335
+ (id)shortDescription;	// IMP=0x001000000029f328
- (void).cxx_destruct;	// IMP=0x000000000029d2be
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000029cc82
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000029c9db
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000029c73f
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x000000000029c562
- (_Bool)cancelOnSetup;	// IMP=0x000000000029bfac
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1;	// IMP=0x000000000029b49a
- (void)main;	// IMP=0x000000000029b235
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x000000000029b1af
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x000000000029b05d
