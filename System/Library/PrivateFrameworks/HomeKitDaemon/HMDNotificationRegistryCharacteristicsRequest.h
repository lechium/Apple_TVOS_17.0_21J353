...
- (void).cxx_destruct;	// IMP=0x00000000007f6224
...
- (id)attributeDescriptions;	// IMP=0x00000000007f6021
- (id)initWithEnable:(_Bool)arg1 user:(id)arg2 deviceIdsDestination:(id)arg3 accessoryUUID:(id)arg4;	// IMP=0x00000000007f5eee
