...
+ (id)properties;	// IMP=0x00100000000afc0d
+ (Class)cd_entityClass;	// IMP=0x0010000000562ad6
+ (id)cd_parentReferenceName;	// IMP=0x0010000000562ac9
- (id)dependentUUIDs;	// IMP=0x00000000000af6ce
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000005623a5
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000561fdd
