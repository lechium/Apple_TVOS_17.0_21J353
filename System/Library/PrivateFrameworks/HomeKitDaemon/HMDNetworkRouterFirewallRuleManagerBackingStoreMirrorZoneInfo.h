...
- (void).cxx_destruct;	// IMP=0x000000000091672a
...
- (void)forceRefresh;	// IMP=0x0000000000916666
- (void)markDeleted;	// IMP=0x0000000000916655
- (void)markChanged;	// IMP=0x0000000000916644
- (id)initWithZoneID:(id)arg1;	// IMP=0x000000000091658d
