...
+ (id)logCategory;	// IMP=0x0010000000afde11
+ (id)processInfoWithConnection:(id)arg1;	// IMP=0x0010000000afdd18
+ (id)privateClientIdentifierSalt;	// IMP=0x0010000000afdce8
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000afdc7e
- (void).cxx_destruct;	// IMP=0x0000000000afd8bf
...
- (id)logIdentifier;	// IMP=0x0000000000afd7dc
- (id)clientIdentifierSalt:(id *)arg1;	// IMP=0x0000000000afd6aa
- (void)removeConnection:(id)arg1;	// IMP=0x0000000000afd62c
- (void)addConnection:(id)arg1;	// IMP=0x0000000000afd3d5
...
- (void)_updateProcessState:(id)arg1;	// IMP=0x0000000000afc94e
@property(readonly) _Bool shouldMonitor;
- (id)attributeDescriptions;	// IMP=0x0000000000afc6a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000afc580
- (id)initWithIdentifier:(int)arg1;	// IMP=0x0000000000afc34a
- (id)initWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x0000000000afbf25
- (id)init;	// IMP=0x0000000000afbe7d
