...
+ (id)logCategory;	// IMP=0x0010000000908026
- (void).cxx_destruct;	// IMP=0x0000000000907fcd
...
- (id)logIdentifier;	// IMP=0x0000000000907efe
@property(readonly, copy) NSString *description;
- (void)main;	// IMP=0x0000000000907db4
- (id)mainReturningError;	// IMP=0x0000000000907dac
- (id)init;	// IMP=0x0000000000907d98
- (id)initWithResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000907cc4
