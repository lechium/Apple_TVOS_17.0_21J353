...
- (void).cxx_destruct;	// IMP=0x0000000000029ac2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000297a6
- (id)description;	// IMP=0x000000000002968e
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x0000000000029578
