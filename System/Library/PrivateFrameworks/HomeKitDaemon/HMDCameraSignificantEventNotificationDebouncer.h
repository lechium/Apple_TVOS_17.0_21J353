...
+ (id)logCategory;	// IMP=0x0010000000999a40
- (void).cxx_destruct;	// IMP=0x00000000009999b4
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000999747
- (void)trackCameraSignificantEvent:(id)arg1 shouldNotify:(_Bool *)arg2;	// IMP=0x0000000000999024
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x0000000000998e89
