...
- (void).cxx_destruct;	// IMP=0x00000000004fd727
...
- (id)description;	// IMP=0x00000000004fd699
- (void)dealloc;	// IMP=0x00000000004fd5a9
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000004fd4f8
