...
+ (int)awdUserPrivilegeFromHMUserPrivilege:(long long)arg1;	// IMP=0x0060000000a9d8ff
+ (id)eventWithP2PEnabled:(_Bool)arg1 privilegeLevel:(long long)arg2 passwordSet:(_Bool)arg3;	// IMP=0x0060000000a9d87a
