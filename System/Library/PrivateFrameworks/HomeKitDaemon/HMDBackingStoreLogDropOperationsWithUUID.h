...
- (void).cxx_destruct;	// IMP=0x000000000090a385
...
- (id)mainReturningError;	// IMP=0x0000000000909d71
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000909cc9
