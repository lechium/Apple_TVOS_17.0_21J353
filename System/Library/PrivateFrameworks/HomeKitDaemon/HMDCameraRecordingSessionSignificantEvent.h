...
- (void).cxx_destruct;	// IMP=0x000000000003f7eb
...
- (id)attributeDescriptions;	// IMP=0x000000000003f1ad
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003effd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003eff2
- (unsigned long long)hash;	// IMP=0x000000000003efae
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003ec27
- (id)initWithUUID:(id)arg1;	// IMP=0x000000000003eb01
