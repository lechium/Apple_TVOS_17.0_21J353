...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000053ffe7
- (void).cxx_destruct;	// IMP=0x000000000053ff61
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000053fd46
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000053fbe8
