...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000583895
- (void).cxx_destruct;	// IMP=0x0000000000582e9e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000058270f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005825dd
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000581f88
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000058196e
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x0000000000581847
- (id)init;	// IMP=0x0000000000581818
