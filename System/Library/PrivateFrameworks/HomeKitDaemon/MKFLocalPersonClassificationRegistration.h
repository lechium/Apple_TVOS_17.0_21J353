...
+ (id)fetchPersonClassificationRegistrationForPersonUUID:(id)arg1 settingsModelUUID:(id)arg2 managedObjectContext:(id)arg3;	// IMP=0x008000000024dc81
+ (id)fetchRequest;	// IMP=0x0080000000cf663e
