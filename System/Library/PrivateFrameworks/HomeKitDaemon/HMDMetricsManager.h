...
@interface HMDMetricsManager : NSObject
{
    ...
    HMMCoreAnalyticsTagObserver *_coreAnalyticsTagObserver;	// 360 = 0x168
    NSMutableArray *_aggregationAnalysisEventContributingAnalyzers;	// 368 = 0x170
}

+ (id)namespaceUUID;	// IMP=0x0010000000643ded
- (void).cxx_destruct;	// IMP=0x00000000006438d2
...
- (id)messageDestination;	// IMP=0x00000000006431cd
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)saveCounters;	// IMP=0x0000000000643176
- (void)waitToCompleteCurrentlyQueuedTasks;	// IMP=0x000000000064310a
- (void)_handleLogEventDailySchedulerSubmitRequest:(id)arg1;	// IMP=0x0000000000643097
- (void)_handleLogEventDailySchedulerStatusRequest:(id)arg1;	// IMP=0x0000000000643010
- (void)_handleResetEventCounters:(id)arg1;	// IMP=0x0000000000642f9d
- (void)_handleFetchEventCounters:(id)arg1;	// IMP=0x0000000000642e19
- (void)addRateTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4 windowSize:(unsigned long long)arg5;	// IMP=0x0000000000642d0d
- (void)addThresholdTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4 uploadImmediately:(_Bool)arg5;	// IMP=0x0000000000642c02
- (void)addThresholdTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4;	// IMP=0x0000000000642b00
- (void)registerEWSTriggers;	// IMP=0x0000000000642652
- (void)startAnalyzers;	// IMP=0x0000000000641c76
- (void)registerTaggedLoggingProcessors;	// IMP=0x0000000000641baa
@property(readonly) _Bool isSubmissionEnabled;
@property(readonly, nonatomic) _Bool isDemoModeConfigured;
@property(readonly, nonatomic) id <HMMLogEventSubmitting> logEventSubmitter;
- (void)updateWidgetStatusInCachedConfiguration;	// IMP=0x000000000064197e
- (id)accessoryForIdentifier:(id)arg1;	// IMP=0x0000000000641644
@property(readonly, nonatomic) id <HMDMetricsDeviceStateProvider> deviceStateProvider;
- (id)cachedHomeConfigurationForHomeUUID:(id)arg1;	// IMP=0x0000000000641439
...
- (void)homeKitConfigurationChanged;	// IMP=0x000000000064112d
@property(readonly, copy, nonatomic) NSArray *configurationObservers;
- (void)addConfigurationChangedObserver:(CDUnknownBlockType)arg1;	// IMP=0x0000000000641058
- (id)logHomeKitErrorAggregationSummary;	// IMP=0x0000000000641008
- (id)logHomeKitAggregationAnalysisSummary;	// IMP=0x0000000000640fb8
- (void)resetHomeKitAggregationAnalysisContext;	// IMP=0x0000000000640e89
- (id)homeKitAggregationAnalysisLogEvent;	// IMP=0x0000000000640d2e
- (void)submitDailyAggregationAnalysisEvents;	// IMP=0x0000000000640c93
- (void)submitCurrentUserSettings;	// IMP=0x0000000000640a6f
- (void)runDailyTask;	// IMP=0x00000000006404be
- (void)startMetricsCollection;	// IMP=0x00000000006401f4
- (void)configureHAPMetricsDispatcher:(id)arg1;	// IMP=0x000000000064018b
- (void)_registerForMessages;	// IMP=0x000000000063fe8b
- (void)_configureManagers;	// IMP=0x000000000063fcff
- (void)addAnalyzer:(id)arg1 toListOfAggregationAnalysisEventContributing:(id)arg2;	// IMP=0x000000000063fc8c
- (void)_configureObservers;	// IMP=0x000000000063f60f
...
- (id)initWithMessageDispatcher:(id)arg1 accountManager:(id)arg2 notificationSettingsProvider:(id)arg3;	// IMP=0x000000000063ee97
