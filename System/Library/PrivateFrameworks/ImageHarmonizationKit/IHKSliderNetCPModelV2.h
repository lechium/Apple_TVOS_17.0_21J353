...
- (id).cxx_construct;	// IMP=0x000000000000d4d0
- (void).cxx_destruct;	// IMP=0x000000000000d370
...
- (id)applyAdjustments:(id)arg1 toCIImage:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000cfc0
- (id)predictSlidersForStyleVector:(id)arg1 contentVector:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000bdd0
- (id)predictContentVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b4f0
- (id)predictStyleVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000a840
- (id)initWithModel:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000009b40
- (id)initWithModel:(id)arg1;	// IMP=0x0000000000009b20
- (unsigned long long)styleFVecSize;	// IMP=0x0000000000009ab0
- (unsigned long long)contentFVecSize;	// IMP=0x0000000000009a40
