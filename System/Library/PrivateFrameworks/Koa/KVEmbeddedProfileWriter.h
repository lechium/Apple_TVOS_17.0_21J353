...
- (id).cxx_construct;	// IMP=0x0000000000026ccd
- (void).cxx_destruct;	// IMP=0x0000000000026c61
- (_Bool)finishProfile:(id *)arg1;	// IMP=0x0000000000026ab0
- (_Bool)finishDataset:(id *)arg1;	// IMP=0x00000000000267c4
- (_Bool)addItem:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000026543
- (_Bool)startDataset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002652f
- (_Bool)startProfile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002651b
- (id)initWithOutputStream:(id)arg1;	// IMP=0x000000000002649c
