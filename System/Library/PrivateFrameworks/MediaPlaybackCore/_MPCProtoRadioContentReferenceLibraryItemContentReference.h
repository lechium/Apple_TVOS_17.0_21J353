...
- (void).cxx_destruct;	// IMP=0x0000000000259326
- (unsigned long long)hash;	// IMP=0x0000000000258ef8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000258b1a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025882e
- (void)writeTo:(id)arg1;	// IMP=0x00000000002585a0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000258593
- (id)dictionaryRepresentation;	// IMP=0x0000000000258049
- (id)description;	// IMP=0x0000000000257f9a
