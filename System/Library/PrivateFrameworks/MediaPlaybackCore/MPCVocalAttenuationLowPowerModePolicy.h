...
- (void).cxx_destruct;	// IMP=0x00000000001cfd1c
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x00000000001cfb71
- (void)powerModeDidChange:(_Bool)arg1;	// IMP=0x00000000001cfa0e
- (void)processInfoPowerStateDidChange:(id)arg1;	// IMP=0x00000000001cf9d9
- (id)evaluation;	// IMP=0x00000000001cf8e1
- (void)reset;	// IMP=0x00000000001cf8db
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithPowerModeMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000001cf78e
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000001cf6f7
