...
+ (id)enumeratorWithMusicBehavior:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x006000000019d008
- (void).cxx_destruct;	// IMP=0x000000000019cedc
...
- (void)_buildEnumerator;	// IMP=0x000000000019c90b
- (id)_init;	// IMP=0x000000000019c8dc
- (id)nextObject;	// IMP=0x000000000019c823
