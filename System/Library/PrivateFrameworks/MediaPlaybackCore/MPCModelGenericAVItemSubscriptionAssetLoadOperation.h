...
- (void).cxx_destruct;	// IMP=0x00000000001e4449
...
- (void)setCancellationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e4305
- (CDUnknownBlockType)cancellationHandler;	// IMP=0x00000000001e4246
- (id)_handlePlaybackResponse:(id)arg1 withPlaybackCacheRequest:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001e3cde
- (id)_loadResultsFromServerObjectDatabaseAssets:(id)arg1 hlsAsset:(id)arg2 playbackAuthorizationToken:(id)arg3;	// IMP=0x00000000001e3542
- (id)_loadResultsFromServerObjectDatabaseAssetsWithMiniSinf:(id)arg1 playbackAuthorizationToken:(id)arg2;	// IMP=0x00000000001e2f18
- (_Bool)_canRetrieveLoadResultsFromServerObjectDatabaseWithAssets:(id *)arg1 hlsAsset:(id *)arg2;	// IMP=0x00000000001e292f
- (_Bool)_canRetrieveLoadResultsFromMiniSinfWithAssets:(id *)arg1;	// IMP=0x00000000001e255c
- (void)execute;	// IMP=0x00000000001e12ae
- (void)cancel;	// IMP=0x00000000001e124e
- (id)description;	// IMP=0x00000000001e1194
- (id)init;	// IMP=0x00000000001e1130
