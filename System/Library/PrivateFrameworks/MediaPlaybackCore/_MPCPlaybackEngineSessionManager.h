...
+ (id)archivesAtURL:(id)arg1;	// IMP=0x00100000002f7a57
- (void).cxx_destruct;	// IMP=0x00000000002f6c2f
...
- (id)_playbackSessionsDirectory;	// IMP=0x00000000002f6af8
@property(retain, nonatomic) NSString *stateRestorationSessionIdentifier;
- (void)deleteSessionWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002f680a
- (void)saveSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f5f56
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x00000000002f5ddb
