...
- (void).cxx_destruct;	// IMP=0x00000000001ad042
...
- (id)stringRepresentation;	// IMP=0x00000000001acfdc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001acf29
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ace6d
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x00000000001acd81
