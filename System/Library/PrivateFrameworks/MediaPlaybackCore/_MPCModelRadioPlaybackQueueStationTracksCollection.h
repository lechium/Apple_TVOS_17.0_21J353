...
- (void).cxx_destruct;	// IMP=0x00000000002d4cf9
...
- (id)trackForItemAtIndex:(long long)arg1;	// IMP=0x00000000002d4c61
- (long long)removeExplicitItems;	// IMP=0x00000000002d4b25
- (void)removeAllItems;	// IMP=0x00000000002d4ae0
@property(readonly, nonatomic) long long numberOfItems;
- (_Bool)isExplicitItemAtIndex:(long long)arg1;	// IMP=0x00000000002d4934
- (id)AVItemAtIndex:(long long)arg1;	// IMP=0x00000000002d465b
- (void)updateWithPersonalizedResponse:(id)arg1;	// IMP=0x00000000002d4274
- (id)initWithPlaybackContext:(id)arg1;	// IMP=0x00000000002d4171
