...
+ (id)_filePathsForModelAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00600000001dc9e7
+ (id)_plistForModelAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00600000001dc6d2
- (void).cxx_destruct;	// IMP=0x00000000001dc694
...
- (id)description;	// IMP=0x00000000001dc1f5
