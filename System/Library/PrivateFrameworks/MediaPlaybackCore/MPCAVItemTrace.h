...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x00600000002cf549
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x00600000002cf465
- (void).cxx_destruct;	// IMP=0x00000000002cf43f
...
- (void)cancel;	// IMP=0x00000000002cf22d
- (void)endInterval;	// IMP=0x00000000002cf09b
- (void)dealloc;	// IMP=0x00000000002cf05d
