...
- (void)resetWithReason:(id)arg1;	// IMP=0x0000000000041e4b
- (void)setRelativeVolume:(float)arg1;	// IMP=0x0000000000043856
- (void)setSpatializationFormat:(long long)arg1;	// IMP=0x00000000000437c0
