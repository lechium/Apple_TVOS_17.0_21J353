...
- (void).cxx_destruct;	// IMP=0x00000000002c9faa
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c9c80
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c9963
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x00000000002c98ca
