...
- (void).cxx_destruct;	// IMP=0x00000000002553cc
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x0000000000255029
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x0000000000254fe7
