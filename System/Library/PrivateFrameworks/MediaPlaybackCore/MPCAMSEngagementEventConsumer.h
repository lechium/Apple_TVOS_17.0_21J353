...
+ (id)identifier;	// IMP=0x001000000025be15
- (void).cxx_destruct;	// IMP=0x000000000025caec
...
- (id)_JSONEncodableEvent:(id)arg1;	// IMP=0x000000000025c955
- (_Bool)_enqueueDataForPlaybackChangingEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x000000000025c03b
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x000000000025c002
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x000000000025be22
