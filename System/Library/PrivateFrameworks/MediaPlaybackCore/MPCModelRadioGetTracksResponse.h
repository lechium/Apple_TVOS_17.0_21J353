...
- (void).cxx_destruct;	// IMP=0x0000000000285263
...
- (id)description;	// IMP=0x0000000000285165
- (id)initWithTracks:(id)arg1 tracklistAction:(long long)arg2;	// IMP=0x00000000002850e7
