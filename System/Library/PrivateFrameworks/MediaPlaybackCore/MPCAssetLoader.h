...
- (void).cxx_destruct;	// IMP=0x00000000001acd30
...
- (double)unloadingPlaybackAssetsOnIdleDuration;	// IMP=0x00000000001acc8d
- (void)cancelLoading;	// IMP=0x00000000001acc50
- (void)loadAssetValuesFor:(id)arg1 keys:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001acae0
- (void)loadAssetFor:(id)arg1 token:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ac836
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000001ac772
