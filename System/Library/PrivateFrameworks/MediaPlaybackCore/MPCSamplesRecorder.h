...
- (void).cxx_destruct;	// IMP=0x000000000014db47
...
- (id)flushSamplesToCSVDataWithHeader:(_Bool)arg1;	// IMP=0x000000000014d9e4
- (id)dictionaryRepresentation;	// IMP=0x000000000014d8df
- (id)description;	// IMP=0x000000000014d826
@property(readonly, nonatomic) int numberOfSamples;
- (void)recordSample:(id)arg1;	// IMP=0x000000000014d790
- (id)initWithRecordID:(id)arg1 modelID:(id)arg2 firstFailureDetector:(id)arg3 shouldStoreSamples:(_Bool)arg4 delegate:(id)arg5;	// IMP=0x000000000014d5f3
