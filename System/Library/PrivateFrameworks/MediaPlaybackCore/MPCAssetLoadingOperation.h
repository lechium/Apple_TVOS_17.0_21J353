...
- (void).cxx_destruct;	// IMP=0x00000000001ac55d
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001abff5
- (void)main;	// IMP=0x00000000001ab7aa
- (_Bool)isFinished;	// IMP=0x00000000001ab79a
- (_Bool)isExecuting;	// IMP=0x00000000001ab78a
- (void)start;	// IMP=0x00000000001ab57c
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00000000001ab3c2
