...
- (void).cxx_destruct;	// IMP=0x000000000023aab9
...
- (_Bool)_isSupportedPlaybackIntent:(id)arg1 forRemotePlayer:(_Bool)arg2 atInsertionPosition:(int)arg3;	// IMP=0x000000000023a6e9
- (id)_createRadioStationCommandRequest;	// IMP=0x000000000023a534
- (id)_insertWithOptions:(id)arg1;	// IMP=0x000000000023a30d
- (id)insertAtEndOfUpNextWithPlaybackIntent:(id)arg1;	// IMP=0x000000000023a0c2
- (id)insertAtEndOfTracklistWithPlaybackIntent:(id)arg1;	// IMP=0x0000000000239f68
- (id)insertPlaybackIntent:(id)arg1 afterItem:(id)arg2;	// IMP=0x0000000000239d48
- (id)insertAfterPlayingItemWithPlaybackIntent:(id)arg1;	// IMP=0x0000000000239951
