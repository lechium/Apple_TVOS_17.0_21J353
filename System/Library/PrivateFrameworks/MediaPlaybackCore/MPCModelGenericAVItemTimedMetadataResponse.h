...
- (void).cxx_destruct;	// IMP=0x000000000014ad9c
...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x000000000014ace1
- (void)dealloc;	// IMP=0x000000000014ac4c
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x000000000014aaf8
