...
- (void).cxx_destruct;	// IMP=0x00000000002c2e50
...
- (unsigned long long)reportingEventType;	// IMP=0x00000000002c2e1a
- (_Bool)isValidReportingEvent;	// IMP=0x00000000002c2e0c
