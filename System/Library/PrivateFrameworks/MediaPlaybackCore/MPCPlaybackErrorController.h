...
- (void).cxx_destruct;	// IMP=0x00000000001e068b
...
- (_Bool)isLeaseTakenError:(id)arg1;	// IMP=0x00000000001e05c7
- (_Bool)shouldHandleFirstItemFailure:(id)arg1 item:(id)arg2;	// IMP=0x00000000001e051a
- (_Bool)isAssetUnavailableFailure:(id)arg1;	// IMP=0x00000000001e0505
- (_Bool)isUnrecoverableAssetLoadingError:(id)arg1;	// IMP=0x00000000001e048c
- (_Bool)isQueueLoadingFailure:(id)arg1;	// IMP=0x00000000001e0477
- (_Bool)isFirstItemFailure:(id)arg1 item:(id)arg2;	// IMP=0x00000000001e038e
- (_Bool)canHandleFirstItemFailure;	// IMP=0x00000000001e031a
- (void)_notifyObserversForError:(id)arg1 item:(id)arg2;	// IMP=0x00000000001dfc88
- (long long)_resolutionForPlaybackError:(id)arg1 item:(id)arg2;	// IMP=0x00000000001df774
- (void)_playbackFailedWithError:(id)arg1 item:(id)arg2 canResolve:(_Bool)arg3 proposedResolution:(long long)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000001df269
- (void)reportCriticalError:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000001defd3
- (void)resolveError:(id)arg1 forItem:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dddcd
- (void)resetWithReason:(id)arg1;	// IMP=0x00000000001ddd46
@property(nonatomic) _Bool itemsHavePlayed;
- (id)initWithPlaybackEngine:(id)arg1 translator:(id)arg2 externalPlaybackRouter:(id)arg3;	// IMP=0x00000000001ddc50
