...
- (void).cxx_destruct;	// IMP=0x00000000001f77f5
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x00000000001f773e
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x00000000001f75e1
