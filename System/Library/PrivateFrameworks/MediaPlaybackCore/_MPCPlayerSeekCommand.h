...
- (void).cxx_destruct;	// IMP=0x0000000000255edc
...
- (id)_seekCommandWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000255cb8
- (id)changePositionToElapsedInterval:(double)arg1;	// IMP=0x0000000000255be7
- (id)jumpByInterval:(double)arg1;	// IMP=0x0000000000255a53
- (id)endSeek;	// IMP=0x0000000000255a0e
- (id)beginSeekWithDirection:(long long)arg1;	// IMP=0x00000000002559b6
- (id)initWithResponse:(id)arg1 seekSupport:(unsigned long long)arg2;	// IMP=0x0000000000255972
