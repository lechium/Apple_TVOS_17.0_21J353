...
- (void).cxx_destruct;	// IMP=0x00000000002398fe
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x000000000023936d
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x0000000000239356
- (id)clearUpNextItems;	// IMP=0x00000000002391ff
- (id)clear;	// IMP=0x0000000000239025
