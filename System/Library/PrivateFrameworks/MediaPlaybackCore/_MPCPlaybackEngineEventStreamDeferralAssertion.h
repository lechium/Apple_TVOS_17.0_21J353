...
- (void).cxx_destruct;	// IMP=0x0000000000277860
...
- (void)invalidate;	// IMP=0x000000000027761e
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000277593
- (id)initWithEventStream:(id)arg1 type:(long long)arg2 reason:(id)arg3 timeout:(double)arg4;	// IMP=0x00000000002773f2
