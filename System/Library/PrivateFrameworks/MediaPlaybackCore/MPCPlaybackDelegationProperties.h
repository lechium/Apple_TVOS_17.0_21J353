...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a502d
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x00100000002a6a40
- (void).cxx_destruct;	// IMP=0x00000000001a4e94
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x00000000001a4d9b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a4d68
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a4ca0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a4b2e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a4b23
- (id)initWithStoreAccountID:(unsigned long long)arg1 deviceGUID:(id)arg2;	// IMP=0x00000000001a4aa5
- (id)mpc_jsonValue;	// IMP=0x00000000002a432f
