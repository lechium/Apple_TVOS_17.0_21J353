...
+ (id)assetLoadResultWithStoreAssetPlaybackResponse:(id)arg1 assetLoadProperties:(id)arg2 source:(long long)arg3 error:(id *)arg4;	// IMP=0x006000000015efbe
- (void).cxx_destruct;	// IMP=0x0000000000160d8e
...
- (id)descriptionDictionary;	// IMP=0x00000000001602bd
- (id)description;	// IMP=0x0000000000160235
