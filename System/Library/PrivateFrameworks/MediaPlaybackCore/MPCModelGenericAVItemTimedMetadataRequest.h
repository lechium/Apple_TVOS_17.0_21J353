...
+ (id)metadataIdentifiers;	// IMP=0x00400000002faf59
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000002faf51
- (void).cxx_destruct;	// IMP=0x00000000002f8ec9
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f8d88
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002f8cf9
- (id)initWithGenericObject:(id)arg1 timedMetadataGroups:(id)arg2 storeRequestContext:(id)arg3;	// IMP=0x00000000002f8c11
