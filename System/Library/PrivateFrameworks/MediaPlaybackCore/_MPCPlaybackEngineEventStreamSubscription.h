...
- (void).cxx_destruct;	// IMP=0x0000000000273215
...
- (void)_onQueue_flush;	// IMP=0x00000000002729ee
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000272690
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000272679
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000272484
- (void)cancelSubscription;	// IMP=0x000000000027230b
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000002720a5
