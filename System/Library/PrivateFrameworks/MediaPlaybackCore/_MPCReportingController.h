...
- (void).cxx_destruct;	// IMP=0x00000000002c9222
...
- (void)recordLyricsViewEvent:(id)arg1;	// IMP=0x00000000002c91db
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x00000000002c915d
