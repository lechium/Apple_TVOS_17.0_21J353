...
+ (id)currentDeviceDelegateInfo;	// IMP=0x0010000000238d01
- (void).cxx_destruct;	// IMP=0x000000000021d5c4
- (unsigned long long)hash;	// IMP=0x000000000021d485
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000021d288
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021d0e7
- (void)writeTo:(id)arg1;	// IMP=0x000000000021cfa4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000021cf97
- (id)dictionaryRepresentation;	// IMP=0x000000000021cd30
- (id)description;	// IMP=0x000000000021cc81
