...
- (void).cxx_destruct;	// IMP=0x0000000000179cd0
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)genericObjectForRadioStationTrack:(id)arg1 radioStationContainsVideo:(_Bool)arg2 containerUniqueID:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000179700
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x000000000017968d
