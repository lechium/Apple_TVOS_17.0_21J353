...
+ (id)infoWithIdentifier:(id)arg1 account:(id)arg2 supported:(_Bool)arg3 supportedReason:(id)arg4 exportable:(_Bool)arg5 exportableReason:(id)arg6;	// IMP=0x00600000002b59d4
- (void).cxx_destruct;	// IMP=0x00000000002b5996
