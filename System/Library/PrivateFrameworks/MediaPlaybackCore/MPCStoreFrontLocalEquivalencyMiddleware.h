...
- (void).cxx_destruct;	// IMP=0x00000000002c33a6
...
- (id)_stateDumpObject;	// IMP=0x00000000002c3200
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000002c3140
- (id)operationsForRequest:(id)arg1;	// IMP=0x00000000002c30d3
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x00000000002c33d9
