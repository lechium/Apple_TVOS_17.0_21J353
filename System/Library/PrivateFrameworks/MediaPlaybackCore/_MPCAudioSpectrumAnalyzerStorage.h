...
- (void)analyzeAudioData:(void *)arg1 numberFrames:(unsigned int)arg2 observers:(id)arg3;	// IMP=0x00000000000deb83
- (void)analyzeFrequencies:(struct AudioBufferList *)arg1 numberFrames:(unsigned long long)arg2 observers:(id)arg3;	// IMP=0x00000000000deaac
- (void)_freeBuffers;	// IMP=0x00000000000dea70
- (void)_destroyFFTSetup;	// IMP=0x00000000000dea4a
- (void)_prepareBuffers;	// IMP=0x00000000000de9f5
- (void)dealloc;	// IMP=0x00000000000de9a2
- (id)initWithMaximumNumberOfFrames:(long long)arg1 sampleRate:(float)arg2;	// IMP=0x00000000000de903
