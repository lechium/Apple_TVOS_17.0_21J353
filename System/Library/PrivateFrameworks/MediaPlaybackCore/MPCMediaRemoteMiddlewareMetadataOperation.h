...
- (void).cxx_destruct;	// IMP=0x00000000000f70d2
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x00000000000f6a6f
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x00000000000f6572
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x00000000000f654e
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x00000000000f63a8
- (void)execute;	// IMP=0x00000000000f62e1
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f60bb
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f5b29
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x00000000000f5a87
