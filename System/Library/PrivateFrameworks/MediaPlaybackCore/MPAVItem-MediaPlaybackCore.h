...
- (_Bool)_isInContiguousAlbumWith:(id)arg1;	// IMP=0x0020000000262e05
- (_Bool)shouldPerformCrossFadeTransitionWith:(id)arg1;	// IMP=0x0020000000262d35
- (_Bool)shouldPerformGaplessTransitionWith:(id)arg1;	// IMP=0x0020000000262ce7
...
- (void)reset;	// IMP=0x0020000000262b5b
- (void)setCurrentItemTransition:(long long)arg1;	// IMP=0x0020000000262b29
