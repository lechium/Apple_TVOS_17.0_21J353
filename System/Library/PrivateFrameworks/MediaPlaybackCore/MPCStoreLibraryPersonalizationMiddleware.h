...
- (void).cxx_destruct;	// IMP=0x00000000000e2a23
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000000e292d
- (id)operationsForRequest:(id)arg1;	// IMP=0x00000000000e28c0
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x00000000000e2a4b
