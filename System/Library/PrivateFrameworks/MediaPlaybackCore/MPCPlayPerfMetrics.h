...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x00600000002f4d1d
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x00600000002f1ee9
- (void).cxx_destruct;	// IMP=0x00000000002f1471
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000002f13aa
- (void)addAssetSelectionWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x00000000002f0a46
- (void)addSessionActivationTimesWithScopedCursor:(id)arg1;	// IMP=0x00000000002f075b
- (void)addNetworkTimesWithScopedCursor:(id)arg1;	// IMP=0x00000000002f04d0
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x00000000002f03e8
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000002f01f7
- (void)addQueueMetadata:(id)arg1;	// IMP=0x00000000002f0143
- (id)jsonObject;	// IMP=0x00000000002eee11
- (id)description;	// IMP=0x00000000002eec01
- (id)dictionaryRepresentation;	// IMP=0x00000000002eebb9
...
- (id)init;	// IMP=0x00000000002ee0b7
