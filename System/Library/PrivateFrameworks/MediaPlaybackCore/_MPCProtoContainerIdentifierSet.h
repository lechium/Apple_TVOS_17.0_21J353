...
- (void).cxx_destruct;	// IMP=0x0000000000208e94
- (unsigned long long)hash;	// IMP=0x0000000000208d5e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000208b64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002089b5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000208875
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000208868
- (id)dictionaryRepresentation;	// IMP=0x0000000000208630
- (id)description;	// IMP=0x0000000000208581
