...
- (void).cxx_destruct;	// IMP=0x000000000014d5cb
...
- (_Bool)processSample:(id)arg1;	// IMP=0x000000000014d2e5
- (id)initWithSamplingTime:(double)arg1 renderingLimit:(double)arg2;	// IMP=0x000000000014d28b
