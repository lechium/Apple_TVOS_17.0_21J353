...
+ (id)sharedNotifier;	// IMP=0x0040000000001242
- (void).cxx_destruct;	// IMP=0x00000000000019fe
...
- (id)_newRemoteConnection;	// IMP=0x00000000000013df
- (id)_remoteConnection;	// IMP=0x0000000000001297
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x0000000000000f98
