...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x00200000000199dc
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x00100000000195ec
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x0010000000018de1
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x0010000000018b3c
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x00100000000199e4
@end
