...
+ (id)descriptorFromGraphicIconConfiguration:(id)arg1;	// IMP=0x0060000000025b16
+ (id)descriptorFromGraphicSymbolRecipe:(id)arg1;	// IMP=0x00600000000256b4
- (void).cxx_destruct;	// IMP=0x0000000000026010
...
- (id)description;	// IMP=0x0000000000025eee
