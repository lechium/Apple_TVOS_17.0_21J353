...
+ (id)resourceProviderWithTypeIdentifier:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000026ae9
+ (id)resourceProviderWithRecord:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0010000000026a8d
+ (id)defaultAppIconResourceProvider;	// IMP=0x00100000000285b7
+ (id)resourceWithTypeCode:(unsigned int)arg1 options:(unsigned long long)arg2;	// IMP=0x00100000000285af
+ (id)resourceWithTypeIdentifier:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00100000000285a7
+ (id)resourceWithBundleURL:(id)arg1 iconDictionary:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000027988
+ (id)resourceWithRecord:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00100000000277e5
...
- (void)resolveIconResource;	// IMP=0x000000000002753b
- (void)setPlatformWithBundle:(id)arg1;	// IMP=0x000000000002748d
- (_Bool)_findTextResourceWithIconDictionary:(id)arg1;	// IMP=0x0000000000027351
- (_Bool)_findCustomRecipeWithIconDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000027349
- (_Bool)_findBackgroundResourceWithIconDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000270d1
- (_Bool)_findBadgeResourceWithIconDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000026e59
- (_Bool)_isAppleResource;	// IMP=0x0000000000026e51
@property(readonly) IFSymbol *symbol; // @dynamic symbol;
@property(readonly) NSData *validationToken; // @dynamic validationToken;
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000026d2b
- (id)resourceForKey:(id)arg1;	// IMP=0x0000000000026d19
...
- (id)initWithResources:(id)arg1;	// IMP=0x0000000000026c34
- (id)initWithResource:(id)arg1 templateResource:(id)arg2;	// IMP=0x0000000000026b9d
- (id)init;	// IMP=0x0000000000026af1
