...
- (void).cxx_destruct;	// IMP=0x0000000000016c76
...
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000016bc5
- (void)clearResources;	// IMP=0x0000000000016b8c
- (void)addResourcesFromDictionary:(id)arg1;	// IMP=0x0000000000016b23
- (void)setResource:(id)arg1 forName:(id)arg2;	// IMP=0x0000000000016a7f
@property(readonly) id <ISCompositorResourceProvider> resourceProvider;
- (id)initWithRecipe:(id)arg1 resources:(id)arg2;	// IMP=0x00000000000169ba
- (id)init;	// IMP=0x0000000000016945
