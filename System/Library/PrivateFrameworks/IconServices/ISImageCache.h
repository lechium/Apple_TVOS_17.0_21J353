...
- (void).cxx_destruct;	// IMP=0x000000000000e8c9
...
- (id)allImages;	// IMP=0x000000000000e68f
- (id)debugDescription;	// IMP=0x000000000000e450
- (void)setImage:(id)arg1 forDescriptor:(id)arg2;	// IMP=0x000000000000e331
- (id)imageForDescriptor:(id)arg1;	// IMP=0x000000000000e23c
- (id)init;	// IMP=0x000000000000e1df
