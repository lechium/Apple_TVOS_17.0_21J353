...
+ (id)sharedInstance;	// IMP=0x00600000000128f9
- (void).cxx_destruct;	// IMP=0x0000000000012a64
- (id)makeResourceProvider;	// IMP=0x0000000000012a52
@property(readonly) ISResourceProvider *resourceProvider; // @synthesize resourceProvider=_resourceProvider;
- (id)init;	// IMP=0x000000000001294e
