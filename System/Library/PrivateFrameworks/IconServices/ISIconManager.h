...
+ (id)serviceName;	// IMP=0x0060000000031fc3
+ (id)sharedInstance;	// IMP=0x0060000000031f5e
- (void).cxx_destruct;	// IMP=0x000000000003276d
...
- (void)removeObserver:(id)arg1;	// IMP=0x000000000003266a
- (void)addObserver:(id)arg1;	// IMP=0x0000000000032616
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x000000000003243d
- (void)dealloc;	// IMP=0x000000000003240e
- (id)_init;	// IMP=0x000000000003201a
