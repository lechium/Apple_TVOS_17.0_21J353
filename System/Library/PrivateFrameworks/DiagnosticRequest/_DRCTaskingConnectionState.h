...
+ (id)sharedConnectionState;	// IMP=0x006000000000167c
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001d91
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000001bb0
- (id)init;	// IMP=0x0000000000001749
- (void)cleanupState;	// IMP=0x00000000000016d1
