...
+ (id)saveEncoder:(id)arg1 withDescriptor:(id)arg2 player:(id)arg3;	// IMP=0x006000000000dbff
- (void).cxx_destruct;	// IMP=0x000000000000dffa
- (void)restoreEncoder:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000000dec5
