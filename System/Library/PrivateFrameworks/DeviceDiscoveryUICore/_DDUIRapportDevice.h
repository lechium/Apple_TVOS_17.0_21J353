...
- (void).cxx_destruct;	// IMP=0x000000000000bcff
...
- (id)initWithIncomingMessageOptions:(id)arg1;	// IMP=0x000000000000babf
- (id)initWithRPCompanionLinkDevice:(id)arg1;	// IMP=0x000000000000b977
