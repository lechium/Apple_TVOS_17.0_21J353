...
@class AFMultiUserSpeechPackage, AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTTRPCandidate, SMTTRPDetected;
