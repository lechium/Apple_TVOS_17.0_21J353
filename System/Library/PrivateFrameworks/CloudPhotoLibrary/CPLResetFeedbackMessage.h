...
+ (id)feedbackType;	// IMP=0x006000000006a59f
- (void).cxx_destruct;	// IMP=0x000000000006a55d
@property(readonly, nonatomic) NSString *uuid; // @synthesize uuid=_uuid;
@property(readonly, nonatomic) NSString *reason; // @synthesize reason=_reason;
@property(readonly, nonatomic) NSString *resetType; // @synthesize resetType=_resetType;
- (id)serverMessage;	// IMP=0x000000000006a3bd
- (id)initWithResetType:(id)arg1 reason:(id)arg2 uuid:(id)arg3 libraryIdentifier:(id)arg4;	// IMP=0x000000000006a2c5
