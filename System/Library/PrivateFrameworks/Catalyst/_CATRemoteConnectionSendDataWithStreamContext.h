...
- (void).cxx_destruct;	// IMP=0x000000000001ce8e
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001cb8a
...
- (id)initWithStream:(id)arg1 length:(unsigned long long)arg2 bufferSize:(unsigned long long)arg3 userInfo:(id)arg4;	// IMP=0x000000000001c91b
