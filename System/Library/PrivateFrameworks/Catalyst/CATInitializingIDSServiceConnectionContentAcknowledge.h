...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x00100000000429ed
- (void).cxx_destruct;	// IMP=0x0000000000042a63
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x00000000000428b0
