...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000db6a
...
- (id)messageContent;	// IMP=0x000000000000dd35
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000d9cd
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000d945
