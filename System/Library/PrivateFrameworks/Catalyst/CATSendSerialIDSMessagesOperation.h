...
- (void).cxx_destruct;	// IMP=0x00000000000233a2
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x000000000002337b
- (void)sendMessages;	// IMP=0x0000000000022ea9
- (void)main;	// IMP=0x0000000000022e97
- (_Bool)isAsynchronous;	// IMP=0x0000000000022e8f
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x0000000000022cff
