...
- (void).cxx_destruct;	// IMP=0x000000000001fc06
...
- (void)didFailWithError:(id)arg1;	// IMP=0x000000000001fba2
- (void)didSendData;	// IMP=0x000000000001fb8e
- (void)didEncodeData:(id)arg1;	// IMP=0x000000000001fab7
- (void)main;	// IMP=0x000000000001f7eb
- (_Bool)isAsynchronous;	// IMP=0x000000000001f7e3
