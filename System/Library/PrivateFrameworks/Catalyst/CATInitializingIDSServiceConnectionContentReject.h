...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000042758
- (void).cxx_destruct;	// IMP=0x0000000000042888
...
- (id)initWithConnectionIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x00000000000425a7
