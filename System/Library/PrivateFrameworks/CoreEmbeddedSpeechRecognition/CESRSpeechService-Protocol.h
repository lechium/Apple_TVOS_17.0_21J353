...
@class AFSpeechCorrectionInfo, CESRAssetConfig, CESRSpeechParameters, NSArray, NSData, NSDictionary, NSNumber, NSSet, NSString, NSURL;

@protocol CESRSpeechService <NSObject>
- (oneway void)forceCooldownIfIdleWithCompletion:(void (^)(_Bool))arg1;
- (oneway void)preheatSpeechRecognizerWithSilence;
...
- (oneway void)handlePostUpgradeSubscriptions;
...
- (oneway void)addAudioPacket:(NSData *)arg1 packetRecordedTime:(NSNumber *)arg2 packetReadyUpstreamTime:(NSNumber *)arg3;
...
- (oneway void)compileAllAssetsWithCompletion:(void (^)(NSError *))arg1;
- (oneway void)resetCacheWithCompletion:(void (^)(NSError *))arg1;
@end
