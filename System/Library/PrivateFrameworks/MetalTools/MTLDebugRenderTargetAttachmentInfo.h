...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000094367
- (unsigned long long)hash;	// IMP=0x0000000000094359
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x00000000000941d7
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x0000000000094048
