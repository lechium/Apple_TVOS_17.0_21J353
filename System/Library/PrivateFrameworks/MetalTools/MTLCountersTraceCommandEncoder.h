...
- (void)endEncoding;	// IMP=0x000000000003ec9b
- (void)setLabel:(id)arg1;	// IMP=0x000000000003ec75
- (void)popDebugGroup;	// IMP=0x000000000003ec06
- (void)pushDebugGroup:(id)arg1;	// IMP=0x000000000003ebe0
- (void)insertDebugSignpost:(id)arg1;	// IMP=0x000000000003e9de
- (id)init:(struct BinaryBuffer *)arg1 flags:(unsigned long long)arg2;	// IMP=0x000000000003e980
