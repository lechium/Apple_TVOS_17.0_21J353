...
- (id).cxx_construct;	// IMP=0x00000000000283f6
- (void).cxx_destruct;	// IMP=0x0000000000028383
...
- (void)updateScoresWithNewMeasurement:(const void *)arg1;	// IMP=0x00000000000281e0
- (void)updateScoresForTime:(double)arg1;	// IMP=0x0000000000027e6b
- (void)reportScoresToClientAlways:(_Bool)arg1 useUpdatedScoreList:(_Bool)arg2 currentMachContTime:(double)arg3;	// IMP=0x000000000002715b
- (void)heartbeatTimeout:(double)arg1 currentMachContTime:(double)arg2 useUpdatedScores:(_Bool)arg3;	// IMP=0x0000000000027095
- (void)addBluetoothProximityEstimate:(struct NeighborMeasurements)arg1 currentMachContTime:(double)arg2;	// IMP=0x0000000000026fd9
- (void)addRoseSolutions:(id)arg1 currentMachContTime:(double)arg2;	// IMP=0x0000000000026353
- (void)createEstimators;	// IMP=0x00000000000262be
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000000261ae
