...
- (void).cxx_destruct;	// IMP=0x00000000000e6b2e
@property(readonly, nonatomic) GEOComposedRouteLeg *arrivalLeg; // @synthesize arrivalLeg=_arrivalLeg;
@property(readonly, nonatomic) GEOComposedRoute *route; // @synthesize route=_route;
- (id)_arrivalRegionsDepartureConditions;	// IMP=0x00000000000e6937
- (id)_defaultDepartureConditions;	// IMP=0x00000000000e6582
- (void)_initConditions;	// IMP=0x00000000000e634a
- (_Bool)allowDepartureForLocation:(id)arg1;	// IMP=0x00000000000e5d6e
@property(readonly, nonatomic) unsigned long long arrivalWaypointLegIndex;
- (id)initWithRoute:(id)arg1 arrivalLegIndex:(unsigned long long)arg2;	// IMP=0x00000000000e5c58
