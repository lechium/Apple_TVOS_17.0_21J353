...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000df52f
- (void).cxx_destruct;	// IMP=0x00000000000df6c2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000df616
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000df537
- (id)initWithAction:(unsigned long long)arg1 withTitle:(id)arg2 buttonDisplay:(int)arg3;	// IMP=0x00000000000df430
