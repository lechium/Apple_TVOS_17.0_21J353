...
- (void).cxx_destruct;	// IMP=0x0000000000007f8f
...
- (void)_notifyShouldShowChargingInfo;	// IMP=0x0000000000007eec
- (void)_startTimer;	// IMP=0x0000000000007cd7
- (void)updateForArrival;	// IMP=0x0000000000007cc5
- (void)updateForLocation:(id)arg1;	// IMP=0x0000000000007b82
- (void)dealloc;	// IMP=0x0000000000007b40
- (id)initWithTargetBatteryCharge:(id)arg1;	// IMP=0x0000000000007ad0
