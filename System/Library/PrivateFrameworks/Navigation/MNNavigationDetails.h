...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c80d3
- (void).cxx_destruct;	// IMP=0x00000000000cd86a
...
- (id)description;	// IMP=0x00000000000cd21b
@property(readonly, nonatomic) NSMapTable *routeIDLookup;
- (void)_updateRouteIDLookup;	// IMP=0x00000000000ccecc
- (id)removeTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000cccd8
- (id)updateWithTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000ccb1e
- (void)markAnnouncementSpoken:(id)arg1;	// IMP=0x00000000000ccaa3
- (id)routeLookupIDs;	// IMP=0x00000000000cc95d
- (id)routeInfoForRoute:(id)arg1;	// IMP=0x00000000000cc8f7
- (id)routeInfoForID:(id)arg1;	// IMP=0x00000000000cc771
- (void)updateETATrafficForRoute:(id)arg1;	// IMP=0x00000000000cc515
- (void)setAlternateRoutes:(id)arg1;	// IMP=0x00000000000cb2ee
- (void)setCurrentRoute:(id)arg1 withAlternateRoutes:(id)arg2;	// IMP=0x00000000000ca345
- (void)setPreviewRoutes:(id)arg1 withSelectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00000000000c9c5a
...
- (void)copySerializableValuesFrom:(id)arg1;	// IMP=0x00000000000c8e4a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c889b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c80db
- (id)init;	// IMP=0x00000000000c7ff7
