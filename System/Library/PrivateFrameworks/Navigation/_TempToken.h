...
@interface _TempToken : NSObject
{
    ...
    int _waypointIndex;	// 24 = 0x18
    long long _type;	// 32 = 0x20
    NSString *_token;	// 40 = 0x28
    NSArray *_value3s;	// 48 = 0x30
    NSString *_stringValue;	// 56 = 0x38
    NSString *_accessibilityLabel;	// 64 = 0x40
    id <GEOServerFormatTokenPriceValue> _priceValue;	// 72 = 0x48
    id <GEOTransitArtworkDataSource> _artworkValue;	// 80 = 0x50
    NSArray *_timeStampValues;	// 88 = 0x58
    id <GEOServerFormatTokenCountdownValue> _countdownValue;	// 96 = 0x60
    id <GEOServerFormatTokenUrlValue> _urlValue;	// 104 = 0x68
    id <GEOServerFormatTokenManeuverValue> _maneuverValue;	// 112 = 0x70
    id <GEOServerFormatTokenNumberData> _numberData;	// 120 = 0x78
    GEOGenericCombinations *_genericCombinations;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0000000000016a52
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000016676
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000164c4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000160ba
