...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000037ca
- (void).cxx_destruct;	// IMP=0x0000000000003c47
...
- (id)description;	// IMP=0x00000000000039ab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003916
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000037d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003716
- (void)updateWithSessionState:(id)arg1;	// IMP=0x0000000000003560
- (void)updateWithETAUResponse:(id)arg1;	// IMP=0x0000000000003289
- (void)updateWithRoute:(id)arg1;	// IMP=0x0000000000002f25
