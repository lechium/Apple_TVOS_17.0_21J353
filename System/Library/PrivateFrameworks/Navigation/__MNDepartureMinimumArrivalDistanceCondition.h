...
- (void).cxx_destruct;	// IMP=0x00000000000e4ea7
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000e4ad9
- (id)initWithUpdater:(id)arg1 distanceThreshold:(double)arg2;	// IMP=0x00000000000e4a40
