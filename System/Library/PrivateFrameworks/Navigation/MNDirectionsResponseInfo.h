...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000aceb9
- (void).cxx_destruct;	// IMP=0x00000000000ad20b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ad0ac
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000acec1
