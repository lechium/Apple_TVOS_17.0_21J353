...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004d7e1
- (void).cxx_destruct;	// IMP=0x000000000004da47
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004d94a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004d7e9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004d738
