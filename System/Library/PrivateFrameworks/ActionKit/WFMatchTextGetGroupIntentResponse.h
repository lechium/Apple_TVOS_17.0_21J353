...
+ (id)rangeErrorIntentResponseWithRangeErrorGroupNumber:(id)arg1 rangeErrorGroupCount:(id)arg2;	// IMP=0x00600000002e4484
+ (id)noMatchIntentResponseWithNoMatchIndex:(id)arg1;	// IMP=0x00600000002e4416
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x00000000002e437a
