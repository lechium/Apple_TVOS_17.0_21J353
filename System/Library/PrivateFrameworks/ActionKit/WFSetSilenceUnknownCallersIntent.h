...
@interface WFSetSilenceUnknownCallersIntent : INIntent
{
}

- (void)applyWithSettingsClient:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000266fa6
