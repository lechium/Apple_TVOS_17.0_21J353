...
- (id)nextObject;	// IMP=0x00000000000065f3
- (id)allObjects;	// IMP=0x00000000000064fe
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000000006459
