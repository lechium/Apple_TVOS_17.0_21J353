...
@interface FigCaptureSourceCompanionFormat : NSObject
{
    ...
    CDStruct_79c71658 _sensorDimensions;	// 72 = 0x48
}
...
- (id)description;	// IMP=0x000000000004386e
- (void)dealloc;	// IMP=0x000000000004383f
- (id)initWithCompanionFormatDictionary:(id)arg1;	// IMP=0x000000000004354f
