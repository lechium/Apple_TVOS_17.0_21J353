...
- (void)resetChevronState;	// IMP=0x00000000000420d1
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x000000000004209b
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000041e40
- (void)layoutStashChevrons;	// IMP=0x0000000000041aa1
- (void)layoutSubviews;	// IMP=0x00000000000418b3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000041288
