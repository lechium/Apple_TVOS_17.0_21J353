...
- (void).cxx_destruct;	// IMP=0x00000000000312d2
...
- (void)layoutSubviews;	// IMP=0x0000000000030da9
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000030ce1
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000030cc4
- (double)_continuousCornerRadius;	// IMP=0x0000000000030ca7
- (struct CGRect)_mainBodyBounds;	// IMP=0x0000000000030c34
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x00000000000306b5
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x000000000002ff7c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002ff5a
