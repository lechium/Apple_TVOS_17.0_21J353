...
+ (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x001000000003f34b
- (void).cxx_destruct;	// IMP=0x000000000003fa73
...
- (void)accessFileAtURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f5cf
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f414
- (void)getDataFileWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f402
- (id)getFileName;	// IMP=0x000000000003f3b2
- (id)initWithURL:(id)arg1 sandboxExtension:(id)arg2;	// IMP=0x000000000003ee8c
