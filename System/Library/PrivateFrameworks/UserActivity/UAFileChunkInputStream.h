...
- (void).cxx_destruct;	// IMP=0x0000000000035959
...
- (id)streamError;	// IMP=0x0000000000035876
- (unsigned long long)streamStatus;	// IMP=0x0000000000035864
- (void)close;	// IMP=0x000000000003584d
- (void)open;	// IMP=0x000000000003580f
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000035807
- (id)propertyForKey:(id)arg1;	// IMP=0x00000000000357ff
- (_Bool)getBuffer:(char **)arg1 length:(unsigned long long *)arg2;	// IMP=0x00000000000357f7
- (long long)read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x000000000003544d
- (_Bool)hasBytesAvailable;	// IMP=0x00000000000353ed
- (id)initWithFileHandle:(id)arg1 offsetInFile:(id)arg2 size:(long long)arg3;	// IMP=0x000000000003530a
