...
- (void).cxx_destruct;	// IMP=0x000000000009fc4b
...
- (void)dealloc;	// IMP=0x000000000009fbda
- (void)removeManagedReferences;	// IMP=0x000000000009faa4
- (id)description;	// IMP=0x000000000009fa22
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x000000000009f879
