...
- (id)_blurredMaterialImageWithSourceBackgroundImage:(id)arg1 forRect:(struct CGRect)arg2 croppedRect:(struct CGRect)arg3;	// IMP=0x000000000014f7bd
- (void)main;	// IMP=0x000000000014f34c
- (id)init;	// IMP=0x000000000014f2dd
- (id)initWithSourceBackgroundImage:(id)arg1;	// IMP=0x000000000014f26f
