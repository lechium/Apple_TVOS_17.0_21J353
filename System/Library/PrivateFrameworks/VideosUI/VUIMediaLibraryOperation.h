...
- (void).cxx_destruct;	// IMP=0x00000000000c6c9f
...
- (void)cancel;	// IMP=0x00000000000c6bb5
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000c6b14
- (id)init;	// IMP=0x00000000000c6aa5
