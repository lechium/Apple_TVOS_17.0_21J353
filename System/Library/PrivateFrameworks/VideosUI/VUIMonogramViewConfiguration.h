...
- (void).cxx_destruct;	// IMP=0x0000000000110575
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001102a6
- (id)focusedShadowImage;	// IMP=0x00000000001101fa
- (id)unfocusedShadowImage;	// IMP=0x000000000011014e
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x00000000001100f1
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000010fe53
