...
+ (id)_changeSetFromMediaItemEntityTypes:(id)arg1 toMediaItemEntityTypes:(id)arg2;	// IMP=0x00600000000e28d3
- (void).cxx_destruct;	// IMP=0x00000000000e29eb
...
- (void)executionDidBegin;	// IMP=0x00000000000e24e8
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2;	// IMP=0x00000000000e24a4
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000e2435
