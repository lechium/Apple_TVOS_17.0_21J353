...
- (void).cxx_destruct;	// IMP=0x0000000000051274
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000051101
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000004fd66
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000004fd07
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000004fcbe
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000004fc38
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004f8b1
