...
- (void).cxx_destruct;	// IMP=0x000000000006bd64
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x000000000006bbab
- (void)_fetchNext;	// IMP=0x000000000006b7f2
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x000000000006b2ed
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000006b0a7
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000006aeef
- (void)stopAnimation;	// IMP=0x000000000006ae86
- (void)startAnimation;	// IMP=0x000000000006adc5
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x000000000006ace1
- (id)init;	// IMP=0x000000000006ac9f
