...
- (void)updateCurrentUpdateRequestWithAppContext:(id)arg1 documentRef:(id)arg2;	// IMP=0x0000000000004c38
- (void)updateRequestCompletedWithViewElements:(id)arg1 documentRef:(id)arg2;	// IMP=0x0000000000004c32
- (id)initWithContextDictionary:(id)arg1 viewElement:(id)arg2;	// IMP=0x0000000000004b98
- (id)init;	// IMP=0x0000000000004b29
