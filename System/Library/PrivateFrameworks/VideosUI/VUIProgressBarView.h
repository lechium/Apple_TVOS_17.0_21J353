...
- (void).cxx_destruct;	// IMP=0x00000000001cf5af
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x00000000001cf38d
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001cee1f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001cedbd
