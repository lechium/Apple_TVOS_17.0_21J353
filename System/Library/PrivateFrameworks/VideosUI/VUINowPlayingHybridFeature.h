...
- (void).cxx_destruct;	// IMP=0x0000000000027403
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002724d
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000002707c
- (id)init;	// IMP=0x0000000000027058
