...
- (void).cxx_destruct;	// IMP=0x000000000019a143
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x0000000000199f71
- (id)init;	// IMP=0x0000000000199f02
