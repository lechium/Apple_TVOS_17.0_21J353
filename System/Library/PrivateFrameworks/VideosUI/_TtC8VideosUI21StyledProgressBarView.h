...
- (void).cxx_destruct;	// IMP=0x00000000007cf38d
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000007ce66e
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000007ce4a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007ce3f9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000007ce317
