...
- (void).cxx_destruct;	// IMP=0x00000000001d14e3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d141a
- (void)removeUnicodeFromScoreValuesIfNeeded;	// IMP=0x00000000001d11a3
- (id)dictionaryRepresentation;	// IMP=0x00000000001d1185
- (id)jsContextDictionary;	// IMP=0x00000000001d10dd
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001d0e47
