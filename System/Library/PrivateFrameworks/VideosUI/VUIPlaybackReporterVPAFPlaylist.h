...
- (void).cxx_destruct;	// IMP=0x000000000019fdf5
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x000000000019fb8b
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x000000000019f9b8
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000019e9d0
