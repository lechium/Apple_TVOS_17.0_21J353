...
- (void).cxx_destruct;	// IMP=0x000000000024f306
...
- (id)showTitle;	// IMP=0x000000000024f230
- (id)duration;	// IMP=0x000000000024f0f5
- (id)genreTitle;	// IMP=0x000000000024f0a5
- (id)releaseYear;	// IMP=0x000000000024efda
- (id)releaseDate;	// IMP=0x000000000024ef8a
- (id)contentDescription;	// IMP=0x000000000024ef3a
- (id)contentRating;	// IMP=0x000000000024eeea
- (id)seasonCount;	// IMP=0x000000000024ee47
- (id)seasonNumber;	// IMP=0x000000000024ebe9
- (id)title;	// IMP=0x000000000024eb1e
- (id)initWithAMSEntity:(id)arg1 requestedProperties:(id)arg2 mediaEntityType:(id)arg3;	// IMP=0x000000000024e9d6
