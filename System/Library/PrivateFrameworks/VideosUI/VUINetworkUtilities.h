...
+ (id)sharedInstance;	// IMP=0x001000000011d318
- (void).cxx_destruct;	// IMP=0x000000000011d7ba
...
- (void)environmentMonitorDidChangeNetworkReachability:(id)arg1;	// IMP=0x000000000011d78d
- (void)environmentMonitorDidChangeNetworkType:(id)arg1;	// IMP=0x000000000011d77b
- (void)_notifyObservers;	// IMP=0x000000000011d60e
- (void)airplaneModeChanged;	// IMP=0x000000000011d5fc
...
- (void)dealloc;	// IMP=0x000000000011d44e
- (id)init;	// IMP=0x000000000011d36d
