...
+ (id)mediaCatgeoryForType:(unsigned long long)arg1;	// IMP=0x006000000009fc89
- (void).cxx_destruct;	// IMP=0x00000000000a0438
...
- (id)description;	// IMP=0x00000000000a0051
- (id)_initWithType:(unsigned long long)arg1;	// IMP=0x000000000009ffca
- (id)init;	// IMP=0x000000000009ff5b
