...
- (void).cxx_destruct;	// IMP=0x0000000000147529
...
- (void)enumerateValuesForProperties:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000014732c
- (id)_uppDictionary;	// IMP=0x0000000000147143
- (void)markAsUnwatched;	// IMP=0x000000000014704e
- (void)markAsWatched;	// IMP=0x0000000000146f20
