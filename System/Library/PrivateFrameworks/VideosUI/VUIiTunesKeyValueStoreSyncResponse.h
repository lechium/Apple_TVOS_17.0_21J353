...
- (void).cxx_destruct;	// IMP=0x0000000000064cd6
...
- (id)_initWithSuccess:(_Bool)arg1 domainVersion:(id)arg2 peerPutItems:(id)arg3 putOKKeys:(id)arg4 rejectedKeys:(id)arg5;	// IMP=0x0000000000064b86
