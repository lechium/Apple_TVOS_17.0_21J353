...
- (void).cxx_destruct;	// IMP=0x0000000000195c3f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000195b7f
- (id)initWithMainMenuItems:(id)arg1 genreMenuItems:(id)arg2;	// IMP=0x0000000000195ae6
