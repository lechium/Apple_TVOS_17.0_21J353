...
- (void).cxx_destruct;	// IMP=0x0000000000160e1d
...
- (void)_bgImageLoaded;	// IMP=0x0000000000160c16
- (void)_setBackdropViewsWithBgImageViewFrame:(struct CGRect)arg1;	// IMP=0x000000000016066d
- (void)_layoutLabels:(id)arg1 withOrigin:(struct CGPoint)arg2 maxWidth:(double)arg3;	// IMP=0x00000000001602cb
- (double)_subscribeButtonHeight;	// IMP=0x0000000000160158
- (_Bool)_isSubscribed;	// IMP=0x00000000001600f7
- (struct CGSize)_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000015df5a
- (id)preferredFocusEnvironments;	// IMP=0x000000000015de94
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000015ddf4
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000015dd63
@property(readonly, nonatomic) UIImage *backdropImage;
- (void)setVuiBackgroundColor:(id)arg1;	// IMP=0x000000000015d53d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015d429
