...
- (void).cxx_destruct;	// IMP=0x00000000001cd626
...
- (id)description;	// IMP=0x00000000001cd17a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ccfa0
- (unsigned long long)hash;	// IMP=0x00000000001cceb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001cce5d
- (id)init;	// IMP=0x00000000001ccdf9
