...
- (void).cxx_destruct;	// IMP=0x00000000001ced37
...
- (void)_updateForStyleChange;	// IMP=0x00000000001ceaaa
- (id)_maskImageForProgressBar;	// IMP=0x00000000001ce8d7
- (void)_layoutMaterialView;	// IMP=0x00000000001ce7c6
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001ce329
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001cdfdd
- (void)layoutSubviews;	// IMP=0x00000000001cdcaa
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001cd9d5
