...
- (void).cxx_destruct;	// IMP=0x00000000001cfdf1
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x00000000001cfbee
- (void)_stopProgressTimer;	// IMP=0x00000000001cfb9b
- (void)_startProgressTimer;	// IMP=0x00000000001cfa4b
- (void)executionDidBegin;	// IMP=0x00000000001cf712
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000001cf671
- (id)init;	// IMP=0x00000000001cf602
