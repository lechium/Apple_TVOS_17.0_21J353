...
- (void).cxx_destruct;	// IMP=0x000000000014589f
...
- (void)_openPunchoutURL:(id)arg1;	// IMP=0x00000000001453f9
- (id)_addMusicAppMetricsToUrl:(id)arg1;	// IMP=0x0000000000145240
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001450c1
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000144f64
