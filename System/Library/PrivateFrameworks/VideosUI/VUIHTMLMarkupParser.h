...
+ (void)initialize;	// IMP=0x0060000000113832
- (void).cxx_destruct;	// IMP=0x000000000011403a
...
- (void)parse;	// IMP=0x0000000000113ada
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x000000000011399c
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x0000000000113917
- (id)init;	// IMP=0x00000000001138ec
- (id)initWithString:(id)arg1;	// IMP=0x0000000000113879
