...
- (void).cxx_destruct;	// IMP=0x0000000000447874
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000447824
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000447763
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000447507
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000004473b5
