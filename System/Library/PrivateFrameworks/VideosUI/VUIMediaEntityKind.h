...
- (void).cxx_destruct;	// IMP=0x0000000000056e8a
...
- (void)_updatePropertyDescriptorsByName;	// IMP=0x0000000000056c44
- (id)description;	// IMP=0x0000000000056a96
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000056a38
- (id)sortingPropertyDescriptorForName:(id)arg1;	// IMP=0x0000000000056972
- (id)propertyDescriptorForName:(id)arg1;	// IMP=0x00000000000568f8
- (id)initWithMediaEntityClassName:(id)arg1;	// IMP=0x000000000005682b
- (id)init;	// IMP=0x00000000000567bc
