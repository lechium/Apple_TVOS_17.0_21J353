...
- (void).cxx_destruct;	// IMP=0x000000000006d8c8
...
- (unsigned long long)preferedMonogramType;	// IMP=0x000000000006d496
- (unsigned long long)hash;	// IMP=0x000000000006d2d2
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x000000000006d1ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006c412
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006c074
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x000000000006bfc7
- (id)init;	// IMP=0x000000000006bfab
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x000000000006be30
