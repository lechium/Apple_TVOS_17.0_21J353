...
- (void).cxx_destruct;	// IMP=0x00000000001eb9ba
...
- (id)description;	// IMP=0x00000000001eb7ea
- (id)initWithMediaItemEntityTypesChangeSet:(id)arg1 localMediaItemsAvailableDidChange:(_Bool)arg2;	// IMP=0x00000000001eb774
- (id)init;	// IMP=0x00000000001eb705
