...
- (void).cxx_destruct;	// IMP=0x00000000000748d2
...
- (id)_namedRatingWithRatings:(id)arg1;	// IMP=0x000000000007473a
- (id)_fileSizeWithDeviceSizes:(id)arg1;	// IMP=0x00000000000745fc
- (void)_fetchStoreInfoForAdamID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000742cc
- (void)_fetchAppInfo;	// IMP=0x00000000000737c1
- (void)_handleSecondaryLink;	// IMP=0x00000000000737a7
- (void)_handleAppStore;	// IMP=0x0000000000073693
- (void)_handleCancel;	// IMP=0x0000000000073575
- (void)_handleAction;	// IMP=0x000000000007346f
- (void)loadView;	// IMP=0x000000000007318f
- (void)setInstallingState;	// IMP=0x0000000000072f4b
- (void)setPreInstallState;	// IMP=0x0000000000072d73
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000072c56
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000072a95
@property(readonly, nonatomic) UIButton *actionButton;
@property(readonly, nonatomic) VUIAppInstallLockup *lockup;
- (void)setSecondaryLinkTitle:(id)arg1;	// IMP=0x00000000000729e8
- (void)setUpdateTitle:(id)arg1;	// IMP=0x00000000000729d4
- (void)setUpdateMessage:(id)arg1;	// IMP=0x00000000000729c0
- (void)setMessage:(id)arg1;	// IMP=0x00000000000729a3
- (void)setTitle:(id)arg1;	// IMP=0x00000000000728f1
- (id)initWithInstallable:(id)arg1;	// IMP=0x00000000000727e9
- (id)init;	// IMP=0x00000000000727aa
