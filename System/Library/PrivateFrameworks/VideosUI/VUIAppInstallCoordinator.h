...
- (void).cxx_destruct;	// IMP=0x00000000000e5715
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e4e76
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e4d99
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e4cd2
- (unsigned long long)hash;	// IMP=0x00000000000e4c64
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x00000000000e4ba7
