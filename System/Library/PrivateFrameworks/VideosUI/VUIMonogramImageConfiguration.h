...
- (void).cxx_destruct;	// IMP=0x00000000001108ba
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001106bf
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001105c9
