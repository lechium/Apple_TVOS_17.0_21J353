...
@interface VUIMediaEntityAssetControllerState : NSObject
{
    ...
    _Bool _downloadFailedDueToError;	// 13 = 0xd
...
- (void).cxx_destruct;	// IMP=0x0000000000051f9a
...
- (id)description;	// IMP=0x000000000005182f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051542
- (unsigned long long)hash;	// IMP=0x00000000000513e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000051361
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x00000000000512fa
