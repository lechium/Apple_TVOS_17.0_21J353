...
- (void).cxx_destruct;	// IMP=0x000000000019e9c0
...
- (id)initWithPosition:(unsigned long long)arg1 duration:(unsigned long long)arg2 eventData:(id)arg3;	// IMP=0x000000000019e7b3
