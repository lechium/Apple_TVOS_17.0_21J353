...
- (void).cxx_destruct;	// IMP=0x0000000000099699
...
- (id)_resultWithResponses:(id)arg1;	// IMP=0x0000000000099533
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x00000000000992b1
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000990f9
- (void)_startMediaLibraryFetchOperation;	// IMP=0x0000000000098ea6
- (void)cancel;	// IMP=0x0000000000098e28
- (void)executionDidBegin;	// IMP=0x0000000000098e16
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2 requests:(id)arg3;	// IMP=0x0000000000098d4d
