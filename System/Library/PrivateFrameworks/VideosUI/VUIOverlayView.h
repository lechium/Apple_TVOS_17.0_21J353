...
+ (id)overlayViewFromMediaItem:(id)arg1 overlayType:(long long)arg2 existingView:(id)arg3;	// IMP=0x0060000000029a9e
- (void).cxx_destruct;	// IMP=0x000000000002b637
...
- (struct UIEdgeInsets)_overlayPadding;	// IMP=0x000000000002b528
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000002a56f
