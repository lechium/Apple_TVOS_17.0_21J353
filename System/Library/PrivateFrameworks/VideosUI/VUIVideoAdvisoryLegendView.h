...
- (void).cxx_destruct;	// IMP=0x00000000000a9f5d
...
- (void)layoutSubviews;	// IMP=0x00000000000a9500
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a947d
- (struct CGSize)legendDescriptionSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a933b
- (struct CGSize)legendNameSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a91b9
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000000a9134
