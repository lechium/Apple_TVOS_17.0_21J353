...
{
    _Bool _centerAlign;	// 8 = 0x8
    _Bool _wrappingAllowed;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x000000000004c26c
...
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000004a504
- (id)init;	// IMP=0x000000000004a4f0
