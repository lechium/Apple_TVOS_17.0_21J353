...
- (void).cxx_destruct;	// IMP=0x00000000003781ec
@property(nonatomic, readonly) VUILabel *accessibilityTitleLabel;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000378112
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000376e58
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000376d3f
