...
- (void).cxx_destruct;	// IMP=0x000000000011fc83
...
- (long long)_getFallbackVisibilityType;	// IMP=0x000000000011fbda
- (id)_createVisibilityDictionary;	// IMP=0x000000000011fa95
- (id)init;	// IMP=0x000000000011fa14
