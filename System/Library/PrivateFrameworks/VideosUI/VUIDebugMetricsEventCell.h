...
- (void).cxx_destruct;	// IMP=0x000000000001b96b
...
- (void)prepareForReuse;	// IMP=0x000000000001b6b0
- (void)layoutSubviews;	// IMP=0x000000000001af80
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x000000000001aec1
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x000000000001aea4
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x000000000001ae87
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000001a599
