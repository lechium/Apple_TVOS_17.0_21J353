...
+ (_Bool)_viewBackgroundImageNeedsUpdatingWithFrame:(struct CGRect)arg1 currentBackgroundImage:(id)arg2;	// IMP=0x006000000016be78
+ (id)badgeWithLayout:(id)arg1 existing:(id)arg2;	// IMP=0x006000000016a10f
- (void).cxx_destruct;	// IMP=0x000000000016c23a
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000016bf20
- (_Bool)_textBadgeBackgroundImageNeedsUpdating;	// IMP=0x000000000016bdc4
- (void)_cancelPendingOperation;	// IMP=0x000000000016bc6a
- (void)_redrawView:(id)arg1 withDuration:(double)arg2;	// IMP=0x000000000016bb71
- (void)_redrawTextBadgeWithDuration:(double)arg1;	// IMP=0x000000000016bb5c
- (void)_updateBackgroundImagesWithCompletedOperation:(id)arg1;	// IMP=0x000000000016ba44
- (void)_updateBackgroundMaterialImagesWithBackgroundImageSize:(struct CGSize)arg1 performSynchronously:(_Bool)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000016b5d9
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000016b541
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3 operationQueue:(id)arg4;	// IMP=0x000000000016b478
- (void)_setBackgroundImageForMaterialRendering:(id)arg1;	// IMP=0x000000000016b436
- (void)_imageLoaded;	// IMP=0x000000000016b408
- (struct CGSize)_textSize;	// IMP=0x000000000016b256
- (void)_invalidateTimer;	// IMP=0x000000000016b21e
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000016aacf
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000016a9b1
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000016a988
- (void)dealloc;	// IMP=0x000000000016a8a7
- (void)reset;	// IMP=0x000000000016a7b5
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x000000000016a733
- (_Bool)isAccessibilityElement;	// IMP=0x000000000016a4e8
- (id)accessibilityTitle;	// IMP=0x000000000016a4d6
- (id)accessibilityLabel;	// IMP=0x000000000016a4a0
- (void)_configureWithLayout:(id)arg1;	// IMP=0x000000000016a1e4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000016a054
