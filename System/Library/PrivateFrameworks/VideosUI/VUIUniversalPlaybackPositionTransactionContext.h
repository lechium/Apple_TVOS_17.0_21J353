...
- (void).cxx_destruct;	// IMP=0x0000000000146dc1
...
- (id)lastSyncedDomainVersion;	// IMP=0x0000000000146d9f
- (id)initWithClientState:(id)arg1 changes:(id)arg2;	// IMP=0x0000000000146cc2
