...
+ (int)_textBlendMode;	// IMP=0x0060000000184131
+ (id)_textColor:(long long)arg1;	// IMP=0x00600000001840d2
+ (id)scoreboardCLayoutWithInnerMargin:(double)arg1;	// IMP=0x0060000000183ecd
+ (id)scoreboardBLayout;	// IMP=0x0060000000183c97
+ (id)scoreboardALayout;	// IMP=0x0060000000183a53
- (void).cxx_destruct;	// IMP=0x00000000001841d1
