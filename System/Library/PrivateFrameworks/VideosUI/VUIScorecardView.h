...
- (void).cxx_destruct;	// IMP=0x00000000000a4dac
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x00000000000a4476
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000a3c7d
- (void)_calculateColumnSpacing;	// IMP=0x00000000000a39d1
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a3992
- (void)invalidateData;	// IMP=0x00000000000a392a
