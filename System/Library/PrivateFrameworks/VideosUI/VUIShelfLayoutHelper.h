...
@interface VUIShelfLayoutHelper : NSObject
{
    ...
    VUIShelfViewLayout *_shelfViewLayout;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x000000000005ed82
...
- (void)_freeBuffers;	// IMP=0x000000000005ecce
- (void)_compute;	// IMP=0x000000000005e107
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x000000000005e06b
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x000000000005e030
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x000000000005dff5
- (void)dealloc;	// IMP=0x000000000005dfb7
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x000000000005df43
