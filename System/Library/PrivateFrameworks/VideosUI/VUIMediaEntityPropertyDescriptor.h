...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x00000000001898e6
- (void).cxx_destruct;	// IMP=0x0000000000189ae8
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x00000000001899a8
- (id)description;	// IMP=0x000000000018932e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018923f
- (id)init;	// IMP=0x0000000000188efc
