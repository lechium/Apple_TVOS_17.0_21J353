...
@interface VUIMediaShowcasingConfig : NSObject
{
    ...
    float _swipeSpeedFactor;	// 48 = 0x30
    ...
    double _itemHoverDelayDuration;	// 136 = 0x88
    double _hideMuteButtonDelayDuration;	// 144 = 0x90
    double _hidePageIndicatorsDelayDuration;	// 152 = 0x98
}
...
- (id)init;	// IMP=0x000000000011f3fc
