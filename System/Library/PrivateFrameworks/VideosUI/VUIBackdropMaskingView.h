...
@interface VUIBackdropMaskingView : UIView
{
    ...
    VUIBackdropView *_backdropView;	// 16 = 0x10
    double _gradientScale;	// 24 = 0x18
    double _gradientStop;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00000000001b5340
...
- (void)layoutSubviews;	// IMP=0x00000000001b4bdc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b4ab5
