...
- (void).cxx_destruct;	// IMP=0x000000000004cbb8
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004ca64
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000004c9af
