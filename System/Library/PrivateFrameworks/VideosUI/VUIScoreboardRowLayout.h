...
+ (id)_bottomLayoutForIdiom:(long long)arg1;	// IMP=0x006000000018394a
+ (id)_topRowLayoutForIdiom:(long long)arg1;	// IMP=0x00600000001838c3
+ (int)_backgroundColorBlendMode;	// IMP=0x00600000001838b8
+ (id)_backgroundColorForIdiom:(long long)arg1;	// IMP=0x0060000000183889
- (void).cxx_destruct;	// IMP=0x0000000000183a2b
