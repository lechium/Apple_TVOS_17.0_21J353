...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x00600000000575ec
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x006000000005744a
- (void).cxx_destruct;	// IMP=0x0000000000057ac5
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x0000000000057702
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x000000000005721e
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000570e9
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x0000000000056ebd
