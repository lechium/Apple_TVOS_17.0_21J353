...
- (void).cxx_destruct;	// IMP=0x00000000001137dc
...
- (void)_updateDescriptionTextViewProperties:(_Bool)arg1;	// IMP=0x00000000001136b8
- (void)layoutSubviews;	// IMP=0x0000000000112f8d
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000112f0f
