...
- (void).cxx_destruct;	// IMP=0x00000000001e480d
...
- (void)_layoutSubviews;	// IMP=0x00000000001e3296
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001e3235
- (void)applyAlphaToFadeableView:(double)arg1;	// IMP=0x00000000001e2ff4
