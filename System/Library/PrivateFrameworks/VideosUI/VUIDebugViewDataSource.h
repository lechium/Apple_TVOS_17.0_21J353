...
- (void).cxx_destruct;	// IMP=0x00000000000adb76
...
- (id)_createMetricsDataSource;	// IMP=0x00000000000ad88d
- (id)_createDefaultsDataSource;	// IMP=0x00000000000ad4fa
- (id)init;	// IMP=0x00000000000ad468
