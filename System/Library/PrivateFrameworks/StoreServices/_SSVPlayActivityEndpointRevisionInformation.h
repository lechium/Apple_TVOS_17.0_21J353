...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000012790f
- (void).cxx_destruct;	// IMP=0x000000000012795d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012789b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000127816
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001276c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000127626
- (unsigned long long)hash;	// IMP=0x00000000001275e3
