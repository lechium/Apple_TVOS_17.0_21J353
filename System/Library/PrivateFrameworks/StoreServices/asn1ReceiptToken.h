...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000016e32f
...
- (id)description;	// IMP=0x000000000016e503
- (void)dealloc;	// IMP=0x000000000016e2f4
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000016e28b
