...
+ (id)signingIdentifierFromSelf;	// IMP=0x006000000002b91e
+ (_Bool)launchdManaged;	// IMP=0x006000000002b8e6
...
- (id)initWithRestorationIdentifier:(id)arg1;	// IMP=0x000000000002b957
