...
- (void).cxx_destruct;	// IMP=0x0000000000021629
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x00000000000211d9
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000002110d
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000020f32
- (id)init;	// IMP=0x0000000000020ed5
