...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x006000000019af30
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x006000000019a760
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x006000000019a600
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0060000000199f10
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0060000000199620
- (id).cxx_construct;	// IMP=0x000000000019b9a0
- (void).cxx_destruct;	// IMP=0x000000000019b7c0
- (id)init;	// IMP=0x000000000019b080
