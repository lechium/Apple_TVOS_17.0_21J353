...
- (void).cxx_destruct;	// IMP=0x00000000001d4bb0
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001d3960
- (id)initWithShouldAddAlternatives:(_Bool)arg1;	// IMP=0x00000000001d37c0
