...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 writingOrientation:(long long)arg3;	// IMP=0x00600000000d58f0
- (void).cxx_destruct;	// IMP=0x00000000000d5d80
...
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3 writingOrientation:(long long)arg4;	// IMP=0x00000000000d5120
