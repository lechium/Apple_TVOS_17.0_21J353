...
- (id).cxx_construct;	// IMP=0x00000000001e7aa0
- (void).cxx_destruct;	// IMP=0x00000000001e7a80
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001e6d70
- (id)init;	// IMP=0x00000000001e6ba0
