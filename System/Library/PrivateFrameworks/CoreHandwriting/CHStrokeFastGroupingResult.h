...
- (id).cxx_construct;	// IMP=0x00000000001c5170
- (void).cxx_destruct;	// IMP=0x00000000001c50e0
@property(readonly, nonatomic) vector_4ea6921b fastGroupingClusters; // @synthesize fastGroupingClusters=_fastGroupingClusters;
- (id)initWithFastGroupingClusters:(const void *)arg1 clusteredStrokes:(id)arg2 strokeProvider:(id)arg3 strategyIdentifier:(id)arg4 clutterFilter:(id)arg5;	// IMP=0x00000000001c4610
