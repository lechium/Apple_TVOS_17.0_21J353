...
- (void).cxx_destruct;	// IMP=0x00000000000c0a90
...
- (_Bool)isValidForLocale:(id)arg1;	// IMP=0x00000000000c0830
- (_Bool)meetsContextRequirementWithLeftContext:(id)arg1 rightContext:(id)arg2;	// IMP=0x00000000000c06a0
- (id)initWithConfusion:(id)arg1 correction:(id)arg2 locales:(id)arg3 leftContext:(id)arg4 rightContext:(id)arg5 requiresLexiconMatch:(_Bool)arg6 shouldPreserveOriginal:(_Bool)arg7;	// IMP=0x00000000000c0580
