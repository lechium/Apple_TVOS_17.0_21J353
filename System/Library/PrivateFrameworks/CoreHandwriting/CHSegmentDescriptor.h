...
+ (long long)indexForSegmentID:(id)arg1 fromSegments:(id)arg2;	// IMP=0x0060000000067a80
+ (struct CGRect)boundingBoxFromSegmentID:(long long)arg1 toSegmentID:(long long)arg2 withSegments:(id)arg3 withSourceDrawing:(id)arg4;	// IMP=0x0060000000067920
+ (id)generateSegmentsFromDrawing:(id)arg1;	// IMP=0x0060000000067720
- (void).cxx_destruct;	// IMP=0x0000000000067c40
...
- (_Bool)isSinglePointSegment;	// IMP=0x0000000000067680
- (long long)strokeCount;	// IMP=0x0000000000067630
- (id)strokeIndexSet;	// IMP=0x0000000000067570
- (id)initWithSegmentID:(id)arg1 startCutPoint:(id)arg2 endCutPoint:(id)arg3 referenceDrawing:(id)arg4;	// IMP=0x0000000000067360
