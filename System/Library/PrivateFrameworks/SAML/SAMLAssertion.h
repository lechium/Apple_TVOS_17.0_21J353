...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b7c7
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c10e
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bf68
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bf17
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000be03
