...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0060000000023762
- (void).cxx_destruct;	// IMP=0x0000000000023b27
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001f432
- (_Bool)resolveOwnershipWithExtraField:(CDStruct_388cbe1a *)arg1 outUID:(unsigned int *)arg2 outGID:(unsigned int *)arg3;	// IMP=0x000000000001f2c7
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001eedb
- (id)finishStream;	// IMP=0x000000000001edad
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001ed98
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001eac5
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001e803
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001e16a
- (id)serializeState;	// IMP=0x000000000001d3f5
- (void)markResumptionPoint;	// IMP=0x000000000001d3ef
- (void)clearSavedState;	// IMP=0x000000000001d32c
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001d01a
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001cfaf
- (id)init;	// IMP=0x000000000001cf8c
