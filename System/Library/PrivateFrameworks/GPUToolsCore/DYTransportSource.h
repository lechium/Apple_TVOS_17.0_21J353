...
- (void)_dispatch:(id)arg1;	// IMP=0x0000000000017c92
- (void)_cancel;	// IMP=0x0000000000017bf3
- (void)_callCancellationHandler;	// IMP=0x0000000000017bb3
- (void)_register;	// IMP=0x0000000000017b16
- (void)_callRegistrationHandler;	// IMP=0x0000000000017ae1
...
- (void)cancel;	// IMP=0x000000000001779c
- (void)suspend;	// IMP=0x000000000001778e
- (void)resume;	// IMP=0x0000000000017780
- (void)dealloc;	// IMP=0x00000000000176f8
- (id)_initWithQueue:(id)arg1 transport:(id)arg2;	// IMP=0x000000000001752f
- (id)init;	// IMP=0x0000000000017504
