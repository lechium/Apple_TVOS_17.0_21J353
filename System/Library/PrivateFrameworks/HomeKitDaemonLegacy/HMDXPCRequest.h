...
- (void).cxx_destruct;	// IMP=0x0000000000305d68
...
- (id)initWithMessageName:(id)arg1 qualityOfService:(long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000305c27
