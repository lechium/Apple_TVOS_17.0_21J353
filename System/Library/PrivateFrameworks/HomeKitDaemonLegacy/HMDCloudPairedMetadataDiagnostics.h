...
+ (id)logCategory;	// IMP=0x00600000007716fb
- (void).cxx_destruct;	// IMP=0x00000000007716b9
...
- (id)attributeDescriptions;	// IMP=0x00000000007712af
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000007711b6
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000770dc5
