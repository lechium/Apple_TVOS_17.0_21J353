...
+ (id)errorWithSQLite3Statement:(struct sqlite3_stmt *)arg1;	// IMP=0x002000000074f4c8
+ (id)errorWithSQLite3Context:(struct sqlite3 *)arg1 statement:(const char *)arg2;	// IMP=0x002000000074f33b
+ (id)errorWithSQLite3Context:(struct sqlite3 *)arg1;	// IMP=0x002000000074f1ed
+ (id)hmd_HTTPMessageTransportErrorWithCode:(long long)arg1;	// IMP=0x00200000009906db
...
- (id)hmd_actualCKErrorFromCKErrorPartialFailure:(id)arg1;	// IMP=0x001000000040a4e8
@end
