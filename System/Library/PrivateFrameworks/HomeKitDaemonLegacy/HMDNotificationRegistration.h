...
+ (id)logCategory;	// IMP=0x0010000000a922c2
- (void).cxx_destruct;	// IMP=0x0000000000a92293
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000a91fc8
- (id)logIdentifier;	// IMP=0x0000000000a91ef3
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000a91e5b
