...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002a52e6
- (void).cxx_destruct;	// IMP=0x00000000002a5293
...
- (id)attributeDescriptions;	// IMP=0x00000000002a5069
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002a4f7b
