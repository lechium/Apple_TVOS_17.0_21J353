...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x00000000007f6e29
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)initWithUser:(id)arg1 userDataController:(id)arg2 homeUUID:(id)arg3;	// IMP=0x00000000007f6a6d
- (id)initWithUser:(id)arg1;	// IMP=0x00000000007f69b0
