...
+ (id)logCategory;	// IMP=0x0010000000b52d65
+ (_Bool)isSupportedEvent:(id)arg1;	// IMP=0x0010000000b52ce3
+ (id)supportedEventClasses;	// IMP=0x0010000000b52cb3
- (void).cxx_destruct;	// IMP=0x0000000000b52c67
...
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b52b5a
- (void)stop;	// IMP=0x0000000000b52a5a
- (void)start;	// IMP=0x0000000000b5292d
- (id)initWithLogEventDispatcher:(id)arg1;	// IMP=0x0000000000b527b1
- (_Bool)shouldSubmitEvent:(id)arg1;	// IMP=0x0000000000b52763
