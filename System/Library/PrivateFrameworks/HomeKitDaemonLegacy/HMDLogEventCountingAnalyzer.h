...
- (void).cxx_destruct;	// IMP=0x000000000030e414
...
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x000000000030e296
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x000000000030e1db
- (void)runDailyTask;	// IMP=0x000000000030e16a
- (void)incrementDailyCountersForEventName:(id)arg1;	// IMP=0x000000000030e01e
- (void)incrementPeriodicCountersForEventName:(id)arg1;	// IMP=0x000000000030ded1
- (id)periodicSnapshotAtCurrentTickSeconds:(unsigned long long)arg1;	// IMP=0x000000000030de23
- (void)didReceiveEventFromDispatcher:(id)arg1 withCurrentTickSeconds:(unsigned long long)arg2;	// IMP=0x000000000030dcf5
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000030dc61
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5 loggingPeriodicitySeconds:(unsigned long long)arg6 tickSecondsProviderBlock:(CDUnknownBlockType)arg7 periodicCountersLoggingBlock:(CDUnknownBlockType)arg8;	// IMP=0x000000000030da4a
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5;	// IMP=0x000000000030d9a3
