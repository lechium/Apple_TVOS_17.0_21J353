...
- (void).cxx_destruct;	// IMP=0x0000000000920820
...
- (id)attributeDescriptions;	// IMP=0x000000000092063d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000920632
- (id)operationByMergingWithOperation:(id)arg1;	// IMP=0x00000000009204fb
- (id)initWithDeviceCredentialKey:(id)arg1 accessories:(id)arg2 user:(id)arg3;	// IMP=0x00000000009202d0
- (id)initWithDeviceCredentialKey:(id)arg1 accessoriesUUIDs:(id)arg2 user:(id)arg3;	// IMP=0x00000000009201e6
