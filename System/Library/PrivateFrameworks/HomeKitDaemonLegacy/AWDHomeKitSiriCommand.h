...
- (void).cxx_destruct;	// IMP=0x00000000005bc855
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005bc648
- (unsigned long long)hash;	// IMP=0x00000000005bc4f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005bc2c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005bc119
- (void)copyTo:(id)arg1;	// IMP=0x00000000005bbfb2
- (void)writeTo:(id)arg1;	// IMP=0x00000000005bbe14
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005bb714
- (id)dictionaryRepresentation;	// IMP=0x00000000005bb300
- (id)description;	// IMP=0x00000000005bb251
...
- (int)StringAsOutcome:(id)arg1;	// IMP=0x00000000005baeb4
- (id)outcomeAsString:(int)arg1;	// IMP=0x00000000005bae6c
@property(nonatomic) _Bool hasOutcome;
@property(nonatomic) int outcome; // @synthesize outcome=_outcome;
@property(nonatomic) _Bool hasDuration;
- (int)StringAsActionType:(id)arg1;	// IMP=0x00000000005bac7a
- (id)actionTypeAsString:(int)arg1;	// IMP=0x00000000005bac32
