...
+ (id)logCategory;	// IMP=0x00100000005d516d
- (void).cxx_destruct;	// IMP=0x00000000005d511e
...
- (id)callerVersionForMessage:(id)arg1;	// IMP=0x00000000005d4f05
- (unsigned long long)dataSourceCallerPrivilegeWithMessage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005d4d1b
- (void)handleAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x00000000005d4654
- (id)siriAvailableLanguagesSetting;	// IMP=0x00000000005d45c7
- (void)handleAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x00000000005d3e19
- (id)initWithHomeUUID:(id)arg1 languageValuesDataProvider:(id)arg2;	// IMP=0x00000000005d3d77
