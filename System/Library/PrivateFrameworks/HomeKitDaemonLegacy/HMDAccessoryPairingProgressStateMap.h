...
- (void).cxx_destruct;	// IMP=0x0000000000512a84
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x0000000000512961
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x000000000051232f
- (id)initWithDate:(id)arg1;	// IMP=0x00000000005122aa
