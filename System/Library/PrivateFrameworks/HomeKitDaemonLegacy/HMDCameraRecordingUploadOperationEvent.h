...
- (void).cxx_destruct;	// IMP=0x000000000090319d
...
- (id)attributeDescriptions;	// IMP=0x0000000000902d66
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x0000000000902cb3
