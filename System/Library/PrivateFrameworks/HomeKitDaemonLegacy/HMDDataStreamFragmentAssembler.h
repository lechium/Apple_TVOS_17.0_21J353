...
- (void).cxx_destruct;	// IMP=0x0000000000209227
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000208bd3
- (id)attributeDescriptions;	// IMP=0x000000000020895e
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x0000000000208760
