...
- (void).cxx_destruct;	// IMP=0x0000000000355ca9
...
- (id)description;	// IMP=0x0000000000355b76
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x0000000000355a9b
