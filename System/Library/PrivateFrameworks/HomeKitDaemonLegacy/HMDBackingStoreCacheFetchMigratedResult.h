...
- (void).cxx_destruct;	// IMP=0x00000000001fedc3
...
- (id)mainReturningError;	// IMP=0x00000000001fe7a5
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x00000000001fe6ca
