...
- (void).cxx_destruct;	// IMP=0x00000000006cc913
...
- (id)initWithStagedDestinationIdentifier:(id)arg1 isTriggeredOnControllerDevice:(id)arg2 userPrivilege:(id)arg3;	// IMP=0x00000000006cc6ee
