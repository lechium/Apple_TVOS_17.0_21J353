...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x00100000004adae4
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004adadc
+ (void)translateCapabilities:(id)arg1;	// IMP=0x00100000004ad3c5
- (void).cxx_destruct;	// IMP=0x00000000004ad159
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004acf64
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004acc5a
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x00000000004ac946
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x00000000004ac200
- (id)_supportedResolutionsWithOverrides;	// IMP=0x00000000004abd33
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x00000000004aba67
- (id)description;	// IMP=0x00000000004ab939
