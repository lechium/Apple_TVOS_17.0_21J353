...
- (void).cxx_destruct;	// IMP=0x0000000000ad72d4
...
- (id)attributeDescriptions;	// IMP=0x0000000000ad70dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ad70d1
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000ad703b
