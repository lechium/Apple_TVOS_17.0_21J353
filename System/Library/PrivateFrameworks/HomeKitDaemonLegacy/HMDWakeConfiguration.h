...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000b1b0b0
- (void).cxx_destruct;	// IMP=0x0000000000b19fd0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b19bf0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b19b38
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000b1968c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000b192aa
- (id)initWithReserved:(id)arg1 custom1:(id)arg2 custom2:(id)arg3;	// IMP=0x0000000000b191f2
- (id)init;	// IMP=0x0000000000b191c3
