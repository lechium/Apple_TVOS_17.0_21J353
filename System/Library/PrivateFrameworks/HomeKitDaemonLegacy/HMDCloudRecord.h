...
+ (id)logCategory;	// IMP=0x006000000090616d
+ (id)shortDescription;	// IMP=0x006000000090615b
- (void).cxx_destruct;	// IMP=0x00000000009060e8
...
- (void)clearData;	// IMP=0x0000000000905f2a
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x0000000000905485
- (id)extractObjectChange;	// IMP=0x000000000090499c
- (id)description;	// IMP=0x0000000000904930
- (id)shortDescription;	// IMP=0x0000000000904844
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x00000000009046ec
- (id)init;	// IMP=0x0000000000904644
