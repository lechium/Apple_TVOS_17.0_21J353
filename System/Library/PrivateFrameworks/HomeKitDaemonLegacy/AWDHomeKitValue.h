...
- (void).cxx_destruct;	// IMP=0x0000000000682beb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000682a7d
- (unsigned long long)hash;	// IMP=0x0000000000682804
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006826a3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000068257f
- (void)copyTo:(id)arg1;	// IMP=0x00000000006824a0
- (void)writeTo:(id)arg1;	// IMP=0x00000000006823ae
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006823a1
- (id)dictionaryRepresentation;	// IMP=0x00000000006821a9
- (id)description;	// IMP=0x00000000006820fa
