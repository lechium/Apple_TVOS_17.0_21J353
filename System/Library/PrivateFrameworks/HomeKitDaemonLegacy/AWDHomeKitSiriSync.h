...
+ (Class)reasonsType;	// IMP=0x0010000000ad41aa
- (void).cxx_destruct;	// IMP=0x0000000000ad4197
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000ad3f16
- (unsigned long long)hash;	// IMP=0x0000000000ad3e3f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ad3ce3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ad3a68
- (void)copyTo:(id)arg1;	// IMP=0x0000000000ad3914
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ad3724
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ad32cf
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad30ad
- (id)description;	// IMP=0x0000000000ad2ffe
...
- (id)reasonsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000ad2f02
- (unsigned long long)reasonsCount;	// IMP=0x0000000000ad2ee5
- (void)addReasons:(id)arg1;	// IMP=0x0000000000ad2e7b
- (void)clearReasons;	// IMP=0x0000000000ad2e5e
