...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000753ac9
+ (id)logCategory;	// IMP=0x0010000000753a99
+ (id)shortDescription;	// IMP=0x0010000000753a87
+ (id)otherAccessoryCategory;	// IMP=0x001000000075398c
- (void).cxx_destruct;	// IMP=0x000000000075375d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000753226
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007530b1
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)messageDestination;	// IMP=0x0000000000753036
- (id)logIdentifier;	// IMP=0x0000000000753024
- (void)associateWithAccessoryAdvertisement:(id)arg1;	// IMP=0x0000000000752f8a
- (void)identifyWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000752e68
- (void)_handleIdentify:(id)arg1;	// IMP=0x0000000000752ce6
@property(readonly, getter=isReachable) _Bool reachable;
- (void)updateCategoryWithCategoryIdentifier:(id)arg1;	// IMP=0x0000000000752ba4
@property(retain) HMAccessoryCategory *category; // @synthesize category=_category;
@property(copy, nonatomic) NSString *name; // @synthesize name=_name;
- (void)_registerForMessages;	// IMP=0x00000000007526a6
- (id)dumpDescription;	// IMP=0x0000000000752575
@property(readonly, copy) NSString *description;
@property(readonly, copy) NSString *debugDescription;
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x000000000075222a
- (id)shortDescription;	// IMP=0x000000000075218f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007520b4
...
- (void)dealloc;	// IMP=0x0000000000751f4a
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 messageDispatcher:(id)arg4;	// IMP=0x0000000000751db1
- (id)init;	// IMP=0x0000000000751d09
