...
+ (_Bool)supportsCloudSettings;	// IMP=0x00100000006d7b20
+ (id)sharedSettings;	// IMP=0x00100000006d7af0
+ (id)logCategory;	// IMP=0x00100000001a2f87
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006d7a81
- (void)synchronize;	// IMP=0x00000000006d7a7b
...
- (id)attributeDescriptions;	// IMP=0x00000000001a2d91
