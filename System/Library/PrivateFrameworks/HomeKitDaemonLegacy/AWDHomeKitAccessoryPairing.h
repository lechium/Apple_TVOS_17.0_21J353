...
- (void).cxx_destruct;	// IMP=0x00000000007ba133
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007b9c28
- (unsigned long long)hash;	// IMP=0x00000000007b98b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007b9310
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007b8f7d
- (void)copyTo:(id)arg1;	// IMP=0x00000000007b8c4d
- (void)writeTo:(id)arg1;	// IMP=0x00000000007b88d0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007b7a17
- (id)dictionaryRepresentation;	// IMP=0x00000000007b7129
- (id)description;	// IMP=0x00000000007b707a
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000007b6c05
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000007b6bbd
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000007b6a21
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000007b69d9
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000007b6822
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000007b67da
