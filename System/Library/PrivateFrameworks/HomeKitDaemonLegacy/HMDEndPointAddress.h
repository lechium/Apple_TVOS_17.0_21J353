...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000071350
- (void).cxx_destruct;	// IMP=0x000000000007130e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000711c3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070f33
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000070da0
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000070b63
@property(readonly, copy) NSData *tlvData;
- (_Bool)compatibleWithRemoteEndPoint:(id)arg1;	// IMP=0x0000000000070938
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x000000000007085f
