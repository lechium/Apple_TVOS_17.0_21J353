...
- (void).cxx_destruct;	// IMP=0x0000000000b66c17
...
- (id)attributeDescriptions;	// IMP=0x0000000000b66ae5
- (id)initWithSession:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000b66a4c
