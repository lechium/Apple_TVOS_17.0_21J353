...
- (void).cxx_destruct;	// IMP=0x00000000002e7502
...
- (id)attributeDescriptions;	// IMP=0x00000000002e7280
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x00000000002e71ca
