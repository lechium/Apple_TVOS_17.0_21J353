...
- (void).cxx_destruct;	// IMP=0x0000000000b6bb08
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b6aa5f
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000b6a967
