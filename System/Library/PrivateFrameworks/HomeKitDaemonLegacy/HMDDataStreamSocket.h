...
+ (id)logCategory;	// IMP=0x00100000004ab26b
- (void).cxx_destruct;	// IMP=0x00000000004aafb9
...
- (void)closeInitiated;	// IMP=0x00000000004aaf24
- (void)handleIncomingData:(id)arg1;	// IMP=0x00000000004aae59
- (void)closeWithError:(id)arg1;	// IMP=0x00000000004aad70
- (id)readData;	// IMP=0x00000000004aad15
- (void)_writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004aac37
- (void)writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004aab8d
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004aaaf8
- (void)close;	// IMP=0x00000000004aaae4
...
- (id)initWithStreamProtocol:(id)arg1 applicationProtocolName:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000004aa863
