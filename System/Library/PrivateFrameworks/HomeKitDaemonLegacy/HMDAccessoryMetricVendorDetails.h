...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00400000004d282a
- (void).cxx_destruct;	// IMP=0x00000000004d26a8
...
- (id)attributeDescriptions;	// IMP=0x00000000004d2412
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x00000000004d22cc
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000004d1b87
