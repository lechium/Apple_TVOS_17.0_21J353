...
+ (id)properties;	// IMP=0x0060000000a9a287
+ (id)schemaHashRoot;	// IMP=0x0060000000a9a27a
- (id)dependentUUIDs;	// IMP=0x0000000000a95336
- (id)validate;	// IMP=0x0000000000a9524b
- (_Bool)validForStorage;	// IMP=0x0000000000a95120
- (void)loadModelWithActionInformation:(id)arg1;	// IMP=0x0000000000a94f4e
