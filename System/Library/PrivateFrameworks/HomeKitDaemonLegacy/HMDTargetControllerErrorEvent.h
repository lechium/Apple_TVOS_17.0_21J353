...
+ (id)errorEventWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0060000000ac2e99
- (void).cxx_destruct;	// IMP=0x0000000000ac2e88
...
- (id)initWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0000000000ac2de5
