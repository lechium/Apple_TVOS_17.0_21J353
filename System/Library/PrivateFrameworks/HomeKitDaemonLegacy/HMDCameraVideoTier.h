...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000920178
- (void).cxx_destruct;	// IMP=0x0000000000920114
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000091ff5f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000091fdc8
- (unsigned long long)hash;	// IMP=0x000000000091fd84
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000091fca8
- (id)description;	// IMP=0x000000000091fb90
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x000000000091fa73
