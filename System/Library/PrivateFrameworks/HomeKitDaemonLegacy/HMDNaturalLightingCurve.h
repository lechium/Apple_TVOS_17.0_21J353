...
+ (id)logCategory;	// IMP=0x00100000004eead7
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x00100000004eeab4
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004eeaac
- (void).cxx_destruct;	// IMP=0x00000000004ee96a
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x00000000004edda3
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x00000000004edbdb
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x00000000004ed30e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004ed1df
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004ed1d4
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004ece91
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004eca57
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004ec082
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x00000000004ebb11
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x00000000004eba43
