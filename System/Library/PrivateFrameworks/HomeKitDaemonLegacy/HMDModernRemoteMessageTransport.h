...
+ (id)logCategory;	// IMP=0x00100000005c5c93
+ (id)timeToLiveHeaderKey;	// IMP=0x00100000005c5c86
+ (id)requestStartTimeHeaderKey;	// IMP=0x00100000005c5c79
- (void).cxx_destruct;	// IMP=0x00000000005c0b3b
...
- (void)configureWithHomeMembershipVerifier:(id)arg1;	// IMP=0x00000000005c09ba
- (void)transport:(id)arg1 idsIdentifier:(id)arg2 didAppearReachable:(_Bool)arg3;	// IMP=0x00000000005c0943
- (void)messageTransport:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00000000005c0865
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000005c05e0
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x00000000005c043f
- (id)start;	// IMP=0x00000000005c01fa
- (long long)qualityOfService;	// IMP=0x00000000005c01ef
- (_Bool)isSecure;	// IMP=0x00000000005c01e7
- (id)initWithAccountRegistry:(id)arg1 rapportTransport:(id)arg2 idsTransport:(id)arg3 contextManager:(id)arg4 systemDateProvider:(id)arg5 idsDateProvider:(id)arg6 timerProvider:(id)arg7;	// IMP=0x00000000005bffa1
- (id)initWithAccountRegistry:(id)arg1;	// IMP=0x00000000005bfe7a
