...
+ (id)logCategory;	// IMP=0x0010000000642a8f
- (void).cxx_destruct;	// IMP=0x0000000000642a1a
...
- (void)runHomeutilTask;	// IMP=0x0000000000642917
- (void)runDailyTask;	// IMP=0x000000000064284d
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 dailyScheduler:(id)arg3 logEventSubmitter:(id)arg4 dateProvider:(id)arg5 requestCountProvider:(id)arg6 logEventFactories:(id)arg7;	// IMP=0x000000000064258d
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 accessoryDetailsManager:(id)arg3 dailyScheduler:(id)arg4 logEventSubmitter:(id)arg5 dateProvider:(id)arg6 activityContributors:(id)arg7;	// IMP=0x00000000006421bb
