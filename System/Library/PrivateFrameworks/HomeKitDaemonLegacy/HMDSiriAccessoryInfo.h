...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x00000000001a3085
- (void).cxx_destruct;	// IMP=0x00000000001a3077
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000001a2fee
