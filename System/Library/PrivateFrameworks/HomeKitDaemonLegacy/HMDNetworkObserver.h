...
+ (id)supportedEventClasses;	// IMP=0x0010000000b5e9de
- (void).cxx_destruct;	// IMP=0x0000000000b5e5f0
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b5e41d
- (void)checkNetworkChange;	// IMP=0x0000000000b5df52
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000b5de97
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000b5dddc
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000b5d890
- (void)runDailyTask;	// IMP=0x0000000000b5d380
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b5d2b7
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000b5d0b8
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000b5ce3c
- (void)_clearNonPersistentCounters;	// IMP=0x0000000000b5cd79
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000b5cc43
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000b5cb63
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x0000000000b5c9ae
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000b5c8c7
- (void)stop;	// IMP=0x0000000000b5c748
- (void)start;	// IMP=0x0000000000b5c51c
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x0000000000b5c324
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000b5c1bc
