...
- (void).cxx_destruct;	// IMP=0x000000000069085d
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x000000000069073f
- (_Bool)isComplete;	// IMP=0x00000000006906de
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000690632
