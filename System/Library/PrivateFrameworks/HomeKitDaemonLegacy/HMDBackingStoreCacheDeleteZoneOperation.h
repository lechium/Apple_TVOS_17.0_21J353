...
- (void).cxx_destruct;	// IMP=0x00000000001f9a90
...
- (id)mainReturningError;	// IMP=0x00000000001f8fde
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001f8f53
