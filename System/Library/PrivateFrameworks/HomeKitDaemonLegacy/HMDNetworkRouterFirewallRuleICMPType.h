...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x00600000007ed39a
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x00600000007ed19a
- (void).cxx_destruct;	// IMP=0x00000000007ed172
...
- (id)description;	// IMP=0x00000000007ecffc
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (unsigned long long)hash;	// IMP=0x00000000007ece12
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007ecca8
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x00000000007ecc05
