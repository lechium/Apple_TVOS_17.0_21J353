...
+ (id)logCategory;	// IMP=0x0010000000b4de0b
+ (id)requestWithCharacteristic:(id)arg1;	// IMP=0x0010000000b4ddc2
- (void).cxx_destruct;	// IMP=0x0000000000b4dd91
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b4dbe0
- (id)attributeDescriptions;	// IMP=0x0000000000b4d74a
- (id)initWithCharacteristic:(id)arg1;	// IMP=0x0000000000b4d6af
