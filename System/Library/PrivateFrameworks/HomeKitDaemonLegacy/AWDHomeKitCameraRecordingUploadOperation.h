...
- (void).cxx_destruct;	// IMP=0x00000000008bc8a7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008bc698
- (unsigned long long)hash;	// IMP=0x00000000008bc525
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008bc2fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008bc173
- (void)copyTo:(id)arg1;	// IMP=0x00000000008bc024
- (void)writeTo:(id)arg1;	// IMP=0x00000000008bbeb8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008bb8bc
- (id)dictionaryRepresentation;	// IMP=0x00000000008bb553
- (id)description;	// IMP=0x00000000008bb4a4
@property(nonatomic) _Bool hasOperationStartTime;
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000008bb36d
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000008bb322
