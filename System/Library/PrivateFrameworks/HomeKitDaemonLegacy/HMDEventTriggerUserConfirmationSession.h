...
+ (id)logCategory;	// IMP=0x00100000007ec1e1
- (void).cxx_destruct;	// IMP=0x00000000007eb9c1
...
- (void)_sessionComplete;	// IMP=0x00000000007eb81b
- (void)_handleUserPermissionRemoveDialogRequest:(id)arg1;	// IMP=0x00000000007eb717
- (void)_removeUserDialog:(id)arg1;	// IMP=0x00000000007eb3c5
- (void)_handleUserPermissionRemoteResponse:(id)arg1;	// IMP=0x00000000007eb141
- (void)_userResponse:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000007ea987
- (void)userDidConfirmExecute:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000007ea8d0
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007ea818
- (void)_createBulletinNotification;	// IMP=0x00000000007ea581
- (void)createBulletinNotification;	// IMP=0x00000000007ea510
- (void)_askForUserPermissionFromDevice:(id)arg1 executionSessionID:(id)arg2;	// IMP=0x00000000007ea06a
- (void)askForUserPermission:(id)arg1;	// IMP=0x00000000007e9fb2
- (void)_registerForMessages;	// IMP=0x00000000007e9db9
- (void)dealloc;	// IMP=0x00000000007e9bbb
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4 requestingDevice:(id)arg5;	// IMP=0x00000000007e9afb
