...
@interface AWDHomeKitAccessoryReadWrite : PBCodable
{
...
+ (Class)characteristicsType;	// IMP=0x001000000020d3b4
- (void).cxx_destruct;	// IMP=0x000000000020d31d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000020cc1d
- (unsigned long long)hash;	// IMP=0x000000000020c89f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000020c30d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020bda6
- (void)copyTo:(id)arg1;	// IMP=0x000000000020b9f3
- (void)writeTo:(id)arg1;	// IMP=0x000000000020b580
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000020a873
- (id)dictionaryRepresentation;	// IMP=0x0000000000209e43
- (id)description;	// IMP=0x0000000000209d94
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000002099f2
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000002099aa
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x00000000002097ed
- (id)sourceAsString:(int)arg1;	// IMP=0x00000000002097a5
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x0000000000209575
- (id)transportTypeAsString:(int)arg1;	// IMP=0x000000000020952d
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002094a6
- (unsigned long long)characteristicsCount;	// IMP=0x0000000000209489
- (void)addCharacteristics:(id)arg1;	// IMP=0x000000000020941f
- (void)clearCharacteristics;	// IMP=0x0000000000209402
