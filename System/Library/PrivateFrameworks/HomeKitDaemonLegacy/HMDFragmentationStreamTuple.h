...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x006000000095f670
- (void).cxx_destruct;	// IMP=0x000000000095f61d
...
- (void)close;	// IMP=0x000000000095f59c
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000095f3ca
