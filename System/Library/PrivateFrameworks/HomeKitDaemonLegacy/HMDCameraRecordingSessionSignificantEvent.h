...
- (void).cxx_destruct;	// IMP=0x000000000003b2d1
...
- (id)attributeDescriptions;	// IMP=0x000000000003ac93
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003aae3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003aad8
- (unsigned long long)hash;	// IMP=0x000000000003aa94
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a70d
- (id)initWithUUID:(id)arg1;	// IMP=0x000000000003a5e7
