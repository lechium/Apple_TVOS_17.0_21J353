...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x001000000053d376
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x001000000053d29e
- (void).cxx_destruct;	// IMP=0x000000000053d23a
...
- (id)__initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 isPrimaryResident:(_Bool)arg5 count:(id)arg6;	// IMP=0x000000000053cec4
- (id)init;	// IMP=0x000000000053ce1c
