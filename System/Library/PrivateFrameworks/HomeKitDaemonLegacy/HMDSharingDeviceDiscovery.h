...
- (void).cxx_destruct;	// IMP=0x000000000053e573
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000053e493
- (void)stop;	// IMP=0x000000000053e439
- (void)start;	// IMP=0x000000000053e3f5
...
- (void)dealloc;	// IMP=0x000000000053df4e
