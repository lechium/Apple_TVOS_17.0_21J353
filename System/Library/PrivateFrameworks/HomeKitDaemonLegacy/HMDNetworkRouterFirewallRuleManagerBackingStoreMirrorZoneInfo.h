...
- (void).cxx_destruct;	// IMP=0x00000000007fbe04
...
- (void)forceRefresh;	// IMP=0x00000000007fbd40
- (void)markDeleted;	// IMP=0x00000000007fbd2f
- (void)markChanged;	// IMP=0x00000000007fbd1e
- (id)initWithZoneID:(id)arg1;	// IMP=0x00000000007fbc67
