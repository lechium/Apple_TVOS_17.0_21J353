...
- (void).cxx_destruct;	// IMP=0x0000000000a808c6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a807ca
- (unsigned long long)hash;	// IMP=0x0000000000a80738
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a80628
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a80554
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a804af
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a80400
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a800e7
- (id)dictionaryRepresentation;	// IMP=0x0000000000a7ff72
- (id)description;	// IMP=0x0000000000a7fec3
