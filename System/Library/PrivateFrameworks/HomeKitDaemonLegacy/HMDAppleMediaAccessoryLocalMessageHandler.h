...
+ (id)logCategory;	// IMP=0x0010000000357ba1
- (void).cxx_destruct;	// IMP=0x0000000000357b37
...
- (id)logIdentifier;	// IMP=0x0000000000357a98
- (id)dataSourceAccessoryWithUUID:(id)arg1;	// IMP=0x0000000000357949
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x00000000003572ee
- (id)initWithIdentifier:(id)arg1 assistantSettingsConnection:(id)arg2;	// IMP=0x0000000000357233
