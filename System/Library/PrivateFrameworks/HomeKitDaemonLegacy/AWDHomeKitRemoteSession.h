...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000057f2
- (unsigned long long)hash;	// IMP=0x0000000000005735
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000055ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005505
- (void)copyTo:(id)arg1;	// IMP=0x0000000000005443
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005350
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000004ed1
- (id)dictionaryRepresentation;	// IMP=0x0000000000004c80
- (id)description;	// IMP=0x0000000000004bd1
