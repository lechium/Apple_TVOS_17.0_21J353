...
- (void).cxx_destruct;	// IMP=0x00000000004b1a4d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004b15ca
- (unsigned long long)hash;	// IMP=0x00000000004b136e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004b0ffa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004b0d38
- (void)copyTo:(id)arg1;	// IMP=0x00000000004b0b0d
- (void)writeTo:(id)arg1;	// IMP=0x00000000004b08d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004b0100
- (id)dictionaryRepresentation;	// IMP=0x00000000004afb85
- (id)description;	// IMP=0x00000000004afad6
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004af791
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004af749
