...
+ (id)logCategory;	// IMP=0x0010000000a86ffd
- (void).cxx_destruct;	// IMP=0x0000000000a86cfd
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000a86a78
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000a868fe
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000a85f92
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000a85e49
- (void)dealloc;	// IMP=0x0000000000a85ce0
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000a855a7
- (void)_startDataReceive;	// IMP=0x0000000000a85408
- (id)logIdentifier;	// IMP=0x0000000000a853b8
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000a851aa
