...
+ (void)loadEnableAirPlay2Accessories;	// IMP=0x0010000000268a8e
- (void).cxx_destruct;	// IMP=0x0000000000268a5d
...
- (id)stringValue;	// IMP=0x00000000002689e1
- (id)numberValue;	// IMP=0x00000000002688e2
- (_Bool)boolValue;	// IMP=0x000000000026889e
@property(readonly, copy) NSString *propertyDescription;
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x00000000002686b0
