...
+ (id)logCategory;	// IMP=0x0010000000b0bd57
- (void).cxx_destruct;	// IMP=0x0000000000b0ba80
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000b0b84c
- (void)_closeSession;	// IMP=0x0000000000b0b772
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000b0b6ba
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000b0b603
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b0b4c3
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000b0b432
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000b0b2ec
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000b0b1ad
