...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000004c2f36
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x001000000044a5e2
- (void).cxx_destruct;	// IMP=0x00000000004c2ee2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004c2753
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c2621
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004c1fcc
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004c19d2
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 destinationIPAddress:(id)arg4 destinationPortStart:(id)arg5 destinationPortEnd:(id)arg6;	// IMP=0x00000000004c18ab
- (id)init;	// IMP=0x00000000004c187c
- (void)addTo:(id)arg1;	// IMP=0x0000000000449006
