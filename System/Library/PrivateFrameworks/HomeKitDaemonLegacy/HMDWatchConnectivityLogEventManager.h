...
+ (id)sharedInstance;	// IMP=0x001000000044dadd
- (void).cxx_destruct;	// IMP=0x000000000044daca
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000044d98c
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x000000000044d909
- (void)completeCurrentReport;	// IMP=0x000000000044d785
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x000000000044d750
- (void)incrementWatchAddedNotificationCount;	// IMP=0x000000000044d71b
- (id)init;	// IMP=0x000000000044d676
