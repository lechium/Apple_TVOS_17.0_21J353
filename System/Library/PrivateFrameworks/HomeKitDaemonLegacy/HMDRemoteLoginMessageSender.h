...
+ (id)logCategory;	// IMP=0x001000000068575c
- (void).cxx_destruct;	// IMP=0x00000000006855cb
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000685171
- (id)logIdentifier;	// IMP=0x0000000000685121
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x0000000000685001
