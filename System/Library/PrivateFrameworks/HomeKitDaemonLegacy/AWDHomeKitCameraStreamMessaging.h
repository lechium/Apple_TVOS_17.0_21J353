...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003aa972
- (unsigned long long)hash;	// IMP=0x00000000003aa87e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003aa6e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003aa5d4
- (void)copyTo:(id)arg1;	// IMP=0x00000000003aa4e5
- (void)writeTo:(id)arg1;	// IMP=0x00000000003aa3b2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003aa3a5
- (id)dictionaryRepresentation;	// IMP=0x00000000003aa0a8
- (id)description;	// IMP=0x00000000003a9ff9
