...
+ (id)logCategory;	// IMP=0x00100000002acb1f
- (void).cxx_destruct;	// IMP=0x00000000002ac0ac
...
- (id)logIdentifier;	// IMP=0x00000000002abf0a
- (void)accessory:(id)arg1 didCloseDataStreamWithError:(id)arg2;	// IMP=0x00000000002abe52
- (void)accessoryDidStartListening:(id)arg1;	// IMP=0x00000000002abd9a
- (void)accessory:(id)arg1 didReceiveBulkSessionCandidate:(id)arg2;	// IMP=0x00000000002abd80
- (void)_bulkSendDidComplete;	// IMP=0x00000000002abce5
- (void)_bulkSendDidFail;	// IMP=0x00000000002abc4a
- (_Bool)_handleFrame:(id)arg1;	// IMP=0x00000000002abbac
@property(readonly, getter=isSessionOpenInProgress) _Bool sessionOpenInProgress;
- (void)_handleAccessoryDidClose;	// IMP=0x00000000002ab9f9
- (void)_callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002ab7e8
- (void)callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002ab70a
- (void)_openSession;	// IMP=0x00000000002ab571
- (void)_setUpTransport;	// IMP=0x00000000002ab41d
- (void)readData;	// IMP=0x00000000002ab25f
- (void)setUpWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002ab0c7
@property(readonly, getter=isBulkSendActive) _Bool bulkSendActive;
- (void)dealloc;	// IMP=0x00000000002aaf48
- (void)shutDown;	// IMP=0x00000000002aada0
- (id)attributeDescriptions;	// IMP=0x00000000002aabb5
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 fileType:(id)arg3 metadata:(id)arg4 reason:(id)arg5;	// IMP=0x00000000002aaa9f
