...
+ (id)logCategory;	// IMP=0x0010000000281197
+ (_Bool)isRoleSupported:(long long)arg1;	// IMP=0x0010000000281163
- (void).cxx_destruct;	// IMP=0x00000000002802e9
...
- (id)setupTrackingInfo;	// IMP=0x000000000027ffdb
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x000000000027ff67
- (void)_sendRequestData:(id)arg1;	// IMP=0x000000000027fd43
- (void)_handleReceiveData:(id)arg1;	// IMP=0x000000000027fca6
- (void)close:(id)arg1;	// IMP=0x000000000027fb43
- (void)_handleClose:(id)arg1;	// IMP=0x000000000027f98c
- (void)_closeWithError:(id)arg1;	// IMP=0x000000000027f34d
- (void)open;	// IMP=0x000000000027f27c
- (void)__registerForMessages;	// IMP=0x000000000027f12d
- (id)messageDispatcher;	// IMP=0x000000000027f0dd
- (id)messageDestination;	// IMP=0x000000000027f074
@property(readonly) long long role;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027ef4d
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 upSecondsFactory:(CDUnknownBlockType)arg4;	// IMP=0x000000000027eb2c
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3;	// IMP=0x000000000027eb13
- (id)init;	// IMP=0x000000000027ea6b
