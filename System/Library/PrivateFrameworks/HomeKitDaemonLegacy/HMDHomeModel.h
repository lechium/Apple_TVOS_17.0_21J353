...
+ (id)properties;	// IMP=0x006000000057991b
@property(copy, nonatomic) HMDNaturalLightingContext *naturalLightingContext;
- (id)audioAnalysisClassifierOptions;	// IMP=0x000000000057a372
- (void)setAudioAnalysisClassifierOptions:(id)arg1;	// IMP=0x000000000057a360
