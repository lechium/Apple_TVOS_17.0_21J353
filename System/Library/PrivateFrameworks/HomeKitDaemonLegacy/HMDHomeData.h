...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x00100000004970f1
- (void).cxx_destruct;	// IMP=0x0000000000496fd2
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x0000000000496b34
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000496ae0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000496ad5
