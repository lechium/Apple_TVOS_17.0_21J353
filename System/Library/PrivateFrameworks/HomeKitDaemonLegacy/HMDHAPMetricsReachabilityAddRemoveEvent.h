...
- (void).cxx_destruct;	// IMP=0x000000000091d5ef
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x000000000091d4e6
- (id)coreAnalyticsEventName;	// IMP=0x000000000091d4d9
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x000000000091d44f
