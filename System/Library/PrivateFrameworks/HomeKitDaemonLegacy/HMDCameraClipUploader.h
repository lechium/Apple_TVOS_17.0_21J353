...
+ (id)logCategory;	// IMP=0x0010000000981c30
- (void).cxx_destruct;	// IMP=0x0000000000981854
...
- (id)attributeDescriptions;	// IMP=0x0000000000981546
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x00000000009814bc
- (void)_handleFatalOperationFailure;	// IMP=0x00000000009812e1
- (void)_startNextOperation;	// IMP=0x00000000009811a8
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x0000000000980f1d
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x0000000000980c81
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000980ab4
- (id)_createClip;	// IMP=0x000000000098092d
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x00000000009808fa
- (id)finish;	// IMP=0x00000000009807fe
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x00000000009804f6
- (id)addVideoInitData:(id)arg1;	// IMP=0x000000000098025c
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x000000000097ff12
- (id)createClip;	// IMP=0x000000000097fd23
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x000000000097fa63
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x000000000097f94c
