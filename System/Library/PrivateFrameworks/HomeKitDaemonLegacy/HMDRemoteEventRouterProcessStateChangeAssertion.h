...
+ (id)logCategory;	// IMP=0x0010000000793b2f
- (void).cxx_destruct;	// IMP=0x00000000007934e9
...
- (void)_backgroundTimerDidExpire:(id)arg1;	// IMP=0x0000000000792faa
- (void)_removeBackgroundTimer:(id)arg1;	// IMP=0x0000000000792e77
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)arg1;	// IMP=0x0000000000792c0a
- (void)foregroundStateChangedWithBundleIdentifier:(id)arg1 applicationState:(unsigned long long)arg2;	// IMP=0x0000000000792b02
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 applicationsAndIntervals:(id)arg3 dataSource:(id)arg4;	// IMP=0x0000000000792991
