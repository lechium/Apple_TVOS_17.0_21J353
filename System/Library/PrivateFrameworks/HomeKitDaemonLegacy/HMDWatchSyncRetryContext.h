...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x00100000001f81ad
- (void).cxx_destruct;	// IMP=0x00000000001f817c
...
- (id)attributeDescriptions;	// IMP=0x00000000001f7f89
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f7f7e
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x00000000001f7e40
