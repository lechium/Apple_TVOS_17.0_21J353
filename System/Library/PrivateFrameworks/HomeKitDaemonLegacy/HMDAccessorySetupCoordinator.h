...
+ (id)logCategory;	// IMP=0x00100000008cd80c
- (void).cxx_destruct;	// IMP=0x00000000008cd35c
...
- (id)logIdentifier;	// IMP=0x00000000008cd1a9
- (id)_setupPayloadWithCHIPSetupPayload:(id)arg1 setupPayloadURL:(id)arg2;	// IMP=0x00000000008ccd96
- (id)_createCHIPSetupAccessoryPayloadWithSetupPayloadDecimalStringRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x00000000008ccbaa
- (void)handleCancelStagedCHIPAccessoryPairingMessage:(id)arg1;	// IMP=0x00000000008cc8dc
- (void)handleCreateCHIPSetupPayloadMessage:(id)arg1;	// IMP=0x00000000008cc4f2
- (void)handleCreateCHIPSetupAccessoryPayloadMessage:(id)arg1;	// IMP=0x00000000008cc130
- (id)createSetupAccessoryPayloadWithCHIPSetupPayload:(id)arg1 error:(id *)arg2;	// IMP=0x00000000008cbf44
- (id)createCHIPSetupAccessoryPayloadWithSetupPayloadURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000008cbd0b
- (void)configure;	// IMP=0x00000000008cbb18
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 chipAccessoryServerBrowser:(id)arg3 chipDataSource:(id)arg4;	// IMP=0x00000000008cb920
