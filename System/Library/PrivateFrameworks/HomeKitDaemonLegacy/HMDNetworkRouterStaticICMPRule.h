...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000004bf852
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x001000000044a9b6
- (void).cxx_destruct;	// IMP=0x00000000004bce9e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004bc978
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004bc899
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004bc40c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004bbf77
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 destinationIPAddress:(id)arg3 icmpTypeList:(id)arg4;	// IMP=0x00000000004bbe8f
- (id)init;	// IMP=0x00000000004bbe60
- (void)addTo:(id)arg1;	// IMP=0x00000000004490b1
