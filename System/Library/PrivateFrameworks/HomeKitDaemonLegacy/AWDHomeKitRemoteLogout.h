...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005d9081
- (unsigned long long)hash;	// IMP=0x00000000005d8ffd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005d8f06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005d8e53
- (void)copyTo:(id)arg1;	// IMP=0x00000000005d8dc3
- (void)writeTo:(id)arg1;	// IMP=0x00000000005d8d10
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005d899e
- (id)dictionaryRepresentation;	// IMP=0x00000000005d87da
- (id)description;	// IMP=0x00000000005d872b
- (int)StringAsRequester:(id)arg1;	// IMP=0x00000000005d8671
- (id)requesterAsString:(int)arg1;	// IMP=0x00000000005d8626
