...
+ (id)supportedEventClasses;	// IMP=0x0010000000aab2a4
- (void).cxx_destruct;	// IMP=0x0000000000aaaefb
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x0000000000aaab44
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x0000000000aaab3e
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x0000000000aaab38
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000aaaa7d
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000aaa9c2
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000aaa88c
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000aaa7ac
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000aa9ddc
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x0000000000aa9631
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x0000000000aa9460
- (void)runDailyTask;	// IMP=0x0000000000aa93dc
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000aa9313
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000aa918d
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000aa8fea
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000aa8f03
- (void)stop;	// IMP=0x0000000000aa8e27
- (void)start;	// IMP=0x0000000000aa8cd0
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x0000000000aa8ca9
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x0000000000aa8b04
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000aa8a0e
