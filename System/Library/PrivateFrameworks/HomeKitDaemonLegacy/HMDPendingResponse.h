...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00600000000aca62
- (void).cxx_destruct;	// IMP=0x00000000000ac9fe
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x00000000000ac855
- (id)retrieveAndClearAllResponses;	// IMP=0x00000000000ac79f
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x00000000000ac6cf
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000000ac607
- (id)description;	// IMP=0x00000000000ac546
