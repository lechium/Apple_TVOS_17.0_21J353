...
- (void).cxx_destruct;	// IMP=0x00000000002a48c2
...
- (id)attributeDescriptions;	// IMP=0x00000000002a4698
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x00000000002a459b
