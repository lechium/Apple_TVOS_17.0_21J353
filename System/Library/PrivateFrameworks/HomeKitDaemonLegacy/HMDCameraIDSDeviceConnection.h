...
+ (id)logCategory;	// IMP=0x0010000000366ee5
- (void).cxx_destruct;	// IMP=0x0000000000365aae
...
- (id)logIdentifier;	// IMP=0x000000000036598f
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x00000000003658db
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x0000000000365827
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000365538
- (void)startKeepAlive;	// IMP=0x00000000003654cf
- (void)_createStreamSocketWithDevice:(id)arg1;	// IMP=0x0000000000363f58
- (void)dealloc;	// IMP=0x0000000000363eb1
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 idsProxyStreamService:(id)arg3;	// IMP=0x0000000000363c91
