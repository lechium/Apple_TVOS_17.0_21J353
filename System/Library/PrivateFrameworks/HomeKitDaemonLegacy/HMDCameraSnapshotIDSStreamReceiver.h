...
+ (id)logCategory;	// IMP=0x0010000000870ab5
- (void).cxx_destruct;	// IMP=0x0000000000870a43
...
- (void)service:(id)arg1 account:(id)arg2 incomingResourceAtURL:(id)arg3 metadata:(id)arg4 fromID:(id)arg5 context:(id)arg6;	// IMP=0x000000000087034a
- (id)logIdentifier;	// IMP=0x00000000008702fa
- (void)_callFileReceivedWithError:(id)arg1;	// IMP=0x00000000008701eb
- (void)dealloc;	// IMP=0x0000000000870106
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3 snapshotFile:(id)arg4 delegate:(id)arg5 delegateQueue:(id)arg6 remoteDevice:(id)arg7;	// IMP=0x000000000086ff40
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 snapshotFile:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 remoteDevice:(id)arg6;	// IMP=0x000000000086fdb1
