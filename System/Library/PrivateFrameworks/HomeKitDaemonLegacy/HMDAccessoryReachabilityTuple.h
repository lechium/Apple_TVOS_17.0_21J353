...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000000acea8
- (void).cxx_destruct;	// IMP=0x00000000000ace95
...
- (id)description;	// IMP=0x00000000000acc95
- (unsigned long long)hash;	// IMP=0x00000000000acc51
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000acbc0
