...
+ (id)broadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x006000000079d021
- (void).cxx_destruct;	// IMP=0x000000000079d00e
...
- (id)initBroadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x000000000079cf6e
