...
- (void).cxx_destruct;	// IMP=0x0000000000791e9e
...
- (void)dealloc;	// IMP=0x0000000000791de0
- (id)initWithPowerAssertionHandler:(id)arg1 remoteRequestHandlerSessionID:(id)arg2;	// IMP=0x0000000000791d45
