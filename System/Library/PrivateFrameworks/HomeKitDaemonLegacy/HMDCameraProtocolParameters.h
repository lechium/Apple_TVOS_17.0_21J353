...
@interface HMDCameraProtocolParameters : HMFObject
{
...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000049234a
- (void).cxx_destruct;	// IMP=0x00000000004922c4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004920a9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000491f4b
