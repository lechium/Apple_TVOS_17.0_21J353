...
- (void).cxx_destruct;	// IMP=0x00000000009afd3f
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchive;	// IMP=0x00000000009af982
- (void)archiveDictionary:(id)arg1;	// IMP=0x00000000009af852
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x00000000009af7ee
