...
- (void).cxx_destruct;	// IMP=0x0000000000b6ebf6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b6ea85
- (unsigned long long)hash;	// IMP=0x0000000000b6e99f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b6e837
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b6e71c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b6e639
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b6e54c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b6e18c
- (id)dictionaryRepresentation;	// IMP=0x0000000000b6df99
- (id)description;	// IMP=0x0000000000b6deea
