...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000007662fe
+ (id)logCategory;	// IMP=0x00100000007662ce
+ (id)assetWithURL:(id)arg1;	// IMP=0x0010000000765dbb
+ (id)assetDirectoryURL;	// IMP=0x0010000000765d8b
- (void).cxx_destruct;	// IMP=0x000000000076396d
...
- (void)setExtractionProgress:(double)arg1;	// IMP=0x000000000076374b
- (void)URLSession:(id)arg1 downloadTask:(id)arg2 didFinishDownloadingToURL:(id)arg3;	// IMP=0x0000000000763130
- (void)URLSession:(id)arg1 downloadTask:(id)arg2 didWriteData:(long long)arg3 totalBytesWritten:(long long)arg4 totalBytesExpectedToWrite:(long long)arg5;	// IMP=0x0000000000763034
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000000762f17
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000762e1f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000762d13
- (id)logIdentifier;	// IMP=0x0000000000762cc3
- (void)finishUnarchive;	// IMP=0x0000000000762c71
- (void)cancelUnarchive;	// IMP=0x0000000000762c1f
- (void)startUnarchive;	// IMP=0x0000000000762bcd
- (void)finishDownload;	// IMP=0x0000000000762b7b
- (void)cancelDownload;	// IMP=0x0000000000762b29
- (void)startDownload;	// IMP=0x0000000000762ad7
- (_Bool)purgeWithError:(id *)arg1;	// IMP=0x0000000000762991
- (void)startCaching;	// IMP=0x0000000000762923
- (_Bool)saveWithError:(id *)arg1;	// IMP=0x00000000007625a7
- (void)resetDownloadRetryCount;	// IMP=0x000000000076245e
- (void)increaseDownloadRetryCount;	// IMP=0x0000000000762202
- (_Bool)isDownloadPermitted;	// IMP=0x000000000076212f
@property(readonly, copy) HMSoftwareUpdateDocumentation *documentation;
@property(readonly, copy) NSURL *bundleURL;
- (id)archiveURL;	// IMP=0x0000000000761de9
- (id)metadataURL;	// IMP=0x0000000000761d92
@property(readonly, copy) NSURL *URL;
- (void)setState:(long long)arg1;	// IMP=0x0000000000761b4b
@property(readonly) long long state; // @synthesize state=_state;
@property _Bool shouldAutomaticallyCache; // @synthesize shouldAutomaticallyCache=_shouldAutomaticallyCache;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000761967
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *propertyDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)initWithDocumentationMetadata:(id)arg1;	// IMP=0x00000000007616e1
- (id)initWithDocumentationMetadata:(id)arg1 dateWithTimeIntervalSinceNowFactory:(CDUnknownBlockType)arg2 URLSessionFactory:(CDUnknownBlockType)arg3 extractorFactory:(CDUnknownBlockType)arg4 notificationCenter:(id)arg5;	// IMP=0x0000000000761497
- (id)init;	// IMP=0x00000000007613ef
