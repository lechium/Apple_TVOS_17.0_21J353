...
- (void).cxx_destruct;	// IMP=0x0000000000518df0
...
- (void)main;	// IMP=0x0000000000518bfa
- (id)initWithItemToPost:(id)arg1 followUpController:(id)arg2;	// IMP=0x0000000000518b2f
