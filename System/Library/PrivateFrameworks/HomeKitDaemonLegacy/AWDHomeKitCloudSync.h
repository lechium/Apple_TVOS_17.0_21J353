...
+ (Class)topErrorsType;	// IMP=0x001000000043d621
+ (Class)topReasonsType;	// IMP=0x001000000043d610
- (void).cxx_destruct;	// IMP=0x000000000043d5df
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000043d004
- (unsigned long long)hash;	// IMP=0x000000000043cd8c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000043c9bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000043c473
- (void)copyTo:(id)arg1;	// IMP=0x000000000043c13b
- (void)writeTo:(id)arg1;	// IMP=0x000000000043bcdc
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000043b185
- (id)dictionaryRepresentation;	// IMP=0x000000000043a794
- (id)description;	// IMP=0x000000000043a6e5
...
- (int)StringAsDataSyncState:(id)arg1;	// IMP=0x000000000043a395
- (id)dataSyncStateAsString:(int)arg1;	// IMP=0x000000000043a34d
...
- (id)topErrorsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000043a1e1
- (unsigned long long)topErrorsCount;	// IMP=0x000000000043a1c4
- (void)addTopErrors:(id)arg1;	// IMP=0x000000000043a15a
- (void)clearTopErrors;	// IMP=0x000000000043a13d
- (id)topReasonsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000043a120
- (unsigned long long)topReasonsCount;	// IMP=0x000000000043a103
- (void)addTopReasons:(id)arg1;	// IMP=0x000000000043a099
- (void)clearTopReasons;	// IMP=0x000000000043a07c
