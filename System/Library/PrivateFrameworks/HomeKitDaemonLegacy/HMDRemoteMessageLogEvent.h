...
+ (id)sendingRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x006000000008e1b5
+ (id)sendingRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x006000000008e0d0
+ (id)receivedRemoteMessage:(id)arg1 transportType:(int)arg2;	// IMP=0x006000000008df59
+ (id)receivedRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 messageQoS:(long long)arg8;	// IMP=0x006000000008de74
- (void).cxx_destruct;	// IMP=0x000000000008de21
...
- (id)initWithRemoteMessage:(id)arg1 identifier:(id)arg2 transactionIdentifier:(id)arg3 messageType:(long long)arg4 peerInformation:(id)arg5 secure:(_Bool)arg6 transportType:(int)arg7 sending:(_Bool)arg8 messageQoS:(long long)arg9;	// IMP=0x000000000008dc16
