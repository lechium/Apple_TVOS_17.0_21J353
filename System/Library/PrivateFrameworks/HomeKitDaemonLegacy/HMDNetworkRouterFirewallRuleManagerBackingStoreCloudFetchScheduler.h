...
+ (void)__unregisterActivity:(id)arg1;	// IMP=0x0010000000729490
+ (id)logCategory;	// IMP=0x0010000000729460
- (void).cxx_destruct;	// IMP=0x0000000000728ed9
...
- (void)stop;	// IMP=0x0000000000728d60
- (void)start;	// IMP=0x0000000000728cb2
- (void)__transitionActivity:(id)arg1 state:(long long)arg2;	// IMP=0x0000000000728b0b
- (void)__unregisterActivity;	// IMP=0x00000000007289e9
- (void)__runActivity:(id)arg1;	// IMP=0x0000000000728637
- (void)__checkInActivity:(id)arg1;	// IMP=0x0000000000728227
- (void)__registerActivity;	// IMP=0x0000000000728063
- (id)__initialCriteria;	// IMP=0x0000000000727f59
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000727d21
- (id)initWithIdentifier:(id)arg1 interval:(double)arg2 retryInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x0000000000727c36
