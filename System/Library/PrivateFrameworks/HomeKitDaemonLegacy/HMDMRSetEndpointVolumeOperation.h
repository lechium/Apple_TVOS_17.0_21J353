...
+ (id)logCategory;	// IMP=0x001000000026d92e
+ (id)shortDescription;	// IMP=0x001000000026d921
- (void).cxx_destruct;	// IMP=0x000000000026b8b7
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000026b27b
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000026afd4
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000026ad38
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x000000000026ab5b
- (_Bool)cancelOnSetup;	// IMP=0x000000000026a5a5
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1;	// IMP=0x0000000000269a93
- (void)main;	// IMP=0x000000000026982e
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x00000000002697a8
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x0000000000269656
