...
- (void).cxx_destruct;	// IMP=0x00000000005ce1d1
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005cdce2
- (void)done;	// IMP=0x00000000005cd82b
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005cd6a4
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005cd51d
- (double)timeoutRemaining;	// IMP=0x00000000005cd439
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x00000000005cd07d
- (void)receivedResponseOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000005ccfc0
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000005ccb2a
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x00000000005cc694
...
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x00000000005cc1d3
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5 activityFactory:(id)arg6;	// IMP=0x00000000005cc01c
