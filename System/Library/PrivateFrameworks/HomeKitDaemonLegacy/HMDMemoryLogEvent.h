...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x00000000009c2d95
- (id)init;	// IMP=0x00000000009c2ced
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b52e70
