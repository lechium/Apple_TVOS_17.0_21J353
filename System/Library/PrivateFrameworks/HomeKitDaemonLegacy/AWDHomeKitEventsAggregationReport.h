...
- (void).cxx_destruct;	// IMP=0x00000000004a865e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004a817f
- (unsigned long long)hash;	// IMP=0x00000000004a7e2f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004a793d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004a75e5
- (void)copyTo:(id)arg1;	// IMP=0x00000000004a72bc
- (void)writeTo:(id)arg1;	// IMP=0x00000000004a6f40
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004a5fcd
- (id)dictionaryRepresentation;	// IMP=0x00000000004a56cf
- (id)description;	// IMP=0x00000000004a5620
