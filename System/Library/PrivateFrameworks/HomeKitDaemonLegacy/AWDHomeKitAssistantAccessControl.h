...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000953a1c
- (unsigned long long)hash;	// IMP=0x000000000095397e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000095384d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000095377b
- (void)copyTo:(id)arg1;	// IMP=0x00000000009536cc
- (void)writeTo:(id)arg1;	// IMP=0x00000000009535f8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009531f8
- (id)dictionaryRepresentation;	// IMP=0x0000000000952ffc
- (id)description;	// IMP=0x0000000000952f4d
