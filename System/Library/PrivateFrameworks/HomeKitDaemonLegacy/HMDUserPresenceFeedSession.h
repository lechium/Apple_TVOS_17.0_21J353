...
+ (id)logCategory;	// IMP=0x0010000000396a91
- (void).cxx_destruct;	// IMP=0x000000000039664a
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003963c0
- (id)logIdentifier;	// IMP=0x00000000003963ae
- (void)_callDelegate;	// IMP=0x00000000003962ed
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x00000000003961d5
- (void)_send;	// IMP=0x0000000000395435
- (void)send;	// IMP=0x00000000003953c4
- (id)attributeDescriptions;	// IMP=0x0000000000395194
- (void)dealloc;	// IMP=0x000000000039504c
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x0000000000394d1e
