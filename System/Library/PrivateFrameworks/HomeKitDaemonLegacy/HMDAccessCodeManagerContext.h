...
+ (id)logCategory;	// IMP=0x0010000000040e12
- (void).cxx_destruct;	// IMP=0x0000000000040bd6
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x0000000000040b43
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x0000000000040a58
...
- (id)userWithUUID:(id)arg1;	// IMP=0x0000000000040766
- (id)userForMessage:(id)arg1;	// IMP=0x00000000000406ec
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x0000000000040638
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x0000000000040470
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x00000000000402cd
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000004012a
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x000000000003ff62
...
- (void)configureWithMessageDispatcher:(id)arg1;	// IMP=0x000000000003f670
- (id)initWithHome:(id)arg1 workQueue:(id)arg2 UUID:(id)arg3;	// IMP=0x000000000003f4ff
- (id)initWithHome:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000003f43e
