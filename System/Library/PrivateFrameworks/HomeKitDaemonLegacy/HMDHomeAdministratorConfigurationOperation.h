...
+ (id)logCategory;	// IMP=0x001000000071c86e
+ (double)timeout;	// IMP=0x001000000071c790
- (void).cxx_destruct;	// IMP=0x000000000071c32f
...
- (id)logIdentifier;	// IMP=0x000000000071c200
- (void)main;	// IMP=0x000000000071bd9d
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000000071bc59
