...
+ (id)logCategory;	// IMP=0x0010000000774891
- (void).cxx_destruct;	// IMP=0x00000000007747eb
...
- (id)logIdentifier;	// IMP=0x00000000007746d2
- (void)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000077457f
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x00000000007743ba
- (void)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x0000000000774067
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegateQueue:(id)arg4 uniqueIdentifier:(id)arg5 snapshotRequestHandler:(id)arg6 residentMessageHandler:(id)arg7 remoteDevice:(id)arg8;	// IMP=0x0000000000773e16
