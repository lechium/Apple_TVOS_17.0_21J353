...
+ (_Bool)isNewBetter:(unsigned long long)arg1 present:(unsigned long long)arg2;	// IMP=0x00600000009d914e
- (void).cxx_destruct;	// IMP=0x00000000009d910c
...
- (id)description;	// IMP=0x00000000009d9071
- (void)dealloc;	// IMP=0x00000000009d8fd2
- (_Bool)removeSync;	// IMP=0x00000000009d8e13
- (void)addNewSync:(id)arg1;	// IMP=0x00000000009d8867
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) HMDWatchSync *currentSync;
- (id)initWithDeviceId:(id)arg1 pairedSync:(id)arg2;	// IMP=0x00000000009d86c2
