...
+ (id)logCategory;	// IMP=0x0010000000b6d871
- (void).cxx_destruct;	// IMP=0x0000000000b6d629
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000b6d4f3
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000b6d482
- (void)_notifyDelegate;	// IMP=0x0000000000b6d2a6
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000b6cee1
- (void)_registerForNotifications;	// IMP=0x0000000000b6cdf9
- (void)start;	// IMP=0x0000000000b6cd99
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000b6cbb7
