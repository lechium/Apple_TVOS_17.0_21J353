...
+ (id)logCategory;	// IMP=0x00100000006a82d5
- (void).cxx_destruct;	// IMP=0x00000000006a8282
...
- (id)logIdentifier;	// IMP=0x00000000006a81da
- (void)startKeepAlive;	// IMP=0x00000000006a81d4
- (void)dealloc;	// IMP=0x00000000006a80bb
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006a7f75
