...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002ec00d
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000002ebf96
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002ebe6b
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000005604fb
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000005604ac
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000056045d
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000076f1d6
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000076f16c
- (unsigned long long)homeManagerOptions;	// IMP=0x00100000002ebe1a
...
- (id)userForHome:(id)arg1;	// IMP=0x001000000097dd8b
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x001000000097d9d5
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000b39e1a
