...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x001000000071b620
...
- (id)initWithIsPrimary:(_Bool)arg1 didChangePrimary:(_Bool)arg2;	// IMP=0x000000000071b4c5
