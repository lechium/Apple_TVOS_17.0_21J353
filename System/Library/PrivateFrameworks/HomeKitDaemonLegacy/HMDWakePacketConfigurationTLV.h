...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000072c962
- (void).cxx_destruct;	// IMP=0x000000000072c919
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000072c2e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000072c1dd
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000072bb7c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000072b60a
- (id)initWithWakePacketType:(id)arg1 wakeDestinationPort:(id)arg2 wakeDestinationAddress:(id)arg3 wakeType:(id)arg4 wakePattern:(id)arg5;	// IMP=0x000000000072b503
- (id)init;	// IMP=0x000000000072b4d4
