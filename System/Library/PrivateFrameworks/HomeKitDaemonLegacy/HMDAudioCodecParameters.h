...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000006e3c4
- (void).cxx_destruct;	// IMP=0x000000000006e2d7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006e17b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006de73
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006dc94
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006d8dc
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x000000000006d7df
