...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000004b6ba1
- (void).cxx_destruct;	// IMP=0x00000000004b6b6e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004b678e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004b66d6
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004b631a
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004b5f41
- (id)initWithClientIdentifier:(id)arg1 lastViolationTimestamp:(id)arg2 lastResetTimestamp:(id)arg3;	// IMP=0x00000000004b5e89
- (id)init;	// IMP=0x00000000004b5e5a
