...
+ (id)sharedManager;	// IMP=0x00600000009198ee
- (void).cxx_destruct;	// IMP=0x00000000009194c4
...
- (void)dealloc;	// IMP=0x00000000009192a2
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000918f99
