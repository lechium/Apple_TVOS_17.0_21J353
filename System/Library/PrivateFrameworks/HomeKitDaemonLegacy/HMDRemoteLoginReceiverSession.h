...
- (void).cxx_destruct;	// IMP=0x000000000023d9d4
...
- (id)description;	// IMP=0x000000000023d935
- (void)dealloc;	// IMP=0x000000000023d845
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000023d771
