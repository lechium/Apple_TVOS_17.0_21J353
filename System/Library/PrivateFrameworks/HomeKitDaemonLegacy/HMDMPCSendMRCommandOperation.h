...
+ (id)logCategory;	// IMP=0x001000000098318f
+ (id)shortDescription;	// IMP=0x0010000000983182
- (void).cxx_destruct;	// IMP=0x00000000009828c6
...
- (void)main;	// IMP=0x000000000098200b
- (id)initWithPlaybackArchive:(id)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000981efd
- (id)initWithPlaybackArchive:(id)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000981e5e
- (id)initWithCommand:(unsigned int)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000981d3c
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000981cb0
