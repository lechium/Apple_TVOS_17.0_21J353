...
- (void).cxx_destruct;	// IMP=0x000000000041958d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041939f
- (id)description;	// IMP=0x00000000004192e2
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x0000000000419218
