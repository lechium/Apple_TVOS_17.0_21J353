...
- (void).cxx_destruct;	// IMP=0x00000000004529aa
...
- (id)initWithAction:(id)arg1 characteristicWriteRequests:(id)arg2;	// IMP=0x00000000004528dc
- (id)init;	// IMP=0x0000000000452834
