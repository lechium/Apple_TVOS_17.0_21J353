...
- (void).cxx_destruct;	// IMP=0x000000000030217f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000301fb8
- (id)description;	// IMP=0x0000000000301e59
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x0000000000301d62
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x0000000000301c98
