...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000081f382
- (void).cxx_destruct;	// IMP=0x000000000081ef56
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000081ee2f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000081ed0a
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000081ebbc
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000081e8c9
- (id)initWithImageWidth:(id)arg1 imageHeight:(id)arg2 frameRate:(id)arg3;	// IMP=0x000000000081e7dc
- (id)initWithResolution:(long long)arg1 frameRate:(id)arg2;	// IMP=0x000000000081e708
