...
+ (id)logCategory;	// IMP=0x0010000000b726bf
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x0000000000b7268b
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)serializedMetric;	// IMP=0x0000000000b7241b
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000b7222c
- (id)initWithHomeUUID:(id)arg1 numCapableSiriEndpoints:(unsigned long long)arg2 numEnabledSiriEndpoints:(unsigned long long)arg3;	// IMP=0x0000000000b721d6
- (id)initWithConfigurationDataSource:(id)arg1;	// IMP=0x0000000000b71e84
