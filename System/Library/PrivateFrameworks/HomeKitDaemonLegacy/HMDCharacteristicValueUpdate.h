...
- (void).cxx_destruct;	// IMP=0x00000000005bcd01
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x00000000005bcbe4
- (id)initWithError:(id)arg1;	// IMP=0x00000000005bcb76
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x00000000005bcaac
