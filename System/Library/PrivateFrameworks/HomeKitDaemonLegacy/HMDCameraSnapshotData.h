...
- (void).cxx_destruct;	// IMP=0x00000000006a8576
...
- (void)dealloc;	// IMP=0x00000000006a84ea
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000006a8406
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000006a833c
