...
+ (id)logCategory;	// IMP=0x00100000002f1813
- (void).cxx_destruct;	// IMP=0x00000000002f0a7d
...
- (void)removeResponses:(id)arg1;	// IMP=0x00000000002f0839
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002f032d
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002eff42
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002efb57
- (void)addMediaWriteRequests:(id)arg1 withRequestProperty:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002ef42d
- (void)handleAccessoryCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000002ef375
- (void)__handleAccessoryCharacteristicsChanged:(id)arg1;	// IMP=0x00000000002ee3c8
- (void)_reportOperationStartedForAccessory:(id)arg1;	// IMP=0x00000000002edb87
- (void)reportOperationStartedForAccessory:(id)arg1;	// IMP=0x00000000002edacf
- (void)_reportResponses;	// IMP=0x00000000002ece0e
- (void)_reportResponsesForMediaRequests;	// IMP=0x00000000002ec6eb
- (void)timeoutAndReportResults;	// IMP=0x00000000002ec67a
- (void)_register;	// IMP=0x00000000002ec616
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)dealloc;	// IMP=0x00000000002ec54a
- (id)initWithQueue:(id)arg1 msgDispatcher:(id)arg2;	// IMP=0x00000000002ec3f3
