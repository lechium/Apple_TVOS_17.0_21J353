...
+ (id)logCategory;	// IMP=0x00100000005bab1c
- (void).cxx_destruct;	// IMP=0x00000000005ba812
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005ba5d7
- (void)handleClientConnectionDidDeactivate:(id)arg1;	// IMP=0x00000000005ba51f
- (void)handleClientConnectionDidActivate:(id)arg1;	// IMP=0x00000000005ba467
- (void)_updateTimer;	// IMP=0x00000000005ba121
- (void)removeClientConnection:(id)arg1;	// IMP=0x00000000005b9f4a
- (void)addClientConnection:(id)arg1;	// IMP=0x00000000005b9d62
@property(readonly, copy) NSSet *clientConnections;
- (id)initWithTimeInterval:(double)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000005b9b48
