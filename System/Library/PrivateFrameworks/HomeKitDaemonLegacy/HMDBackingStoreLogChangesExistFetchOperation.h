...
- (void).cxx_destruct;	// IMP=0x00000000007f0717
...
- (id)mainReturningError;	// IMP=0x00000000007f03da
- (id)initWithNeedsPushTo:(unsigned long long)arg1 result:(CDUnknownBlockType)arg2;	// IMP=0x00000000007f032e
