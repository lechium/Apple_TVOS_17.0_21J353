...
- (void).cxx_destruct;	// IMP=0x0000000000aa8959
...
- (unsigned long long)hash;	// IMP=0x0000000000aa867b
- (long long)compare:(id)arg1;	// IMP=0x0000000000aa8585
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aa81b0
- (id)attributeDescriptions;	// IMP=0x0000000000aa7eb1
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000aa7cb1
