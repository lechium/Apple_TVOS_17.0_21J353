...
- (void).cxx_destruct;	// IMP=0x0000000000770a73
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x0000000000770764
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x0000000000770562
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x0000000000770360
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000770291
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x000000000077012e
- (void)_removeBrowser:(id)arg1;	// IMP=0x00000000007700b8
- (void)_addBrowser:(id)arg1;	// IMP=0x0000000000770042
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x000000000076fe8d
- (void)_stopBrowsers;	// IMP=0x000000000076fa08
- (void)stop;	// IMP=0x000000000076f997
- (_Bool)_startBrowsers;	// IMP=0x000000000076f5f9
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000076f541
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x000000000076f2c4
