...
- (void).cxx_destruct;	// IMP=0x000000000074ea13
...
- (void)main;	// IMP=0x000000000074e3ec
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000074e31f
