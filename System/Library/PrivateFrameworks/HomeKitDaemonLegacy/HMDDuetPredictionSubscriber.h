...
- (void).cxx_destruct;	// IMP=0x000000000061d9c3
...
- (void)dealloc;	// IMP=0x000000000061d90c
- (void)_unregisterForNotifications;	// IMP=0x000000000061d8c7
- (void)_registerForNotifications;	// IMP=0x000000000061d714
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 dataSource:(id)arg3;	// IMP=0x000000000061d62d
