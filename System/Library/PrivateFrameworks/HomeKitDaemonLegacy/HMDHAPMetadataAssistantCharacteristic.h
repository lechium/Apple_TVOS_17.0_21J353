...
- (void).cxx_destruct;	// IMP=0x000000000021243d
...
- (id)description;	// IMP=0x0000000000212243
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x00000000002120a5
- (id)init;	// IMP=0x0000000000211ffd
