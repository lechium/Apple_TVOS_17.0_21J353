...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000006f1ac
- (void).cxx_destruct;	// IMP=0x000000000006f17b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006f0ab
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006eeeb
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006ed81
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006ea75
- (id)initWithAudioCodecGroup:(id)arg1 codecParameter:(id)arg2;	// IMP=0x000000000006e9d3
