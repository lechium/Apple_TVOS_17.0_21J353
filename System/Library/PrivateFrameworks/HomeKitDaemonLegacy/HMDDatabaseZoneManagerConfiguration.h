...
- (void).cxx_destruct;	// IMP=0x000000000045959c
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000459378
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000045936d
- (unsigned long long)hash;	// IMP=0x000000000045924a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000458fc9
- (id)attributeDescriptions;	// IMP=0x0000000000458ca7
- (id)init;	// IMP=0x0000000000458b9d
