...
- (void).cxx_destruct;	// IMP=0x0000000000712826
...
- (id)attributeDescriptions;	// IMP=0x0000000000712623
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 accessoryUUID:(id)arg3;	// IMP=0x000000000071251c
