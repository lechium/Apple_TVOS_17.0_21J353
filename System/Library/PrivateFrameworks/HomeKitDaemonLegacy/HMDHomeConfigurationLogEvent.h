...
@interface HMDHomeConfigurationLogEvent : HMMLogEvent
{
    ...
    _Bool _isSmokeAlarmEnabled;	// 21 = 0x15
    _Bool _isSiriPhraseOptionsHeySiriEnabled;	// 22 = 0x16
    _Bool _isSiriPhraseOptionsJustSiriEnabled;	// 23 = 0x17
...
- (void).cxx_destruct;	// IMP=0x00000000004e6623
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x00000000004e2583
- (id)initWithDataSource:(id)arg1 home:(id)arg2;	// IMP=0x00000000004e0937
- (id)initWithHome:(id)arg1;	// IMP=0x00000000004e0922
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004e08bc
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004e07f5
- (void)setHomeConfigurationBitMasks;	// IMP=0x00000000004e06d9
