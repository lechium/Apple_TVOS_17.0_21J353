...
- (void).cxx_destruct;	// IMP=0x00000000001f8f40
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x00000000001f8e42
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x00000000001f8db9
