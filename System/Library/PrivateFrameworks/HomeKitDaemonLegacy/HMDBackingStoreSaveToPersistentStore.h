...
- (void).cxx_destruct;	// IMP=0x00000000009842bb
...
- (id)mainReturningError;	// IMP=0x0000000000984106
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x0000000000984042
