...
+ (id)logCategory;	// IMP=0x00100000009bcdb8
- (void).cxx_destruct;	// IMP=0x00000000009bcd47
...
- (id)logIdentifier;	// IMP=0x00000000009bcc9b
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x00000000009bcad0
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x00000000009bc9ea
- (id)shortDescription;	// IMP=0x00000000009bc96f
- (void)dealloc;	// IMP=0x00000000009bc8b2
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x00000000009bc817
