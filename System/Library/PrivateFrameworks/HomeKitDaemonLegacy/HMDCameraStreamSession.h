...
+ (id)logCategory;	// IMP=0x0010000000a8fe48
- (void).cxx_destruct;	// IMP=0x0000000000a8fde4
...
- (id)logIdentifier;	// IMP=0x0000000000a8fd03
- (id)negotiatedParameters;	// IMP=0x0000000000a8fbae
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000a8f82e
