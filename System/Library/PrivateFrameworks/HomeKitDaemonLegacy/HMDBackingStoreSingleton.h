...
+ (id)logCategory;	// IMP=0x0010000000983daf
+ (void)resetSchemaHash;	// IMP=0x0010000000983d3e
+ (void)resetClassMappings;	// IMP=0x0010000000983c9b
+ (void)setClass:(Class)arg1 forClassName:(id)arg2;	// IMP=0x0010000000983b18
+ (id)sharedInstance;	// IMP=0x0010000000983b07
+ (void)start;	// IMP=0x0010000000983ae3
+ (id)dataVersion;	// IMP=0x0010000000983aca
- (void).cxx_destruct;	// IMP=0x0000000000983a46
...
- (id)logIdentifier;	// IMP=0x00000000009839a6
- (void)setHomeManager:(id)arg1;	// IMP=0x000000000098388a
- (id)resetBackingStore;	// IMP=0x0000000000983835
- (id)flushBackingStore;	// IMP=0x00000000009837e3
- (id)schemaHashForObject:(id)arg1;	// IMP=0x0000000000983692
- (id)init;	// IMP=0x0000000000983408
