...
- (void).cxx_destruct;	// IMP=0x0000000000712509
...
- (id)attributeDescriptions;	// IMP=0x00000000007122f8
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2;	// IMP=0x000000000071226c
