...
@interface HMDHomePodSetupLatencyLogEvent : HMMLogEvent
{
    ...
    unsigned long long _siriReadinessTime;	// 48 = 0x30
}

+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x001000000051a12d
...
- (id)initWithSetupStartTime:(unsigned long long)arg1 setupEndTime:(unsigned long long)arg2 settingsCreationTime:(unsigned long long)arg3 pairingIdentityCreationTime:(unsigned long long)arg4 accessoryAddProcessedTime:(unsigned long long)arg5 siriReadinessTime:(unsigned long long)arg6;	// IMP=0x0000000000519d3e
