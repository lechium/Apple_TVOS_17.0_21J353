...
+ (id)localizedBodyForAddedEcosystemHomeName:(id)arg1 accessoryName:(id)arg2 accessoryCategory:(id)arg3;	// IMP=0x00600000006a7d98
+ (id)localizedTitleForAddedEcosystemName:(id)arg1;	// IMP=0x00600000006a7bff
- (void).cxx_destruct;	// IMP=0x00000000006a7b9b
...
- (id)attributeDescriptions;	// IMP=0x00000000006a787a
- (id)initWithAddedPairing:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000006a72f1
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x00000000006a70ff
