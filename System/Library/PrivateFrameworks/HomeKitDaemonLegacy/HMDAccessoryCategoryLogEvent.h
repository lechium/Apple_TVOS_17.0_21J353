...
+ (id)denominatorSpecifyingEvent;	// IMP=0x0010000000094edb
- (void).cxx_destruct;	// IMP=0x0000000000094ec8
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x0000000000094e82
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x0000000000094bc3
