...
@interface HMDCameraAccessorySettingsConfiguration : HMFObject
{
    ...
    _Bool _inclusionZone;	// 10 = 0xa
    _Bool _smartBulletinBoardNotificationEnabled;	// 11 = 0xb
    _Bool _reachabilityNotificationEnabled;	// 12 = 0xc
...
- (id)initWithCameraAccessory:(id)arg1;	// IMP=0x00000000004a1163
