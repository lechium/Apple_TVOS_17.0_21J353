...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000083174
- (unsigned long long)hash;	// IMP=0x0000000000082e23
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000082cc0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082bd1
- (void)copyTo:(id)arg1;	// IMP=0x0000000000082b05
- (void)writeTo:(id)arg1;	// IMP=0x0000000000082a0c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000829ff
- (id)dictionaryRepresentation;	// IMP=0x00000000000827a8
- (id)description;	// IMP=0x00000000000826f9
