...
+ (id)logCategory;	// IMP=0x00100000007429bd
- (void).cxx_destruct;	// IMP=0x0000000000742959
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000742486
- (void)dealloc;	// IMP=0x000000000074240a
- (id)logIdentifier;	// IMP=0x00000000007423ba
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000007421e3
