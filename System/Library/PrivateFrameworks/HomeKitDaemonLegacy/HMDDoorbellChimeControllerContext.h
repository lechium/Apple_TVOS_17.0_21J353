...
- (void).cxx_destruct;	// IMP=0x000000000066e388
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x000000000066e30e
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x000000000066e22a
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x000000000066e211
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x000000000066e209
- (id)postCoordinationState:(id)arg1;	// IMP=0x000000000066e1f0
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x000000000066dfa6
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x000000000066dd37
