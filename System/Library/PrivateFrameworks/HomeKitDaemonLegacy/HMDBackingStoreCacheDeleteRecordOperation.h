...
- (void).cxx_destruct;	// IMP=0x00000000001fba28
...
- (id)mainReturningError;	// IMP=0x00000000001fb5ac
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001fb4f6
