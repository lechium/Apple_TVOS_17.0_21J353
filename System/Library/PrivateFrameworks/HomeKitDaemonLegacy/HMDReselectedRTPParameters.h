...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000777d1
- (void).cxx_destruct;	// IMP=0x000000000007778f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000077679
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000077428
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000772da
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000077143
@property(readonly, copy) NSData *tlvData;
- (id)initWithMaximumBitrate:(id)arg1 minimumBitrate:(id)arg2 rtcpInterval:(id)arg3;	// IMP=0x0000000000076f49
