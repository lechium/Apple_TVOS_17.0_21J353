...
+ (id)logCategory;	// IMP=0x001000000040a481
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x001000000040a20e
- (void).cxx_destruct;	// IMP=0x000000000040825a
...
- (id)logIdentifier;	// IMP=0x00000000004080f3
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000407a3c
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000040780f
- (void)_commitConfigurationUpdate;	// IMP=0x00000000004076d6
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000407535
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x00000000004074c4
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000407358
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000040721a
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000004070b5
