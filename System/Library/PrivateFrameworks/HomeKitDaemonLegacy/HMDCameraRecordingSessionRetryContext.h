...
- (void).cxx_destruct;	// IMP=0x00000000005869f9
...
- (void)computeNextRetryInterval;	// IMP=0x0000000000586922
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x000000000058664f
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000005865b8
