...
- (void).cxx_destruct;	// IMP=0x00000000001d6072
...
- (void)addModelToBeUpdated:(id)arg1;	// IMP=0x00000000001d5fc2
- (void)removeModelWithIdentifier:(id)arg1;	// IMP=0x00000000001d5f59
- (void)addModel:(id)arg1;	// IMP=0x00000000001d5ef0
- (void)addSettingModel:(id)arg1;	// IMP=0x00000000001d5dae
- (id)initForInitialCreationWithTransactionLabel:(id)arg1;	// IMP=0x00000000001d5ce1
- (id)initWithTransactionLabel:(id)arg1;	// IMP=0x00000000001d5c14
