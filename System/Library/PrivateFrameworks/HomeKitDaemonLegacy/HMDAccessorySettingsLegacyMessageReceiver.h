...
- (void).cxx_destruct;	// IMP=0x000000000023e184
...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x000000000023df24
- (void)routeAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x000000000023dd18
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x000000000023dada
- (id)initWithMessageTargetUUID:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x000000000023da16
