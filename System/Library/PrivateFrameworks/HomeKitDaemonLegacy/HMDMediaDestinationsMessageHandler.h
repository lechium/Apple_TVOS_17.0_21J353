...
- (void).cxx_destruct;	// IMP=0x00000000008c3c9b
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x00000000008c3baa
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x00000000008c37ab
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000008c3637
