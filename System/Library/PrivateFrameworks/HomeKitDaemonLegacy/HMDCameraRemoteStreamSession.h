...
+ (id)logCategory;	// IMP=0x0010000000642154
- (void).cxx_destruct;	// IMP=0x0000000000642080
...
- (id)logIdentifier;	// IMP=0x0000000000641fe2
- (id)stateAsString;	// IMP=0x0000000000641f26
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000641f03
- (void)updateState:(long long)arg1;	// IMP=0x0000000000641da8
- (void)dealloc;	// IMP=0x0000000000641cc3
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 streamReceiver:(id)arg4 remoteCapabilities:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000641b96
