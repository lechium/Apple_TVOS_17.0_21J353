...
+ (id)logCategory;	// IMP=0x0010000000997c94
- (void).cxx_destruct;	// IMP=0x0000000000997bb1
...
- (id)logIdentifier;	// IMP=0x0000000000997aec
- (id)stateAsString;	// IMP=0x0000000000997a30
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000997a0d
- (void)updateState:(long long)arg1;	// IMP=0x00000000009978b2
- (void)dealloc;	// IMP=0x00000000009977cd
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000997669
