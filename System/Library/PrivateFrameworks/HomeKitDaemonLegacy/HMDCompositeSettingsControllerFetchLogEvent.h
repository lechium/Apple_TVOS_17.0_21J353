...
- (void).cxx_destruct;	// IMP=0x00000000002206be
@property(readonly, copy) NSString *keyPath; // @synthesize keyPath=_keyPath;
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)dictionaryRepresentation;	// IMP=0x00000000002202fe
- (id)initWithKeyPath:(id)arg1 date:(id)arg2;	// IMP=0x000000000022025b
