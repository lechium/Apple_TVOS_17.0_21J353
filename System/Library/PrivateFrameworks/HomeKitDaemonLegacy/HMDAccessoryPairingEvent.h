...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00100000005185ce
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x0010000000518522
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x001000000051849c
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x001000000051842a
- (void).cxx_destruct;	// IMP=0x00000000005182d8
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x0000000000517c24
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x0000000000517b9a
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
- (id)getLowestError:(id)arg1;	// IMP=0x0000000000516a47
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x0000000000515f2c
- (_Bool)_isMatterAccessory;	// IMP=0x0000000000515f17
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x0000000000515e71
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x0000000000515a21
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x000000000051588d
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x000000000051561d
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x000000000051560b
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x00000000005155f9
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x0000000000514d8b
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x0000000000513ef3
