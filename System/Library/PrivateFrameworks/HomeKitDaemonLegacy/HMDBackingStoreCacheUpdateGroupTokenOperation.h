...
- (void).cxx_destruct;	// IMP=0x00000000001fa951
...
- (id)mainReturningError;	// IMP=0x00000000001fa5b8
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001fa502
