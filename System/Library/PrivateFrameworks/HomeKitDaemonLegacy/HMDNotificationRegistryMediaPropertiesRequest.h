...
- (void).cxx_destruct;	// IMP=0x0000000000712b61
...
- (id)attributeDescriptions;	// IMP=0x000000000071295e
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 mediaProfileUUID:(id)arg3;	// IMP=0x0000000000712857
