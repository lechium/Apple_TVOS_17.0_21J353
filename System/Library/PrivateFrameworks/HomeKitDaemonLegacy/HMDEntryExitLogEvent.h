...
+ (id)exitLogEvent:(double)arg1 isFalse:(_Bool)arg2;	// IMP=0x001000000041db69
+ (id)entryLogEvent:(double)arg1 isFalse:(_Bool)arg2;	// IMP=0x001000000041db29
...
- (id)initWithReason:(unsigned long long)arg1 isFalse:(_Bool)arg2 lastFired:(double)arg3;	// IMP=0x000000000041d7f5
