...
- (void).cxx_destruct;	// IMP=0x00000000001fadd1
...
- (id)mainReturningError;	// IMP=0x00000000001faa38
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001fa982
