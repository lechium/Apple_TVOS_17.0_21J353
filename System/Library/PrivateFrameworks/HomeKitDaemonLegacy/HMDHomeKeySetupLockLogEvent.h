...
- (void).cxx_destruct;	// IMP=0x0000000000690601
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006904ee
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x00000000006902ab
- (void)submitSuccess;	// IMP=0x000000000069022f
- (_Bool)incrementCompleted;	// IMP=0x00000000006901bb
- (id)initWithAccessoryUUID:(id)arg1 withKeyType:(unsigned long long)arg2 expectedCount:(long long)arg3 queue:(id)arg4;	// IMP=0x000000000069008a
