...
- (void).cxx_destruct;	// IMP=0x0000000000421219
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x0000000000421161
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x0000000000420ee2
- (void)_update;	// IMP=0x0000000000420d3d
- (void)stop;	// IMP=0x0000000000420ceb
- (void)start;	// IMP=0x0000000000420c99
- (void)dealloc;	// IMP=0x0000000000420c15
- (id)init;	// IMP=0x0000000000420b8c
