...
- (void).cxx_destruct;	// IMP=0x0000000000675f67
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x0000000000675dbd
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000675a0b
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x00000000006754fc
