...
{
    NSNumber *_supportsAudioAnalysis;	// 8 = 0x8
    NSNumber *_supportsDropIn;	// 16 = 0x10
}

+ (id)properties;	// IMP=0x00600000008de157
+ (id)schemaHashRoot;	// IMP=0x00600000008de136
- (void).cxx_destruct;	// IMP=0x00000000008de105
@property(copy, nonatomic) NSNumber *supportsDropIn; // @synthesize supportsDropIn=_supportsDropIn;
@property(copy, nonatomic) NSNumber *supportsAudioAnalysis; // @synthesize supportsAudioAnalysis=_supportsAudioAnalysis;
