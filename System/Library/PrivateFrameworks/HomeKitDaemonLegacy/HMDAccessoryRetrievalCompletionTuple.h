...
- (void).cxx_destruct;	// IMP=0x0000000000a9ae82
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a9aaa7
- (void)stop;	// IMP=0x0000000000a9a9fd
- (void)start;	// IMP=0x0000000000a9a884
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a9a7b6
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000a9a695
