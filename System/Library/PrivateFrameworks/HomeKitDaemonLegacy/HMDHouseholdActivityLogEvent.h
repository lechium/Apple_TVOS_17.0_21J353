...
+ (id)logCategory;	// IMP=0x00100000004649bf
+ (id)coalescedEventFromHouseholdActivityLogEvents:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x00100000004643ee
- (void).cxx_destruct;	// IMP=0x00000000004643db
...
- (id)submitEventWithHistogrammedHomeDataCommonDimensionsForSpecifiedHome;	// IMP=0x00000000004640cc
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)serializedMetric;	// IMP=0x0000000000463d4a
- (id)initWithDictionary:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000463a70
- (id)initPopulatedFromDate:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x00000000004638ac
- (id)initWithHomeUUID:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000463828
