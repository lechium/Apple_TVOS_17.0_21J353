...
+ (id)logCategory;	// IMP=0x00100000009bef35
- (void).cxx_destruct;	// IMP=0x00000000009bea32
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x00000000009be847
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x00000000009be699
- (void)sessionStarted:(id)arg1;	// IMP=0x00000000009be50d
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x00000000009be391
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x00000000009be215
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x00000000009be0d9
- (void)dealloc;	// IMP=0x00000000009bdf70
- (void)_startDataTransfer;	// IMP=0x00000000009bdcb4
- (void)sendIDSInvitation;	// IMP=0x00000000009bd7e3
- (void)_sendData;	// IMP=0x00000000009bd74a
- (void)sendData:(id)arg1;	// IMP=0x00000000009bd561
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000009bd3c7
