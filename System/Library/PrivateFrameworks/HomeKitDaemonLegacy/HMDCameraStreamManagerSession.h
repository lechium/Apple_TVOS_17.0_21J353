...
+ (id)logCategory;	// IMP=0x001000000007f743
- (void).cxx_destruct;	// IMP=0x000000000007f6ce
...
- (id)logIdentifier;	// IMP=0x000000000007f5d8
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x000000000007f409
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x000000000007f286
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x000000000007f153
