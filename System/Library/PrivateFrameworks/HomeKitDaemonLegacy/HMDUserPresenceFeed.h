...
- (void).cxx_destruct;	// IMP=0x0000000000023a78
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002375c
- (id)description;	// IMP=0x0000000000023644
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x000000000002352e
