...
- (void).cxx_destruct;	// IMP=0x00000000001fc0e8
...
- (id)mainReturningError;	// IMP=0x00000000001fbe8a
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001fbdce
