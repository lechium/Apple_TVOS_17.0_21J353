...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000004ca33b
- (void).cxx_destruct;	// IMP=0x00000000004ca313
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004ca021
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c9f93
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004c9cca
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004c9998
- (id)initWithOperation:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000004c98ff
- (id)init;	// IMP=0x00000000004c98d0
