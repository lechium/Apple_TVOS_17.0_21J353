...
+ (id)logCategory;	// IMP=0x001000000008d2ca
...
- (id)logIdentifier;	// IMP=0x000000000008d1ea
- (_Bool)shouldRetryImmediately:(double)arg1;	// IMP=0x000000000008d1be
@property(readonly) double retryTimeInterval;
- (void)cancel;	// IMP=0x000000000008d13c
- (void)startWithDelegate:(id)arg1 delegateQueue:(id)arg2 responseTime:(double)arg3;	// IMP=0x000000000008cd57
- (id)attributeDescriptions;	// IMP=0x000000000008cc23
- (id)init;	// IMP=0x000000000008cbb6
