...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x0010000000609cd9
+ (Class)hapServicesListCertifiedType;	// IMP=0x0010000000609cc8
+ (Class)primaryHAPServicesListType;	// IMP=0x0010000000609cb7
+ (Class)hapServicesListType;	// IMP=0x0010000000609ca6
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x0010000000609c95
+ (Class)eventTriggersType;	// IMP=0x0010000000609c84
- (void).cxx_destruct;	// IMP=0x0000000000606629
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000604b66
- (unsigned long long)hash;	// IMP=0x0000000000603d95
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000602b0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000601418
- (void)copyTo:(id)arg1;	// IMP=0x000000000060023d
- (void)writeTo:(id)arg1;	// IMP=0x00000000005fec95
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005fec88
- (id)dictionaryRepresentation;	// IMP=0x00000000005fbe5b
- (id)description;	// IMP=0x00000000005fbdac
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x00000000005fb87f
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x00000000005fb834
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005faef7
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x00000000005faeda
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x00000000005fae70
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x00000000005fae53
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005fae36
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x00000000005fae19
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x00000000005fadaf
- (void)clearHapServicesListCertifieds;	// IMP=0x00000000005fad92
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005fad75
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x00000000005fad58
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x00000000005facee
- (void)clearPrimaryHAPServicesLists;	// IMP=0x00000000005facd1
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005facb4
- (unsigned long long)hapServicesListsCount;	// IMP=0x00000000005fac97
- (void)addHapServicesList:(id)arg1;	// IMP=0x00000000005fac2d
- (void)clearHapServicesLists;	// IMP=0x00000000005fac10
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005fa9e8
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x00000000005fa9cb
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x00000000005fa961
- (void)clearHomeKitMultiUserSettings;	// IMP=0x00000000005fa944
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x00000000005fa5ea
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x00000000005fa5a2
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005f9f41
- (unsigned long long)eventTriggersCount;	// IMP=0x00000000005f9f24
- (void)addEventTriggers:(id)arg1;	// IMP=0x00000000005f9eba
- (void)clearEventTriggers;	// IMP=0x00000000005f9e9d
