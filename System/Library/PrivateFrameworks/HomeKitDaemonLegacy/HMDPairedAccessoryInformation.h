...
- (void).cxx_destruct;	// IMP=0x00000000008886c2
...
- (id)description;	// IMP=0x00000000008885e7
- (unsigned long long)hash;	// IMP=0x00000000008885a3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008884c7
- (id)initWithIdentifier:(id)arg1 transports:(unsigned long long)arg2 setupHash:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000008883dd
- (id)init;	// IMP=0x0000000000888335
