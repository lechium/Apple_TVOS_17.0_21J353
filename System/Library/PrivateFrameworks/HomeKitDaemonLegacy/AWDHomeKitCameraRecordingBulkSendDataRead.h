...
- (void).cxx_destruct;	// IMP=0x00000000008d4c5e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008d49d2
- (unsigned long long)hash;	// IMP=0x00000000008d4842
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008d45da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008d440f
- (void)copyTo:(id)arg1;	// IMP=0x00000000008d4276
- (void)writeTo:(id)arg1;	// IMP=0x00000000008d40bc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008d39a6
- (id)dictionaryRepresentation;	// IMP=0x00000000008d35a2
- (id)description;	// IMP=0x00000000008d34f3
