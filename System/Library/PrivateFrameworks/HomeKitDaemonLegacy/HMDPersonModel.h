...
+ (id)sentinelParentUUID;	// IMP=0x004000000069b642
+ (id)hmbProperties;	// IMP=0x004000000069b612
- (id)createPerson;	// IMP=0x000000000069bca2
- (id)initWithPerson:(id)arg1;	// IMP=0x000000000069bb8d
