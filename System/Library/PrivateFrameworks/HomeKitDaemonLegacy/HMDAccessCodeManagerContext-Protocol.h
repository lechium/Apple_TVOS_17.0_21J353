...
@class HMAccessCodeValue, HMDBulletinBoard, HMDDevice, HMDHAPAccessory, HMDHome, HMDHomeAdministratorHandler, HMDRemoteMessageForwarder, HMDUser, HMFMessage, HMFMessageDispatcher, NAFuture, NSArray, NSNotificationCenter, NSObject, NSUUID;
