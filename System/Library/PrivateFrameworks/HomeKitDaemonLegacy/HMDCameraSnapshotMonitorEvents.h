...
+ (id)logCategory;	// IMP=0x001000000068d396
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x001000000068d38e
- (void).cxx_destruct;	// IMP=0x0000000000689503
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000068905d
- (void)handleCameraSettingsDidUpdateNotification:(id)arg1;	// IMP=0x0000000000688fa6
- (void)handleCharacteristicsChangedNotification:(id)arg1;	// IMP=0x0000000000688eef
- (void)handleBulletinBoardNotificationDidUpdateNotification:(id)arg1;	// IMP=0x0000000000688e38
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x0000000000688ce8
- (void)dealloc;	// IMP=0x0000000000688b28
- (void)registerForMessages;	// IMP=0x0000000000688928
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000006883df
