...
+ (id)logCategory;	// IMP=0x00100000007161f6
- (void).cxx_destruct;	// IMP=0x0000000000716192
...
- (void)dealloc;	// IMP=0x0000000000716006
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000715e75
