...
+ (id)sharedState;	// IMP=0x00600000007b6553
- (void).cxx_destruct;	// IMP=0x00000000007b6540
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x00000000007b64d3
- (void)registerDelegate:(id)arg1;	// IMP=0x00000000007b645d
...
- (id)init;	// IMP=0x00000000007b5ffb
