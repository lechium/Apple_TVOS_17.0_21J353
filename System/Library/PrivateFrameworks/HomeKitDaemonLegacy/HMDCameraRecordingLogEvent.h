...
- (void).cxx_destruct;	// IMP=0x000000000053dba1
...
- (id)attributeDescriptions;	// IMP=0x000000000053d8cb
...
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x000000000053d6de
