...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000006b06b
+ (_Bool)translateImageResolution:(id)arg1 imageWidth:(id *)arg2 imageHeight:(id *)arg3;	// IMP=0x001000000006b01a
- (void).cxx_destruct;	// IMP=0x000000000006afc7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006aea0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006abf1
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006aa35
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006a72e
- (id)translateImageWidth:(id)arg1 imageHeight:(id)arg2;	// IMP=0x000000000006a06a
- (id)initWithResolution:(id)arg1 framerate:(id)arg2;	// IMP=0x0000000000069efd
