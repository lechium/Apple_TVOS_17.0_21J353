...
+ (id)logCategory;	// IMP=0x00100000009029e9
- (void).cxx_destruct;	// IMP=0x0000000000901c70
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x000000000090104e
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000900ed5
