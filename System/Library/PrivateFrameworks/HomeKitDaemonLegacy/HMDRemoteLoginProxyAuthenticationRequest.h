...
+ (id)xpcMessageName;	// IMP=0x001000000035eef1
+ (id)messageName;	// IMP=0x001000000035eee4
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000035eedc
+ (id)objWithMessage:(id)arg1;	// IMP=0x001000000035ed45
+ (id)objWithDict:(id)arg1;	// IMP=0x001000000035ebcc
- (void).cxx_destruct;	// IMP=0x000000000035eb79
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000035e984
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000035e849
