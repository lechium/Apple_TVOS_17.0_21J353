...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00600000009a4947
- (void).cxx_destruct;	// IMP=0x00000000009a4914
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x00000000009a4795
