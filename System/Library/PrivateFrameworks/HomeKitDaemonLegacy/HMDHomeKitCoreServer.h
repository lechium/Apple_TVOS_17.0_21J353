...
+ (id)logCategory;	// IMP=0x001000000086c1e1
- (void).cxx_destruct;	// IMP=0x000000000086c884
...
- (void)_handleXPCEvent:(id)arg1;	// IMP=0x000000000086c68b
- (void)_startUpEmptyMachServices;	// IMP=0x000000000086c319
- (void)configureWithQueue:(id)arg1;	// IMP=0x000000000086c248
