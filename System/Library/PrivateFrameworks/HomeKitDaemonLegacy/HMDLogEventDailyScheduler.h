...
+ (id)logCategory;	// IMP=0x0010000000231737
+ (id)createSchedulerWithLogEventSubmitter:(id)arg1;	// IMP=0x001000000023162a
- (void).cxx_destruct;	// IMP=0x0000000000231330
...
- (id)statusSummary;	// IMP=0x0000000000231153
- (void)runHomeutilTasks;	// IMP=0x0000000000230e7a
- (void)runDailyTasks;	// IMP=0x0000000000230c57
- (id)taskRunners;	// IMP=0x0000000000230bef
- (void)registerDailyTaskRunner:(id)arg1;	// IMP=0x0000000000230b79
- (void)_runActivity:(id)arg1;	// IMP=0x0000000000230778
- (void)_handleCheckInForActivity:(id)arg1;	// IMP=0x00000000002304ea
- (void)_registerActivity;	// IMP=0x000000000023030d
- (id)_criteriaForActivity;	// IMP=0x000000000023026e
- (id)initWithIdentifier:(id)arg1 preferencesKey:(id)arg2 logEventSubmitter:(id)arg3 xpcActivityInterface:(id)arg4 dateFactory:(CDUnknownBlockType)arg5;	// IMP=0x0000000000230082
