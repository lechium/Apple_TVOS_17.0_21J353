...
+ (id)localIPAddress;	// IMP=0x00100000005bfa75
- (void).cxx_destruct;	// IMP=0x00000000005bfa44
...
- (id)description;	// IMP=0x00000000005bf8ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005bf80b
- (id)initWithAddress:(id)arg1 ipv6:(_Bool)arg2 rtpPort:(id)arg3;	// IMP=0x00000000005bf768
- (id)init;	// IMP=0x00000000005bf729
