...
+ (void)loadEnableMediaAccessories;	// IMP=0x001000000026868d
- (void).cxx_destruct;	// IMP=0x000000000026867a
@property(readonly) HMFSystemPreference *homeKitPreference; // @synthesize homeKitPreference=_homeKitPreference;
- (id)stringValue;	// IMP=0x0000000000268614
- (id)numberValue;	// IMP=0x00000000002684ec
- (_Bool)boolValue;	// IMP=0x00000000002684a8
...
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x0000000000268214
