...
+ (id)logCategory;	// IMP=0x0060000000406aa4
- (void).cxx_destruct;	// IMP=0x0000000000405c8a
...
- (void)_notifyDelegateWifiInfoUpdated:(id)arg1;	// IMP=0x00000000004059e3
- (void)_postUpdateSoftwareVersionIfDifferent:(id)arg1;	// IMP=0x0000000000405870
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x00000000004056c5
- (id)currentWifiNetworkInfo;	// IMP=0x00000000004055f8
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000004053a4
- (void)configure;	// IMP=0x000000000040521d
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 delegate:(id)arg3 notificationCenter:(id)arg4 wifiManager:(id)arg5;	// IMP=0x000000000040511a
