...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000074ba7
- (void).cxx_destruct;	// IMP=0x0000000000074b21
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000748d1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007443c
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000741fa
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000073e7c
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x0000000000073b44
