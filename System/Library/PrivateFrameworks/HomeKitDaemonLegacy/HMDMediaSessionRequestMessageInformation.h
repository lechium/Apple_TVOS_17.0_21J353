...
+ (id)logCategory;	// IMP=0x001000000063e6be
- (void).cxx_destruct;	// IMP=0x000000000063e6ab
@property(readonly) HMFMessage *message; // @synthesize message=_message;
- (id)attributeDescriptions;	// IMP=0x000000000063e577
@property(readonly) HMDDevice *remoteSourceDevice;
@property(readonly, copy) NSUUID *messageIdentifier;
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000063e3b5
