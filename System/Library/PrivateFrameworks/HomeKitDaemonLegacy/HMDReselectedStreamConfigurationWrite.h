...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000787ca
- (void).cxx_destruct;	// IMP=0x0000000000078799
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000786c9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000078509
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000783e4
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000781da
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionControl:(id)arg1;	// IMP=0x000000000007804b
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2;	// IMP=0x0000000000077fa9
