...
+ (id)logCategory;	// IMP=0x00100000009b37a1
- (void).cxx_destruct;	// IMP=0x00000000009b363f
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000009b336f
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x00000000009b32b7
- (void)handleAccessoryConfigured:(id)arg1;	// IMP=0x00000000009b3246
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x00000000009b26b8
- (void)start;	// IMP=0x00000000009b2567
- (void)dealloc;	// IMP=0x00000000009b23f1
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x00000000009b21d4
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000009b1ff0
