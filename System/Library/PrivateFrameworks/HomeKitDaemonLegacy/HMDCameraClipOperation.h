...
+ (id)logCategory;	// IMP=0x00100000002d63c3
+ (id)shortDescription;	// IMP=0x00100000002d63b1
+ (unsigned long long)cameraClipOperationType;	// IMP=0x00100000002d6309
- (void).cxx_destruct;	// IMP=0x00000000002d6272
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x00000000002d5d33
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000002d59e4
- (id)fetchClipModel;	// IMP=0x00000000002d5796
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000002d567e
- (void)finish;	// IMP=0x00000000002d5566
- (void)main;	// IMP=0x00000000002d54e2
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000002d515f
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x00000000002d50d9
