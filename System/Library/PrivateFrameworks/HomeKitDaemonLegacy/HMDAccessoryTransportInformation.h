...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000415aa3
- (void).cxx_destruct;	// IMP=0x0000000000415a3f
...
- (id)attributeDescriptions;	// IMP=0x000000000041582c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000041575a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000415549
- (id)report;	// IMP=0x000000000041535a
...
- (id)initWithServerIdentifier:(id)arg1 instanceID:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000414ec2
