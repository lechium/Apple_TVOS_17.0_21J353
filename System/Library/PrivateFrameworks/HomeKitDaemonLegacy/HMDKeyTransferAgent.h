...
@interface HMDKeyTransferAgent : HMFObject
{
...
+ (id)logCategory;	// IMP=0x00100000006632e7
- (void).cxx_destruct;	// IMP=0x0000000000663296
...
- (void)resetConfig;	// IMP=0x0000000000663095
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000662f74
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000662e03
