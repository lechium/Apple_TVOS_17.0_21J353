...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x0060000000347237
+ (id)hmbProperties;	// IMP=0x0060000000347207
- (id)userActionPrediction;	// IMP=0x0000000000347dba
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x00000000003477b5
