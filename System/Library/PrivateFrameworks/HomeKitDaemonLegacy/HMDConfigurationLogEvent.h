...
@interface HMDConfigurationLogEvent : HMMLogEvent
{
    ...
    _Bool _isDeviceHH2Enabled;	// 14 = 0xe
...
- (void).cxx_destruct;	// IMP=0x0000000000271bb6
...
- (_Bool)isSubmitted;	// IMP=0x00000000002718ed
...
- (id)initWithHomeConfigurations:(id)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x0000000000270e7a
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x0000000000270be7
