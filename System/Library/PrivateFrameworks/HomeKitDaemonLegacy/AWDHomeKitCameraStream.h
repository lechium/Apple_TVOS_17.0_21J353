...
+ (Class)resolutionCountType;	// IMP=0x00100000004255f9
+ (Class)reconfigurationsType;	// IMP=0x00100000004255e8
- (void).cxx_destruct;	// IMP=0x000000000042550d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000424ce4
- (unsigned long long)hash;	// IMP=0x0000000000424a09
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004245ba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000423fb3
- (void)copyTo:(id)arg1;	// IMP=0x0000000000423bf2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000423758
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000422d94
- (id)dictionaryRepresentation;	// IMP=0x0000000000422344
- (id)description;	// IMP=0x0000000000422295
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000422278
- (unsigned long long)resolutionCountsCount;	// IMP=0x000000000042225b
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000004221f1
- (void)clearResolutionCounts;	// IMP=0x00000000004221d4
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x0000000000422030
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x0000000000421fe5
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000421d96
- (unsigned long long)reconfigurationsCount;	// IMP=0x0000000000421d79
- (void)addReconfigurations:(id)arg1;	// IMP=0x0000000000421d0f
- (void)clearReconfigurations;	// IMP=0x0000000000421cf2
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000421b06
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000421abe
