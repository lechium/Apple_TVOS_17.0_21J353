...
- (void).cxx_destruct;	// IMP=0x000000000059232d
@property(readonly, nonatomic) NSString *name; // @synthesize name=_name;
@property(readonly, nonatomic) NSString *uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
@property(nonatomic) void *outputDevice; // @synthesize outputDevice=_outputDevice;
- (_Bool)shouldCreateAppleMediaAccessory;	// IMP=0x00000000005922a6
- (id)description;	// IMP=0x0000000000592228
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000592111
- (unsigned long long)hash;	// IMP=0x00000000005920f4
- (void)dealloc;	// IMP=0x00000000005920ae
...
- (id)initWithOutputDevice:(void *)arg1;	// IMP=0x0000000000591e2a
