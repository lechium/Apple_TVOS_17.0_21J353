...
- (void).cxx_destruct;	// IMP=0x00000000004a94fb
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchiveLegacyEventFlags;	// IMP=0x00000000004a93a7
- (id)unarchive;	// IMP=0x00000000004a9114
- (void)archiveDictionary:(id)arg1;	// IMP=0x00000000004a9021
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x00000000004a8fbd
