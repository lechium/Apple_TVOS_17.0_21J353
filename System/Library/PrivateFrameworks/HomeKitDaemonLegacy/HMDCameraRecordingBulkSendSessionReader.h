...
+ (id)logCategory;	// IMP=0x001000000079e152
- (void).cxx_destruct;	// IMP=0x000000000079d625
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000079d485
- (void)stopWithReason:(unsigned short)arg1;	// IMP=0x000000000079d443
- (void)start;	// IMP=0x000000000079d2a7
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readCallbackTimer:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x000000000079d196
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readTimeout:(double)arg3 logIdentifier:(id)arg4;	// IMP=0x000000000079d0d1
