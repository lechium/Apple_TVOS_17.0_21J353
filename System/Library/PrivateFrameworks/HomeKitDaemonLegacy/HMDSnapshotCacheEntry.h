...
- (void).cxx_destruct;	// IMP=0x0000000000952d87
...
- (id)description;	// IMP=0x0000000000952c9f
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000952bd5
