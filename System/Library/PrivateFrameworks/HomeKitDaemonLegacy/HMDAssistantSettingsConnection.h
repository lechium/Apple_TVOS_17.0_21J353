...
+ (id)logCategory;	// IMP=0x00100000002aaa38
- (void).cxx_destruct;	// IMP=0x00000000002aa86e
...
- (id)deleteSiriHistoryOperationWithConnection:(id)arg1;	// IMP=0x00000000002aa7de
- (id)connectionForEndpointUUID:(id)arg1;	// IMP=0x00000000002aa715
- (void)deleteSiriHistoryWithEndpointUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002aa2de
- (id)initWithScheduler:(id)arg1;	// IMP=0x00000000002aa270
