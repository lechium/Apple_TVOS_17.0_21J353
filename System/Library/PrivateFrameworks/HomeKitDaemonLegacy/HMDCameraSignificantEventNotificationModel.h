...
+ (id)significantEventsBetweenDatesQueryWithIsAscending:(_Bool)arg1;	// IMP=0x00600000002a54db
+ (id)hmbQueries;	// IMP=0x00600000002a5410
+ (id)hmbExternalRecordType;	// IMP=0x00600000002a5403
+ (id)hmbProperties;	// IMP=0x00600000002a53d3
- (id)createClipSignificantEventWithCameraProfileUUID:(id)arg1 faceClassification:(id)arg2;	// IMP=0x00000000002a5c10
