...
- (void).cxx_destruct;	// IMP=0x00000000000ad0c2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000acfc8
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000acf26
