...
- (void).cxx_destruct;	// IMP=0x00000000007106fa
...
- (id)attributeDescriptions;	// IMP=0x0000000000710361
- (id)serializeFields;	// IMP=0x0000000000710168
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x000000000070ff55
