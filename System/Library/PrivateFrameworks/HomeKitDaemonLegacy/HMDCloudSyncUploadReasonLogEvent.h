...
+ (id)uploadReason:(id)arg1 acceptedHomeManagerZonePush:(_Bool)arg2;	// IMP=0x0060000000506dae
+ (id)uploadReason:(id)arg1 acceptedHomeZonePush:(_Bool)arg2;	// IMP=0x0060000000506d47
+ (id)uploadReason:(id)arg1 acceptedLegacyPush:(_Bool)arg2;	// IMP=0x0060000000506ce0
- (void).cxx_destruct;	// IMP=0x0000000000506ccd
...
- (id)initWithUploadReason:(id)arg1 legacyPushCount:(long long)arg2 homeZonePushCount:(long long)arg3 homeManagerPushCount:(long long)arg4;	// IMP=0x0000000000506be4
