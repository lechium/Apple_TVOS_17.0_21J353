...
- (void).cxx_destruct;	// IMP=0x0000000000afb3a0
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x0000000000afb1d5
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000afb02d
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000afac58
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000afa8e2
