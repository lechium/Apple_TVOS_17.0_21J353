...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000075830
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000075681
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007539f
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007517a
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000074e8f
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x0000000000074baf
