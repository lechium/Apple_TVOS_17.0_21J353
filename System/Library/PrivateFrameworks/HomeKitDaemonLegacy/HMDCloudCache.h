...
- (void).cxx_destruct;	// IMP=0x00000000009adeb9
...
- (void)persistDatabaseServerChangeToken;	// IMP=0x00000000009ade05
@property(retain, nonatomic) CKServerChangeToken *databaseServerChangeToken;
- (void)deleteHomeZoneWithName:(id)arg1;	// IMP=0x00000000009adb91
- (void)deleteAllZones;	// IMP=0x00000000009ad804
- (void)homeZoneWithName:(id)arg1 owner:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000009ad667
- (id)homeZoneWithName:(id)arg1;	// IMP=0x00000000009ad5b9
- (_Bool)homeZoneExists:(id)arg1;	// IMP=0x00000000009ad502
- (id)allHomeZones;	// IMP=0x00000000009ad475
- (void)createAndFetchZonesFromBackingStore:(CDUnknownBlockType)arg1;	// IMP=0x00000000009ad284
- (void)_createZones:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000009accc9
- (id)_findStoreCacheZone:(id)arg1 byName:(id)arg2;	// IMP=0x00000000009acad0
...
- (id)initWithBackingStore:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000009ac79c
- (id)init;	// IMP=0x00000000009ac6f4
