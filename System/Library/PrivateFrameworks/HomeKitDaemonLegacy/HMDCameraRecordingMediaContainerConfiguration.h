...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005e4380
- (void).cxx_destruct;	// IMP=0x00000000005e434f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005e427f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005e4193
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000005e4029
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000005e3d27
- (id)initWithMediaContainer:(id)arg1 containerParameters:(id)arg2;	// IMP=0x00000000005e3c85
