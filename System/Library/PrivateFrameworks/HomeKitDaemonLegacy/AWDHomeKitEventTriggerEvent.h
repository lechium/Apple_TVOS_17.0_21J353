...
- (void).cxx_destruct;	// IMP=0x0000000000794aae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000794783
- (unsigned long long)hash;	// IMP=0x0000000000794664
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000794464
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007942ae
- (void)copyTo:(id)arg1;	// IMP=0x000000000079416b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000794039
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000079402c
- (id)dictionaryRepresentation;	// IMP=0x0000000000793d32
- (id)description;	// IMP=0x0000000000793c83
