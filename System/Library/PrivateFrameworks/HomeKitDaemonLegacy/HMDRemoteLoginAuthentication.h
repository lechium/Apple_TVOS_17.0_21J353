...
+ (id)logCategory;	// IMP=0x00100000005855c3
- (void).cxx_destruct;	// IMP=0x0000000000585570
...
- (void)authenticate;	// IMP=0x0000000000585484
- (id)logIdentifier;	// IMP=0x0000000000585472
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x0000000000585375
