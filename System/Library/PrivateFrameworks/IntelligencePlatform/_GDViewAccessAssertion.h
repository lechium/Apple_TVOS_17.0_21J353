...
- (void).cxx_destruct;	// IMP=0x000000000032a090
...
- (void)dealloc;	// IMP=0x0000000000329f33
- (id)initWithViewName:(id)arg1 extensionToken:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000329b93
