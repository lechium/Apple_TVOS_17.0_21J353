...
- (void).cxx_destruct;	// IMP=0x00000000003299f6
- (void)enumeratePeopleWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000329985
- (id)initWithAccessAssertion:(id)arg1 database:(id)arg2;	// IMP=0x0000000000329803
