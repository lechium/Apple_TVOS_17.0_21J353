...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000af52
- (void).cxx_destruct;	// IMP=0x000000000000b345
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000b013
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000ad65
- (id)init;	// IMP=0x000000000000abd7
