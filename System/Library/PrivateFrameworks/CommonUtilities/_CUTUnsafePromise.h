...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005829
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x0000000000005633
- (id)initWithResult:(id)arg1;	// IMP=0x00000000000055b9
- (id)init;	// IMP=0x0000000000005551
