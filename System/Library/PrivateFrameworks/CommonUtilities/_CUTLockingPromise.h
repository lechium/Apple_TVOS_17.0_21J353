...
- (void).cxx_destruct;	// IMP=0x0000000000007922
...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000077c6
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x00000000000075a7
- (id)init;	// IMP=0x0000000000007519
