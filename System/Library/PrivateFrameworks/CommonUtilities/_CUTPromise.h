...
- (void).cxx_destruct;	// IMP=0x00000000000073cb
...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007227
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x00000000000070fc
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000000705f
