...
+ (id)sharedManager;	// IMP=0x006000000045bd04
...
- (void)effectsRegistered:(_Bool)arg1;	// IMP=0x000000000045c727
- (void)encodeProcessedPixelBuffer:(struct __CVBuffer *)arg1 time:(CDStruct_1b6d18a9)arg2 imageData:(id)arg3 processTime:(id)arg4;	// IMP=0x000000000045c641
- (void)resetEffectsLogging;	// IMP=0x000000000045c5e3
- (void)flushRemoteQueue;	// IMP=0x000000000045c2c2
- (void)tearDownRemoteQueues;	// IMP=0x000000000045c2bc
- (void)updateThermalLevel:(int)arg1;	// IMP=0x000000000045bef0
- (_Bool)isFaceMeshTrackingEnabled;	// IMP=0x000000000045bd12
- (void)registerBlocksForService;	// IMP=0x000000000045bd0c
@property(nonatomic) id <VCEffectsManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)releaseAllocators;	// IMP=0x000000000045bcdf
- (_Bool)createAllocators;	// IMP=0x000000000045bcd7
- (_Bool)initializeReceiveQueue:(id)arg1 error:(id *)arg2;	// IMP=0x000000000045bccf
- (void)dealloc;	// IMP=0x000000000045bc2d
- (id)init;	// IMP=0x000000000045bb24
