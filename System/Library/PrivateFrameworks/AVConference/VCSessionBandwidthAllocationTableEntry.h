...
@interface VCSessionBandwidthAllocationTableEntry : NSObject
{
    ...
    NSDictionary *_upgradeQualityTiers;	// 80 = 0x50
    _Bool _subscribedTo;	// 88 = 0x58
    _Bool _startOnDemand;	// 89 = 0x59
    id <VCSessionUplinkBandwidthAllocatorClient> _uplinkClient;	// 96 = 0x60
}

+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001cadd4
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ca948
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x00600000001ca719
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x00600000001ca4d2
...
- (long long)compare:(id)arg1;	// IMP=0x00000000001ca55e
- (id)description;	// IMP=0x00000000001ca3ad
- (void)dealloc;	// IMP=0x00000000001ca34f
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x00000000001ca29e
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x00000000001ca165
