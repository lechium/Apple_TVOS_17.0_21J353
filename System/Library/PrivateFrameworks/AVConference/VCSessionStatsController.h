...
- (void)flushRealTimeReportingStats;	// IMP=0x000000000037e155
- (void)deregisterPeriodicTask;	// IMP=0x000000000037e136
- (void)periodicTask:(void *)arg1;	// IMP=0x000000000037df00
- (void)registerPeriodicTask;	// IMP=0x000000000037deb0
@property(readonly) id reportingAgent;
- (unsigned short)translateTimestampFromMicro:(double)arg1;	// IMP=0x000000000037de89
- (void)stopLocalSessionStatsUpdate;	// IMP=0x000000000037d432
- (void)startLocalSessionStatsSend;	// IMP=0x000000000037cfac
- (void)startLocalSessionStatsReceive;	// IMP=0x000000000037cc2f
- (void)startLocalSessionStatsUpdate;	// IMP=0x000000000037cc01
- (void)sendLocalStats;	// IMP=0x000000000037cb64
- (void)reset;	// IMP=0x000000000037ca89
- (void)dealloc;	// IMP=0x000000000037c8fe
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 uplinkStatsCollector:(id)arg3 downlinkStatsCollector:(id)arg4 reportingAgent:(struct opaqueRTCReporting *)arg5 transportSessionID:(unsigned int)arg6 streamID:(unsigned short)arg7 mediaQueue:(struct tagVCMediaQueue *)arg8;	// IMP=0x000000000037c683
