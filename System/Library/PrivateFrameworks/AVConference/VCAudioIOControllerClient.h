...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x00000000002ac0f4
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x00000000002ac0dc
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x00000000002ac0b0
