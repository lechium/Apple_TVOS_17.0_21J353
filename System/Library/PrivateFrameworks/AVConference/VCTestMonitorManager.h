...
+ (id)sharedManager;	// IMP=0x00600000004242f2
...
- (void)registerBlocksForService;	// IMP=0x000000000042466b
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x0000000000424341
- (void)dealloc;	// IMP=0x0000000000424282
- (id)init;	// IMP=0x00000000004241e0
