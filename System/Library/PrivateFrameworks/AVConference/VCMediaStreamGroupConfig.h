...
- (void)setupStreams;	// IMP=0x000000000017f4f0
...
- (_Bool)addMediaStreamInfo:(id)arg1;	// IMP=0x000000000017f29c
- (void)unlock;	// IMP=0x000000000017f24d
- (void)lock;	// IMP=0x000000000017f23c
- (void)dealloc;	// IMP=0x000000000017f159
- (id)init;	// IMP=0x000000000017f0c9
