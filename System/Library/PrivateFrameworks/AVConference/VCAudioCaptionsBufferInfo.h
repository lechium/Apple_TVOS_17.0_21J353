...
- (unsigned long long)hash;	// IMP=0x00000000002a0441
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a03ac
- (id)description;	// IMP=0x00000000002a0357
- (void)dealloc;	// IMP=0x00000000002a02f3
- (id)initWithStreamToken:(long long)arg1 format:(struct AudioStreamBasicDescription)arg2 bufferLength:(double)arg3;	// IMP=0x00000000002a00ca
