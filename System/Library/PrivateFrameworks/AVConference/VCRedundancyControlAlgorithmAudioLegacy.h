...
- (void)computeRedundancyInfo;	// IMP=0x0000000000406f9e
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000406f20
