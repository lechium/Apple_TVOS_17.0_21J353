...
- (void)deregisterPeriodicTask;	// IMP=0x000000000037aaee
- (void)setErrorResponseCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000037aad2
- (id)sessionInfoSynchronizerDelegate;	// IMP=0x000000000037aac4
@property(readonly) id reportingAgent;
- (void)setVCIDSSessionInfoPublishedStreamIDs:(id)arg1;	// IMP=0x000000000037a65f
- (void)sendVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x000000000037a276
- (void)retryVCIDSSessionInfoSubscribedStreamIDs;	// IMP=0x000000000037a04c
- (void)setVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x0000000000379cee
- (void)dealloc;	// IMP=0x0000000000379c14
- (void)flushRealTimeReportingStats;	// IMP=0x000000000037c65c
- (void)registerPeriodicTask;	// IMP=0x000000000037c609
- (void)periodicTask:(void *)arg1;	// IMP=0x000000000037c3d3
- (void)optOutStreamIDsForNonPrimaryConnection:(id)arg1 sentOnConnection:(id)arg2;	// IMP=0x000000000037c168
- (void)optInStreamIDsForNewPrimaryConnection:(id)arg1 oldPrimaryConnection:(id)arg2;	// IMP=0x000000000037c126
- (void)optInAllStreamsForConnection:(id)arg1;	// IMP=0x000000000037c10d
- (void)optInStreamIDsForConnection:(id)arg1;	// IMP=0x000000000037be63
- (void)updateVCIDSSessionInfoResponse:(id)arg1;	// IMP=0x000000000037b1ee
- (void)checkVCIDSSessionInfoNeedUpdate:(unsigned char)arg1;	// IMP=0x000000000037af41
- (void)resetParticipantGenerationCounter;	// IMP=0x000000000037ae66
@property(retain, nonatomic) NSNumber *duplicationLinkID;
@property(retain, nonatomic) NSNumber *primaryLinkID;
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 reportingAgent:(id)arg3;	// IMP=0x000000000037ab58
