...
@interface VCMediaNegotiatorResults : NSObject
{
    ...
    int _accessNetworkType;	// 56 = 0x38
    union tagNTP _remoteBlobCreationTime;	// 64 = 0x40
}
...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000003392b1
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x000000000033927c
- (void)dealloc;	// IMP=0x0000000000339208
- (id)init;	// IMP=0x0000000000339188
