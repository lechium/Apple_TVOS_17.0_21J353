...
- (void)dealloc;	// IMP=0x000000000042eedc
- (id)description;	// IMP=0x000000000042eea8
- (long long)compare:(id)arg1;	// IMP=0x000000000042ee61
- (id)initWithBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000042edd8
