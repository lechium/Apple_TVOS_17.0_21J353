...
+ (unsigned int)worstCaseNetworkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x001000000026cd86
+ (id)VCConnectionIDS_CDBPS:(id)arg1;	// IMP=0x001000000026cb61
+ (id)VCConnectionIDS_RPS:(id)arg1;	// IMP=0x001000000026ca9b
...
- (int)cellTechForSoMask:(unsigned int)arg1 fallbackTo:(int)arg2;	// IMP=0x000000000026d7de
- (_Bool)isOnSameInterfacesAndQRSessionWithConnection:(id)arg1;	// IMP=0x000000000026d209
- (_Bool)isOnSameQRSessionWithConnection:(id)arg1;	// IMP=0x000000000026d099
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x000000000026cf00
- (void)setCellularMTU:(int)arg1;	// IMP=0x000000000026cedb
...
- (id)connectionQRSessionID;	// IMP=0x000000000026cc44
...
- (void)dealloc;	// IMP=0x000000000026c60c
- (id)initWithLinkContext:(id)arg1 dataChannelToken:(unsigned int)arg2;	// IMP=0x000000000026c16e
- (void)setUpVTable;	// IMP=0x000000000026b2d4
