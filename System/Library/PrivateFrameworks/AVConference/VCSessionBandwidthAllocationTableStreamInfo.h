...
- (id)entryForQualityIndex:(unsigned int)arg1;	// IMP=0x0000000000459cc6
- (_Bool)addTableEntry:(id)arg1;	// IMP=0x0000000000459b7f
- (void)dealloc;	// IMP=0x0000000000459b12
- (id)init;	// IMP=0x0000000000459a93
