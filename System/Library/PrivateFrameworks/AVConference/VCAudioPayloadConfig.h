...
- (id)description;	// IMP=0x0000000000454501
- (id)className;	// IMP=0x00000000004544ef
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x0000000000454409
- (void)dealloc;	// IMP=0x000000000045439c
- (id)initWithConfigDict:(id)arg1;	// IMP=0x0000000000454314
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x0000000000453ee7
- (void)createSupportedBitratesForANETEC;	// IMP=0x0000000000453ec6
- (void)createSupportedBitratesForEVS;	// IMP=0x0000000000453ea5
- (void)createSupportedBitratesForAMR16k;	// IMP=0x0000000000453e84
- (void)createSupportedBitratesForAMR8k;	// IMP=0x0000000000453e63
- (void)createSupportedBitratesForOpus;	// IMP=0x0000000000453e42
- (void)createSupportedBitratesForAACELD48;	// IMP=0x0000000000453e21
- (void)createSupportedBitratesForAACELD;	// IMP=0x0000000000453e00
- (void)createSupportedBitrates;	// IMP=0x0000000000453d81
- (unsigned int)anetecBitrate;	// IMP=0x0000000000453c54
- (unsigned int)aacBitrate;	// IMP=0x0000000000453b27
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x0000000000453aac
- (_Bool)configure:(id)arg1;	// IMP=0x00000000004533f8
