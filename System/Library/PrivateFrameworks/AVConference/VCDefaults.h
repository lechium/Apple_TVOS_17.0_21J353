...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x006000000046922b
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00600000004691cb
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000004691b0
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0060000000469066
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x006000000046904b
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x0060000000468efa
+ (id)sharedInstance;	// IMP=0x0060000000468e1b
...
- (_Bool)forceEnableAudioMockInputPathForAppleTV;	// IMP=0x000000000046b19f
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x000000000046b17d
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x000000000046ad8d
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x000000000046aa5c
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x000000000046aa3a
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x000000000046a79a
- (_Bool)forceWifiAssist;	// IMP=0x000000000046a77a
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000004697fb
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000004694f4
...
- (id)autorelease;	// IMP=0x00000000004692ed
- (oneway void)release;	// IMP=0x00000000004692e7
- (unsigned long long)retainCount;	// IMP=0x00000000004692da
- (id)retain;	// IMP=0x00000000004692d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004692c8
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004692bb
- (id)init;	// IMP=0x0000000000469269
