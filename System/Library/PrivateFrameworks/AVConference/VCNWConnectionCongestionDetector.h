...
- (void)enableNWLogDump:(void *)arg1;	// IMP=0x000000000002b0fb
- (void)sendCongestionEventWithTimestamp:(unsigned int)arg1;	// IMP=0x000000000002b024
- (_Bool)processNWConnectionPacketEvent:(struct packet_id *)arg1 eventType:(int)arg2;	// IMP=0x000000000002aeb9
- (_Bool)processNWConnectionNotification:(struct ifnet_interface_advisory *)arg1;	// IMP=0x000000000002ac71
- (void)dealloc;	// IMP=0x000000000002ac13
