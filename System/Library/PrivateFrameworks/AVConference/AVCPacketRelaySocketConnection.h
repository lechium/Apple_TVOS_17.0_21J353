...
- (void)dealloc;	// IMP=0x000000000038ae10
- (id)description;	// IMP=0x000000000038ad44
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000038aa26
- (void)receiveDataOnSocket:(unsigned short)arg1;	// IMP=0x000000000038a6bd
- (void)readyToRead;	// IMP=0x000000000038a6a7
- (int)stop;	// IMP=0x000000000038a5ab
- (int)start;	// IMP=0x000000000038a456
- (id)initWithSocket:(unsigned short)arg1 remoteAddress:(id)arg2 packetFilter:(id)arg3;	// IMP=0x000000000038a055
