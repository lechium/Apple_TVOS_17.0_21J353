...
- (void)setWidth:(int)arg1 height:(int)arg2;	// IMP=0x000000000034a92d
- (int)frameRate;	// IMP=0x000000000034a91c
- (void)setFrameRate:(int)arg1;	// IMP=0x000000000034a90b
- (int)stop;	// IMP=0x000000000034a6f3
- (int)start;	// IMP=0x0000000000349c4a
- (void)dealloc;	// IMP=0x0000000000349b32
- (id)initWithVideo:(id)arg1 callbackContext:(id)arg2 frameCallback:(CDUnknownFunctionPointerType)arg3;	// IMP=0x000000000034975f
