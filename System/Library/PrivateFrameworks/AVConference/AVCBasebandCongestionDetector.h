...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x00000000001c93fe
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001c92b7
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x00000000001c92a8
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001c928e
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x00000000001c905f
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001c8f69
- (void)dealloc;	// IMP=0x00000000001c8dcd
- (id)init;	// IMP=0x00000000001c8d5e
