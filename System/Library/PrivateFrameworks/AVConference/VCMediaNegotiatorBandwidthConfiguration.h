...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002c4a4
- (id)initWithMode:(int)arg1 connectionType:(int)arg2 maxBandwidth:(unsigned int)arg3;	// IMP=0x000000000002c42f
- (id)initWithConnectionType:(int)arg1 maxBandwidth:(unsigned int)arg2;	// IMP=0x000000000002c3bb
