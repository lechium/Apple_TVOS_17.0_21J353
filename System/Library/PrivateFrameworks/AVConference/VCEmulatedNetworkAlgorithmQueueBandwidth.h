...
- (int)getRemainingAQMBudgetWithPacket:(id)arg1;	// IMP=0x0000000000067f6d
- (void)addPacketToBudgetBuffer:(id)arg1;	// IMP=0x0000000000067ecb
- (_Bool)shouldDropPacketWithCurrentAQMBudget:(id)arg1;	// IMP=0x0000000000067e58
- (void)process:(id)arg1;	// IMP=0x0000000000067a78
- (double)computeNetworkServiceRate;	// IMP=0x00000000000679a7
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x000000000006768c
- (id)init;	// IMP=0x000000000006762e
