...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x006000000040b2c5
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000040b2b8
- (void)setUserAgent:(id)arg1;	// IMP=0x000000000040b176
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x000000000040b115
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000040ae78
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x000000000040adb9
- (id)init;	// IMP=0x000000000040abef
