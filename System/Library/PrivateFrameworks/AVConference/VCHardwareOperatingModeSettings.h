...
+ (unsigned int)encoderUsageTypeWithOperatingMode:(int)arg1;	// IMP=0x0060000000488165
...
- (void)initFeatureListString;	// IMP=0x000000000048839a
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x00000000004882a8
- (void)dealloc;	// IMP=0x000000000048822d
- (id)initWithMode:(int)arg1;	// IMP=0x0000000000488182
