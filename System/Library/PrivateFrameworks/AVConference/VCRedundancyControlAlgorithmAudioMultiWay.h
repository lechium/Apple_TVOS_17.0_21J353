...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x00000000002afd61
- (void)computeRedundancyInfo;	// IMP=0x00000000002afcdf
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002afaeb
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002afa51
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002afa24
- (id)init;	// IMP=0x00000000002af9b4
