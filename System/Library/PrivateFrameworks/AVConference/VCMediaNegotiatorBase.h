...
+ (void)setupNegotiatedAudioPayloads:(id)arg1 negotiatedAudioSettings:(id)arg2 primaryPayloadPreference:(id)arg3;	// IMP=0x001000000003815a
+ (void)updateScreenRuleCollections:(id)arg1 size:(struct CGSize)arg2;	// IMP=0x0010000000037eac
+ (void)applyCellularPreferredRule:(id)arg1;	// IMP=0x0010000000037c81
+ (_Bool)selectBestVideoRuleForTransport:(unsigned char)arg1 payload:(int)arg2 encodingType:(unsigned char)arg3 videoSettings:(id)arg4 localVideoRuleCollection:(id)arg5 remoteVideoRuleCollection:(id)arg6;	// IMP=0x0010000000037737
+ (id)negotiateVideoMaxResolutionWithEncodeRules:(id)arg1 decodeRules:(id)arg2 isEncoder:(_Bool)arg3;	// IMP=0x0010000000037458
+ (id)getPreferredVideoPayloadList:(id)arg1 localSupportedPayloads:(id)arg2;	// IMP=0x00100000000370f0
+ (id)streamGroupIDsWithMediaBlob:(id)arg1;	// IMP=0x0010000000036b38
+ (_Bool)initializeLocalConfiguration:(id)arg1 negotiationData:(id)arg2 deviceRole:(int)arg3 preferredAudioPayload:(int)arg4;	// IMP=0x0010000000036ad7
...
- (id)negotiatedResultsForGroupID:(unsigned int)arg1 localU1Config:(id)arg2 remoteU1Config:(id)arg3;	// IMP=0x0000000000036f26
- (id)negotiatedResultsForGroupID:(unsigned int)arg1;	// IMP=0x0000000000036e76
- (id)negotiatedStreamGroupConfigForGroupID:(unsigned int)arg1 negotiatedStreamGroupConfigs:(id)arg2;	// IMP=0x0000000000036bfa
- (unsigned int)remoteMaxBandwidthForOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x0000000000036b99
- (_Bool)processRemoteNegotiationData:(id)arg1;	// IMP=0x0000000000036a76
- (id)negotiationData;	// IMP=0x0000000000036a15
- (void)dealloc;	// IMP=0x0000000000036977
- (id)initWithLocalSettings:(id)arg1;	// IMP=0x0000000000036544
