...
+ (unsigned long long)hdrModeWithNegotiatorInitOptions:(id)arg1;	// IMP=0x00600000002c1a21
+ (id)negotiatorSettingsForMode:(long long)arg1 deviceRole:(unsigned char)arg2 options:(id)arg3 errorString:(id *)arg4;	// IMP=0x00600000002c1990
...
- (void)dealloc;	// IMP=0x00000000002c17d8
- (id)init;	// IMP=0x00000000002c1769
- (id)initWithOptions:(id)arg1 deviceRole:(unsigned char)arg2 error:(id *)arg3;	// IMP=0x00000000002c1757
