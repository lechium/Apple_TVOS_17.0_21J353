...
- (id)className;	// IMP=0x0000000000341551
- (void)releaseLogDumpFile;	// IMP=0x0000000000341488
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x00000000003413e0
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x000000000034133c
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x0000000000341132
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x00000000003410af
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x0000000000341023
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x0000000000340f28
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000340e41
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000340ba4
- (void)setRateControlInterval:(double)arg1;	// IMP=0x0000000000340b12
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x0000000000340a17
- (void)dealloc;	// IMP=0x00000000003409a3
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x0000000000340802
