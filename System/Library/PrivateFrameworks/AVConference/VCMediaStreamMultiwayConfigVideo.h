...
- (id)streamIds;	// IMP=0x000000000032b1c6
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x000000000032b1a9
- (void)addPayload:(int)arg1;	// IMP=0x000000000032b169
- (void)dealloc;	// IMP=0x000000000032b0ee
- (id)init;	// IMP=0x000000000032b061
