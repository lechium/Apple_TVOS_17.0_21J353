...
- (id)className;	// IMP=0x000000000005ac50
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x000000000005a836
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000005a32b
- (void)resetLossEventBuffer;	// IMP=0x000000000005a31a
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x000000000005a2f2
- (int)lossEventCount;	// IMP=0x000000000005a2d8
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x000000000005a288
- (_Bool)shouldRampUp;	// IMP=0x000000000005a1c2
- (_Bool)shouldRampDown;	// IMP=0x000000000005a10e
- (unsigned short)rampDownTier;	// IMP=0x000000000005a0e4
- (unsigned short)rampUpTier;	// IMP=0x000000000005a0c5
- (void)stateEnter;	// IMP=0x000000000005a0a6
- (void)stateExit;	// IMP=0x000000000005a0a0
- (void)stateChange:(int)arg1;	// IMP=0x0000000000059f47
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x0000000000059e22
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000059e10
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000059c13
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x0000000000059b5d
- (id)init;	// IMP=0x000000000005994d
