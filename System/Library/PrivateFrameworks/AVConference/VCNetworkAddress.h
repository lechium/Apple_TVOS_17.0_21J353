...
- (int)getSockaddrStorage:(struct sockaddr_storage *)arg1 size:(unsigned long long *)arg2;	// IMP=0x00000000003f676a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f66f0
- (id)description;	// IMP=0x00000000003f666c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f659e
- (_Bool)isValid;	// IMP=0x00000000003f6554
- (_Bool)isIPv6;	// IMP=0x00000000003f6546
- (void)dealloc;	// IMP=0x00000000003f64d9
