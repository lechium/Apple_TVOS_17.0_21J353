...
- (id)description;	// IMP=0x00000000003f8fc2
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x00000000003f8f19
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x00000000003f8d6f
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x00000000003f88e2
- (void)mergeProbingResults:(id)arg1;	// IMP=0x00000000003f88ce
- (void)dealloc;	// IMP=0x00000000003f8853
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x00000000003f8745
