...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x000000000019a106
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x000000000019a091
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x000000000019a02e
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x0000000000199f77
- (void)dealloc;	// IMP=0x0000000000199f10
- (id)init;	// IMP=0x0000000000199e39
