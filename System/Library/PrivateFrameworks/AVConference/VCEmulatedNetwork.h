...
- (void)runUntilTime:(double)arg1;	// IMP=0x0000000000087654
- (id)copyPacketFromPop;	// IMP=0x0000000000087605
- (void)push:(id)arg1;	// IMP=0x00000000000875cc
- (void)dealloc;	// IMP=0x0000000000087548
- (id)initWithPolicies:(id)arg1;	// IMP=0x0000000000087459
