...
+ (id)profileLevelStringForId:(unsigned int)arg1;	// IMP=0x000000000032bb93
+ (unsigned int)profileLevelIdForString:(id)arg1;	// IMP=0x000000000032bb11
+ (_Bool)validateClientDictionary:(id)arg1;	// IMP=0x000000000032b7eb
...
- (void)initializeParameterSets;	// IMP=0x000000000032c3fd
- (void)addTxCodecFeatureListString:(id)arg1 codecType:(long long)arg2;	// IMP=0x000000000032c3ab
- (void)addRxCodecFeatureListString:(id)arg1 codecType:(long long)arg2;	// IMP=0x000000000032c359
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x000000000032c347
- (_Bool)applyVideoStreamClientDictionary:(id)arg1;	// IMP=0x000000000032bc19
- (void)dealloc;	// IMP=0x000000000032b754
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000032b489
- (id)init;	// IMP=0x000000000032b475
