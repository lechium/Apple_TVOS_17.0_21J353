...
- (unsigned long long)hash;	// IMP=0x0000000000273ef6
...
- (id)description;	// IMP=0x0000000000273e62
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000273dbb
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x0000000000273d1c
- (id)init;	// IMP=0x0000000000273d0e
