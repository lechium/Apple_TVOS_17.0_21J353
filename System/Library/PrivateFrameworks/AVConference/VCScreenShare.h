...
- (void)setConfig:(id)arg1 pid:(id)arg2 captureSourceID:(id)arg3;	// IMP=0x0000000000431af3
- (void)updateScreenCaptureWithConfig:(id)arg1;	// IMP=0x0000000000431a99
- (void)dealloc;	// IMP=0x0000000000431a10
- (id)initWithConfig:(id)arg1 pid:(id)arg2 captureSourceID:(id)arg3;	// IMP=0x0000000000431983
