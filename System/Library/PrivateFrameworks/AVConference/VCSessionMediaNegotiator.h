...
+ (id)unserializeNegotiationData:(id)arg1;	// IMP=0x00100000001518d5
+ (id)serializeNegotiationData:(id)arg1;	// IMP=0x0010000000151891
+ (_Bool)initializeLocalConfiguration:(id)arg1 negotiationData:(id)arg2 deviceRole:(int)arg3 preferredAudioPayload:(int)arg4;	// IMP=0x00100000001516c9
+ (id)streamGroupIDsWithMediaBlob:(id)arg1;	// IMP=0x0010000000151453
+ (id)negotiationDataWithVersion1:(id)arg1 version2:(id)arg2;	// IMP=0x0010000000150ef1
+ (id)negotiationDataWithVersion:(int)arg1 mediaBlob:(id)arg2;	// IMP=0x0010000000150e7b
+ (id)mediaBlobForVersion:(int)arg1 negotiationData:(id)arg2;	// IMP=0x0010000000150e22
@property(readonly, nonatomic) VCMediaNegotiatorLocalConfiguration *localSettings; // @synthesize localSettings=_localSettings;
- (unsigned int)remoteMaxBandwidthForOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000001516b3
- (id)negotiatedResultsForGroupID:(unsigned int)arg1;	// IMP=0x000000000015143d
...
- (_Bool)processRemoteNegotiationData:(id)arg1;	// IMP=0x0000000000151193
- (id)negotiationData;	// IMP=0x0000000000150f76
- (void)dealloc;	// IMP=0x0000000000150dae
- (id)initWithLocalConfiguration:(id)arg1;	// IMP=0x0000000000150b75
