...
@interface VCVideoTransmitterConfig : NSObject
{
    ...
    _Bool _setupBWEstimationOptionWithFeatureString;	// 244 = 0xf4
    _Bool _reinitEncoderOnFrameSizeChangeEnabled;	// 245 = 0xf5
    _Bool _isIPv6;	// 246 = 0xf6
    _Bool _rtxEnabled;	// 247 = 0xf7
    _Bool _isFecGeneratorEnabled;	// 248 = 0xf8
    _Bool _fecHeaderV1Enabled;	// 249 = 0xf9
    _Bool _useInBandFec;	// 250 = 0xfa
    _Bool _fecEnabled;	// 251 = 0xfb
    unsigned int _qualityIndex;	// 252 = 0xfc
    unsigned int _maxSupportedTemporalLayers;	// 256 = 0x100
    int _reportingClientType;	// 260 = 0x104
    int _ltrAckFeedbackType;	// 264 = 0x108
    int _accessNetworkType;	// 268 = 0x10c
    unsigned long long _remoteIDSParticipantID;	// 272 = 0x110
    unsigned long long _maxEncoderPixels;	// 280 = 0x118
    double _minKeyFrameGenerationIntervalInSeconds;	// 288 = 0x120
}
...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002c3c7a
- (void)dealloc;	// IMP=0x00000000002c3bd3
- (id)description;	// IMP=0x00000000002c3a96
- (id)init;	// IMP=0x00000000002c39bd
