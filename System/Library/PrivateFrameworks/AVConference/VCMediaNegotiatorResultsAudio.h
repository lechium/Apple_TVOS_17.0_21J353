...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b9bb7
- (void)dealloc;	// IMP=0x00000000001b9b59
- (void)addSecondaryPayload:(int)arg1;	// IMP=0x00000000001b9b20
@property(readonly, nonatomic) NSArray *secondaryPayloads;
- (id)init;	// IMP=0x00000000001b9a86
