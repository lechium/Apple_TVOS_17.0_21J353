...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x0000000000062169
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x000000000006213f
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x00000000000620f3
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000062045
