...
- (int)jitterBufferModeFromAVCJitterBufferMode:(unsigned int)arg1;	// IMP=0x00000000003f7a20
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x00000000003f753a
- (void)setupMediaStreamConfig;	// IMP=0x00000000003f74b1
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x00000000003f72f3
- (void)addTxPayloadType:(int)arg1;	// IMP=0x00000000003f72dc
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x00000000003f7273
- (void)addRxPayloadType:(int)arg1;	// IMP=0x00000000003f725c
- (id)description;	// IMP=0x00000000003f721b
- (void)dealloc;	// IMP=0x00000000003f713d
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x00000000003f7074
- (id)init;	// IMP=0x00000000003f7005
