...
- (void)dealloc;	// IMP=0x000000000005b1ce
- (_Bool)isSameRemoteAddress:(id)arg1;	// IMP=0x000000000005b107
- (id)newParametersFromConnection;	// IMP=0x000000000005b097
- (id)newRemoteAddressFromConnection;	// IMP=0x000000000005ae19
