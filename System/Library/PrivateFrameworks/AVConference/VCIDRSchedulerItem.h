...
- (id)description;	// IMP=0x000000000007022b
- (long long)compareBudget:(id)arg1;	// IMP=0x00000000000701d2
- (void)addStream:(id)arg1;	// IMP=0x000000000007016d
- (void)dealloc;	// IMP=0x000000000007010f
- (id)init;	// IMP=0x0000000000070099
