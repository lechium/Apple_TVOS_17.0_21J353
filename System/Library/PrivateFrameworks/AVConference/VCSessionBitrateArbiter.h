...
- (void)readStoreBagValues;	// IMP=0x000000000029586e
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x0000000000295659
- (void)readHardwareValues;	// IMP=0x000000000029562f
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x00000000002955b7
- (void)dealloc;	// IMP=0x0000000000295559
- (id)init;	// IMP=0x00000000002954d5
