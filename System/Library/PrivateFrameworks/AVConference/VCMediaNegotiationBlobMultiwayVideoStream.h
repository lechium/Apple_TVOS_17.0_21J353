...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x00100000003b76d2
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00100000003b76b4
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00100000003b7525
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x00100000003b73c9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000b6b5
- (unsigned long long)hash;	// IMP=0x000000000000b567
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b3bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b284
- (void)copyTo:(id)arg1;	// IMP=0x000000000000b18a
- (void)writeTo:(id)arg1;	// IMP=0x000000000000aff9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000afec
- (id)dictionaryRepresentation;	// IMP=0x000000000000a53c
- (id)description;	// IMP=0x000000000000a4a2
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003b7163
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000003b6ee7
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003b6ce5
