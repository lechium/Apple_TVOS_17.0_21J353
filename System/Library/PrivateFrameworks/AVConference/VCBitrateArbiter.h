...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x006000000042fd04
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x000000000042fd2f
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x000000000042fc94
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x000000000042fbaf
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x000000000042f9ee
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x000000000042f8f3
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x000000000042f7f8
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x000000000042f579
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x000000000042f564
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x000000000042f42b
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x000000000042f412
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x000000000042f3f1
- (void)readCarrierBundleValues;	// IMP=0x000000000042f3eb
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x000000000042f3e5
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x000000000042f2a3
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x000000000042f208
- (void)readHardwareValues;	// IMP=0x000000000042f202
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000042f193
- (void)createSupportedBitrateRuleSets;	// IMP=0x000000000042f15d
- (void)dealloc;	// IMP=0x000000000042f0ff
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x000000000042ef68
