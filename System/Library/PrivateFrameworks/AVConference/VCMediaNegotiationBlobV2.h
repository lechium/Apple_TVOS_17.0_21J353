...
+ (Class)streamGroupsType;	// IMP=0x00100000000c63bb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000c737c
- (unsigned long long)hash;	// IMP=0x00000000000c72a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c714b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c6ecc
- (void)copyTo:(id)arg1;	// IMP=0x00000000000c6d79
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c6bd1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c6bc4
- (id)dictionaryRepresentation;	// IMP=0x00000000000c6466
- (id)description;	// IMP=0x00000000000c63cc
- (id)streamGroupsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000c639e
- (unsigned long long)streamGroupsCount;	// IMP=0x00000000000c6381
- (void)addStreamGroups:(id)arg1;	// IMP=0x00000000000c6334
- (void)clearStreamGroups;	// IMP=0x00000000000c6317
...
- (void)dealloc;	// IMP=0x00000000000c61d4
- (void)printWithTitle:(id)arg1 logFile:(void *)arg2;	// IMP=0x000000000014a2ac
