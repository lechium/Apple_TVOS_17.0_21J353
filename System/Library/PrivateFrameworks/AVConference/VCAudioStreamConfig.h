...
+ (int)bundlingSchemeForAudioStreamMode:(long long)arg1 payloadType:(int)arg2;	// IMP=0x0060000000418741
...
- (void)addSupportedNumRedundantPayload:(unsigned int)arg1;	// IMP=0x0000000000419313
- (void)addCodecConfiguration:(id)arg1;	// IMP=0x0000000000419238
@property(nonatomic) const struct tagVCAudioFrameFormat *externalIOFormat;
- (_Bool)setupDTMFCodecWithClientDictionary:(id)arg1;	// IMP=0x0000000000418f98
- (_Bool)setupCNCodecWithClientDictionary:(id)arg1;	// IMP=0x0000000000418d34
- (void)setupRedWithRxPayload:(unsigned int)arg1 txPayload:(unsigned int)arg2;	// IMP=0x0000000000418ce2
- (_Bool)setupCodecWithClientDictionary:(id)arg1;	// IMP=0x0000000000418820
- (void)dealloc;	// IMP=0x00000000004186c6
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000041822c
- (id)init;	// IMP=0x000000000041819f
