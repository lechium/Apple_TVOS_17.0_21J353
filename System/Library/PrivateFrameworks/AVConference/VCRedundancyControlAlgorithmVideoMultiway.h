...
- (void)updateRedundancyPercentage;	// IMP=0x0000000000247cad
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000247c2c
- (id)init;	// IMP=0x0000000000247bc0
