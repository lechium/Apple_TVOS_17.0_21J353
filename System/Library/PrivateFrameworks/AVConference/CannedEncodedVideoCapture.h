...
- (void)getFrameRate:(double *)arg1 frameCount:(int *)arg2;	// IMP=0x000000000038f2cd
- (struct __CVBuffer *)createPixelBufferForFrameIndex:(int)arg1;	// IMP=0x000000000038ed41
- (void)attachMetadataToPixelBuffer:(struct __CVBuffer *)arg1;	// IMP=0x000000000038ed3b
- (int)setWidth:(int)arg1 height:(int)arg2;	// IMP=0x000000000038eae3
- (int)initialize;	// IMP=0x000000000038e80c
- (int)initializeAssetReader;	// IMP=0x000000000038e53b
- (int)loadCannedMediaAssets;	// IMP=0x000000000038e297
- (int)finalizeVideoCapture;	// IMP=0x000000000038e11c
- (int)loadMetadataTrackFromList:(id)arg1 error:(id)arg2;	// IMP=0x000000000038dfd6
- (int)loadVideoTrackFromList:(id)arg1 error:(id)arg2;	// IMP=0x000000000038de72
- (void)dealloc;	// IMP=0x000000000038dd88
- (id)initWithPath:(id)arg1;	// IMP=0x000000000038dc72
