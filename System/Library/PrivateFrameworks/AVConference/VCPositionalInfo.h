...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000034afff
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000034b125
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000034b007
...
- (void)unserialize:(id)arg1;	// IMP=0x000000000034ac16
- (id)serialize;	// IMP=0x000000000034ab53
- (id)description;	// IMP=0x000000000034ab09
- (id)init;	// IMP=0x000000000034aaae
