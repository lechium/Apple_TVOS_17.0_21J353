...
- (void)process:(id)arg1;	// IMP=0x0000000000134ce0
- (double)computeNetworkDelay;	// IMP=0x0000000000134bff
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x0000000000134998
- (id)init;	// IMP=0x000000000013493a
