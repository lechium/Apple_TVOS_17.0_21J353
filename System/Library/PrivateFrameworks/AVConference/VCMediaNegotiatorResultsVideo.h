...
@interface VCMediaNegotiatorResultsVideo : NSObject
{
    ...
    _Bool _fecEnabled;	// 81 = 0x51
    _Bool _rtxEnabled;	// 82 = 0x52
}
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033d1f2
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x000000000033d1dc
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x000000000033d1c6
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x000000000033d17c
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x000000000033d132
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x000000000033d11c
- (void)dealloc;	// IMP=0x000000000033d09a
- (id)init;	// IMP=0x000000000033cfeb
