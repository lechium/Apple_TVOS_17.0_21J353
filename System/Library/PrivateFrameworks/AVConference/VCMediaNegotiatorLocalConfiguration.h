...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012fb58
- (_Bool)isEqualFaceTimeSettings:(id)arg1;	// IMP=0x000000000012fa6d
- (_Bool)isEqualMediaRecorderVideoCodecs:(id)arg1;	// IMP=0x000000000012f8db
- (_Bool)isEqualMediaRecorderImageTypes:(id)arg1;	// IMP=0x000000000012f749
- (_Bool)isEqualFeatureStrings:(id)arg1;	// IMP=0x000000000012f233
- (_Bool)isEqualStreamGroupConfigs:(id)arg1;	// IMP=0x000000000012eff6
- (_Bool)isEqualMultiwayVideoStreamSet:(id)arg1;	// IMP=0x000000000012edbf
- (_Bool)isEqualMultiwayAudioStreamSet:(id)arg1;	// IMP=0x000000000012eb88
- (_Bool)isEqualBandwidthConfigurations:(id)arg1;	// IMP=0x000000000012e983
- (void)resetStreamGroups;	// IMP=0x000000000012e96a
- (void)addStreamGroupConfig:(id)arg1;	// IMP=0x000000000012e951
- (void)addMultiwayVideoStream:(id)arg1;	// IMP=0x000000000012e93b
- (void)addMultiwayAudioStream:(id)arg1;	// IMP=0x000000000012e925
- (void)addBandwidthConfiguration:(id)arg1;	// IMP=0x000000000012e90f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012e572
- (_Bool)setupBandwidthExtensionConfiguration:(id)arg1;	// IMP=0x000000000012dfc3
- (_Bool)setupBandwidthConfigurationsWithArbiter:(id)arg1;	// IMP=0x000000000012dacd
- (void)dealloc;	// IMP=0x000000000012d9e5
- (id)initWithBitrateArbiter:(id)arg1;	// IMP=0x000000000012d99c
- (id)init;	// IMP=0x000000000012d5f4
