...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000431e9
- (unsigned long long)hash;	// IMP=0x0000000000042ff8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042e98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000042d8c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000042cbe
- (void)writeTo:(id)arg1;	// IMP=0x0000000000042b89
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000042b7c
- (id)dictionaryRepresentation;	// IMP=0x0000000000042382
- (id)description;	// IMP=0x00000000000422e8
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003b6ae4
- (id)newMultiwayAudioStream;	// IMP=0x00000000003b693f
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x00000000003b67ca
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003b661f
