...
- (id)description;	// IMP=0x000000000048944c
- (unsigned long long)hash;	// IMP=0x000000000048941b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000048938e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000048933b
- (id)initWithPayload:(int)arg1 transportType:(unsigned char)arg2 encodingType:(unsigned char)arg3;	// IMP=0x00000000004892c6
