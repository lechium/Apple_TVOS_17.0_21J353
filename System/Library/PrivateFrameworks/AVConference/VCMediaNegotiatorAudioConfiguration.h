...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000354897
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003546d3
- (_Bool)isSecondaryPayload:(int)arg1;	// IMP=0x000000000035469a
- (void)addAudioPayload:(int)arg1 isSecondary:(_Bool)arg2;	// IMP=0x0000000000354519
- (void)dealloc;	// IMP=0x00000000003544ac
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5 audioRuleCollection:(id)arg6;	// IMP=0x0000000000354231
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5;	// IMP=0x0000000000354214
