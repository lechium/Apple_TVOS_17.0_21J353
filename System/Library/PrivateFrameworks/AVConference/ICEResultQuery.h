...
- (void)dealloc;	// IMP=0x0000000000063d2e
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x0000000000063c73
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x0000000000063bdf
