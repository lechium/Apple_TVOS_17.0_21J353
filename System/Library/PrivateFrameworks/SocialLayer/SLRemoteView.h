...
- (void).cxx_destruct;	// IMP=0x000000000001dfd6
...
- (void)serviceProxyDidDisconnect:(id)arg1;	// IMP=0x000000000001def5
- (void)serviceProxyDidConnect:(id)arg1;	// IMP=0x000000000001de69
- (void)remoteContentIsLoadedValueChanged;	// IMP=0x000000000001de63
- (CDUnknownBlockType)_contentProviderForCurrentConfiguration;	// IMP=0x000000000001d9f2
- (id)_finalSlotStyleForStyle:(id)arg1;	// IMP=0x000000000001d9dc
- (void)renderRemoteContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000001d9d6
- (id)makePlaceholderSlotContentForStyle:(id)arg1;	// IMP=0x000000000001d9ce
- (_Bool)shouldInvalidatePreviousPlaceHolderSlotContent:(id)arg1 forStyle:(id)arg2;	// IMP=0x000000000001d9c6
- (id)initWithServiceProxyClass:(Class)arg1 maxWidth:(double)arg2;	// IMP=0x000000000001d281
