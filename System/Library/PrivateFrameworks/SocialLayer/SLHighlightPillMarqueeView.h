...
- (void).cxx_destruct;	// IMP=0x000000000001343b
...
- (void)_deactivateMarqueeAnimationIfNecessary;	// IMP=0x0000000000013228
- (void)_activateMarqueeAnimationIfNecessary;	// IMP=0x0000000000012f5a
- (void)updateConstraints;	// IMP=0x0000000000012509
- (void)layoutSubviews;	// IMP=0x000000000001221f
- (id)initWithFrame:(struct CGRect)arg1 pillView:(id)arg2;	// IMP=0x0000000000011e73
