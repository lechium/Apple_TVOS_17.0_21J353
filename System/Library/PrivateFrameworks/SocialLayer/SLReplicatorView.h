...
+ (Class)layerClass;	// IMP=0x006000000001124e
- (void).cxx_destruct;	// IMP=0x0000000000011e0f
...
- (void)updateConstraints;	// IMP=0x00000000000115be
- (void)_updateReplicatorLayer;	// IMP=0x0000000000011450
- (void)updateInstanceCount:(unsigned long long)arg1 replicationPaddingX:(double)arg2;	// IMP=0x0000000000011357
- (id)initWithFrame:(struct CGRect)arg1 targetView:(id)arg2;	// IMP=0x000000000001125f
