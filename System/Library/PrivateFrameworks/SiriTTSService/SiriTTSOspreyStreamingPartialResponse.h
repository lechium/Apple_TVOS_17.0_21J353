...
+ (void)processServerLogs:(id)arg1;	// IMP=0x0060000000113ed5
- (void).cxx_destruct;	// IMP=0x0000000000113ead
...
- (id)initWithOspreyPartialResponse:(id)arg1;	// IMP=0x0000000000113b8a
