...
- (void).cxx_destruct;	// IMP=0x000000000010dd88
- (id)flatbuffData;	// IMP=0x000000000010dc71
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000010d1a4
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000010c868
- (unsigned long long)context_info_count;	// IMP=0x000000000010c7cc
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000010c6ac
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010c23b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000010c058
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000010c043
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000010c029
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000010c012
