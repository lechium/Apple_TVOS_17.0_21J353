...
- (void).cxx_destruct;	// IMP=0x000000000010f705
- (id)flatbuffData;	// IMP=0x000000000010f5ee
- (Offset_afb4d078)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000010f27d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010edba
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000010ebd7
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2;	// IMP=0x000000000010ebc2
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000010eba8
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000010eb91
