...
- (void).cxx_destruct;	// IMP=0x00000000000a7f1e
...
- (void)reset;	// IMP=0x00000000000a7ad2
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000a78fd
- (id)init;	// IMP=0x00000000000a7855
