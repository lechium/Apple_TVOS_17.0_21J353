...
+ (id)new;	// IMP=0x006000000015b9e3
- (void).cxx_destruct;	// IMP=0x000000000015b9b2
...
- (id)initWithDeviceID:(id)arg1 rawDiscoveryInfo:(id)arg2;	// IMP=0x000000000015b81f
- (id)init;	// IMP=0x000000000015b777
