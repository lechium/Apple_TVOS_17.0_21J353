...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000063842
- (void).cxx_destruct;	// IMP=0x00000000000637cd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000062c9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062b13
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000061fe0
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000061695
- (id)initWithInstanceID:(id)arg1 characteristicType:(id)arg2 characteristicProperties:(id)arg3 userDescription:(id)arg4 bluetoothFormat:(id)arg5 validRange:(id)arg6 stepValue:(id)arg7 validValues:(id)arg8 validValuesRange:(id)arg9;	// IMP=0x0000000000061510
- (id)init;	// IMP=0x00000000000614e1
