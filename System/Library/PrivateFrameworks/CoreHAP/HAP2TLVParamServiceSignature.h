...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006399c
- (void).cxx_destruct;	// IMP=0x0000000000060bc0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006058c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000060484
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000005fdf7
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000005f860
- (id)initWithInstanceID:(id)arg1 serviceType:(id)arg2 properties:(id)arg3 linkedServices:(id)arg4 characteristicList:(id)arg5;	// IMP=0x000000000005f759
- (id)init;	// IMP=0x000000000005f72a
