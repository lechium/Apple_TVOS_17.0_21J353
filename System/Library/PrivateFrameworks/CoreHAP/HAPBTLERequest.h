...
- (void).cxx_destruct;	// IMP=0x000000000012e4a0
...
- (id)_serializeHeader;	// IMP=0x000000000012e10e
- (id)serialize;	// IMP=0x000000000012dffe
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000012df4f
- (id)description;	// IMP=0x000000000012df3b
- (id)debugDescription;	// IMP=0x000000000012df24
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x000000000012dd3c
- (id)shortDescription;	// IMP=0x000000000012dd2a
- (id)initWithRequestType:(unsigned char)arg1 bodyData:(id)arg2 shouldEncrypt:(_Bool)arg3 timeoutInterval:(double)arg4;	// IMP=0x000000000012dd0b
- (id)initWithCharacteristic:(id)arg1 requestType:(unsigned char)arg2 bodyData:(id)arg3 shouldEncrypt:(_Bool)arg4 timeoutInterval:(double)arg5;	// IMP=0x000000000012dc1a
- (id)_initWithCharacteristic:(id)arg1 requestType:(unsigned char)arg2 bodyData:(id)arg3 shouldEncrypt:(_Bool)arg4 timeoutInterval:(double)arg5;	// IMP=0x000000000012d8c1
- (id)init;	// IMP=0x000000000012d819
