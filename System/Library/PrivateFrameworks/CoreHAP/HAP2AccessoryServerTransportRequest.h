...
+ (id)new;	// IMP=0x006000000005bc5e
- (void).cxx_destruct;	// IMP=0x000000000005bb08
...
- (id)debugDescription;	// IMP=0x000000000005ba2f
- (id)description;	// IMP=0x000000000005b9ac
@property(readonly, nonatomic, getter=isForWriting) _Bool forWriting;
- (id)initForWritingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005b97e
- (id)initForReadingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005b962
- (id)init;	// IMP=0x000000000005b8ba
