...
- (void).cxx_destruct;	// IMP=0x00000000001793da
...
- (_Bool)reapSession:(id)arg1;	// IMP=0x000000000017931e
- (id)initWithSession:(struct coap_session_t *)arg1 startTime:(id)arg2;	// IMP=0x00000000001792a7
