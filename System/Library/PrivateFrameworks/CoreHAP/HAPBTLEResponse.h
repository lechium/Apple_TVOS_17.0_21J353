...
- (unsigned long long)_deserializeHeaderBodyLengthWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000041711
- (unsigned long long)_deserializeHeaderWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000415e7
- (unsigned long long)appendData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004117d
- (unsigned long long)_remainingBodyLength;	// IMP=0x00000000000410f0
...
- (id)description;	// IMP=0x0000000000040f34
- (id)debugDescription;	// IMP=0x0000000000040f1d
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x0000000000040d94
- (id)shortDescription;	// IMP=0x0000000000040d82
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000040d14
- (id)init;	// IMP=0x0000000000040c6c
