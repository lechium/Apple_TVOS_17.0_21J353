...
- (void).cxx_destruct;	// IMP=0x0000000000067ec2
- (id)serialize;	// IMP=0x0000000000067ddc
...
- (id)initWithBTLERequests:(id)arg1 requestType:(unsigned long long)arg2 enforcePDUBodyLength:(_Bool)arg3;	// IMP=0x0000000000067b76
