...
+ (id)reachabilityScanTupleWithCompletion:(CDUnknownBlockType)arg1 workQueue:(id)arg2 identifier:(id)arg3;	// IMP=0x006000000008d989
- (void).cxx_destruct;	// IMP=0x000000000008d947
