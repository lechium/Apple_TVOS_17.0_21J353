...
- (void).cxx_destruct;	// IMP=0x000000000008e199
...
- (id)description;	// IMP=0x000000000008dee1
- (void)updatePairedPeripheralConfiguration:(_Bool)arg1 connectionPriority:(unsigned long long)arg2;	// IMP=0x000000000008dd38
- (void)updateWithPeripheral:(id)arg1;	// IMP=0x000000000008dbd9
- (id)initRecentlySeenPairedHAPBLEPeripheral:(id)arg1;	// IMP=0x000000000008db0c
