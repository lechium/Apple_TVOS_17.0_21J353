...
- (void).cxx_destruct;	// IMP=0x0000000000003b4b
...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x00000000000037cd
- (id)debugDescription;	// IMP=0x00000000000037b4
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x0000000000003753
