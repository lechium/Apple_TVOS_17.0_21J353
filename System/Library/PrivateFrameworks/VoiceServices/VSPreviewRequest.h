...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001843c
- (void).cxx_destruct;	// IMP=0x0000000000018414
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000182ac
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001820f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000018139
