...
- (void)_handleRequests;	// IMP=0x000000000002e52e
- (void)_notifyRequestHandled:(id)arg1;	// IMP=0x000000000002e4b4
- (void)invalidate;	// IMP=0x000000000002e46d
- (void)handleResults:(id)arg1 withHandler:(id)arg2;	// IMP=0x000000000002e393
- (void)setDelegate:(id)arg1;	// IMP=0x000000000002e35b
- (void)dealloc;	// IMP=0x000000000002e311
- (id)init;	// IMP=0x000000000002e2ac
