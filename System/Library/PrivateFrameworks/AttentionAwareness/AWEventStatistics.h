...
+ (id)sharedStatistics;	// IMP=0x006000000000532d
- (void).cxx_destruct;	// IMP=0x0000000000004e8a
- (void)logEvent:(unsigned long long)arg1;	// IMP=0x0000000000004d48
- (id)init;	// IMP=0x0000000000004c0a
