...
- (id)wf_initWithIdentifier:(id)arg1 displayString:(id)arg2;	// IMP=0x0020000000111673
- (void)wf_transformUsingCodableAttribute:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0020000000261431
