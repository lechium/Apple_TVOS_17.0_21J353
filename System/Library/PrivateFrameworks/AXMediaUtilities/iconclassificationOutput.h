...
- (void).cxx_destruct;	// IMP=0x0000000000033582
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000003350e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLeaf_leaf_predictions_probabilities:(id)arg1;	// IMP=0x0000000000033483
