...
- (void).cxx_destruct;	// IMP=0x0000000000024a8e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000249bd
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithConfidence:(id)arg1 coordinates:(id)arg2;	// IMP=0x000000000002492b
