...
- (void).cxx_destruct;	// IMP=0x00000000000527db
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000005256b
- (void)didSelectManualSignInButton;	// IMP=0x000000000005251f
- (id)init;	// IMP=0x000000000005245b
