...
@interface VSIKItemGroup : NSObject <VSJSItemGroupBridge>
{
...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x001000000001a650
+ (void)registerFeature;	// IMP=0x001000000001a61e
- (void).cxx_destruct;	// IMP=0x000000000001aa4d
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000001a6e7
