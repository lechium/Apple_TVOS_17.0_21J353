...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000008a4c
+ (Class)transformedValueClass;	// IMP=0x0060000000008a3b
@property(nonatomic) struct CGSize preferredSize; // @synthesize preferredSize=_preferredSize;
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000008a54
