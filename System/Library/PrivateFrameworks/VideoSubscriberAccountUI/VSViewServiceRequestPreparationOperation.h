...
- (void).cxx_destruct;	// IMP=0x0000000000025265
...
- (void)cancel;	// IMP=0x0000000000024ff7
- (void)executionDidBegin;	// IMP=0x0000000000024fe5
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x0000000000024c71
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000024696
- (void)_checkSupportedProviders;	// IMP=0x0000000000023fc2
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x000000000002373d
- (void)_checkAvailability;	// IMP=0x00000000000235ba
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x0000000000023419
- (void)_checkPrivacy;	// IMP=0x0000000000022c36
- (void)_checkEntitlement;	// IMP=0x0000000000022aec
- (void)_finishWithError:(id)arg1;	// IMP=0x00000000000229d3
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000022959
- (void)dealloc;	// IMP=0x0000000000022910
- (id)init;	// IMP=0x00000000000226bd
