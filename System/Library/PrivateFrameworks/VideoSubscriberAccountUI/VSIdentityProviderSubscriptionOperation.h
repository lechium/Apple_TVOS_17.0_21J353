...
- (void).cxx_destruct;	// IMP=0x00000000000155e9
...
- (void)cancel;	// IMP=0x00000000000154a7
- (void)_registerSubscriptions:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x00000000000150ea
- (void)_removeSubscriptionsForBundleIdentifiers:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x0000000000014a24
- (id)_authorizedBundleIdsFromAppDescriptions:(id)arg1;	// IMP=0x0000000000014883
- (void)executionDidBegin;	// IMP=0x0000000000013c3a
- (id)initWithRegistrationCenter:(id)arg1 andDeveloperSettingsFetchOperation:(id)arg2;	// IMP=0x0000000000013b9f
- (id)init;	// IMP=0x0000000000013ab6
