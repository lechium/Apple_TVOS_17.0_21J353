...
- (void).cxx_destruct;	// IMP=0x0000000000019bd5
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000019aa4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000019a11
- (void)dealloc;	// IMP=0x00000000000199db
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019986
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000019114
