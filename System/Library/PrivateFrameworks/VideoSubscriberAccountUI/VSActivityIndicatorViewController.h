...
- (void).cxx_destruct;	// IMP=0x0000000000074172
...
- (id)_textColor;	// IMP=0x00000000000740df
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000073be7
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000073967
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000738d4
- (void)dealloc;	// IMP=0x0000000000073873
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000737a8
