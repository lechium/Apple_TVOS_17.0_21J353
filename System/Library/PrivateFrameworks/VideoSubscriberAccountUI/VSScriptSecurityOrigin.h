...
- (void).cxx_destruct;	// IMP=0x000000000005e760
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005e50c
- (unsigned long long)hash;	// IMP=0x000000000005e474
- (id)description;	// IMP=0x000000000005e361
