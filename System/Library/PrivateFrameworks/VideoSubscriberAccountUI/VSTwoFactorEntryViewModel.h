...
- (void).cxx_destruct;	// IMP=0x0000000000048101
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000047fe7
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000047e1c
- (id)init;	// IMP=0x0000000000047aa1
