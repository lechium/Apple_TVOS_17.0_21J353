...
- (void).cxx_destruct;	// IMP=0x000000000001e6c2
...
- (id)formattedWebsiteURL;	// IMP=0x000000000001e14c
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000001dc34
- (void)generateQRCode;	// IMP=0x000000000001da6e
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000001da0a
