...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000027a8a
- (void).cxx_destruct;	// IMP=0x0000000000027d4c
...
- (void)messagePort:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x0000000000027c9a
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000027bcc
