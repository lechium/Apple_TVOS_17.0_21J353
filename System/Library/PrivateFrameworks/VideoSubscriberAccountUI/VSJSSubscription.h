...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x0010000000051fc0
- (void).cxx_destruct;	// IMP=0x000000000005231a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005218b
- (id)toVSSubscription;	// IMP=0x0000000000051e57
- (id)init;	// IMP=0x0000000000051d79
