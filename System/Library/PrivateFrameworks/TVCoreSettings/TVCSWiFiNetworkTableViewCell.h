...
- (void)_updateAccessoryTintColor;	// IMP=0x0000000000026a82
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000269bd
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000002697c
- (void)setBars:(unsigned long long)arg1;	// IMP=0x0000000000026976
- (void)setSecure:(_Bool)arg1;	// IMP=0x0000000000026959
- (void)setSubtitle:(id)arg1;	// IMP=0x0000000000026953
- (void)setTitle:(id)arg1;	// IMP=0x00000000000268ea
- (void)didMoveToSuperview;	// IMP=0x0000000000026569
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000264a6
