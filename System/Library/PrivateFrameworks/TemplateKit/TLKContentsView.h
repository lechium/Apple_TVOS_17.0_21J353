...
+ (id)detailsLabel;	// IMP=0x006000000002a725
- (void).cxx_destruct;	// IMP=0x000000000002ac6d
...
- (void)updateWithTitle:(id)arg1 contents:(id)arg2;	// IMP=0x000000000002a79b
- (id)init;	// IMP=0x000000000002a611
