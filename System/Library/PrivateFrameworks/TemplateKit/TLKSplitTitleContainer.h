...
+ (double)widthForString:(id)arg1 font:(id)arg2;	// IMP=0x006000000001205f
- (void).cxx_destruct;	// IMP=0x0000000000012284
...
- (id)titleFont;	// IMP=0x0000000000012162
- (_Bool)titleLabelsFitInWidth:(double)arg1 pointSize:(double)arg2;	// IMP=0x0000000000011ea7
- (void)layoutSubviews;	// IMP=0x0000000000011c47
- (struct CGSize)effectiveLayoutSizeFittingSize:(struct CGSize)arg1;	// IMP=0x0000000000011848
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000117f6
- (id)init;	// IMP=0x00000000000115f7
