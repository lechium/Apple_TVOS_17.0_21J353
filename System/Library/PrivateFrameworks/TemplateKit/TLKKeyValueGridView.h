...
- (void).cxx_destruct;	// IMP=0x000000000003bf9f
...
- (void)updateWithTuples:(id)arg1 valueColumnIsTrailing:(_Bool)arg2 truncateKey:(_Bool)arg3;	// IMP=0x000000000003b807
- (id)init;	// IMP=0x000000000003b734
