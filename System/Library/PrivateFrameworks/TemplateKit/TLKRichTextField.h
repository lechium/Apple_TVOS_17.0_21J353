...
- (void).cxx_destruct;	// IMP=0x0000000000043016
...
- (id)attributedString;	// IMP=0x0000000000042dbe
- (struct CGRect)containerView:(id)arg1 layoutFrameForArrangedSubview:(id)arg2 withProposedFrame:(struct CGRect)arg3;	// IMP=0x0000000000042bf8
- (void)updateRoundedCornerLabels:(id)arg1;	// IMP=0x000000000004295d
- (void)updateIcons:(id)arg1;	// IMP=0x00000000000426a2
- (void)updateStarRating:(id)arg1;	// IMP=0x0000000000042426
@property(nonatomic) unsigned long long prominence;
- (void)updateIconSizing;	// IMP=0x0000000000042072
@property(retain, nonatomic) UIFont *font;
- (void)updateWithRichText:(id)arg1;	// IMP=0x0000000000041d48
- (void)propertiesDidChange;	// IMP=0x0000000000041cfc
- (id)init;	// IMP=0x00000000000417d7
