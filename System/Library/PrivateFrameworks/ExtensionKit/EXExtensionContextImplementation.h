...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x001000000000f99c
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000f994
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x001000000000f916
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000f7c6
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x001000000000f71d
+ (id)_extensionContextHostProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000f407
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x001000000000f3b0
- (void).cxx_destruct;	// IMP=0x0000000000012909
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000124e5
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x00000000000124da
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000000122b1
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012035
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011e60
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011aa3
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011838
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x0000000000011574
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000010bc5
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010bba
- (_Bool)_isHost;	// IMP=0x0000000000010b87
- (void)dealloc;	// IMP=0x0000000000010b32
- (void)invalidate;	// IMP=0x0000000000010a1e
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000010509
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010490
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010485
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010331
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x000000000000fc5f
