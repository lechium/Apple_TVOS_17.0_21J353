...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x001000000001a2e4
+ (void)notifyExtensionMainCalled;	// IMP=0x001000000001a2b3
- (void).cxx_destruct;	// IMP=0x000000000001a5ef
...
- (id)initForCurrentProcess;	// IMP=0x000000000001a35f
