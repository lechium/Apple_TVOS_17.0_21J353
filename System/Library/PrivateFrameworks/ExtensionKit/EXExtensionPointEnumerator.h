...
+ (id)translateAppexptDictionary:(id)arg1 definitionURL:(id)arg2 isCatalyst:(_Bool)arg3;	// IMP=0x006000000003d72f
+ (void)enumerateExtensionPointsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000003c607
...
- (id)nextObject;	// IMP=0x000000000003e3d4
- (_Bool)validateExtensionPointIdentifier:(id)arg1 sdkDictionary:(id)arg2;	// IMP=0x000000000003e08e
- (id)flattenEXExtensionPointConfigurationInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000003df48
- (id)synthesizeNSExtensionKeysInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000003dc7f
- (id)translateXPCCacheDictionary:(id)arg1;	// IMP=0x000000000003d890
- (id)initWithSDKDictionary:(id)arg1 urls:(id)arg2 config:(id)arg3;	// IMP=0x000000000003cada
- (id)initWithSDKDictionary:(id)arg1 config:(id)arg2;	// IMP=0x000000000003caad
- (id)initWithCacheURLs:(id)arg1 config:(id)arg2;	// IMP=0x000000000003ca8e
