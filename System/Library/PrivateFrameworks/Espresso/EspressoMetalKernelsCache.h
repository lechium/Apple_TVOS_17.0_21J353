...
- (id).cxx_construct;	// IMP=0x00000000008d2e90
- (void).cxx_destruct;	// IMP=0x00000000008d2e17
...
- (_Bool)shouldUseTexArray;	// IMP=0x00000000008d2dcd
- (id)kernelForFunction:(const char *)arg1 cacheString:(const char *)arg2 withConstants:(id)arg3;	// IMP=0x00000000008d1bcd
- (id)kernelForFunction:(const char *)arg1;	// IMP=0x00000000008d1bb6
- (void)addLibraryAtPath:(id)arg1;	// IMP=0x00000000008d19c3
- (void)loadLibraryNamed:(id)arg1;	// IMP=0x00000000008d179b
- (_Bool)wasSetup;	// IMP=0x00000000008d178d
- (void)lazySetup;	// IMP=0x00000000008d0f24
- (id)initWithDevice:(id)arg1;	// IMP=0x00000000008d0dee
