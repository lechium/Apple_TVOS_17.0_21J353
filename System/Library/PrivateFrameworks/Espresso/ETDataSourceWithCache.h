...
- (id).cxx_construct;	// IMP=0x00000000006ad05b
- (void).cxx_destruct;	// IMP=0x00000000006ad026
- (int)numberOfDataPoints;	// IMP=0x00000000006ad010
- (id)dataPointAtIndex:(int)arg1;	// IMP=0x00000000006ace57
- (id)initWithDataSource:(id)arg1 dumpPath:(id)arg2;	// IMP=0x00000000006acd80
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000006acca4
