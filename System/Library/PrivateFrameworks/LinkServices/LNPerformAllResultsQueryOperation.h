...
- (void).cxx_destruct;	// IMP=0x000000000009e65a
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000009e4e8
- (void)start;	// IMP=0x000000000009e422
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000009e15c
