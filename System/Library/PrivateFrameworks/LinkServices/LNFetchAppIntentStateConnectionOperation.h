...
- (void).cxx_destruct;	// IMP=0x000000000008e655
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000008e505
- (void)start;	// IMP=0x000000000008e3e7
- (id)initWithConnectionInterface:(id)arg1 appIntentIdentifiers:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000008e13f
