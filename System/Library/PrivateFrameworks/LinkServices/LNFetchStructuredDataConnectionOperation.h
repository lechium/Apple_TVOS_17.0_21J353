...
- (void).cxx_destruct;	// IMP=0x0000000000076ea3
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000076d50
- (void)start;	// IMP=0x0000000000076c1e
- (id)initWithConnectionInterface:(id)arg1 typeIdentifier:(long long)arg2 entityIdentifiers:(id)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000007695a
