...
- (void).cxx_destruct;	// IMP=0x000000000007d367
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000007d1d3
- (void)start;	// IMP=0x000000000007cfb9
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 actionMetadata:(id)arg3 parameterIdentifier:(id)arg4 queue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000007cc44
