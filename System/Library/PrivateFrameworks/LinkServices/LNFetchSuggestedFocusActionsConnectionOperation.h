...
- (void).cxx_destruct;	// IMP=0x000000000008dc28
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000008dab0
- (void)start;	// IMP=0x000000000008d901
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000008d6b6
