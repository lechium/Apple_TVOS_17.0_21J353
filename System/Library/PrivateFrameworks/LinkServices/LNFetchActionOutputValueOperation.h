...
- (void).cxx_destruct;	// IMP=0x0000000000073fea
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000073e94
- (void)start;	// IMP=0x0000000000073ca1
- (id)initWithConnectionInterface:(id)arg1 actionOutput:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000739fc
