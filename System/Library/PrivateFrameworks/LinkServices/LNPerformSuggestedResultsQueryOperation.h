...
- (void).cxx_destruct;	// IMP=0x000000000009a1bd
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000009a04b
- (void)start;	// IMP=0x0000000000099f07
- (id)initWithConnectionInterface:(id)arg1 entityType:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000099c3f
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000099979
