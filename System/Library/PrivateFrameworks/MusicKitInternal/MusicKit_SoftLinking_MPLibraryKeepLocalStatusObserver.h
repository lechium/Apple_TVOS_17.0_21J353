...
- (void).cxx_destruct;	// IMP=0x00000000000096ab
...
- (void)_handleUpdatedUnderlyingActiveKeepLocalStatus:(struct MPLibraryActiveKeepLocalStatus)arg1;	// IMP=0x000000000000961d
- (struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus)_activeKeepLocalStatusFromUnderlyingStatus:(struct MPLibraryActiveKeepLocalStatus)arg1 underlyingDownloadPauseReasons:(unsigned long long)arg2;	// IMP=0x00000000000095f6
- (void)calculateDownloadProgressWithChildren:(id)arg1;	// IMP=0x0000000000009397
@property(readonly, nonatomic) struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x0000000000008e99
