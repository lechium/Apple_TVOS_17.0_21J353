...
- (void).cxx_destruct;	// IMP=0x0000000000005f48
...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005bc4
- (id)initWithModelObject:(id)arg1 children:(id)arg2;	// IMP=0x0000000000005b19
