...
- (void).cxx_destruct;	// IMP=0x00000000000048ff
...
- (void)restoreStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000048b3
- (void)becomeActive;	// IMP=0x000000000000489d
- (void)start;	// IMP=0x0000000000004887
- (void)setStateRestorationSupported:(_Bool)arg1;	// IMP=0x0000000000004871
- (void)setVideoSupported:(_Bool)arg1;	// IMP=0x0000000000004845
- (void)setAudioAnalyzerEnabled:(_Bool)arg1;	// IMP=0x0000000000004819
- (void)setSystemMusicApplication:(_Bool)arg1;	// IMP=0x00000000000047ed
@property(readonly, nonatomic, getter=isStarted) _Bool started;
@property(readonly, copy, nonatomic) NSString *playerID;
- (id)initWithPlayerID:(id)arg1 options:(unsigned long long)arg2 fallbackPlaybackIntent:(id)arg3;	// IMP=0x00000000000045b8
