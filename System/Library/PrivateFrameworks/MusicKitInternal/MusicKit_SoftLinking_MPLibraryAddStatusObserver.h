...
- (void).cxx_destruct;	// IMP=0x00000000000107ac
...
- (long long)_libraryAddStatusFromUnderlyingStatus:(long long)arg1;	// IMP=0x0000000000010775
- (void)_handleUpdatedUnderlyingLibraryAddStatus:(long long)arg1;	// IMP=0x0000000000010740
@property(readonly, nonatomic) long long currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x0000000000010338
