...
- (double)pruneIntervalInSeconds;	// IMP=0x000000000001b082
- (double)cacheExpiryInSeconds;	// IMP=0x000000000001af8e
- (id)noLocationKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ae97
- (id)gridKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ada0
- (void)pruneCacheIfNeeded;	// IMP=0x000000000001a739
- (void)flushCache;	// IMP=0x000000000001a4e0
- (void)saveMetaData;	// IMP=0x0000000000019ec8
- (void)readMetaData;	// IMP=0x0000000000019974
- (_Bool)pendingMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x00000000000198c8
- (_Bool)pendingMapImageForRequest:(id)arg1;	// IMP=0x000000000001958a
- (void)cacheMapImage:(id)arg1 forLocation:(id)arg2 altitude:(double)arg3 pitch:(double)arg4 width:(double)arg5 andHeight:(double)arg6;	// IMP=0x00000000000194c9
- (void)cacheMapImage:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000000018e53
- (id)cachedMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000018d99
- (id)cachedMapImageForRequest:(id)arg1;	// IMP=0x0000000000018c22
- (void)cacheNoLocationImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x00000000000187b5
- (id)cachedNoLocationImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000018658
- (void)cacheGridImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x00000000000181eb
- (id)cachedGridImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001808e
- (id)init;	// IMP=0x0000000000017b7b
