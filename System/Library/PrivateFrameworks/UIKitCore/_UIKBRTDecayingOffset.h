...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000c8708a
- (void)reset;	// IMP=0x0000000000c87044
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000c87002
