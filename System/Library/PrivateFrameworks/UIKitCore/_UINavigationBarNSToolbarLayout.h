...
@interface _UINavigationBarNSToolbarLayout : NSObject
{
    ...
    NSArray *_leadingGroups;	// 56 = 0x38
    NSArray *_centerGroups;	// 64 = 0x40
    NSArray *_trailingGroups;	// 72 = 0x48
    UIBarButtonItemGroup *_pinnedTrailingGroup;	// 80 = 0x50
    NSString *_backButtonTitle;	// 88 = 0x58
    UIImage *_backButtonImage;	// 96 = 0x60
    CDUnknownBlockType _backButtonHandler;	// 104 = 0x68
    UISearchTextField *_inlineSearchTextField;	// 112 = 0x70
}

- (void).cxx_destruct;	// IMP=0x00000000007cee66
...
- (id)description;	// IMP=0x00000000007cec1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007cebed
- (id)_initWithLayout:(id)arg1;	// IMP=0x00000000007cea9e
