...
@interface _UICollectionLayoutItemSolverState : NSObject
{
    ...
    NSArray *_preferredSizeGroupingRanges;	// 72 = 0x48
    NSString *_errorDescription;	// 80 = 0x50
    struct CGPoint _additionalOffsetForOutermostGroup;	// 88 = 0x58
    struct CGRect _solvedFittingFrame;	// 104 = 0x68
}

- (void).cxx_destruct;	// IMP=0x00000000003212e7
