...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x0060000001307759
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x00600000013076dd
