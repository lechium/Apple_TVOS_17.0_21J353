...
- (void).cxx_destruct;	// IMP=0x000000000116f041
...
- (id)replacements;	// IMP=0x000000000116e640
- (void)addSpellingGuessesForString:(id)arg1 ToReplacements:(id)arg2;	// IMP=0x000000000116e03b
- (void)addAutocorrectionGuessesToReplacements:(id)arg1;	// IMP=0x000000000116dc82
- (void)addPreviouslySuggestedAutocorrectionToReplacements:(id)arg1;	// IMP=0x000000000116daa3
- (id)addReplacementRevertingAutocorrectionToReplacements:(id)arg1;	// IMP=0x000000000116d8b5
- (_Bool)isStringToReplaceMisspelled;	// IMP=0x000000000116d864
- (_Bool)isStringMisspelled:(id)arg1;	// IMP=0x000000000116d757
- (id)init;	// IMP=0x000000000116d70e
