...
- (void).cxx_destruct;	// IMP=0x00000000013da684
...
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000013da52c
- (void)setModifierGroupRequestHandler:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000013da4e1
- (id)modifierGroupRequestHandlerForKey:(id)arg1;	// IMP=0x00000000013da4cb
- (void)setPresentationModifier:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000013da480
- (id)presentationModifierForKey:(id)arg1;	// IMP=0x00000000013da46a
- (void)setAnimatableProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000013da35a
- (id)animatablePropertyForKey:(id)arg1 createIfNecessary:(_Bool)arg2;	// IMP=0x00000000013da099
- (id)animatablePropertyKeys;	// IMP=0x00000000013d9f9e
- (void)_invalidateIfPossible;	// IMP=0x00000000013d9f59
- (_Bool)_canInvalidate;	// IMP=0x00000000013d9ef6
- (id)initWithView:(id)arg1;	// IMP=0x00000000013d9e09
