...
+ (id)contextForTransition:(int)arg1;	// IMP=0x000000000022b2df
- (void).cxx_destruct;	// IMP=0x000000000022cf72
...
- (void)_updateIncomingLayoutWidthToMatchOutgoingLayout;	// IMP=0x000000000022cde8
- (void)_animateAsTwoPartsWithoutOverlap:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x000000000022cdce
- (void)_animateAsTwoPartsWithOverlapIfNecessaryPartOne:(CDUnknownBlockType)arg1 partTwo:(CDUnknownBlockType)arg2;	// IMP=0x000000000022cd48
- (void)_animateAsTwoPartsWithOverlap:(double)arg1 partOne:(CDUnknownBlockType)arg2 partTwo:(CDUnknownBlockType)arg3;	// IMP=0x000000000022cafa
- (void)_removeAllClippingViews;	// IMP=0x000000000022c9b2
- (void)_addClippingView:(id)arg1;	// IMP=0x000000000022c947
...
- (void)cancel;	// IMP=0x000000000022c675
- (void)complete;	// IMP=0x000000000022c4d0
- (void)_resetContentAndLargeTitleViewCompleted:(_Bool)arg1;	// IMP=0x000000000022c481
- (void)setAllLargeTitleLayoutsVisible;	// IMP=0x000000000022c442
- (void)animate;	// IMP=0x000000000022c430
- (void)_animateBackgroundView;	// IMP=0x000000000022c267
- (_Bool)shouldPerformTwoPartCrossfadeTransition;	// IMP=0x000000000022c21d
- (void)_animateFromBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x000000000022bd68
- (void)_prepareToBottomPaletteAtEdge:(unsigned long long)arg1;	// IMP=0x000000000022ba71
- (void)prepare;	// IMP=0x000000000022b7cc
- (void)recordUpdates:(CDUnknownBlockType)arg1;	// IMP=0x000000000022b438
- (id)description;	// IMP=0x000000000022b255
- (void)setBackgroundView:(id)arg1 isBarBackground:(_Bool)arg2;	// IMP=0x000000000022b21f
