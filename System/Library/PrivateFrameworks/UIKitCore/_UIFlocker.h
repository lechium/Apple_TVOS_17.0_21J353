...
- (void).cxx_destruct;	// IMP=0x00000000005efade
...
- (void)_installGhostPortalForPreview:(id)arg1;	// IMP=0x00000000005ef6af
- (id)_primaryPlatterView;	// IMP=0x00000000005ef65f
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000005ef564
- (struct CGPoint)_badgeCenter;	// IMP=0x00000000005ef471
- (void)updateFlockLocation;	// IMP=0x00000000005ef1c3
- (struct CGPoint)badgeLocationInView:(id)arg1;	// IMP=0x00000000005ef0f2
- (void)unflock;	// IMP=0x00000000005ef0d9
- (void)unflockToDrag:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000005ee6ac
- (void)flock;	// IMP=0x00000000005ed3f3
- (void)install;	// IMP=0x00000000005ec9c2
- (id)initWithContainerView:(id)arg1;	// IMP=0x00000000005ec71b
