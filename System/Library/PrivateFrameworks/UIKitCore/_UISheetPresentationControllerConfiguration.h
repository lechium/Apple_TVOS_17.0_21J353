...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x001000000110258e
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001102586
+ (id)_fullScreenConfiguration;	// IMP=0x0010000001100b7a
- (void).cxx_destruct;	// IMP=0x00000000011027ad
...
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x00000000011021c4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001101dfb
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x0000000001101a86
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011016f0
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001100bb2
- (id)init;	// IMP=0x0000000001100a3a
