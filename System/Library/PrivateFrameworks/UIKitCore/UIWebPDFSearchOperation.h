...
- (void)cancel;	// IMP=0x000000000147a36a
- (void)main;	// IMP=0x000000000147a22b
- (void)_search;	// IMP=0x0000000001479af3
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x00000000014797c7
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x00000000014794c5
- (void)_notifyDelegateOfStatus;	// IMP=0x000000000147934e
- (_Bool)_hitSearchLimit;	// IMP=0x0000000001479323
- (void)dealloc;	// IMP=0x00000000014792bb
- (id)init;	// IMP=0x0000000001479236
