...
- (void).cxx_destruct;	// IMP=0x0000000000fa22f2
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000fa21bd
- (id)type;	// IMP=0x0000000000fa2196
- (id)itemStates;	// IMP=0x0000000000fa1fe7
- (_Bool)isFulfilled;	// IMP=0x0000000000fa1e35
