...
+ (id)contextWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x00100000005ea872
- (void).cxx_destruct;	// IMP=0x00000000005ea978
...
- (void)dealloc;	// IMP=0x00000000005ea777
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x00000000005e9bb5
