...
+ (id)decodeFromCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x006000000018a393
+ (id)transparentBackgroundData;	// IMP=0x006000000018a2a3
+ (id)opaqueBackgroundData;	// IMP=0x006000000018a187
+ (id)standardBackgroundData;	// IMP=0x006000000018a01d
- (void).cxx_destruct;	// IMP=0x000000000018c6f3
...
- (long long)behaviorForTransitioningTo:(id)arg1;	// IMP=0x000000000018c350
@property(readonly, nonatomic) _Bool hasShadow;
@property(readonly, nonatomic) _Bool hasBackground;
- (void)configureWithoutShadow;	// IMP=0x000000000018c29c
- (void)configureWithDefaultShadow;	// IMP=0x000000000018c1f8
- (void)_updateShadowFlags;	// IMP=0x000000000018bfd2
@property(copy, nonatomic) UIBlurEffect *backgroundEffect;
- (void)_updateBackgroundFlags;	// IMP=0x000000000018bbc4
- (id)replicate;	// IMP=0x000000000018ba58
- (_Bool)checkEqualTo:(id)arg1;	// IMP=0x000000000018b70b
- (long long)hashInto:(long long)arg1;	// IMP=0x000000000018b614
- (void)describeInto:(id)arg1;	// IMP=0x000000000018b443
- (void)encodeToCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x000000000018aba7
