...
- (void).cxx_destruct;	// IMP=0x00000000009358cb
...
- (void)_configureSharedFloatingContentViewStyle;	// IMP=0x000000000093538f
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000935314
- (void)removeConstraints;	// IMP=0x0000000000935279
- (void)updateConstraints;	// IMP=0x0000000000935273
- (void)installConstraints;	// IMP=0x0000000000934674
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x0000000000934572
@property(readonly, nonatomic) struct NSDirectionalEdgeInsets backgroundViewInsets;
- (_Bool)allowsHighlightingOnHover;	// IMP=0x0000000000934552
...
- (id)initWithContentView:(id)arg1;	// IMP=0x000000000093448b
