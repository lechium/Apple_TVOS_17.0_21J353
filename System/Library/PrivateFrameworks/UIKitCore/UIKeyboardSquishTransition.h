...
- (void).cxx_destruct;	// IMP=0x0000000000cc9310
...
- (id)meshTransformForKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000cc73e0
- (id)symmetricMeshTransformForKeyplane:(id)arg1;	// IMP=0x0000000000cc5868
- (_Bool)_allowFacesToAdjoinToAdjacentFaces;	// IMP=0x0000000000cc5800
- (id)geometriesForKeyplane:(id)arg1;	// IMP=0x0000000000cc57cc
- (id)sortedCommonVisibleKeys;	// IMP=0x0000000000cc5656
- (void)updateOpacityAnimation:(id)arg1;	// IMP=0x0000000000cc5476
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000cc5267
- (void)removeAllAnimations;	// IMP=0x0000000000cc513c
- (void)_updateTransition;	// IMP=0x0000000000cc4f75
- (id)_animationsForEnd;	// IMP=0x0000000000cc49e4
- (id)_animationsForStart;	// IMP=0x0000000000cc443c
- (void)commitTransitionRebuild;	// IMP=0x0000000000cc437c
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000cc3f19
- (void)dealloc;	// IMP=0x0000000000cc3ed0
