...
- (void).cxx_destruct;	// IMP=0x0000000000f5286b
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000f527aa
- (void)jiggleWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f522dd
- (void)animateUnlockWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f51f86
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f51f70
- (void)resetLock;	// IMP=0x0000000000f51eb6
@property(readonly, nonatomic) _Bool prefersBaselineAlignment;
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f51cb5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f51ba6
