...
- (void).cxx_destruct;	// IMP=0x000000000131d192
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000131cf75
- (void)animationDidStart:(id)arg1;	// IMP=0x000000000131ccb6
- (id)initWithLabel:(id)arg1;	// IMP=0x000000000131cc52
