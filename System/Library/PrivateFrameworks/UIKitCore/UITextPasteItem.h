...
- (void).cxx_destruct;	// IMP=0x000000000119a281
...
- (void)setDefaultResult;	// IMP=0x0000000001199def
- (void)setNoResult;	// IMP=0x0000000001199dd4
- (void)setAttachmentResult:(id)arg1;	// IMP=0x0000000001199d7b
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x0000000001199d62
- (void)setStringResult:(id)arg1;	// IMP=0x0000000001199cb6
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x0000000001199c4b
