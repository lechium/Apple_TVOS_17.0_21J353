...
- (void).cxx_destruct;	// IMP=0x0000000000c86ff2
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c86ef0
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x0000000000c86ed0
- (void)startOrUpdateDecay;	// IMP=0x0000000000c86ea4
- (void)updateDecay;	// IMP=0x0000000000c86e5f
- (void)reset;	// IMP=0x0000000000c86e29
- (void)resetDecayTo:(double)arg1;	// IMP=0x0000000000c86dd2
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x0000000000c86d8f
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x0000000000c86d4c
