...
- (void).cxx_destruct;	// IMP=0x000000000077d17c
...
- (int)textEffectsVisibilityLevel;	// IMP=0x000000000077cdb1
- (int)textEffectsVisibilityLevelInKeyboardWindow;	// IMP=0x000000000077cda6
- (void)dismissWithText:(id)arg1;	// IMP=0x000000000077cd3b
- (void)dismissWithRevert:(id)arg1;	// IMP=0x000000000077cce4
- (void)dismissWithCancel;	// IMP=0x000000000077cc64
- (void)removeAnimated;	// IMP=0x000000000077cbb1
- (void)reset;	// IMP=0x000000000077cb67
- (void)removeFromSuperview;	// IMP=0x000000000077ca16
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000077c9f8
- (void)tappedInside:(id)arg1;	// IMP=0x000000000077c7f4
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000077c6ef
- (id)optionForPoint:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000077c68f
- (void)showTextHighlightView:(_Bool)arg1;	// IMP=0x000000000077c131
- (id)bubblePathInRect:(struct CGRect)arg1;	// IMP=0x000000000077c110
- (id)squaredOffBubblePathInRect:(struct CGRect)arg1;	// IMP=0x000000000077bb0e
- (id)backgroundImageView;	// IMP=0x000000000077b95f
- (id)textOptionWithText:(id)arg1 type:(long long)arg2;	// IMP=0x000000000077b903
- (void)layoutSubviews;	// IMP=0x000000000077b705
- (void)updateButtonForType:(long long)arg1;	// IMP=0x000000000077b6d5
- (void)updateButtonName:(id)arg1 placement:(long long)arg2 originalText:(id)arg3;	// IMP=0x000000000077a74c
- (void)updateViewForOptions:(id)arg1;	// IMP=0x0000000000779e69
- (void)updateWithChoices:(id)arg1 fromParentView:(id)arg2 referenceTextView:(id)arg3 presentedFromRect:(id)arg4;	// IMP=0x0000000000779cad
- (void)hideForNow;	// IMP=0x0000000000779c30
- (void)updateTextHighlightViewWithColor:(id)arg1 convertedRect:(struct CGRect)arg2;	// IMP=0x0000000000779b7a
- (void)updateTextBoxHighlightForRect:(id)arg1 inTextView:(id)arg2 parentView:(id)arg3 highlightColor:(id)arg4;	// IMP=0x0000000000779ab6
- (void)updateForSingleWord:(id)arg1 textAnchorRect:(id)arg2 inTextView:(id)arg3 parentView:(id)arg4 highlightColor:(id)arg5;	// IMP=0x00000000007798a1
- (void)showChoices:(_Bool)arg1;	// IMP=0x0000000000779651
- (_Bool)promptWillCollideWithKeyboard:(struct CGRect)arg1;	// IMP=0x00000000007793ac
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000778ae3
- (void)anchorToTextIfNeeded;	// IMP=0x0000000000777baa
- (void)updateTextAnchorForParentView:(id)arg1;	// IMP=0x000000000077734f
- (void)prepareGesture;	// IMP=0x0000000000777203
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000777130
- (id)init;	// IMP=0x00000000007770fe
