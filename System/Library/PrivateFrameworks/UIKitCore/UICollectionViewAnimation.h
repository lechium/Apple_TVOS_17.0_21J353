...
- (void).cxx_destruct;	// IMP=0x00000000004191ac
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000041910e
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000004190b6
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000418095
- (void)start;	// IMP=0x0000000000418081
...
- (id)description;	// IMP=0x0000000000417f9d
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000417d17
