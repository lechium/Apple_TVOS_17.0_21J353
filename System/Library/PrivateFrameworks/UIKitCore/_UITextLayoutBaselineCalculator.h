...
- (void).cxx_destruct;	// IMP=0x00000000006eeeb3
- (double)_convertOffset:(double)arg1;	// IMP=0x00000000006eedd1
...
- (double)_baselineOffsetAtPosition:(id)arg1;	// IMP=0x00000000006ee6f1
- (id)initWithTextLayoutController:(id)arg1 typingAttributes:(id)arg2 usesLineFragmentOrigin:(_Bool)arg3 coordinateSpace:(id)arg4 scale:(double)arg5 fallbackTextContainerOrigin:(struct CGPoint)arg6;	// IMP=0x00000000006ee5ff
