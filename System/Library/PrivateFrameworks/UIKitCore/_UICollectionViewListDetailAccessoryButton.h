...
- (void).cxx_destruct;	// IMP=0x000000000094935a
...
- (id)_renderedImage;	// IMP=0x0000000000949290
- (void)_executeActionHandler;	// IMP=0x000000000094919e
- (id)init;	// IMP=0x0000000000949021
