...
- (void).cxx_destruct;	// IMP=0x000000000087c431
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000087c380
- (id)viewForLastBaselineLayout;	// IMP=0x000000000087c36b
- (struct UIEdgeInsets)alignmentRectInsets;	// IMP=0x000000000087c32d
- (void)animateSlashForUpdate:(id)arg1;	// IMP=0x000000000087c15c
- (void)resetSlashForUpdate:(id)arg1;	// IMP=0x000000000087c0a9
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x000000000087bfdf
- (void)updateFramesForStyleAttributes:(id)arg1;	// IMP=0x000000000087be42
- (void)_setupForStyleAttributes:(id)arg1;	// IMP=0x000000000087b8ae
