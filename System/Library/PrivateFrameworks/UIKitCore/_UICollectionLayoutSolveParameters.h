...
- (void).cxx_destruct;	// IMP=0x0000000000314455
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000031439f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000031422b
- (id)init;	// IMP=0x0000000000313bae
