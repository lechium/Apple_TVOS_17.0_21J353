...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x0010000001042cc0
- (void).cxx_destruct;	// IMP=0x00000000010440eb
...
- (void)_completeHighlightEffect;	// IMP=0x0000000001043ffb
- (void)_createHighlightPlatter;	// IMP=0x0000000001043b25
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x00000000010431f8
@property(readonly, nonatomic) UITargetedPreview *targetedPreviewForEffectContinuation;
- (id)initWithTargetedPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x0000000001042d32
