...
- (void).cxx_destruct;	// IMP=0x000000000082343e
...
- (void)_pickerDidSelectColor:(id)arg1 colorSpace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x000000000082330e
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x0000000000823244
- (void)_displayLinkFired;	// IMP=0x00000000008231f4
- (id)init;	// IMP=0x00000000008230b1
