...
- (void).cxx_destruct;	// IMP=0x0000000000196811
...
- (void)_invoke:(id)arg1 forEvent:(id)arg2;	// IMP=0x00000000001965eb
@property(readonly, nonatomic) SEL proxyAction;
- (id)initWithBarButtonItem:(id)arg1;	// IMP=0x0000000000196573
- (id)init;	// IMP=0x00000000001964c6
