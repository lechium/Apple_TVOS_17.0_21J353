...
- (void).cxx_destruct;	// IMP=0x0000000000d58b2b
...
- (_Bool)_isPlatterInYLockedPosition;	// IMP=0x0000000000d58716
- (void)_updateSwipeEdgeMultipliersIfNeededForTouchPosition:(struct CGPoint)arg1;	// IMP=0x0000000000d584bc
- (void)_positionSwipeActionViewsForCurrentPlatterViewPosition;	// IMP=0x0000000000d5821d
- (_Bool)isDefaultAnimatorBehavior:(id)arg1;	// IMP=0x0000000000d5805b
- (void)addBehaviorIfNotPresent:(id)arg1;	// IMP=0x0000000000d57f88
- (void)resetAnimatorToDefaultBehaviors;	// IMP=0x0000000000d57d9b
- (struct CGPoint)menuCenter;	// IMP=0x0000000000d57c9d
- (struct CGPoint)platterCenter;	// IMP=0x0000000000d57b9f
- (struct CGPoint)centerForCurrentPlatterPosition;	// IMP=0x0000000000d57a9f
- (struct CGPoint)centerForMenuPresentedRelativeToCurrentPlatter;	// IMP=0x0000000000d578b7
- (struct CGVector)modifiedOffsetForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 touchPosition:(struct CGPoint)arg3 axisLock:(unsigned long long)arg4;	// IMP=0x0000000000d575c3
- (void)beginTransitionWithAnimatorUsingBehaviors:(id)arg1 observedItems:(id)arg2 stateIfCompleted:(long long)arg3;	// IMP=0x0000000000d57228
- (void)performActionsAndEnterState:(long long)arg1 velocity:(struct CGVector)arg2 underDirectManipulation:(_Bool)arg3;	// IMP=0x0000000000d5635a
- (void)performActionsAndEnterState:(long long)arg1;	// IMP=0x0000000000d5633d
- (long long)_stateForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 velocity:(struct CGVector)arg3;	// IMP=0x0000000000d56133
- (void)stopObservingBehavior;	// IMP=0x0000000000d560d9
- (void)_configureAnimator;	// IMP=0x0000000000d556ad
- (void)panningTransformer:(id)arg1 didEnterTransitionNotchForTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000d556a7
- (void)panningTransformer:(id)arg1 didEndPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 velocity:(struct CGVector)arg4;	// IMP=0x0000000000d5555d
- (void)panningTransformer:(id)arg1 didPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 touchPosition:(struct CGPoint)arg4 velocity:(struct CGVector)arg5 didChangeAxis:(_Bool)arg6 axisLock:(unsigned long long)arg7;	// IMP=0x0000000000d55179
- (void)panningTransformer:(id)arg1 didBeginPanToTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000d55068
- (_Bool)hasBeenPresented;	// IMP=0x0000000000d5504f
- (void)_animateToPlatterDismissedWithDuration:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d54df5
- (void)_animateToPlatterPresentedWithVelocity:(struct CGVector)arg1;	// IMP=0x0000000000d54d7f
- (void)_beginInYLockedStatePresented;	// IMP=0x0000000000d54d2d
- (void)lockIntoYAxis;	// IMP=0x0000000000d54cf0
- (_Bool)platterPanned;	// IMP=0x0000000000d54c16
- (_Bool)isSelectingSwipeAction;	// IMP=0x0000000000d54b16
- (_Bool)isMenuPresenting;	// IMP=0x0000000000d54afc
- (_Bool)isMenuPresented;	// IMP=0x0000000000d54ae2
- (void)resetAnimator;	// IMP=0x0000000000d54aa5
- (void)dealloc;	// IMP=0x0000000000d54a3a
- (void)toggleAnimatorDebugState;	// IMP=0x0000000000d549ae
- (void)didEndPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000d54908
- (void)didPanWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000d54871
- (void)didBeginPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000d547a4
...
- (id)initWithContainerView:(id)arg1 platterView:(id)arg2 menuView:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000d54603
