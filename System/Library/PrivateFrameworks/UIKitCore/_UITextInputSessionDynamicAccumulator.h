...
+ (id)accumulatorWithName:(id)arg1 depthRange:(struct _NSRange)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x006000000112bed2
- (void).cxx_destruct;	// IMP=0x000000000112c175
...
- (void)enumerateAnalytics:(CDUnknownBlockType)arg1;	// IMP=0x000000000112c13c
- (void)increaseWithActions:(id)arg1;	// IMP=0x000000000112c012
