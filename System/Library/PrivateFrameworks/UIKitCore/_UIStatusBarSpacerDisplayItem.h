...
- (void).cxx_destruct;	// IMP=0x0000000000f39277
@property(nonatomic) struct CGSize size; // @synthesize size=_size;
@property(retain, nonatomic) NSArray *constraints; // @synthesize constraints=_constraints;
@property(retain, nonatomic) UILayoutGuide *layoutGuide; // @synthesize layoutGuide=_layoutGuide;
- (void)_applyConstraintsIfNeeded;	// IMP=0x0000000000f3918f
- (void)setContainerView:(id)arg1;	// IMP=0x0000000000f390ba
- (void)applyUpdate:(id)arg1;	// IMP=0x0000000000f38ecf
- (id)initWithIdentifier:(id)arg1 item:(id)arg2;	// IMP=0x0000000000f38e8e
