...
- (void).cxx_destruct;	// IMP=0x0000000000d66e34
...
- (void)_performActionForPreviewAction:(id)arg1 interfaceAction:(id)arg2;	// IMP=0x0000000000d66c68
- (void)_setupViewHierarchy;	// IMP=0x0000000000d6619c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d6616d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d66125
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 items:(id)arg3 contentInsets:(struct UIEdgeInsets)arg4;	// IMP=0x0000000000d66045
