...
@class BKSAnimationFenceHandle, BSAnimationSettings, NSArray, NSData, NSSet, NSString, NSValue, UIFocusMovementAction, _UIClientToHostGestureChangeAction, _UISheetPresentationControllerClientConfiguration, _UITextServiceSessionContext, _UIViewAnimationAttributes;
