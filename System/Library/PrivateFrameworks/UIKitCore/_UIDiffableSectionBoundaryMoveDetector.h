...
- (void).cxx_destruct;	// IMP=0x0000000000948665
...
- (id)_computeMovePairsFoundation;	// IMP=0x0000000000947d20
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x0000000000947c09
