...
- (void).cxx_destruct;	// IMP=0x0000000000cbaf9e
...
- (_Bool)canDisplayTransitionFromKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000cbaef2
- (void)finishWithProgress:(double)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000cbad87
- (void)transitionToFinalState:(id)arg1;	// IMP=0x0000000000cbacf5
- (void)finalizeTransition;	// IMP=0x0000000000cbac0a
- (void)removeAllAnimations;	// IMP=0x0000000000cba9a3
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000cba659
- (void)cancelNonInteractiveAnimation;	// IMP=0x0000000000cba603
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000cba5f1
@property(readonly, nonatomic) double nonInteractiveDuration;
- (void)commitTransitionRebuild;	// IMP=0x0000000000cba5e2
- (void)addTransitionView:(id)arg1 startFrame:(struct CGRect)arg2 endFrame:(struct CGRect)arg3;	// IMP=0x0000000000cba28e
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000cba189
@property(readonly, nonatomic) double endHeight;
@property(readonly, nonatomic) double startHeight;
- (void)dealloc;	// IMP=0x0000000000cba0b2
