...
+ (id)sharedInstance;	// IMP=0x0060000000ca7586
- (void).cxx_destruct;	// IMP=0x0000000000ca82ec
...
- (void)configureOneFingerForcePressRecognizer:(id)arg1;	// IMP=0x0000000000ca804d
- (void)configureTwoFingerTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000ca7ff2
- (void)configureTwoFingerPanGestureRecognizer:(id)arg1;	// IMP=0x0000000000ca7f97
- (id)addLongPressTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000ca7f8f
- (id)addTwoFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000ca7f21
- (id)addOneFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000ca7e82
- (id)textSelectionInteractionForRTIForwarding;	// IMP=0x0000000000ca7e3e
- (_Bool)_longPressAllowedForView:(id)arg1;	// IMP=0x0000000000ca7e22
- (_Bool)allowOneFingerDeepPress;	// IMP=0x0000000000ca7e1a
- (double)oneFingerForcePressAllowableMovement;	// IMP=0x0000000000ca7e0c
- (_Bool)oneFingerForcePressShouldCancelTouchesInView;	// IMP=0x0000000000ca7e04
- (_Bool)oneFingerForcePressShouldFailWithoutForce;	// IMP=0x0000000000ca7dfc
- (double)oneFingerForcePressMinimumDuration;	// IMP=0x0000000000ca7dee
- (void)redisableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000ca7cae
- (void)enableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000ca7b58
- (void)didRemoveSelectionController;	// IMP=0x0000000000ca7b52
- (void)willRemoveSelectionController;	// IMP=0x0000000000ca7aa9
- (void)_cleanupDeadGesturesIfNecessary;	// IMP=0x0000000000ca798e
- (id)selectionController;	// IMP=0x0000000000ca793e
- (void)dealloc;	// IMP=0x0000000000ca7787
- (void)removeDeallocationHandler:(id)arg1;	// IMP=0x0000000000ca776a
- (id)addDeallocationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ca76ac
- (id)init;	// IMP=0x0000000000ca7637
- (_Bool)shouldAddForceGesture;	// IMP=0x0000000000ca75ec
- (Class)textInteractionClass;	// IMP=0x0000000000ca75db
