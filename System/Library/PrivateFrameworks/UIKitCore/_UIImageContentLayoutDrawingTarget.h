...
- (id)_symbolConfigurationForSource:(id)arg1;	// IMP=0x000000000096c426
- (long long)_effectiveRenderingModeForSource:(id)arg1 symbolConfiguration:(id)arg2;	// IMP=0x000000000096c40e
- (id)_renditionForSource:(id)arg1 size:(struct CGSize)arg2 symbolConfiguration:(id)arg3 withRenditionResult:(id)arg4 lazy:(_Bool)arg5;	// IMP=0x000000000096c1f4
- (id)_effectForRenderingSource:(id)arg1;	// IMP=0x000000000096c1eb
