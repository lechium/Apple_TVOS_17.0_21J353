...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x006000000116cf90
- (void).cxx_destruct;	// IMP=0x000000000116d2d8
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x000000000116d23b
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x000000000116d058
