...
- (void).cxx_destruct;	// IMP=0x0000000001023ca2
- (id)reorderSeparatorView:(_Bool)arg1;	// IMP=0x0000000001023b9e
- (id)reorderControl:(_Bool)arg1;	// IMP=0x0000000001023afa
- (id)editControl:(_Bool)arg1;	// IMP=0x00000000010239df
@property(readonly, nonatomic) _Bool wantsMaskingWhileAnimatingDisabled;
- (void)dealloc;	// IMP=0x000000000102392c
- (id)initWithTableViewCell:(id)arg1 editingStyle:(long long)arg2;	// IMP=0x00000000010238bd
