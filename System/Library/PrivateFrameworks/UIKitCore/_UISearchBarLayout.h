...
@interface _UISearchBarLayout
{
    ...
    double _leftContentInsetForInlineSearch;	// 112 = 0x70
    double _rightContentInsetForInlineSearch;	// 120 = 0x78
    long long _representedLayoutState;	// 128 = 0x80
    _UISearchBarScopeContainerLayout *_scopeContainerLayout;	// 136 = 0x88
    _UISearchBarSearchContainerLayout *_searchContainerLayout;	// 144 = 0x90
    struct UIOffset _searchFieldBackgroundPositionAdjustment;	// 152 = 0x98
    CDStruct_ef18196a _heightRange;	// 168 = 0xa8
    struct CGRect _promptContainerLayoutFrame;	// 184 = 0xb8
    struct CGRect _searchFieldContainerLayoutFrame;	// 216 = 0xd8
    struct CGRect _scopeBarContainerLayoutFrame;	// 248 = 0xf8
    struct CGRect _searchBarBackgroundLayoutFrame;	// 280 = 0x118
    struct CGRect _separatorLayoutFrame;	// 312 = 0x138
}

- (void).cxx_destruct;	// IMP=0x000000000026350f
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002631c0
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000263166
@property(readonly, copy) NSString *description;
- (void)cleanUpLayout;	// IMP=0x0000000000262358
- (void)applyScopeContainerSublayout;	// IMP=0x00000000002622f6
- (void)applyLayout;	// IMP=0x00000000002619ca
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x000000000026192b
- (double)minimumLayoutWidth;	// IMP=0x00000000002618f3
- (void)updateLayout;	// IMP=0x00000000002614e9
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x0000000000261436
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000002613cd
- (void)prepareSublayouts;	// IMP=0x000000000026139f
- (void)prepareScopeContainerLayout;	// IMP=0x000000000026126a
- (void)prepareSearchContainerLayout;	// IMP=0x0000000000260f73
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x0000000000260ee7
- (void)setUpSearchContainerLayout;	// IMP=0x0000000000260dc2
- (void)setUpScopeContainerLayout;	// IMP=0x0000000000260d43
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025fe94
