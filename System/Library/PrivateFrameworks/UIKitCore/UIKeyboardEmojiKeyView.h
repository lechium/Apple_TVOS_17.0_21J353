...
- (void).cxx_destruct;	// IMP=0x0000000000b3c263
...
- (long long)updateToCategoryWithOffsetPercentage:(double)arg1;	// IMP=0x0000000000b3c22e
- (void)updateToCategory:(long long)arg1;	// IMP=0x0000000000b3c228
