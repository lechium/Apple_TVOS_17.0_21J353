...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000000cbc0e3
- (void).cxx_destruct;	// IMP=0x0000000000cbc805
...
- (id)description;	// IMP=0x0000000000cbc525
- (void)addSlice:(id)arg1;	// IMP=0x0000000000cbc50f
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000cbbf3c
