...
- (void).cxx_destruct;	// IMP=0x00000000007aaeff
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000007aade7
- (id)initWithSceneLayer:(id)arg1;	// IMP=0x00000000007aac98
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000007aac11
