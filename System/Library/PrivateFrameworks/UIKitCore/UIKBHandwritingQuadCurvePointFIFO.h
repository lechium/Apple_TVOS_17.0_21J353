...
- (void).cxx_destruct;	// IMP=0x0000000000a0f8a5
...
- (void)clear;	// IMP=0x0000000000a0f78c
- (void)flush;	// IMP=0x0000000000a0f478
- (void)addPoint:(struct)arg1;	// IMP=0x0000000000a0eed0
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x0000000000a0ee3a
