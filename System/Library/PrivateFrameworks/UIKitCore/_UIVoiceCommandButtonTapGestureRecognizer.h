...
- (id)voiceCommandButtonTapDuration;	// IMP=0x0000000000ae033d
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ae02b2
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ae0227
- (void)reset;	// IMP=0x0000000000ae01de
