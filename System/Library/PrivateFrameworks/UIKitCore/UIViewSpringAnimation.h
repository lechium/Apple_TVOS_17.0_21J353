...
- (void).cxx_destruct;	// IMP=0x0000000001306e2f
...
- (_Bool)isStable;	// IMP=0x0000000001306c48
@property(retain, nonatomic) id <UIVectorOperatable> velocity;
- (id)stepWithDelta:(double)arg1;	// IMP=0x00000000013069bd
- (id)initWithCurrent:(id)arg1 targetValue:(id)arg2;	// IMP=0x0000000001306916
- (void)updateWithDescription:(id)arg1 initial:(_Bool)arg2;	// IMP=0x000000000130636b
- (void)updateWithDescription:(id)arg1;	// IMP=0x0000000001306357
- (id)initWithDescription:(id)arg1 current:(id)arg2 targetValue:(id)arg3;	// IMP=0x0000000001306117
