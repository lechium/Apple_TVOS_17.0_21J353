...
- (void).cxx_destruct;	// IMP=0x000000000084efa2
...
- (void)clearAllTimers;	// IMP=0x000000000084eeb0
- (void)_startEnoughTimeElapsedTimer;	// IMP=0x000000000084ebb6
- (void)secondDelayElapsed:(id)arg1;	// IMP=0x000000000084eb5b
- (void)setState:(long long)arg1;	// IMP=0x000000000084eaaf
- (void)_resetGestureRecognizer;	// IMP=0x000000000084ea62
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000084ea11
