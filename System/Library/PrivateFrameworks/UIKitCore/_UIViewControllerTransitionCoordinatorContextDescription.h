...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000012bc31c
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x00100000012bc1a3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000012bc4fc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000012bc324
