...
- (void).cxx_destruct;	// IMP=0x0000000000ed3ffb
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000000ed3c68
- (double)legibilityStrength;	// IMP=0x0000000000ed3c5a
- (void)_updateAccessoryImage;	// IMP=0x0000000000ed385b
- (double)extraRightPadding;	// IMP=0x0000000000ed37de
- (id)contentsImage;	// IMP=0x0000000000ed3766
- (id)_contentsImage;	// IMP=0x0000000000ed3268
- (id)_accessoryImage;	// IMP=0x0000000000ed3211
- (_Bool)_needsAccessoryImage;	// IMP=0x0000000000ed31fd
- (struct CGSize)_batteryOffsetWithBackground:(id)arg1;	// IMP=0x0000000000ed30ff
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000ed305e
