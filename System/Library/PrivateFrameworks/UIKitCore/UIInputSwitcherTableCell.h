...
+ (id)reuseIdentifier;	// IMP=0x00000000009a3f6b
...
- (void)_updateRoundedCorners;	// IMP=0x00000000009a42c6
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x00000000009a42c0
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000009a4216
- (void)layoutSubviews;	// IMP=0x00000000009a3ffc
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000009a3f75
