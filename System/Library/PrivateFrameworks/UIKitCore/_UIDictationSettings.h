...
+ (id)compositingFilters;	// IMP=0x0060000000b2484e
+ (id)frameRatesTitles;	// IMP=0x0060000000b2469c
+ (id)frameRates;	// IMP=0x0060000000b24566
+ (id)settingsControllerModule;	// IMP=0x0060000000b238d3
- (void).cxx_destruct;	// IMP=0x0000000000b24e35
...
- (void)setDefaultValues;	// IMP=0x0000000000b2368d
