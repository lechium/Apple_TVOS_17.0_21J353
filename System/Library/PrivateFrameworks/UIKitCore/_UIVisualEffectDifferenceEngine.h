...
- (void).cxx_destruct;	// IMP=0x00000000001795ba
...
- (id)description;	// IMP=0x00000000001793c1
- (id)describeMergeTable;	// IMP=0x00000000001792a1
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000001791ea
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x0000000000179063
- (void)_calculateMerge;	// IMP=0x0000000000178852
- (void)_calculateLCSSTable;	// IMP=0x000000000017862d
- (void)_calculatePrefixAndSuffix;	// IMP=0x0000000000178468
- (void)_reset;	// IMP=0x000000000017843b
- (void)dealloc;	// IMP=0x0000000000178401
