...
- (void).cxx_destruct;	// IMP=0x00000000002ca918
...
- (void)recordDictationTipReplacementText:(id)arg1;	// IMP=0x00000000002ca87a
- (void)startRecodingReplacementText:(id)arg1;	// IMP=0x00000000002ca868
- (void)finalizeRecordedText;	// IMP=0x00000000002ca6e2
- (void)recordDictationTipText:(id)arg1;	// IMP=0x00000000002ca63c
- (void)startRecodingText:(id)arg1;	// IMP=0x00000000002ca581
- (void)resetHandler;	// IMP=0x00000000002ca529
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002ca470
