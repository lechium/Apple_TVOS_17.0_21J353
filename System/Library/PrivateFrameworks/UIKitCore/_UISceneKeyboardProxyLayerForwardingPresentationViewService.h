...
+ (_Bool)forwardsLayersToRootSystemShell;	// IMP=0x00100000011e314b
- (void).cxx_destruct;	// IMP=0x00000000011e3326
@property(readonly, copy) NSString *description;
- (void)removeObserver:(id)arg1;	// IMP=0x00000000011e3244
- (void)addObserver:(id)arg1;	// IMP=0x00000000011e3153
- (id)keyboardLayers;	// IMP=0x00000000011e3108
