...
- (void).cxx_destruct;	// IMP=0x0000000000df11c2
...
- (void)updateSuggestionGroups:(id)arg1 userInitiated:(_Bool)arg2;	// IMP=0x0000000000df1174
- (void)updateSuggestions:(id)arg1 userInitiated:(_Bool)arg2;	// IMP=0x0000000000df116e
