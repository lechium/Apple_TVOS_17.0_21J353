...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0060000000f90d62
- (void).cxx_destruct;	// IMP=0x0000000000f9107e
...
- (id)description;	// IMP=0x0000000000f90f22
