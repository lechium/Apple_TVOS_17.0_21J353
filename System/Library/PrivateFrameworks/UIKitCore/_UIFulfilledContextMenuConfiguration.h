...
- (void).cxx_destruct;	// IMP=0x00000000012b3678
...
- (void)setPrimaryInternalIdentifier:(id)arg1 secondaryIdentifiers:(id)arg2;	// IMP=0x00000000012b3459
- (_Bool)isPresentable;	// IMP=0x00000000012b33d5
