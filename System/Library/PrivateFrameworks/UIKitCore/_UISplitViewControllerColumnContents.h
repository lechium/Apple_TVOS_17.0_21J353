...
- (void).cxx_destruct;	// IMP=0x0000000000559821
...
- (id)description;	// IMP=0x0000000000559721
@property(readonly, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
- (id)initWithViewController:(id)arg1 navigationController:(id)arg2 navigationControllerWrapper:(id)arg3;	// IMP=0x0000000000559592
