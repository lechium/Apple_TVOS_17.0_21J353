...
@class NSArray, UIGestureRecognizer, UITargetedPreview, UITouch, _UIClickPresentation, _UIClickPresentationInteraction;
...
- (void)_clickPresentationInteraction:(_UIClickPresentationInteraction *)arg1 shouldBeginWithTouch:(UITouch *)arg2 completion:(void (^)(unsigned long long))arg3;
@end
