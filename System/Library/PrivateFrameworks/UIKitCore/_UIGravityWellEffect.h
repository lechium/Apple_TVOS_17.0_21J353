...
+ (id)effectWithDescriptor:(id)arg1 continuationPreview:(id)arg2;	// IMP=0x001000000043dca7
- (void).cxx_destruct;	// IMP=0x0000000000440d42
...
- (id)_criticallyDampedEffectSpringBehavior;	// IMP=0x0000000000440c2c
- (id)_effectSpringBehavior;	// IMP=0x0000000000440bcf
- (void)_performAllCompletions;	// IMP=0x0000000000440ab2
- (void)_tearDownEffectViews;	// IMP=0x000000000044090f
- (void)_updateToProgress:(double)arg1 state:(long long)arg2;	// IMP=0x000000000043fea7
- (void)_installEffectViews;	// IMP=0x000000000043eca0
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000043ec13
- (id)previewForContinuingToEffectWithPreview:(id)arg1;	// IMP=0x000000000043e86b
- (void)setDescriptor:(id)arg1 andKey:(id)arg2;	// IMP=0x000000000043e85a
- (void)endForHandOff;	// IMP=0x000000000043e7b5
- (void)end;	// IMP=0x000000000043e734
- (void)updateWithProgress:(double)arg1;	// IMP=0x000000000043e6f1
- (void)begin;	// IMP=0x000000000043e630
