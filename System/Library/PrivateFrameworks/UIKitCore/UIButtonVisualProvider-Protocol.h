...
@class NSAttributedString, NSString, UIButton, UIContextMenuConfiguration, UIContextMenuInteraction, UIFocusAnimationCoordinator, UIFocusUpdateContext, UIImage, UIImageSymbolConfiguration, UIImageView, UILabel, UIMenu, UIScreen, UITargetedPreview, UITraitCollection, UIView, UIVisualEffectView, UIWindow, _UIContextMenuStyle, _UIFocusAnimationConfiguration;
