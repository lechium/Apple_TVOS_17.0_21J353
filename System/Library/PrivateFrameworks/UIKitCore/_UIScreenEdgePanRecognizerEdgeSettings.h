...
+ (id)settingsControllerModule;	// IMP=0x0060000000865753
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x0060000000865733
...
- (void)setDefaultValues;	// IMP=0x000000000086557e
