...
+ (id)transitionForExistingPlacement:(id)arg1 animationStyle:(id)arg2;	// IMP=0x0060000000b592e5
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000b59231
- (void).cxx_destruct;	// IMP=0x0000000000b59596
...
- (void)dealloc;	// IMP=0x0000000000b5946f
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000b59385
