...
+ (_Bool)_allowsDeferredTransitions;	// IMP=0x0010000000474dd2
- (void).cxx_destruct;	// IMP=0x0000000000474e31
...
- (id)_createVisualStyleForProvider:(id)arg1;	// IMP=0x0000000000474de2
- (_Bool)_mayChildGrabPresentedViewControllerView;	// IMP=0x0000000000474dda
- (_Bool)_isRootPresentation;	// IMP=0x0000000000474dca
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000474cdf
...
- (id)_fullscreenPresentationSuperview;	// IMP=0x0000000000474cb7
- (id)_parentTraitEnvironment;	// IMP=0x0000000000474ca5
- (id)initWithPresentedViewController:(id)arg1 presentingWindow:(id)arg2;	// IMP=0x0000000000474c32
