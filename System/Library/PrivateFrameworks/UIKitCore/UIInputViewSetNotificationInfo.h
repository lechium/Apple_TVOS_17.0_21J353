...
+ (id)info;	// IMP=0x0060000000b56ee0
- (void).cxx_destruct;	// IMP=0x0000000000b57da2
...
- (id)description;	// IMP=0x0000000000b57a9e
- (void)addKeyboardNotificationDebuggingInfo:(id)arg1;	// IMP=0x0000000000b57991
- (void)populateEndInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b578de
- (void)populateStartInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b5785e
- (void)populateWithAnimationStyle:(id)arg1;	// IMP=0x0000000000b577e6
- (_Bool)containsChange;	// IMP=0x0000000000b57765
- (void)logGeometry;	// IMP=0x0000000000b5775f
@property(readonly, nonatomic) NSDictionary *privateUserInfo;
- (id)rotationUserInfo;	// IMP=0x0000000000b5740d
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)inverseInfo;	// IMP=0x0000000000b5700b
- (id)init;	// IMP=0x0000000000b56ef9
