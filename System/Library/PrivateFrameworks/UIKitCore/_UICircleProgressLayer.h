...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x00600000005e0efe
- (void).cxx_destruct;	// IMP=0x00000000005e1269
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000005e0f73
- (id)initWithLayer:(id)arg1;	// IMP=0x00000000005e0d2e
- (id)init;	// IMP=0x00000000005e0bf4
