...
- (void).cxx_destruct;	// IMP=0x0000000000b56a2f
...
- (void)dragWillBegin:(id)arg1;	// IMP=0x0000000000b568e3
- (void)layoutSubviews;	// IMP=0x0000000000b5643f
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000b558a6
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000b55755
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b5525f
