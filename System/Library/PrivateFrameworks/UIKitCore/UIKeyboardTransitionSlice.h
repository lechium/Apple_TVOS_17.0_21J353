...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000000cbc8d7
- (void).cxx_destruct;	// IMP=0x0000000000cbcba6
...
- (id)description;	// IMP=0x0000000000cbc9fa
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000cbc93d
- (id)init;	// IMP=0x0000000000cbc838
