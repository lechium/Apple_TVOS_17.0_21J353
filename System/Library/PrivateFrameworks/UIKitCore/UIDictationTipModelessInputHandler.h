...
- (void).cxx_destruct;	// IMP=0x0000000000c96a6f
...
- (void)showModelessInputTip;	// IMP=0x0000000000c9694c
- (_Bool)shouldShowModelessInputTip;	// IMP=0x0000000000c9687d
- (void)triggerAttemptToShowModelessTipFlag;	// IMP=0x0000000000c9681e
- (void)userInteractionEndedDuringModelessInputTipDictationStoppedSignal;	// IMP=0x0000000000c967d9
- (void)processUserInteractionEnded;	// IMP=0x0000000000c96754
- (void)processSoftwareKeyboardInteraction;	// IMP=0x0000000000c966ca
- (void)resetDictationTipModelessHandlerSignalFlags;	// IMP=0x0000000000c96689
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000c96611
