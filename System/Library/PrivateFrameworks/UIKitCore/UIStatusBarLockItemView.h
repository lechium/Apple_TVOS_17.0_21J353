...
+ (double)lockSlideAnimationDuration;	// IMP=0x0010000000ee62e6
- (void).cxx_destruct;	// IMP=0x0000000000ee9152
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000000ee8f0c
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000ee8efa
- (void)jiggleCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ee8d1a
- (void)animateUnlockForegroundView:(id)arg1 timeItemSnapshot:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ee6af4
- (void)setVisible:(_Bool)arg1 frame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x0000000000ee66b3
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000ee6634
- (double)updateContentsAndWidth;	// IMP=0x0000000000ee646e
- (_Bool)_isAnimating;	// IMP=0x0000000000ee645a
- (void)_endAnimation;	// IMP=0x0000000000ee6316
- (void)_beginAnimation;	// IMP=0x0000000000ee6306
- (_Bool)isExclusive;	// IMP=0x0000000000ee62f4
