...
- (void).cxx_destruct;	// IMP=0x0000000000496acd
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000495d38
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000495cd7
- (void)finishTransition;	// IMP=0x0000000000495a2b
- (void)interruptTabBarControllerTransition;	// IMP=0x0000000000495a19
- (id)init;	// IMP=0x00000000004959dd
