...
- (void).cxx_destruct;	// IMP=0x0000000000ed5dfe
...
- (double)extraRightPadding;	// IMP=0x0000000000ed5d91
- (id)shortenedTitleWithCompressionLevel:(int)arg1;	// IMP=0x0000000000ed5ceb
- (void)userDidActivateButton:(id)arg1;	// IMP=0x0000000000ed5c54
- (long long)labelLineBreakMode;	// IMP=0x0000000000ed5c49
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000ed5a4f
