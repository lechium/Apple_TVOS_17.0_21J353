...
- (void).cxx_destruct;	// IMP=0x0000000000f455c9
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f4556a
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f45291
@property(copy, nonatomic) NSString *text;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f44e44
