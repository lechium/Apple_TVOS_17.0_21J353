...
- (void).cxx_destruct;	// IMP=0x0000000000f56dc0
@property(retain, nonatomic) UIStackView *stackView; // @synthesize stackView=_stackView;
@property(nonatomic) long long numberOfLines; // @synthesize numberOfLines=_numberOfLines;
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f56d3a
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000f56cea
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f56b8f
@property(readonly, nonatomic) NSArray *stringViews;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f5663d
