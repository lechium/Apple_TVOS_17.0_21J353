...
+ (_Bool)isEnabled;	// IMP=0x0060000000c8174b
- (void).cxx_destruct;	// IMP=0x0000000000c86beb
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000c864eb
- (void)_updateDriftView;	// IMP=0x0000000000c84c88
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000c84ba5
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000c84b97
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000c84b89
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000c8411f
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000c83727
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000c832ea
- (void)_updateHistory;	// IMP=0x0000000000c832a1
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000c82efa
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000c82c13
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000c8281b
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000c82577
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000c82314
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000c81ffd
- (void)reset;	// IMP=0x0000000000c81daa
- (void)_resetFeedback;	// IMP=0x0000000000c81ce1
- (void)dealloc;	// IMP=0x0000000000c81ca3
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000c81c52
- (id)init;	// IMP=0x0000000000c81776
