...
- (void).cxx_destruct;	// IMP=0x0000000000eaf853
...
- (void)dispatchUpdateWithPressure:(double)arg1 stillEstimated:(_Bool)arg2;	// IMP=0x0000000000eaf5ee
- (void)removeTouchable:(id)arg1;	// IMP=0x0000000000eaf5d8
- (void)addTouchable:(id)arg1;	// IMP=0x0000000000eaf57e
- (id)initWithLiveTouch:(id)arg1 freezeTouch:(id)arg2 contextID:(id)arg3;	// IMP=0x0000000000eaf4c6
