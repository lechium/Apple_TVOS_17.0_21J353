...
- (void).cxx_destruct;	// IMP=0x00000000007fd1bf
...
- (void)extraButtonTapAction;	// IMP=0x00000000007fce42
- (void)restartPagingAnimation;	// IMP=0x00000000007fcda8
- (void)tapInsideButton:(id)arg1;	// IMP=0x00000000007fcd4c
- (id)constructMediaView;	// IMP=0x00000000007fc6db
- (void)updateMediaViewTextAndPlacement;	// IMP=0x00000000007fbee6
- (struct CGSize)sizeForTutorialPageView;	// IMP=0x00000000007fbeb5
- (void)containerForAlertPresentation;	// IMP=0x00000000007fb550
- (void)containerForFullScreenView;	// IMP=0x00000000007fa355
- (void)containerForKeyboardView;	// IMP=0x00000000007f97a0
- (struct UIEdgeInsets)safeAreaInsets;	// IMP=0x00000000007f9716
- (void)configContainerView;	// IMP=0x00000000007f96d8
- (void)configBackgroundBlur;	// IMP=0x00000000007f8e86
- (double)containerBottomPadding;	// IMP=0x00000000007f8e42
- (double)containerTopPadding;	// IMP=0x00000000007f8c11
- (_Bool)isPortrait;	// IMP=0x00000000007f8bbd
- (void)layoutSubviews;	// IMP=0x00000000007f8b8f
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000007f8838
