...
- (void).cxx_destruct;	// IMP=0x00000000005ec6e4
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000005ebdb7
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000005ebda5
- (void)dealloc;	// IMP=0x00000000005ebd65
