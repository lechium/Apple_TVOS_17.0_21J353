...
- (void).cxx_destruct;	// IMP=0x000000000009b8ba
...
- (void)_updateForShadowPath;	// IMP=0x000000000009b649
- (id)initWithFrame:(struct CGRect)arg1 shadowPath:(id)arg2;	// IMP=0x000000000009b4d8
