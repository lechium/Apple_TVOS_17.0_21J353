...
- (void).cxx_destruct;	// IMP=0x0000000000644990
- (void)refreshControl:(id)arg1 didChangeToState:(long long)arg2 fromState:(long long)arg3;	// IMP=0x0000000000644890
- (void)incrementInsetHeight:(double)arg1;	// IMP=0x0000000000644855
- (void)decrementInsetHeight:(double)arg1;	// IMP=0x000000000064481a
...
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000000644798
