...
+ (id)applicatorForOwner:(id)arg1 withPlacement:(id)arg2;	// IMP=0x0010000000b4ab22
- (void).cxx_destruct;	// IMP=0x0000000000b4b6fc
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b4b5ad
- (_Bool)allConstraintsActive;	// IMP=0x0000000000b4b562
- (void)invalidate;	// IMP=0x0000000000b4b55c
- (void)prepare;	// IMP=0x0000000000b4b556
- (void)applyChanges:(id)arg1;	// IMP=0x0000000000b4b27c
- (void)checkVerticalConstraint;	// IMP=0x0000000000b4b263
...
- (_Bool)isGesture:(id)arg1 inDraggableView:(struct CGPoint)arg2;	// IMP=0x0000000000b4af14
- (_Bool)preBeginGesture:(id)arg1 shouldBegin:(_Bool *)arg2;	// IMP=0x0000000000b4ae80
- (struct CGRect)targetRect;	// IMP=0x0000000000b4aca2
...
- (id)initForOwner:(id)arg1 withPlacement:(id)arg2;	// IMP=0x0000000000b4a6f9
