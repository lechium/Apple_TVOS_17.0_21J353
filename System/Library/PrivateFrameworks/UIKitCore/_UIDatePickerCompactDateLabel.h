...
@class NSArray, NSDictionary, _UIDatePickerLinkedLabel, _UIDatePickerOverlayPresentation, _UIDatePickerStyle;
...
- (void).cxx_destruct;	// IMP=0x0000000000457a77
...
- (void)setEnabled:(_Bool)arg1;	// IMP=0x0000000000457438
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x000000000045724a
- (void)_didTapTextLabel;	// IMP=0x0000000000456ef8
- (void)activateLabel;	// IMP=0x0000000000456ee6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004566a6
