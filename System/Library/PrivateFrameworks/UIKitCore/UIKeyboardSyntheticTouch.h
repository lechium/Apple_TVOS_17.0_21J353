...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0060000000a929cc
- (void).cxx_destruct;	// IMP=0x0000000000a92cc7
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x0000000000a92c22
- (struct CGPoint)getLocationInWindow;	// IMP=0x0000000000a92c02
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x0000000000a92b76
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000a92aea
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0000000000a92a3f
