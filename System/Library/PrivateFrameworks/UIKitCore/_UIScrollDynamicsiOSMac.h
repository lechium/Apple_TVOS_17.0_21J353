...
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x0000000001388696
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x00000000013882c2
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x0000000001388232
- (double)speedAfterDuration:(double)arg1;	// IMP=0x00000000013880dc
- (double)durationUntilStop;	// IMP=0x00000000013880ca
- (void)calculateToReachDecelerationTarget;	// IMP=0x00000000013876a0
- (void)calculateDecelerationTarget;	// IMP=0x00000000013868ac
- (id)init;	// IMP=0x0000000001386863
