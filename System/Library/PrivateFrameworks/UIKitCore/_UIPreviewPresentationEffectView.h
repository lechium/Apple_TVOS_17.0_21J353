...
- (void).cxx_destruct;	// IMP=0x0000000000d6e84d
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x0000000000d6e1d1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d6dfa9
