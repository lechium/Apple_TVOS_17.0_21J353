...
+ (id)subrangeWithSubstring:(id)arg1 basePosition:(id)arg2;	// IMP=0x0060000000cf9ed5
- (void).cxx_destruct;	// IMP=0x0000000000cf9fed
...
- (id)description;	// IMP=0x0000000000cf9f68
