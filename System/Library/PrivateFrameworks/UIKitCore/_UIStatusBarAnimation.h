...
+ (void)_addAnimations:(id)arg1 toDispatchGroup:(id)arg2;	// IMP=0x0010000000f8ea59
+ (void)_addAnimations:(id)arg1 toPreparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3 visitedDisplayItemIdentifiers:(id)arg4;	// IMP=0x0010000000f8df73
+ (void)prepareAnimations:(id)arg1 forStatusBar:(id)arg2;	// IMP=0x0010000000f8dd56
+ (id)animationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000f8da19
+ (void)initialize;	// IMP=0x0010000000f8d9c2
- (void).cxx_destruct;	// IMP=0x0000000000f90196
...
- (id)description;	// IMP=0x0000000000f8fe4f
- (id)_dependentItemIdentifiersEnabledOnly:(_Bool)arg1;	// IMP=0x0000000000f8fc0f
@property(readonly, nonatomic) NSSet *effectiveDelayedItemIdentifiers;
- (void)addSubAnimation:(id)arg1 forDisplayItemWithIdentifier:(id)arg2;	// IMP=0x0000000000f8f690
- (void)cancel;	// IMP=0x0000000000f8f480
- (void)addTimeout:(double)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000f8f456
- (void)performForStatusBar:(id)arg1;	// IMP=0x0000000000f8eca8
- (void)_prepareForStatusBar:(id)arg1 preparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3;	// IMP=0x0000000000f8e48b
- (void)addTotalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f8dc88
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f8dbfb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f8dade
