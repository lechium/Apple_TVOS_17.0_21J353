...
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3 cornerMask:(unsigned long long)arg4;	// IMP=0x00100000000d333d
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3;	// IMP=0x00100000000d331f
+ (id)shapeWithPath:(id)arg1;	// IMP=0x00100000000d3204
- (void).cxx_destruct;	// IMP=0x00000000000d3f8c
...
- (id)description;	// IMP=0x00000000000d3d1b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d3c32
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d397d
...
- (id)shapeConvertedFromCoordinateSpace:(id)arg1 toCoordinateSpace:(id)arg2;	// IMP=0x00000000000d33ae
