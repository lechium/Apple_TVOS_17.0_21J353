...
- (UIColor *)defaultSidebarImageTintColorForTraitCollection:(UITraitCollection *)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2 isHeader:(_Bool)arg3 isAccompanied:(_Bool)arg4;
- (UIColor *)defaultSidebarTextColorForTraitCollection:(UITraitCollection *)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2 isHeader:(_Bool)arg3 isAccompanied:(_Bool)arg4 isSecondaryText:(_Bool)arg5;
