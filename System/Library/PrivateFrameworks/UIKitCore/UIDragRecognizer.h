...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x006000000110e120
- (void).cxx_destruct;	// IMP=0x000000000110e296
...
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000110e0ed
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000110e028
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000110dcad
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000110da55
- (void)clearIgnoreTouch;	// IMP=0x000000000110d9fb
- (void)tooSlow:(id)arg1;	// IMP=0x000000000110d9c8
- (void)clearTimer;	// IMP=0x000000000110d990
- (void)_resetGestureRecognizer;	// IMP=0x000000000110d93b
- (void)dealloc;	// IMP=0x000000000110d8d9
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000110d839
