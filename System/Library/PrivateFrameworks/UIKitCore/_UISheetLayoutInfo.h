...
@interface _UISheetLayoutInfo : NSObject
{
    ...
    _Bool __anyDescendantWantsFullScreen;	// 40 = 0x28
    _Bool __interactionEnabled;	// 41 = 0x29
    _Bool __scrollInteractionEnabled;	// 42 = 0x2a
    _Bool __shouldPresentedViewControllerControlStatusBarAppearance;	// 43 = 0x2b
    _Bool __shouldDimmingIgnoreTouches;	// 44 = 0x2c
    _Bool __dimmingEnabled;	// 45 = 0x2d
    _Bool __tucksIntoUnsafeAreaInCompactHeight;	// 46 = 0x2e
    _Bool __allowsAsymmetricVerticalMargins;	// 47 = 0x2f
    _Bool __containsFirstResponder;	// 48 = 0x30
    _Bool __firstResponderRequiresKeyboard;	// 49 = 0x31
    _Bool __remoteContainsFirstResponder;	// 50 = 0x32
    _Bool __remoteFirstResponderRequiresKeyboard;	// 51 = 0x33
    _Bool __shouldAdjustDetentsToAvoidKeyboard;	// 52 = 0x34
    _Bool __wantsFullScreen;	// 53 = 0x35
    _Bool __wantsEdgeAttached;	// 54 = 0x36
    _Bool __wantsEdgeAttachedInCompactHeight;	// 55 = 0x37
    _Bool __wantsFloatingInRegularWidthCompactHeight;	// 56 = 0x38
    _Bool __wantsInvertedWhenFloating;	// 57 = 0x39
    _Bool __widthFollowsPreferredContentSizeWhenEdgeAttached;	// 58 = 0x3a
    _Bool __presented;	// 59 = 0x3b
    _Bool __transitioning;	// 60 = 0x3c
    _Bool __hidden;	// 61 = 0x3d
    _Bool __shouldScaleDownBehindDescendants;	// 62 = 0x3e
    _Bool __reduceMotionEnabled;	// 63 = 0x3f
    _Bool __peeksWhenFloating;	// 64 = 0x40
    _Bool __hosting;	// 65 = 0x41
    _Bool __dismissible;	// 66 = 0x42
    _Bool __shouldDismissWhenTappedOutside;	// 67 = 0x43
    _Bool __allowsInteractiveDismissWhenFullScreen;	// 68 = 0x44
    _Bool __prefersScrollingResizesWhenDetentDirectionIsDown;	// 69 = 0x45
    _Bool __prefersScrollingExpandsToLargerDetentWhenScrolledToEdge;	// 70 = 0x46
    _Bool __dragging;	// 71 = 0x47
    _Bool __wantsGrabber;	// 72 = 0x48
    _Bool __insetsContentViewForGrabber;	// 73 = 0x49
    NSArray *__ancestorSheetIDs;	// 80 = 0x50
    NSSet *__descendantHiddenAncestorSheetIDs;	// 88 = 0x58
    double __percentFullHeight;	// 96 = 0x60
    double __proposedDepthLevelIncrement;	// 104 = 0x68
    double __proposedDepthLevel;	// 112 = 0x70
    double __depthLevel;	// 120 = 0x78
    double __percentFullScreen;	// 128 = 0x80
    double __dismissOffset;	// 136 = 0x88
    long long __indexOfCurrentActiveDetent;	// 144 = 0x90
    long long __adjustedIndexOfCurrentActiveDetentForContainedFirstResponder;	// 152 = 0x98
    long long __indexOfActiveDimmingDetent;	// 160 = 0xa0
    double __smallestNonDismissDetentOffset;	// 168 = 0xa8
    long long __numberOfActiveNonDismissDetents;	// 176 = 0xb0
    long long __indexOfActiveDetentForTappingGrabber;	// 184 = 0xb8
    long long __grabberAction;	// 192 = 0xc0
    long long __indexOfCurrentActiveOrDismissDetent;	// 200 = 0xc8
    double __rubberBandExtentBeyondMinimumOffset;	// 208 = 0xd0
    double __rubberBandExtentBeyondMaximumOffset;	// 216 = 0xd8
    _UISheetPresentationControllerAppearance *__effectiveAppearance;	// 224 = 0xe0
    double __offsetForCurrentActiveDetent;	// 232 = 0xe8
    double __nonFullHeightOffset;	// 240 = 0xf0
    double __offsetAdjustment;	// 248 = 0xf8
    double __percentPresented;	// 256 = 0x100
    ...
    double __remoteProposedDepthLevel;	// 496 = 0x1f0
    double __hostParentDepthLevel;	// 504 = 0x1f8
    CDUnknownBlockType __currentOffsetGetter;	// 512 = 0x200
    _UISheetLayoutInfo *__parentLayoutInfo;	// 520 = 0x208
    _UISheetLayoutInfo *__childLayoutInfo;	// 528 = 0x210
    CDUnknownBlockType __indexOfCurrentActiveOrDismissDetentWasInvalidated;	// 536 = 0x218
    CDUnknownBlockType __rubberBandExtentBeyondMinimumOffsetWasInvalidated;	// 544 = 0x220
    CDUnknownBlockType __rubberBandExtentBeyondMaximumOffsetWasInvalidated;	// 552 = 0x228
    double __confinedPercentLightened;	// 560 = 0x230
    id <_UISheetLayoutInfoDelegate> __delegate;	// 568 = 0x238
    NSMutableArray *__mutableDetentValues;	// 576 = 0x240
    NSMutableArray *__mutableActiveDetents;	// 584 = 0x248
    struct CGSize __preferredSize;	// 592 = 0x250
    struct CGPoint __rawCurrentOffset;	// 608 = 0x260
    struct CGPoint __currentOffset;	// 624 = 0x270
    struct CGSize __screenSize;	// 640 = 0x280
    struct UIEdgeInsets __unsafeInsets;	// 656 = 0x290
    struct UIEdgeInsets __marginsWhenFloating;	// 688 = 0x2b0
    struct UIEdgeInsets __margins;	// 720 = 0x2d0
    struct CGRect __effectiveKeyboardFrame;	// 752 = 0x2f0
    struct CGRect __stackAlignmentFrame;	// 784 = 0x310
    struct CGRect __fullHeightUntransformedFrame;	// 816 = 0x330
    struct CGRect __fullHeightUntransformedFrameForDepthLevel;	// 848 = 0x350
    struct CGRect __untransformedFrame;	// 880 = 0x370
    struct CGRect __hostedUntransformedFrame;	// 912 = 0x390
    struct CGRect __frameOfPresentedViewInContainerView;	// 944 = 0x3b0
    struct UIEdgeInsets __touchInsets;	// 976 = 0x3d0
    struct UIRectCornerRadii __cornerRadii;	// 1008 = 0x3f0
    struct UIRectCornerRadii __hostedCornerRadii;	// 1040 = 0x410
    struct CGRect __containerBounds;	// 1072 = 0x430
    struct UIEdgeInsets __containerSafeAreaInsets;	// 1104 = 0x450
    struct CGRect __sourceFrame;	// 1136 = 0x470
    struct CGRect __keyboardFrame;	// 1168 = 0x490
    struct CGRect __remoteKeyboardFrame;	// 1200 = 0x4b0
    struct CGRect __dismissSourceFrame;	// 1232 = 0x4d0
    struct CGRect __hostParentStackAlignmentFrame;	// 1264 = 0x4f0
    struct CGRect __hostParentFullHeightUntransformedFrameForDepthLevel;	// 1296 = 0x510
    struct CGAffineTransform __transform;	// 1328 = 0x530
}

- (void).cxx_destruct;	// IMP=0x0000000000480087
...
- (double)_maximumDepthLevelInChain;	// IMP=0x000000000047fb69
...
- (id)_descendantDescription;	// IMP=0x000000000047f88f
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x000000000047e26c
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000004777aa
- (void)_invalidateDetents;	// IMP=0x0000000000476e13
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x000000000047643b
- (void)_invalidatePreferredSize;	// IMP=0x00000000004763e8
- (id)initWithMetrics:(id)arg1;	// IMP=0x00000000004760da
