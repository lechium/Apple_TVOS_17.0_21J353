...
- (void).cxx_destruct;	// IMP=0x00000000000ef8ea
...
- (void)interactionProgress:(id)arg1 didEnd:(_Bool)arg2;	// IMP=0x00000000000ef87e
- (void)interactionProgressDidUpdate:(id)arg1;	// IMP=0x00000000000ef835
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x00000000000ef69c
