...
+ (id)autoFillTestArchiveWithData:(id)arg1;	// IMP=0x001000000093eff5
- (void).cxx_destruct;	// IMP=0x000000000093f36f
...
- (void)setTableViewDataSource:(id)arg1 forTableViewWithTag:(long long)arg2;	// IMP=0x000000000093f228
- (id)tableViewDataSourceWithTag:(long long)arg1;	// IMP=0x000000000093f1c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000093f16e
- (id)autoFillTestArchiveData;	// IMP=0x000000000093f0f2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000093eefb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000093eced
- (id)init;	// IMP=0x000000000093ec75
