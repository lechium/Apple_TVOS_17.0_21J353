...
- (void).cxx_destruct;	// IMP=0x000000000104f278
@property(copy, nonatomic) NSString *currentText;
- (void)layoutSubviews;	// IMP=0x000000000104f1e7
- (void)_willChangeToIdiom:(long long)arg1 onScreen:(id)arg2;	// IMP=0x000000000104f0df
- (void)_tapGestureChanged:(id)arg1;	// IMP=0x000000000104f088
- (id)initWithHost:(id)arg1;	// IMP=0x000000000104ef8e
