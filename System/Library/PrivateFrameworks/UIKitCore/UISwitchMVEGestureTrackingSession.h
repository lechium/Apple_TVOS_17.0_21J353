...
+ (_Bool)gestureIsInEndState:(long long)arg1;	// IMP=0x0060000000634253
- (void).cxx_destruct;	// IMP=0x00000000006342dd
...
- (void)_updateMovementVectorForPanInitiatedChanges;	// IMP=0x000000000063421b
- (_Bool)_isMovementDirectionAndMagnitudeEnoughToPerformOnOffChange:(double)arg1;	// IMP=0x00000000006341cd
- (_Bool)_isMovementDirectionTrackableForPossibleOnOffChange:(double)arg1;	// IMP=0x00000000006341a6
- (void)_sendStateChangeActionsIfNecessary;	// IMP=0x0000000000634163
- (void)_applyPendingChangesIfNecessary;	// IMP=0x00000000006340b6
- (void)applyPendingDisplayedOnValueWithoutSendingActions;	// IMP=0x00000000006340a4
- (void)applyPendingDisplayedOnValueAndSendActions;	// IMP=0x0000000000634076
- (_Bool)canApplyPendingOnValueForGesture:(id)arg1;	// IMP=0x0000000000634069
- (_Bool)updatePendingDisplayedOnValueIfMovementIsEnoughToInitiateChange:(double)arg1 forGesture:(id)arg2;	// IMP=0x0000000000633ff2
- (_Bool)pendingDisplayedOnValueIsValid;	// IMP=0x0000000000633fe4
- (void)invalidatePendingOnValue;	// IMP=0x0000000000633fcc
- (void)setPendingDisplayedOnValue:(_Bool)arg1 forGesture:(id)arg2;	// IMP=0x0000000000633f87
- (void)reset;	// IMP=0x0000000000633edf
- (id)initWithVisualElement:(id)arg1;	// IMP=0x0000000000633e29
