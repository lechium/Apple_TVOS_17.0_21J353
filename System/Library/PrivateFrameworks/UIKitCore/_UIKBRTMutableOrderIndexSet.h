...
- (void).cxx_destruct;	// IMP=0x0000000000c8c0ab
...
- (id)description;	// IMP=0x0000000000c8c001
- (void)removeIndexes:(id)arg1;	// IMP=0x0000000000c8bfeb
- (void)removeIndex:(unsigned long long)arg1;	// IMP=0x0000000000c8bfd5
- (void)addIndex:(unsigned long long)arg1;	// IMP=0x0000000000c8bfbf
...
- (id)initWithIndexesInRange:(struct _NSRange)arg1;	// IMP=0x0000000000c8beae
- (id)init;	// IMP=0x0000000000c8be54
