...
- (void).cxx_destruct;	// IMP=0x0000000000c8bd11
...
- (void)timerFired:(id)arg1;	// IMP=0x0000000000c8b916
- (void)invalidate;	// IMP=0x0000000000c8b875
- (void)fireNow;	// IMP=0x0000000000c8b786
- (void)dealloc;	// IMP=0x0000000000c8b748
- (id)initWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3 owner:(id)arg4;	// IMP=0x0000000000c8b5d5
