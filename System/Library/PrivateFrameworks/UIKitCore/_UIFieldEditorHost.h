...
+ (id)fieldEditorHostForTextField:(id)arg1;	// IMP=0x006000000013c996
- (void).cxx_destruct;	// IMP=0x000000000013cd18
...
- (id)description;	// IMP=0x000000000013ccd5
- (void)layoutIfNeeded;	// IMP=0x000000000013cccf
- (void)addPlaceholderLabel:(id)arg1;	// IMP=0x000000000013cc29
- (void)removeFieldEditor;	// IMP=0x000000000013cbf7
- (id)_viewForHostingFieldEditor;	// IMP=0x000000000013cbb4
- (void)addFieldEditor:(id)arg1;	// IMP=0x000000000013ca96
@property(readonly, nonatomic, getter=isHostingFieldEditor) _Bool hostingFieldEditor;
- (id)initWithHostingView:(id)arg1;	// IMP=0x000000000013ca24
