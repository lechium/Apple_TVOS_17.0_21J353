...
- (void).cxx_destruct;	// IMP=0x000000000103df44
...
- (void)invalidate;	// IMP=0x000000000103de20
- (void)dealloc;	// IMP=0x000000000103dde2
- (id)_initWithReason:(id)arg1 options:(unsigned long long)arg2 controller:(id)arg3 userInfo:(id)arg4;	// IMP=0x000000000103dd16
