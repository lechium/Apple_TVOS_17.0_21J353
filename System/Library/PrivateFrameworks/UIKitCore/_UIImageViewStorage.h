...
+ (id)storageForImageView:(id)arg1;	// IMP=0x0010000000d64989
- (void).cxx_destruct;	// IMP=0x0000000000d65a45
...
- (id)extendedStorage;	// IMP=0x0000000000d64a28
- (id)simpleStorage;	// IMP=0x0000000000d649cb
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000d65a6b
