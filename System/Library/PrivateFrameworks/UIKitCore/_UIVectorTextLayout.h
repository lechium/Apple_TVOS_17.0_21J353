...
- (void).cxx_destruct;	// IMP=0x000000000133b5c3
...
- (void)_layoutIfNeeded;	// IMP=0x000000000133a802
- (id)layoutDescription;	// IMP=0x0000000001339de3
- (id)description;	// IMP=0x0000000001339ccf
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001339c12
...
- (void)resetLayout;	// IMP=0x0000000001339aac
- (_Bool)hasLayout;	// IMP=0x0000000001339a9e
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x00000000013399cc
