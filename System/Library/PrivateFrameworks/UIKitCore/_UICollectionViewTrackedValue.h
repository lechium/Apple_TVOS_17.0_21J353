...
- (void).cxx_destruct;	// IMP=0x0000000000417d07
...
- (double)speed;	// IMP=0x0000000000417bc9
- (void)addValue:(double)arg1;	// IMP=0x0000000000417b04
- (id)init;	// IMP=0x00000000004179a2
