...
+ (id)animationWithPlatterView:(id)arg1 destination:(id)arg2 positionReferenceView:(id)arg3 type:(long long)arg4;	// IMP=0x0060000001116c1f
- (void).cxx_destruct;	// IMP=0x00000000011184a7
...
- (void)complete;	// IMP=0x0000000001118370
- (void)play;	// IMP=0x0000000001116dc5
