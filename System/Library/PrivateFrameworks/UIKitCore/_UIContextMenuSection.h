...
+ (id)sectionWithMenu:(id)arg1;	// IMP=0x0060000000378d8b
- (void).cxx_destruct;	// IMP=0x0000000000379621
...
- (unsigned long long)hash;	// IMP=0x00000000003795b6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000037955b
- (long long)cellSizeGivenTraits:(id)arg1;	// IMP=0x00000000003794d1
