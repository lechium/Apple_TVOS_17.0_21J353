...
@interface _UIPopoverLayoutInfo : NSObject
{
    ...
    struct UIEdgeInsets _sourceViewRectInsets;	// 176 = 0xb0
    _Bool _canOverlapSourceViewRect;	// 208 = 0xd0
    struct CGRect _frame;	// 216 = 0xd8
    double _offset;	// 248 = 0xf8
    unsigned long long _arrowDirection;	// 256 = 0x100
    _Bool _preferLandscapeOrientations;	// 264 = 0x108
    _Bool _updatesEnabled;	// 265 = 0x109
    NSMutableArray *_candidates;	// 272 = 0x110
    _Bool _isRTL;	// 280 = 0x118
    long long _preferredHorizontalAlignment;	// 288 = 0x120
}

+ (id)_observationKeys;	// IMP=0x0010000001266eff
- (void).cxx_destruct;	// IMP=0x00000000012689c8
...
@property(nonatomic) struct UIEdgeInsets sourceViewRectInsets; // @synthesize sourceViewRectInsets=_sourceViewRectInsets;
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000001268794
- (void)_updateOutputs;	// IMP=0x00000000012679a5
- (struct CGRect)_effectiveViewSourceRect;	// IMP=0x000000000126793c
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x00000000012677a2
- (id)candidates;	// IMP=0x0000000001267791
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x0000000001267729
- (id)description;	// IMP=0x0000000001267448
- (void)dealloc;	// IMP=0x00000000012672e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000126712d
- (id)init;	// IMP=0x0000000001266f84
