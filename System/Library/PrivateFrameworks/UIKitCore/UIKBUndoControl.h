...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0060000000d0ebe8
- (void).cxx_destruct;	// IMP=0x0000000000d0f9d2
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d0f846
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000d0f831
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000d0f7be
- (unsigned int)_secureName;	// IMP=0x0000000000d0f7a4
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000d0ece4
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000d0eb74
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d0eaee
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d0e76d
- (void)updateUndoControlStyle;	// IMP=0x0000000000d0e3c5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000d0e3bf
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000d0e021
