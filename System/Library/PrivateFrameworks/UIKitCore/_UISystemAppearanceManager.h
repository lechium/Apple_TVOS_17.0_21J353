...
- (void).cxx_destruct;	// IMP=0x00000000002ed49c
...
- (void)_logOrientationPreferencesChangeWithOldSupportedOrientations:(unsigned long long)arg1 newSupportedOrientations:(unsigned long long)arg2 oldPreferredOrientation:(long long)arg3 newPreferredOrientation:(long long)arg4 animationSettings:(id)arg5 fenced:(_Bool)arg6;	// IMP=0x00000000002ecf7f
- (void)window:(id)arg1 didUpdateSupportedOrientations:(unsigned long long)arg2 preferredOrientation:(long long)arg3 prefersAnimation:(_Bool)arg4;	// IMP=0x00000000002ec757
- (void)updateContainerBackgroundStyle;	// IMP=0x00000000002ec751
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x00000000002ec2e7
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x00000000002ec1c3
- (void)updateUserInterfaceStyle;	// IMP=0x00000000002ec10c
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x00000000002ec106
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x00000000002ec100
- (void)_windowDrivingSystemAppearanceDidChange:(id)arg1;	// IMP=0x00000000002ec0e9
- (void)_handleWindowVisibilityNotification:(id)arg1;	// IMP=0x00000000002ebe3c
- (id)_findWindowDrivingSystemAppearance;	// IMP=0x00000000002ebae2
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (void)dealloc;	// IMP=0x00000000002eb7e7
- (id)initWithScene:(id)arg1;	// IMP=0x00000000002eb645
