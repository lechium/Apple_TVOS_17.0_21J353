...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000b924b7
+ (id)_standardGlyphColor;	// IMP=0x0060000000b9247e
- (void).cxx_destruct;	// IMP=0x0000000000b92cdc
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000b9297a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b925a6
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000b924d0
