...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0060000000e5ba06
- (void).cxx_destruct;	// IMP=0x0000000000e5be5b
...
- (id)description;	// IMP=0x0000000000e5bc42
- (void)dealloc;	// IMP=0x0000000000e5bb9d
