...
+ (id)instanceForScene:(id)arg1;	// IMP=0x00600000005d82ff
+ (id)sharedInstance;	// IMP=0x00600000005d827a
- (void).cxx_destruct;	// IMP=0x00000000005daaf6
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000005d97ab
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000005d9799
- (void)displayForDownloadingURL:(id)arg1 sourceViewController:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005d977f
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 sourceViewController:(id)arg5 preDisplayTestBlock:(CDUnknownBlockType)arg6 dismissalHandler:(CDUnknownBlockType)arg7;	// IMP=0x00000000005d932f
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000005d8c77
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 replacementDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005d8b16
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d89dd
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x00000000005d89be
- (void)_hideTimerAction:(id)arg1;	// IMP=0x00000000005d8981
- (void)_showTimerAction:(id)arg1;	// IMP=0x00000000005d88b6
- (_Bool)_shouldAnimatePresentation;	// IMP=0x00000000005d88ae
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000005d885e
- (void)_reset;	// IMP=0x00000000005d872a
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000005d86da
- (id)init;	// IMP=0x00000000005d85c8
