...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x0010000000961895
- (void).cxx_destruct;	// IMP=0x0000000000961ab9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009616e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000961609
