...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0010000000f9e393
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0010000000f9dbd7
- (void).cxx_destruct;	// IMP=0x0000000000fa1ab6
...
- (id)description;	// IMP=0x0000000000fa1622
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000fa1288
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000fa0d46
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000fa0acf
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000fa08d8
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000fa03ae
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000fa018e
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000f9fed0
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000f9f7a4
- (_Bool)updatePlacement;	// IMP=0x0000000000f9f6c7
- (void)resetToPreferredPlacement;	// IMP=0x0000000000f9f6b1
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9f526
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9f284
- (void)_updateStatuses;	// IMP=0x0000000000f9f1a2
- (void)prepareForDataUpdate;	// IMP=0x0000000000f9f18b
- (void)prepareForOverflowDataUpdate;	// IMP=0x0000000000f9f175
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000f9e1ce
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000f9dfea
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000f9df5d
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000f9df26
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000f9dea2
