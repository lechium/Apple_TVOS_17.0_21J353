...
+ (id)atomWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0060000000b201ef
- (void).cxx_destruct;	// IMP=0x0000000000b20287
...
- (id)description;	// IMP=0x0000000000b20139
- (id)initWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0000000000b200a8
