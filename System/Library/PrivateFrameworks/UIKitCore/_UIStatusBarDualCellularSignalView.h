...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0010000000f47ab5
- (void).cxx_destruct;	// IMP=0x0000000000f4864d
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f48176
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f48034
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f48009
- (void)_iconSizeDidChange;	// IMP=0x0000000000f47ebd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f47e76
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f47e1e
- (void)_commonInit;	// IMP=0x0000000000f47ad5
