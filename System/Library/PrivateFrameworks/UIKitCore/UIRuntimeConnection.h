...
- (void).cxx_destruct;	// IMP=0x000000000093172e
...
- (void)connectForSimulator;	// IMP=0x00000000009316d9
- (void)connect;	// IMP=0x00000000009316d3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000931650
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000931582
