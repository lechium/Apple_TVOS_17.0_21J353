...
- (void).cxx_destruct;	// IMP=0x00000000002669bc
...
- (void)sendWillLayoutSubviewsForSearchFieldContainerView:(id)arg1;	// IMP=0x000000000026666f
- (id)description;	// IMP=0x00000000002661a3
- (void)applyLayout;	// IMP=0x0000000000265dee
- (void)updateLayout;	// IMP=0x0000000000265116
- (double)searchFieldHeightUpdatingShrinkageAndFadeAlphas;	// IMP=0x0000000000264fed
@property(readonly, nonatomic) double prescribedWidth;
- (double)_effectiveActiveWidth;	// IMP=0x0000000000264e36
- (double)_effectiveInactiveWidth;	// IMP=0x0000000000264df5
@property(readonly, nonatomic) double naturalSearchFieldHeight;
@property(readonly, nonatomic) double naturalContainerHeight;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000264970
