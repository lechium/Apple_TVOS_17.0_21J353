...
- (void).cxx_destruct;	// IMP=0x000000000088bfed
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x000000000088bd3d
- (id)_customScrollingMaskForScrollView:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x000000000088bbbd
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x000000000088bb6f
- (void)_scroll:(id)arg1 toContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000088b791
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x000000000088b6a0
- (void)_tearDown:(id)arg1;	// IMP=0x000000000088b61f
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x000000000088b346
- (void)dealloc;	// IMP=0x000000000088b1dc
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x000000000088b063
