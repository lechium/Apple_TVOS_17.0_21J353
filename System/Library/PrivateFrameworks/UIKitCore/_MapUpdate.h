...
+ (id)itemMoveFromIndexIndexPath:(id)arg1 toIndexPath:(id)arg2 fromIndex:(long long)arg3 toIndex:(long long)arg4;	// IMP=0x006000000043c573
+ (id)itemMoveSection:(long long)arg1 toSection:(long long)arg2 fromRange:(struct _NSRange)arg3 toRange:(struct _NSRange)arg4;	// IMP=0x006000000043c4bf
+ (id)itemDeleteItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000043c403
+ (id)itemDeleteSection:(long long)arg1 deleteRange:(struct _NSRange)arg2;	// IMP=0x006000000043c379
+ (id)itemInsertItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000043c2bd
+ (id)itemInsertSection:(long long)arg1 insertRange:(struct _NSRange)arg2;	// IMP=0x006000000043c233
- (void).cxx_destruct;	// IMP=0x000000000043cc38
...
- (id)reverseUpdateItem;	// IMP=0x000000000043c7ef
- (id)description;	// IMP=0x000000000043c684
