...
- (void).cxx_destruct;	// IMP=0x0000000001400587
...
- (void)startRecodingText:(id)arg1;	// IMP=0x0000000001400499
- (void)resetHandler;	// IMP=0x0000000001400457
- (void)recordDictationTipText:(id)arg1;	// IMP=0x00000000014003b0
- (void)finalizeRecordedText;	// IMP=0x0000000001400220
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000001400167
