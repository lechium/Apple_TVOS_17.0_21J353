...
- (void).cxx_destruct;	// IMP=0x00000000000d293e
...
- (_Bool)_isFixedWidth;	// IMP=0x00000000000d28fc
- (void)_updateConstantSizedConstraints;	// IMP=0x00000000000d284d
- (void)separatorViewDidUpdateConstraints;	// IMP=0x00000000000d283b
@property(nonatomic) double constantAxisDimension; // @synthesize constantAxisDimension=_constantAxisDimension;
- (id)initWithSeparatorView:(id)arg1;	// IMP=0x00000000000d252a
