...
- (void).cxx_destruct;	// IMP=0x0000000000ef5223
...
- (_Bool)_isEligibleForFocusOcclusion;	// IMP=0x0000000000ef5163
- (id)initWithTargetedPreview:(id)arg1;	// IMP=0x0000000000ef45a0
