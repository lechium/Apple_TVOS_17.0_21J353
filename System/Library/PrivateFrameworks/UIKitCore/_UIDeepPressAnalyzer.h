...
- (void).cxx_destruct;	// IMP=0x0000000000d6fad6
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000d6f8cf
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000d6f749
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000d6f6c5
- (id)init;	// IMP=0x0000000000d6f613
