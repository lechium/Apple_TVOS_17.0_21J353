...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x0060000001309540
- (void).cxx_destruct;	// IMP=0x00000000013095e4
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000013094a7
