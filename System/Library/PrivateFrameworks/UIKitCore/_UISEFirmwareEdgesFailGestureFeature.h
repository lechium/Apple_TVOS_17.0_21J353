...
- (void).cxx_destruct;	// IMP=0x000000000080a526
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x000000000080a473
- (id)debugDictionary;	// IMP=0x000000000080a3c4
- (id)initWithSettings:(id)arg1;	// IMP=0x000000000080a354
