...
@class NSArray, NSCoder, NSString, UIBarButtonItem, UIBlurEffect, UIDimmingView, UIFocusAnimationCoordinator, UIFocusUpdateContext, UIPopoverController, UIPresentationController, UIResponder, UISplitViewController, UISplitViewControllerDisplayModeBarButtonItem, UITraitCollection, UIView, UIViewController;
@protocol UIContentContainer, UIFocusEnvironment, UISplitViewControllerDelegate, UITraitEnvironment, UIViewControllerTransitionCoordinator;
...
- (_Bool)_isRotating;
- (_Bool)_isExpanding;
- (UIBlurEffect *)sidebarBlurEffect;
