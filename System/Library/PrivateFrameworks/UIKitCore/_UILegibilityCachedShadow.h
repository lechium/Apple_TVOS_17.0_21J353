...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008e35b0
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x00000000008e3536
- (void)dealloc;	// IMP=0x00000000008e34dd
