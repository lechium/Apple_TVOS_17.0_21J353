...
- (void).cxx_destruct;	// IMP=0x000000000025d424
...
- (id)imageForIcon:(long long)arg1 state:(unsigned long long)arg2;	// IMP=0x000000000025d2fa
- (void)setImage:(id)arg1 forIcon:(long long)arg2 state:(unsigned long long)arg3;	// IMP=0x000000000025d23d
- (id)searchFieldBackgroundImageForState:(unsigned long long)arg1;	// IMP=0x000000000025d1d6
- (void)setSearchFieldBackgroundImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x000000000025d0f9
