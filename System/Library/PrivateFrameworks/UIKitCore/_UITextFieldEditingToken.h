...
- (void).cxx_destruct;	// IMP=0x00000000011a4a19
...
- (_Bool)endEditing;	// IMP=0x00000000011a4768
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x00000000011a46c4
