...
- (void)sendImageTo:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x0000000000f14a3d
- (void)sendImage;	// IMP=0x0000000000f14901
- (void)renderImage;	// IMP=0x0000000000f142b1
@property(readonly, retain) UIImage *image; // @dynamic image;
- (void)releaseOperation;	// IMP=0x0000000000f14253
@property UIPDFPageRenderOperation *operation; // @dynamic operation;
- (void)setTarget:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x0000000000f14099
- (void)cancelOperationForTarget:(id)arg1;	// IMP=0x0000000000f13f11
- (void)cancelOperation;	// IMP=0x0000000000f13da9
- (void)cancel;	// IMP=0x0000000000f13c27
- (void)dealloc;	// IMP=0x0000000000f13bcf
- (id)initWithPage:(id)arg1 maxSize:(struct CGSize)arg2 queuePriority:(long long)arg3;	// IMP=0x0000000000f13aed
- (_Bool)hasPage;	// IMP=0x0000000000f13ac0
