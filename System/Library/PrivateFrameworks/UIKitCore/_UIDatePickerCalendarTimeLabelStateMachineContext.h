...
- (void).cxx_destruct;	// IMP=0x00000000004439e2
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x00000000004438a4
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x0000000000443874
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000443784
