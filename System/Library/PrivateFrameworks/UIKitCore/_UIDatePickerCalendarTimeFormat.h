...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3;	// IMP=0x00100000007b9388
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x00100000007b9373
- (void).cxx_destruct;	// IMP=0x00000000007bba17
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007bb710
- (id)withTimeZone:(id)arg1;	// IMP=0x00000000007bb664
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x00000000007bb61d
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x00000000007bb512
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x00000000007bb4fd
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x00000000007ba8b1
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3 forceDoubleDigitHours:(_Bool)arg4 displaysTimeZone:(_Bool)arg5;	// IMP=0x00000000007b943f
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x00000000007b9417
