...
+ (id)animatorWithViewController:(id)arg1;	// IMP=0x001000000148f55f
- (void).cxx_destruct;	// IMP=0x000000000148fb57
...
- (void)performAllCompletions;	// IMP=0x000000000148f98c
- (void)performAllAnimations;	// IMP=0x000000000148f7f3
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000148f766
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x000000000148f6d9
