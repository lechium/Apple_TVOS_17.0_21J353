...
- (id)ui_allSupplementalCandidates;	// IMP=0x003000000018ee64
...
- (long long)sourceForAutocorrection;	// IMP=0x0030000000964ef7
- (void)updateLabelsWithSmartPunctuation:(id)arg1;	// IMP=0x0030000000964c2e
@end
