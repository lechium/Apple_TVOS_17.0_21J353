...
- (void).cxx_destruct;	// IMP=0x000000000066f8a3
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x000000000066f1df
- (id)initWithShadowPath:(id)arg1;	// IMP=0x000000000066f0a0
