...
- (void).cxx_destruct;	// IMP=0x000000000081ee1d
...
- (id)description;	// IMP=0x000000000081ecdf
- (void)describeInto:(id)arg1;	// IMP=0x000000000081ec09
...
- (_Bool)bg2HasHeight;	// IMP=0x000000000081eba0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000081ea8c
- (id)initWithLayout:(id)arg1;	// IMP=0x000000000081e9c8
- (id)init;	// IMP=0x000000000081e9b4
