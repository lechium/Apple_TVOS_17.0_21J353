...
- (void).cxx_destruct;	// IMP=0x0000000000975a4d
...
- (id)traitCollection;	// IMP=0x0000000000975799
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000097556e
- (void)layoutSubviews;	// IMP=0x00000000009753c0
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x0000000000974bb1
- (_Bool)shouldExtendUpwards;	// IMP=0x0000000000974985
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x0000000000974330
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x000000000097404d
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x0000000000973bc9
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x000000000097332d
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x00000000009732ac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009731ec
