...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000013e8e73
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000013e8d92
- (void).cxx_destruct;	// IMP=0x00000000013e93ea
...
- (_Bool)_allowsHitTesting;	// IMP=0x00000000013e939f
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x00000000013e9396
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x00000000013e9321
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x00000000013e8fc4
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x00000000013e8f9c
