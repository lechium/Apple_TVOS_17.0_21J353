...
- (void).cxx_destruct;	// IMP=0x0000000001025d75
...
- (_Bool)handledUpdateOfActionable:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3;	// IMP=0x0000000001025c45
- (void)updateRegion:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3 cornerRadius:(double)arg4;	// IMP=0x0000000001025a58
- (id)animationForBackgroundActivityPillWithDuration:(double)arg1 scale:(double)arg2;	// IMP=0x0000000001025824
- (id)animationForBackgroundActivityPill;	// IMP=0x0000000001025807
- (id)animationForBackgroundActivityIcon;	// IMP=0x0000000001025684
- (void)_hideActivityDetailAndUpdate:(_Bool)arg1;	// IMP=0x00000000010255ae
- (void)updatePill;	// IMP=0x0000000001025592
- (void)_updateBackgroundActivityWithEntry:(id)arg1 timeEntry:(id)arg2 needsUpdate:(_Bool)arg3;	// IMP=0x000000000102518c
- (void)updateDataForBackgroundActivity:(id)arg1;	// IMP=0x0000000001024df1
