...
+ (id)settingsControllerModule;	// IMP=0x00100000011c6943
...
- (void)setDefaultValues;	// IMP=0x00000000011c68b6
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x00000000011c662b
- (id)initWithDefaultValues;	// IMP=0x00000000011c65dc
