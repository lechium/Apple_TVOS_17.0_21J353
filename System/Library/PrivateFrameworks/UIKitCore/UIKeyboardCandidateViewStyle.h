...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x0010000000963d51
+ (id)tvGridStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x001000000096394c
+ (id)tvLinearStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x001000000096357a
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000963548
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000963516
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x0010000000963290
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x0010000000963058
+ (id)darkKeyboardStyle;	// IMP=0x0010000000962c07
+ (id)lightKeyboardStyle;	// IMP=0x00100000009627b6
- (void).cxx_destruct;	// IMP=0x00000000009646ec
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000961f0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000961ae1
