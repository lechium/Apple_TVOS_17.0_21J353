...
- (double)_dimensionForRootGroupAlongAxis:(unsigned long long)arg1;	// IMP=0x000000000032a769
- (double)auxillaryHostPaddingBeforeBoundarySupplementaries;	// IMP=0x000000000032a651
- (id)auxillaryHostTraitCollection;	// IMP=0x000000000032a63f
- (id)auxillaryHostPreferredSizes;	// IMP=0x000000000032a637
- (id)auxillaryHostSupplementaryEnroller;	// IMP=0x000000000032a61d
- (long long)auxillaryHostAuxillaryKind;	// IMP=0x000000000032a612
- (unsigned long long)auxillaryHostLayoutAxis;	// IMP=0x000000000032a600
- (_Bool)auxillaryHostShouldLayoutRTL;	// IMP=0x000000000032a5ee
- (id)auxillaryHostAuxillaryItems;	// IMP=0x000000000032a59e
- (id)auxillaryHostContainer;	// IMP=0x000000000032a40f
- (_Bool)auxillaryHostWantsOverlapAdjustmentForMatchingAlignmentsOnly;	// IMP=0x000000000032a3e3
- (struct CGRect)auxillaryHostPinningRect;	// IMP=0x000000000032a33b
- (struct CGSize)auxillaryHostContentSize;	// IMP=0x000000000032a22c
- (struct _NSRange)preferredSizeGroupingRangeForItemAtIndex:(long long)arg1;	// IMP=0x0000000000329e9b
@property(readonly, nonatomic) unsigned long long containerSizeDependentAxes;
- (id)sectionSupplementaryFrameWithKind:(id)arg1 index:(long long)arg2;	// IMP=0x0000000000329cb5
- (long long)sectionSupplementaryKindIndexForEnrollmentIdentifier:(id)arg1;	// IMP=0x0000000000329c06
- (id)unpinnedSectionSupplementaryFrameForIndex:(long long)arg1;	// IMP=0x0000000000329a14
- (id)sectionSupplementaryFrameForIndex:(long long)arg1;	// IMP=0x000000000032983e
- (id)supplementaryFrameWithKind:(id)arg1 index:(long long)arg2;	// IMP=0x0000000000329552
- (id)frameForIndex:(long long)arg1;	// IMP=0x000000000032946b
...
- (id)visualDescription;	// IMP=0x000000000032904c
- (id)queryFramesIntersectingRect:(struct CGRect)arg1 frameOffset:(struct CGPoint)arg2;	// IMP=0x0000000000329042
- (id)queryFramesIntersectingRect:(struct CGRect)arg1;	// IMP=0x0000000000328a44
- (void)updatePinnedSupplementaryItemsWithVisibleBounds:(struct CGRect)arg1 overrideContentRectForPinning:(struct CGRect)arg2;	// IMP=0x00000000003289e1
- (void)updatePinnedSupplementaryItemsWithVisibleBounds:(struct CGRect)arg1;	// IMP=0x000000000032893b
- (id)resolveWithParameters:(id)arg1 preferredSizes:(id)arg2;	// IMP=0x00000000003288ad
- (void)solveForContainer:(id)arg1 supplementaryContainer:(id)arg2 traitCollection:(id)arg3 layoutAxis:(unsigned long long)arg4 frameCount:(long long)arg5 preferredSizes:(id)arg6 layoutRTL:(_Bool)arg7;	// IMP=0x000000000032813a
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4 preferredSizes:(id)arg5;	// IMP=0x000000000032810e
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4;	// IMP=0x00000000003280e3
