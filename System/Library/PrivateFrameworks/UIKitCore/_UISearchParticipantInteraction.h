...
- (void).cxx_destruct;	// IMP=0x00000000009da7db
...
- (void)_didMoveFromWindow:(id)arg1 toWindow:(id)arg2;	// IMP=0x00000000009da760
- (void)didMoveToView:(id)arg1;	// IMP=0x00000000009da735
- (void)willMoveToView:(id)arg1;	// IMP=0x00000000009da72f
- (void)dealloc;	// IMP=0x00000000009da6f1
- (void)_teardown;	// IMP=0x00000000009da653
- (void)_updateActiveSearchParticipationIfNeeded;	// IMP=0x00000000009da493
