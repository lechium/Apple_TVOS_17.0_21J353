...
+ (id)parametersSuitableForView:(id)arg1;	// IMP=0x001000000133b5eb
- (void).cxx_destruct;	// IMP=0x000000000133b9f9
...
- (_Bool)isEqualToParameters:(id)arg1;	// IMP=0x000000000133b842
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000133b813
- (void)_copyFromParameters:(id)arg1;	// IMP=0x000000000133b71c
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000133b6b4
