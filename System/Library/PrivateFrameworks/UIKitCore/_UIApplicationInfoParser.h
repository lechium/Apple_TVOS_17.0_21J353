...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _supportsSceneItemProviders;	// 19 = 0x13
    _Bool _supportedOnLockScreen;	// 20 = 0x14
    ...
    NSString *_preferredDefaultSceneSessionRole;	// 120 = 0x78
    NSDictionary *_sceneConfigurations;	// 128 = 0x80
    long long _supportedUserInterfaceStyle;	// 136 = 0x88
    NSArray *_deviceFamilies;	// 144 = 0x90
    NSDictionary *_utTypeToDocumentClassMap;	// 152 = 0x98
}

+ (id)mainBundleInfoParser;	// IMP=0x00600000007a0181
- (void).cxx_destruct;	// IMP=0x00000000007a1714
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x00000000007a15c6
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x00000000007a14ef
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000007a1217
- (_Bool)_shouldUseHiResForClassic;	// IMP=0x00000000007a120f
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x00000000007a0502
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000000007a027c
- (id)_initWithBundle:(id)arg1;	// IMP=0x00000000007a0226
