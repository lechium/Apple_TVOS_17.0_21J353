...
- (void).cxx_destruct;	// IMP=0x00000000005f0351
...
- (_Bool)updateVariableLengthStringForView:(id)arg1;	// IMP=0x00000000005f01ea
- (id)description;	// IMP=0x00000000005f014f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005effbf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005efd62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005efb83
