...
@interface UIEventFetcher : NSObject
{
    ...
    id <UIEventFetcherSink> _eventFetcherSink;	// 224 = 0xe0
}

- (void).cxx_destruct;	// IMP=0x0000000000ec30be
- (void)_receiveHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000ec17ad
- (void)threadMain;	// IMP=0x0000000000ec1624
- (void)displayLinkDidFire:(id)arg1;	// IMP=0x0000000000ec10a1
- (id)init;	// IMP=0x0000000000ec0b13
