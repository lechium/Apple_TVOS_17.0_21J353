...
- (void).cxx_destruct;	// IMP=0x0000000000c3a2f8
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x0000000000c3a0da
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x0000000000c3a0c8
- (id)_currentTitleColor;	// IMP=0x0000000000c3a07c
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000c3a03b
