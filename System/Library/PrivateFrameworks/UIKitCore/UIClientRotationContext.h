...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x0000000000498ff0
- (void)finishFirstHalfRotation;	// IMP=0x0000000000498b5a
- (void)rotateSnapshots;	// IMP=0x00000000004984d9
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x0000000000497882
- (_Bool)_isFooterTranslucent;	// IMP=0x000000000049783d
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000004977c0
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x0000000000497524
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x0000000000497504
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x0000000000497192
- (void)dealloc;	// IMP=0x0000000000497129
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x0000000000496edc
