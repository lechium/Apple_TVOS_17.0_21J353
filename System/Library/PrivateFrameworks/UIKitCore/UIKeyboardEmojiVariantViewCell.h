...
- (void).cxx_destruct;	// IMP=0x000000000066d8ab
@property(retain, nonatomic) UIKBRenderConfig *renderConfig; // @synthesize renderConfig=_renderConfig;
@property(nonatomic) _Bool highlighted; // @synthesize highlighted=_highlighted;
- (void)dragWillBegin:(id)arg1;	// IMP=0x000000000066d876
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000066d865
@property(retain, nonatomic) NSString *emoji;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000066d5f1
