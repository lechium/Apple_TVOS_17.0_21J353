...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x006000000102d902
- (void).cxx_destruct;	// IMP=0x000000000102db40
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000102dae8
- (id)description;	// IMP=0x000000000102da1d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000102d94b
- (id)init;	// IMP=0x000000000102d8c6
