...
- (void).cxx_destruct;	// IMP=0x0000000000821315
...
- (id)description;	// IMP=0x00000000008211c6
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x000000000082102f
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000820ff2
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000820e72
