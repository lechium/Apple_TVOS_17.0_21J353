...
+ (id)settingsControllerModule;	// IMP=0x00600000008663b2
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x0060000000866392
...
- (void)setDefaultValues;	// IMP=0x00000000008662ef
