...
- (void).cxx_destruct;	// IMP=0x00000000007f60b4
...
- (id)backgroundBlurEffects:(long long)arg1;	// IMP=0x00000000007f5fb3
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000007f5eb9
