...
- (void).cxx_destruct;	// IMP=0x00000000011c83c4
...
- (_Bool)supportsCoalescing;	// IMP=0x00000000011c8379
- (void)undoRedo;	// IMP=0x00000000011c8373
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x00000000011c82e6
