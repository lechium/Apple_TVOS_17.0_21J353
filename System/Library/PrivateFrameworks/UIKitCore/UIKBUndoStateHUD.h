...
- (void).cxx_destruct;	// IMP=0x0000000000d14b84
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000d14a7e
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000d148d9
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000d13423
