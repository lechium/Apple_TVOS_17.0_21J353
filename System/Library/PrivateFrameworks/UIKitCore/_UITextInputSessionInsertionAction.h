...
- (long long)inputActionCount;	// IMP=0x000000000112ea60
- (id)description;	// IMP=0x000000000112e89b
- (_Bool)changedContent;	// IMP=0x000000000112e893
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x000000000112e57b
