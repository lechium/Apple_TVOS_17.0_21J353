...
- (void).cxx_destruct;	// IMP=0x00000000008137b1
@property(readonly, nonatomic) NSDictionary *subfeatures; // @synthesize subfeatures=_subfeatures;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000008136c1
- (id)debugDictionary;	// IMP=0x000000000081356a
- (void)featureDidChangeState:(id)arg1;	// IMP=0x00000000008134ad
- (id)initWithSettings:(id)arg1 createFeatureBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000008133fa
