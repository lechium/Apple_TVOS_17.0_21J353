...
- (void).cxx_destruct;	// IMP=0x0000000000508027
...
- (id)description;	// IMP=0x0000000000507f3c
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x0000000000507e2b
