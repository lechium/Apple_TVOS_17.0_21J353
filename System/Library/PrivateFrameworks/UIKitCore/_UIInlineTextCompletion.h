...
+ (id)inlineTextCompletion:(id)arg1 source:(id)arg2;	// IMP=0x006000000123134a
- (void).cxx_destruct;	// IMP=0x000000000123152d
...
- (id)initWithCompletion:(id)arg1 source:(id)arg2;	// IMP=0x00000000012313c0
