...
- (void).cxx_destruct;	// IMP=0x00000000002e20e2
...
- (id)_textViewDefaults:(long long)arg1;	// IMP=0x00000000002e1c28
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x00000000002e1bdc
- (id)_labelDefaults:(long long)arg1;	// IMP=0x00000000002e1acc
- (id)_genericDefaults:(long long)arg1;	// IMP=0x00000000002e195d
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x00000000002e1742
