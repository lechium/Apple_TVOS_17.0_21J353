...
+ (id)settingsControllerModule;	// IMP=0x0060000000ee1479
- (void).cxx_destruct;	// IMP=0x0000000000ee17de
...
- (id)springAnimationBehavior;	// IMP=0x0000000000ee173e
- (void)setDefaultValues;	// IMP=0x0000000000ee1413
