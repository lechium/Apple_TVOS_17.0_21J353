...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x0010000000e7c071
+ (_Bool)requiresForceCapability;	// IMP=0x0010000000e7c069
- (void).cxx_destruct;	// IMP=0x0000000000e7c64c
...
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000e7c36a
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000e7c346
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000e7c266
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000e7c25e
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000e7c1ac
- (void)cancelInteraction;	// IMP=0x0000000000e7c16a
...
- (id)init;	// IMP=0x0000000000e7bfe0
