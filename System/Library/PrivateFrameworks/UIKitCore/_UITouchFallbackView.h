...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000efff4
- (int)textEffectsVisibilityLevel;	// IMP=0x00000000000effe9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000eff48
