...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x000000000068538b
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000006852de
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x0000000000685297
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x000000000068523b
- (id)init;	// IMP=0x00000000006851fc
