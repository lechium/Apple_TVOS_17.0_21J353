...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000d71566
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000d71539
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000d71508
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000d7149f
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000d7148d
- (void)reset;	// IMP=0x0000000000d71295
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000d70ed2
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000d70da3
- (id)description;	// IMP=0x0000000000d70cd0
- (void)dealloc;	// IMP=0x0000000000d70c4e
- (id)init;	// IMP=0x0000000000d70b3c
