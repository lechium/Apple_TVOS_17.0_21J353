...
+ (id)leftShadowImage;	// IMP=0x006000000094a492
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x006000000094a476
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000094aa92
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000094a591
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000094a509
