...
- (void).cxx_destruct;	// IMP=0x0000000000b9016e
...
- (void)complete;	// IMP=0x0000000000b90113
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x0000000000b8ff2d
