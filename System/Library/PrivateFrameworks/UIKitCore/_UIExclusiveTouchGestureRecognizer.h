...
- (void)reset;	// IMP=0x00000000008250a2
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000082505c
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000824db3
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000824a05
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008249bf
- (id)description;	// IMP=0x0000000000824896
