...
+ (id)defaultFormatter;	// IMP=0x00600000006f4529
- (void).cxx_destruct;	// IMP=0x00000000006f49be
...
- (id)stringFromReportComponents:(id)arg1;	// IMP=0x00000000006f458c
- (id)init;	// IMP=0x00000000006f453b
