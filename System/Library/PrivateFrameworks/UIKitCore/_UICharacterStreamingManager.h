...
- (void).cxx_destruct;	// IMP=0x00000000011ed792
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x00000000011ed642
- (void)_displayLinkFired:(id)arg1;	// IMP=0x00000000011ecd77
- (void)_startStreamingAnimations;	// IMP=0x00000000011ecc5f
- (void)_stopStreamingAnimation;	// IMP=0x00000000011ecbe9
- (void)setWords:(id)arg1;	// IMP=0x00000000011ecb0f
- (void)commitFinalResults;	// IMP=0x00000000011ecabf
- (id)initWithTextView:(id)arg1;	// IMP=0x00000000011eca4e
