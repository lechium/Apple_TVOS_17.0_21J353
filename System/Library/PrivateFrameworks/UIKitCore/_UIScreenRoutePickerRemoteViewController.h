...
+ (id)exportedInterface;	// IMP=0x00100000008fc11f
+ (id)serviceViewControllerInterface;	// IMP=0x00100000008fc0ff
- (void).cxx_destruct;	// IMP=0x00000000008fc3dc
...
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000008fc29a
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x00000000008fc259
- (void)_dismissViewController;	// IMP=0x00000000008fc1a3
- (void)invalidate;	// IMP=0x00000000008fc13f
