...
- (void).cxx_destruct;	// IMP=0x0000000000eb3636
- (void)dealloc;	// IMP=0x0000000000eb35f3
- (void)eventFetcherDidReceiveEvents:(id)arg1;	// IMP=0x0000000000eb35d2
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000000eb3338
