...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0010000000f486c0
+ (double)_fontSizeForIconSize:(long long)arg1;	// IMP=0x0010000000f486a0
- (void).cxx_destruct;	// IMP=0x0000000000f491a9
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000f48d8c
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000f48c68
- (void)_iconSizeDidChange;	// IMP=0x0000000000f48ac8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f48a81
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000f48a29
- (void)_commonInit;	// IMP=0x0000000000f486e0
