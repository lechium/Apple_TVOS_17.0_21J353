...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000b0e345
- (void).cxx_destruct;	// IMP=0x0000000000b0e6bc
...
- (id)description;	// IMP=0x0000000000b0e5e9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000b0e50e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000b0e3fb
- (id)initWithInterpretations:(id)arg1 isLowConfidence:(_Bool)arg2;	// IMP=0x0000000000b0e3d7
- (id)initWithInterpretations:(id)arg1;	// IMP=0x0000000000b0e34d
