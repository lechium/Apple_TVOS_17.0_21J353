...
- (void).cxx_destruct;	// IMP=0x00000000009b813a
...
- (void)endMultiselectInteraction;	// IMP=0x00000000009b801e
- (void)beginMultiselectInteraction;	// IMP=0x00000000009b8014
@property(readonly, nonatomic, getter=isInMultiselectInteraction) _Bool inMultiselectInteraction;
- (id)pathsToDeselectForInterpolatedIndexPaths:(id)arg1 currentlySelectedIndexPaths:(id)arg2;	// IMP=0x00000000009b7f22
- (id)pathsToSelectForInterpolatedIndexPaths:(id)arg1;	// IMP=0x00000000009b7e64
- (void)beginSelectingWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2 keepCurrentSelection:(_Bool)arg3;	// IMP=0x00000000009b7da0
- (void)updateStateWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2;	// IMP=0x00000000009b7c5f
- (void)updateStateWithDifferenceFromCurrentSelection:(id)arg1;	// IMP=0x00000000009b78a9
- (_Bool)stillValidForSelectedIndexPaths:(id)arg1;	// IMP=0x00000000009b783b
@property(readonly, nonatomic) _Bool ignoringSelectionChangedNotifications;
- (void)ignoreSelectionChangedNotificationsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000009b780f
- (id)initWithCurrentSelection:(id)arg1;	// IMP=0x00000000009b7729
