...
+ (id)transitionWithTransition:(id)arg1 sourceSymbolImage:(id)arg2 targetSymbolImage:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0060000000ff190c
- (void).cxx_destruct;	// IMP=0x0000000000ff1a63
