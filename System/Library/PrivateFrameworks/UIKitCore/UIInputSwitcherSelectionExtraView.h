...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000009aeb39
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000009aeae7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009aea5f
