...
- (void).cxx_destruct;	// IMP=0x000000000116f913
...
- (id)replacements;	// IMP=0x000000000116f62a
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x000000000116f567
