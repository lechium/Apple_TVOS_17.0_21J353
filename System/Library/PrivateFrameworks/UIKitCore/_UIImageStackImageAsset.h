...
- (void).cxx_destruct;	// IMP=0x00000000008dcf70
...
- (id)imageWithConfiguration:(id)arg1;	// IMP=0x00000000008dcd6a
- (id)initWithData:(id)arg1;	// IMP=0x00000000008dcbed
- (id)initWithContentsOfFile:(id)arg1;	// IMP=0x00000000008dcacc
