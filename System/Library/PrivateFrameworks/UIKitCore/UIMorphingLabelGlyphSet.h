...
- (void).cxx_destruct;	// IMP=0x0000000000d0891f
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000d087ff
- (void)placeGlyphs;	// IMP=0x0000000000d08633
- (void)removeGlyphs;	// IMP=0x0000000000d084c9
- (void)buildGlyphViews;	// IMP=0x0000000000d07329
- (void)dealloc;	// IMP=0x0000000000d072c0
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000d070c1
