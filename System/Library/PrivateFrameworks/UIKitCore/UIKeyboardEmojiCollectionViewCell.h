...
- (void).cxx_destruct;	// IMP=0x0000000000b39b8c
...
- (id)debugDescription;	// IMP=0x0000000000b39a11
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000b39525
@property(nonatomic) long long emojiFontSize;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b3865e
