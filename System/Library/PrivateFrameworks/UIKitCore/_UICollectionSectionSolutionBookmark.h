...
@interface _UICollectionSectionSolutionBookmark : NSObject
{
    ...
    _UICollectionPreferredSizes *_preferredSizes;	// 104 = 0x68
    _UICollectionLayoutSectionDescriptor *_memoizedDescriptor;	// 112 = 0x70
}

- (void).cxx_destruct;	// IMP=0x000000000030e312
- (id)description;	// IMP=0x000000000030dd09
