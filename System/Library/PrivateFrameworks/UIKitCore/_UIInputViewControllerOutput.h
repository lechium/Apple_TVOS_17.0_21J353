...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009c279d
- (void).cxx_destruct;	// IMP=0x00000000009c3b5c
...
- (id)description;	// IMP=0x00000000009c3677
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009c318d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009c2f2c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009c2c64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009c2b5d
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x00000000009c2b3a
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x00000000009c2a3c
- (void)deleteBackward;	// IMP=0x00000000009c2981
- (void)insertText:(id)arg1;	// IMP=0x00000000009c2918
- (id)_currentKeyboardOutput;	// IMP=0x00000000009c286f
- (void)_pushNewKeyboardOutput;	// IMP=0x00000000009c27a5
