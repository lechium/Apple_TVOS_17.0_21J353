...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000c27517
- (void).cxx_destruct;	// IMP=0x0000000000c276bb
...
- (void)dealloc;	// IMP=0x0000000000c275b4
