...
- (void).cxx_destruct;	// IMP=0x0000000000c93745
...
- (id)description;	// IMP=0x0000000000c93657
- (id)splitAtIndex:(long long)arg1 withImage:(id)arg2 active:(_Bool)arg3;	// IMP=0x0000000000c9344d
- (_Bool)validPageWithinBound:(long long)arg1;	// IMP=0x0000000000c93436
- (void)invalidateLayoutInfo;	// IMP=0x0000000000c933f2
- (void)_copyImagesFromObject:(id)arg1;	// IMP=0x0000000000c9332e
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) struct CGSize resolvedSize;
- (id)initWithStartIndex:(long long)arg1 endIndex:(long long)arg2;	// IMP=0x0000000000c93244
