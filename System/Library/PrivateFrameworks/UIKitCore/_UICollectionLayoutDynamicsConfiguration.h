...
- (void).cxx_destruct;	// IMP=0x0000000000312ae6
...
- (id)_dirtyItems;	// IMP=0x0000000000312a61
- (void)_reset;	// IMP=0x00000000003129f1
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x00000000003128e9
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000312805
- (id)behaviorsForItem:(id)arg1;	// IMP=0x00000000003126e7
- (id)init;	// IMP=0x0000000000312672
