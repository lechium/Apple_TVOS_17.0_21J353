...
+ (double)defaultDuration;	// IMP=0x006000000051dbb3
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x006000000051db75
+ (id)timingCurveProvider;	// IMP=0x006000000051db5c
- (void).cxx_destruct;	// IMP=0x000000000051dcb0
...
- (id)description;	// IMP=0x000000000051dac2
