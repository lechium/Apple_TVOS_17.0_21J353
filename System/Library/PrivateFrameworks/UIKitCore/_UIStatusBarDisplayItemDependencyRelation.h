...
- (void).cxx_destruct;	// IMP=0x0000000000fa25a0
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000fa2417
- (id)type;	// IMP=0x0000000000fa23f0
- (id)itemStates;	// IMP=0x0000000000fa2367
- (_Bool)isFulfilled;	// IMP=0x0000000000fa2305
