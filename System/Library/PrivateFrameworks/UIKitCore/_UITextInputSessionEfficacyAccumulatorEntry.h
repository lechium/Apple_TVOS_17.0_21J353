...
+ (id)generateAccumulatorEntryFromAction:(id)arg1;	// IMP=0x0060000001219b99
...
- (_Bool)isAllZeroes;	// IMP=0x0000000001219f0c
- (void)increaseWithEntry:(id)arg1;	// IMP=0x0000000001219e7e
