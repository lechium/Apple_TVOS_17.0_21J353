...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3 desiredUnits:(long long)arg4;	// IMP=0x0060000000d9fd78
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3;	// IMP=0x0060000000d9fd5c
- (void).cxx_destruct;	// IMP=0x0000000000da0743
...
- (id)description;	// IMP=0x0000000000da04d0
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000da0433
