...
- (void).cxx_destruct;	// IMP=0x000000000133d685
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000133d668
- (void)update;	// IMP=0x000000000133d64b
...
- (id)initWithContents:(id)arg1 delegatingToView:(id)arg2;	// IMP=0x000000000133d4a0
