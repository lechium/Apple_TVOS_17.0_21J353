...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001e1a99
- (void).cxx_destruct;	// IMP=0x00000000001e22f2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e1f99
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e1bcd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e1aa1
- (unsigned long long)hash;	// IMP=0x00000000001e1a29
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e154a
- (id)init;	// IMP=0x00000000001e14ec
