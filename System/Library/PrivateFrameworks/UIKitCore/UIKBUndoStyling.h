...
- (void).cxx_destruct;	// IMP=0x0000000000d0dfac
...
- (void)createDynamicColors;	// IMP=0x0000000000d0dac5
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000d0daac
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000d0d9d8
