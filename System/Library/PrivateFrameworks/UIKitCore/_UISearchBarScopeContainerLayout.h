...
- (void).cxx_destruct;	// IMP=0x0000000000264422
...
- (id)description;	// IMP=0x00000000002640f3
- (void)applyLayout;	// IMP=0x0000000000264041
- (void)updateLayout;	// IMP=0x0000000000263cab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000263c0b
- (double)scopeControlHeight;	// IMP=0x0000000000263ba6
