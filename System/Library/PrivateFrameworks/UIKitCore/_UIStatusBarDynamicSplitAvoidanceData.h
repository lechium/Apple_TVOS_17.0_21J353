...
- (void).cxx_destruct;	// IMP=0x0000000000de2882
...
- (id)initWithLeadingDelta:(double)arg1 trailingDelta:(double)arg2;	// IMP=0x0000000000de27da
- (id)init;	// IMP=0x0000000000de275a
