...
- (_Bool)_shouldFailInResponseToPresses:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ae0804
- (void)cancelPendingHoldToAction;	// IMP=0x0000000000ae07c1
- (void)scheduleHoldToAction;	// IMP=0x0000000000ae0788
- (void)holdToAction:(id)arg1;	// IMP=0x0000000000ae0703
- (void)cancelPendingTooSlowForDoubleTap;	// IMP=0x0000000000ae06c0
- (void)scheduleTooSlowForDoubleTap;	// IMP=0x0000000000ae0692
- (void)tooSlowForDoubleTap:(id)arg1;	// IMP=0x0000000000ae064f
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ae0541
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000ae049f
- (void)reset;	// IMP=0x0000000000ae040d
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000ae03de
