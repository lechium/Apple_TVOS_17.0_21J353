...
+ (double)fontSizeMultiplierForCurrentLanguage;	// IMP=0x006000000095bdb9
+ (double)lineHeightMultiplierForCurrentLanguage;	// IMP=0x006000000095bc4e
+ (id)configuration;	// IMP=0x006000000095b7b9
...
- (double)candidateDefaultFontSize;	// IMP=0x000000000095bc40
- (id)candidateFontWithSize:(double)arg1 language:(id)arg2;	// IMP=0x000000000095bad0
- (id)candidateFontWithSize:(double)arg1;	// IMP=0x000000000095ba17
...
- (id)extendedScrolledState;	// IMP=0x000000000095b9ec
- (id)extendedState;	// IMP=0x000000000095b9e4
- (id)initialState;	// IMP=0x000000000095b7cb
