...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000431790
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004319e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004318d2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000431798
