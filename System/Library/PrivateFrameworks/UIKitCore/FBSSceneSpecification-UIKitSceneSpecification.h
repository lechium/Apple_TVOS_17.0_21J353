...
- (id)disconnectionHandlers;	// IMP=0x00300000007d1bab
- (id)connectionHandlers;	// IMP=0x00300000007d1b9e
...
- (id)coreSceneComponentClassDictionary;	// IMP=0x00300000007d1b70
