...
- (void).cxx_destruct;	// IMP=0x0000000000c804ac
...
- (void)kbStatusMessage:(id)arg1;	// IMP=0x0000000000c80310
- (void)makeTouchIgnored:(id)arg1 force:(_Bool)arg2;	// IMP=0x0000000000c802f7
- (void)makeTouchIgnored:(id)arg1 force:(_Bool)arg2 withMessage:(id)arg3;	// IMP=0x0000000000c800ac
- (void)makeTouchIgnored:(id)arg1 force:(_Bool)arg2 because:(id)arg3;	// IMP=0x0000000000c7ff83
- (_Bool)makeTouchActive:(id)arg1;	// IMP=0x0000000000c7fbd8
- (void)cancelTouchOnLayoutWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7f9d1
- (void)notifyDelegateOfRestingTouch:(id)arg1;	// IMP=0x0000000000c7f8fb
- (void)notifyDelegateOfIgnoringTouch:(id)arg1;	// IMP=0x0000000000c7f6c6
- (_Bool)queryDelegateOfRestingTouch:(id)arg1;	// IMP=0x0000000000c7f6b2
- (_Bool)queryDelegateOfIgnoringTouch:(id)arg1 forOtherTouch:(_Bool)arg2;	// IMP=0x0000000000c7f368
- (void)notifyDelegateOfMovedIgnoredTouch:(id)arg1;	// IMP=0x0000000000c7f170
- (_Bool)notifyDelegateOfMovedTouch:(id)arg1;	// IMP=0x0000000000c7ee3f
- (void)notifyDelegateOfCancelledTouch:(id)arg1;	// IMP=0x0000000000c7eb4c
- (void)notifyDelegateOfSuccessfulTouch:(id)arg1;	// IMP=0x0000000000c7e781
- (_Bool)queryDelegateToBeginTouch:(id)arg1 forBeginState:(unsigned long long)arg2 restartIfNecessary:(_Bool)arg3;	// IMP=0x0000000000c7e2b9
- (_Bool)removedFromActiveTouches:(id)arg1;	// IMP=0x0000000000c7e186
- (_Bool)addedToActiveTouches:(id)arg1;	// IMP=0x0000000000c7e051
- (void)processTouchInfo:(id)arg1;	// IMP=0x0000000000c7dec9
- (void)updateIgnoredTouchesForTouchInfo:(id)arg1 whenTouchInfo:(id)arg2 changesStateTo:(BOOL)arg3;	// IMP=0x0000000000c7dd83
- (void)explicitlyIgnoreTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000c7dccb
- (void)_doIgnoreTouchWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7dc3e
- (void)markTouchProcessed:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000c7db86
- (void)_doMarkTouchProcessedWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7da82
- (void)touchCancelled:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000c7d98d
- (void)_doCancelledTouchWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7d7b4
- (void)touchUp:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000c7d6bf
- (void)_doEndedTouchWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7d17f
- (void)touchDragged:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000c7d09f
- (void)_doMovedTouchWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7cfd4
- (void)touchDown:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000c7cef7
- (void)_doBeginTouchWithTouchInfo:(id)arg1;	// IMP=0x0000000000c7bd30
- (void)letRulesModifyPendingTouchInfo:(id)arg1;	// IMP=0x0000000000c7b8c5
- (float)letRulesModifyNewTouchInfo:(id)arg1;	// IMP=0x0000000000c7b44b
- (void)setStandardKeyPixelSize:(struct CGSize)arg1;	// IMP=0x0000000000c7b2a4
- (void)reset;	// IMP=0x0000000000c7afd9
- (id)init;	// IMP=0x0000000000c7ae80
