...
- (void).cxx_destruct;	// IMP=0x000000000075d152
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x000000000075c947
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x000000000075c81e
- (_Bool)supportsBackButtons;	// IMP=0x000000000075c816
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x000000000075c7eb
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x000000000075c55e
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x000000000075c240
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x000000000075abaa
- (void)_selectGestureChanged:(id)arg1;	// IMP=0x000000000075ab44
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x000000000075aaad
- (id)contentView;	// IMP=0x000000000075aa19
- (id)backIndicatorView;	// IMP=0x000000000075aa07
