...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x0010000000298e2c
- (void).cxx_destruct;	// IMP=0x0000000000298f18
...
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x0000000000298e79
