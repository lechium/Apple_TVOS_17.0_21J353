...
- (void).cxx_destruct;	// IMP=0x0000000000c2594f
...
- (void)resetTimer;	// IMP=0x0000000000c256b3
- (void)invalidate;	// IMP=0x0000000000c255f3
- (_Bool)isValid;	// IMP=0x0000000000c2553b
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000c252ba
- (void)timerFired:(id)arg1;	// IMP=0x0000000000c251ea
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x0000000000c2508d
- (void)dealloc;	// IMP=0x0000000000c25032
