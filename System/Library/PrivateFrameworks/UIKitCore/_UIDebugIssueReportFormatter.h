...
- (void).cxx_destruct;	// IMP=0x00000000006f28b7
...
- (id)stringFromReport:(id)arg1;	// IMP=0x00000000006f27e1
- (id)_componentsFromReport:(id)arg1;	// IMP=0x00000000006f22b4
- (id)init;	// IMP=0x00000000006f21f2
