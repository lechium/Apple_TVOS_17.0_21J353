...
- (void).cxx_destruct;	// IMP=0x0000000001391e97
...
- (void)didFinishRotation;	// IMP=0x0000000001391c9e
- (void)willBeginRotationWithOriginalBounds:(struct CGRect)arg1 newBounds:(struct CGRect)arg2;	// IMP=0x0000000001391b85
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000001391893
- (void)setMagicShadowAlpha:(double)arg1;	// IMP=0x0000000001391844
- (void)_grabberPrimaryAction;	// IMP=0x00000000013917e7
- (_Bool)_isGrabber:(id)arg1;	// IMP=0x0000000001391761
@property(readonly, nonatomic) _Bool _hasCreatedGrabbers;
- (void)didMoveToWindow;	// IMP=0x0000000001390cd2
- (void)updateCornerClippingViews;	// IMP=0x00000000013906e9
@property(readonly, nonatomic) UIView *deepestClippingView;
- (void)_layoutGrabbers;	// IMP=0x0000000001390397
- (void)layoutSubviews;	// IMP=0x0000000001390265
...
- (id)initWithFrame:(struct CGRect)arg1 independentCorners:(long long)arg2 supportsShadow:(_Bool)arg3 stylesSheetsAsCards:(_Bool)arg4;	// IMP=0x000000000138f60c
