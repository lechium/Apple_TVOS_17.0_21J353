...
- (void).cxx_destruct;	// IMP=0x0000000000223925
...
- (void)adoptNewLayout;	// IMP=0x00000000002237d9
- (void)adoptLayout:(id)arg1;	// IMP=0x00000000002236ee
- (void)clearTransitionContext;	// IMP=0x0000000000223685
- (void)finalizeStateFromTransition:(id)arg1;	// IMP=0x000000000022367f
- (void)ensureBackButtonTruncationOccursWithContext:(id)arg1;	// IMP=0x0000000000223679
- (void)recordToStateForTransition:(id)arg1;	// IMP=0x00000000002235de
- (void)prepareToRecordToState:(id)arg1;	// IMP=0x000000000022355c
- (void)recordFromStateForTransition:(id)arg1;	// IMP=0x00000000002234bb
- (void)_clearAssistants;	// IMP=0x00000000002234b5
- (void)_setAssistants;	// IMP=0x00000000002234af
- (void)_contentSizeCategoryDidChange;	// IMP=0x0000000000223472
- (void)updateContent;	// IMP=0x000000000022345b
- (void)_updateContentAndInvalidate:(_Bool)arg1;	// IMP=0x0000000000223074
- (void)safeAreaInsetsDidChange;	// IMP=0x0000000000222f45
- (id)_effectiveTitle;	// IMP=0x0000000000222ed7
- (id)_titleForCurrentWidth;	// IMP=0x000000000022287b
- (void)layoutSubviews;	// IMP=0x000000000022278b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000022276e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x00000000002226f6
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000002226a5
@property(readonly, nonatomic) double restingHeightOfTitleView;
- (id)_layoutForMeasurement;	// IMP=0x00000000002225d5
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000222114
- (id)_newLayout;	// IMP=0x00000000002220e6
