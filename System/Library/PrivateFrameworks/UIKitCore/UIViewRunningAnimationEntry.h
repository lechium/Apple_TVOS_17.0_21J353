...
- (void).cxx_destruct;	// IMP=0x0000000001313a1c
...
- (void)performWithoutLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000013139b6
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001313911
- (void)setCompletionCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000013138ec
- (void)performCompletionCallbackFinished:(_Bool)arg1;	// IMP=0x000000000131389c
@property(nonatomic) _Bool invalidated;
- (id)initWithAnimation:(id)arg1 completion:(CDUnknownBlockType)arg2 composer:(id)arg3;	// IMP=0x00000000013137a5
