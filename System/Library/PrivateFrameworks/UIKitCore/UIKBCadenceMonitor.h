...
- (void).cxx_destruct;	// IMP=0x0000000000c79377
...
- (id)init;	// IMP=0x0000000000c7927e
- (void)reset;	// IMP=0x0000000000c791fc
- (void)addTypingTouchTime:(double)arg1;	// IMP=0x0000000000c791b5
- (void)logUserTyping:(id)arg1;	// IMP=0x0000000000c7913b
- (void)typingCadence:(double)arg1;	// IMP=0x0000000000c78e51
- (void)updateConfidenceWithGap:(double)arg1;	// IMP=0x0000000000c78dab
- (id)recognizer:(id)arg1 confidenceWhenSettingTouchInfo:(id)arg2;	// IMP=0x0000000000c78da3
- (id)recognizer:(id)arg1 confidenceWhenPendingTouchInfo:(id)arg2;	// IMP=0x0000000000c78d1e
