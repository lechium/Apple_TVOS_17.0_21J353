...
- (void).cxx_destruct;	// IMP=0x0000000000f07503
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000f0731c
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000f0730a
- (void)_create_nameView;	// IMP=0x0000000000f072b0
- (id)dependentEntryKeys;	// IMP=0x0000000000f07216
