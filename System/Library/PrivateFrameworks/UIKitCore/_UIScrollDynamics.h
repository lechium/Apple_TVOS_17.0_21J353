...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x000000000138553e
- (void)calculateToReachDecelerationTarget;	// IMP=0x0000000001385538
- (void)calculateDecelerationTarget;	// IMP=0x0000000001385532
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x000000000138552a
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x0000000001385514
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x0000000001385508
- (double)speedAfterDuration:(double)arg1;	// IMP=0x00000000013854ff
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x00000000013853ea
- (id)init;	// IMP=0x000000000138537f
