...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x0060000000208b33
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x00000000002091b7
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x0000000000209155
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x0000000000209140
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000020912b
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x0000000000209101
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000020903b
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000020902f
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x0000000000208fd1
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x0000000000208db4
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x0000000000208d81
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x0000000000208c06
- (id)initWithIdiom:(long long)arg1;	// IMP=0x0000000000208bc9
