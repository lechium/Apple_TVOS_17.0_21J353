...
- (void).cxx_destruct;	// IMP=0x00000000000ce5f3
...
- (void)_gestureChanged:(id)arg1;	// IMP=0x00000000000ce4a6
- (void)reset;	// IMP=0x00000000000ce463
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000ce365
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000ce2d0
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x00000000000ce22c
