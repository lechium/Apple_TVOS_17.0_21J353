...
- (void).cxx_destruct;	// IMP=0x000000000038d283
...
- (void)_prepareAnimationViews;	// IMP=0x000000000038c8a3
- (void)_prepareSnapshots;	// IMP=0x000000000038c547
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000038b924
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x000000000038b811
