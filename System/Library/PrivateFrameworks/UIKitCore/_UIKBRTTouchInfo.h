...
+ (id)createTouchInfoForTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0060000000c8a7d6
+ (id)touchInfoForTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0060000000c8a72a
+ (void)setTouchInfo:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0060000000c8a686
+ (id)touchDict;	// IMP=0x0060000000c8a614
- (void).cxx_destruct;	// IMP=0x0000000000c8b593
...
- (_Bool)willChangeTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000c8b372
- (id)setOfTouchesToIgnoreWhenSettingTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000c8ae4b
- (void)cleanup;	// IMP=0x0000000000c8addb
- (void)invalidateTimer;	// IMP=0x0000000000c8ad49
- (void)fireTimerNow;	// IMP=0x0000000000c8aca3
- (void)setTimerWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c8ab62
- (void)updateTouch:(id)arg1;	// IMP=0x0000000000c8aa74
@property(readonly, nonatomic) _UIKBRTTouchInfo *nextTouch;
@property(readonly, nonatomic) _UIKBRTTouchInfo *previousTouch;
- (void)dealloc;	// IMP=0x0000000000c8aa12
- (id)initWithTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000c8a86f
