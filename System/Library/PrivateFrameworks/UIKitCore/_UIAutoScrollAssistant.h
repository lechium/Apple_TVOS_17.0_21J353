...
- (void).cxx_destruct;	// IMP=0x0000000001260225
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x00000000012600fa
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x000000000126006d
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x000000000125fff7
- (void)displayLinkFired:(id)arg1;	// IMP=0x000000000125fde2
- (_Bool)_scrollContinuous;	// IMP=0x000000000125fd74
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x000000000125fcd8
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x000000000125faa7
- (id)initWithScrollView:(id)arg1;	// IMP=0x000000000125f9d4
