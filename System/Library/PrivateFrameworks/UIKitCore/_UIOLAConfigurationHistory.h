...
- (void).cxx_destruct;	// IMP=0x00000000012c5f0d
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x00000000012c5d90
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x00000000012c5cc9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000012c5b93
