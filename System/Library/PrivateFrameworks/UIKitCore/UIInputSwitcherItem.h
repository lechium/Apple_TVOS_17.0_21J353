...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x00600000009a62f8
- (void).cxx_destruct;	// IMP=0x00000000009a65e3
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000009a63a7
- (void)dealloc;	// IMP=0x00000000009a6341
