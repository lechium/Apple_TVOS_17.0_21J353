...
+ (id)layoutForSource:(id)arg1 inTarget:(id)arg2 withSize:(struct CGSize)arg3;	// IMP=0x0060000000969698
- (void).cxx_destruct;	// IMP=0x000000000096c12c
...
- (id)description;	// IMP=0x000000000096bf3a
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000096be59
- (_Bool)hasContents;	// IMP=0x000000000096be3f
