...
- (void).cxx_destruct;	// IMP=0x0000000000e74e80
...
- (void)setContentVisible:(_Bool)arg1;	// IMP=0x0000000000e74da0
...
- (_Bool)_forcePresentationInPresenterScene;	// IMP=0x0000000000e74d29
- (id)_presentationControllerForTraitCollection:(id)arg1;	// IMP=0x0000000000e74c6b
- (id)_presentedViewControllerForSizeClassPair:(CDStruct_627e0f85)arg1;	// IMP=0x0000000000e74c59
- (long long)adaptivePresentationStyle;	// IMP=0x0000000000e74c4e
- (void)_transitionFromDidEnd;	// IMP=0x0000000000e74c37
- (void)_transitionFromWillBegin;	// IMP=0x0000000000e74c25
- (void)_transitionToDidEnd;	// IMP=0x0000000000e74c0e
- (void)_transitionToWillBegin;	// IMP=0x0000000000e74bd3
- (void)presentationTransitionWillBegin;	// IMP=0x0000000000e74b55
- (id)_popoverHostingWindow;	// IMP=0x0000000000e74a4b
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0000000000e74913
