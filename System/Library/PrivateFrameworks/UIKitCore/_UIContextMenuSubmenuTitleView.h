...
- (void).cxx_destruct;	// IMP=0x000000000094b71c
...
- (_Bool)_wantsKeyCommandsWhenDeferred;	// IMP=0x000000000094b63f
- (long long)_focusItemDeferralMode;	// IMP=0x000000000094b626
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000094b583
- (_Bool)canBecomeFocused;	// IMP=0x000000000094b571
- (void)setDirectionalLayoutMargins:(struct NSDirectionalEdgeInsets)arg1;	// IMP=0x000000000094b4d2
- (void)addObscuringMaterialViewWithGroupName:(id)arg1;	// IMP=0x000000000094b302
- (void)setBackgroundMaterialGroupName:(id)arg1;	// IMP=0x000000000094b035
- (void)didMoveToWindow;	// IMP=0x000000000094af3f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000094ab4d
