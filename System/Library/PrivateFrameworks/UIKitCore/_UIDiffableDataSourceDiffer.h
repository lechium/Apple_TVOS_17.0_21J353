...
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x001000000035e5e4
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2;	// IMP=0x001000000035e573
- (void).cxx_destruct;	// IMP=0x0000000000361a20
...
- (_Bool)_verifyForUpdates:(id)arg1;	// IMP=0x000000000035ff05
- (id)_sectionUpdatesForDiffResults:(id)arg1 deletedSections:(id)arg2 insertedSections:(id)arg3;	// IMP=0x000000000035f886
- (id)_itemUpdatesForDiffResults:(id)arg1 sectionBoundaryMoves:(id)arg2 deletedSections:(id)arg3 insertedSections:(id)arg4;	// IMP=0x000000000035ee57
- (id)_computeSectionBoundaryMovesForItemDiffer:(id)arg1;	// IMP=0x000000000035ed85
- (id)_computeUpdatesForIdentifierBasedDiff;	// IMP=0x000000000035e6a2
- (void)_computeUpdates;	// IMP=0x000000000035e670
- (id)description;	// IMP=0x000000000035df6e
- (id)initWithBeforeDataSource:(id)arg1 afterDataSource:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x000000000035dea3
