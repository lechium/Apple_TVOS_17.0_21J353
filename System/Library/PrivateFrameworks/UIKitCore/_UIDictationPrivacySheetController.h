...
{
    id <_UIDictationPrivacySheetControllerDelegate> _privacyDelegate;	// 416 = 0x1a0
    OBPrivacyPresenter *_privacyPresenter;	// 424 = 0x1a8
    long long _sheetType;	// 432 = 0x1b0
}

- (void).cxx_destruct;	// IMP=0x0000000000ae0ec7
...
- (void)dismiss;	// IMP=0x0000000000ae0dc1
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000ae0b2d
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000ae0b25
