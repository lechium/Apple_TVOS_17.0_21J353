...
- (void).cxx_destruct;	// IMP=0x000000000112de2b
...
- (_Bool)isMergeableWith:(id)arg1;	// IMP=0x000000000112db8a
- (id)inputModeUniqueString;	// IMP=0x000000000112db0a
@property(readonly, nonatomic) long long inputActionCount;
- (id)description;	// IMP=0x000000000112d525
@property(readonly, nonatomic) _Bool changedContent;
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x000000000112d515
