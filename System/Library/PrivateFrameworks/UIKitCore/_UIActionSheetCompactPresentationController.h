...
- (void).cxx_destruct;	// IMP=0x000000000044361d
...
- (double)_resizeAnimationDuration;	// IMP=0x000000000044345b
- (struct CGSize)_minimumSizeForDismissButton;	// IMP=0x00000000004433cb
- (_Bool)_shouldDisableAvoidsKeyboard;	// IMP=0x00000000004432d0
- (CDStruct_758ece87)_currentLayoutGeometry;	// IMP=0x00000000004430fc
- (void)_handleDismiss:(id)arg1;	// IMP=0x0000000000442fe1
- (void)_dismiss;	// IMP=0x0000000000442efa
@property(nonatomic) _Bool dismissActionUsesShorterHeightWhenCompactVertically;
- (void)endPseudoAlertPresentationMode;	// IMP=0x0000000000442d64
- (void)beginPseudoAlertPresentationMode;	// IMP=0x0000000000442c43
@property(copy, nonatomic) NSString *dismissActionTitle;
- (void)_updateForKeyboardStartFrame:(struct CGRect)arg1 endFrame:(struct CGRect)arg2 duration:(double)arg3 curve:(long long)arg4;	// IMP=0x0000000000442927
- (void)_keyboardChanged:(id)arg1;	// IMP=0x000000000044271c
- (void)_unsubscribeFromKeyboardNotifications;	// IMP=0x0000000000442650
- (void)_subscribeToKeyboardNotifications;	// IMP=0x000000000044257d
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x0000000000442128
- (void)dismissalTransitionWillBegin;	// IMP=0x0000000000442035
- (void)_willRunTransitionForCurrentStateDeferred:(_Bool)arg1;	// IMP=0x0000000000441fe0
- (void)presentationTransitionWillBegin;	// IMP=0x0000000000441cd1
- (struct CGSize)preferredContentSize;	// IMP=0x0000000000441c98
- (void)_applyVisualAffordancesToViews;	// IMP=0x0000000000441be8
- (void)_layoutViews;	// IMP=0x00000000004419dc
- (struct CGRect)_frameOfPresentedViewControllerViewInSuperview;	// IMP=0x00000000004419bd
- (struct CGRect)frameOfPresentedViewInContainerView;	// IMP=0x000000000044183b
- (void)_transitionToPresentationController:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000004417f7
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000004416d9
- (struct UIEdgeInsets)_baseContentInsetsWithLeftMargin:(double *)arg1 rightMargin:(double *)arg2;	// IMP=0x00000000004414f8
- (_Bool)_shouldOccludeDuringPresentation;	// IMP=0x00000000004414f0
- (_Bool)_shouldPresentedViewControllerControlStatusBarAppearance;	// IMP=0x00000000004414e8
- (_Bool)shouldPresentInFullscreen;	// IMP=0x0000000000441494
- (void)dealloc;	// IMP=0x0000000000441412
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2 visualStyle:(id)arg3;	// IMP=0x0000000000441188
