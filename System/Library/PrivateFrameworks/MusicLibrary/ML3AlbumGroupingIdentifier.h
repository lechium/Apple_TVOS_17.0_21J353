...
- (void).cxx_destruct;	// IMP=0x000000000017bf2a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017bdad
- (unsigned long long)hash;	// IMP=0x000000000017bd4b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017bb8c
- (id)description;	// IMP=0x000000000017bad4
- (id)initWithAlbumArtistPersistentID:(long long)arg1 groupingKey:(id)arg2 feedURL:(id)arg3 seasonNumber:(long long)arg4 compilation:(_Bool)arg5;	// IMP=0x000000000017ba02
