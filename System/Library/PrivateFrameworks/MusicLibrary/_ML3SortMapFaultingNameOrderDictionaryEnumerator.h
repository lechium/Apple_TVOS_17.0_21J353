...
- (void).cxx_destruct;	// IMP=0x00000000000b1cff
- (id)nextObject;	// IMP=0x00000000000b1b00
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000b1a5e
