...
- (void).cxx_destruct;	// IMP=0x00000000000db877
...
- (void)execute;	// IMP=0x00000000000db711
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000db663
