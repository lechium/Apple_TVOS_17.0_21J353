...
- (void).cxx_destruct;	// IMP=0x00000000001e8a4e
...
- (_Bool)currentQueueIsValidationQueue;	// IMP=0x00000000001e89e3
- (id)init;	// IMP=0x00000000001e89a1
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00000000001e884f
