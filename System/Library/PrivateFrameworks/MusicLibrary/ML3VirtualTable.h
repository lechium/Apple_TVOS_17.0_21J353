...
- (id).cxx_construct;	// IMP=0x00000000001785bb
- (void).cxx_destruct;	// IMP=0x000000000017856b
...
- (_Bool)unregister;	// IMP=0x000000000017830b
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x0000000000178038
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x0000000000177fb7
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x0000000000177e33
