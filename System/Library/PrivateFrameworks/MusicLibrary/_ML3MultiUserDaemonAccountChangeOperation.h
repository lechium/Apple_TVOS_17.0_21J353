...
- (void).cxx_destruct;	// IMP=0x00000000001e9892
...
- (void)execute;	// IMP=0x00000000001e9443
- (id)initWithInitialDSID:(id)arg1 finalDSID:(id)arg2 accountChangeObserver:(id)arg3;	// IMP=0x00000000001e934e
