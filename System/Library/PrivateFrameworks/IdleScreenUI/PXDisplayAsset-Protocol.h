...
#import <IdleScreenUI/PXDisplayThumbnailAsset-Protocol.h>
...
- (void)enumerateCropVariantsForTargetSize:(struct CGSize)arg1 preferFaceCrops:(_Bool)arg2 usingBlock:(void (^)(long long, struct CGRect, double, _Bool *))arg3;
