...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x00000000000068c2
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000006638
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000000063f8
- (id)init;	// IMP=0x0000000000006392
