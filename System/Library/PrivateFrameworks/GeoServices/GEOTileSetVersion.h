...
- (void).cxx_destruct;	// IMP=0x00000000013a4ec6
- (unsigned long long)hash;	// IMP=0x00000000013a4def
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000013a4c8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000013a4a5a
- (void)writeTo:(id)arg1;	// IMP=0x00000000013a4749
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000013a473a
- (id)jsonRepresentation;	// IMP=0x00000000013a462a
- (id)dictionaryRepresentation;	// IMP=0x00000000013a40ac
- (id)description;	// IMP=0x00000000013a3ffd
- (void)dealloc;	// IMP=0x00000000013a31df
- (id)initWithData:(id)arg1;	// IMP=0x00000000013a3183
- (id)init;	// IMP=0x00000000013a3127
