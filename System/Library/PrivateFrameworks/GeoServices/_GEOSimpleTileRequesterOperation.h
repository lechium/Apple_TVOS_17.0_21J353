...
@interface _GEOSimpleTileRequesterOperation : NSObject
{
    ...
    GEODataURLSessionTask *_task;	// 24 = 0x18
    ...
    GEODataURLSession *_dataSession;	// 128 = 0x80
...
- (void).cxx_destruct;	// IMP=0x00000000011a51b3
...
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000011a34f7
- (void)dataURLSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000011a3371
...
- (double)startTime;	// IMP=0x00000000011a3210
- (double)elapsed;	// IMP=0x00000000011a31c0
- (void)clearAllRelatedOperations;	// IMP=0x00000000011a318e
- (void)cancel;	// IMP=0x00000000011a2ff1
- (void)start;	// IMP=0x00000000011a29d0
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000011a20de
- (id)init;	// IMP=0x00000000011a20d0
