...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000c09eec
- (void).cxx_destruct;	// IMP=0x0000000000c0b0d5
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000c0b062
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c0ae2a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c0a927
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c0a6a0
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c0a51c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c0a247
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c0a238
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000c09c93
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000c09c81
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000c0972f
- (id)jsonRepresentation;	// IMP=0x0000000000c0961f
- (id)dictionaryRepresentation;	// IMP=0x0000000000c0915c
@property(readonly, copy) NSString *description;
@property(retain, nonatomic) NSString *displayNameOverride;
@property(readonly, nonatomic) _Bool hasDisplayNameOverride;
- (int)StringAsRealTimeStatusInfo:(id)arg1;	// IMP=0x0000000000c08eb8
- (id)realTimeStatusInfoAsString:(int)arg1;	// IMP=0x0000000000c08e6f
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c07f5b
- (id)init;	// IMP=0x0000000000c07eff
- (_Bool)isPastDepartureRelativeToDate:(id)arg1 usingGracePeriod:(_Bool)arg2;	// IMP=0x000000000117f018
