...
- (void).cxx_destruct;	// IMP=0x0000000000347902
...
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x0000000000347079
- (void)removeOldData:(id)arg1;	// IMP=0x0000000000346d64
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000000346d5e
- (void)cancel;	// IMP=0x0000000000346cb8
- (void)_finishedAllTasks;	// IMP=0x0000000000346ca4
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000346984
- (void)_startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000345f25
- (_Bool)_hasExistingUsableDownloadForURL:(id)arg1 withChecksum:(id)arg2;	// IMP=0x0000000000345d16
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000345c3e
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x0000000000345aac
- (id)init;	// IMP=0x0000000000345a82
