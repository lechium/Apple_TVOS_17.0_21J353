...
+ (id)transitInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a35731
- (void).cxx_destruct;	// IMP=0x0000000000d1718d
- (unsigned long long)hash;	// IMP=0x0000000000d17058
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d16e21
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d16616
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d15c86
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d15c77
- (id)jsonRepresentation;	// IMP=0x0000000000d15a9f
- (id)dictionaryRepresentation;	// IMP=0x0000000000d14d9a
- (id)description;	// IMP=0x0000000000d14ceb
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d12c32
- (id)init;	// IMP=0x0000000000d12bd6
