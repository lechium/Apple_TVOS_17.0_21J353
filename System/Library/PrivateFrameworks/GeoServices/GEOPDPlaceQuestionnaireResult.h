...
- (void).cxx_destruct;	// IMP=0x000000000141c17a
- (unsigned long long)hash;	// IMP=0x000000000141baa1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000141b871
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000141b497
- (void)writeTo:(id)arg1;	// IMP=0x000000000141af13
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000141af04
- (id)jsonRepresentation;	// IMP=0x0000000001418f44
- (id)dictionaryRepresentation;	// IMP=0x000000000141883c
- (id)description;	// IMP=0x000000000141878d
- (id)initWithData:(id)arg1;	// IMP=0x000000000141753c
- (id)init;	// IMP=0x00000000014174e0
