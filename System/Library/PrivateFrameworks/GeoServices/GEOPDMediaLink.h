...
- (void).cxx_destruct;	// IMP=0x0000000000c73668
- (unsigned long long)hash;	// IMP=0x0000000000c73583
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c73402
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c73067
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c72d2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c72d1e
- (id)jsonRepresentation;	// IMP=0x0000000000c72426
- (id)dictionaryRepresentation;	// IMP=0x0000000000c71e47
- (id)description;	// IMP=0x0000000000c71d98
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c70d32
- (id)init;	// IMP=0x0000000000c70cd6
