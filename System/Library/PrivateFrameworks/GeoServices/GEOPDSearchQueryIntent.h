...
- (void).cxx_destruct;	// IMP=0x0000000000ad7af1
- (unsigned long long)hash;	// IMP=0x0000000000ad7a2e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ad78b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ad7271
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ad5c1f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ad5c10
- (id)jsonRepresentation;	// IMP=0x0000000000acfb76
- (id)dictionaryRepresentation;	// IMP=0x0000000000acf14a
- (id)description;	// IMP=0x0000000000acf09b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000acdd31
- (id)init;	// IMP=0x0000000000acdcd5
