...
- (void).cxx_destruct;	// IMP=0x0000000000638d71
- (unsigned long long)hash;	// IMP=0x00000000006389e1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000063847e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000063775c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000636c73
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000636c64
- (id)jsonRepresentation;	// IMP=0x0000000000636b54
- (id)dictionaryRepresentation;	// IMP=0x0000000000634e8c
- (id)description;	// IMP=0x0000000000634ddd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000630c9a
- (id)init;	// IMP=0x0000000000630c3e
