...
- (void).cxx_destruct;	// IMP=0x00000000005bbdd8
- (unsigned long long)hash;	// IMP=0x00000000005bb950
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005bb6e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005bb29c
- (void)writeTo:(id)arg1;	// IMP=0x00000000005bae3f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005bae30
- (id)jsonRepresentation;	// IMP=0x00000000005b9ae8
- (id)dictionaryRepresentation;	// IMP=0x00000000005b923a
- (id)description;	// IMP=0x00000000005b918b
- (id)initWithData:(id)arg1;	// IMP=0x00000000005b7b6f
- (id)init;	// IMP=0x00000000005b7b13
- (_Bool)_routeHypothesisPlaceRefinementParametersIsEqual:(id)arg1;	// IMP=0x000000000114e9eb
- (unsigned long long)_routeHypothesisPlaceRefinementParametersHash;	// IMP=0x000000000114e97f
- (_Bool)_hasRequiredFields;	// IMP=0x000000000114e953
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000137f6a4
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2;	// IMP=0x000000000137f407
- (id)initWithIdentifier:(id)arg1 placeNameHint:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000137f1e1
