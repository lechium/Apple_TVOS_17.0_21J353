...
- (void).cxx_destruct;	// IMP=0x0000000000dec3e8
- (unsigned long long)hash;	// IMP=0x0000000000debf78
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000debce5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000deb87b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000deb480
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000deb471
- (id)jsonRepresentation;	// IMP=0x0000000000dea887
- (id)dictionaryRepresentation;	// IMP=0x0000000000de9fea
- (id)description;	// IMP=0x0000000000de9f3b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000de861b
- (id)init;	// IMP=0x0000000000de85bf
