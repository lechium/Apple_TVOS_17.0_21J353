...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000e95575
- (id).cxx_construct;	// IMP=0x0000000000e95bde
- (void).cxx_destruct;	// IMP=0x0000000000e95b87
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000e95a7a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000e9557d
