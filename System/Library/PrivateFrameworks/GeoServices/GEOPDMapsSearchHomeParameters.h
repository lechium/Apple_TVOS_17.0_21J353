...
- (void).cxx_destruct;	// IMP=0x000000000056a9e9
- (unsigned long long)hash;	// IMP=0x000000000056a4d7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000056a33b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056a0b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000569b6b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000569b5c
- (id)jsonRepresentation;	// IMP=0x0000000000568da9
- (id)dictionaryRepresentation;	// IMP=0x00000000005687f2
- (id)description;	// IMP=0x0000000000568743
- (void)dealloc;	// IMP=0x00000000005672ac
- (id)initWithData:(id)arg1;	// IMP=0x0000000000567250
- (id)init;	// IMP=0x00000000005671f4
