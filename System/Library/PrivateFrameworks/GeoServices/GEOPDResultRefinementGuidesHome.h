...
- (void).cxx_destruct;	// IMP=0x0000000000e05a57
- (unsigned long long)hash;	// IMP=0x0000000000e05963
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e057ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e05522
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e05295
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e05286
- (id)jsonRepresentation;	// IMP=0x0000000000e04c88
- (id)dictionaryRepresentation;	// IMP=0x0000000000e045ea
- (id)description;	// IMP=0x0000000000e0453b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e03554
- (id)init;	// IMP=0x0000000000e034f8
