...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x0010000000a2ac54
+ (Class)_resourceLoaderClass;	// IMP=0x0010000000a2ac43
- (void).cxx_destruct;	// IMP=0x0000000000a2ef8f
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x0000000000a2ddf9
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a2d51e
- (void)removeOldData:(id)arg1;	// IMP=0x0000000000a2cc37
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000000a2bfd9
- (void)cancel;	// IMP=0x0000000000a2bde1
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000a2acad
- (id)_resourcesDirectory;	// IMP=0x0000000000a2ac85
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x0000000000a2a97c
- (id)init;	// IMP=0x0000000000a2a952
