...
- (void).cxx_destruct;	// IMP=0x0000000000aecb1b
- (unsigned long long)hash;	// IMP=0x0000000000aec67c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aec03a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aeb7a3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aeb030
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aeb021
- (id)jsonRepresentation;	// IMP=0x0000000000adcd3e
- (id)dictionaryRepresentation;	// IMP=0x0000000000ada66f
- (id)description;	// IMP=0x0000000000ada5c0
- (void)dealloc;	// IMP=0x0000000000ad7c2f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ad7bd3
- (id)init;	// IMP=0x0000000000ad7b77
