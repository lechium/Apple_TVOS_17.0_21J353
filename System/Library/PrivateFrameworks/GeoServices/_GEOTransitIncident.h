...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000117c1b6
- (void).cxx_destruct;	// IMP=0x000000000117d11b
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000117c62a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000117c2d1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000117c229
- (id)initWithIncident:(id)arg1;	// IMP=0x000000000117c1be
