...
- (void).cxx_destruct;	// IMP=0x0000000000623a90
- (unsigned long long)hash;	// IMP=0x00000000006237f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000062350b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006231e1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000622eb1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000622ea2
- (id)jsonRepresentation;	// IMP=0x0000000000622208
- (id)dictionaryRepresentation;	// IMP=0x000000000062183c
- (id)description;	// IMP=0x000000000062178d
- (void)dealloc;	// IMP=0x000000000062009c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000620040
- (id)init;	// IMP=0x000000000061ffe4
