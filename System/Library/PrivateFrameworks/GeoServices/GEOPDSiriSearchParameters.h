...
- (void).cxx_destruct;	// IMP=0x00000000006425dc
- (unsigned long long)hash;	// IMP=0x000000000064245e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006421d5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000641c9c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000641807
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006417f8
- (id)jsonRepresentation;	// IMP=0x00000000006416e8
- (id)dictionaryRepresentation;	// IMP=0x0000000000640c05
- (id)description;	// IMP=0x0000000000640b56
- (id)initWithData:(id)arg1;	// IMP=0x000000000063f558
- (id)init;	// IMP=0x000000000063f4fc
