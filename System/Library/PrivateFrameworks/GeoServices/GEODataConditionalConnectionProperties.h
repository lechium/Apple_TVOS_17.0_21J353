...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000013f5b6f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000013f5ccf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000013f5c20
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowDuration:(double)arg2;	// IMP=0x00000000013f5bd2
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowStartTime:(double)arg2 timeWindowDuration:(double)arg3;	// IMP=0x00000000013f5b77
