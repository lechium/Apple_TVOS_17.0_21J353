...
- (void).cxx_destruct;	// IMP=0x0000000000579471
- (unsigned long long)hash;	// IMP=0x0000000000579342
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000579198
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000578f0b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000578c82
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000578c73
- (id)jsonRepresentation;	// IMP=0x00000000005786a1
- (id)dictionaryRepresentation;	// IMP=0x0000000000577e13
- (id)description;	// IMP=0x0000000000577d64
- (id)initWithData:(id)arg1;	// IMP=0x0000000000577316
- (id)init;	// IMP=0x00000000005772ba
