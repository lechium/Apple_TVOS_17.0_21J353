...
- (void).cxx_destruct;	// IMP=0x00000000007888bd
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x000000000078875f
- (id)factoidAtIndex:(int)arg1;	// IMP=0x00000000007886b8
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000788128
