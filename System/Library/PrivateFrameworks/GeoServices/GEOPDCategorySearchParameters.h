...
- (void).cxx_destruct;	// IMP=0x000000000052d2ea
- (unsigned long long)hash;	// IMP=0x000000000052cd71
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052c8df
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052c2f2
- (void)writeTo:(id)arg1;	// IMP=0x000000000052bb3b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000052bb2c
- (id)jsonRepresentation;	// IMP=0x000000000052b2db
- (id)dictionaryRepresentation;	// IMP=0x0000000000529d25
- (id)description;	// IMP=0x0000000000529c76
- (void)dealloc;	// IMP=0x0000000000526a4d
- (id)initWithData:(id)arg1;	// IMP=0x00000000005269f1
- (id)init;	// IMP=0x0000000000526995
