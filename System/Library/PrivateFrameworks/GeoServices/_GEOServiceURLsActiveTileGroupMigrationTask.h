...
- (void).cxx_destruct;	// IMP=0x00000000011a003d
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000011a0001
- (void)populateTileGroup:(id)arg1;	// IMP=0x000000000119ff91
- (void)cancel;	// IMP=0x000000000119ff8b
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x000000000119fea9
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x000000000119fd30
- (id)init;	// IMP=0x000000000119fd06
