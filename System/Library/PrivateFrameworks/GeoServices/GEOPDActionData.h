...
- (void).cxx_destruct;	// IMP=0x0000000000b3baed
- (unsigned long long)hash;	// IMP=0x0000000000b3ba2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b3b8ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b3b421
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b3b041
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b3b032
- (id)jsonRepresentation;	// IMP=0x0000000000b3aa44
- (id)dictionaryRepresentation;	// IMP=0x0000000000b3a2c8
- (id)description;	// IMP=0x0000000000b3a219
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b38f49
- (id)init;	// IMP=0x0000000000b38eed
- (id)actionName;	// IMP=0x0000000000a3f0ac
