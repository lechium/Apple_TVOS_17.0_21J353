...
- (id).cxx_construct;	// IMP=0x0000000000a30380
- (void).cxx_destruct;	// IMP=0x0000000000a3034d
...
- (id)description;	// IMP=0x0000000000a30151
- (double)_oldestEventInJulianDay;	// IMP=0x0000000000a300ed
- (int)_numberOfEvents;	// IMP=0x0000000000a300d7
...
- (id)_dateFromOffset:(double)arg1;	// IMP=0x0000000000a2ff88
- (id)initWithJulianDay:(double)arg1 riseTransitSet:(struct CAARiseTransitSetDetails)arg2;	// IMP=0x0000000000a2ff2a
