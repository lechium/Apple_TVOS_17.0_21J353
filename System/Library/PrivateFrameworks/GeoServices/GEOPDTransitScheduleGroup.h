...
- (void).cxx_destruct;	// IMP=0x0000000000d29bf4
- (unsigned long long)hash;	// IMP=0x0000000000d29a9d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d2989a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d2960b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d29317
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d29308
- (id)jsonRepresentation;	// IMP=0x0000000000d291f8
- (id)dictionaryRepresentation;	// IMP=0x0000000000d28cc4
- (id)description;	// IMP=0x0000000000d28c15
- (void)dealloc;	// IMP=0x0000000000d275db
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d2757f
- (id)init;	// IMP=0x0000000000d27523
