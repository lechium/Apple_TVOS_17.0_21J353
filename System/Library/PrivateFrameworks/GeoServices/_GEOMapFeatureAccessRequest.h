...
- (void).cxx_destruct;	// IMP=0x000000000110eced
@property(readonly, nonatomic) GEOTileLoader *tileLoader; // @synthesize tileLoader=_tileLoader;
- (void)cancel;	// IMP=0x000000000110eab5
- (void)addTileRequest:(id)arg1;	// IMP=0x000000000110ea01
- (id)initWithTileLoader:(id)arg1;	// IMP=0x000000000110e951
