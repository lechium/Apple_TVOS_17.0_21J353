...
- (void).cxx_destruct;	// IMP=0x0000000000630adb
- (unsigned long long)hash;	// IMP=0x000000000063061e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000062ff6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000062f7c7
- (void)writeTo:(id)arg1;	// IMP=0x000000000062f09c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000062f08d
- (id)jsonRepresentation;	// IMP=0x000000000062ca1e
- (id)dictionaryRepresentation;	// IMP=0x000000000062ab77
- (id)description;	// IMP=0x000000000062aac8
- (void)dealloc;	// IMP=0x0000000000626591
- (id)initWithData:(id)arg1;	// IMP=0x0000000000626535
- (id)init;	// IMP=0x00000000006264d9
- (void)addPlaceSummaryRevision:(id)arg1;	// IMP=0x000000000138003a
- (void)addSearchImplicitInfo:(id)arg1 idenitfier:(id)arg2 categoryID:(id)arg3;	// IMP=0x0000000001380ced
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7 routeInfo:(id)arg8;	// IMP=0x0000000001380609
- (id)initWithGeoMapItemIdentifier:(id)arg1 categoryID:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4;	// IMP=0x0000000001380378
