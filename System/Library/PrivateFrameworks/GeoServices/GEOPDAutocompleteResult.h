...
- (void).cxx_destruct;	// IMP=0x0000000000512ae2
- (unsigned long long)hash;	// IMP=0x0000000000512887
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005124ab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000511dc4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000511062
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000511053
- (id)jsonRepresentation;	// IMP=0x000000000050d6aa
- (id)dictionaryRepresentation;	// IMP=0x000000000050c7d7
- (id)description;	// IMP=0x000000000050c728
- (id)initWithData:(id)arg1;	// IMP=0x000000000050a7d4
- (id)init;	// IMP=0x000000000050a778
