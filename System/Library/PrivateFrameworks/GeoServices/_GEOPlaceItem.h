...
@interface _GEOPlaceItem : GEOBaseMapItem
{
    ...
    GEOPlace *_place;	// 16 = 0x10
    geo_isolater *_lazyIvarIsolater;	// 24 = 0x18
    GEOAddressObject *_addressObject;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00000000008595d4
...
- (id)_placecardLayoutConfiguration;	// IMP=0x00000000008595ac
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x00000000008595a4
...
- (id)_businessClaim;	// IMP=0x000000000085955c
- (_Bool)_hasBusinessClaim;	// IMP=0x0000000000859554
- (id)_mapItemByStrippingOptionalData;	// IMP=0x000000000085954b
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x00000000008594f3
...
- (id)_yelpID;	// IMP=0x0000000000859292
...
- (id)_urlForWritingAReview;	// IMP=0x000000000085927a
- (id)_urlForReview:(id)arg1;	// IMP=0x0000000000859272
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x000000000085926a
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000008591e7
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000008591df
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000858e42
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x0000000000858e00
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x0000000000858dbe
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x0000000000858da1
- (int)_recommendedTransportType;	// IMP=0x0000000000858d96
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000858d79
...
- (id)weatherDisplayName;	// IMP=0x0000000000858cd1
- (id)addressObject;	// IMP=0x0000000000858c1e
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000858662
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x00000000008585a7
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x00000000008583c5
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x00000000008582ec
