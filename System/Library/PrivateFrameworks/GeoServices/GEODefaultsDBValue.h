...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x006000000029648f
- (void).cxx_destruct;	// IMP=0x000000000029657f
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x00000000002963d9
