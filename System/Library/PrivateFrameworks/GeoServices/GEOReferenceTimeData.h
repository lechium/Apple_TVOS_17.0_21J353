...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000010efe2d
...
- (id)description;	// IMP=0x00000000010f0142
- (double)currentReferenceTime;	// IMP=0x00000000010f0045
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000010eff89
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000010efea8
- (id)initWithRefTime:(double)arg1 refError:(double)arg2 kernTime:(double)arg3 bootTime:(struct timeval)arg4;	// IMP=0x00000000010efe35
