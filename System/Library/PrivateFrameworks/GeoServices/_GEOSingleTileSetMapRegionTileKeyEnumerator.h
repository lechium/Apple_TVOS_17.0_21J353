...
- (void).cxx_destruct;	// IMP=0x0000000001230704
@property(readonly, nonatomic) unsigned long long count;
- (_Bool)continueEnumeratingTileKeysWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001230325
- (id)initWithMapRegion:(id)arg1 tileSet:(id)arg2 zoomMode:(long long)arg3;	// IMP=0x0000000001230083
