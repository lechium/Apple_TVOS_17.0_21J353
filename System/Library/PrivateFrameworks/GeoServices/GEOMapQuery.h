...
- (void).cxx_destruct;	// IMP=0x0000000000d9ef2f
- (unsigned long long)hash;	// IMP=0x0000000000d9ecfb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d9e9aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d9e637
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d9e07f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d9e072
- (id)jsonRepresentation;	// IMP=0x0000000000d9de06
- (id)dictionaryRepresentation;	// IMP=0x0000000000d9d6ba
- (id)description;	// IMP=0x0000000000d9d60b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d9c2c0
- (id)init;	// IMP=0x0000000000d9c264
