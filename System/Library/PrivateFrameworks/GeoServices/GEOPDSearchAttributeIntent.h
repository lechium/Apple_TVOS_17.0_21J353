...
- (void).cxx_destruct;	// IMP=0x0000000000a938af
- (unsigned long long)hash;	// IMP=0x0000000000a937e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a93658
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a933fe
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a93137
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a93128
- (id)jsonRepresentation;	// IMP=0x0000000000a926f7
- (id)dictionaryRepresentation;	// IMP=0x0000000000a9211b
- (id)description;	// IMP=0x0000000000a9206c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a9187f
- (id)init;	// IMP=0x0000000000a91823
