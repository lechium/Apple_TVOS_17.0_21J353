...
- (void).cxx_destruct;	// IMP=0x0000000001180d9f
...
- (id)initWithTransitScheduleCategory:(id)arg1 nearbyScheduleGroups:(id)arg2 categoryArtwork:(id)arg3;	// IMP=0x0000000001180c8d
