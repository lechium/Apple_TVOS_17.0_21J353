...
- (void).cxx_destruct;	// IMP=0x0000000000d4b7ca
@property(nonatomic) __weak id <_GEONetworkDefaultsServerProxyDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateNetworkDefaultsWithReason:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d4b16f
- (void)updateNetworkDefaults:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d4b155
- (void)_networkDefaultsDidChange;	// IMP=0x0000000000d4b07b
- (void)dealloc;	// IMP=0x0000000000d4b042
- (id)init;	// IMP=0x0000000000d4af00
