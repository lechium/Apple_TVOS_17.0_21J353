...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x0010000001116378
- (void).cxx_destruct;	// IMP=0x0000000001116b61
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x0000000001116817
