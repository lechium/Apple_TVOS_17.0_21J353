...
- (void).cxx_destruct;	// IMP=0x000000000077c595
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000077c187
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x000000000077c171
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x000000000077c005
...
- (id)calloutTitle;	// IMP=0x000000000077bc6e
- (id)queryLine;	// IMP=0x000000000077bb50
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x000000000077bb01
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x000000000077a546
