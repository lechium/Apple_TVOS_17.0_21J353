...
- (void).cxx_destruct;	// IMP=0x0000000000c5f0a2
- (unsigned long long)hash;	// IMP=0x0000000000c5efcb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c5ee3b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c5ebc4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c5e997
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c5e988
- (id)jsonRepresentation;	// IMP=0x0000000000c5e878
- (id)dictionaryRepresentation;	// IMP=0x0000000000c5e2ad
- (id)description;	// IMP=0x0000000000c5e1fe
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c5d6ee
- (id)init;	// IMP=0x0000000000c5d692
