...
- (id).cxx_construct;	// IMP=0x000000000102d1ce
- (void).cxx_destruct;	// IMP=0x000000000102d138
...
- (void)cancel;	// IMP=0x000000000102d03f
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000102c325
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x000000000102c191
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x000000000102bfa4
