...
- (void).cxx_destruct;	// IMP=0x000000000041ba9f
- (unsigned long long)hash;	// IMP=0x000000000041b0ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041ad20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000041a97f
- (void)writeTo:(id)arg1;	// IMP=0x000000000041a5ea
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000041a5dd
- (id)jsonRepresentation;	// IMP=0x000000000041a192
- (id)dictionaryRepresentation;	// IMP=0x000000000041970f
- (id)description;	// IMP=0x0000000000419660
- (id)initWithData:(id)arg1;	// IMP=0x000000000041876c
- (id)init;	// IMP=0x0000000000418710
