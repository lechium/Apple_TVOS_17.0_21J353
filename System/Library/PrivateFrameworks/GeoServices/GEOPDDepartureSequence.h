...
- (void).cxx_destruct;	// IMP=0x0000000000c13066
- (unsigned long long)hash;	// IMP=0x0000000000c12c29
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c12993
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c1240b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c11d7b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c11d6c
- (id)jsonRepresentation;	// IMP=0x0000000000c107fa
- (id)dictionaryRepresentation;	// IMP=0x0000000000c0fd48
- (id)description;	// IMP=0x0000000000c0fc99
- (void)dealloc;	// IMP=0x0000000000c0dc55
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c0dbf9
- (id)init;	// IMP=0x0000000000c0db9d
