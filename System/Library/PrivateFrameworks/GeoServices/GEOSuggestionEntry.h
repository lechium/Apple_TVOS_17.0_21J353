...
- (void).cxx_destruct;	// IMP=0x0000000000ffdab5
- (unsigned long long)hash;	// IMP=0x0000000000ffd9a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ffd7cf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ffd2fa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ffce35
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ffce26
- (id)jsonRepresentation;	// IMP=0x0000000000ffcaa7
- (id)dictionaryRepresentation;	// IMP=0x0000000000ffc030
- (id)description;	// IMP=0x0000000000ffbf81
- (void)dealloc;	// IMP=0x0000000000ffad9f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ffad43
- (id)init;	// IMP=0x0000000000fface7
