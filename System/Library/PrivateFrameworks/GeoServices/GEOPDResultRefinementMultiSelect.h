...
- (void).cxx_destruct;	// IMP=0x0000000000e0e4a6
- (unsigned long long)hash;	// IMP=0x0000000000e0e3a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e0e1ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e0de2f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e0dad5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e0dac6
- (id)jsonRepresentation;	// IMP=0x0000000000e0d747
- (id)dictionaryRepresentation;	// IMP=0x0000000000e0d13b
- (id)description;	// IMP=0x0000000000e0d08c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e0beaa
- (id)init;	// IMP=0x0000000000e0be4e
