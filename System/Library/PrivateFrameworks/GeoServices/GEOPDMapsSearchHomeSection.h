...
- (void).cxx_destruct;	// IMP=0x000000000056e495
- (unsigned long long)hash;	// IMP=0x000000000056e25f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000056e0aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056de1e
- (void)writeTo:(id)arg1;	// IMP=0x000000000056db82
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000056db73
- (id)jsonRepresentation;	// IMP=0x000000000056d3af
- (id)dictionaryRepresentation;	// IMP=0x000000000056ceef
- (id)description;	// IMP=0x000000000056ce40
- (id)initWithData:(id)arg1;	// IMP=0x000000000056bd21
- (id)init;	// IMP=0x000000000056bcc5
