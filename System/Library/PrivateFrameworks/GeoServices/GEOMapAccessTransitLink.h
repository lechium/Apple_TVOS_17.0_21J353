...
- (id).cxx_construct;	// IMP=0x0000000000359243
- (void).cxx_destruct;	// IMP=0x00000000003591e9
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x0000000000358f5f
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x0000000000358a81
