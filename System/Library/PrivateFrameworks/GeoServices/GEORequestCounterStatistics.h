...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000311763
- (void).cxx_destruct;	// IMP=0x0000000000311d6f
...
- (id)description;	// IMP=0x0000000000311ca0
- (unsigned long long)countForResult:(unsigned char)arg1;	// IMP=0x0000000000311c24
- (void)addUsedInterfaces:(unsigned long long)arg1;	// IMP=0x0000000000311c1a
- (void)incrementCountForResult:(unsigned char)arg1;	// IMP=0x0000000000311ae6
- (void)incrementDuration:(double)arg1;	// IMP=0x0000000000311ab2
- (void)incrementBytesReceived:(unsigned long long)arg1;	// IMP=0x0000000000311aa8
- (void)incrementBytesTransmitted:(unsigned long long)arg1;	// IMP=0x0000000000311a9e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003119c5
- (unsigned long long)hash;	// IMP=0x000000000031198f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003118c6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000031176b
