...
- (void).cxx_destruct;	// IMP=0x000000000053e85d
- (unsigned long long)hash;	// IMP=0x000000000053e715
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000053e505
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000053e256
- (void)writeTo:(id)arg1;	// IMP=0x000000000053df3b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000053df2c
- (id)jsonRepresentation;	// IMP=0x000000000053dbad
- (id)dictionaryRepresentation;	// IMP=0x000000000053d45e
- (id)description;	// IMP=0x000000000053d3af
- (void)dealloc;	// IMP=0x000000000053c183
- (id)initWithData:(id)arg1;	// IMP=0x000000000053c127
- (id)init;	// IMP=0x000000000053c0cb
