...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000e9e8a0
- (void).cxx_destruct;	// IMP=0x0000000000ea011e
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000e9ff02
- (unsigned long long)hash;	// IMP=0x0000000000e9faf5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e9f759
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e9f404
- (void)copyTo:(id)arg1;	// IMP=0x0000000000e9f19a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e9ee2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e9ee20
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000e9e659
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000e9e647
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000e9ded3
- (id)jsonRepresentation;	// IMP=0x0000000000e9dec4
- (id)dictionaryRepresentation;	// IMP=0x0000000000e9d8b5
- (id)description;	// IMP=0x0000000000e9d806
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e9c148
- (id)init;	// IMP=0x0000000000e9c0ec
