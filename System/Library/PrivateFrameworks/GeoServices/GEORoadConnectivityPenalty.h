...
- (void).cxx_destruct;	// IMP=0x00000000007f6a9a
@property(retain, nonatomic) NSMutableDictionary *roadIntersections; // @synthesize roadIntersections=_roadIntersections;
- (double)penaltyForCandidate:(id)arg1;	// IMP=0x00000000007f6a0d
- (unsigned long long)shortestLengthToRoad:(id)arg1;	// IMP=0x00000000007f68fa
@property(readonly, nonatomic) GEOMapFeatureRoad *originRoad;
- (void)_addRoadsFromOriginRoad:(id)arg1 currentDepth:(unsigned long long)arg2;	// IMP=0x00000000007f64a5
- (void)_initConnectivityMap;	// IMP=0x00000000007f63fb
- (id)initWithOriginRoad:(id)arg1;	// IMP=0x00000000007f6346
- (id)init;	// IMP=0x00000000007f631c
