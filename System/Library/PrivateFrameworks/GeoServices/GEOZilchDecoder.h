...
+ (_Bool)decodingSupported;	// IMP=0x0060000000d4c896
- (id).cxx_construct;	// IMP=0x0000000000d4cc36
- (void).cxx_destruct;	// IMP=0x0000000000d4cbe7
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000d4cb1d
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000d4ca91
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d4c976
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000d4c962
- (id)requestQueue;	// IMP=0x0000000000d4c94d
- (id)init;	// IMP=0x0000000000d4c8af
