...
- (void).cxx_destruct;	// IMP=0x0000000000acdc93
- (unsigned long long)hash;	// IMP=0x0000000000acdc09
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000acdb03
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000acd810
- (void)writeTo:(id)arg1;	// IMP=0x0000000000acd4c4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000acd4b5
- (id)jsonRepresentation;	// IMP=0x0000000000accfc8
- (id)dictionaryRepresentation;	// IMP=0x0000000000acc9be
- (id)description;	// IMP=0x0000000000acc90f
- (void)dealloc;	// IMP=0x0000000000acbd3f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000acbce3
- (id)init;	// IMP=0x0000000000acbc87
