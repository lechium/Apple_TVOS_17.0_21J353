...
- (void).cxx_destruct;	// IMP=0x0000000001413a65
- (void)cancel;	// IMP=0x0000000001413a4f
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000014139a6
- (id)init;	// IMP=0x000000000141397c
