...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x0010000000a3f5f5
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x0010000000a3f3d4
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x0010000000a3f1ae
- (void).cxx_destruct;	// IMP=0x0000000000c1eb1a
- (unsigned long long)hash;	// IMP=0x0000000000c1e9cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c1e7a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c1e4ed
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c1e255
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c1e246
- (id)jsonRepresentation;	// IMP=0x0000000000c1d93b
- (id)dictionaryRepresentation;	// IMP=0x0000000000c1d079
- (id)description;	// IMP=0x0000000000c1cfca
- (void)dealloc;	// IMP=0x0000000000c1bc77
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c1bc1b
- (id)init;	// IMP=0x0000000000c1bbbf
