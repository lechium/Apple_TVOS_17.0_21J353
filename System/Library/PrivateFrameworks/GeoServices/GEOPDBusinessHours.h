...
+ (id)businessHoursForPlaceData:(id)arg1;	// IMP=0x0010000000a3e1b9
- (void).cxx_destruct;	// IMP=0x0000000000b67b5d
- (unsigned long long)hash;	// IMP=0x0000000000b6785f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b676a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b672cd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b66db5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b66da6
- (id)jsonRepresentation;	// IMP=0x0000000000b6569e
- (id)dictionaryRepresentation;	// IMP=0x0000000000b64f7a
- (id)description;	// IMP=0x0000000000b64ecb
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b63d8a
- (id)init;	// IMP=0x0000000000b63d2e
