...
- (void).cxx_destruct;	// IMP=0x0000000000afe2b3
- (unsigned long long)hash;	// IMP=0x0000000000afe1b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000afdfe3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000afdec0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000afddac
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000afdd9f
- (id)jsonRepresentation;	// IMP=0x0000000000afdd90
- (id)dictionaryRepresentation;	// IMP=0x0000000000afda58
- (id)description;	// IMP=0x0000000000afd9a9
