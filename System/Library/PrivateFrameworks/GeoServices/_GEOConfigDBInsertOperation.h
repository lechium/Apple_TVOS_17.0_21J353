...
- (void).cxx_destruct;	// IMP=0x000000000029bbb2
- (_Bool)performOperation;	// IMP=0x000000000029bb0c
- (id)init:(id)arg1 rowId:(long long)arg2 type:(id)arg3 key:(id)arg4 value:(id)arg5 parentId:(long long)arg6;	// IMP=0x000000000029b9f1
