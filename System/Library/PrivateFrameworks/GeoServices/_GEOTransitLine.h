...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000117d819
- (void).cxx_destruct;	// IMP=0x000000000117d9e5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000117d945
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000117d821
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000117d337
