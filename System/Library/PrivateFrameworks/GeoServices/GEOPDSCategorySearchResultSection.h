...
- (void).cxx_destruct;	// IMP=0x0000000000695bf0
- (unsigned long long)hash;	// IMP=0x00000000006959d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000695884
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000695636
- (void)writeTo:(id)arg1;	// IMP=0x000000000069542b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000069541c
- (id)jsonRepresentation;	// IMP=0x0000000000694ac4
- (id)dictionaryRepresentation;	// IMP=0x00000000006946a2
- (id)description;	// IMP=0x00000000006945f3
- (id)initWithData:(id)arg1;	// IMP=0x00000000006938c7
- (id)init;	// IMP=0x000000000069386b
