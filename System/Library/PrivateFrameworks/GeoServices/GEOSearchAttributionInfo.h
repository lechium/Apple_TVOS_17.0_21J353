...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000011b3b13
- (void).cxx_destruct;	// IMP=0x00000000011b46c7
...
- (void)addLogoPath:(id)arg1;	// IMP=0x00000000011b460f
- (id)snippetLogoPathForScale:(double)arg1;	// IMP=0x00000000011b4339
- (id)logoPathForScale:(double)arg1;	// IMP=0x00000000011b4063
- (_Bool)hasAttributionRequirement:(int)arg1;	// IMP=0x00000000011b4054
- (id)description;	// IMP=0x00000000011b3fa5
- (id)dictionaryRepresentation;	// IMP=0x00000000011b3de9
- (_Bool)supportsActionURLs;	// IMP=0x00000000011b3b1b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011b3a10
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011b37d4
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000011b35b4
...
- (id)initWithSource:(id)arg1 localizedAttribution:(id)arg2 logoPaths:(id)arg3 snippetLogoPaths:(id)arg4;	// IMP=0x00000000011b3330
