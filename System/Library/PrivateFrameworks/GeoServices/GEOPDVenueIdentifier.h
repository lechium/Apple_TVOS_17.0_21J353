...
- (void).cxx_destruct;	// IMP=0x00000000011bdf79
- (unsigned long long)hash;	// IMP=0x00000000011bda63
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011bd81e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011bd583
- (void)writeTo:(id)arg1;	// IMP=0x00000000011bd27b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000011bd26c
- (id)jsonRepresentation;	// IMP=0x00000000011bc007
- (id)dictionaryRepresentation;	// IMP=0x00000000011bba1f
- (id)description;	// IMP=0x00000000011bb970
- (void)dealloc;	// IMP=0x00000000011ba758
- (id)initWithData:(id)arg1;	// IMP=0x00000000011ba6fc
- (id)init;	// IMP=0x00000000011ba6a0
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000a3ed99
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3 componentIdentifier:(id)arg4;	// IMP=0x0000000000a3e965
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3;	// IMP=0x0000000000a3e863
