...
- (void).cxx_destruct;	// IMP=0x0000000000c828f0
- (unsigned long long)hash;	// IMP=0x0000000000c827c1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c82593
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c82291
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c81fab
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c81f9c
- (id)jsonRepresentation;	// IMP=0x0000000000c7e993
- (id)dictionaryRepresentation;	// IMP=0x0000000000c7e1cf
- (id)description;	// IMP=0x0000000000c7e120
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c7ca2c
- (id)init;	// IMP=0x0000000000c7c9d0
