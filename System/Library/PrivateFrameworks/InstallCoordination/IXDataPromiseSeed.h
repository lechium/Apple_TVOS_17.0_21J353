...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000491d4
- (void).cxx_destruct;	// IMP=0x0000000000049338
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000491dc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004908e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048f2b
