...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005ab88
- (void).cxx_destruct;	// IMP=0x000000000005acbb
...
- (Class)clientPromiseClass;	// IMP=0x000000000005ac45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005ab90
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005aaa2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a9ba
