...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005b9c9
- (void).cxx_destruct;	// IMP=0x000000000005c0a3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005bef7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005bd18
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005b9d1
