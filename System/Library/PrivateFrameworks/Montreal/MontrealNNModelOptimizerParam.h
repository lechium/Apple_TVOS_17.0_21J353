...
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000023e170
- (id)initWithOptimizerType:(unsigned long long)arg1 learningRate:(float)arg2 momentum:(float)arg3 gradientClipMin:(id)arg4 gradientClipMax:(id)arg5;	// IMP=0x000000000023e040
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000023de70
