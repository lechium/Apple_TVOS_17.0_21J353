...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000018bcf
- (unsigned long long)hash;	// IMP=0x0000000000018a35
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000188dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000187be
- (void)copyTo:(id)arg1;	// IMP=0x00000000000186ee
- (void)writeTo:(id)arg1;	// IMP=0x000000000001860d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000018600
- (id)dictionaryRepresentation;	// IMP=0x000000000001815b
- (id)description;	// IMP=0x00000000000180ac
