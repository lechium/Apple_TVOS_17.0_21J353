...
- (void).cxx_destruct;	// IMP=0x0000000000014f79
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000014e3d
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000014c6e
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000014b4c
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x000000000001474c
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x00000000000146c5
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x000000000001464c
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000014598
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x000000000001454a
- (void)_addMonitor;	// IMP=0x000000000001448a
- (void)dealloc;	// IMP=0x0000000000014446
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x00000000000142c2
