...
- (void).cxx_destruct;	// IMP=0x0000000000016438
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x00000000000162ff
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x00000000000161a7
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016085
...
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x000000000001598f
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x0000000000015916
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000015862
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x0000000000015814
@property(readonly, nonatomic) struct __CFString *wwanInterfaceName;
@property(readonly, nonatomic) int currentRAT; // @synthesize currentRAT=_currentRAT;
- (id)_currentDataSimContext;	// IMP=0x0000000000015555
...
- (_Bool)_isCurrentDataSimContextOnIvarQueue:(id)arg1;	// IMP=0x00000000000154d8
- (void)_adjustInterfaceNameForWWANContextID:(int)arg1 interfaceName:(id)arg2 forContext:(id)arg3;	// IMP=0x000000000001528b
- (void)_setupWWANMonitor;	// IMP=0x00000000000151b5
- (void)dealloc;	// IMP=0x0000000000015157
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014fcd
