...
+ (id)stringForLinkQuality:(int)arg1;	// IMP=0x001000000001385e
+ (_Bool)isBadLinkQuality:(int)arg1;	// IMP=0x0010000000012a6c
+ (_Bool)isPoorLinkQuality:(int)arg1;	// IMP=0x0010000000012a1c
- (void).cxx_destruct;	// IMP=0x000000000001424a
- (_Bool)_createLinkQualityMonitor:(_Bool)arg1;	// IMP=0x0000000000013e58
- (void)_dynamicStoreCallbackForKeys:(id)arg1;	// IMP=0x0000000000013df3
- (void)_dynamicStoreCallback:(id)arg1;	// IMP=0x0000000000013b69
- (void)_processLinkQualityUpdateWithChangedKey:(id)arg1 updatedLinkQuality:(int)arg2;	// IMP=0x00000000000138a0
- (void)_unscheduleLinkQualityMonitor;	// IMP=0x0000000000013817
- (void)_updatePathParameters;	// IMP=0x0000000000013729
- (void)_pathUpdate:(id)arg1;	// IMP=0x00000000000130cd
- (void)_createPathEvaluator;	// IMP=0x0000000000012f19
- (void)_unschedulePathEvaluator;	// IMP=0x0000000000012e34
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012cad
...
- (_Bool)_isInterfaceHistoricallyUsable;	// IMP=0x0000000000012949
@property(readonly, nonatomic) _Bool isInterfaceUsable;
- (_Bool)_isInterfaceUsable;	// IMP=0x00000000000128ea
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000012887
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x0000000000012834
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x00000000000127ae
- (void)_flushStaleTransitions;	// IMP=0x000000000001262c
- (void)_updateOffTransitionsForLinkQualityChange;	// IMP=0x000000000001256d
- (id)currentInterfaceName;	// IMP=0x00000000000124fa
- (void)dealloc;	// IMP=0x0000000000012465
- (id)initWithInterfaceIdentifier:(long long)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000012357
- (id)init;	// IMP=0x00000000000122d9
