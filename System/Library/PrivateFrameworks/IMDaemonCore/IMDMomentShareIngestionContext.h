...
- (void).cxx_destruct;	// IMP=0x0000000000002e06
...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000002d74
- (void)clearAllTransfers;	// IMP=0x0000000000002d5e
- (void)addTransfers:(id)arg1;	// IMP=0x0000000000002d48
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x0000000000002c68
