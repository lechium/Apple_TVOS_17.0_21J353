...
- (id).cxx_construct;	// IMP=0x000000000002b797
- (void).cxx_destruct;	// IMP=0x000000000002b712
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b4e9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b030
@property(readonly, nonatomic) void *irProgram;
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002a9eb
- (id)initWithMessageStream:(struct CodedInputStream *)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002a5c8
- (id)initWithSpecificationData:(id)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002a480
