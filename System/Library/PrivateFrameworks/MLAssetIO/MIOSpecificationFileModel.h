...
- (void).cxx_destruct;	// IMP=0x000000000002c1f0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c0c5
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002bf7d
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002bbb3
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002bb34
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002b96c
