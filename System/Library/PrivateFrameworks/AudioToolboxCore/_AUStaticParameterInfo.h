...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000018e4f8
- (void).cxx_destruct;	// IMP=0x000000000018e4d0
...
- (void)dealloc;	// IMP=0x000000000018e3e1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018e0f6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018dfc0
