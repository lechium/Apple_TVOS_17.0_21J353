...
@interface WebViewPrivate : NSObject
{
    ...
    struct unique_ptr<WebViewRenderingUpdateScheduler, std::default_delete<WebViewRenderingUpdateScheduler>> renderingUpdateScheduler;	// 936 = 0x3a8
...
+ (void)initialize;	// IMP=0x006000000012e0d0
- (id).cxx_construct;	// IMP=0x000000000012e610
- (void).cxx_destruct;	// IMP=0x000000000012e1e0
- (void)dealloc;	// IMP=0x000000000012e1b0
- (id)init;	// IMP=0x000000000012e0e0
