...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000002c80
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002e43
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002ce5
- (id)init;	// IMP=0x0000000000002c88
