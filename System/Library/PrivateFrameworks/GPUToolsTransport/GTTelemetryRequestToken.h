...
- (void).cxx_destruct;	// IMP=0x000000000002f746
@property(readonly, nonatomic) unsigned long long tokenId; // @synthesize tokenId=_tokenId;
- (void)waitUntilCompleted;	// IMP=0x000000000002f727
- (void)completed;	// IMP=0x000000000002f719
- (id)initWithService:(id)arg1 andTokenId:(unsigned long long)arg2;	// IMP=0x000000000002f67b
