...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001a75
- (void).cxx_destruct;	// IMP=0x0000000000001ced
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001b16
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001a7d
