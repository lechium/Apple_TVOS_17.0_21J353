...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000005dad
- (void).cxx_destruct;	// IMP=0x0000000000005fca
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005e8e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005db5
