...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000521c
- (void).cxx_destruct;	// IMP=0x00000000000052eb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005272
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005224
