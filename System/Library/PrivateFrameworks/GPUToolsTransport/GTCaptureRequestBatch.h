...
- (void).cxx_destruct;	// IMP=0x000000000000c650
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c5e5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c55e
- (id)initWithRequestID:(unsigned long long)arg1;	// IMP=0x000000000000c521
- (id)init;	// IMP=0x000000000000c4c2
