...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000462b
- (void).cxx_destruct;	// IMP=0x000000000000494d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000047a7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004633
