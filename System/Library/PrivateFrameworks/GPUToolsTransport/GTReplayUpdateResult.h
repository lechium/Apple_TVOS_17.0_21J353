...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000498f
- (void).cxx_destruct;	// IMP=0x0000000000004c90
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004b2a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004997
