...
- (void).cxx_destruct;	// IMP=0x000000000000c342
@property(readonly, nonatomic) unsigned long long tokenId; // @synthesize tokenId=_tokenId;
- (void)waitUntilCompleted;	// IMP=0x000000000000c323
- (void)completed;	// IMP=0x000000000000c315
- (id)description;	// IMP=0x000000000000c297
- (id)initWithCaptureService:(id)arg1 andTokenId:(unsigned long long)arg2;	// IMP=0x000000000000c1f9
