...
- (id).cxx_construct;	// IMP=0x0000000002437c80
- (void).cxx_destruct;	// IMP=0x0000000002437b60
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x0000000002437a60
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x0000000002437960
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x0000000002437860
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x0000000002437450
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x0000000002436f30
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x0000000002436de0
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x0000000002436d90
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x0000000002436870
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x0000000002436860
- (id)_timingData;	// IMP=0x0000000002436850
- (void)dealloc;	// IMP=0x0000000002436650
- (void)resume;	// IMP=0x00000000024365b0
- (void)suspend;	// IMP=0x0000000002436510
- (void)cancel;	// IMP=0x0000000002436440
...
- (void)_cancel;	// IMP=0x00000000024361b0
- (void)_restart;	// IMP=0x0000000002435cb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000002435ca0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x0000000002435b70
