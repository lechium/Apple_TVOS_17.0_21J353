...
- (id).cxx_construct;	// IMP=0x00000000024330e0
- (void).cxx_destruct;	// IMP=0x0000000002433060
- (_Bool)multipath;	// IMP=0x0000000002433050
- (_Bool)constrained;	// IMP=0x0000000002433040
- (_Bool)expensive;	// IMP=0x0000000002433030
- (_Bool)cellular;	// IMP=0x0000000002433020
...
- (void)dealloc;	// IMP=0x0000000002432bd0
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x0000000002432ae0
