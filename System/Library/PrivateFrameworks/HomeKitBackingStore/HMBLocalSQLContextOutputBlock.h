...
+ (id)logCategory;	// IMP=0x0010000000072a02
- (void).cxx_destruct;	// IMP=0x000000000007279a
...
- (id)logIdentifier;	// IMP=0x00000000000726d9
- (id)abort;	// IMP=0x000000000007223d
- (id)commit:(id)arg1;	// IMP=0x0000000000071d0f
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x00000000000719bc
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x0000000000071731
