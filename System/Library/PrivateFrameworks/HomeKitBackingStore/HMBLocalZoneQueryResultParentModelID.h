...
- (void).cxx_destruct;	// IMP=0x0000000000054c6a
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054b83
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x0000000000054a00
