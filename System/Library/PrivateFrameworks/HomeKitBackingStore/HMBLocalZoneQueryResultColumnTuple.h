...
- (void).cxx_destruct;	// IMP=0x00000000000540dd
...
- (id)description;	// IMP=0x0000000000053ffc
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000053f49
