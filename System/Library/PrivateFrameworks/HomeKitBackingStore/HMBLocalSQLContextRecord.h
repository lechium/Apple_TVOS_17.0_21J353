...
- (void).cxx_destruct;	// IMP=0x0000000000081edb
...
- (id)attributeDescriptions;	// IMP=0x0000000000081d73
- (id)initWithModel:(id)arg1 externalID:(id)arg2;	// IMP=0x0000000000081cd1
