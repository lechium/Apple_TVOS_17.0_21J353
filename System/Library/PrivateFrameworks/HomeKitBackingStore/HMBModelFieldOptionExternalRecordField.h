...
- (void).cxx_destruct;	// IMP=0x000000000009d84f
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009d79f
- (id)initWithExternalRecordField:(id)arg1 encrypted:(_Bool)arg2;	// IMP=0x000000000009d720
