...
- (void).cxx_destruct;	// IMP=0x000000000009de2b
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009dbd4
- (id)initWithEncodingBlock:(CDUnknownBlockType)arg1 decodingBlock:(CDUnknownBlockType)arg2 descriptionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000009daf2
