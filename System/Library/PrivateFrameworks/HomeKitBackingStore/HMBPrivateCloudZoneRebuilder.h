...
+ (id)logCategory;	// IMP=0x001000000003d376
- (void).cxx_destruct;	// IMP=0x0000000000036563
...
- (id)logIdentifier;	// IMP=0x0000000000036401
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000036175
- (void)handleZoneChanged;	// IMP=0x0000000000035edd
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x0000000000035cf1
- (void)handleIdentityLost;	// IMP=0x0000000000035b4d
- (id)zoneStartUp;	// IMP=0x00000000000359ee
- (id)initWithCloudZone:(id)arg1;	// IMP=0x0000000000035927
