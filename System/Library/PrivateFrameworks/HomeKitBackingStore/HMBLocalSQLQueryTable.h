...
- (void).cxx_destruct;	// IMP=0x000000000001f0f4
...
- (void)finalize;	// IMP=0x000000000001ecc3
- (void)dealloc;	// IMP=0x000000000001eb5a
- (unsigned long long)_updateQueryForZoneRow:(unsigned long long)arg1 recordRow:(unsigned long long)arg2 encodedColumns:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001ea2f
- (id)buildQueriableFieldsForModel:(id)arg1;	// IMP=0x000000000001e8e7
- (unsigned long long)_deleteAllQueriesForZoneRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001e835
- (unsigned long long)_deleteQueryForRecordRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001e75d
- (id)performQueryOn:(id)arg1 properties:(id)arg2 filter:(CDUnknownBlockType)arg3;	// IMP=0x000000000001e5bb
- (id)initWithContext:(id)arg1 queryModel:(Class)arg2 prepareOnly:(_Bool)arg3;	// IMP=0x000000000001c9e5
