...
- (void).cxx_destruct;	// IMP=0x00000000000556ea
...
- (id)nextObject;	// IMP=0x000000000005540d
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000055347
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000055059
