...
+ (id)logCategory;	// IMP=0x00600000000565fa
- (void).cxx_destruct;	// IMP=0x000000000005652c
...
- (void)main;	// IMP=0x000000000005641a
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000056386
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000562eb
