...
- (void)cancelCallbacks;	// IMP=0x0000000000149d98
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x0000000000149d86
- (void)start;	// IMP=0x0000000000149d3d
@property(readonly, nonatomic) NSObject *observedObject;
- (void)dealloc;	// IMP=0x0000000000149c8b
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000000149aa9
