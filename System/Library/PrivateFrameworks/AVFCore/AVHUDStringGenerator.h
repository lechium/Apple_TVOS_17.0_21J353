...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x00600000000577b8
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x006000000005778d
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x0060000000057722
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x0060000000057428
- (void).cxx_destruct;	// IMP=0x0000000000059507
...
- (void)update;	// IMP=0x0000000000058ccb
- (void)updateFromPlayerItem;	// IMP=0x0000000000057fd8
- (void)updateFromPlayer;	// IMP=0x0000000000057abf
- (void)dealloc;	// IMP=0x00000000000572f4
