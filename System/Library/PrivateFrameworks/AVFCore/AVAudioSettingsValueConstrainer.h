...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000125188
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x0000000000125032
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000124cf1
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x0000000000124c26
- (void)_bringUpToDate;	// IMP=0x0000000000124b6e
- (id)_fetchApplicableOutputDataRates;	// IMP=0x0000000000124acd
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x0000000000124528
- (void)_buildAvailableSampleRates;	// IMP=0x00000000001243ed
- (void)_buildAudioConverter;	// IMP=0x0000000000124325
- (void)dealloc;	// IMP=0x00000000001242bc
- (id)init;	// IMP=0x0000000000124261
