...
- (void)requestMediaDataIfNecessary;	// IMP=0x00000000000b7b18
@property __weak id <AVAssetWriterInputMediaDataRequesterDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000b7907
- (void)_collectUncollectables_invokedFromDeallocAndFinalize;	// IMP=0x00000000000b78d9
- (id)init;	// IMP=0x00000000000b78c3
- (id)initWithRequestQueue:(id)arg1 requestBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b779f
