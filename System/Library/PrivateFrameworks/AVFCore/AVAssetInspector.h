...
- (id)makePropertyListForProxyWithOptions:(id)arg1;	// IMP=0x00000000000efa83
...
- (_Bool)isCompatibleWithPhotosTranscodingServiceWithOptions:(id)arg1;	// IMP=0x00000000000ef9dc
@property(readonly, nonatomic, getter=isPlayable) _Bool playable;
- (_Bool)hasProtectedContent;	// IMP=0x00000000000ef9cc
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000ef99b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ef801
