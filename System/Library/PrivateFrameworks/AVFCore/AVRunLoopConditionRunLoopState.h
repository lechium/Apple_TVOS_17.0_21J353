...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000000eee8a
...
- (void)dealloc;	// IMP=0x00000000000eef26
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000eeec1
