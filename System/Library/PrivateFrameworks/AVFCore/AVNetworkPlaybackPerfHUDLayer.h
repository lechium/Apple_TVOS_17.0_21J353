...
- (void).cxx_destruct;	// IMP=0x000000000005a8ca
...
- (void)_hudUpdateTrigger;	// IMP=0x000000000005a5f2
- (void)copyPropertiesFromStringGenerator:(id)arg1;	// IMP=0x000000000005a51f
- (id)displayStringGenerator;	// IMP=0x000000000005a469
- (void)updateHudWithDisplayString:(id)arg1;	// IMP=0x000000000005a053
- (_Bool)valueLoadedForKey:(id)arg1 onObject:(id)arg2;	// IMP=0x0000000000059f1b
- (void)currentItemTracksChanged;	// IMP=0x0000000000059da0
- (void)currentItemChanged;	// IMP=0x0000000000059d20
- (float)getScaleFactorForDisplaySize:(struct CGSize)arg1;	// IMP=0x0000000000059c71
- (void)dealloc;	// IMP=0x0000000000059bdf
- (void)startDispatchTimer;	// IMP=0x0000000000059acc
- (void)readHudSettingsAndCallCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000059a4b
- (void)getHudSetting;	// IMP=0x0000000000059838
- (void)setColor:(int)arg1;	// IMP=0x000000000005970f
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000059618
- (id)init;	// IMP=0x0000000000059525
- (_Bool)hudEnabled;	// IMP=0x0000000000059515
