...
+ (void)initialize;	// IMP=0x00100000000f6c2c
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000f6f28
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f6f13
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000f6f0d
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000f6f07
...
- (struct OpaqueFigFormatReader *)_copyFormatReader;	// IMP=0x00000000000f6dfc
@property(readonly, nonatomic) NSURL *URL;
- (void)cancelLoading;	// IMP=0x00000000000f6dee
- (id)assetInspector;	// IMP=0x00000000000f6de6
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f6dbb
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f6d8d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f6d82
- (void)dealloc;	// IMP=0x00000000000f6d47
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000f6cde
