...
- (void)dealloc;	// IMP=0x00000000001429e2
- (id)init;	// IMP=0x00000000001429c9
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x00000000001428e9
