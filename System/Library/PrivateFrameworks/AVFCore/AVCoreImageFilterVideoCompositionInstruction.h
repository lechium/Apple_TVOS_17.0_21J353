...
- (void)dealloc;	// IMP=0x000000000013d4be
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1 sourceTrackIDs:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000013d405
- (id)init;	// IMP=0x000000000013d39f
