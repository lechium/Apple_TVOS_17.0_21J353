...
@interface AVContentKeyRequestInternal : NSObject
{
    ...
    _Bool useContentKeyBoss;	// 192 = 0xc0
    unsigned long long requestID;	// 200 = 0xc8
    struct FigContentKeySpecifier *keySpecifier;	// 208 = 0xd0
}

- (void).cxx_destruct;	// IMP=0x0000000000156e14
