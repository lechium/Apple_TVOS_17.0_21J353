...
- (void).cxx_destruct;	// IMP=0x00000000000d4ea3
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (_Bool)supportsScreenMirroringControls;	// IMP=0x00000000000d4e7c
- (_Bool)supportsFitnessDataDestination;	// IMP=0x00000000000d4e74
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d4e37
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000d4e11
@property(readonly, nonatomic) NSString *currentBluetoothListeningMode;
- (_Bool)setConversationDetectionEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000d4de3
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000d4d98
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000d4d65
...
- (float)volumeForActivatedDeviceClusterMembersWithRoomID:(id)arg1;	// IMP=0x00000000000d4cb6
- (void)setActivatedDeviceClusterMembersVolume:(float)arg1 withRoomID:(id)arg2;	// IMP=0x00000000000d4cb0
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000d4caa
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000d4ca4
- (void)setVolume:(float)arg1;	// IMP=0x00000000000d4c9e
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d4c50
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000d4c4a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d4af9
