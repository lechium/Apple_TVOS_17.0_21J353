...
+ (id)configurationPromiseWithBag:(id)arg1;	// IMP=0x00600000002fcfac
- (void).cxx_destruct;	// IMP=0x00000000002fd929
...
- (id)_generateModifiersIfNeeded;	// IMP=0x00000000002fd525
@property(readonly, nonatomic) NSArray *overrides; // @synthesize overrides=_overrides;
- (id)modifierForEvent:(id)arg1;	// IMP=0x00000000002fd1fd
- (void)prepareForFlush;	// IMP=0x00000000002fd0f2
- (id)initWithMetricsDictionary:(id)arg1;	// IMP=0x00000000002fcef5
