...
- (void).cxx_destruct;	// IMP=0x000000000037c686
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x000000000037bf40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037be4e
