...
- (void).cxx_destruct;	// IMP=0x00000000001eca93
...
- (id)createFrozenDataSource;	// IMP=0x00000000001ec74b
- (id)createFrozenBag;	// IMP=0x00000000001ec5d5
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x00000000001ec3c4
