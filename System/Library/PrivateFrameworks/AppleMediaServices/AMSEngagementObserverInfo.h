...
- (void).cxx_destruct;	// IMP=0x0000000000275732
...
- (void)removeServiceType:(id)arg1;	// IMP=0x0000000000275678
- (void)addServiceType:(id)arg1;	// IMP=0x000000000027560f
- (void)removePlacement:(id)arg1;	// IMP=0x00000000002755a6
- (void)addPlacements:(id)arg1;	// IMP=0x000000000027553d
@property(readonly, nonatomic) NSSet *serviceTypes;
@property(readonly, nonatomic) NSSet *placements;
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000002753a0
