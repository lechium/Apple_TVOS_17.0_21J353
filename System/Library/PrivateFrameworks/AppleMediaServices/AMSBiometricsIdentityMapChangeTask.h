...
- (void).cxx_destruct;	// IMP=0x0000000000200bb7
...
- (id)perform;	// IMP=0x00000000002000b5
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x00000000001fffeb
