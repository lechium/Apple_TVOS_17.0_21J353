...
- (void).cxx_destruct;	// IMP=0x000000000031734b
...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000003172ce
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000003172c6
- (void)valueForURLVariable:(id)arg1 account:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000003172b6
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000003172ae
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003170b7
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x0000000000316fa5
