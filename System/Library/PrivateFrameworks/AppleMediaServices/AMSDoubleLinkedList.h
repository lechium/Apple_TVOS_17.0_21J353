...
- (void).cxx_destruct;	// IMP=0x000000000026029e
...
- (id)description;	// IMP=0x0000000000260020
- (void)removeNode:(id)arg1;	// IMP=0x000000000025fddb
- (void)removeAllNodes;	// IMP=0x000000000025fda2
- (id)insertObject:(id)arg1;	// IMP=0x000000000025fd36
- (void)insertNode:(id)arg1;	// IMP=0x000000000025fbbf
- (id)appendObject:(id)arg1;	// IMP=0x000000000025fb53
- (void)appendNode:(id)arg1;	// IMP=0x000000000025f9de
@property(readonly, nonatomic) NSArray *allNodes;
- (id)init;	// IMP=0x000000000025f8b1
