...
- (void).cxx_destruct;	// IMP=0x0000000000340d93
...
- (id)description;	// IMP=0x0000000000340be6
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x0000000000340b23
