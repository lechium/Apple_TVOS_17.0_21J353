...
- (void).cxx_destruct;	// IMP=0x0000000000237ff5
...
- (void)invalidate;	// IMP=0x0000000000237fa6
- (id)initWithDeallocGuardBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000237f26
- (void)dealloc;	// IMP=0x0000000000237ea1
