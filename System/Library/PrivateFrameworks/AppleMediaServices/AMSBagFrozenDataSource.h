...
@interface AMSBagFrozenDataSource : NSObject <NSSecureCoding>
{
...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001ec32c
- (void).cxx_destruct;	// IMP=0x00000000001ec370
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ec04c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ebe8f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ebd94
- (void)valueForURLVariable:(id)arg1 account:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ebd0b
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001ebd05
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000001ebc37
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001ebb41
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000001eba16
@property(readonly, copy) NSString *description;
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)_initWithProfile:(id)arg1 profileVersion:(id)arg2 data:(id)arg3 expirationDate:(id)arg4 processInfo:(id)arg5 defaultValues:(id)arg6;	// IMP=0x00000000001eb7c4
