...
- (void).cxx_destruct;	// IMP=0x00000000002e0518
...
- (double)_calculateThrottleInterval;	// IMP=0x00000000002e0431
- (void)throttle;	// IMP=0x00000000002e03aa
- (_Bool)shouldThrottle;	// IMP=0x00000000002e035d
- (void)reset;	// IMP=0x00000000002e032b
- (id)initWithBaseSleepInterval:(double)arg1 maxSleepInterval:(double)arg2;	// IMP=0x00000000002e02c1
