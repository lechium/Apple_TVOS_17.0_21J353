...
- (void).cxx_destruct;	// IMP=0x00000000002da003
...
- (id)_devicePlatform;	// IMP=0x00000000002d9c61
- (void)_addSearchTerm:(id)arg1;	// IMP=0x00000000002d9a82
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x00000000002d9860
- (void)_addCharts:(id)arg1;	// IMP=0x00000000002d973d
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x00000000002d9591
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x00000000002d8d9b
- (id)_pathPromise;	// IMP=0x00000000002d8844
- (id)_languagePromise;	// IMP=0x00000000002d8457
- (id)_hostPromise;	// IMP=0x00000000002d8392
- (id)_verifyConfiguration;	// IMP=0x00000000002d807a
- (id)build;	// IMP=0x00000000002d7cf3
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x00000000002d7c20
