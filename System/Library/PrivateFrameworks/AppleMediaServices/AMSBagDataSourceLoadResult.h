...
- (void).cxx_destruct;	// IMP=0x00000000001eb02a
...
- (id)initWithData:(id)arg1 expirationDate:(id)arg2 loadedBagIdentifier:(id)arg3 loadedBagPartialIdentifier:(id)arg4;	// IMP=0x00000000001eaef8
