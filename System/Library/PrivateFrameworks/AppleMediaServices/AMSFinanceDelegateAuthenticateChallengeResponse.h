...
+ (_Bool)isDelegateAuthChallengeForTaskInfo:(id)arg1;	// IMP=0x001000000028fcd2
- (void).cxx_destruct;	// IMP=0x0000000000290002
...
- (id)performWithTaskInfo:(id)arg1;	// IMP=0x000000000028fea8
- (id)initWithResponseDictionary:(id)arg1 taskInfo:(id)arg2;	// IMP=0x000000000028fc39
