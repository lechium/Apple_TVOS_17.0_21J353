...
+ (void)_valueForURLVariable:(id)arg1 account:(id)arg2 clientInfo:(id)arg3 sync:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00100000001f095a
+ (id)valueForURLVariable:(id)arg1 account:(id)arg2 clientInfo:(id)arg3;	// IMP=0x00100000001eedb7
+ (id)requestPartialIdentifierForClientInfo:(id)arg1 profile:(id)arg2 profileVersion:(id)arg3;	// IMP=0x00100000001eeba9
- (void).cxx_destruct;	// IMP=0x00000000001f10b2
...
- (void)_updateCachedResult:(id)arg1;	// IMP=0x00000000001eff83
- (id)_newCompletionQueue;	// IMP=0x00000000001efeed
- (void)_invalidateCacheNotification:(id)arg1;	// IMP=0x00000000001efda1
- (id)_fetchBag;	// IMP=0x00000000001ef493
- (void)_accountStoreDidChange;	// IMP=0x00000000001eef2a
- (void)valueForURLVariable:(id)arg1 account:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001eed04
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000001eec61
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001eebc2
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001ee65c
@property(readonly, copy, nonatomic) NSString *bagLoadingPartialIdentifier;
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000001ee499
...
- (id)loadedValuesForKeys:(id)arg1;	// IMP=0x00000000001edf3f
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
@property(readonly, nonatomic) NSDate *expirationDate;
- (void)dealloc;	// IMP=0x00000000001ed98d
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 processInfo:(id)arg3 accountProvider:(id)arg4;	// IMP=0x00000000001ed1dd
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 processInfo:(id)arg3;	// IMP=0x00000000001ed13e
