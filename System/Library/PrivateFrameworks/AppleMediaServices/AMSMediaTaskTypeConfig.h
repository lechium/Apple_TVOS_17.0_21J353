...
+ (id)configForType:(long long)arg1;	// IMP=0x00600000002d750f
- (void).cxx_destruct;	// IMP=0x00000000002d7bed
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x00000000002d7444
