...
- (void).cxx_destruct;	// IMP=0x0000000000020060
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x000000000001ff01
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001fdfa
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x000000000001fd25
- (id)init;	// IMP=0x000000000001fc7d
