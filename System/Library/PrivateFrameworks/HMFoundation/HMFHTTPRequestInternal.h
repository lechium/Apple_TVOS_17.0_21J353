...
- (void).cxx_destruct;	// IMP=0x000000000004eb39
...
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x000000000004e9f6
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x000000000004e9b4
- (id)init;	// IMP=0x000000000004e905
