...
- (void).cxx_destruct;	// IMP=0x000000000002f385
...
- (_Bool)shouldFetchProtectedKey:(id)arg1;	// IMP=0x000000000002f161
- (_Bool)shouldFetchUserAssignedDeviceName;	// IMP=0x000000000002f0b9
- (void)dealloc;	// IMP=0x000000000002f072
- (id)init;	// IMP=0x000000000002e5e3
