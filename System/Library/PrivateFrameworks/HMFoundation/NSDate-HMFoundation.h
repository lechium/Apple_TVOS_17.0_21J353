...
+ (id)shortDescription;	// IMP=0x0010000000048b95
+ (id)timeIntervalDescription:(double)arg1;	// IMP=0x0010000000048d55
- (id)hmf_dateComponentsUsingTimeZone:(id)arg1;	// IMP=0x0010000000048cb6
