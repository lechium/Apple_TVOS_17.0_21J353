...
+ (id)currentContext;	// IMP=0x004000000001f643
- (void).cxx_destruct;	// IMP=0x000000000001f875
...
- (id)description;	// IMP=0x000000000001f7bd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001f72b
- (unsigned long long)hash;	// IMP=0x000000000001f70e
- (id)__init;	// IMP=0x000000000001f6df
- (id)init;	// IMP=0x000000000001f59b
