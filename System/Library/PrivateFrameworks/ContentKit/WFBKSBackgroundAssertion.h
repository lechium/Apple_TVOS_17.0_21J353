...
+ (id)backgroundAssertionWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0060000000081fa3
- (void).cxx_destruct;	// IMP=0x0000000000081b40
...
- (void)end;	// IMP=0x000000000008199d
- (id)initWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000008160b
