...
- (void).cxx_destruct;	// IMP=0x000000000003c5d3
...
- (id)initWithSerializedRepresentationBlock:(CDUnknownBlockType)arg1 deserializationBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003c4f7
