...
- (void).cxx_destruct;	// IMP=0x00000000000d898d
...
- (void)removeAllAttachments;	// IMP=0x00000000000d87bb
- (void)addAttachments:(id)arg1;	// IMP=0x00000000000d84d7
- (void)updateAttachments:(id)arg1;	// IMP=0x00000000000d8402
- (void)saveWithCompletionHandler:(CDUnknownBlockType)arg1 isNew:(_Bool)arg2;	// IMP=0x00000000000d821a
- (id)initWithContentItem:(id)arg1 eventStore:(id)arg2;	// IMP=0x00000000000d805f
