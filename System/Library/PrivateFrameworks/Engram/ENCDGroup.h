...
+ (id)predicateForStableGroupID:(id)arg1;	// IMP=0x006000000000737b
+ (id)predicateForGroupIDs:(id)arg1;	// IMP=0x00600000000072f6
+ (id)predicateForGroupID:(id)arg1;	// IMP=0x0060000000007271
+ (id)groupFromGroup:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x00600000000070e5
+ (id)insertIntoManagedObjectContext:(id)arg1;	// IMP=0x0060000000007015
+ (id)fetchRequest;	// IMP=0x0060000000006f98
