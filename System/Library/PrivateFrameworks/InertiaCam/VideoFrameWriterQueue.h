...
- (void).cxx_destruct;	// IMP=0x000000000002466b
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x0000000000024318
- (void)StartWatchingForFrames;	// IMP=0x0000000000024255
- (void)FrameRequestCallback;	// IMP=0x0000000000023dc9
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x0000000000023cf4
- (_Bool)WaitForFinish;	// IMP=0x0000000000023aa3
- (unsigned long long)FramesInQueue;	// IMP=0x0000000000023a54
- (void)AddAFrame:(id)arg1;	// IMP=0x00000000000239cb
- (void)dealloc;	// IMP=0x000000000002399c
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x0000000000023583
