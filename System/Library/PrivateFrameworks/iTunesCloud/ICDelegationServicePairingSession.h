...
- (void).cxx_destruct;	// IMP=0x0000000000139beb
...
- (void)_sendData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000139a62
- (void)_receivedData:(id)arg1;	// IMP=0x00000000001397e2
- (_Bool)_deriveEncryptionKeysReturningError:(id *)arg1;	// IMP=0x00000000001392a5
- (void)_handlePairingSessionCompletionWithError:(id)arg1;	// IMP=0x000000000013905d
- (id)_encryptedDataForData:(id)arg1;	// IMP=0x0000000000138eed
- (void)getEncryptedDataForData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000138e36
- (void)getDecryptedDataForEncryptedData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000138d7f
- (void)receievedData:(id)arg1;	// IMP=0x0000000000138cf2
- (void)prepareEncryptedSessionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000138c65
- (void)dealloc;	// IMP=0x0000000000138c26
- (id)initWithRole:(long long)arg1 securitySettings:(id)arg2;	// IMP=0x0000000000138b6e
