...
- (void).cxx_destruct;	// IMP=0x0000000000138213
- (unsigned long long)hash;	// IMP=0x000000000013728b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001364ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013593b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000134fa4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001333f9
- (id)dictionaryRepresentation;	// IMP=0x00000000001320fb
- (id)description;	// IMP=0x000000000013204c
