...
- (void).cxx_destruct;	// IMP=0x00000000000a9273
- (unsigned long long)hash;	// IMP=0x00000000000a918a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a8ff2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a8ea7
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a8dc0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a8db3
- (id)dictionaryRepresentation;	// IMP=0x00000000000a8b35
- (id)description;	// IMP=0x00000000000a8a86
