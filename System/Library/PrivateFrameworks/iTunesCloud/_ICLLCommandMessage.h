...
- (void).cxx_destruct;	// IMP=0x000000000008cc1f
- (unsigned long long)hash;	// IMP=0x000000000008caaf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008c839
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008c600
- (void)writeTo:(id)arg1;	// IMP=0x000000000008c49e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008c491
- (id)dictionaryRepresentation;	// IMP=0x000000000008c0b4
- (id)description;	// IMP=0x000000000008c005
