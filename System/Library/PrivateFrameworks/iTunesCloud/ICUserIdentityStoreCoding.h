...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000cc5db
- (void).cxx_destruct;	// IMP=0x00000000000cc59d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cc460
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000cc2b1
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cc247
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000cc1f6
- (id)_initCommon;	// IMP=0x00000000000cc1bb
