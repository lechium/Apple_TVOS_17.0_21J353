...
- (void).cxx_destruct;	// IMP=0x00000000001307c1
- (unsigned long long)hash;	// IMP=0x0000000000130681
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000130484
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001302fe
- (void)writeTo:(id)arg1;	// IMP=0x00000000001301b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001301ac
- (id)dictionaryRepresentation;	// IMP=0x000000000012ff43
- (id)description;	// IMP=0x000000000012fe94
