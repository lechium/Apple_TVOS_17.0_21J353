...
- (void).cxx_destruct;	// IMP=0x000000000003d0e9
- (unsigned long long)hash;	// IMP=0x000000000003cece
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003cb4a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003c82a
- (void)writeTo:(id)arg1;	// IMP=0x000000000003c605
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003c5f8
- (id)dictionaryRepresentation;	// IMP=0x000000000003c05c
- (id)description;	// IMP=0x000000000003bfad
