...
- (void).cxx_destruct;	// IMP=0x00000000001c9ddc
@property(readonly, nonatomic) NSNetService *netService; // @synthesize netService=_netService;
- (void)_updateTXTRecordProperties;	// IMP=0x00000000001c9c65
- (void)_setState:(long long)arg1;	// IMP=0x00000000001c9b16
- (void)_resolveWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c9a3c
...
- (void)getResolvedStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c970c
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000001c9615
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x00000000001c9547
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x00000000001c9479
- (void)dealloc;	// IMP=0x00000000001c9435
- (id)initWithNetService:(id)arg1;	// IMP=0x00000000001c9307
