...
- (void).cxx_destruct;	// IMP=0x00000000000b3708
- (unsigned long long)hash;	// IMP=0x00000000000b35f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b344d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b3302
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b31fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b31f0
- (id)dictionaryRepresentation;	// IMP=0x00000000000b2fbd
- (id)description;	// IMP=0x00000000000b2f0e
