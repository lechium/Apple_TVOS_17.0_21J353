...
- (void).cxx_destruct;	// IMP=0x000000000001999c
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000000196c6
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x000000000001954b
