...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x0010000000193a61
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x0010000000193a12
- (void).cxx_destruct;	// IMP=0x000000000019110f
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001908de
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019054c
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000190401
- (void)_renewUserPseudonym;	// IMP=0x0000000000190255
- (void)_beginPseudonymAutoRenewal;	// IMP=0x00000000001900c1
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018f8c1
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000018f809
- (void)dealloc;	// IMP=0x000000000018f757
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x000000000018f65f
