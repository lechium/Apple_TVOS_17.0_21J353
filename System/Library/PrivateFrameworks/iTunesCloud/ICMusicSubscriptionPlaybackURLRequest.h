...
- (void).cxx_destruct;	// IMP=0x000000000015fc41
...
- (id)_analyticSignature;	// IMP=0x000000000015f9c8
- (id)description;	// IMP=0x000000000015f8de
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x000000000015f6ff
- (id)_actionType;	// IMP=0x000000000015f6c9
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015f5f9
