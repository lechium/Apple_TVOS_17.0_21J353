...
- (void).cxx_destruct;	// IMP=0x0000000000186bf2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000186740
- (id)description;	// IMP=0x000000000018658a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001864c2
- (unsigned long long)hash;	// IMP=0x0000000000186478
- (id)initWithTXTRecordData:(id)arg1;	// IMP=0x00000000001860e1
