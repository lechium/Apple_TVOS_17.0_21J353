...
- (void).cxx_destruct;	// IMP=0x000000000018d471
...
- (void)_stop;	// IMP=0x000000000018d29c
- (void)_handleTimeout;	// IMP=0x000000000018d1ac
- (void)stop;	// IMP=0x000000000018d161
- (void)start;	// IMP=0x000000000018d116
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x000000000018cdfb
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x000000000018cd6e
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x000000000018cce1
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000018cc17
- (void)dealloc;	// IMP=0x000000000018cbd9
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000018ca6d
