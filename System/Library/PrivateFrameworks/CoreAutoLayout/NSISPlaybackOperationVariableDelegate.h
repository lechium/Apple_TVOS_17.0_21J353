...
- (void)_addToEngine:(id)arg1;	// IMP=0x000000000001a5ee
- (id)secondItem;	// IMP=0x000000000001a5e6
- (id)firstItem;	// IMP=0x000000000001a5de
- (id)description;	// IMP=0x000000000001a579
- (int)nsis_orientationHintForVariable:(id)arg1;	// IMP=0x000000000001a567
- (_Bool)nsis_valueOfVariableIsUserObservable:(id)arg1;	// IMP=0x000000000001a555
- (id)nsis_descriptionOfVariable:(id)arg1;	// IMP=0x000000000001a543
- (void)nsis_valueOfVariable:(id)arg1 didChangeInEngine:(id)arg2;	// IMP=0x000000000001a53d
- (void)dealloc;	// IMP=0x000000000001a4ec
