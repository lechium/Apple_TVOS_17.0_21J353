...
+ (id)observableForExpression:(id)arg1 inEngine:(id)arg2;	// IMP=0x0060000000005e1e
- (id)addObserver:(id)arg1;	// IMP=0x00000000000064d4
- (id)addObserverBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006494
- (_Bool)_overrideUseFastBlockObservers;	// IMP=0x000000000000648c
- (void)dealloc;	// IMP=0x0000000000005ec3
