...
- (id)makeChildRules;	// IMP=0x000000000000396f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000038e7
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003896
- (void)dealloc;	// IMP=0x000000000000384c
