...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000262d5
- (unsigned long long)hash;	// IMP=0x0000000000026251
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000026145
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002605b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000025fb8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000025f21
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000025f14
- (id)dictionaryRepresentation;	// IMP=0x0000000000025c7f
- (id)description;	// IMP=0x0000000000025bd0
