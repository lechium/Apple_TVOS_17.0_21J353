...
- (id)_listener;	// IMP=0x000000000001b0be
- (id)_browser;	// IMP=0x000000000001a428
- (id)_peerToPeerParameters;	// IMP=0x000000000001a25e
- (id)initWithParent:(id)arg1;	// IMP=0x000000000001a0cc
