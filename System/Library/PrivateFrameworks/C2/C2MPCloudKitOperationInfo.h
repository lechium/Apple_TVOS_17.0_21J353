...
- (void).cxx_destruct;	// IMP=0x00000000000079d4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000078ca
- (unsigned long long)hash;	// IMP=0x000000000000782c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007716
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000763b
- (void)copyTo:(id)arg1;	// IMP=0x000000000000759b
- (void)writeTo:(id)arg1;	// IMP=0x00000000000074ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000074e0
- (id)dictionaryRepresentation;	// IMP=0x00000000000070ee
- (id)description;	// IMP=0x000000000000703f
