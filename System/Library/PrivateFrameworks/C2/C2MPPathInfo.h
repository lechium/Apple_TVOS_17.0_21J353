...
- (void).cxx_destruct;	// IMP=0x0000000000008447
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000008339
- (unsigned long long)hash;	// IMP=0x000000000000829f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008196
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000080b9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008017
- (void)writeTo:(id)arg1;	// IMP=0x0000000000007f6a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000007f5d
- (id)dictionaryRepresentation;	// IMP=0x0000000000007b6e
- (id)description;	// IMP=0x0000000000007abf
