...
+ (Class)internalTestConfigType;	// IMP=0x00100000000363d6
- (void).cxx_destruct;	// IMP=0x0000000000037a91
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000376be
- (unsigned long long)hash;	// IMP=0x000000000003758b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003735f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037035
- (void)copyTo:(id)arg1;	// IMP=0x0000000000036e51
- (void)writeTo:(id)arg1;	// IMP=0x0000000000036c0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000036c00
- (id)dictionaryRepresentation;	// IMP=0x0000000000036496
- (id)description;	// IMP=0x00000000000363e7
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000363b9
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000003639c
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x0000000000036332
- (void)clearInternalTestConfigs;	// IMP=0x0000000000036315
