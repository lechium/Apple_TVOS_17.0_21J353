...
- (void).cxx_destruct;	// IMP=0x0000000000020d95
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000020c5b
- (unsigned long long)hash;	// IMP=0x0000000000020bc6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000020ab2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000209c9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000020925
- (void)writeTo:(id)arg1;	// IMP=0x0000000000020885
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000020878
- (id)dictionaryRepresentation;	// IMP=0x00000000000204a4
- (id)description;	// IMP=0x00000000000203f5
