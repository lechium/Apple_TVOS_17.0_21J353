...
+ (Class)networkPathInfoType;	// IMP=0x0010000000008d2e
- (void).cxx_destruct;	// IMP=0x000000000000ed05
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000e0c3
- (unsigned long long)hash;	// IMP=0x000000000000d96e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000cfed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c7b5
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c16b
- (void)writeTo:(id)arg1;	// IMP=0x000000000000ba69
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000ba5c
- (id)dictionaryRepresentation;	// IMP=0x00000000000094c5
- (id)description;	// IMP=0x0000000000009416
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000008d11
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000008cf4
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x0000000000008c8a
- (void)clearNetworkPathInfos;	// IMP=0x0000000000008c6d
