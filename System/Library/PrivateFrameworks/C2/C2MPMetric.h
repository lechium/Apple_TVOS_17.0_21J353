...
- (void).cxx_destruct;	// IMP=0x0000000000032dd3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000032a58
- (unsigned long long)hash;	// IMP=0x00000000000328a5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000325e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000323af
- (void)copyTo:(id)arg1;	// IMP=0x00000000000321f8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000032039
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003202c
- (id)dictionaryRepresentation;	// IMP=0x00000000000314f4
- (id)description;	// IMP=0x0000000000031445
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00000000000311a2
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000000031136
