...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000c27a5
+ (Class)__class;	// IMP=0x00600000000c2755
- (void).cxx_destruct;	// IMP=0x00000000000c2812
