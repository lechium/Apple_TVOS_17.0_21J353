...
- (void)hf_updateWithDiscoveredAccessory:(id)arg1;	// IMP=0x00300000000e301c
...
- (_Bool)hf_isLogitechCircleViewDoorbell;	// IMP=0x00300000000e2be9
- (id)hf_home;	// IMP=0x00300000000e2a8f
@end
