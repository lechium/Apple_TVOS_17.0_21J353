...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x0010000000151e0d
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x0010000000152523
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x001000000015213f
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x0010000000151bc0
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00100000002392d3
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x001000000023919c
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x001000000023914c
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x00100000002390c8
- (id)_hf_doorbellBulletinNotification;	// IMP=0x0010000000239044
