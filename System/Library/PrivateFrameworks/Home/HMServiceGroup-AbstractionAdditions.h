...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00200000000697f5
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00200000000697c2
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0020000000069766
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000069680
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x00200000000694ef
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00200000000692bc
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000000af8b3
...
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001ca5f5
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001ca552
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001ca4bc
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001ca41e
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001ca380
- (_Bool)hf_isValidObject;	// IMP=0x002000000020ade3
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x0020000000238f5b
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)_hf_allBulletinBoardNotifications;	// IMP=0x0020000000238e86
- (void)hf_postUpdateApplicationDataNotification:(id)arg1 needCellReload:(_Bool)arg2;	// IMP=0x0020000000254578
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x002000000025455b
- (void)hf_updateApplicationData:(id)arg1 needCellReload:(_Bool)arg2 handleError:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0020000000254262
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000031b6c0
