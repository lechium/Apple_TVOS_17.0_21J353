...
- (void).cxx_destruct;	// IMP=0x000000000021d302
...
- (id)controlPanelItemForControlItems:(id)arg1;	// IMP=0x000000000021d1bc
- (id)initWithFilter:(CDUnknownBlockType)arg1 displayResultsGenerator:(CDUnknownBlockType)arg2;	// IMP=0x000000000021d103
