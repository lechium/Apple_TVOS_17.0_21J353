...
- (_Bool)hf_fake8021xNetworkSymptom;	// IMP=0x002000000008e381
...
- (id)hf_roleForAccessory:(id)arg1;	// IMP=0x002000000017325b
- (id)hf_accessoryForRole:(id)arg1;	// IMP=0x0020000000173054
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001cb6bc
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001cb5f6
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001cb560
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001cb4c2
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001cb424
- (_Bool)hf_isValidObject;	// IMP=0x002000000020b19f
- (id)hf_identify;	// IMP=0x00200000002426d3
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x0020000000242665
- (id)hf_preferredMediaUser;	// IMP=0x00200000002425d0
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x0020000000242418
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x002000000024240b
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0020000000242340
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x0020000000242206
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0020000000241fe3
...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x0020000000241d0b
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0020000000241b98
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0020000000241b3c
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000241a56
...
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x00200000002419af
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x00200000002418b4
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x00200000002417b9
- (id)hf_siriLanguageOptionsManager;	// IMP=0x002000000024153b
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x002000000024139f
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x00200000002412fe
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x00200000002412f6
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x002000000024121e
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x002000000024112f
