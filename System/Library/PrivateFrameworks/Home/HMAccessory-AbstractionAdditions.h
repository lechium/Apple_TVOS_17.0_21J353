...
+ (_Bool)hf_isSuspendedStateSupported:(unsigned long long)arg1;	// IMP=0x0010000000184d06
+ (_Bool)hf_isSuspendedStateSuspended:(unsigned long long)arg1;	// IMP=0x0010000000184c56
+ (id)hf_userFriendlyLocalizedLowercaseDescription:(id)arg1;	// IMP=0x001000000018474d
+ (id)hf_userFriendlyLocalizedCapitalizedDescription:(id)arg1;	// IMP=0x00100000001845f5
+ (id)hf_getUserFriendlyDescriptionKey:(id)arg1;	// IMP=0x00100000001840b1
+ (CDUnknownBlockType)hf_softwareUpdateComparator;	// IMP=0x00100000002298bf
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00100000000686e6
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00100000000686b3
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0010000000068657
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0010000000068569
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x00100000000683e8
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00100000000682e0
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00100000000aeeb3
@property(readonly, nonatomic) NSSet *hf_fakeDebugSymptoms;
- (void)_pushSymptomUpdate;	// IMP=0x00100000000d5011
...
- (_Bool)hf_shouldDisplayManualFixOptionForSymptom:(long long)arg1;	// IMP=0x00100000000d4363
- (_Bool)hf_shouldShowSoftwareUpdateInfo;	// IMP=0x00100000000d432a
- (id)hf_identifyHomePod;	// IMP=0x00100000000d42bb
...
- (_Bool)hf_supportsMultiUserLanguage:(id)arg1;	// IMP=0x00100000000d3fc3
...
- (_Bool)hf_isCategorizedAsMediaAccessory;	// IMP=0x00100000000d3c6e
...
- (_Bool)hf_shouldHideNearbyAccessoryService:(id)arg1;	// IMP=0x00100000001850e7
- (id)hf_errorForCurrentSessionState;	// IMP=0x0010000000184f08
- (_Bool)hf_needsOnboarding;	// IMP=0x0010000000184ec4
- (id)hf_siriEndpointProfile;	// IMP=0x0010000000184db6
...
- (id)_hf_categoryType;	// IMP=0x0010000000184971
...
- (id)hf_serviceOfType:(id)arg1;	// IMP=0x00100000001835a4
...
- (id)hf_primaryService;	// IMP=0x0010000000182cb7
...
- (id)hf_setShowAsIndividualServices:(_Bool)arg1;	// IMP=0x0010000000182591
...
- (_Bool)_areAllSensorServices;	// IMP=0x00100000001c9b60
- (_Bool)hf_anyNonSensorServiceIsOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c9a87
- (id)hf_updateValueForCurrentObjectOnly:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001c957a
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001c9179
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c8e78
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c8c4c
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c89b8
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001c87bc
- (_Bool)hf_isValidObject;	// IMP=0x001000000020ac8a
@property(readonly, nonatomic) __weak HMRoom *hf_parentRoom;
- (id)hf_softwareUpdateDependentClasses;	// IMP=0x001000000022a443
- (id)hf_softwareUpdateDependentObjects;	// IMP=0x001000000022a382
- (id)hf_softwareUpdateHash;	// IMP=0x001000000022a2a9
- (id)hf_startSoftwareUpdate;	// IMP=0x001000000022a222
- (id)hf_fetchAvailableSoftwareUpdateWithOptions:(unsigned long long)arg1;	// IMP=0x001000000022a18c
- (id)hf_softwareUpdatePortionComplete;	// IMP=0x001000000022a105
- (unsigned long long)hf_softwareUpdateDownloadSize;	// IMP=0x001000000022a08a
- (id)hf_softwareUpdateReleaseDate;	// IMP=0x001000000022a003
- (id)hf_softwareUpdateVersion;	// IMP=0x0010000000229f7c
- (id)hf_softwareUpdateDocumentation;	// IMP=0x0010000000229ef5
- (_Bool)hf_softwareUpdatePossessesNecessaryDocumentation;	// IMP=0x0010000000229e7c
- (_Bool)hf_isSoftwareUpdateInstalled;	// IMP=0x0010000000229e03
- (_Bool)hf_isSoftwareUpdateInProgress;	// IMP=0x0010000000229d8a
- (_Bool)hf_isInstallingSoftwareUpdate;	// IMP=0x0010000000229d11
- (_Bool)hf_isDownloadingSoftwareUpdate;	// IMP=0x0010000000229c98
- (_Bool)hf_isReadyToInstallSoftwareUpdate;	// IMP=0x0010000000229c1f
- (_Bool)hf_hasRequestedSoftwareUpdate;	// IMP=0x0010000000229ba6
- (_Bool)hf_hasNewValidSoftwareUpdate;	// IMP=0x0010000000229b2d
- (_Bool)hf_hasValidSoftwareUpdate;	// IMP=0x0010000000229ab4
- (_Bool)hf_hasSoftwareUpdate;	// IMP=0x0010000000229a3b
- (_Bool)hf_hasNewValidSoftwareOrFirmwareUpdate;	// IMP=0x0010000000229a02
- (_Bool)hf_hasValidSoftwareOrFirmwareUpdate;	// IMP=0x00100000002299c9
- (_Bool)hf_supportsSoftwareUpdate;	// IMP=0x0010000000229996
- (id)_hf_audioAnalysisEventBulletinBoardNotification;	// IMP=0x001000000023958d
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00100000002394a4
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x00100000002393bc
- (void)hf_postUpdateApplicationDataNotification:(id)arg1 needCellReload:(_Bool)arg2;	// IMP=0x0010000000252dfe
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000252de1
- (void)hf_updateApplicationData:(id)arg1 needCellReload:(_Bool)arg2 handleError:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000252b2f
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x001000000031b7fb
