...
+ (id)_profilesWithNonStandardTileUI;	// IMP=0x00100000000757b0
- (id)hf_setTileSize:(id)arg1;	// IMP=0x0010000000069ee8
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0010000000069e6e
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x0010000000069e12
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0010000000069cb7
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x0010000000069be6
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0010000000069a30
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00100000000b1355
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001caac4
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00100000001ca9e8
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001ca952
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00100000001ca901
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001ca8b0
- (_Bool)hf_isValidObject;	// IMP=0x001000000020b44a
