...
- (id).cxx_construct;	// IMP=0x0000000000730002
- (void).cxx_destruct;	// IMP=0x000000000072ffa8
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x000000000072f6cf
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x000000000072f547
- (void)initializeJunctionInfos;	// IMP=0x000000000072f22e
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x000000000072f066
- (void)_findTileEdgeJunctions;	// IMP=0x000000000072ef36
- (void)addJunction:(id)arg1;	// IMP=0x000000000072eea2
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x000000000072ed08
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x000000000072ecf2
- (id)initWithTile:(const void *)arg1;	// IMP=0x000000000072ebf8
