...
- (id).cxx_construct;	// IMP=0x00000000003568c4
- (void).cxx_destruct;	// IMP=0x0000000000356859
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x0000000000356811
- (void)stopObserving:(id)arg1;	// IMP=0x0000000000356733
- (void)startObserving:(id)arg1;	// IMP=0x0000000000356528
- (void)dealloc;	// IMP=0x0000000000356465
- (id)initWithRouteContextChangeObserver:(struct RouteContextChangeObserver *)arg1;	// IMP=0x0000000000356428
