...
- (id).cxx_construct;	// IMP=0x000000000051a6a5
- (void).cxx_destruct;	// IMP=0x000000000051a69f
...
- (id)description;	// IMP=0x000000000051a590
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051a41f
...
- (id)initWithOrientedRect:(const void *)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000519c7e
- (id)initWithYaw:(float)arg1 pitch:(float)arg2 roll:(float)arg3 x:(double)arg4 y:(double)arg5 z:(double)arg6 w:(float)arg7 h:(float)arg8 undulationProvider:(CDUnknownBlockType)arg9;	// IMP=0x00000000005199ed
- (id)initWithGEOOrientedBox:(id)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000519766
- (id)initWithOrientedRect:(const void *)arg1;	// IMP=0x0000000000519752
