...
- (id).cxx_construct;	// IMP=0x000000000050dd9e
- (void).cxx_destruct;	// IMP=0x000000000050dc1f
...
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x000000000050dacd
- (void)didDrawView;	// IMP=0x000000000050dac3
- (void)willDrawView;	// IMP=0x000000000050da67
...
- (_Bool)hasRenderTarget;	// IMP=0x000000000050d203
- (void)destroyRenderTarget;	// IMP=0x000000000050d087
- (void)createRenderTarget;	// IMP=0x000000000050c4d2
- (struct __IOSurface *)flipImage;	// IMP=0x000000000050c318
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x000000000050c140
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x000000000050c0d6
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 services:(void *)arg7 signpostId:(unsigned long long)arg8;	// IMP=0x000000000050ba9d
- (void *)_internalRenderTarget;	// IMP=0x000000000050ba93
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void)willDealloc;	// IMP=0x000000000050b6e9
- (void *)finalSurface;	// IMP=0x000000000050b6df
