...
- (id).cxx_construct;	// IMP=0x00000000005da38d
- (void).cxx_destruct;	// IMP=0x00000000005da365
...
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x00000000005da278
