...
- (id).cxx_construct;	// IMP=0x00000000006e19b1
- (void).cxx_destruct;	// IMP=0x00000000006e1989
...
- (id)detailedDescription;	// IMP=0x00000000006e17a0
...
- (void)projectFromLocation:(id)arg1 routeMatch:(id)arg2 speedMultiplier:(double)arg3 routeLine:(id)arg4;	// IMP=0x00000000006e0f78
- (void)_updateCourseAndPositionFromRouteMatch:(id)arg1;	// IMP=0x00000000006e0cec
- (void)reset;	// IMP=0x00000000006e0c90
- (void)dealloc;	// IMP=0x00000000006e0c1d
- (id)init;	// IMP=0x00000000006e0ba1
