...
- (void).cxx_destruct;	// IMP=0x00000000007a3cd0
...
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x00000000007a348e
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x00000000007a1d8c
- (Matrix_443f5d51)_centerCursor;	// IMP=0x00000000007a1bd7
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1;	// IMP=0x00000000007a1b8c
- (struct VKEdgeInsets)_effectiveEdgeInsets;	// IMP=0x00000000007a1aa7
- (Matrix_443f5d51)_nonOffsetCenterCursor;	// IMP=0x00000000007a1951
- (void)dealloc;	// IMP=0x00000000007a18e5
- (id)init;	// IMP=0x00000000007a189e
