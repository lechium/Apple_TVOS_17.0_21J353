...
- (id).cxx_construct;	// IMP=0x00000000006eb605
- (void).cxx_destruct;	// IMP=0x00000000006eb5e1
@property(nonatomic) __weak id <VKMercatorTerrainHeightProvider> heightProvider; // @synthesize heightProvider=_heightProvider;
- (void)invalidateRect:(const void *)arg1;	// IMP=0x00000000006eb4ec
- (void)removeCachedValueForAnchor:(void *)arg1;	// IMP=0x00000000006eb48f
- (double)heightForAnchor:(void *)arg1;	// IMP=0x00000000006eb33a
