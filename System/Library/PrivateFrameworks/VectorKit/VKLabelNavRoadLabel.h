...
- (id).cxx_construct;	// IMP=0x0000000000728067
- (void).cxx_destruct;	// IMP=0x0000000000728038
...
- (id)description;	// IMP=0x0000000000727efb
- (id)displayGroup;	// IMP=0x0000000000727d49
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000727d38
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000727d06
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x0000000000727bc5
