...
- (id).cxx_construct;	// IMP=0x00000000006d6602
- (void).cxx_destruct;	// IMP=0x00000000006d65a8
...
- (void)createLabelWithNavContext:(struct NavContext *)arg1 isDrivingSideRight:(_Bool)arg2 artworkCache:(void *)arg3;	// IMP=0x00000000006d5e93
- (void)prepareStyleVarsWithContext:(struct NavContext *)arg1;	// IMP=0x00000000006d5c26
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible=_isVisible;
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006d5bbf
- (void)_updateWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006d5baa
- (void)_updateWithNavContext:(struct NavContext *)arg1 threshold:(double)arg2;	// IMP=0x00000000006d5b20
- (Mercator3_d8bb135c)_anchorCoordinateForSignOrientation:(unsigned char)arg1;	// IMP=0x00000000006d5965
- (unsigned char)_signOrientationWithDrivingSide:(_Bool)arg1;	// IMP=0x00000000006d55ec
...
- (void)evaluateCrossStreetsUsingRouteJunction:(id)arg1;	// IMP=0x00000000006d4903
- (void)evaluateCrossStreets;	// IMP=0x00000000006d48ee
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge *)arg1 atA:(_Bool)arg2;	// IMP=0x00000000006d4698
- (void)findRoads;	// IMP=0x00000000006d4100
...
- (_Bool)matchesLocationForJunction:(id)arg1;	// IMP=0x00000000006d3a40
- (id)description;	// IMP=0x00000000006d3998
- (void)dealloc;	// IMP=0x00000000006d391f
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge *)arg1 atA:(_Bool)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const void *)arg4;	// IMP=0x00000000006d36d9
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction *)arg1 routeOffset:(struct PolylineCoordinate)arg2 tile:(const void *)arg3;	// IMP=0x00000000006d3490
