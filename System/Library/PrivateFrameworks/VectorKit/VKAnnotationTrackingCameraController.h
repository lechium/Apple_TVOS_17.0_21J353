...
- (id).cxx_construct;	// IMP=0x00000000002fe140
- (void).cxx_destruct;	// IMP=0x00000000002fe0ed
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000002fde05
- (void)resumeAnimation;	// IMP=0x00000000002fdd0a
- (void)pauseAnimation;	// IMP=0x00000000002fdca9
- (_Bool)isAnimating;	// IMP=0x00000000002fdc41
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x00000000002fdbab
- (void)stopTrackingAnnotation;	// IMP=0x00000000002fda43
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x00000000002fd6a0
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x00000000002fd69a
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x00000000002fd694
- (void)updateFramerate;	// IMP=0x00000000002fd592
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x00000000002fd43a
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x00000000002fd3dd
