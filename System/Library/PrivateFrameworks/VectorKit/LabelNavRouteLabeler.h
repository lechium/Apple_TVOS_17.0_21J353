...
@interface LabelNavRouteLabeler : NSObject
{
    ...
    _Bool _isCurrentRoadSignVisible;	// 464 = 0x1d0
    _Bool _debugDisableRoadSignLimit;	// 465 = 0x1d1
    ...
    struct range_map<geo::Unit<geo::RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<geo::RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<geo::RadianUnitDescription, float>>, md::OrientationAction>>> _leftTurnOrientations;	// 560 = 0x230
    struct range_map<geo::Unit<geo::RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<geo::RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<geo::RadianUnitDescription, float>>, md::OrientationAction>>> _rightTurnOrientations;	// 584 = 0x248
}

- (id).cxx_construct;	// IMP=0x00000000005da14d
- (void).cxx_destruct;	// IMP=0x00000000005d9fcb
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x00000000005d9ecf
- (_Bool)_updateActiveRouteRange;	// IMP=0x00000000005d907f
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x00000000005d8ef1
- (void)_updateCurrentRoadInfo;	// IMP=0x00000000005d8bc1
- (void)_initalizeCurrentRoadInfo;	// IMP=0x00000000005d8ba4
- (void)_dedupOffRouteRoads;	// IMP=0x00000000005d831d
- (void)_updatePreferredLabelPlacements;	// IMP=0x00000000005d8001
- (void)_updateRoadsInGuidance;	// IMP=0x00000000005d7a9f
- (void)_updateRoadStarts;	// IMP=0x00000000005d75fd
- (void)_updateUniqueOffRouteRoads;	// IMP=0x00000000005d7073
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x00000000005d600a
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x00000000005d51fa
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x00000000005d4c04
- (void)_addVisibleSigns;	// IMP=0x00000000005d4b40
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x00000000005d1f5a
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000005d1de0
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x00000000005d1c94
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000005d1bfc
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x00000000005d10fc
- (void)styleManagerDidFinishAnimating;	// IMP=0x00000000005d10ef
- (void)styleManagerDidStartAnimating;	// IMP=0x00000000005d10e0
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x00000000005d10c9
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x00000000005d088d
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x00000000005cf5b9
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x00000000005cf129
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x00000000005cefb4
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x00000000005cee3a
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x00000000005ceb39
- (void)_refreshGuidanceRoadNames;	// IMP=0x00000000005ce8ae
- (void)_reloadRouteJunctions;	// IMP=0x00000000005ce5dc
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x00000000005ce4e6
- (_Bool)isNavMode;	// IMP=0x00000000005ce4ce
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x00000000005ce34b
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x00000000005ce17f
- (id)init;	// IMP=0x00000000005cdc24
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000004b8247
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000004b742d
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000004b72bd
- (_Bool)needsDebugDraw;	// IMP=0x00000000004b71b8
