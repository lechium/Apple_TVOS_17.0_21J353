...
- (id).cxx_construct;	// IMP=0x000000000066d74d
- (void).cxx_destruct;	// IMP=0x000000000066d6d3
- (void)purgeExpired:(double)arg1;	// IMP=0x000000000066d64e
- (void)reportCorruptTile:(const struct _GEOTileKey *)arg1;	// IMP=0x000000000066d638
- (void)cancelRequests;	// IMP=0x000000000066d58d
- (void)updateJobPriority:(void *)arg1;	// IMP=0x000000000066d4d6
- (void)cancelJob:(void *)arg1;	// IMP=0x000000000066d416
- (void)fetchDataForJob:(void *)arg1;	// IMP=0x000000000066cb3a
- (shared_ptr_97fa0047)getJobForKey:(const struct _GEOTileKey *)arg1;	// IMP=0x000000000066cac1
- (id)initWithToken:(id)arg1;	// IMP=0x000000000066c90a
