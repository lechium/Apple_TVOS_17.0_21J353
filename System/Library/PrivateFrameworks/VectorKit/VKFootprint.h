...
- (id).cxx_construct;	// IMP=0x000000000008d696
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000008d43d
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x000000000008d284
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x000000000008d1e4
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x000000000008d0c0
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x000000000008ce89
- (void)computeFromCamera:(id)arg1;	// IMP=0x000000000008c7cd
