...
- (id).cxx_construct;	// IMP=0x0000000000088f1a
- (void).cxx_destruct;	// IMP=0x0000000000088ec4
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x0000000000088bad
- (CameraFrame_b765d6d7)cameraFrame:(_Bool)arg1;	// IMP=0x0000000000088a14
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x000000000008896a
...
- (void)adjustClipPlanes;	// IMP=0x0000000000088797
- (float)zoomAtCentrePoint;	// IMP=0x000000000008877a
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000000886cc
- (double)depthForViewWidth:(double)arg1;	// IMP=0x000000000008869b
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x0000000000088672
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x00000000000885ba
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x00000000000883d7
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x00000000000883b5
- (void)updateIfNeeded;	// IMP=0x0000000000087950
- (void)setNeedsUpdate;	// IMP=0x0000000000087921
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x000000000008790b
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000878f5
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x00000000000877ab
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x00000000000874e9
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x0000000000086efe
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x0000000000086d9a
- (void)_setPosition:(const void *)arg1;	// IMP=0x0000000000086d6f
- (id)descriptionDictionaryRepresentation;	// IMP=0x0000000000086a4c
- (id)description;	// IMP=0x000000000008686c
- (id)detailedDescription;	// IMP=0x000000000008685a
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x00000000000866e2
