...
@interface VKRouteLine : NSObject
{
    ...
    NSMutableArray *_pendingMatchedSegments;	// 408 = 0x198
    struct mutex _matchedSegmentsLock;	// 416 = 0x1a0
}

- (id).cxx_construct;	// IMP=0x000000000055fedf
- (void).cxx_destruct;	// IMP=0x000000000055fdf4
...
- (double)boundsUnitsPerMeter;	// IMP=0x000000000055fc66
- (Matrix_08d701e4)maneuverTransform;	// IMP=0x000000000055fbd4
- (Matrix_08d701e4)inverseManeuverTransform;	// IMP=0x000000000055fb80
- (vector_9022e479)maneuverPoints;	// IMP=0x000000000055f872
- (void)_updateBounds:(id)arg1 boundsInflation:(float)arg2;	// IMP=0x000000000055eebc
- (void)forEachSection:(CDUnknownBlockType)arg1;	// IMP=0x000000000055edf7
- (void)splitRouteLineAtAnnotation:(id)arg1;	// IMP=0x000000000055e595
- (optional_db527fce)snapRouteMatch:(id)arg1;	// IMP=0x000000000055d9a9
- (_Bool)needsUpdateForViewingScale:(double)arg1;	// IMP=0x000000000055d886
- (_Bool)isTrafficUptoDate:(double)arg1;	// IMP=0x000000000055d857
- (_Bool)isTrafficUpToDate;	// IMP=0x000000000055d820
- (void)createMeshIfNecessary:(long long)arg1;	// IMP=0x000000000055d748
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2;	// IMP=0x000000000055d0f3
- (_Bool)buildRouteLine:(id)arg1 matchToRoads:(_Bool)arg2 shouldGenerateSnapPath:(_Bool)arg3 viewUnitsPerPoint:(double)arg4 force:(_Bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(_Bool)arg7 currentLegIndex:(unsigned int)arg8;	// IMP=0x000000000055a8c6
- (void)_updateTilesCovered:(id)arg1;	// IMP=0x000000000055a6a2
@property(readonly, nonatomic) NSArray *matchedSegments; // @synthesize matchedSegments=_matchedSegments;
- (void)_clearMatchedSegments;	// IMP=0x000000000055a5ae
- (void)_addMatchedSegments:(id)arg1;	// IMP=0x000000000055a533
@property(readonly, nonatomic) GEOComposedRoute *composedRoute;
- (void)dealloc;	// IMP=0x000000000055a467
- (id)initWithPolylineOverlay:(id)arg1;	// IMP=0x000000000055a310
