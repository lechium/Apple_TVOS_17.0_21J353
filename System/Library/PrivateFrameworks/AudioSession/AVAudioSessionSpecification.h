...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001eda6
- (void).cxx_destruct;	// IMP=0x000000000001f05d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001ee9b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001edae
