...
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000036508
- (_Bool)matchesProcess:(id)arg1;	// IMP=0x0000000000036488
@property(readonly, nonatomic) NSSet *processIdentifiers;
- (id)initWithIdentifiers:(id)arg1;	// IMP=0x00000000000363a0
