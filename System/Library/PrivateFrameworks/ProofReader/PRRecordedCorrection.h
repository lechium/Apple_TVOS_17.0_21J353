...
- (id)correctedString;	// IMP=0x000000000002de96
- (id)correctionResult;	// IMP=0x000000000002de8c
- (id)description;	// IMP=0x000000000002de25
- (void)dealloc;	// IMP=0x000000000002dddb
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002dd5c
