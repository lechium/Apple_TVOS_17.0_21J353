...
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000000aa808
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000aa7f2
- (void)dealloc;	// IMP=0x00000000000aa707
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000aa47b
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000000000aa46a
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000aa3a9
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x00000000000aa349
- (id)originalObject;	// IMP=0x00000000000aa33b
- (_Bool)serializeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000aa189
@property(readonly) id <MTLDynamicLibrary> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x00000000000aa09d
