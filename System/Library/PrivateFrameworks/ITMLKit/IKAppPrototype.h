...
- (void).cxx_destruct;	// IMP=0x00000000000e1737
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e0dfa
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e0cb4
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0c9e
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0c46
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e0a67
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x0000000000002b87
- (id)dsepm_viewElement;	// IMP=0x0000000000002b76
