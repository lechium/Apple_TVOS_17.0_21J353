...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024fb5
- (void).cxx_destruct;	// IMP=0x0000000000025252
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x00000000000250e4
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024fda
