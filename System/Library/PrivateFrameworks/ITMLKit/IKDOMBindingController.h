...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x0010000000093aec
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x0010000000093635
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x00100000000924d2
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0010000000090ca9
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0010000000090bee
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x00100000000903ba
- (void).cxx_destruct;	// IMP=0x0000000000095b02
...
- (void)_evaluateMutationRules;	// IMP=0x000000000009581b
- (void)_resolveBinding;	// IMP=0x000000000009451d
- (_Bool)_canBeReused;	// IMP=0x000000000009429b
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x0000000000092ce1
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x00000000000928e2
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x0000000000091dcb
- (void)dealloc;	// IMP=0x0000000000091d1a
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000090cbe
