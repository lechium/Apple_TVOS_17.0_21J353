...
- (void).cxx_destruct;	// IMP=0x00000000000e0a34
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e0784
- (unsigned long long)hash;	// IMP=0x00000000000e0740
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e0735
- (id)initWithIdentifier:(id)arg1 selector:(id)arg2 groupingValues:(id)arg3;	// IMP=0x00000000000e0649
