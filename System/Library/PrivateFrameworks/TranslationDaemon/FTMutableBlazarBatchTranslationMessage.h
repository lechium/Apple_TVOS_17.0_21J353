...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a1230
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a10d5
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a109b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a0773
- (id)init;	// IMP=0x00000000000a06e5
