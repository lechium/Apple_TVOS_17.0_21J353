...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a00b3
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009fd43
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009fd09
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e6ee
- (id)init;	// IMP=0x000000000009e660
