...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a22b0
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a21d6
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a219c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a1b71
- (id)init;	// IMP=0x00000000000a1ae3
