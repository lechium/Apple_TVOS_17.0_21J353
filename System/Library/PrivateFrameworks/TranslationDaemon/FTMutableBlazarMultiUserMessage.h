...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009c8ad
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009c566
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009c52c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009b010
- (id)init;	// IMP=0x000000000009af82
