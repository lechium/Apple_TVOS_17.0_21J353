...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018ff08
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018fc8e
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018fc54
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018ec33
- (id)init;	// IMP=0x000000000018eba5
