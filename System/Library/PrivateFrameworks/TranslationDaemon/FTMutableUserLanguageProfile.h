...
- (void)profile_blob:(CDUnknownBlockType)arg1;	// IMP=0x0000000000145163
@property(copy, nonatomic) NSData *profile_blob;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014504c
- (id)init;	// IMP=0x0000000000144fbe
