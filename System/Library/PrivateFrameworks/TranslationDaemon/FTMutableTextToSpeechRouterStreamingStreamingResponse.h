...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000198187
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x00600000001980d3
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000198099
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000197b6d
- (id)init;	// IMP=0x0000000000197adf
