...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000019613c
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000195f14
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000195eda
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001950b7
- (id)init;	// IMP=0x0000000000195029
