...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017f0f7
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017f0bd
- (void).cxx_destruct;	// IMP=0x000000000017f6d1
- (id)flatbuffData;	// IMP=0x000000000017f554
- (Offset_f0c4c3ad)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017f229
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017eab0
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultilingualStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017e8cd
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultilingualStreamingResponse *)arg2;	// IMP=0x000000000017e8b8
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017e89e
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017e887
