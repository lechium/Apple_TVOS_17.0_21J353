...
@class FTTTSRequestFeatureFlags, FTTextToSpeechRequestContext, FTTextToSpeechRequestDebug, FTTextToSpeechRequestDevConfig, FTTextToSpeechRequestExperiment, FTTextToSpeechRequestMeta, FTTextToSpeechRequestProsodyControlConfig, FTTextToSpeechRequestProsodyTransferConfig, FTTextToSpeechUserProfile, NSArray, NSString;
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001639cf
- (id)init;	// IMP=0x0000000000163941
