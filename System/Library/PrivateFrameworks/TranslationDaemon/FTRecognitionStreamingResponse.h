...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017a4bf
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017a485
- (void).cxx_destruct;	// IMP=0x000000000017af69
- (id)flatbuffData;	// IMP=0x000000000017adec
- (Offset_48f69b49)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017a739
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000179720
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017953d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2;	// IMP=0x0000000000179528
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017950e
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001794f7
