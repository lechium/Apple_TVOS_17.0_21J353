...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009e1f6
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009df7c
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009df42
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009cf21
- (id)init;	// IMP=0x000000000009ce93
