...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000192303
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000019215d
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000192123
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001915fd
- (id)init;	// IMP=0x000000000019156f
