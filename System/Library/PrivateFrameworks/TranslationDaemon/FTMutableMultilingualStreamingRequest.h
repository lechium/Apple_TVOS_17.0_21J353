...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000193257
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x00600000001930d9
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019309f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000192678
- (id)init;	// IMP=0x00000000001925ea
