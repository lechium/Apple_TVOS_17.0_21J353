...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a697c
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a68a2
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a6868
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a623d
- (id)init;	// IMP=0x00000000000a61af
