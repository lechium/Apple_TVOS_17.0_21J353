...
+ (long long)container_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000085a99
+ (Class)container_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000085a5f
- (void).cxx_destruct;	// IMP=0x0000000000086d48
- (id)flatbuffData;	// IMP=0x0000000000086bcb
- (Offset_eabeea59)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000085eff
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084050
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000083e6d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2;	// IMP=0x0000000000083e58
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000083e3e
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000083e27
