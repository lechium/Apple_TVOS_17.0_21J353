...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017bbad
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017bb73
- (void).cxx_destruct;	// IMP=0x000000000017c3ef
- (id)flatbuffData;	// IMP=0x000000000017c272
- (Offset_2c19e347)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017bd83
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017b1ba
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017afd7
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingRequest *)arg2;	// IMP=0x000000000017afc2
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017afa8
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017af91
