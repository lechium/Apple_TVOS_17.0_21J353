...
- (void).cxx_destruct;	// IMP=0x000000000004c450
...
- (void)callCompletionHandlersWithError:(id)arg1;	// IMP=0x000000000004beda
- (void)streamFailVerifyBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x000000000004bdf8
- (void)streamDidReceiveBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x000000000004b131
