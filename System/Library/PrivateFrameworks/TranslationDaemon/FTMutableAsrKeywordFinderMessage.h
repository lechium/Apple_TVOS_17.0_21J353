...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009a1f5
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009a166
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009a126
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000099cf9
- (id)init;	// IMP=0x0000000000099c6b
