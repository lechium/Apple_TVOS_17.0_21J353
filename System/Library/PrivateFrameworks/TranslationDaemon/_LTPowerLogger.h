...
+ (id)sharedInstance;	// IMP=0x00600000000565b9
- (void).cxx_destruct;	// IMP=0x0000000000056652
...
- (void)logTranslateRequestEvent:(id)arg1 requestType:(id)arg2 routeType:(long long)arg3;	// IMP=0x000000000005660e
- (id)init;	// IMP=0x00000000000564c8
