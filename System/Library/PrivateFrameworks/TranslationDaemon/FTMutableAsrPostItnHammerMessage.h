...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x0060000000099b98
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x0060000000099b09
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x0060000000099ac9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009969c
- (id)init;	// IMP=0x000000000009960e
