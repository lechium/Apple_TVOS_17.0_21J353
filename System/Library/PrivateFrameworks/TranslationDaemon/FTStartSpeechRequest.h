...
- (void).cxx_destruct;	// IMP=0x00000000000bd151
- (id)flatbuffData;	// IMP=0x00000000000bcfd4
- (Offset_b7f57b05)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000bc0aa
@property(readonly, nonatomic) unsigned int initial_result_candidate_id;
- (void)multi_user_parameters_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bbece
- (unsigned long long)multi_user_parameters_count;	// IMP=0x00000000000bbe32
- (id)multi_user_parameters_objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000bbd39
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bb1ae
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000bb003
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2;	// IMP=0x00000000000bafee
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bafd4
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000bafbd
