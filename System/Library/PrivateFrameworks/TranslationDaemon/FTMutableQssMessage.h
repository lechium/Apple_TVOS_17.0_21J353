...
+ (long long)container_message_typeForObject:(id)arg1;	// IMP=0x00600000000a8d53
+ (long long)container_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a88ed
+ (Class)container_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a88b3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a6b76
- (id)init;	// IMP=0x00000000000a6ae8
