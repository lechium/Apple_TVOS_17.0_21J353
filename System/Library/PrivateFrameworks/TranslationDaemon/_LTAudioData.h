...
- (void)writeToURL:(id)arg1;	// IMP=0x0000000000005076
- (_Bool)_populateWithOpusData:(id)arg1;	// IMP=0x0000000000004e3a
- (id)initWithASBD:(struct AudioStreamBasicDescription)arg1 rawData:(id)arg2 wordTimingInfo:(id)arg3;	// IMP=0x0000000000004d1c
