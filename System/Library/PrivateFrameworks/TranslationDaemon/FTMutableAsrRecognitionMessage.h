...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x0060000000097b49
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009770c
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000976d2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000095bbc
- (id)init;	// IMP=0x0000000000095b2e
