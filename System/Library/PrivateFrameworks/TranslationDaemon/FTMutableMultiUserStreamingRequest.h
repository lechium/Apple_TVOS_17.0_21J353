...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000191235
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000019105f
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000191025
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000190400
- (id)init;	// IMP=0x0000000000190372
