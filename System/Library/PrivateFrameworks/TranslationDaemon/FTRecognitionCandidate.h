...
- (void).cxx_destruct;	// IMP=0x00000000000ee647
- (id)flatbuffData;	// IMP=0x00000000000ee4ca
- (Offset_adec5a97)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000edfac
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ed912
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000ed767
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2;	// IMP=0x00000000000ed752
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000ed738
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000ed721
