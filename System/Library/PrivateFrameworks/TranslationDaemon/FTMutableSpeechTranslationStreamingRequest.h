...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000194d8d
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000194c0f
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000194bd5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001941ae
- (id)init;	// IMP=0x0000000000194120
