...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018e81f
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018e620
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018e5e6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018d8c2
- (id)init;	// IMP=0x000000000018d834
