...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001974ef
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000019743b
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000197401
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000196ed5
- (id)init;	// IMP=0x0000000000196e47
