...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000196cdb
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000196c01
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000196bc7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019659c
- (id)init;	// IMP=0x000000000019650e
