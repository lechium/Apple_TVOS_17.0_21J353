...
- (void).cxx_destruct;	// IMP=0x000000000005c44b
...
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x000000000005c40e
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x000000000005c02c
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResultPackage:(id)arg2;	// IMP=0x000000000005be9f
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x000000000005bb5b
- (void)_recognizedResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000005ba78
- (void)triggerServerSideEndPointer;	// IMP=0x000000000005b9be
- (void)cancelRecognition;	// IMP=0x000000000005b8e1
- (void)endAudio;	// IMP=0x000000000005b827
- (void)addSpeechAudioData:(id)arg1;	// IMP=0x000000000005b72b
- (void)startRecognitionWithAutoStop:(_Bool)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000005b56f
- (id)initWithModelURL:(id)arg1 language:(id)arg2 modelVersion:(id)arg3;	// IMP=0x000000000005b23e
