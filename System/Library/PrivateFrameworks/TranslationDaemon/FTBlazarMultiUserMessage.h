...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000077276
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x001000000007723c
- (void).cxx_destruct;	// IMP=0x0000000000078028
- (id)flatbuffData;	// IMP=0x0000000000077eab
- (Offset_86cece31)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000775bd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000076040
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000075e5d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2;	// IMP=0x0000000000075e48
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000075e2e
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000075e17
