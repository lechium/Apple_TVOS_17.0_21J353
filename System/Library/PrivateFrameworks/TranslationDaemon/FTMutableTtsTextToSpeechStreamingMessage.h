...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a533e
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a523c
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a5202
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a4ad8
- (id)init;	// IMP=0x00000000000a4a4a
