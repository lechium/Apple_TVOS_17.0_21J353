...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007117e
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000071144
- (void).cxx_destruct;	// IMP=0x00000000000722ed
- (id)flatbuffData;	// IMP=0x0000000000072170
- (Offset_b5e03a40)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000715bb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006f9c6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000006f7e3
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2;	// IMP=0x000000000006f7ce
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000006f7b4
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000006f79d
