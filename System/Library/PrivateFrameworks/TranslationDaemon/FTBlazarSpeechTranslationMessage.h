...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007b034
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x001000000007affa
- (void).cxx_destruct;	// IMP=0x000000000007be80
- (id)flatbuffData;	// IMP=0x000000000007bd03
- (Offset_a55c7777)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000007b3a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000079d13
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000079b30
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2;	// IMP=0x0000000000079b1b
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000079b01
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000079aea
