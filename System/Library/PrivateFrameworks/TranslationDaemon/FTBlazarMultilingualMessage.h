...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000079018
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000078fde
- (void).cxx_destruct;	// IMP=0x0000000000079ac2
- (id)flatbuffData;	// IMP=0x0000000000079945
- (Offset_a99fc554)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000079292
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000078279
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000078096
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2;	// IMP=0x0000000000078081
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000078067
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000078050
