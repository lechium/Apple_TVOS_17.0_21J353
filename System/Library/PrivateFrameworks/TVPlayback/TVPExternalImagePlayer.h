...
- (void).cxx_destruct;	// IMP=0x0000000000046ec4
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000046ca8
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000046bd4
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x000000000004699f
- (void)_cancelAllImageLoads;	// IMP=0x000000000004690b
- (void)_loadImagesIfNecessary;	// IMP=0x0000000000045e23
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000045a1b
- (void)invalidate;	// IMP=0x0000000000045a06
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000045614
