...
- (void).cxx_destruct;	// IMP=0x000000000004af48
...
- (void)_updateUserInteractionEnabled;	// IMP=0x000000000004acfb
- (void)setLabelAlpha:(double)arg1;	// IMP=0x000000000004acac
...
- (id)createProgressBarView;	// IMP=0x000000000004aa1b
- (double)dimmingAlpha;	// IMP=0x000000000004aa0d
- (void)setInteractionMode:(long long)arg1;	// IMP=0x000000000004a3c9
...
- (struct CGRect)playerHeadFrameForRect:(struct CGRect)arg1;	// IMP=0x0000000000049330
- (void)layoutSubviews;	// IMP=0x00000000000486b8
- (void)updateProgressBarPlayheadLocations;	// IMP=0x00000000000484ea
- (id)timeFont;	// IMP=0x00000000000482e2
@property(nonatomic) _Bool dimsWithGradient;
@property(nonatomic) _Bool dimsEntireBounds;
- (id)initWithPlayer:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x00000000000470c9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000470b5
