...
- (void).cxx_destruct;	// IMP=0x00000000000f44ac
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000f42a2
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000f41d0
- (void)cancelScrub;	// IMP=0x00000000000f419e
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000f40bf
