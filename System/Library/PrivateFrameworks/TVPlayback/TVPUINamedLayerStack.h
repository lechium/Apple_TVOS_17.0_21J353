...
@interface TVPUINamedLayerStack : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000000ffc70
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ffa9f
- (void)dealloc;	// IMP=0x00000000000ffa60
