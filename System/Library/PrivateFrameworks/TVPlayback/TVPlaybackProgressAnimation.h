...
+ (void)initialize;	// IMP=0x00000000000164f5
- (void).cxx_destruct;	// IMP=0x0000000000016808
...
- (_Bool)isFinished;	// IMP=0x00000000000166a4
- (double)currentPlaybackTime;	// IMP=0x0000000000016545
