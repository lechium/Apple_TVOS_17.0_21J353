...
- (void).cxx_destruct;	// IMP=0x0000000000025170
...
- (double)_timeAfterInsertingInterstitials:(double)arg1;	// IMP=0x0000000000024fd0
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000024f1c
- (id)_closestLoadedImageInfoForTime:(double)arg1;	// IMP=0x0000000000024bc2
- (void)_saveLoadedImageInfo:(id)arg1;	// IMP=0x00000000000249ba
- (id)_imageLoadInfoIfNeededForTime:(double)arg1;	// IMP=0x00000000000248ab
- (id)_imageInfosNeededWithStride:(double)arg1;	// IMP=0x00000000000246c2
- (id)_progressiveImageLoadInfosNeeded;	// IMP=0x00000000000245c2
- (void)_loadImages;	// IMP=0x0000000000023949
- (void)_reset;	// IMP=0x00000000000237d6
- (void)_playerCurrentMediaItemMetadataDidChange:(id)arg1;	// IMP=0x0000000000023687
- (id)closestImageForTime:(double)arg1 imageTime:(double *)arg2;	// IMP=0x00000000000233b4
- (void)prioritizeLoadingOfImageAtTime:(double)arg1;	// IMP=0x0000000000023379
- (void)loadImages;	// IMP=0x0000000000023367
- (void)dealloc;	// IMP=0x00000000000232e4
- (id)initWithPlayer:(id)arg1 maxImageSize:(struct CGSize)arg2;	// IMP=0x00000000000231ff
