...
- (void).cxx_destruct;	// IMP=0x000000000009fde6
...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x000000000009fbaf
- (id)description;	// IMP=0x000000000009faf8
