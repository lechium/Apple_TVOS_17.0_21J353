...
- (void)_beginFadeAnimationFromViewController:(id)arg1 toViewController:(id)arg2 containerView:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000000bd50
- (void)animateTransition:(id)arg1;	// IMP=0x000000000000bc25
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000000bc1a
- (id)init;	// IMP=0x000000000000bbd8
