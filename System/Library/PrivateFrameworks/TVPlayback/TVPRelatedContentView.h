...
- (void).cxx_destruct;	// IMP=0x000000000006e2bd
...
- (void)setView:(id)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006dee3
- (id)viewForContentType:(long long)arg1;	// IMP=0x000000000006de63
- (void)setPreferredSize:(struct CGSize)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006dae3
- (struct CGSize)preferredSizeForContentType:(long long)arg1;	// IMP=0x000000000006da30
- (id)_keyForContentType:(long long)arg1;	// IMP=0x000000000006da17
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006d9d3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006d1e7
