...
- (void).cxx_destruct;	// IMP=0x0000000000005d89
...
- (double)_textLabelWidthWithXPosition:(double)arg1 currentWidth:(double)arg2;	// IMP=0x0000000000005beb
- (void)_updateImage;	// IMP=0x0000000000005ad4
- (void)layoutSubviews;	// IMP=0x000000000000558d
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004f08
- (id)labelForMarquee;	// IMP=0x0000000000004e95
- (_Bool)canBecomeFocused;	// IMP=0x0000000000004e3d
- (void)prepareForReuse;	// IMP=0x0000000000004d69
- (void)dealloc;	// IMP=0x0000000000004d04
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000004c3b
