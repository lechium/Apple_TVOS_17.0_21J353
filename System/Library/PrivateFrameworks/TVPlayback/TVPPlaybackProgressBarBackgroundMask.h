...
- (void).cxx_destruct;	// IMP=0x00000000000068f6
...
- (void)_updateMasks;	// IMP=0x00000000000064e6
- (void)layoutSubviews;	// IMP=0x00000000000064a5
- (void)setMinPlayheadProgress:(double)arg1 maxPlayheadProgress:(double)arg2;	// IMP=0x00000000000062fd
- (void)setMinBufferingProgress:(double)arg1 maxBufferingProgress:(double)arg2;	// IMP=0x0000000000006187
- (void)_commonInit;	// IMP=0x0000000000005e85
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005e39
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005ddc
