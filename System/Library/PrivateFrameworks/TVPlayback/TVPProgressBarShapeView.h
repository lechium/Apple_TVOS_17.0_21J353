...
- (void).cxx_destruct;	// IMP=0x00000000000a069a
...
- (void)_updateMask;	// IMP=0x00000000000a04ab
- (void)_updateShapes;	// IMP=0x00000000000a02b2
@property(nonatomic) double borderWidth;
- (void)layoutSubviews;	// IMP=0x00000000000a00a3
- (void)_commonInit;	// IMP=0x000000000009fecd
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009fe81
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009fe24
