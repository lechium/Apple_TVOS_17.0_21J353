...
- (void).cxx_destruct;	// IMP=0x0000000000004108
...
- (id)allObjects;	// IMP=0x000000000000403f
- (id)nextObject;	// IMP=0x0000000000003f6c
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003eb7
