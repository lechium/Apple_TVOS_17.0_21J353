...
- (void)invalidate;	// IMP=0x0000000000018396
- (void)performObserverBlock;	// IMP=0x000000000001833d
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000000180ee
