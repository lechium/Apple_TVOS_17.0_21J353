...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x0060000000004e95
- (void).cxx_destruct;	// IMP=0x00000000000051be
...
- (unsigned long long)hash;	// IMP=0x0000000000005096
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004f5e
