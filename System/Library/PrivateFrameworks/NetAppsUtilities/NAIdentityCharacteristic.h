...
- (void).cxx_destruct;	// IMP=0x000000000001ef6f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ec3e
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001eafa
- (id)init;	// IMP=0x000000000001ea79
