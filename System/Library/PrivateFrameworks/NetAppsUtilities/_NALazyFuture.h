...
- (void).cxx_destruct;	// IMP=0x0000000000004a65
...
- (void)willAddCompletionBlock;	// IMP=0x000000000000477f
- (id)initWithBlock:(CDUnknownBlockType)arg1 scheduler:(id)arg2;	// IMP=0x000000000000466a
