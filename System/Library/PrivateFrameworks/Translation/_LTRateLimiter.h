...
- (void)markPageLoaded;	// IMP=0x0000000000013d6b
- (_Bool)allowedForRequests:(unsigned long long)arg1;	// IMP=0x0000000000013d51
- (id)initWithMaximumPageLoadRequest:(unsigned long long)arg1 maximumDynamicContentRequests:(long long)arg2;	// IMP=0x0000000000013ce0
