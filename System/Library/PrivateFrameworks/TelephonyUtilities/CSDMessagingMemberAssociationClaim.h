...
- (void).cxx_destruct;	// IMP=0x00000000000810d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000080ee5
- (unsigned long long)hash;	// IMP=0x0000000000080de0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000080c3f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080aeb
- (void)copyTo:(id)arg1;	// IMP=0x00000000000809e9
- (void)writeTo:(id)arg1;	// IMP=0x00000000000808e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000808d8
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x0000000000025db0
