...
+ (id)stridesExcludingBatch:(id)arg1;	// IMP=0x00100000000b4de1
+ (id)shapeExcludingBatch:(id)arg1;	// IMP=0x00100000000b4c7d
- (void).cxx_destruct;	// IMP=0x00000000000b59f9
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000b57f2
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithRegion_score:(id)arg1 script_feature:(id)arg2 link_score_horizontal:(id)arg3 link_score_vertical:(id)arg4 orientation_score:(id)arg5 text_type_score:(id)arg6 table_score:(id)arg7;	// IMP=0x00000000000b4f45
