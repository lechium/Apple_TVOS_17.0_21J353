...
- (void).cxx_destruct;	// IMP=0x000000000002dced
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000002dc42
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithOutput_label_prob_map:(id)arg1;	// IMP=0x000000000002dbde
