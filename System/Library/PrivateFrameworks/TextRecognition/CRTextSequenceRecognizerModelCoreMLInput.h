...
- (void).cxx_destruct;	// IMP=0x000000000002dbb6
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000002db1f
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImg_input:(id)arg1 featureInfo:(id)arg2;	// IMP=0x000000000002da8d
