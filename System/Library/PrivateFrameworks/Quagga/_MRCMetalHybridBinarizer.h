...
- (void).cxx_destruct;	// IMP=0x0000000000059e58
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000005961e
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000594a9
- (id)init;	// IMP=0x0000000000059493
