...
- (void).cxx_destruct;	// IMP=0x000000000003e053
- (id)captureState;	// IMP=0x000000000003e017
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003cef5
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x0000000000039bac
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000000039b93
- (id)init;	// IMP=0x0000000000030b29
