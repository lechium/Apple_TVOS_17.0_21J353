...
- (void).cxx_destruct;	// IMP=0x000000000007cd9a
...
- (id)initWithevent:(unsigned long long)arg1 identity:(id)arg2 assertionCount:(int)arg3 pid:(int)arg4;	// IMP=0x000000000007cce9
