...
@interface EXEnumeratorConfig : NSObject
{
    ...
    NSDictionary *_compatibilityExtensionPointAllowList;	// 24 = 0x18
    NSURL *_rootURL;	// 32 = 0x20
    NSURL *_xpcExtensionsCache;	// 40 = 0x28
    NSURL *_xpcExtensionPointsCache;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x000000000003b212
...
- (id)init;	// IMP=0x000000000003af38
