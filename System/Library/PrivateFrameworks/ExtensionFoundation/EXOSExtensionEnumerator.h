...
+ (void)enumerateExtensionsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000003f2ea
- (void).cxx_destruct;	// IMP=0x000000000003ffda
...
- (id)nextObject;	// IMP=0x000000000003ff3e
- (id)initWithCacheURLs:(id)arg1 paths:(id)arg2;	// IMP=0x000000000003f8ca
- (id)initWithCacheURLs:(id)arg1;	// IMP=0x000000000003f8b1
