...
+ (_Bool)safari_isSafariFamilyBundleIdentifier:(id)arg1;	// IMP=0x0020000000028662
+ (_Bool)safari_isICloudAppWithBundleIdentifier:(id)arg1;	// IMP=0x00200000000285a2
+ (id)safari_safariInjectedBundleURL;	// IMP=0x0020000000028407
+ (id)safari_currentTemplateAppName;	// IMP=0x002000000002806c
+ (id)safari_safariApplicationPlatformBundleIdentifier;	// IMP=0x0020000000028064
+ (id)safari_safariCoreBundle;	// IMP=0x0020000000027fb6
