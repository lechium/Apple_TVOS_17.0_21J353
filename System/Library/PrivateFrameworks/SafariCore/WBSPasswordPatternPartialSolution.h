...
- (void).cxx_destruct;	// IMP=0x000000000004d0dc
...
- (id)initWithPatternMatch:(id)arg1 guessesRequiredWithoutPatternCountPenalty:(double)arg2 withPatternCountPenalty:(double)arg3;	// IMP=0x000000000004d01e
