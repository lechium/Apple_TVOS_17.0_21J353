...
- (void).cxx_destruct;	// IMP=0x0000000000005d6b
...
- (void)shutdownViewServiceIfOverlayOffScreen;	// IMP=0x0000000000005b66
- (void)didEnterBackground;	// IMP=0x0000000000005b02
- (void)didReceiveMemoryWarning;	// IMP=0x0000000000005a7d
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x000000000000589b
- (void)didFinishDismissingOverlay:(id)arg1;	// IMP=0x00000000000057ba
- (void)willStartPresentingOverlay:(id)arg1;	// IMP=0x00000000000056d8
- (id)remoteViewControllerForOverlayViewService;	// IMP=0x00000000000056c6
- (id)hostContextForOverlayViewService;	// IMP=0x00000000000056b4
- (void)_loadRemoteViewController:(CDUnknownBlockType)arg1;	// IMP=0x000000000000502b
- (void)_loadViewServiceIfNeeded:(CDUnknownBlockType)arg1;	// IMP=0x00000000000048f4
- (void)loadViewServiceIfNeeded;	// IMP=0x00000000000047c1
- (void)failAllQueuedOverlaysWithError:(id)arg1;	// IMP=0x00000000000044a9
- (void)dismissOverlay;	// IMP=0x000000000000438e
- (void)presentOverlay:(id)arg1;	// IMP=0x00000000000041d9
- (void)viewDidLayoutSubviews;	// IMP=0x000000000000403e
- (void)viewDidLoad;	// IMP=0x0000000000003eab
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000003dc4
