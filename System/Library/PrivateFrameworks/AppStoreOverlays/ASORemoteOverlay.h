...
+ (id)dismissOverlayOperationWithContextProvider:(id)arg1;	// IMP=0x001000000000665a
+ (id)log;	// IMP=0x0010000000006365
- (void).cxx_destruct;	// IMP=0x0000000000007be4
...
- (void)remoteStoreOverlayDidFinishDismissal:(id)arg1;	// IMP=0x00000000000078bb
- (void)remoteStoreOverlayWillStartDismissing:(id)arg1 executeBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007303
- (void)remoteStoreOverlayDidFinishPresentation:(id)arg1;	// IMP=0x0000000000007097
- (void)remoteStoreOverlayWillStartPresenting:(id)arg1 executeBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006aa3
- (void)remoteStoreOverlayDidFailToLoadWithError:(id)arg1;	// IMP=0x00000000000067b6
@property(readonly, copy, nonatomic) id <ASOOverlayConfiguration> overlayConfiguration;
- (id)context;	// IMP=0x00000000000066a7
- (id)presentOverlayOperation;	// IMP=0x0000000000006624
- (void)finishWithError:(id)arg1;	// IMP=0x000000000000647e
- (id)initWithOverlay:(id)arg1 contextProvider:(id)arg2 hostSpan:(id)arg3;	// IMP=0x00000000000063c1
