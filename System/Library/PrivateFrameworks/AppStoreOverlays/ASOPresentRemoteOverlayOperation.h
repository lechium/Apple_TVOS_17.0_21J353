...
- (void).cxx_destruct;	// IMP=0x0000000000006352
...
- (void)start;	// IMP=0x0000000000006085
- (void)finishExecuting;	// IMP=0x0000000000005f82
- (void)cancel;	// IMP=0x0000000000005ec1
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000005e53
