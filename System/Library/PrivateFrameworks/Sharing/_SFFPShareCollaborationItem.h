...
- (void).cxx_destruct;	// IMP=0x0000000000056b40
...
- (void)loadCopyRepresentationURLWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000056a38
- (id)_defaultLoadingOptionsSummary;	// IMP=0x00000000000569dc
@property(readonly, nonatomic) _Bool hasSeparateSendCopyRepresentation;
@property(readonly, nonatomic) _Bool isCollaborativeURL;
- (void)_loadSendCopyRepresentationIfNeeded;	// IMP=0x000000000005695f
- (void)_loadMetadataIfNeeded;	// IMP=0x0000000000056705
@property(readonly, copy, nonatomic) NSString *additionalContentIdentifier;
- (id)initWithFileURL:(id)arg1 itemProvider:(id)arg2 activityItem:(id)arg3 defaultCollaboration:(_Bool)arg4 managedFileURL:(id)arg5;	// IMP=0x00000000000566e3
