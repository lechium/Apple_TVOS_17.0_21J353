...
- (void).cxx_destruct;	// IMP=0x0000000000056e67
...
- (void)_loadOptionsIfNeeded;	// IMP=0x0000000000056dda
- (id)initWithItemProvider:(id)arg1 activityItem:(id)arg2 isURLProviderSupported:(_Bool)arg3;	// IMP=0x0000000000056b82
