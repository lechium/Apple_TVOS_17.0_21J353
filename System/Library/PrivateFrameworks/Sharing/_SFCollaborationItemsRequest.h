...
- (void).cxx_destruct;	// IMP=0x00000000000f951e
...
- (void)_addCollaborationItem:(id)arg1;	// IMP=0x00000000000f8f9b
- (void)_processRemainingActivityItems;	// IMP=0x00000000000f8b57
- (id)collaborationService;	// IMP=0x00000000000f8af8
- (void)cancel;	// IMP=0x00000000000f8ae4
- (void)perform;	// IMP=0x00000000000f8ad2
- (id)initWithActivityItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f8958
