...
- (int)_estimateRSSIForSFBLEDevice:(id)arg1;	// IMP=0x00000000000f2443
- (id)description;	// IMP=0x00000000000f2358
- (void)dealloc;	// IMP=0x00000000000f22e9
- (id)initWithProximityInfo:(id)arg1;	// IMP=0x00000000000f21d5
