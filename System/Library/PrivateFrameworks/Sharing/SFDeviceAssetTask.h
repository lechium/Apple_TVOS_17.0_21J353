...
- (void).cxx_destruct;	// IMP=0x000000000006ccd5
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006c7ad
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x000000000006c4e1
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x000000000006bcde
- (_Bool)completeIfPossible;	// IMP=0x000000000006b757
- (void)cancelTimeout;	// IMP=0x000000000006b70d
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b509
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b453
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006b3c2
- (void)createQueryParameters;	// IMP=0x000000000006b099
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x000000000006ad35
