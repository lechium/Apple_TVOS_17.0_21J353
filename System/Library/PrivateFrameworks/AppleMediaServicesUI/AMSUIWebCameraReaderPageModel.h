...
- (void).cxx_destruct;	// IMP=0x000000000006d3aa
...
- (id)loadPage;	// IMP=0x000000000006cd23
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000006ccb2
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006c762
