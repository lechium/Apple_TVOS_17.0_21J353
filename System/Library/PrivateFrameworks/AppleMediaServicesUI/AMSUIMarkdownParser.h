...
+ (void)initialize;	// IMP=0x00600000000350be
- (void).cxx_destruct;	// IMP=0x0000000000035a80
...
- (void)parse;	// IMP=0x0000000000035366
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x0000000000035228
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x00000000000351a3
- (id)init;	// IMP=0x0000000000035178
- (id)initWithString:(id)arg1;	// IMP=0x0000000000035105
