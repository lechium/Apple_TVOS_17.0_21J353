...
- (void).cxx_destruct;	// IMP=0x0000000000097360
...
- (id)_createSession;	// IMP=0x000000000009718d
- (id)runAction;	// IMP=0x0000000000095de6
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009578c
