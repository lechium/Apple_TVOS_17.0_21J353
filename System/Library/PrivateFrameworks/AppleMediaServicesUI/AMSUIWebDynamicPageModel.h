...
- (void).cxx_destruct;	// IMP=0x000000000007a219
...
- (id)loadPage;	// IMP=0x0000000000079d78
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000079be3
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007983d
