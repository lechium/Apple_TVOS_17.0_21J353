...
- (void).cxx_destruct;	// IMP=0x000000000006c70f
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x000000000006c5e6
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000006c42d
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x000000000006c3e8
- (void)layoutSubviews;	// IMP=0x000000000006bed5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006bd0a
