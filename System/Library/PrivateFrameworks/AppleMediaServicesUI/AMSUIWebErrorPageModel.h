...
+ (id)_messageFromError:(id)arg1;	// IMP=0x001000000007b9e8
- (void).cxx_destruct;	// IMP=0x000000000007bce7
...
- (id)loadPage;	// IMP=0x000000000007b9cf
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000007b95e
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007b134
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000007aea6
