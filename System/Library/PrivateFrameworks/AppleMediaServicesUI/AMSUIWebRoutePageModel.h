...
- (void).cxx_destruct;	// IMP=0x00000000000a06b9
...
- (id)_webPageViewController;	// IMP=0x00000000000a041f
- (id)loadPage;	// IMP=0x00000000000a0406
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000a03ec
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009fe6b
