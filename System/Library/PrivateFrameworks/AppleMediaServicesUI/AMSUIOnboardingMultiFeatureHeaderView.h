...
- (void).cxx_destruct;	// IMP=0x000000000004bcc4
...
- (void)updateContentSize;	// IMP=0x000000000004b6e8
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000004b6ba
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000004b668
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004b471
- (void)adjustedContentInsetDidChange;	// IMP=0x000000000004b41b
- (void)layoutSubviews;	// IMP=0x000000000004ae88
- (id)initWithFeatures:(id)arg1;	// IMP=0x000000000004aa9b
