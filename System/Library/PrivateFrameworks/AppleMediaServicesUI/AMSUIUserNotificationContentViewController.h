...
- (void).cxx_destruct;	// IMP=0x000000000005e38a
...
- (void)viewTapped:(id)arg1;	// IMP=0x000000000005e222
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000005e1a6
- (void)mediaPause;	// IMP=0x000000000005e0cd
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000005d569
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000005d479
- (void)viewWillLayoutSubviews;	// IMP=0x000000000005cba2
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x000000000005cb1d
- (void)loadView;	// IMP=0x000000000005c6f8
- (void)dealloc;	// IMP=0x000000000005c636
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000005b81f
