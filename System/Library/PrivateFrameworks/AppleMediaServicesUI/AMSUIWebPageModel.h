...
- (void).cxx_destruct;	// IMP=0x000000000009abed
...
- (id)loadPage;	// IMP=0x000000000009a84a
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000009a7f2
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009a4db
