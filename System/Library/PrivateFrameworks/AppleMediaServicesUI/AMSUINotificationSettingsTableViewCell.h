...
- (void).cxx_destruct;	// IMP=0x000000000004830d
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000004817b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000047f0c
