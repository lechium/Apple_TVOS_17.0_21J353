...
@interface AMSUIWebFetchMetricsIdentifierAction
{
    ...
    _Bool _generateEventFields;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x000000000007fdd7
...
- (id)runAction;	// IMP=0x000000000007f246
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007ee90
