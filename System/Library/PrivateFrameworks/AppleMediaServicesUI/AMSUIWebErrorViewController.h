...
- (void).cxx_destruct;	// IMP=0x000000000007d59a
...
- (void)_showCancelButtonIfNeeded;	// IMP=0x000000000007d117
- (void)_applyAppearance;	// IMP=0x000000000007cfac
- (void)willPresentPageModel:(id)arg1 appearance:(id)arg2;	// IMP=0x000000000007cd9d
- (void)viewWillLayoutSubviews;	// IMP=0x000000000007ccd4
- (void)loadView;	// IMP=0x000000000007bfc9
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000007bdcf
- (id)initWithContext:(id)arg1;	// IMP=0x000000000007bd72
