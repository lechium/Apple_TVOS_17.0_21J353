...
- (void).cxx_destruct;	// IMP=0x000000000006704d
...
- (id)_imageForButtonWithNavStyle:(long long)arg1;	// IMP=0x0000000000066e12
@property(readonly, copy) NSString *description;
- (id)createDialogAction;	// IMP=0x0000000000066c66
- (id)_createProxCardItemWithActionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000066c5e
- (id)_createSpinnerItem;	// IMP=0x0000000000066b95
- (long long)_barButtonItemStyle;	// IMP=0x0000000000066b7c
- (id)createBarButtonItemWithNavigationBarModel:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000006681e
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000066317
