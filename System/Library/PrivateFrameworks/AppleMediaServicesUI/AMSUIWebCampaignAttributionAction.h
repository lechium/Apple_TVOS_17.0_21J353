...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x006000000006fae8
- (void).cxx_destruct;	// IMP=0x000000000006fbdc
...
- (id)runAction;	// IMP=0x000000000006f0de
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006ec1d
