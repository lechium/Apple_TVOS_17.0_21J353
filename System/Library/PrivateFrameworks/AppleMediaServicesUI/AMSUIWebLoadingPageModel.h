...
- (void).cxx_destruct;	// IMP=0x0000000000090249
...
- (id)loadPage;	// IMP=0x00000000000901a8
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000009011b
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008fb37
- (id)initWithContext:(id)arg1;	// IMP=0x000000000008facc
