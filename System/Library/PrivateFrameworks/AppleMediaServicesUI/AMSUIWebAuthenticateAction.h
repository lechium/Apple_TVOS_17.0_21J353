...
- (void).cxx_destruct;	// IMP=0x0000000000063db8
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x0000000000063bc5
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x0000000000063a98
- (id)runAction;	// IMP=0x00000000000633c0
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000062b2f
