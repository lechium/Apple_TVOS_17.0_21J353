...
+ (_Bool)validateJSObject:(id)arg1;	// IMP=0x0010000000062a48
- (void).cxx_destruct;	// IMP=0x0000000000062af1
...
- (id)iconWithSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x00000000000625f7
- (id)createBarButtonItem;	// IMP=0x000000000006204b
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000061c52
