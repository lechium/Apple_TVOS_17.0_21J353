...
- (void).cxx_destruct;	// IMP=0x00000000000833d2
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x0000000000082f52
- (id)runAction;	// IMP=0x0000000000082b27
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000082523
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000824e0
