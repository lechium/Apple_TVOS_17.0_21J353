...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x00100000000aab6c
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x00100000000aaa11
- (void).cxx_destruct;	// IMP=0x00000000000aace1
...
- (id)runAction;	// IMP=0x00000000000aa50f
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a9ce6
