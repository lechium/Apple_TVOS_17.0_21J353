...
- (void).cxx_destruct;	// IMP=0x0000000000010c75
...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x0000000000010873
- (id)performAuthenticate;	// IMP=0x00000000000100bd
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000001001b
