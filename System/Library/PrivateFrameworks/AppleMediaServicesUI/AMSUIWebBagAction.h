...
- (void).cxx_destruct;	// IMP=0x00000000000655f7
...
- (void)_fetchValuesForKeys:(id)arg1 bag:(id)arg2 startingAtIndex:(long long)arg3 valuesArray:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000064e69
- (id)runAction;	// IMP=0x00000000000647cd
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000641bd
