...
@interface AMSUIWebClientContext : NSObject
{
    ...
    AMSMescalAccountPrimeSession *_mescalSession;	// 112 = 0x70
    AMSUIWebPluginLoader *_pluginLoader;	// 120 = 0x78
    AMSURLSession *_URLSession;	// 128 = 0x80
    AMSUIWebPageViewController *_webPage;	// 136 = 0x88
    NSString *_URL;	// 144 = 0x90
    id <AMSBagProtocol> _backingBag;	// 152 = 0x98
}

+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x0060000000071974
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x006000000007190c
- (void).cxx_destruct;	// IMP=0x0000000000072005
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x00000000000718fa
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x0000000000071327
- (id)loadSnapshot;	// IMP=0x0000000000071031
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x0000000000070a67
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x000000000007094c
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x00000000000704b7
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x000000000007025e
