...
+ (id)resultFromURL:(id)arg1 error:(id)arg2;	// IMP=0x00100000000981cb
- (void).cxx_destruct;	// IMP=0x00000000000991a7
...
- (void)_safariDataUpdate:(id)arg1;	// IMP=0x0000000000098cbc
- (_Bool)_presentViewContoller:(id)arg1;	// IMP=0x0000000000098ac6
- (id)runAction;	// IMP=0x0000000000098315
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000097fcd
