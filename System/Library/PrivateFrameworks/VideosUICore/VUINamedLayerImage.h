...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0010000000006e13
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0010000000006d9f
- (void).cxx_destruct;	// IMP=0x0000000000007239
...
- (id)imageObj;	// IMP=0x00000000000071e8
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x0000000000006d64
- (id)init;	// IMP=0x0000000000006d56
