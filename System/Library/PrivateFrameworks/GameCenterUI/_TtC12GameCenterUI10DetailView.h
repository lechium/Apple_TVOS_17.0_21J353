...
- (void).cxx_destruct;	// IMP=0x0000000000215763
- (void)didTapWithAccessoryView:(id)arg1;	// IMP=0x00000000002145c8
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000000021449c
- (void)layoutSubviews;	// IMP=0x00000000002140ae
- (void)wasTapped;	// IMP=0x0000000000213c7f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000021338d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000021322c
