...
- (void).cxx_destruct;	// IMP=0x000000000039874a
...
- (void)layoutSubviews;	// IMP=0x0000000000397dad
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x0000000000397b80
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003979c5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003978d2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000039761b
