...
@interface CVNLPCaptionDecoderBlock
{
    ...
    map_33c06f8b _stateOutputEspressoBuffers;	// 80 = 0x50
    map_33c06f8b _stateInputEspressoBuffers;	// 104 = 0x68
    map_0c0ea2fa _stateInputEspressoBuffersShape;	// 128 = 0x80
...
- (id).cxx_construct;	// IMP=0x000000000003f9a0
- (void).cxx_destruct;	// IMP=0x000000000003f8b0
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003ee70
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ecd0
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ead0
- (void)copyOutputState:(id)arg1;	// IMP=0x000000000003dd10
- (void)copyInputState:(id)arg1;	// IMP=0x000000000003d1d0
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x0000000000039150
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x0000000000037e70
- (void)dealloc;	// IMP=0x0000000000037d50
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x0000000000037b30
