...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x00300000000574cd
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x003000000009615c
@end
