...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000000000033bc
- (void)_handleEvent:(id)arg1;	// IMP=0x00000000000030f8
- (id)_deserializeMessage:(id)arg1;	// IMP=0x0000000000002fc0
- (void)dealloc;	// IMP=0x0000000000002f82
- (void)close;	// IMP=0x0000000000002f4c
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000002e18
