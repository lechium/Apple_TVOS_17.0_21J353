...
+ (id)identifierForPID:(int)arg1;	// IMP=0x00600000000013e0
- (void).cxx_destruct;	// IMP=0x0000000000001e4d
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x00000000000017f2
- (id)dictionaryRepresentation;	// IMP=0x000000000000153b
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x0000000000001405
