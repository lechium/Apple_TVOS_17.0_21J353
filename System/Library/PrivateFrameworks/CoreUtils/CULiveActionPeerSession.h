...
- (void).cxx_destruct;	// IMP=0x0000000000063c4d
...
- (void)performRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006392c
- (void)setupWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000636c6
- (void)invalidate;	// IMP=0x0000000000063694
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000634ab
