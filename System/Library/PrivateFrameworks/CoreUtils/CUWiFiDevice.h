...
- (void).cxx_destruct;	// IMP=0x00000000000b8080
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000b755d
- (id)description;	// IMP=0x00000000000b73cb
