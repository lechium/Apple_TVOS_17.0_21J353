...
+ (id)_tps_resolvedContextualDuetEventMetadataKeyPathComponents:(id)arg1 forStream:(id)arg2;	// IMP=0x0020000000051b6b
+ (id)tps_resolvedContextualDuetEventKeyPath:(id)arg1 forStream:(id)arg2;	// IMP=0x00200000000519c7
+ (id)_eventWithTipIdentifier:(id)arg1 bundleIdentifier:(id)arg2 displayType:(unsigned long long)arg3 eligibleContext:(id)arg4 context:(id)arg5 flags:(unsigned long long)arg6 state:(long long)arg7 reason:(long long)arg8 event:(id)arg9 date:(id)arg10;	// IMP=0x0020000000057831
