...
- (void).cxx_destruct;	// IMP=0x00000000005ef350
- (void)doneButtonTapped;	// IMP=0x00000000005ef2a0
- (void)startButtonTapped;	// IMP=0x00000000005ef280
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005ef140
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005ef110
