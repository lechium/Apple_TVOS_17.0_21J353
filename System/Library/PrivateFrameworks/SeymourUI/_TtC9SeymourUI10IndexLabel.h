...
- (void).cxx_destruct;	// IMP=0x0000000000360700
- (void)textSizeUpdated:(id)arg1;	// IMP=0x0000000000360330
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003601b0
- (void)layoutSubviews;	// IMP=0x0000000000360180
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000035ff80
