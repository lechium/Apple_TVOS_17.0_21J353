...
+ (long long)activityCategory;	// IMP=0x004000000063e750
- (void).cxx_destruct;	// IMP=0x000000000063efe0
- (id)init;	// IMP=0x000000000063ef80
- (void)performActivity;	// IMP=0x000000000063ef50
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x000000000063eab0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x000000000063e940
