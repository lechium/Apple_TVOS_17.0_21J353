...
- (void).cxx_destruct;	// IMP=0x0000000000953ad0
- (void)panGestureRecognized:(id)arg1;	// IMP=0x0000000000953940
- (void)layoutSubviews;	// IMP=0x0000000000953290
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009530b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000953080
