...
- (void).cxx_destruct;	// IMP=0x0000000000956be0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000009559d0
- (void)tintColorDidChange;	// IMP=0x00000000009556a0
- (void)layoutSubviews;	// IMP=0x0000000000955490
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009551b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000955180
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x00000000009547d0
