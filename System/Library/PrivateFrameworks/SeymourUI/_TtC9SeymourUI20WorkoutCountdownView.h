...
- (void).cxx_destruct;	// IMP=0x00000000001da6d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001da670
- (void)layoutSubviews;	// IMP=0x00000000001d99d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d99b0
