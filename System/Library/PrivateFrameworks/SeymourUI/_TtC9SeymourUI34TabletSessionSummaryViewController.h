...
- (void).cxx_destruct;	// IMP=0x00000000001e4720
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000001e46c0
- (void)updateViewConstraints;	// IMP=0x00000000001e34b0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001e3400
- (void)ttrButtonTapped;	// IMP=0x00000000001e0c90
- (void)shareButtonTapped;	// IMP=0x00000000001e0c60
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000001e0c20
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000001e0ae0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e08a0
