...
+ (long long)activityCategory;	// IMP=0x0040000000968aa0
- (void).cxx_destruct;	// IMP=0x00000000009698b0
- (id)init;	// IMP=0x0000000000969850
- (void)performActivity;	// IMP=0x0000000000968f20
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000968bf0
