...
- (void).cxx_destruct;	// IMP=0x0000000000327380
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003272d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000327240
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000326480
