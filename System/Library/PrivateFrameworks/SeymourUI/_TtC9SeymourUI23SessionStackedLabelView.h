...
- (void).cxx_destruct;	// IMP=0x00000000005ddf10
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000005dde20
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005dde00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005dddd0
