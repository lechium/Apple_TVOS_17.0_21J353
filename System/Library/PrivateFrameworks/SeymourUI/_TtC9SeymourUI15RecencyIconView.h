...
- (void).cxx_destruct;	// IMP=0x0000000000188f70
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000188f10
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000188ef0
- (void)didMoveToSuperview;	// IMP=0x0000000000188ec0
- (void)layoutSubviews;	// IMP=0x0000000000188c80
