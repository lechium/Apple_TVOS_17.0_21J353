...
- (void).cxx_destruct;	// IMP=0x00000000007704c0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000770440
- (void)viewSafeAreaInsetsDidChange;	// IMP=0x000000000076fd10
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000076f9b0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000076f900
- (void)viewDidLoad;	// IMP=0x000000000076f8d0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000076f5c0
