...
- (void).cxx_destruct;	// IMP=0x000000000066aae0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000066aa80
- (void)menuButtonTapped;	// IMP=0x000000000066aa50
- (void)viewDidLoad;	// IMP=0x000000000066a860
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000066a480
