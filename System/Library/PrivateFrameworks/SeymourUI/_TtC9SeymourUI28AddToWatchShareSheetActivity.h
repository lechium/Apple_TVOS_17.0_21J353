...
+ (long long)activityCategory;	// IMP=0x00400000000bdd90
- (void).cxx_destruct;	// IMP=0x00000000000be2f0
- (id)init;	// IMP=0x00000000000be290
- (void)performActivity;	// IMP=0x00000000000be260
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000000be0b0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000000bdf30
