...
- (void).cxx_destruct;	// IMP=0x000000000002fc70
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000002f770
- (void)connectAndPair;	// IMP=0x000000000002f760
- (void)togglePlayPause;	// IMP=0x000000000002f750
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000002f6b0
- (id)init;	// IMP=0x000000000002f680
