...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000028f50
- (void).cxx_destruct;	// IMP=0x000000000002d5d0
...
- (id)_preloadArtwork;	// IMP=0x000000000002d110
- (id)_placeholderArtwork;	// IMP=0x000000000002d010
- (void)_updateState;	// IMP=0x000000000002cdb0
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000002ccc0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000002c610
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000002c450
- (void)_updateMetadata;	// IMP=0x000000000002a2d0
- (void)_createRequestController;	// IMP=0x0000000000029c40
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000029970
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000296c0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000291d0
- (void)playPause;	// IMP=0x00000000000291a0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000029110
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029030
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000028eb0
- (id)playerPath;	// IMP=0x0000000000028dc0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000028bd0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000028830
