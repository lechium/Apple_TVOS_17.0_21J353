...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00100000000014a0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000000bc90
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000b870
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000a2c0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000006240
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000005dc0
- (void)_updateAvailableRoutes;	// IMP=0x0000000000005270
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000005060
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000004fe0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000004f90
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000004d90
- (void)presentEARCUpsell;	// IMP=0x0000000000004910
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00000000000042b0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000003de0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000002860
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000002780
- (void)dealloc;	// IMP=0x00000000000021d0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001650
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x00000000000015b0
- (id)init;	// IMP=0x0000000000001550
