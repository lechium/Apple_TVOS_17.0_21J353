...
- (_Bool)requiresOverlayAssertion;	// IMP=0x000000000002d8c0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000002d820
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000002d780
- (void)dealloc;	// IMP=0x000000000002d740
