...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x004000000001ff30
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000001da90
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x0040000000019a20
+ (_Bool)allowsSelection;	// IMP=0x0040000000019a00
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000000001fd20
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001ee80
- (unsigned long long)_controlStateForCell;	// IMP=0x000000000001edb0
- (void)_addInitialConstraints;	// IMP=0x000000000001dc40
- (void)accessoryViewSelected;	// IMP=0x000000000001da80
- (void)routeViewSelected;	// IMP=0x000000000001da70
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000001da30
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000001d010
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000001cee0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001cdd0
- (void)updateConstraints;	// IMP=0x000000000001af90
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000001ae60
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000001ae40
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001ad00
- (void)prepareForReuse;	// IMP=0x000000000001ac60
- (id)preferredFocusEnvironments;	// IMP=0x000000000001aae0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a40
