...
@interface TVNPRoutingMainViewController : UIViewController <TVNPRoutingDestinationsCollectionViewControllerDelegate>
{
...
+ (id)_destinationLayout;	// IMP=0x001000000000ff10
- (void).cxx_destruct;	// IMP=0x0000000000010a90
...
- (id)_routesLayout;	// IMP=0x0000000000010370
- (void)_updateHintText;	// IMP=0x000000000000eba0
- (void)_updateTitleView;	// IMP=0x000000000000eaf0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000e9c0
- (void)didPressMute:(id)arg1;	// IMP=0x000000000000e6d0
- (void)didPressPlayPause:(id)arg1;	// IMP=0x000000000000e630
- (void)didPressMenu:(id)arg1;	// IMP=0x000000000000e590
- (void)routingViewController:(id)arg1 shareAudioPresentationRequested:(id)arg2;	// IMP=0x000000000000e500
- (void)routingViewControllerWillEndEditingVolume:(id)arg1;	// IMP=0x000000000000e480
- (void)routingViewControllerWillBeginEditingVolume:(id)arg1;	// IMP=0x000000000000e400
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x000000000000e370
- (id)preferredFocusEnvironments;	// IMP=0x000000000000e2f0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000000e280
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000000e210
- (void)viewDidLoad;	// IMP=0x000000000000d080
- (void)dealloc;	// IMP=0x000000000000cf00
- (id)initWithRoutingController:(id)arg1 options:(id)arg2;	// IMP=0x000000000000c580
