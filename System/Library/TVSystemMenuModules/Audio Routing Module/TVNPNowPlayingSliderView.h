...
- (void).cxx_destruct;	// IMP=0x000000000003c2b0
...
- (id)_unfocusedProgressColor;	// IMP=0x000000000003bfd0
- (id)_focusedProgressColor;	// IMP=0x000000000003bef0
- (void)_rightPressed:(id)arg1;	// IMP=0x000000000003be00
- (void)_leftPressed:(id)arg1;	// IMP=0x000000000003bd20
- (void)_panUpdated:(id)arg1;	// IMP=0x000000000003b780
- (void)_menuPressed;	// IMP=0x000000000003b770
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b700
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b690
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b620
- (_Bool)shouldTrack;	// IMP=0x000000000003b600
- (double)maxBarWidth;	// IMP=0x000000000003b5e0
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x000000000003b570
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000003b280
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000003b1a0
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000003b160
- (void)layoutSubviews;	// IMP=0x000000000003ab20
- (_Bool)canBecomeFocused;	// IMP=0x000000000003ab00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003a130
