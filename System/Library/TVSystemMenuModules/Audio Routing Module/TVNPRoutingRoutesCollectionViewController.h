...
- (void).cxx_destruct;	// IMP=0x0000000000036840
...
- (void)_pickRoute:(id)arg1;	// IMP=0x0000000000036130
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000000036080
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000000035f10
- (void)_calculateVisibleVolumeCells;	// IMP=0x00000000000359c0
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x0000000000035870
- (id)_gradientMask;	// IMP=0x0000000000035210
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0000000000035100
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0000000000034810
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00000000000347a0
- (void)shareAudioSelected;	// IMP=0x0000000000034700
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x00000000000343f0
- (void)longPressSelect:(id)arg1;	// IMP=0x00000000000342f0
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0000000000034190
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000033fc0
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000033df0
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0000000000033d50
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000000339c0
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000033780
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000033650
- (void)handleVolumeDown;	// IMP=0x0000000000033020
- (void)handleVolumeUp;	// IMP=0x0000000000032990
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x00000000000316f0
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000031360
- (void)viewDidLoad;	// IMP=0x0000000000030430
- (void)dealloc;	// IMP=0x00000000000303e0
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x0000000000030290
