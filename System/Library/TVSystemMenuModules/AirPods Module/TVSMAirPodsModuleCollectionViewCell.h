...
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000000005200
- (void)_updatePackageRasterizationScale;	// IMP=0x0000000000005130
- (void)_updatePackageViewVisibility;	// IMP=0x0000000000004f60
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000004950
- (void)_setupPackageViews;	// IMP=0x00000000000040f0
- (void)_setupConstraints;	// IMP=0x0000000000003670
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003560
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000034e0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000002ab0
