...
- (void)_calculateAndSetRasterizationScaleForLayer:(id)arg1;	// IMP=0x00000000000024f0
- (void)_updateRasterizationScale;	// IMP=0x0000000000002470
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000002280
- (void)setStateName:(id)arg1;	// IMP=0x00000000000021d0
- (void)layoutSubviews;	// IMP=0x0000000000001e00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001ce0
