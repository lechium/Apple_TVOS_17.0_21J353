...
+ (Class)layoutAttributesClass;	// IMP=0x006000000002e0a0
- (void).cxx_destruct;	// IMP=0x000000000002e780
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000002e540
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000002e230
- (void)prepareLayout;	// IMP=0x000000000002e0d0
