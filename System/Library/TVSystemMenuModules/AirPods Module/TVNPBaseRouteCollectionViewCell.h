...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x004000000003d900
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000003b460
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x00400000000373f0
+ (_Bool)allowsSelection;	// IMP=0x00400000000373d0
- (void).cxx_destruct;	// IMP=0x000000000003dde0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000000003d6f0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000003c850
- (unsigned long long)_controlStateForCell;	// IMP=0x000000000003c780
- (void)_addInitialConstraints;	// IMP=0x000000000003b610
- (void)accessoryViewSelected;	// IMP=0x000000000003b450
- (void)routeViewSelected;	// IMP=0x000000000003b440
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000003b400
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000003a9e0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000003a8b0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000003a7a0
- (void)updateConstraints;	// IMP=0x0000000000038960
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000038830
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000038810
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000386d0
- (void)prepareForReuse;	// IMP=0x0000000000038630
- (id)preferredFocusEnvironments;	// IMP=0x00000000000384b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000037410
