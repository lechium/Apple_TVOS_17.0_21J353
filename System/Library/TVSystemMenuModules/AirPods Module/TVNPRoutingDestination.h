...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000002d280
- (void)connectAndPair;	// IMP=0x000000000002d270
- (void)togglePlayPause;	// IMP=0x000000000002d260
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000002d1c0
- (id)init;	// IMP=0x000000000002d190
