...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000030710
- (void).cxx_destruct;	// IMP=0x0000000000034d30
...
- (id)_preloadArtwork;	// IMP=0x0000000000034870
- (id)_placeholderArtwork;	// IMP=0x0000000000034770
- (void)_updateState;	// IMP=0x0000000000034510
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000034420
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000033dd0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000033c10
- (void)_updateMetadata;	// IMP=0x0000000000031a90
- (void)_createRequestController;	// IMP=0x0000000000031400
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000031130
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000030e80
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000030990
- (void)playPause;	// IMP=0x0000000000030960
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000308d0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000307f0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000030670
- (id)playerPath;	// IMP=0x0000000000030580
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000030390
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000000002fff0
