...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00100000000020b0
- (void).cxx_destruct;	// IMP=0x0000000000006870
...
- (id)_preloadArtwork;	// IMP=0x00000000000063b0
- (id)_placeholderArtwork;	// IMP=0x00000000000062b0
- (void)_updateState;	// IMP=0x0000000000006050
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000005f60
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000005820
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000005660
- (void)_updateMetadata;	// IMP=0x0000000000003470
- (void)_createRequestController;	// IMP=0x0000000000002de0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000002b10
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000002820
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000002330
- (void)playPause;	// IMP=0x0000000000002300
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000002270
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000002190
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000002010
- (id)playerPath;	// IMP=0x0000000000001f20
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000001d30
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000001920
