...
- (void)setPlatterColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007c60
- (void)setSecondaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007ae0
- (void)setPrimaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007960
- (void)setAccessoryText:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007890
- (void)setSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007760
- (void)setSystemImageName:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007630
- (void)setTitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007500
- (void)updateStateAnimated:(_Bool)arg1;	// IMP=0x0000000000006d10
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000006b90
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006a70
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006980
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006830
- (_Bool)canBecomeFocused;	// IMP=0x0000000000006810
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 systemImageName:(id)arg3 subtitle:(id)arg4 accessoryText:(id)arg5;	// IMP=0x0000000000005300
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 systemImageName:(id)arg3;	// IMP=0x0000000000005220
