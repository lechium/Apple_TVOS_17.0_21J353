...
- (id)_collectionViewWrapperViewGradientMask;	// IMP=0x00000000000072e0
- (void)_handleMenuPress:(id)arg1;	// IMP=0x0000000000007260
- (void)layoutSubviews;	// IMP=0x0000000000007040
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005dc0
