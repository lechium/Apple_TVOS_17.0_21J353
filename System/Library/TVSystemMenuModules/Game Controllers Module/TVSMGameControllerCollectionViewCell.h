...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0060000000004290
- (void).cxx_destruct;	// IMP=0x0000000000004c70
...
- (void)_updateColors;	// IMP=0x00000000000047a0
- (void)_updateVisibleAccessoryView;	// IMP=0x00000000000046b0
- (unsigned long long)_floatingContentViewControlState;	// IMP=0x00000000000045e0
- (void)_updateFloatingContentViewControlState;	// IMP=0x0000000000004540
- (_Bool)_canHandlePresses:(id)arg1;	// IMP=0x0000000000004440
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000041c0
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000040f0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000004020
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003e60
- (void)prepareForReuse;	// IMP=0x0000000000003de0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000003cf0
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000003cd0
- (void)updateConstraints;	// IMP=0x0000000000003a60
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001720
