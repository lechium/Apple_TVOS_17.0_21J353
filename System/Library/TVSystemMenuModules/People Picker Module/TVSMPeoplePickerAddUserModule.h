...
+ (id)availableStyles;	// IMP=0x00100000000038f0
- (void).cxx_destruct;	// IMP=0x0000000000003e30
...
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000003c60
...
- (id)init;	// IMP=0x0000000000003910
