...
+ (id)_defaultShortNameFormatter;	// IMP=0x0010000000006950
+ (id)availableStyles;	// IMP=0x0010000000006290
- (void).cxx_destruct;	// IMP=0x0000000000006ba0
...
- (id)stringForNameComponents:(id)arg1;	// IMP=0x00000000000068a0
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000006720
...
- (void)_updateProfilePhoto;	// IMP=0x0000000000006580
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000006480
...
- (void)dealloc;	// IMP=0x0000000000006230
- (id)initWithSuggestedUser:(id)arg1;	// IMP=0x00000000000060c0
