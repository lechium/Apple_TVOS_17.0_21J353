...
+ (id)availableStyles;	// IMP=0x0010000000002c80
...
- (void)_updateContentViewControllerForUser:(id)arg1;	// IMP=0x0000000000003310
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000003240
...
- (void)handleAction;	// IMP=0x0000000000002e30
- (_Bool)dismissAfterAction;	// IMP=0x0000000000002e10
- (id)initWithUser:(id)arg1;	// IMP=0x0000000000002ca0
